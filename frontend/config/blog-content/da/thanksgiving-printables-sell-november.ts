...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'farvelaegning-arbejdsark', anchorText: 'November Farvelægning' },
    { pageType: 'app', slug: 'banko-arbejdsark', anchorText: 'Mortens Aften Banko' },
    { pageType: 'app', slug: 'ordsoegning-arbejdsark', anchorText: 'November Ordsøgning' },
  ],
  relatedPosts: [
