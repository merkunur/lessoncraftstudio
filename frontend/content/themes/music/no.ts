...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare musikk-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med musikktema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Musikk-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare musikk-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'musikkoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, musikkinstrumenter, rytmeøvelse, musikkundervisning, musikkøvelser førskole, musikkens læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Musikk-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare musikk-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'musikkoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, musikkinstrumenter, rytmeøvelse, musikkundervisning, musikkøvelser barnehage, musikkens læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Musikk-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare musikk-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'musikkoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, musikkinstrumenter, rytmeøvelse, musikkundervisning, musikkøvelser 1. klasse, musikkens læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Musikk-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare musikk-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'musikkoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, musikkinstrumenter, rytmeøvelse, musikkundervisning, musikkøvelser 2. klasse, musikkens læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Musikk-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare musikk-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'musikkoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, musikkinstrumenter, rytmeøvelse, musikkundervisning, musikkøvelser 3. klasse, musikkens læring 8-9 år',
