...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Ajustez le curseur des cases-indices de 1 à 5 (par défaut 1). Les cases-indices sont des positions de la grille où la tuile d\'image réelle reste visible comme indice pour les élèves. Avec une grille 3×3 et 1 indice, les élèves doivent associer 8 tuiles mélangées — un vrai défi. Avec 3 indices sur la même grille, seulement 6 tuiles restent à associer. Avec 5 indices, seulement 4 tuiles restent masquées — un échauffement accessible pour les plus jeunes. Ce simple contrôle transforme la même image en puzzles allant de facile à avancé, vous permettant de créer des ensembles progressifs à partir d\'une seule image.',
      },
      {
  ...
  businessIdeas: [
    ...
    {
      title: 'Packs d\'Activités de Puzzles Grille pour TPT',
      description: 'Téléversez des packs d\'activités de puzzles grille sur TPT avec la difficulté différenciée comme argument de vente principal. Les enseignants recherchant des activités de perception visuelle valorisent les puzzles qui incluent plusieurs niveaux de difficulté et des corrigés. Créez des ensembles liés au programme : puzzles grille d\'animaux pour les sciences, puzzles d\'aliments pour la nutrition, puzzles de véhicules pour les transports. Chaque pack inclut des versions facile (2×2), moyenne (3×3) et difficile (4×4) des mêmes puzzles thématiques pour que les enseignants puissent adapter selon le niveau de l\'élève. Le corrigé auto-généré avec cercles numérotés élimine le temps de préparation.',
      platform: 'Teachers Pay Teachers',
    },
    {
      title: 'Tunnel de Vente Pinterest pour Puzzles Grille',
      description: 'Les puzzles grille font des épingles Pinterest visuellement saisissantes — la grille d\'image divisée avec la palette de tuiles numérotées et l\'en-tête coloré crée un format éducatif immédiatement reconnaissable. Épinglez des exemples de puzzles montrant différentes tailles de grille : un simple 2×2 pour les épingles faciles, un détaillé 4×4 pour les épingles défi, et le corrigé avec cercles numérotés pour les épingles solution. Créez des séries d\'épingles distinctes pour « puzzles grille animaux », « puzzles d\'images de fêtes » et « activités de perception visuelle ». Le format purement visuel plaît aux parents et enseignants de tous les pays. Reliez chaque épingle à vos listings Etsy ou TPT.',
      platform: 'Pinterest',
    },
    {
  ...
  proTips: [
    {
      ...
      description: 'Les deux contrôles de difficulté indépendants — taille de grille (2×2 à 4×4) et cases-indices (1–5) — créent un large spectre de niveaux de défi à partir d\'une seule image. Une grille 2×2 avec 3 indices ne laisse qu\'1 tuile à associer : un échauffement trivial. Une grille 4×4 avec 1 indice nécessite d\'associer 15 tuiles : un vrai défi de raisonnement spatial. Créez des lots à difficulté progressive en commençant facile et en réduisant progressivement les indices tout en augmentant la taille de la grille. Les lots différenciés se vendent mieux que les packs à difficulté unique car les enseignants ont besoin de puzzles pour des classes à niveaux mixtes.',
    },
    {
    ...
    },
    {
      ...
      description: 'Le corrigé auto-généré affiche l\'image complète avec des cercles numérotés montrant quel numéro de palette correspond à chaque position — une présentation professionnelle qui distingue vos puzzles grille de la concurrence. Incluez toujours des aperçus du corrigé dans vos images de listing sur Etsy et TPT. Montrez la fiche et le corrigé côte à côte pour démontrer le package complet. Le système double canevas produit les deux versions simultanément, donc inclure les corrigés n\'ajoute aucun temps de production supplémentaire.',
    },
    {
      title: 'Exploitez le Format Purement Visuel pour des Ventes Mondiales',
      description: 'Les puzzles grille ne contiennent que des tuiles d\'images et des numéros — aucun texte spécifique à une langue sur la fiche. Cela signifie que chaque puzzle que vous créez est instantanément vendable partout dans le monde sans traduction ni localisation. Un ensemble de puzzles grille sert toutes les boutiques Etsy internationales, toutes les places de marché KDP et tous les acheteurs TPT quelle que soit la langue. Pendant que vos concurrents créent des versions linguistiques séparées de fiches avec du texte, vos puzzles grille fonctionnent partout à partir d\'un seul ensemble de fichiers.',
    },
    {
    ...
    },
    {
      ...
      description: 'Adaptez la configuration de la grille aux attentes des acheteurs sur chaque place de marché. Pour les ressources TPT ciblant la maternelle et le CP, utilisez des grilles 2×2 et 2×3 avec 2–3 indices pour des puzzles accessibles. Pour les lots d\'activités Etsy ciblant les parents d\'élèves de primaire, utilisez des grilles 3×3 avec 1–2 indices pour un défi équilibré. Pour les cahiers de puzzles KDP ciblant les élèves plus âgés et les adultes, utilisez des grilles 4×3 et 4×4 avec 1 indice pour de vrais défis de raisonnement spatial. Adapter la complexité de la grille à l\'âge du public garantit des avis positifs et des achats récurrents.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Oui. Avec une licence commerciale, vous avez tous les droits pour vendre des puzzles grille en téléchargements numériques sur Etsy, en cahiers de perception visuelle sur Amazon KDP, en ressources pédagogiques sur TPT ou par tout autre canal de vente. Les tailles de grille configurables, les cases-indices ajustables, le mélange Fisher-Yates, les corrigés auto-générés avec cercles numérotés superposés, le téléchargement d\'images personnalisées et les 104 collections d\'images thématiques vous donnent tout le nécessaire pour créer des produits professionnels compétitifs dans les catégories de puzzles et de perception visuelle sur toutes les grandes places de marché.',
    },
    {
