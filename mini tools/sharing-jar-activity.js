...
(function (global) {
  ...
  var LANG = 'en';
  function numWord(n) { var w = (LANG === 'de' ? WORDS_DE : LANG === 'fr' ? WORDS_FR : LANG === 'es' ? WORDS_ES : LANG === 'pt' ? WORDS_PT : LANG === 'it' ? WORDS_IT : LANG === 'nl' ? WORDS_NL : WORDS)[n]; return (w != null) ? w : String(n); }
  ...
  global.SharingJarActivity = {
    ...
    strings: {
      ...
      qZero: { en: 'How many more does Pim need to match Bo?', de: 'Wie viele braucht Pim noch, um genauso viele wie Bo zu haben?', fr: 'Combien de perles Pim doit-il ajouter pour en avoir autant que Bo ?', es: '¿Cuántas más necesita Pim para igualar a Bo?', pt: 'Quantas contas a mais o Pim precisa para ficar igual ao Bo?', it: 'Quante ne servono a Pim per pareggiare Bo?', nl: 'Hoeveel heeft Pim er nog nodig om evenveel als Bo te hebben?' },
      hint: { en: 'Work it out, then tap that number.', de: 'Rechne es aus und tippe dann auf die Zahl.', fr: 'Réfléchis, puis touche le bon nombre.', es: 'Piénsalo y toca ese número.', pt: 'Descubra e toque nesse número.', it: 'Pensaci, poi tocca quel numero.', nl: 'Reken het uit en tik dan op het getal.' },
      hintZero: { en: 'Look closely — maybe it is already fair!', de: 'Schau genau hin – vielleicht ist es schon fair!', fr: 'Regarde bien… c’est peut-être déjà juste !', es: 'Fíjate bien: ¡a lo mejor ya está parejo!', pt: 'Olhe bem — talvez já esteja justo!', it: 'Guarda bene: forse è già pari!', nl: 'Kijk goed – misschien is het al eerlijk!' },
      had: { en: 'had {n}', de: 'hatte {n}', fr: 'en avait {n}', es: 'tenía {n}', pt: 'tinha {n}', it: 'aveva {n}', nl: 'had {n}' },
      fairIs: { en: 'fair = {n}', de: 'fair = {n}', fr: 'juste = {n}', es: 'parejo = {n}', pt: 'justo = {n}', it: 'giusto = {n}', nl: 'eerlijk = {n}' },
      gaveAway: { en: 'gave {k} away', de: '{k} verschenkt', fr: 'a donné {k}', es: 'regaló {k}', pt: 'deu {k}', it: 'ha regalato {k}', nl: '{k} weggegeven' },
      lookAgain: { en: 'Look again — how many more does Pim need?', de: 'Schau noch mal – wie viele braucht Pim noch?', fr: 'Regarde encore : combien Pim doit-il en ajouter ?', es: 'Mira otra vez: ¿cuántas más necesita Pim?', pt: 'Olhe de novo — quantas a mais o Pim precisa?', it: 'Guarda di nuovo: quante ne servono ancora a Pim?', nl: 'Kijk nog eens – hoeveel heeft Pim er nog nodig?' },
      revealEqualize: { en: 'Yes! Now both have {n} — fair! 💛', de: 'Ja! Jetzt haben beide {n} – fair! 💛', fr: 'Oui ! Maintenant chacun en a {n} — c’est juste ! 💛', es: '¡Sí! Ahora los dos frascos tienen {n}: ¡parejo! 💛', pt: 'Isso! Agora os dois têm {n} — justo! 💛', it: 'Sì! Ora tutti e due ne hanno {n} — giusto! 💛', nl: 'Ja! Nu hebben ze allebei {n} – eerlijk! 💛' },
      revealCompare: { en: "Right! Bo's jar has {u} more. That's the gap.", de: 'Richtig! Bos Glas hat {u} mehr. Das ist der Unterschied.', fr: 'Bravo ! Le pot de Bo en a {u} de plus. C’est l’écart.', es: '¡Correcto! El frasco de Bo tiene {u} más. Esa es la diferencia.', pt: 'Certo! O pote do Bo tem {u} a mais. Essa é a diferença.', it: 'Esatto! Il barattolo di Bo ne ha {u} in più. Ecco la differenza.', nl: 'Goed zo! De pot van Bo heeft er {u} meer. Dat is het verschil.' },
      revealRestore: { en: 'Restored to {n} — Pim is happy again! 💛', de: 'Wieder bei {n} – Pim freut sich! 💛', fr: 'De retour à {n} — Pim est content ! 💛', es: '¡Devueltas hasta {n}! Pim ya está feliz otra vez. 💛', pt: 'De volta a {n} — o Pim ficou feliz de novo! 💛', it: 'Di nuovo {n} perline — Pim è felice! 💛', nl: 'Weer terug op {n} – Pim is blij! 💛' },
      revealReduce: { en: 'Now each can have {n} — fair! 💛', de: 'Jetzt hat jeder {n} – fair! 💛', fr: 'Maintenant chacun en a {n} — c’est juste ! 💛', es: 'Ahora cada quien puede tener {n}: ¡parejo! 💛', pt: 'Agora cada um pode ter {n} — justo! 💛', it: 'Ora ognuno può averne {n} — giusto! 💛', nl: 'Nu hebben ze allebei {n} – eerlijk! 💛' },
      revealStart: { en: 'Yes! Bo started with {u} beads.', de: 'Ja! Bo hatte am Anfang {u} Perlen.', fr: 'Oui ! Bo en avait {u} au départ.', es: '¡Sí! Bo empezó con {u} cuentas.', pt: 'Isso! O Bo começou com {u} contas.', it: 'Sì! All\'inizio Bo aveva {u} perline.', nl: 'Ja! Bo had in het begin {u} kralen.' },
      revealZero: { en: "They're already the SAME — that's fair! Give none. 💛", de: 'Sie haben schon GLEICH viele – das ist fair! Gib keine. 💛', fr: 'Ils en ont déjà AUTANT — c’est juste ! N’en ajoute aucune. 💛', es: '¡Ya están IGUALES: parejo! No des ninguna. 💛', pt: 'Já estão IGUAIS — isso é justo! Não precisa dar nenhuma. 💛', it: 'Sono già UGUALI — è giusto! Non darne nessuna. 💛', nl: 'Ze hebben al EVENVEEL – dat is eerlijk! Geef er geen. 💛' },
      ...
      pim: { en: 'Pim', de: 'Pim', fr: 'Pim', es: 'Pim', pt: 'Pim', it: 'Pim', nl: 'Pim' }, bo: { en: 'Bo', de: 'Bo', fr: 'Bo', es: 'Bo', pt: 'Bo', it: 'Bo', nl: 'Bo' }, fairBridge: { en: 'fair', de: 'fair', fr: 'juste', es: 'parejo', pt: 'justo', it: 'giusto', nl: 'gelijk' }
    },
    defaults: {},
    ...
    _produce: function (n) {
      ...
      else { this.api.sound && this.api.sound(330); this.msg = this.api.t('lookAgain'); speak(LANG === 'de' ? 'schau noch mal' : LANG === 'fr' ? 'regarde encore' : LANG === 'es' ? 'mira otra vez' : LANG === 'pt' ? 'olhe de novo' : LANG === 'it' ? 'guarda di nuovo' : LANG === 'nl' ? 'kijk nog eens' : 'look again'); this.render(); }
    },
    _reconcile: function () {
