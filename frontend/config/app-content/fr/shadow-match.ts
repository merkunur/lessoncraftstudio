...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur d\'Association d\'Ombres | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Association d\'Ombres professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche d\'association d\'ombres avec images et silhouettes',

    },
    sampleGallery: [
      { src: '/samples/english/shadow match/Shadow Match 1.jpeg', alt: 'Association ombres-images', caption: 'Associer chaque ombre' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Association d\'Ombres thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur d\'Association d\'Ombres est-il vraiment gratuit ?',
  ...
  internalLinks: [
    { slug: 'matching', pageType: 'app' as const, anchorText: 'Générateur de Fiches d\'Association' },
    { slug: 'grid-match', pageType: 'app' as const, anchorText: 'Générateur de Grilles de Correspondance' },
    { slug: 'bingo', pageType: 'app' as const, anchorText: 'Générateur de Cartes de Bingo' },
    { slug: 'shadow-match', pageType: 'tool' as const, anchorText: 'Essayer Générateur d\'Association d\'Ombres Gratuit' },
    { slug: 'matching-bundle', pageType: 'bundle' as const, anchorText: 'Pack Association et Tri Complet' }
  ],
};
