 ...
 *
 * FULL SEO content from: INDIVIDUAL APP PAGES/German/bilder-sortieren.md
 ...
 *
 * PRICING: Picture Sort is a FULL ACCESS app (240 Euro/year or 25 Euro/month)
 */

export const pictureSortDeContent: ProductPageContent = {
...
Mit Ihrem Abonnement erhalten Sie Zugang zu über 3000 kindgerechten Bildern. Die Ausmalbilder und Malvorlagen lassen sich mit Sortieraufgaben kombinieren. Erstellen Sie individuelle Arbeitsblätter für Ihre Klasse. Der Generator bietet professionelle 300 DPI Qualität für den Druck. Alle Materialien sind sofort einsatzbereit.`,
  ...
  samples: {
    sectionTitle: 'Bilder Sortieren Arbeitsblätter Beispiele',
...
PDF-Dateien enthalten eingebettete Schriften für konsistente Darstellung. Die Graustufen-Option wandelt farbige Arbeitsblätter in Schwarzweiß um. Das spart Druckertinte und eignet sich für Kopiergeräte in Schulen. Die Bildqualität bleibt dabei vollständig erhalten.`,
  ...
  howTo: {
    sectionTitle: 'Sortierarbeitsblätter in 5 Schritten erstellen - Arbeitsblätter Grundschule und Vorschule Arbeitsblätter schnell und einfach',
    sectionDescription: 'Die Erstellung von Sortierarbeitsblättern dauert weniger als 3 Minuten. Folgen Sie dieser einfachen Schritt-für-Schritt Anleitung. Auch ohne technische Vorkenntnisse gelingen perfekte Ergebnisse. In nur 5 Schritten haben Sie ein druckfertiges Arbeitsblatt.',
    ...
    steps: [
      {
        ...
        number: 1,
        icon: '🎯',
        title: 'Schritt 1: Kategorien wählen für Kostenlose Arbeitsblätter - Mathe Arbeitsblätter oder Deutsch Arbeitsblätter Themen festlegen',
        description: `Öffnen Sie den Bereich Sortierkategorien in der Seitenleiste. Wählen Sie ein Thema für die linke Kategorie aus. Wählen Sie ein zweites Thema für die rechte Kategorie. Beispiel: Links Obst und rechts Gemüse. Oder links Haustiere und rechts Wildtiere. Die Kategorien bestimmen das Lernziel Ihres Arbeitsblatts.

Bei der automatischen Generierung wählt der Generator passende Bilder aus beiden Themen. Bei der manuellen Auswahl bestimmen Sie selbst welche Bilder erscheinen. Für Mathe Arbeitsblätter wählen Sie Zahlen und Formen. Für Deutsch Arbeitsblätter eignen sich Buchstaben und Wörterbilder.`,
      },
      {
        id: '2',
        number: 2,
        icon: '🖼️',
        title: 'Schritt 2: Bilder auswählen für Arbeitsblätter Grundschule - Einmaleins und Rechnen lernen Motive finden',
        description: `Wechseln Sie zur Bildbibliothek im Seitenmenü. Durchsuchen Sie die über 3000 verfügbaren Bilder. Nutzen Sie die Suchfunktion für schnelle Ergebnisse. Klicken Sie auf ein Bild um es hinzuzufügen. Weisen Sie jedem Bild eine Kategorie zu. Maximal 12 Bilder pro Arbeitsblatt sind möglich. Wählen Sie passende Motive für Einmaleins oder Rechnen lernen Übungen.

Die Bildauswahl bestimmt den Schwierigkeitsgrad. Weniger Bilder für Anfänger, mehr für Fortgeschrittene. Mindestens 6 Bilder insgesamt und mindestens 3 pro Kategorie sind erforderlich. Maximal 6 Bilder pro Kategorie sorgen für übersichtliche Arbeitsblätter.`,
      },
      {
        id: '3',
        number: 3,
        icon: '📄',
        title: 'Schritt 3: Seitenformat einstellen für Vorschule Arbeitsblätter - Kostenlose Arbeitsblätter in Letter oder A4 erstellen',
        description: `Öffnen Sie den Bereich Seiteneinstellungen. Wählen Sie das gewünschte Papierformat aus. Verfügbar sind Letter Hochformat und Querformat. Auch A4 Hochformat und Querformat stehen bereit. Quadratisch oder benutzerdefinierte Größen sind möglich. Stellen Sie die Seitenfarbe nach Wunsch ein. Aktivieren Sie optional das Name-Datum Feld.

Wählen Sie einen Hintergrund aus der Themenbibliothek. Passen Sie die Hintergrund-Deckkraft an. Fügen Sie einen dekorativen Rahmen hinzu. Auch die Rahmen-Deckkraft ist einstellbar. So entstehen professionelle Vorschule Arbeitsblätter.`,
      },
      {
        id: '4',
        number: 4,
        icon: '✨',
        title: 'Schritt 4: Arbeitsblatt erstellen mit Schwungübungen und Buchstaben lernen Elementen - Ausmalbilder und Malvorlagen hinzufügen',
        description: `Klicken Sie auf den Erstellen Button in der Kopfzeile. Der Generator erstellt automatisch das Sortierarbeitsblatt. Alle Bilder werden übersichtlich angeordnet. Zwei Kategorie-Boxen erscheinen für die Sortierung. Fügen Sie optional Text hinzu für Schwungübungen. Ergänzen Sie Buchstaben lernen Elemente nach Bedarf. Kombinieren Sie mit Ausmalbilder und Malvorlagen aus der Bibliothek.

Bearbeiten Sie das Ergebnis nach Ihren Wünschen. Verschieben Sie Elemente per Drag-and-Drop. Ändern Sie die Größe durch Ziehen an den Ecken. Drehen Sie Bilder in jeden beliebigen Winkel. Die Ausrichtungswerkzeuge positionieren mehrere Elemente gleichmäßig.`,
      },
      {
        id: '5',
        number: 5,
        icon: '📥',
        title: 'Schritt 5: Herunterladen und Drucken von Mathe Arbeitsblättern - Deutsch Arbeitsblätter und Rechnen 1. Klasse als PDF speichern',
        description: `Klicken Sie auf den Download Button. Wählen Sie zwischen Arbeitsblatt und Lösungsschlüssel. Entscheiden Sie sich für JPEG oder PDF Format. Aktivieren Sie Graustufen um Tinte zu sparen. Der Download startet automatisch. Die Mathe Arbeitsblätter sind sofort druckbereit. Auch Deutsch Arbeitsblätter und Rechnen 1. Klasse Materialien exportieren Sie so einfach.

Generieren Sie den Lösungsschlüssel separat. Die Lösung zeigt alle Bilder korrekt sortiert in den jeweiligen Kategorien. Wechseln Sie zwischen Arbeitsblatt und Lösung über die Tabs. Laden Sie beide Versionen separat herunter. Perfekt für die Selbstkontrolle der Schüler.`,
      },
    ],
  },

  // Use Cases Section - FULL text from bilder-sortieren.md
  useCases: {
    ...
    sectionDescription: 'Sortierarbeitsblätter sind vielseitig einsetzbar. Verschiedene Zielgruppen nutzen den Generator für unterschiedliche Zwecke. Entdecken Sie wie auch Sie von diesem Tool profitieren können. Die folgenden Anwendungsfälle zeigen die Vielseitigkeit.',
...
export default pictureSortDeContent;
