...
const noBlock = tmpl.match(/\s\sno:\s*\{[\s\S]*?\},/);
if (noBlock) {
  console.log('startCreating: ' + (noBlock[0].match(/startCreating:\s*'([^']*)'/)?.[1] || ''));
  console.log('pairedToolPrompt present: ' + /pairedToolPrompt/.test(noBlock[0]));
}
