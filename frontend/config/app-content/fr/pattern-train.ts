...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Train de Motifs | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Train de Motifs professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Train de motifs avec séquences d\'images à compléter',

    },
    sampleGallery: [
      { src: '/samples/english/pattern train/Pattern Train 1.jpeg', alt: 'Suite logique en train', caption: 'Compléter la suite' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Train de Motifs thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Train de Motifs est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'pattern-worksheet', pageType: 'app' as const, anchorText: 'Générateur de Fiches de Motifs' },
    { slug: 'draw-and-color', pageType: 'app' as const, anchorText: 'Générateur Dessiner et Colorier' },
    { slug: 'pattern-train', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Train de Motifs Gratuit' },
