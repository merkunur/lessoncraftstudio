...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare camping-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med campingtema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Camping-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare camping-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'campingoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, friluftsliv, naturopplevelse, campingutstyr, campingøvelser førskole, campingens læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Camping-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare camping-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'campingoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, friluftsliv, naturopplevelse, campingutstyr, campingøvelser barnehage, campingens læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Camping-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare camping-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'campingoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, friluftsliv, naturopplevelse, campingutstyr, campingøvelser 1. klasse, campingens læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Camping-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare camping-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'campingoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, friluftsliv, naturopplevelse, campingutstyr, campingøvelser 2. klasse, campingens læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Camping-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare camping-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'campingoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, friluftsliv, naturopplevelse, campingutstyr, campingøvelser 3. klasse, campingens læring 8-9 år',
