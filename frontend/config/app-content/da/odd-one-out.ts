...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Find den forkerte-generator | LessonCraftStudio',
  ...
  hero: {
    title: 'Find den forkerte-generator — Lav printables at sælge på Etsy og KDP',
