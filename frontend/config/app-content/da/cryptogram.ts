  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Indstillingen Bogstaver at Afsløre styrer, hvor mange bogstav-til-billede-koblinger der er frigivet som ledetråde på arbejdsarket. Ved nul møder brugerne en ren kodeknækkerudfordring uden startinformation. Ved ti er en betydelig del af chifferet allerede afkodet, hvilket giver kraftig støtte til yngre eller mindre erfarne løsere. Denne ene kontrol generator en jævn sværhedsgradient, der gør kryptogrampuslespil tilgængelige for en bred vifte af evneniveauer — og den fungerer som en kraftfuld differentieringsakse for produktpakker.',
      },
      {
