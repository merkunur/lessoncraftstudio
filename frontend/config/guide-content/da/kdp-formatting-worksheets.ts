...
const content: GuideContent = {
  ...
  visuals: {
    heroImage: { src: '/samples/danish/math%20worksheet/matematikopgave-1.webp', alt: 'Matematikarbejdsark der viser gitterlayout og afstand formateret til Amazon KDP trykspecifikationer' },
    samples: [
