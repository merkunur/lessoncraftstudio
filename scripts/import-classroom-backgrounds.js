/**
 * Background Import Script: Classroom
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-classroom-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'classroom_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/classroom',
  displayNames: {
    en: 'Classroom',
    de: 'Klassenzimmer',
    fr: 'Salle de classe',
