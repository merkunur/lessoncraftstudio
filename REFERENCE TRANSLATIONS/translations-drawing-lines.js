/**
 * DRAWING LINES - COMPREHENSIVE TRANSLATIONS
 * ================================================
 * Complete Translation System for Drawing Lines App
 * Version: 2.0.0 - Compiled Professional Edition
 * Generated: December 2024
 *
 * COMPLETE COVERAGE: 162 keys × 11 languages = 1,782 translations
 *
 * Languages: EN, DE, FR, ES, IT, PT, NL, SV, DA, NO, FI
 *
 * CRITICAL USER-MENTIONED ITEMS CONFIRMED:
 * - Background ✓ (All languages)
 * - Border ✓ (All languages)
 * - Grayscale ✓ (All languages)
 *
 * This file contains ALL professional translations compiled
 * from individual language files into one comprehensive system.
 */
...
const DRAWING_LINES_TRANSLATIONS = {
  ...
  "en": {
    ...
    "couldNotLoadImageThemes": "Could not load image themes.",
    ...
    "preparingPdfWait": "Preparing PDF... Please wait.",
  ...
  "fr": {
    ...
    "selectBackgroundTheme": "Sélectionnez un thème pour voir les arrière-plans.",
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Choisir le modèle de liaison",
    "assignImagePairs": "2. Associer les paires d'images",
    "autoFillImages": "Remplissage automatique avec le thème sélectionné",

    // ============= DRAWING TEMPLATES =============
    "template_curve1": "Courbe 1",
    "template_curve2": "Courbe 2",
    "template_curve3": "Courbe 3",
    "template_curve4": "Courbe 4",
    "template_diagonal1": "Diagonale 1",
    "template_diagonal2": "Diagonale 2",
    "template_horizontal1": "Horizontale 1",
    "template_vertical1": "Verticale 1",
    ...
    // ============= NAME/DATE FIELD =============
    "nameDatePlaceholder": "Nom : _________________________ Date : ____________",

    // ============= SUCCESS MESSAGES =============
    "worksheetGenerated": "Fiche créée !",
    ...
    "couldNotLoadBackgroundImages": "Impossible de charger les images d'arrière-plan.",
    "errorLoadingBackgrounds": "Erreur lors du chargement des arrière-plans.",
    "errorReadingFile": "Erreur de lecture du fichier : {filename}",
    "pleaseSelectSlotFirst": "Veuillez d'abord sélectionner un emplacement dans la section « Associer les paires d'images ».",
    "pleaseSelectDrawingTemplate": "Veuillez sélectionner un modèle de liaison.",
    "cannotAutoFill": "Remplissage automatique impossible. Veuillez sélectionner un thème ou importer des images.",
    "pleaseFillAllImagePairs": "Veuillez remplir toutes les paires d'images ou activer le remplissage automatique.",
    "errorDuringGeneration": "Une erreur s'est produite lors de la création.",
    ...
    "loadingImages": "Chargement de {count} image(s)...",
    ...
    "autoFillingFromAllThemes": "Remplissage automatique depuis tous les thèmes...",
  ...
  "es": {
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Seleccionar plantilla de conexión",
    "assignImagePairs": "2. Asignar pares de imágenes",
    "autoFillImages": "Rellenar automáticamente con el tema seleccionado",

    // ============= DRAWING TEMPLATES =============
    "template_curve1": "Curva 1",
    "template_curve2": "Curva 2",
    "template_curve3": "Curva 3",
    "template_curve4": "Curva 4",
    "template_diagonal1": "Diagonal 1",
    "template_diagonal2": "Diagonal 2",
    "template_horizontal1": "Horizontal 1",
    "template_vertical1": "Vertical 1",
    ...
    "searchPlaceholder": "ej. manzana, carro",
    ...
    "couldNotLoadBackgroundImages": "No se pudieron cargar las imágenes de fondo.",
    ...
    "loadingImages": "Cargando {count} imagen(es)...",
    ...
    "autoFillingFromAllThemes": "Rellenando automáticamente desde todos los temas...",
    "preparingJpeg": "Preparando JPEG... Por favor espera.",
  ...
  "it": {
    ...
    "selectBackgroundTheme": "Seleziona un tema per vedere gli sfondi.",
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Scegli il modello di collegamento",
    "assignImagePairs": "2. Assegna le coppie di immagini",
    "autoFillImages": "Riempimento automatico dal tema selezionato",
    ...
    "template_diagonal1": "Diagonale 1",
    "template_diagonal2": "Diagonale 2",
    "template_horizontal1": "Orizzontale 1",
    "template_vertical1": "Verticale 1",
    ...
    "yourUploadedImages": "Le tue immagini caricate (sessione attuale):",
    ...
    // ============= NAME/DATE FIELD =============
    "nameDatePlaceholder": "Nome: _________________________ Data: ____________",
    ...
    "pleaseSelectSlotFirst": "Per favore, seleziona prima una posizione nella sezione \"Assegna le coppie di immagini\".",
    "pleaseSelectDrawingTemplate": "Per favore, seleziona un modello di collegamento.",
    "cannotAutoFill": "Riempimento automatico non possibile. Seleziona un tema o carica delle immagini.",
    "pleaseFillAllImagePairs": "Per favore, completa tutte le coppie di immagini o attiva il riempimento automatico.",
    "errorDuringGeneration": "Si è verificato un errore durante la creazione.",
    ...
    "autoFillingFromAllThemes": "Riempimento automatico da tutti i temi...",
  ...
  "pt": {
    ...
    "selectBackgroundTheme": "Selecione um tema para ver os fundos.",
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Escolher modelo de ligação",
    "assignImagePairs": "2. Atribuir pares de imagens",
    "autoFillImages": "Preencher automaticamente com o tema selecionado",
    ...
    "yourUploadedImages": "Suas imagens carregadas (sessão atual):",
    ...
    // ============= SUCCESS MESSAGES =============
    "worksheetGenerated": "Folha de exercícios criada!",
    "textAddedToWorksheet": "Texto adicionado à folha.",
    ...
    "couldNotLoadBackgroundImages": "Não foi possível carregar as imagens de fundo.",
    "errorLoadingBackgrounds": "Erro ao carregar os fundos.",
    "errorReadingFile": "Erro ao ler o arquivo: {filename}",
    "pleaseSelectSlotFirst": "Por favor, selecione primeiro um espaço na seção \"Atribuir pares de imagens\".",
    "pleaseSelectDrawingTemplate": "Por favor, selecione um modelo de ligação.",
    "cannotAutoFill": "Não é possível preencher automaticamente. Selecione um tema ou carregue imagens.",
    "pleaseFillAllImagePairs": "Por favor, preencha todos os pares de imagens ou ative o preenchimento automático.",
    "errorDuringGeneration": "Ocorreu um erro durante a criação.",
    ...
    "noBordersInTheme": "Nenhuma moldura neste tema.",
    "loadingImages": "Carregando {count} imagem(ns)...",
    ...
    "autoFillingFromAllThemes": "Preenchendo automaticamente de todos os temas...",
  ...
  "sv": {
    ...
    "generate": "Skapa",
    "download": "Ladda ner",
    "downloadAsJpeg": "Spara som JPEG",
    "downloadAsPdf": "Spara som PDF",
    "grayscale": "Gråskala",
    "clearAll": "Rensa allt",
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Välj kopplingsmall",
    "assignImagePairs": "2. Tilldela bildpar",
    "autoFillImages": "Fyll automatiskt från valt tema",

    // ============= DRAWING TEMPLATES =============
    "template_curve1": "Kurva 1",
    "template_curve2": "Kurva 2",
    "template_curve3": "Kurva 3",
    "template_curve4": "Kurva 4",
    "template_diagonal1": "Diagonal 1",
    "template_diagonal2": "Diagonal 2",
    "template_horizontal1": "Horisontell 1",
    "template_vertical1": "Vertikal 1",
    ...
    "couldNotLoadBackgroundImages": "Kunde inte ladda bakgrundsbilder.",
    "errorLoadingBackgrounds": "Fel vid laddning av bakgrunder.",
    "errorReadingFile": "Fel vid läsning av fil: {filename}",
    "pleaseSelectSlotFirst": "Välj först en plats i avsnittet \"Tilldela bildpar\".",
    "pleaseSelectDrawingTemplate": "Välj en kopplingsmall.",
    "cannotAutoFill": "Kan inte fylla automatiskt. Välj ett tema eller ladda upp bilder.",
    "pleaseFillAllImagePairs": "Fyll i alla bildpar eller aktivera automatisk ifyllning.",
    ...
    "loadingImages": "Laddar {count} bild(er)...",
    ...
    "autoFillingFromAllThemes": "Fyller automatiskt från alla teman...",
    "preparingJpeg": "Förbereder JPEG... Vänta lite.",
  ...
  "da": {
    ...
    "generate": "Opret",
    "download": "Download",
    "downloadAsJpeg": "Gem som JPEG",
    "downloadAsPdf": "Gem som PDF",
    "grayscale": "Gråtoner",
    "clearAll": "Ryd alt",
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Vælg forbindelsesskabelon",
    "assignImagePairs": "2. Tildel billedpar",
    "autoFillImages": "Fyld automatisk fra valgt tema",
    ...
    "template_diagonal1": "Diagonal 1",
    "template_diagonal2": "Diagonal 2",
    "template_horizontal1": "Vandret 1",
    "template_vertical1": "Lodret 1",
    ...
    "couldNotLoadBackgroundImages": "Kunne ikke indlæse baggrundsbilleder.",
    "errorLoadingBackgrounds": "Fejl ved indlæsning af baggrunde.",
    "errorReadingFile": "Fejl ved læsning af fil: {filename}",
    "pleaseSelectSlotFirst": "Vælg først en plads i afsnittet \"Tildel billedpar\".",
    "pleaseSelectDrawingTemplate": "Vælg en forbindelsesskabelon.",
    "cannotAutoFill": "Kan ikke fylde automatisk. Vælg et tema eller upload billeder.",
    "pleaseFillAllImagePairs": "Udfyld alle billedpar eller aktiver automatisk udfyldning.",
    ...
    "loadingImages": "Indlæser {count} billede(r)...",
    ...
    "autoFillingFromAllThemes": "Fylder automatisk fra alle temaer...",
  ...
  "no": {
    ...
    "generate": "Lag",
    "download": "Last ned",
    "downloadAsJpeg": "Lagre som JPEG",
    "downloadAsPdf": "Lagre som PDF",
    "grayscale": "Gråtoner",
    "clearAll": "Fjern alt",
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Velg koblingsmal",
    "assignImagePairs": "2. Tildel bildepar",
    "autoFillImages": "Fyll automatisk fra valgt tema",
    ...
    "template_diagonal1": "Diagonal 1",
    "template_diagonal2": "Diagonal 2",
    "template_horizontal1": "Horisontal 1",
    "template_vertical1": "Vertikal 1",
    "templateInfo": "Valgt: {name} ({pairs} par, {orientation})",
    ...
    "couldNotLoadBackgroundImages": "Kunne ikke laste bakgrunnsbilder.",
    "errorLoadingBackgrounds": "Feil ved lasting av bakgrunner.",
    "errorReadingFile": "Feil ved lesing av fil: {filename}",
    "pleaseSelectSlotFirst": "Velg først en plass i seksjonen \"Tildel bildepar\".",
    "pleaseSelectDrawingTemplate": "Velg en koblingsmal.",
    "cannotAutoFill": "Kan ikke fylle automatisk. Velg et tema eller last opp bilder.",
    "pleaseFillAllImagePairs": "Fyll ut alle bildepar eller aktiver automatisk utfylling.",
    ...
    "loadingImages": "Laster {count} bilde(r)...",
    ...
    "autoFillingFromAllThemes": "Fyller automatisk fra alle temaer...",
    "preparingJpeg": "Klargjør JPEG... Vennligst vent.",
  ...
  "fi": {
    ...
    "generate": "Luo",
    "download": "Lataa",
    "downloadAsJpeg": "Tallenna JPEG-muodossa",
    "downloadAsPdf": "Tallenna PDF-muodossa",
    ...
    // ============= TEMPLATE & IMAGES =============
    "selectDrawingTemplate": "1. Valitse yhdistämismalli",
    "assignImagePairs": "2. Määritä kuvaparit",
    "autoFillImages": "Täytä automaattisesti valitusta teemasta",

    // ============= DRAWING TEMPLATES =============
    "template_curve1": "Kaari 1",
    "template_curve2": "Kaari 2",
    "template_curve3": "Kaari 3",
    "template_curve4": "Kaari 4",
    "template_diagonal1": "Vino 1",
    "template_diagonal2": "Vino 2",
    "template_horizontal1": "Vaakasuora 1",
    "template_vertical1": "Pystysuora 1",
    ...
    "alignLeft": "Kohdista vasemmalle",
    "alignRight": "Kohdista oikealle",
    "alignTop": "Kohdista ylös",
    "alignBottom": "Kohdista alas",
    ...
    "noImagesFoundWithQuery": "Kuvia ei löytynyt hakusanalla \"{query}\".",
    "autoFillingFromAllThemes": "Täytetään automaattisesti kaikista teemoista...",
    "preparingJpeg": "Valmistellaan JPEG:tä... Odota hetki.",
...
function t(key, locale = 'en', params = {}) {
  // Get current locale if not specified
  if (typeof currentLocale !== 'undefined' && locale === 'en') {
 ...
 * VALIDATION REPORT
 */
console.log('=== DRAWING LINES TRANSLATIONS VALIDATION ===');
const supportedLocales = getSupportedLocales();
supportedLocales.forEach(locale => {
  const validation = validateTranslations(locale);
  console.log(`${locale.toUpperCase()}: ${validation.coverage} (${validation.translatedKeys}/${validation.totalKeys} keys)`);
});
...
supportedLocales.forEach(locale => {
  const criticalItems = {
    background: DRAWING_LINES_TRANSLATIONS[locale].background,
    border: DRAWING_LINES_TRANSLATIONS[locale].border,
    grayscale: DRAWING_LINES_TRANSLATIONS[locale].grayscale
  };
  console.log(`${locale.toUpperCase()}:`, criticalItems);
});

console.log('\n✅ All 162 keys × 11 languages = 1,782 total translations compiled successfully!');
...
if (typeof window !== 'undefined') {
  ...
  window.translations = DRAWING_LINES_TRANSLATIONS; // Alias for compatibility
  window.t = t;
