...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      'utskriftsbar koblingsaktivitet generator til Etsy-selgere',
      'trekk-en-strek koblings arbeidsark generator til KDP',
      'bildekobling arbeidsark generator kommersiell lisens',
      'selg koblings arbeidsark på Gumroad',
    ],
    lsiKeywords: [
      'digitale koblings utskriftsbare produkter nettbasert forretning',
      'kommersielt bruk koblings arbeidsark generator',
  ...
  hero: {
    title: 'Koblings Arbeidsark Generator for Trekk-en-Strek Koblingsaktiviteter',
