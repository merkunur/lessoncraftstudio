...
const GRADE_OVERRIDE: Record<string, Record<string, string>> = {
  ...
  'vet-diagnosis.word-problems.1-oa-a-1': { de: '2', fr: '2' },           // Sachaufgaben ZR bis 20 BUT grade follows STRUCTURE: Anfang-unbekannt + additiver Vergleich = schwierigste Klasse-2 Sachaufgabentypen; length-sibling precedent. fr → CE1 (same structural logic: problèmes à état-initial-inconnu + comparaison additive = attendus consolidés au CE1, même ≤20; en stays Grade 1 native); strand falls through auto-map « Nombres et calcul »
...
export default async function ActivityPage({ params }: { params: PageParams }) {
  ...
  const ACTIVITY_WRAPPER_VERSION = '9.219';
