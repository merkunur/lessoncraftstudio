...
const content: AppContent = {
  seo: {
    primaryKeyword: 'criar e vender fichas de preposições',
    secondaryKeywords: [
    ...
    lsiKeywords: [
      ...
      'negócio de fichas de preposições imprimíveis online',
      'gerador de fichas de linguagem espacial uso comercial',
    ],
  ...
  howItWorks: {
    title: 'Como Criar Fichas de Preposições em 5 Passos',
    steps: [
      {
        title: 'Configure o layout da página',
        description:
          'Abra o painel de Configuração de Página e escolha um tamanho: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) ou qualquer dimensão personalizada. Selecione uma cor de fundo, escolha um tema decorativo de fundo da biblioteca de imagens e ajuste a opacidade para manter os exercícios legíveis. Adicione uma moldura de borda combinante e selecione um modelo de ficha para dar às suas fichas de preposições um aspeto profissional e pronto para impressão.',
      },
      {
  ...
  visuals: {
    ...
    videoTitle: 'Como Criar Fichas de Preposições com Exercícios de Imagens e Formas — Tutorial Passo a Passo',
  },
};
