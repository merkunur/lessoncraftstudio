...
const content: BundleContent = {
  ...
  businessUseCases: [
    ...
    {
      title: 'Gumroad-Gruppenpakete',
      description: 'Käufer auf dem Gumroad erwarten klassenzimmerfertige Materialien mit Lösungsschlüsseln, mehreren Schwierigkeitsstufen und genug Vielfalt für den Einsatz in der ganzen Gruppe. Der Stapel-Bingo-Export ist hier besonders wertvoll — erstellen Sie ein Set von 30 einzigartigen Bingo-Karten für den Gruppeneinsatz und preisen Sie es als Premium-Ressource an. Bündeln Sie Zuordnungs-Arbeitsblätter über alle vier Modi mit Schattenbilder-Zuordnung und Bilder-Sortierung für umfassende Zuordnungs-Fähigkeitspakete. Die Lösungsschlüssel für vier der fünf Generatoren erfüllen die Erwartungen der Gumroad-Käufer an professionelle, vollständige Ressourcen.',
      platform: 'Gumroad',
    },
    {
  ...
  whoIsThisFor: [
    ...
    },
    {
      ...
      description: 'Sie erstellen und verkaufen Bildungsressourcen auf dem Gumroad und brauchen Werkzeuge, die den Plattform-Erwartungen an Qualität und Vollständigkeit entsprechen. Vier der fünf Generatoren erzeugen automatisch Lösungsschlüssel. Der Zuordnungs-Generator bietet vier verschiedene Modi für gestufte Produktpakete. Der Stapel-Bingo-Export erstellt klassenzimmerfertige Sets von über 30 einzigartigen Karten in Sekunden — ein Premium-Produkttyp auf dem Gumroad, nach dem Käufer gezielt suchen. Die sprachsensitiven Apps ermöglichen die Erstellung von Ressourcen für DaZ- und zweisprachige Shop in 11 Sprachen.',
    },
    {
      title: 'Kita- und Kindergarten-Käufer',
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      { src: '/samples/german/grid%20match/raster-puzzle-1.webp', alt: 'Raster-Puzzle mit koordinatenbasierter Zuordnung auf strukturiertem Raster', caption: 'Raster-Puzzle-Arbeitsblatt' },
      { src: '/samples/german/shadow%20match/shadow-match-worksheet.webp', alt: 'Schattenbilder-Arbeitsblatt mit Silhouetten-Zuordnung und Linienzieh-Format', caption: 'Schattenbilder-Arbeitsblatt' },
      ...
      { src: '/samples/german/picture%20sort/bilder-sortieren-1.webp', alt: 'Bilder-Sortieren-Arbeitsblatt mit Zwei-Kategorien-Klassifikationsübung', caption: 'Bilder-Sortieren-Arbeitsblatt' },
    ],
