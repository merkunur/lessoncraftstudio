...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Rummet',
  title: 'Gratis rumarbejdsark til børn | LessonCraftStudio',
  description: 'Opret printbare rumtemaede arbejdsark til børn. Planeter, raketter, astronauter og stjerner. Matematik, læsning, gåder og farvning fra førskole til 3. klasse.',
  keywords: 'rumarbejdsark, planetarbejdsark til børn, solsystemaktiviteter, astronaut-farvesider, printbare rumarbejdsark til børn',
  heading: 'Gratis rumarbejdsark til børn',
