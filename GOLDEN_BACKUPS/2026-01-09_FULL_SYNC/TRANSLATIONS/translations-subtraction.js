...
const translations = {
  "en": {
    ...
    "message.worksheetGenerated": "Worksheet created successfully!",
  ...
  "de": {
    ...
    "subtraction.language.description": "Wählt die Sprache nur für Bildbibliotheksinhalte aus. Die UI-Sprache wird durch den Haupt-Sprachselektor im Header gesteuert.",
  ...
  "fr": {
    ...
    "button.generate": "Créer la fiche",
    ...
    "pleaseGenerateWorksheetFirst": "Veuillez d'abord créer une fiche.",
    "pleaseSelectImagesFirst": "Veuillez d'abord sélectionner des images, soit depuis la bibliothèque, soit en ajoutant vos propres images.",
    ...
    "selectImagesToUpload": "Sélectionner les images à ajouter :",
    ...
    "uploadedImagesWillAppear": "Vos images ajoutées apparaîtront ici.",
    "uploadCustomImages": "Ajouter des images personnalisées",
    "undo": "Annuler",
  ...
  "it": {
    ...
    "answerKeyGenerated": "Foglio soluzioni generato!",
    ...
    "button.generate": "Genera scheda",
    "button.generateAnswer": "Genera foglio soluzioni",
    ...
    "generate": "Genera",
    "generateAnswerKey": "Genera foglio soluzioni",
    ...
    "maxImagesSelected": "Massimo {count} immagini selezionate.",
    ...
    "message.preparingDownload": "Preparazione scaricamento...",
    "message.worksheetGenerated": "Scheda generata con successo!",
    "multipleChoice": "Scelta multipla (foglio con tutte le soluzioni corrette)",
    ...
    "orderMatters": "L'ordine è importante (sequenza fissa)",
    ...
    "subtraction.language.description": "Seleziona la lingua solo per i contenuti della libreria di immagini. Il selettore di lingua principale nell'intestazione controlla la lingua dell'interfaccia.",
    ...
    "selectThemeFromDropdown": "Seleziona un tema dal menu a tendina qui sopra.",
    ...
    "settings.downloadOptions": "Opzioni di Scaricamento Immagine",
  ...
  "pt": {
    ...
    "button.generate": "Criar atividade",
    "button.generateAnswer": "Criar gabarito",
    "canvasIsEmpty": "A área de trabalho está vazia. Nada para baixar.",
    ...
    "generateWorksheet": "Criar atividade",
    ...
    "jpegDownloadInitiated": "Baixando JPEG!",
    ...
    "loadingImagesForTheme": "Carregando imagens para o tema...",
    ...
    "message.preparingDownload": "Preparando download...",
    "message.worksheetGenerated": "Atividade criada com sucesso!",
    "multipleChoice": "Escolha múltipla (gabarito com todas as respostas corretas)",
    "noFileChosen": "Nenhum arquivo escolhido",
    "noImagesFound": "Nenhuma imagem encontrada{query}.",
    "none": "Nenhum",
    "newWorksheet": "Nova Atividade",
    "numberOfProblems": "Número de problemas (1-30):",
    "orderMatters": "A ordem importa (ordem fixa de imagens)",
    "outlineColor": "Cor do contorno:",
    "outlineWidth": "Contorno (0-10):",
    "page.title": "Gerador de Atividades de Subtração",
    ...
    "pleaseGenerateWorksheetFirst": "Por favor, crie primeiro uma atividade.",
    ...
    "settings.downloadOptions": "Opções para Baixar Imagem",
  ...
  "nl": {
    ...
    "backgroundOpacity": "Achtergrondtransparantie:", // FIXED 2025-11-30: Platform standard "Transparantie" (not "dekking")
    "backgroundTheme": "Achtergrondthema:",
    "border": "Rand",
    "borderOpacity": "Randtransparantie:", // FIXED 2025-11-30: Platform standard "Transparantie" (not "dekking")
    "borderTheme": "Randthema:",
    "bringForward": "Naar voren", // FIXED 2025-11-30: Lowercase "voren" (not capitalized) - Dutch grammar
    ...
    "config.exerciseCount": "Aantal Opgaven:", // FIXED 2025-11-30: Consistency - use "Opgaven" (not "Oefeningen") per RATIONALE
    ...
    "heightPx": "Hoogte (px):",
    "imageLibrary": "Afbeeldingenbibliotheek", // FIXED 2025-11-30: Compound word (platform standard from Wordsearch)
    ...
    "library.title": "Afbeeldingenbibliotheek", // FIXED 2025-11-30: Compound word (platform standard)
    ...
    "subtraction.exercise.mode": "Opgavemodus", // FIXED 2025-11-30: Consistency - use "Opgave" (not "Oefening")
    "subtraction.mode.cross.out": "Doorstrepen (traditioneel)",
    "subtraction.mode.find.subtrahend": "Aftrekker zoeken (afbeeldingen - ? = resultaat)", // FIXED 2025-11-30: "Aftrekker" (subtrahend) not "Aftrektal" (minuend)
    "subtraction.mode.image.number": "Afbeelding - Nummer",
    "subtraction.mode.mixed": "Gemengd (Afbeelding-Nummer + Aftrekker zoeken)", // FIXED 2025-11-30: "Aftrekker" not "Aftrektal"
    ...
    "sendBackward": "Naar achteren", // FIXED 2025-11-30: Lowercase "achteren" (not capitalized) - Dutch grammar
    "sendToBack": "Naar achteren sturen",
    "settings.downloadOptions": "Downloadopties", // FIXED 2025-11-30: Natural Dutch word order (not English "Afbeelding Download Opties")
    "settings.exerciseConfig": "Opgave Configuratie", // FIXED 2025-11-30: Consistency - use "Opgave" (not "Oefening")
    ...
    "size": "Grootte:",
    "spacingBetweenImages": "Ruimte tussen Afbeeldingen (px, 0-50):", // FIXED 2025-11-30: Lowercase "tussen" - Dutch grammar
    ...
    "verticalSpacing": "Verticale Ruimte tussen Opgaven (px, 0-100):", // FIXED 2025-11-30: Lowercase "tussen" - Dutch grammar
  ...
  "sv": {
    ...
    "button.generate": "Skapa Övningsblad",
    ...
    "pleaseSelectImagesFirst": "Välj först några bilder, antingen från bildsamlingen eller genom att ladda upp egna.",
    ...
    "subtraction.language.description": "Väljer språk endast för bildsamlingsinnehåll. UI-språket styrs av huvudspråksväljaren i rubriken.",
    ...
    "settings.title": "Övningsbladsinställningar",
    "size": "Storlek:",
  ...
  "da": {
    ...
    "button.downloadJpeg": "Download JPEG",
    "button.downloadPdf": "Download PDF",
    "button.generate": "Opret Opgaveark",
    ...
    "subtraction.language.description": "Vælger sprog kun for billedbiblioteksindhold. UI-sproget styres af hovedsprogvælgeren i overskriften.",
    ...
    "settings.title": "Indstillinger for Opgaveark",
    "size": "Størrelse:",
  ...
  "no": {
    ...
    "button.generate": "Lag Oppgaveark",
    ...
    "subtraction.language.description": "Velger språk kun for bildesamlinginnhold. UI-språket styres av hovedspråkvelgeren i overskriften.",
    ...
    "settings.title": "Innstillinger for Oppgaveark",
    "size": "Størrelse:",
  ...
  "fi": {
    ...
    "subtraction.mode.find.subtrahend": "Etsi vähentäjä (kuvat - ? = tulos)",
    "subtraction.mode.image.number": "Kuva - Numero",
    "subtraction.mode.mixed": "Sekoitettu (Kuva-Numero + Etsi vähentäjä)",
