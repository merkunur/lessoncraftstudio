...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare bondegård-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med bondegårdtema. Førskole til 3. klasse. Gratis PDF. Hent nå.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Bondegård-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare bondegård-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Velg mellom 3 000+ bilder.',
      seoKeywords: 'gårdsoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, gårdsdyr, matproduksjon, husdyr, gårdsøvelser førskole, gårdens læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Bondegård-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare bondegård-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'gårdsoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, gårdsdyr, matproduksjon, husdyr, gårdsøvelser barnehage, gårdens læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Bondegård-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare bondegård-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'gårdsoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, gårdsdyr, matproduksjon, husdyr, gårdsøvelser 1. klasse, gårdens læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Bondegård-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare bondegård-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'gårdsoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, gårdsdyr, matproduksjon, husdyr, gårdsøvelser 2. klasse, gårdens læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Bondegård-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare bondegård-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'gårdsoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, gårdsdyr, matproduksjon, husdyr, gårdsøvelser 3. klasse, gårdens læring 8-9 år',
