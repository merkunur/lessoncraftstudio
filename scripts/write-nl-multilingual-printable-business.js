...
const filePath = path.join(__dirname, '..', 'frontend', 'config', 'guide-content', 'nl', 'multilingual-printable-business.ts');
...
const content: GuideContent = {
  ...
  nextSteps: [
    { slug: 'worksheets-multiple-languages', title: 'Werkbladen in Meerdere Talen Maken', description: 'Leer hoe je werkbladen produceert in meerdere talen met gedetailleerde instructies voor taalspecifieke aanpassingen en kwaliteitscontrole.' },
    { slug: 'scale-printable-business-guide', title: 'Printable Bedrijf Opschalen', description: 'Ontdek strategieën om je printable bedrijf op te schalen van een nevenactiviteit naar een volwaardig inkomen met geautomatiseerde workflows.' },
    { slug: 'complete-guide-printable-business', title: 'Complete Gids Printable Bedrijf', description: 'De uitgebreide gids die alle aspecten van het starten en laten groeien van een printable bedrijf behandelt van nul tot winstgevend.' },
  ],
  ...
  internalLinks: [
    ...
    { pageType: 'start', slug: 'create-multilingual-worksheets', anchorText: 'Meertalige werkbladen cre\u00ebren met geautomatiseerde generatoren' },
  ],
  ...
  toolsRecommended: [
    {
      ...
      description: 'Maak woordzoekerpuzzels in 11 talen \u2014 demonstreert hoe \u00e9\u00e9n enkele tool direct meertalige content produceert. Start een gratis proefversie met watermerk om de meertalige uitvoer in actie te zien.',
    },
    {
      appId: 'matching',
      title: 'Koppelwerkblad Generator',
      description: 'Bouw koppelwerkbladen met visuele thema\\'s die universeel werken over talen. Beeldgebaseerde content vertaalt natuurlijk over markten met minimale aanpassing. Start een gratis proefversie met watermerk.',
    },
    {
      appId: 'addition',
      title: 'Optelwerkblad Generator',
      description: 'Maak optelwerkbladen die taalbarri\u00e8res natuurlijk doorbreken omdat cijfers universeel zijn. Rekenproducten zijn ideale startpunten voor meertalige uitbreiding. Start een gratis proefversie met watermerk.',
    },
    {
      appId: 'crossword',
      title: 'Kruiswoordpuzzel Generator',
      description: 'Genereer kruiswoordpuzzels in meerdere talen met automatische woordplaatsing en aanwijzingen. Taalspecifieke puzzels zijn zeer gewild in onderbedeelde markten. Start een gratis proefversie met watermerk.',
    },
  ],
  ...
  visuals: {
    ...
    videoTitle: 'Hoe Meertalige Woordzoeker Werkbladen Maken voor Internationale Markten',
  },
