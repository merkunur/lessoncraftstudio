...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Un programme complet = un prix premium',
    description: 'Créez des packs curriculum complets pour un niveau scolaire entier. Le produit premium des imprimables. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour créer packs curriculum imprimables. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
  ...
  relatedPosts: [
    ...
    { slug: 'homeschool-printables-growing-market', title: 'Marché IEF' },
    { slug: 'worksheet-difficulty-levels-product-tiers', title: 'Niveaux de difficulté' },
  ],
  cta: {
