...
const appsMetadata: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  no: {
    title: '33 Utskriftsgeneratorer | Etsy & KDP-verkt\øy',
    description: 'Utforsk 33 profesjonelle utskriftsgeneratorer. Ords\øk, matteoppgaver, fargelegging, puslespill & mer. Pr\øv gratis med vannmerke. Selg p\å Etsy & Amazon KDP.',
    keywords: 'utskriftsgenerator, Etsy utskrifter, KDP oppgaver, selg utskrifter online, ords\økgenerator, oppgaveskaper, utskriftsvirksomhet',
  },
  fi: {
