...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur Dessiner et Colorier | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Dessiner et Colorier professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche dessiner et colorier avec modèle guidé',

    },
    sampleGallery: [
      { src: '/samples/english/draw and color/Draw and Color 1.jpeg', alt: 'Activité dessin guidé', caption: 'Dessiner et colorier' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Dessiner et Colorier thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur Dessiner et Colorier est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'draw-and-color', pageType: 'tool' as const, anchorText: 'Essayer Générateur Dessiner et Colorier Gratuit' },
