...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Hemmet',
  title: 'Gratis Hushåll-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara hushåll-övningar för barn. Matematik, målarbilder, ordspel och pussel med hushålltema. Förskola till årskurs 3. Gratis PDF. Skriv ut direkt.',
  keywords: 'hushållsövningar barn, hushålls arbetsblad, hushålls målarbilder, hushålls matematik, hushålls förskola, hushålls utskrivbar, hushålls pussel, hushålls räkning, hushålls korsord, hemmet övningar, hushållsföremål',
  heading: 'Hushållsövningar och Arbetsblad',
  ...
  gradeContent: {
    'preschool': {
      ...
      seoKeywords: 'hushållsövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, dagliga färdigheter, hushållssysslor, vardagsrutiner, hushållsuppgifter förskola, hushållets lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoKeywords: 'hushållsövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, dagliga färdigheter, hushållssysslor, vardagsrutiner, hushållsuppgifter förskoleklass, hushållets lärande 5–6 år',
    ...
    'first-grade': {
      ...
      seoDescription: 'Utskrivbara hushållsövningar för elever i årskurs 1 (6–7 år). Sortering, mätning och ordproblem med hushållstema. 33 generatorer. Gratis PDF. Gratis PDF.',
      seoKeywords: 'hushållsövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, dagliga färdigheter, hushållssysslor, vardagsrutiner, hushållsuppgifter årskurs 1, hushållets lärande 6–7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Hemmet-övningar Årskurs 2 | LessonCraftStudio',
      seoDescription: 'Utskrivbara hemövningar för elever i årskurs 2 (7–8 år). Budget, mätning, tidplanering och instruktionsskrivning. 33 generatorer. Gratis PDF. Gratis PDF.',
      seoKeywords: 'hushållsövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, dagliga färdigheter, hushållssysslor, vardagsrutiner, hushållsuppgifter årskurs 2, hushållets lärande 7–8 år',
    ...
    'third-grade': {
      ...
      seoDescription: 'Utskrivbara hemmet-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'hushållsövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, dagliga färdigheter, hushållssysslor, vardagsrutiner, hushållsuppgifter årskurs 3, hushållets lärande 8–9 år',
