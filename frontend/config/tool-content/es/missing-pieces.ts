...
const content: ToolContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: `La dificultad se controla con dos configuraciones independientes. El número de piezas faltantes (1–5) determina cuántos huecos se recortan de la imagen — más piezas significa más demanda de razonamiento espacial. El número de opciones de solución (2–6) determina cuántas opciones numeradas evalúan los usuarios — cuando las opciones exceden las piezas faltantes, las extras son piezas distractoras que requieren comparación visual cuidadosa. Un puzzle con 1 pieza faltante y 2 opciones es fácil; 5 piezas faltantes con 6 opciones incluyendo distractoras es genuinamente desafiante. Ajusta ambos ejes independientemente para crear niveles de dificultad precisos para cualquier grupo de edad.`,
    },
    {
