...
const content: AppContent = {
  seo: {
    primaryKeyword: 'criar e vender cartelas de bingo com imagens',
    secondaryKeywords: [
  ...
  keyFeatures: {
    ...
    features: [
      ...
      {
        title: 'Geração em Lote de 1 a 10 Cartelas de Bingo Únicas por Ficha',
        description:
      ...
      {
        title: 'Exportação ZIP em Lote de Todas as Cartelas Geradas como Ficheiros JPEG Individuais',
        description:
          'Exporte todas as cartelas de bingo geradas numa única descarga bingo_cards.zip. Cada cartela é guardada como um ficheiro JPEG individual de alta resolução dentro do arquivo ZIP, nomeado sequencialmente para organização fácil. Esta exportação em lote elimina o processo tedioso de descarregar cartelas uma por uma — gere 10 cartelas únicas, clique num botão e receba um conjunto completo de cartelas de bingo pronto para empacotar no seu produto do marketplace. A exportação ZIP utiliza JSZip para compressão fiável em todos os navegadores e funciona junto com os botões padrão de descarga individual em JPEG e PDF.',
      },
      {
        title: 'Duplo Modo de Preenchimento: Imagem ou Palavra para as Células e as Fichas Circulares',
        description:
          'As células da cartela e as fichas têm cada uma uma seleção de modo de preenchimento independente — Imagem ou Palavra. O preenchimento de imagens apresenta ilustrações temáticas nas células ou como padrões de fichas circulares. O preenchimento de palavras apresenta os nomes localizados das imagens como texto. Misture os modos para variedade criativa: cartelas com imagens e fichas com palavras criam um desafio de associação visual-textual, enquanto cartelas com palavras e fichas com imagens invertem a dinâmica. As fichas circulares apresentam bordas tracejadas (#666, strokeDashArray [5,5]) e são embaralhadas pelo algoritmo Fisher-Yates, garantindo que nunca espelhem o layout da grade. Este sistema de duplo preenchimento produz quatro estilos de cartelas de bingo distintos a partir de um só gerador.',
      },
      {
        title: 'Folha de Chamada Dedicada com Grade Dinâmica de Palavras para o Chamador',
        description:
          'Cada conjunto de cartelas de bingo inclui uma folha de chamada complementar num separador à parte. A folha de chamada apresenta uma grade dinâmica de todas as palavras únicas do banco de imagens — o chamador lê-as em voz alta enquanto os jogadores marcam as suas cartelas. As colunas são calculadas com base no comprimento da palavra mais longa (2 a 6 colunas) com um tamanho de fonte uniforme em todas as entradas para legibilidade clara. A grade é centrada na página e herda as bordas e o fundo do canvas. Ative a seleção personalizada de chamada para escolher manualmente as imagens específicas para o banco de chamada, com um contador em tempo real que mostra o número de elementos selecionados.',
      },
      {
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Cartela de bingo com imagens temáticas numa grade e fichas circulares com bordas tracejadas abaixo',
    },
    sampleGallery: [
      {
        src: '/samples/portuguese/bingo/Bingo de Imagenes 2.webp',
        alt: 'Cartela de bingo com preenchimento de imagens mostrando ilustrações temáticas coloridas nas células e fichas circulares com imagens',
        caption: 'Modo preenchimento de imagens — ilustrações coloridas nas células e nas fichas circulares',
      },
      {
        src: '/samples/portuguese/bingo/Bingo de Imagenes 3.webp',
        alt: 'Cartela de bingo com preenchimento de palavras mostrando nomes localizados de imagens nas células e fichas com palavras',
