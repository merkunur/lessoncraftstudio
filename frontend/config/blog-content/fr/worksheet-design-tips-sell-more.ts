...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Un meilleur design = plus de ventes',
    description: 'Améliorez le design de vos fiches pour augmenter vos ventes. Astuces de mise en page et d\'attrait visuel. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour conseils design fiches vendre plus. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
  ...
  relatedPosts: [
    ...
    { slug: 'worksheet-quality-vs-quantity-etsy', title: 'Qualité vs quantité' },
  ],
  cta: {
