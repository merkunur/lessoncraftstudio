...
const content: BlogContent = {
  ...
  keyTakeaways: [
    'Dinosaurier sind eine Premium-Evergreen-Nische mit leidenschaftlichen Fans',
    'MINT-Premium-Faktor erlaubt 20-30% hoehere Preise',
    'Dino-Mega-Bundles (50-80 Seiten) sind Flaggschiff-Produkte',
    'KDP-Dino-Buecher sind ganzjaehrige Geschenk-Bestseller',
    'Als eigenstaendiges Geschaeft mit 25+ Listings profitabel'
  ,],
  faq: [
    {
      question: 'Wie profitabel sind Dinosaurier-Druckvorlagen?',
  ...
  relatedPosts: [
    ...
    { slug: 'weltraum-themen-arbeitsblaetter-geschaeft', title: 'Weltraum-Arbeitsblaetter: MINT-Premium' },
    { slug: 'druckbare-spiele-geburtstagsfeiern', title: 'Druckbare Partyspiele' },
  ],
  cta: {
    heading: 'Dinosaurier-Druckvorlagen erstellen',
