...
const content: GuideContent = {
  ...
  tutorial: [
    ...
    },
    {
      ...
      content: 'Tematiske mønsterarbejdsark outsælger konsekvent generiske abstrakt-form arbejdsark på enhver markedsplads. Forældre og sælgere søger aktivt efter termer som "animal pattern worksheets" eller "dinosaur pattern activities" fordi tematiske visuelle elementer gør læring mere engagerende for børn.\n\nMønsterarbejdsark-makeren inkluderer et søgbart billedbibliotek organiseret efter kategori. Med kommerciel licens får du adgang til tematiske billedsæt. Full Access-licensen låser op for over 100 tematiske billedsæt der dækker dyr, mad, køretøjer, natur, ferier, erhverv, sport og dusinvis af flere kategorier.\n\nBrug temavælgeren eller søgefeltet til at gennemse tilgængelige temaer. Når det er valgt bruger generatoren billeder fra det tema til mønsterøvelserne. Et "bondegårdsdyr"-tema generator mønstre med køer, grise, kyllinger og heste. Et "havdyr"-tema bruger fisk, blæksprutte, søstjerne og hval.\n\nEn unik funktion ved mønsterarbejdsark-makeren er per-puslespil tema-tildeling. Hver øvelse på siden kan bruge et andet tema. Puslespil 1 kunne vise et AB-mønster af bondegårdsdyr mens puslespil 2 viser et ABC-mønster af køretøjer på den samme side. Dette generator visuelt varierede arbejdsark der holder børns opmærksomhed længere.\n\nAlternativt, anvend ét enkelt tema til alle puslespil på siden for en sammenhængende produktidentitet. Et "Dinosaur mønsterøvelse"-arbejdsark med alle-dinosaurer øvelser generator et mere målrettet produkt for specifikke søgetermer.\n\nTemavalg er en strategisk produktbeslutning. Hvert tema generator et distinkt produkt du kan liste separat. Ti temaer ved det samme sværhedsniveau giver dig ti unikke produkter fra den samme generatorsession.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Ja. Mønsterarbejdsark-makeren understøtter per-puslespil tema-tildeling. Hver øvelse på siden kan bruge et andet tema fra billedbiblioteket, eller du kan anvende ét tema til alle øvelser for et sammenhængende look. Per-puslespil tematik generator visuelt varierede arbejdsark der holder børns opmærksomhed, mens enkelttema-sider generator målrettede produkter for specifikke søgetermer.',
    },
    {
      question: 'Kan jeg sælge de mønsterarbejdsark jeg generator på Etsy og Amazon KDP?',
  ...
  nextSteps: [
    {
      ...
      description: 'Matchingaktiviteter parrer naturligt med mønstergenkendelse. Begge udvikler visuelle diskriminationsfærdigheder, og at pakke dem sammen generator omfattende visuelle læringsprodukter.',
    },
    {
    ...
    },
    {
      ...
      description: 'Udvid dit visuelle lærings-katalog med tematiske farvelægningssider. Farvelægningsaktiviteter komplementerer mønsterarbejdsark for yngre børn og generator alsidige pakker.',
    },
  ],
  ...
  visuals: {
    heroImage: { src: '/samples/danish/pattern%20worksheet/mønstergåder-1.webp', alt: 'Mønstergenkendelsesarbejdsark med tematiske billeder der viser visuelle mønsterfuldførelsesøvelser til børn' },
    samples: [
      { src: '/samples/danish/pattern%20worksheet/mønstergåder-1.webp', alt: 'Mønstergåder — dansk eksempelarbejdsark', caption: 'Mønstergåder eksempel 1' },
      { src: '/samples/danish/pattern%20worksheet/mønstergåder-2.webp', alt: 'Mønstergåder — dansk eksempel 2', caption: 'Mønstergåder eksempel 2' },
      { src: '/samples/danish/pattern%20worksheet/mønstergåder-3.webp', alt: 'Mønstergåder — dansk eksempel 3', caption: 'Mønstergåder eksempel 3' },
    ],
    youtubeId: 'W94X5_RA3ug',
    videoTitle: 'Sådan generator du mønstergenkendelsesarbejdsark — Komplet vejledning',
  },
