...
const content: AppContent = {
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'generador-fichas-patrones',
      anchorText: 'Creador de Fichas de Patrones',
    },
    {
      pageType: 'start',
