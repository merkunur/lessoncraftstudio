...
const content: ToolContent = {
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      { src: '/samples/finnish/sudoku/Kuva-Sudoku%201%20answer_key.webp', alt: 'Kuvasudokun vastausavain nayttaen tayden 4x4-ruudukon kaikki 16 solua oikein taytettyna', caption: 'Automaattisesti generoitu vastausavain — taysi ruudukko kaikki kuvat oikein sijoitettuina' },
    ],
