...
export const startPageSlugs: StartSlugConfig[] = [
  { startId: 'complete-guide-printable-business', slugs: { en: 'complete-guide-printable-business', de: 'komplettanleitung-druckvorlagen-geschaeft', fr: 'guide-complet-activite-imprimables', es: 'guia-completa-negocio-imprimibles', pt: 'guia-completo-negocio-imprimiveis', it: 'guida-completa-attivita-stampabili', nl: 'complete-gids-printable-bedrijf', sv: 'komplett-guide-utskriftsbart-foretagande' } },
  { startId: 'create-worksheets-that-sell', slugs: { en: 'create-worksheets-that-sell', de: 'arbeitsblaetter-erstellen-die-verkaufen', fr: 'creer-fiches-qui-se-vendent', es: 'crear-fichas-que-se-venden', pt: 'criar-fichas-que-vendem', it: 'creare-schede-che-vendono', nl: 'werkbladen-maken-die-verkopen', sv: 'skapa-arbetsblad-som-saljer' } },
  { startId: 'printable-business-blueprint', slugs: { en: 'printable-business-blueprint', de: 'druckvorlagen-geschaeft-bauplan', fr: 'plan-activite-imprimables', es: 'plan-negocio-imprimibles', pt: 'plano-negocio-imprimiveis', it: 'piano-attivita-stampabili', nl: 'blauwdruk-printable-bedrijf', sv: 'ritning-utskriftsbart-foretag' } },
  ...
  { startId: 'amazon-kdp-activity-books', slugs: { en: 'amazon-kdp-activity-books', de: 'amazon-kdp-aktivitaetsbuecher', fr: 'livres-activites-amazon-kdp', es: 'libros-actividades-amazon-kdp', pt: 'livros-atividades-amazon-kdp', it: 'libri-attivita-amazon-kdp', nl: 'amazon-kdp-activiteitenboeken', sv: 'amazon-kdp-aktivitetsbocker' } },
  ...
  { startId: 'commercial-license-guide', slugs: { en: 'commercial-license-guide', de: 'kommerzielle-lizenz-leitfaden', fr: 'guide-licence-commerciale', es: 'guia-licencia-comercial', pt: 'guia-licenca-comercial', it: 'guida-licenza-commerciale', nl: 'commerciele-licentie-gids', sv: 'kommersiell-licens-guide' } },
  { startId: 'printable-business-income', slugs: { en: 'printable-business-income', de: 'druckvorlagen-geschaeft-einkommen', fr: 'revenus-activite-imprimables', es: 'ingresos-negocio-imprimibles', pt: 'rendimentos-negocio-imprimiveis', it: 'reddito-attivita-stampabili', nl: 'printable-bedrijf-inkomen', sv: 'utskriftsbart-foretag-inkomst' } },
