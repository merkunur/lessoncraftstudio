...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Insekter',
  title: 'Gratis Insekter-opgaver til Børn | LessonCraftStudio',
  description: 'Printbare insekter-opgaver til børn. Matematik, farvelægning, ordspil og puslespil med insektertema. Førskole til 3. klasse. Gratis PDF.',
  keywords: 'insektopgaver til børn, insekt arbejdsark, insekt farvelægning, insekt matematik, insekt førskole, insekt printbar, sommerfugle opgaver, insekt puslespil, småkryb til børn, insekt ordopgaver, insekter i naturen',
  heading: 'Insekt-opgaver og Øvelser',
