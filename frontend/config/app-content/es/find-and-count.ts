...
const content: AppContent = {
  seo: {
    primaryKeyword: 'generador de fichas busca y encuentra',
    secondaryKeywords: [
    ...
    steps: [
      {
        ...
        description:
          'Abre el panel de Configuración de Página y elige un tamaño: Predeterminado (800×1000), Carta, A4, Cuadrado (1200×1200) o cualquier dimensión personalizada. Configura la densidad de la cuadrícula con filas (5–10) y columnas (5–10) — el valor predeterminado es 6×6. Elige un color de página con el selector de color, selecciona un tema de fondo y ajusta su opacidad, luego elige un tema de borde con su propio control de opacidad independiente. Estas opciones de diseño enmarcan tu ficha yo espío antes de añadir contenido.',
      },
      {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'El modo Identificación de Letras muestra una cuadrícula de alfabeto adaptada al conjunto de caracteres de cada idioma. El inglés muestra A–Z (26 letras), el alemán añade Ä, Ö y Ü (29 letras), el español añade Ñ (27 letras), el sueco y finlandés añaden Å, Ä y Ö (29 letras), y el danés y noruego añaden Æ, Ø y Å (29 letras). La cuadrícula se muestra en 7 columnas con ajuste automático de filas. Cuando seleccionas una letra, el generador muestra imágenes que empiezan con esa letra en el idioma seleccionado y rellena las celdas restantes con distractores.',
    },
    {
      question: '¿Cómo funcionan las etiquetas de nombres de imágenes localizadas?',
      answer:
        'El Generador de Busca y Encuentra es sensible al idioma. Las etiquetas de nombres de imágenes se muestran en el idioma seleccionado a través del sistema de Vocabulario de Imágenes (image-vocabulary.js). Por ejemplo, una imagen de gato muestra «Cat» en inglés, «Katze» en alemán, «Chat» en francés y «Gato» en español. En el modo Identificación de Letras, las primeras letras también cambian con el idioma — un gato empieza con «C» en inglés pero con «K» en alemán y «G» en español. El nivel Comercial soporta solo inglés; el Acceso Completo desbloquea los 11 idiomas.',
    },
    {
