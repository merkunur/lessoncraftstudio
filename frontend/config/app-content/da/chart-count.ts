...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Tælleopgaver-generator | LessonCraftStudio',
    metaDescription: 'Lav tælle- og diagramopgaver med temabilleder. Automatisk facit, printklare PDF\'er. Prøv gratis.',
  },

  hero: {
    title: 'Tælleopgaver-generator — Lav printables at sælge på Etsy og KDP',
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'billeddiagram-arbejdsark-skaber',
