...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Twee platforms met fundamenteel verschillende benaderingen',
    description: 'Twee platforms met fundamenteel verschillende benaderingen. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
