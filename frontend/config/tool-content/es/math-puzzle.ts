...
const content: ToolContent = {
  seo: {
    ...
    secondaryKeywords: [
      'crear rompecabezas de matemáticas imprimibles',
      'generador de fichas puzzle de matemáticas para vender',
      'rompecabezas matemáticos imprimibles uso comercial',
      'puzzle matemático tipo rompecabezas para KDP',
    ],
    lsiKeywords: [
      'fichas de cuadrícula matemática con imágenes para Etsy',
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Usa los controles de Filas y Columnas para definir la cuadrícula del puzzle. Las filas van de 2 a 4 y las columnas de 2 a 4. Una cuadrícula de 2×2 produce 4 piezas (más fácil), 3×3 genera 9 piezas (intermedio) y 4×4 produce 16 piezas (más difícil). Experimenta con 2×3 o 3×4 para niveles de dificultad intermedios.',
      },
      {
        title: 'Elegir la Operación Matemática',
        description: 'Selecciona el modo de operación: Suma (cada celda muestra una ecuación de suma), Resta (cada celda muestra una ecuación de resta) o Suma y Resta (ambas operaciones mezcladas aleatoriamente en la cuadrícula). El modo mixto es ideal para fichas de repaso y crea la mayor variedad en un solo puzzle.',
      },
      {
      ...
      },
      {
        ...
        description: 'Activa el interruptor de Escala de Grises para convertir la imagen del puzzle a blanco y negro. Esto produce fichas con ahorro de tinta que cuestan menos de imprimir en grandes cantidades y funcionan bien para cuadernos KDP donde la impresión a color aumenta el precio de venta. El modo a color es mejor para productos digitales y listings de Etsy donde las imágenes vibrantes atraen clics.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Genera de 50 a 100 páginas de puzzles en los tres modos de operación y múltiples tamaños de cuadrícula. Exporta como PDF de alta resolución y publica como cuaderno de actividades low-content en Amazon KDP. Usa el modo escala de grises para mantener bajos los costes de impresión. Estructura los capítulos por dificultad: cuadrículas 2×2 para calentamiento, 3×3 para la sección principal y 4×4 para páginas de desafío.',
    },
    {
  ...
  businessIdeas: [
    ...
    },
    {
      ...
      description: 'El formato rompecabezas crea pines llamativos que generan clics — una imagen colorida dividida en piezas numeradas es reconocible al instante. Ofrece un muestrario gratuito con marca de agua de 5 páginas en Pinterest, recopila direcciones de correo electrónico y luego ofrece tus packs temáticos completos y cuadernos KDP. Las imágenes de puzzles consiguen significativamente más guardados que las vistas previas de fichas simples.',
      platform: 'Pinterest',
    },
    {
      title: 'Vendedor Multilingüe de Puzzles Matemáticos',
      description: 'Los puzzles matemáticos usan solo imágenes, números y ecuaciones — no requieren texto. Un mismo PDF de puzzle funciona de forma idéntica en todos los idiomas. Publica el mismo producto en Etsy Alemania, Francia, España, Italia y cualquier otro mercado sin traducción. La mayoría de competidores solo atienden a compradores de habla inglesa, lo que te da una ventaja de mercado de 5 a 10 veces. Crear puzzles matemáticos en alemán, francés y español abre oportunidades en marketplaces internacionales donde los vendedores angloparlantes tienen presencia mínima. La naturaleza visual de los rompecabezas significa que requieren mínima traducción de texto, haciendo la expansión multilingüe más rápida y rentable que los productos educativos con mucho texto.',
      platform: 'Etsy',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Puedes configurar las filas de 2 a 4 y las columnas de 2 a 4, produciendo cuadrículas desde 2×2 (4 piezas) hasta 4×4 (16 piezas). Las configuraciones habituales incluyen 2×2 (más fácil, 4 piezas), 2×3 o 3×2 (6 piezas), 3×3 (9 piezas, intermedio), 3×4 o 4×3 (12 piezas) y 4×4 (16 piezas, más difícil).',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sí. Los puzzles matemáticos usan solo imágenes, números y ecuaciones — sin texto. Los puzzles que crees funcionan de forma idéntica en todos los idiomas. Puedes vender el mismo producto a compradores de cualquier país sin traducción, multiplicando al instante tu mercado potencial.',
    },
    {
      question: '¿En qué formatos de archivo puedo descargar?',
      answer: 'Puedes descargar los puzzles como imágenes JPEG de alta resolución o archivos PDF optimizados para impresión. Tanto la ficha del puzzle como su clave de respuestas están disponibles en ambos formatos. Los PDF son ideales para impresión directa; los JPEG son perfectos para crear maquetas de productos y publicaciones en redes sociales.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'rompecabezas-matematicos-fichas', anchorText: 'Rompecabezas Matemáticos — Detalles Completos del Producto' },
