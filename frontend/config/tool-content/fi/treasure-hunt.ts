...
const content: ToolContent = {
  ...
  visuals: {
    heroImages: { primary: '/samples/finnish/treasure%20hunt/aarteenetsintä-1.webp', primaryAlt: 'Aarteenetsintae polunetsintaetehtava 5x5-koordinaattiruudukolla, 6 hajautetulla teemakuvalla maamerkkeinaeae, suuntavihjeilla ja aarteenetsintae-teemaisella teal-otsikolla kultaisella otsikolla' },
    sampleGallery: [
      { src: '/samples/finnish/treasure%20hunt/aarteenetsintä-1.webp', alt: 'Aarteenetsintaepalapelitehtava kardinaalisuuntavihjeilla pohjoinen etela ita lansi 5x5-koordinaattiruudukossa', caption: 'Kardinaalitila — kompassisuunnat edentyneeseen avaruudelliseen paeaettelyyn ja kartanlukutaitoihin' },
      { src: '/samples/finnish/treasure%20hunt/aarteenetsintä-1-answer-key.webp', alt: 'Aarteenetsinnaevaen vastausavain viimeisella aarresolulla korostettuna vaaleankeltaisella 5x5-koordinaattiruudukossa', caption: 'Automaattisesti generoitu vastausavain — vaaleankeltainen korostus merkitsee aarteen maaeraenpaen itsetarkistukseen' },
    ],
