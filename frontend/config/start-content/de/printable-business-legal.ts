...
const content: StartContent = {
  ...
  toolsRecommended: [
    {
      ...
      description: 'Erstellung lehrreicher Arbeitsblätter, bei denen die kommerzielle Lizenz die Ausgabe auf allen Marktplätzen legal verkaufbar macht. Die Lizenz ist eine absetzbare Betriebsausgabe, die direkt mit der Umsatzgenerierung Ihres Druckvorlagen-Geschäfts verbunden ist.',
    },
    {
  ...
  visuals: {
    ...
    samples: [
      ...
      { src: '/samples/german/math%20puzzle/mathe-rätsel-1.webp', alt: 'Mathe-Arbeitsblatt als Beispiel für zeitlose kommerzielle Produktgenerierung', caption: 'Mathe — Zeitlose kommerzielle Produktgenerierung' },
    ],
