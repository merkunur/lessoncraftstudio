...
const content: BlogContent = {
  ...
  keyTakeaways: [
    'Find-og-Tæl Printables er en profitabel niche for danske sælgere',
  ...
  cta: {
    heading: 'Kom I Gang Med Find-og-Tæl Printables',
