...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Summer',
  title: 'Summer Worksheets & Activities for Kids | LessonCraftStudio',
  description: 'Explore summer worksheets for kids: sunshine, beach, ice cream, and outdoor play. Free printable activities for preschool to 3rd grade. Learn all summer long.',
  keywords: 'summer coloring pages for kids, beach worksheets for kindergarten, summer vacation activities printable, ice cream worksheets for kids, summer math worksheets printable, summer vocabulary for kindergarten, pool and water activities printable, summer sorting worksheets for kids, summer themed puzzles for kids, summer learning activities printable',
  heading: 'Summer Season Worksheets and Activities',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Summer Preschool Worksheets \u2014 Splash & Count | LCS',
      seoDescription: 'Free printable summer worksheets for preschool (ages 3-4). Count ice cream scoops and shells, trace sunny words, color beach scenes, and match pool pairs.',
      seoKeywords: 'preschool summer ice cream scoop shell counting worksheets one to ten objects ages 3-4, trace sun beach vocabulary words worksheets bold dotted letter formation preschool free, color beach scene worksheets thick outlines fine motor preschool printable, match summer pool swimsuit pairs worksheets visual discrimination preschool pages, summer AB pattern sandcastle wave sequence worksheets repeating recognition preschool activities',
    ...
    'kindergarten': {
      seoTitle: 'Summer Kindergarten Worksheets \u2014 Add & Explore | LCS',
      seoDescription: 'Free printable summer worksheets for kindergarten (ages 5-6). Add seashell groups, search vacation words, sort pool items by size, and extend wave patterns.',
      seoKeywords: 'kindergarten summer seashell addition worksheets number sentences within 10 ages 5-6, vacation tropical vocabulary word search worksheets letter scanning kindergarten free, sort summer pool item size category worksheets classification skills kindergarten printable, extend wave sandcastle pattern sequence worksheets ABC AABB kindergarten pages, summer beach scene find and count worksheets observation accuracy kindergarten activities',
    ...
    'first-grade': {
      seoTitle: 'Summer First Grade Worksheets \u2014 Solve & Decode | LCS',
      seoDescription: 'Free printable summer worksheets for first grade (ages 6-7). Solve beach word problems, decode ocean cryptograms, write vacation stories, and spot odd items.',
      seoKeywords: 'first grade summer beach word problem worksheets addition subtraction within 20 ages 6-7, ocean cryptogram code decode worksheets symbol letter deduction first grade free, write summer vacation descriptive paragraph worksheets seasonal vocabulary first grade printable, summer odd one out beach detail worksheets visual analysis first grade pages, summer cause effect sun heat scenario worksheets logical reasoning first grade activities',
    ...
    'second-grade': {
      seoTitle: 'Summer Second Grade Worksheets \u2014 Budget & Journal | LCS',
      seoDescription: 'Free printable summer worksheets for second grade (ages 7-8). Calculate trip costs, graph daily temperatures, write travel journal entries, and compare facts.',
      seoKeywords: 'second grade summer vacation cost calculation worksheets addition subtraction money ages 7-8, graph daily temperature observation data worksheets bar chart creation second grade free, summer travel journal descriptive entry worksheets sensory detail paragraphs second grade printable, compare summer habitat ocean meadow fact evidence worksheets informational reading second grade pages, summer elapsed time schedule calculation worksheets hour minute planning second grade activities',
    ...
    'third-grade': {
      seoTitle: 'Summer Third Grade Worksheets \u2014 Multiply & Plan | LCS',
      seoDescription: 'Free printable summer worksheets for third grade (ages 8-9). Multiply camp budgets, analyze heat fractions, write adventure narratives, and chart weather data.',
      seoKeywords: 'third grade summer camp budget multiplication worksheets multi-step calculation ages 8-9, temperature fraction weekly analysis worksheets part whole reasoning third grade free, summer adventure narrative story writing worksheets vivid detail paragraphs third grade printable, weather data comparison line plot worksheets graph analysis third grade pages, pool patio area perimeter worksheets spacing geometry design third grade activities',
