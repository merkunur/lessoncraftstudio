...
const content: AppContent = {
  seo: {
    primaryKeyword: 'atividades de sequência para imprimir',
    secondaryKeywords: [
      'sequência lógica atividade',
      'completar a sequência exercício',
      'padrões para completar',
      'sequência educação infantil',
    ],
    lsiKeywords: [
      'AB',
      'ABC',
  ...
  ctaHeading: 'Crie atividades de sequência',
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Cinco tipos de padrões cobrem todo o espetro de complexidade de sequências repetitivas. AB alterna dois elementos no padrão mais simples possível. AAB e ABB introduzem agrupamentos assimétricos onde um elemento aparece duas vezes antes ou depois do outro. ABC rota três elementos diferentes, obrigando os usuários a acompanhar uma unidade de repetição mais longa. AABB emparelha dois de cada elemento num ciclo alargado. Esta progressão cria uma escala de dificuldade natural desde a alternância simples no pré-escolar até sequências avançadas de múltiplos elementos — oferecendo aos vendedores um eixo de diferenciação integrado para pacotes de produtos por níveis.',
      },
      {
        title: 'Número de pistas ajustável de 4 a 10 para controlo de dificuldade',
        description:
          'O controlo do número de pistas determina quantas das 11 posições de vagões mostram imagens face à única posição em branco. Os 3 primeiros vagões são sempre revelados, estabelecendo a base do padrão. Com 10 pistas, apenas um vagão está em branco entre 10 elementos visíveis — o padrão é muito evidente. Com 4 pistas, os usuários veem informação mínima e devem raciocinar cuidadosamente para identificar a sequência a partir de dados limitados. Esta única definição cria uma ampla gama de dificuldade a partir de cada tipo de padrão, multiplicando efetivamente a variedade dos seus produtos: um padrão AB com 10 pistas é ideal para principiantes, enquanto um padrão ABC com 4 pistas desafia os usuários avançados.',
      },
      {
  ...
  faq: [
    {
      ...
      answer:
        'AB alterna dois elementos (A-B-A-B) para o padrão repetitivo mais simples. AAB agrupa dois de um elemento seguido de um de outro (A-A-B-A-A-B). ABB inverte esse agrupamento (A-B-B-A-B-B). ABC rota três elementos diferentes (A-B-C-A-B-C), obrigando os usuários a acompanhar uma unidade de repetição mais longa. AABB emparelha dois de cada elemento (A-A-B-B-A-A-B-B) num ciclo alargado. A progressão de AB a AABB cria uma escala de dificuldade natural desde a alternância simples de dois elementos até sequências complexas de múltiplos elementos.',
    },
    {
      question: 'Como é que o número de pistas controla a dificuldade?',
      answer:
        'O número de pistas determina quantos dos 11 vagões do trem mostram imagens. Os 3 primeiros vagões são sempre visíveis para estabelecer o padrão. Com 10 pistas, apenas um vagão está em branco entre 10 preenchidos — o padrão é muito evidente. Com 4 pistas, os usuários veem informação mínima e devem raciocinar cuidadosamente para identificar a sequência. Esta única definição transforma qualquer tipo de padrão de um exercício simples num verdadeiro desafio de raciocínio, multiplicando efetivamente a variedade de produtos a partir de cada tipo de padrão.',
    },
    {
