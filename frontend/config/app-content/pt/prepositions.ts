...
const content: AppContent = {
  seo: {
    primaryKeyword: 'atividade de localização espacial para imprimir',
    secondaryKeywords: [
      'preposições de lugar atividade',
      'noções espaciais atividade',
      'em cima embaixo ao lado atividade',
      'orientação espacial educação infantil',
    ],
    lsiKeywords: [
      'em cima',
      'embaixo',
  ...
  keyFeatures: {
    ...
    features: [
      ...
      {
        title: 'Número de exercícios configurável de 1 a 8 por atividade',
        description:
      ...
      },
      {
        ...
        description:
          'Explore uma biblioteca de mais de 3100 ilustrações de alta resolução organizadas em 104 temas: animais, veículos, alimentos, festividades, desportos, espaço, natureza e muito mais. Cada tema fornece imagens de objetos posicionados em relação a uma das 8 formas geométricas. Também pode carregar as suas próprias imagens personalizadas para atividades com a sua marca. A combinação de objetos temáticos e formas geométricas cria milhares de permutações de exercícios únicos — variedade suficiente para anos de criação de produtos.',
      },
      {
        title: 'Geração automática de gabarito',
        description:
          'Clique num botão para gerar um gabarito completo que reproduz o layout da sua atividade com cada preposição correta preenchida. Para os exercícios de Preencher a Lacuna, o gabarito mostra a frase completa. Para Escolha Múltipla, destaca a imagem correta. Exporte o gabarito como arquivo JPEG ou PDF separado, ideal para edições do vendedor, guias para pais ou pacotes de produtos na Etsy sem qualquer trabalho manual.',
      },
      {
      ...
      },
      {
        ...
        description:
          'O canvas Fabric.js integrado permite-lhe arrastar, redimensionar, rodar e reposicionar cada elemento da página — texto, blocos de exercícios, imagens, formas, bordas e fundos. Use os controlos de camadas para gerir o empilhamento de elementos, as ferramentas de alinhamento para colocação precisa ao píxel, e o bloqueio para proteger elementos posicionados enquanto edita outros. Desfazer e refazer até 50 passos permitem-lhe experimentar livremente, oferecendo a flexibilidade de uma ferramenta de design gráfico dentro de um gerador de atividades de vocabulário espacial.',
      },
    ],
  },

  businessUseCases: {
    title: 'Como Vender Atividades de Preposições Online',
    cases: [
      {
        title: 'Pacotes temáticos de atividades de preposições na Etsy',
        description:
          'Crie conjuntos de 10 a 20 atividades de preposições agrupadas por tema — animais da quinta, criaturas marinhas, veículos, alimentos — e ofereça-os como download instantâneo na Etsy. Alterne exercícios de Preencher a Lacuna e Escolha Múltipla dentro de cada pacote para maior variedade. Inclua os gabaritos como arquivos extra. O formato de imagens e formas é visualmente distinto e destaca-se nos resultados de pesquisa da Etsy face às atividades de gramática clássicas em texto simples. Defina o preço de pacotes temáticos individuais entre $3–$5 e mega-pacotes multi-tema entre $12–$18.',
        platform: 'Etsy (etsy.com)',
      },
      {
        title: 'Livros de atividades de vocabulário espacial na Amazon KDP',
        description:
          'Compile de 50 a 100 atividades de preposições num livro de atividades impresso em formato Amazon KDP. Use dificuldade progressiva, começando com duas preposições (em, em cima de) e um único exercício por página, e depois introduza gradualmente as oito preposições com páginas densas de oito exercícios. Alterne secções de Preencher a Lacuna e Escolha Múltipla para prática variada. Adicione uma capa, um quadro de referência de preposições e uma secção de gabaritos no final. Os livros de vocabulário espacial para crianças dos 4 aos 8 anos ocupam um nicho com menos concorrência do que os livros de gramática genéricos.',
        platform: 'Amazon KDP (kdp.amazon.com)',
      },
      {
        title: 'Centros de linguagem diferenciados para Hotmart',
        description:
  ...
  faq: [
    {
      question: 'Que modos de exercício oferece o Gerador de Atividades de Preposições?',
      answer:
    ...
    },
    {
      ...
      answer:
        'O gerador suporta oito preposições espaciais: em/dentro de, em cima de, debaixo de, ao lado de, atrás de, entre, acima de e à frente de. Seleciona quais incluir a partir de uma lista, podendo usar as oito para uma revisão completa ou reduzir a seleção a duas ou três para prática direcionada. Os vendedores que criam pacotes de atividades separados para cada par de preposições podem construir um catálogo mais amplo a partir da mesma ferramenta, oferecendo aos compradores opções de prática focada enquanto aumentam o número total de listagens na sua loja.',
    },
    {
    ...
    {
      question: 'Quantos exercícios posso colocar em cada atividade?',
      answer:
        'Pode definir de 1 a 8 exercícios por atividade. Menos exercícios criam páginas mais simples e menos carregadas, ideais para usuários mais novos ou prática focada. Mais exercícios maximizam a densidade de prática para sessões de revisão, avaliações ou trabalhos de casa. Variar o número de exercícios nas suas listagens também o ajuda a criar níveis de preços distintos — uma atividade introdutória de um único exercício como ponto de entrada económico e um pacote de revisão completo de oito exercícios a um preço premium.',
    },
    {
      question: 'O Gerador de Atividades de Preposições depende do idioma?',
      answer:
        'Sim. Ao contrário das aplicações de matemática puramente visuais, as atividades de preposições mudam fundamentalmente conforme o idioma selecionado. Cada idioma tem as suas próprias preposições, regras de artigos e estruturas gramaticais. O alemão usa contrações dativas (\"im\", \"am\") e artigos de género (dem/der). O francês aplica a elisão (\"l\'\" antes de vogais). O português usa artigos com género (o/a) e contrações preposicionais como \"no\", \"na\", \"do\", \"da\". Cada frase gerada é gramaticalmente correta — não uma tradução palavra por palavra. A Licença Comercial é apenas em inglês; o Acesso Completo desbloqueia os 11 idiomas.',
    },
    {
      question: 'Como funciona a gestão gramatical nos diferentes idiomas?',
      answer:
        'O gerador integra um motor gramatical para cada um dos 11 idiomas suportados. Procura o artigo correto conforme o género do substantivo (importante para o alemão, francês, espanhol, português e italiano), aplica as regras do dativo para as preposições alemãs, gere a elisão francesa onde os artigos se contraem antes de vogais ou h mudo, e usa as formas plurais corretas para os nomes das formas. O resultado são frases fluidas em cada idioma, não traduções literais forçadas.',
    },
    {
      question: 'Como funciona a lista de preposições?',
      answer:
        'O painel de Lista de Preposições permite-lhe ativar ou desativar cada uma das oito preposições. Apenas as preposições marcadas aparecem nos exercícios gerados. Isto dá-lhe um controlo preciso sobre o conteúdo da lição — marque apenas \"em\" e \"em cima de\" para uma atividade introdutória, ou marque as oito para uma revisão completa. A lista reinicia-se cada vez que gera uma nova atividade.',
    },
    {
      question: 'O gerador cria gabaritos automaticamente?',
      answer:
        'Sim. Clique no botão Gerar Gabarito para criar uma versão resolvida da sua atividade. Para os exercícios de Preencher a Lacuna, o gabarito mostra cada espaço em branco preenchido com a preposição correta. Para Escolha Múltipla, indica a imagem correta. Exporte o gabarito como arquivo JPEG ou PDF separado junto com a atividade do usuário.',
    },
    {
      question: 'Existe um teste grátis?',
      answer:
        'Sim. Pode aceder a todas as funcionalidades — ambos os modos de exercício, as oito preposições, a biblioteca completa de imagens, todas as formas, a geração de gabaritos e todos os formatos de exportação — sem criar uma conta, inserir cartão de crédito ou instalar qualquer software. Os downloads do teste grátis incluem uma pequena marca d\'água. Uma licença comercial remove a marca d\'água e concede direitos completos de venda.',
    },
    {
      question: 'O que inclui a licença comercial?',
      answer:
        'A Licença Comercial oferece exportações em inglês sem marca d\'água com direitos completos de venda. A licença Acesso Completo adiciona os 11 idiomas com preposições, artigos e regras gramaticais corretas, multiplicando o seu catálogo de produtos. Ambos os níveis concedem direitos ilimitados para vender na Hotmart, Etsy, Amazon KDP, no seu próprio site ou em qualquer outra plataforma — sem royalties por venda, sem taxas mensais e sem limites de produção.',
    },
    {
      question: 'Posso vender atividades criadas com esta ferramenta na Etsy e Amazon KDP?',
      answer:
        'Sim. Com uma licença comercial, tem todos os direitos para vender as suas atividades de preposições como downloads digitais na Etsy, como livros de atividades impressos na Amazon KDP, como recursos educativos na Hotmart ou através de qualquer outro canal de venda. O formato de imagens e formas e a capacidade multilingue oferecem-lhe uma forte diferenciação em categorias de mercado muito concorridas.',
    },
    {
      question: 'Qual é a política de reembolso?',
      answer:
        'Como o teste grátis lhe dá acesso a todas as funcionalidades, não oferecemos reembolsos em compras de licenças comerciais. Pode testar ambos os modos de exercício, cada preposição, cada tema, cada forma e cada formato de exportação antes de comprar. O teste grátis é a política de reembolso — certifique-se de que a ferramenta se adapta às suas necessidades antes de adquirir uma licença.',
    },
  ],
  ...
  internalLinks: [
    ...
    {
      pageType: 'guide',
      slug: 'criar-atividades-preposicoes',
      anchorText: 'Guia para Criar Atividades de Preposições que Vendem',
    },
    {
      pageType: 'start',
  ...
  visuals: {
    ...
    videoTitle: 'Como Criar Atividades de Preposições com Exercícios de Imagens e Formas — Tutorial Passo a Passo',
  },
};
