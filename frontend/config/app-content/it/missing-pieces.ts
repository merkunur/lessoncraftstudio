...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Generatore di pezzi mancanti | LessonCraftStudio',
  ...
  hero: {
    title: 'Generatore di pezzi mancanti — Crea stampabili da vendere su Etsy e KDP',
  ...
  ctaHeading: 'Crea puzzle a pezzi mancanti',
