...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Chasse au Trésor | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Chasse au Trésor professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche chasse au trésor avec flèches directionnelles',

    },
    sampleGallery: [
      { src: '/samples/english/treasure hunt/Treasure Hunt 1.jpeg', alt: 'Chasse au trésor avec directions', caption: 'Suivre les directions' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Chasse au Trésor thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Chasse au Trésor est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'find-objects', pageType: 'app' as const, anchorText: 'Générateur d\'Objets Cachés' },
    { slug: 'crossword', pageType: 'app' as const, anchorText: 'Générateur de Mots Croisés' },
    { slug: 'treasure-hunt', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Chasse au Trésor Gratuit' },
