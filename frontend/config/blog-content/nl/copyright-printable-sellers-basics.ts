...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Bescherm uw werk en respecteer het werk van anderen',
    description: 'Bescherm uw werk en respecteer het werk van anderen. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
