/* =====================================================================
   APPLY + GATE — TOOL #53's ten non-English string sets
   =====================================================================
   Merges `_pair-gate-strings.js` into the tool's `strings` block and
   ...
   *våningen* and `kerros` failing to match *kerroksessa* — a ban tested
   ...
   Run: node scripts/apply-pair-gate-locales.js [--dry-run]
   ===================================================================== */
'use strict';
const fs = require('fs');
...
const TOOL = path.join(__dirname, '..', 'mini tools', 'pair-gate.js');
const LOC = require(path.join(__dirname, '_pair-gate-strings.js'));
