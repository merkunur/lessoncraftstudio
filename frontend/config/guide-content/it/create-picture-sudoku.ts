...
const content: GuideContent = {
  seo: {
    ...
    metaDescription: 'Crea sudoku con immagini per piccoli studenti. Griglie 4x4, 3 livelli di difficoltà, immagini tematiche, chiavi di risposta e PDF pronti per la stampa per.',
  },
  ...
  visuals: {
    heroImage: { src: '/samples/italian/sudoku/Sudoku con Immagini 1.webp', alt: 'Scheda di sudoku con immagini che mostra un puzzle logico 4x4 con immagini tematiche per piccoli studenti' },
    samples: [
