...
_Further readiness types (sudoku, picture-sort, odd-one-out, find-objects) + the EN-Preschool set (alphabet-train, big-small, more-less) append their rows at their sub-slice's source-read. Future numeric slices (subtraction; code-addition/crossword/Anlaute) per their later steps._
