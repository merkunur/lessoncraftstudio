...
const content: BlogContent = {
  seo: {
    ...
    secondaryKeywords: [
      'copyright law printable business',
      'copyright protection digital products',
      'intellectual property printable sellers',
    ],
    lsiKeywords: [
      'DMCA printable sellers etsy',
  ...
  cta: {
    heading: 'Create Original Products with Full Rights',
    description: 'All generators produce original content you own commercially. 33 tools available. Free trial with watermark — no signup required.',
