...
const localeContent: Record<string, {
  ...
  de: {
    ...
    subtitle: 'Testen Sie alle 33 Generatoren als kostenlose Testversion mit Wasserzeichen. Sehen Sie die volle Qualitaet vor dem Kauf. Kein Konto erforderlich.',
  ...
  fr: {
    ...
    titleStart: 'Pret a construire votre ',
    titleHighlight: 'empire d\'imprimables',
    subtitle: 'Essayez les 33 generateurs en version d\'essai gratuite avec filigrane. Voyez la qualite complete avant d\'acheter. Aucun compte requis.',
    ctaPrimary: 'Essai gratuit avec filigrane',
    ctaSecondary: 'Explorer les 33 générateurs',
    trustNoCard: 'Aucun compte requis',
    trustFreeGenerators: '33 generateurs en essai gratuit',
  ...
  it: {
    ...
    subtitle: 'Prova tutti i 33 generatori come prova gratuita con filigrana. Verifica la qualita completa prima di acquistare. Nessun account richiesto.',
  ...
  pt: {
    badge: 'Comece seu negocio de imprimiveis hoje',
    titleStart: 'Pronto para construir seu ',
    titleHighlight: 'imperio de imprimiveis',
    subtitle: 'Experimente os 33 geradores como teste gratuito com marca d\'agua. Veja a qualidade completa antes de comprar. Sem conta necessaria.',
  ...
  nl: {
    ...
    trustCancelAnytime: 'Commerciele licentie inbegrepen',
  },
  da: {
    badge: 'Start din printable-virksomhed i dag',
    titleStart: 'Klar til at bygge dit ',
    titleHighlight: 'printable-imperium',
    subtitle: 'Proev alle 33 generatorer som gratis proeveversion med vandmaerke. Se den fulde kvalitet foer du koeber. Ingen konto paakraevet.',
    ctaPrimary: 'Prøv gratis med vandmærke',
    ctaSecondary: 'Se alle 33 generatorer',
    trustNoCard: 'Ingen konto paakraevet',
    trustFreeGenerators: 'Alle 33 generatorer i gratis proeveversion',
    trustCancelAnytime: 'Kommerciel licens inkluderet',
  },
  sv: {
    badge: 'Starta ditt utskriftsfoereag idag',
    titleStart: 'Redo att bygga ditt ',
    titleHighlight: 'utskriftsimperium',
    subtitle: 'Testa alla 33 generatorer som gratis provversion med vattenstempel. Se den fulla kvaliteten innan du koeper. Inget konto kraevs.',
    ctaPrimary: 'Prova gratis med vattenstämpel',
    ctaSecondary: 'Se alla 33 generatorer',
    trustNoCard: 'Inget konto kraevs',
    trustFreeGenerators: 'Alla 33 generatorer i gratis provversion',
    trustCancelAnytime: 'Kommersiell licens ingaar',
  },
  no: {
    badge: 'Start din utskriftsvirksomhet i dag',
    titleStart: 'Klar til aa bygge ditt ',
    titleHighlight: 'utskriftsimperium',
    subtitle: 'Proev alle 33 generatorer som gratis proeveversjon med vannmerke. Se den fulle kvaliteten foer du kjoeper. Ingen konto noedvendig.',
    ctaPrimary: 'Prøv gratis med vannmerke',
    ctaSecondary: 'Se alle 33 generatorer',
    trustNoCard: 'Ingen konto noedvendig',
    trustFreeGenerators: 'Alle 33 generatorer i gratis proeveversjon',
    trustCancelAnytime: 'Kommersiell lisens inkludert',
  },
  fi: {
    badge: 'Aloita tulostettavien liiketoiminta taenaeaen',
    titleStart: 'Valmis rakentamaan ',
    titleHighlight: 'tulostettavien imperiumisi',
    subtitle: 'Kokeile kaikkia 33 generaattoria ilmaisena kokeiluversiona vesileimalla. Nae taeysi laatu ennen ostamista. Ei tilia tarvita.',
    ctaPrimary: 'Kokeile ilmaiseksi vesileimalla',
    ctaSecondary: 'Tutustu kaikkiin 33 generaattoriin',
    trustNoCard: 'Ei tilia tarvita',
    trustFreeGenerators: 'Kaikki 33 generaattoria ilmaisessa kokeiluversiossa',
    trustCancelAnytime: 'Kaupallinen lisenssi sisaeltyy',
  },
};
