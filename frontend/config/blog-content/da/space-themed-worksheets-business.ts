...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'farvelaegning-arbejdsark', anchorText: 'Rum Farvelægning' },
    { pageType: 'app', slug: 'ordsoegning-arbejdsark', anchorText: 'Rum Ordsøgning' },
    { pageType: 'app', slug: 'addition-arbejdsark', anchorText: 'Rum Addition' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Rumtema-Arbejdsark',
