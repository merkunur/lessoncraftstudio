...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'generador de fichas de clasificación de imágenes',
    secondaryKeywords: [
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Activa la escala de grises para versiones con ahorro de tinta ideales para impresión en el aula e interiores de KDP. Descarga los cuatro archivos de una sola sesión: ficha JPEG, ficha PDF, clave de respuestas JPEG y clave de respuestas PDF — todo renderizado a 300 DPI (multiplicador 6×, calidad JPEG 1,0). Cada pestaña tiene su propio par de botones de descarga. Los archivos están listos para producción en listados de Etsy, interiores de Amazon KDP y archivos de productos de TpT sin necesidad de posprocesamiento. Cambia temas, ajusta la cantidad de imágenes o alterna entre modos temático y manual para crear rápidamente variedad en tu catálogo de fichas de clasificación.',
      },
    ],
  },
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Crea paquetes de actividades de clasificación organizados por emparejamientos de categorías naturales usando las 104 colecciones de imágenes. Animales vs Comida, Tierra vs Agua, Frutas vs Verduras, Interior vs Exterior, Animales de Granja vs Animales Salvajes, Artículos de Verano vs Artículos de Invierno — el selector de categorías basado en temas facilita la generación rápida de fichas con agrupaciones izquierda/derecha bien diferenciadas. Empaqueta 15–20 fichas de clasificación por paquete con claves de respuestas autogeneradas incluidas. Varía la cantidad de imágenes entre fichas para dificultad progresiva: empieza con 4–6 imágenes para clasificación simple y escala hasta 10–12 imágenes para desafíos avanzados de clasificación. La cuadrícula de recortes barajada asegura que los estudiantes clasifiquen activamente cada imagen en lugar de copiar un patrón.',
    },
    {
      title: 'Cuadernos de Clasificación para KDP con Dificultad Progresiva',
      description: 'Compila 50–80 fichas de clasificación en cuadernos de actividades impresos para Amazon KDP. Estructura capítulos por dificultad: los capítulos iniciales usan 4–6 imágenes con diferencias obvias entre categorías (animales vs vehículos), los capítulos intermedios usan 8–10 imágenes con distinciones más sutiles (animales de granja vs animales salvajes) y los capítulos avanzados usan 12 imágenes con categorías desafiantes (comida saludable vs golosinas). Incluye páginas de clave de respuestas al final de cada capítulo usando la clave autogenerada con imágenes 6× más grandes en cajas de categoría. Activa la escala de grises para salida con ahorro de tinta que se imprime perfectamente en blanco y negro. El formato de clasificación en dos categorías funciona para todos los grupos de edad desde preescolar hasta primaria.',
    },
    {
      title: 'Actividades de Clasificación para el Aula con Campos de Nombre/Fecha',
      description: 'Construye fichas de clasificación listas para el aula para centros de clasificación, trabajo matutino y práctica independiente con campos de nombre/fecha y claves de respuestas impresas. Crea sets alineados con el currículo: vivos vs no vivos para ciencias, comida saludable vs no saludable para nutrición, animales diurnos vs nocturnos para hábitats, ropa de clima caliente vs frío para estaciones. El modo temático genera fichas rápidamente para sets masivos del aula, mientras que el modo manual te permite seleccionar imágenes específicas que coincidan con tus objetivos de la lección. La clave de respuestas autogenerada ahorra tiempo de preparación al maestro y hace posibles estaciones de clasificación con autocorrección.',
    },
    {
      title: 'Productos de Clasificación Multilingüe para Mercados Internacionales',
      description: 'El Generador de Clasificación de Imágenes es sensible al idioma — las etiquetas de categoría usan nombres localizados de imágenes de la Biblioteca de Imágenes, así que al cambiar de idioma se actualiza el texto en la ficha. Crea fichas de clasificación en inglés, alemán, francés, español, portugués, italiano, holandés, sueco, danés, noruego y finlandés desde las mismas imágenes sin reconstruir nada. El encabezado localizado de Clasificación de Imágenes también se traduce automáticamente. Vende paquetes de clasificación en idiomas específicos dirigidos a tiendas Etsy internacionales y compradores multilingües de TpT, o crea actividades de clasificación ESL/EFL donde las etiquetas bilingües de categoría refuerzan la adquisición de vocabulario.',
    },
    {
      title: 'Fichas de Clasificación con Fotos Personalizadas',
      description: 'Usa la función de Subir Imágenes Personalizadas para crear fichas de clasificación con tus propias fotos o ilustraciones. Actividades de clasificación familiares donde los niños clasifican fotos en categorías como "Personas" vs "Lugares", tareas de clasificación específicas del aula usando fotos tomadas por los estudiantes, actividades de clasificación con marca para empresas educativas o fichas personalizadas para educación especial con imágenes familiares. El modo manual te permite asignar cada imagen subida a la categoría izquierda o derecha. Combinadas con la clave de respuestas autogenerada, las fichas de clasificación con fotos personalizadas se convierten en productos únicos e imposibles de replicar por la competencia.',
    },
    {
      title: 'Colecciones de Clasificación Estacionales y de Festividades',
      description: 'Construye colecciones estacionales rotativas usando temas de festividades y naturaleza de la biblioteca de 104 temas. Decoraciones navideñas vs comida navideña, disfraces de Halloween vs dulces de Halloween, actividades de verano vs actividades de invierno, flores de primavera vs hojas de otoño — los emparejamientos estacionales de categorías crean actividades de clasificación naturales que padres y maestros buscan activamente. Publica cada colección 4–6 semanas antes de la festividad para máxima visibilidad en el mercado. Incluye versiones simples (4–6 imágenes) y avanzadas (10–12 imágenes) en cada set estacional para máxima cobertura de rango de edad.',
    },
  ],
  ...
  proTips: [
    {
      title: 'Usa el Modo Temático para Producción Masiva Rápida',
    ...
    {
      title: 'Usa el Modo Manual para Precisión Curricular',
      description: 'El modo manual te permite seleccionar imágenes individualmente y asignar cada una a la categoría izquierda o derecha. Esto es esencial para crear actividades de clasificación específicas del currículo donde las imágenes exactas importan — selecciona solo los animales de un hábitat específico, solo los alimentos de una unidad de nutrición o solo los objetos relevantes para una lección de ciencias. Las fichas del modo manual consiguen precios más altos en TpT porque demuestran alineación curricular intencional en lugar de selección aleatoria de temas.',
    },
    {
      title: 'Varía la Cantidad de Imágenes para Productos de Dificultad Progresiva',
      description: 'La cantidad configurable de imágenes de 4 a 12 es tu herramienta de escalado de dificultad. Crea paquetes con dificultad progresiva: empieza con fichas de 4 imágenes donde las categorías son obvias y la tarea de clasificación es simple, luego progresa a fichas de 8 imágenes con más elementos a clasificar, y termina con fichas avanzadas de 12 imágenes donde los estudiantes deben ordenar muchos elementos en dos categorías. Los paquetes de dificultad progresiva sirven al rango de edad más amplio y justifican precios premium porque los compradores obtienen contenido para múltiples niveles en un solo producto.',
    },
    {
      title: 'Aprovecha las Etiquetas Sensibles al Idioma para Productos Multilingües',
      description: 'Las etiquetas de categoría en las fichas de clasificación usan nombres localizados de imágenes — al cambiar el idioma de la aplicación se actualiza el texto en cada ficha. Genera un set temático de clasificación en inglés, luego cambia a alemán, francés, español o cualquiera de los 11 idiomas soportados y regenera el mismo emparejamiento de categorías con etiquetas localizadas. Esto produce productos de clasificación multilingüe desde imágenes idénticas sin esfuerzo de rediseño. Los paquetes de clasificación multilingüe están desatendidos en la mayoría de los mercados, dándote una ventaja competitiva.',
    },
    {
      title: 'Incluye Ficha y Clave de Respuestas en Cada Listado',
      description: 'La clave de respuestas autogenerada con imágenes 6× más grandes organizadas en cajas de categoría es lo que convierte tus fichas de clasificación en un producto completo con autocorrección en lugar de solo una actividad de clasificación. Siempre incluye claves de respuestas en tus paquetes de productos y muéstralas en las imágenes de vista previa del listado. Los productos que incluyen claves de respuestas consistentemente superan en ventas a los listados de solo fichas porque maestros y padres quieren materiales con autocorrección que no requieran tiempo adicional de preparación. El sistema de doble lienzo genera ambas versiones simultáneamente, así que incluir la clave de respuestas no te cuesta nada extra.',
    },
    {
      title: 'Usa Fondos y Bordes Temáticos para Branding Cohesivo de Producto',
      description: 'El sistema independiente de fondos y bordes temáticos con controles de opacidad separados te permite crear una identidad visual consistente en tus paquetes de fichas de clasificación. Configura un fondo temático sutil al 15–25% de opacidad para calidez visual sin distraer del contenido de clasificación. Superpone un borde decorativo al 80–100% de opacidad para un marco pulido. Aplica la misma combinación de fondo y borde en cada ficha de un paquete para un aspecto de producto cohesivo que los compradores asocian con calidad y profesionalismo.',
    },
    {
      title: 'Apunta a Emparejamientos Naturales de Categorías para Máxima Visibilidad',
      description: 'Los productos de fichas de clasificación más exitosos usan emparejamientos de categorías que coinciden con cómo maestros y padres piensan sobre la clasificación: animales vs comida, tierra vs agua, vivos vs no vivos, saludable vs no saludable, grande vs pequeño, caliente vs frío, día vs noche. Estas oposiciones binarias naturales son los términos que los compradores buscan en Etsy, TpT y Amazon. Nombra tus listados usando el emparejamiento real de categorías (por ejemplo, "Fichas de Clasificación Animales vs Comida") en lugar de títulos genéricos, y crea listados separados para cada emparejamiento principal para capturar tráfico de búsqueda segmentado.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Sí. Marca la casilla "Incluir Campos de Nombre/Fecha" en el panel de Configuración de Página para añadir líneas de nombre y fecha del estudiante en la ficha. Estos campos aseguran la responsabilidad estudiantil en el aula y hacen que tus fichas de clasificación estén listas para recogida y calificación del maestro sin ninguna preparación adicional. Los campos de nombre/fecha son un punto de venta clave para productos de aula en TpT donde los maestros esperan fichas que lleguen listas para usar.',
    },
    {
