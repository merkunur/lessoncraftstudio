...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Fairy Tales',
  title: 'Fairy Tale & Story Worksheets for Kids | LessonCraftStudio',
  description: 'Explore fairy tale worksheets for kids: stories, characters, castles, and magic. Free printable activities for preschool to 3rd grade. Once upon a worksheet.',
  keywords: 'fairy tale coloring pages for kids, storybook activities for kindergarten, princess and castle worksheets, fairy tale characters printable, fairy tale math activities for kids, fairy tale vocabulary worksheets, story sequencing worksheets printable, fairy tale puzzles for kindergarten, fairy tale sorting activities for kids, enchanted forest worksheets printable',
  heading: 'Fairy Tale and Story Worksheets for Kids',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Fairy Tale Preschool Worksheets \u2014 Tracing & Counting | LCS',
      seoDescription: 'Free printable fairy tale worksheets for preschool (ages 3-4). Count wizard stars, trace castle words, match characters, and color storybook scenes. Get pages.',
      seoKeywords: 'preschool fairy tale counting worksheets wizard stars to 10, castle word tracing activities letter formation ages 3-4, fairy tale character matching worksheets princess to crown pre-K, three-picture story sequencing fairy tale worksheets preschool, preschool storybook castle coloring pages thick outlines printable',
    ...
    'kindergarten': {
      seoTitle: 'Fairy Tale Kindergarten Worksheets \u2014 Word Hunts & Math | LCS',
      seoDescription: 'Free printable fairy tale worksheets for kindergarten (ages 5-6). Add magic wands, find castle words, predict story outcomes, and extend patterns. Get pages.',
      seoKeywords: 'kindergarten fairy tale addition worksheets magic wands within 10, enchanted word search worksheets castle dragon vocabulary ages 5-6, fairy tale character trait identification worksheets brave kind K, crown shield wand pattern recognition worksheets kindergarten, kindergarten fairy tale story prediction and retelling activity pages',
    ...
    'first-grade': {
      seoTitle: 'Fairy Tale First Grade Worksheets \u2014 Plots & Story Math | LCS',
      seoDescription: 'Free printable fairy tale worksheets for first grade (ages 6-7). Solve story math problems, analyze character morals, and write tale endings. Get pages now.',
      seoKeywords: 'first grade fairy tale word problems multi-step addition subtraction 20, fairy tale reading comprehension passages character morals ages 6-7, enchanted pattern recognition worksheets crown shield wand sequence grade 1, fairy tale creative writing prompts alternate endings first grade, first grade fairy tale vocabulary puzzles enchantment kingdom adventure pages',
    ...
    'second-grade': {
      seoTitle: 'Fairy Tale Second Grade Worksheets \u2014 Versions & Morals | LCS',
      seoDescription: 'Free printable fairy tale worksheets for second grade (ages 7-8). Compare tale versions, solve two-step story problems, and write opinion pieces. Get pages.',
      seoKeywords: 'second grade fairy tale comparison worksheets two versions culture, multi-step fairy tale math problems within 100 treasure sharing ages 7-8, fairy tale opinion writing worksheets character decisions second grade, cross-cultural fairy tale analysis worksheets Cinderella variants grade 2, second grade fairy tale narrative pattern identification and theme writing pages',
    ...
    'third-grade': {
      seoTitle: 'Fairy Tale Third Grade Worksheets \u2014 Plots & Cultures | LCS',
      seoDescription: 'Free printable fairy tale worksheets for third grade (ages 8-9). Analyze plot structure, compare cultural variants, and write tales with dialogue. Get pages.',
      seoKeywords: 'third grade fairy tale plot structure analysis exposition climax resolution, cross-cultural Cinderella variant comparison worksheets ages 8-9, original fairy tale writing worksheets dialogue description grade 3, fairy tale point of view narrative retelling villain perspective third grade, third grade fairy tale multiplication frequency patterns and essay writing pages',
