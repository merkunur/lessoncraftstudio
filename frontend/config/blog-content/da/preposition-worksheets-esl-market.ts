...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'prepositions-worksheets', anchorText: 'Præpositions-Generator' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Ordsøgning (dansk ordforråd)' },
