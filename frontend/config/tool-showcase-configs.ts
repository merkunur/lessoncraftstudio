...
const nlToolText: Record<string, FrTextTuple> = {
  ...
  'prepositions': ['Waar is het?', 'Voorzetsels leren met plaatjes en scènes', 'Positiewoorden beheersen', 'Drie niveaus van positiebegrip', 'Basisposities (op, in, onder)', 'Uitgebreide posities (naast, tussen, achter)', 'Complexe ruimtelijke beschrijvingen', 'Positiewoorden versterken taalbegrip', 'Voorzetsels!', 'Waar bevindt het zich?', 'Voorzetselwerkbladen', 'Visuele positieoefeningen'],
  'writing': ['Schrijven en leren!', 'Schrijfoefenwerkbladen voor handschrift', 'Van lijnen naar letters naar woorden', 'Drie niveaus van schrijfvaardigheid', 'Lijnen en vormen overtrekken', 'Letters vormen en oefenen', 'Woorden en zinnen schrijven', 'Elke letter bouwt schrijfvertrouwen', 'Schrijfpret!', 'Pen op papier', 'Schrijfwerkbladen', 'Gestructureerde schrijfoefeningen'],
  'matching': ['Vind het paar!', 'Koppelactiviteiten met themaplaatjes en woorden', 'Van eenvoudig naar complex', 'Drie koppelmodi voor differentiatie', 'Plaatje-aan-plaatje koppelen', 'Plaatje-aan-woord koppelen', 'Eigen woordenlijsten koppelen', 'Koppelen versterkt woordenschat en geheugen', 'Koppelpret!', 'Zoek de paren', 'Koppelwerkbladen', 'Visuele koppelactiviteiten'],
  'sudoku': ['Sudoku-plezier!', 'Plaatjes-sudoku voor jonge denkers', 'Van klein naar groot raster', 'Drie niveaus van sudoku-uitdaging', 'Mini-sudoku met 4 plaatjes', 'Gemiddelde puzzels met 6 plaatjes', 'Uitdagende puzzels met 9 plaatjes', 'Sudoku ontwikkelt logisch redeneren', 'Sudoku!', 'Denk logisch', 'Sudoku-werkbladen', 'Logicapuzzels voor kinderen'],
