  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      },
      {
        ...
        alt: 'Ficha de subtração no modo Encontrar o Subtraendo desafiando os usuários a encontrar o valor em falta',
