  ...
  var WordclassActivity = {
    ...
    _injectStyle: function () {
      ...
      s.textContent = [
        ...
        '.wc-say{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;}',
        '.wc-glim{flex:0 0 auto;}',
        '.wc-line-msg{flex:0 1 auto;min-height:1.1em;text-align:center;font:700 clamp(0.88rem,2.1vw,1.14rem)/1.3 Nunito,system-ui,sans-serif;color:#146B5E;margin:0;}',
