...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Configure what each row practices. Image Library \u2014 Beginning Letter mode uses the first letter of each image name with the image as visual reference. Image Library \u2014 Whole File Name mode writes the complete word. Custom Text mode lets you type any word, phrase, or sentence. Empty mode creates blank ruled lines with the three-line guide system. Then set the letter case: Upper-case, Lower-case, or Title Case per row.',
      },
      {
        title: 'Add Pre-Writing Strokes for Fine Motor Warm-Ups',
        description: 'For younger learners or fine motor development, add pre-writing stroke exercises: vertical lines (top-to-bottom pull), horizontal lines (left-to-right sweep), circles (continuous curve control), and zigzag lines (directional change practice). These exercises build the foundational pencil grip strength and hand-eye coordination needed before letter formation. Place pre-writing rows at the top of the worksheet as warm-ups before letter practice rows.',
      },
      {
  ...
  businessIdeas: [
    {
      title: 'Stroke-Order Handwriting Shop on Etsy',
      description: 'Open an Etsy shop specializing in arrow-guided stroke-order handwriting worksheets. The numbered directional arrows on each letter are a genuine differentiator \u2014 most handwriting sellers offer plain tracing lines without stroke-order instruction. Create separate listings for uppercase alphabet sets, lowercase alphabet sets, number formation, and complete A\u2013Z progression bundles. Use per-row independence to offer mixed-mode worksheets that competitors using template-based tools cannot replicate. Stroke-order products command premium prices because they teach proper technique rather than just providing lines to trace.',
      platform: 'Etsy',
    },
    {
      title: 'Amazon KDP Handwriting Workbook Series',
      description: 'Publish a series of handwriting workbooks on Amazon KDP, each targeting a specific stage: "Pre-Writing Strokes for Fine Motor Development," "Print Letters with Arrow Stroke Order," "Fading Trace Letter Practice," "Cursive Handwriting for Beginners." Each book uses 80\u2013120 pages with progressive difficulty structure. Use grayscale mode for lower printing costs. Handwriting workbooks sell consistently year-round and the three practice modes plus five font styles give you enough variety to sustain a multi-book series without repetitive content.',
      platform: 'Amazon KDP',
    },
    {
    ...
    {
      title: 'Gumroad Complete Handwriting Curriculum',
      description: 'Bundle pre-writing strokes, print letter tracing with stroke order, fading trace practice, guided copy, and cursive handwriting into a comprehensive handwriting curriculum on Gumroad. Include all five font styles, all three practice modes, and themed image variations. A multi-stage handwriting program justifies a premium price point because it replaces multiple individual purchases. Pair with alphabet train and drawing lines worksheets for a complete early literacy and motor skills package.',
      platform: 'Gumroad',
    },
  ],
  ...
  proTips: [
    {
      title: 'Use the Three Practice Modes as a Built-In Difficulty Progression',
      description: 'Trace mode provides full support for new letters. Fading Trace reduces support incrementally across each row. Guided Copy offers minimal scaffolding for near-independent writing. This three-tier progression creates a natural difficulty curve within a single worksheet or across a product bundle. Use it as your primary differentiation axis for leveled products \u2014 buyers immediately understand the progression without needing lengthy descriptions.',
    },
    {
    ...
    },
    {
      ...
      description: 'Per-row independence means every row has its own practice mode, font style, content source, and case setting. Put arrow-guided Trace at the top for instruction, Fading Trace in the middle for practice, and Guided Copy at the bottom for assessment \u2014 all on one page. This creates worksheets that competitors using template-based tools cannot replicate, and it reduces the total pages needed per product bundle because each page covers multiple skill stages.',
    },
    {
    ...
    },
    {
      ...
      description: 'Print handwriting and cursive handwriting target different buyer audiences searching different keywords. Create separate product listings for print letter practice (using Print Regular, Print Arrow, Print Tracing fonts) and cursive practice (using the Cursive Great Vibes font). Two product lines from the same tool doubles your marketplace visibility without doubling your design time.',
    },
    {
      title: 'Pair with Other Literacy and Motor Skills Tools',
      description: 'Combine handwriting worksheets with alphabet train worksheets for letter recognition, drawing lines worksheets for additional fine motor practice, and word guess or word scramble worksheets for spelling reinforcement. Handwriting exercises letter formation \u2014 a fundamentally different skill from letter recognition (alphabet train) or visual scanning (word search). Multi-format literacy packs sell for more than any single format alone.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Print Regular provides standard block letters for general handwriting practice. Print Regular Arrow adds numbered directional arrows showing exact stroke order. Print Tracing shows dotted-outline letters designed for tracing exercises. Print Tracing Arrow combines dotted outlines with stroke-order arrows for guided tracing with formation instruction. Cursive (Great Vibes) provides flowing script letters for cursive handwriting practice. Each font serves a different instructional purpose.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Every row on the worksheet has its own independent settings for practice mode, font style, content source, and letter case. Row 1 can be Trace mode with Print Arrow font practicing uppercase A, Row 2 can be Fading Trace with Print Tracing font practicing lowercase a, and Row 3 can be Guided Copy with Cursive font for a complete word \u2014 all on the same worksheet. Per-row independence lets you create progressive worksheets that would normally require multiple pages.',
    },
    {
  ...
  visuals: {
    ...
    sampleGallery: [
      {
        src: '/samples/english/writing/writing_worksheet.jpeg',
        alt: 'Handwriting practice worksheet with three progressive practice modes and themed image integration',
