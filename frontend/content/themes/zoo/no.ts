...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare dyrepark-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med dyreparktema. Førskole til 3. klasse. Gratis PDF. Skriv ut nå.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Dyrehage-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare dyrehage-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Velg mellom 3 000+ bilder.',
      seoKeywords: 'zoo-oppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, eksotiske dyr, zoo-besøk, ville dyr, zoo-øvelser førskole, zoos læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Dyrehage-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare dyrehage-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'zoo-oppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, eksotiske dyr, zoo-besøk, ville dyr, zoo-øvelser barnehage, zoos læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Dyrehage-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare dyrehage-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'zoo-oppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, eksotiske dyr, zoo-besøk, ville dyr, zoo-øvelser 1. klasse, zoos læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Dyrehage-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare dyrehage-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'zoo-oppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, eksotiske dyr, zoo-besøk, ville dyr, zoo-øvelser 2. klasse, zoos læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Dyrehage-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare dyrehage-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'zoo-oppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, eksotiske dyr, zoo-besøk, ville dyr, zoo-øvelser 3. klasse, zoos læring 8-9 år',
