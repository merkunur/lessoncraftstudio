...
window.MochiFeastActivity = Object.assign({}, MochiFeastCore, {
  ...
  strings: {
    title:        { en: "Mochi's Counting Feast", de: 'Mochis Zählfest', fr: 'Le grand festin de Mochi', es: 'El banquete de Mochi', pt: 'O banquete do Mochi', it: 'Il banchetto dei numeri di Mochi' },
    instruction:  { en: "Tap the dish to feed Mochi the right number of treats, then tap Check.", de: 'Tippe auf den Teller, um Mochi die richtige Anzahl Leckereien zu geben, und tippe dann auf „Prüfen".', fr: 'Tape sur le plat pour donner à Mochi le bon nombre de gourmandises, puis tape sur « Vérifier ».', es: 'Toca el plato para darle a Mochi el número correcto de golosinas y luego toca Comprobar.', pt: 'Toque no prato para dar a quantidade certa de guloseimas ao Mochi. Depois, toque em Verificar.', it: 'Tocca il piatto per dare a Mochi il numero giusto di golosità, poi tocca Verifica.' },
    promptStrawberry: { en: "Feed Mochi {n} strawberries!", de: 'Gib Mochi {n} Erdbeeren!', fr: 'Donne {n} fraises à Mochi !', es: '¡Dale a Mochi {n} fresas!', pt: 'Dê {n} morangos ao Mochi!', it: 'Dai {n} fragole a Mochi!' },
    promptCookie:     { en: "Feed Mochi {n} cookies!",      de: 'Gib Mochi {n} Kekse!', fr: 'Donne {n} cookies à Mochi !', es: '¡Dale a Mochi {n} galletas!', pt: 'Dê {n} biscoitos ao Mochi!', it: 'Dai {n} biscotti a Mochi!' },
    promptCherry:     { en: "Feed Mochi {n} cherries!",     de: 'Gib Mochi {n} Kirschen!', fr: 'Donne {n} cerises à Mochi !', es: '¡Dale a Mochi {n} cerezas!', pt: 'Dê {n} cerejas ao Mochi!', it: 'Dai {n} ciliegie a Mochi!' },
    promptCupcake:    { en: "Feed Mochi {n} cupcakes!",     de: 'Gib Mochi {n} Cupcakes!', fr: 'Donne {n} cupcakes à Mochi !', es: '¡Dale a Mochi {n} cupcakes!', pt: 'Dê {n} cupcakes ao Mochi!', it: 'Dai {n} cupcake a Mochi!' },
    promptBanana:     { en: "Feed Mochi {n} bananas!",      de: 'Gib Mochi {n} Bananen!', fr: 'Donne {n} bananes à Mochi !', es: '¡Dale a Mochi {n} plátanos!', pt: 'Dê {n} bananas ao Mochi!', it: 'Dai {n} banane a Mochi!' },
    promptApple:      { en: "Feed Mochi {n} apples!",       de: 'Gib Mochi {n} Äpfel!', fr: 'Donne {n} pommes à Mochi !', es: '¡Dale a Mochi {n} manzanas!', pt: 'Dê {n} maçãs ao Mochi!', it: 'Dai {n} mele a Mochi!' },
    promptDonut:      { en: "Feed Mochi {n} donuts!",       de: 'Gib Mochi {n} Donuts!', fr: 'Donne {n} donuts à Mochi !', es: '¡Dale a Mochi {n} donas!', pt: 'Dê {n} rosquinhas ao Mochi!', it: 'Dai {n} ciambelle a Mochi!' },
    promptMuffin:     { en: "Feed Mochi {n} muffins!",      de: 'Gib Mochi {n} Muffins!', fr: 'Donne {n} muffins à Mochi !', es: '¡Dale a Mochi {n} muffins!', pt: 'Dê {n} muffins ao Mochi!', it: 'Dai {n} muffin a Mochi!' },
    hintAddSome: { en: "Tap the dish to give Mochi a treat.", de: 'Tippe auf den Teller, um Mochi eine Leckerei zu geben.', fr: 'Tape sur le plat pour donner une gourmandise à Mochi.', es: 'Toca el plato para darle una golosina a Mochi.', pt: 'Toque no prato para dar uma guloseima ao Mochi.', it: 'Tocca il piatto per dare una golosità a Mochi.' },
    hintMore:    { en: "Mochi is still a little hungry — add a few more.", de: 'Mochi hat noch ein bisschen Hunger – leg noch ein paar dazu.', fr: 'Mochi a encore un petit peu faim… ajoute-en encore quelques-unes.', es: 'Mochi todavía tiene un poquito de hambre… agrégale unas cuantas más.', pt: 'O Mochi ainda está com um pouquinho de fome — coloque mais algumas.', it: 'Mochi ha ancora un poco di fame: aggiungine altre.' },
    hintTooMany: { en: "Ooh, that's a lot! Tap a treat in the bowl to take one back.", de: 'Oh, das sind zu viele! Tippe auf eine Leckerei in der Schüssel, um eine zurückzunehmen.', fr: 'Oh là là, ça fait beaucoup ! Tape sur une gourmandise dans le bol pour en reprendre une.', es: '¡Uy, son muchas! Toca una golosina del tazón para quitar una.', pt: 'Opa, quanta coisa! Toque em uma guloseima na tigela para tirar uma.', it: 'Ops, quante! Tocca una golosità nella ciotola per riprenderla.' },
    trayLabel:  { en: "Tap to feed", de: 'Zum Füttern tippen', fr: 'Tape pour nourrir', es: 'Toca para dar', pt: 'Toque para alimentar', it: 'Tocca per servire' },
    srAddTreat: { en: "Give Mochi a treat", de: 'Mochi eine Leckerei geben', fr: 'Donner une gourmandise à Mochi', es: 'Darle una golosina a Mochi', pt: 'Dar uma guloseima ao Mochi', it: 'Dai una golosità a Mochi' },
    srTakeBack: { en: "Take this treat back", de: 'Diese Leckerei zurücknehmen', fr: 'Reprendre cette gourmandise', es: 'Quitar esta golosina', pt: 'Tirar esta guloseima', it: 'Riprendi questa golosità' }
  },
