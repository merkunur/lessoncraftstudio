/* =====================================================================
   register-unroll-tape.js — wire TOOL #40 into the site
   ---------------------------------------------------------------------
   Run:  node scripts/register-unroll-tape.js [--dry-run]
...
const KEY = 'unroll-tape';
const PREV = 'unit-handle';           /* the key this one is inserted after */
const E = require('./_unroll-tape-content.js');
...
LOCALES.forEach((l) => {
  ...
  if (!e || !e.slug || !e.name || !Array.isArray(e.about) || e.about.length !== 4) {
    die(`_unroll-tape-content.js is incomplete for "${l}" — run apply-unroll-tape-locales.js first`);
  }
});
