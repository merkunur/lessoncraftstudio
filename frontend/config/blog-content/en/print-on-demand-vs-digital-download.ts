...
const content: BlogContent = {
  seo: {
    ...
    secondaryKeywords: [
      'POD vs digital download business model',
      'print on demand printables comparison',
      'digital download vs physical printable products',
    ],
    lsiKeywords: [
  ...
  cta: {
    heading: 'Create Products for Digital and Print',
    description: 'Professional worksheets ready for Etsy downloads or KDP print books. 33 generators available. Free trial with watermark — no signup required.',
