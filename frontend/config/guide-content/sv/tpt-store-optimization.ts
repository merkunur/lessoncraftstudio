...
const content: GuideContent = {
  ...
  tutorial: [
    ...
    {
      heading: 'Skala din Gumroad-katalog med datadriven innehållsplanering',
      content: 'Övergången från sporadisk Gumroad-säljare till konsekvent intäktsgenerering sker när du slutar gissa och börjar använda din försäljningsdata.\n\nIdentifiera dina topppresterande resurser och analysera vad de har gemensamt. Om dina tre högst tjänande resurser alla är årskurs 1 mattearbetsblad, skapa mer årskurs 1 matteinnehåll. Om dina ordsökningspussel konsekvent överträffar andra resurstyper, prioritera fler variationer.\n\nFördubbla insatsen i kategorier där du redan har fäste. 30 högkvalitativa årskurs 1 matteresurser dominerar den nischen mer effektivt än 30 resurser utspridda över 6 årskurser och 5 ämnen. Djup skapar sammansatta fördelar: köpare som köper en resurs köper sannolikt fler, din butik vinner tematisk auktoritet i Gumroad-sökning, och dina recensioner koncentreras.\n\nIdentifiera luckor genom att undersöka vad toppresurser saknar i kompanjoninnehåll. Om dina "Årskurs 1 additionsarbetsblad" är din toppsäljare, vad behöver säljaren härnäst? Subtraktionsarbetsblad på samma nivå, mer avancerad addition, blandade operationer, eller utvärderingsverktyg?\n\nPlanera innehåll kring säsongsbetonade efterfrågecykler. Skolstart i juli–september, högtider oktober–december, vårterminsutvärdering mars–maj, slutet-av-läsåret maj–juni. Ha säsongsresurser publicerade minst 3–4 veckor före varje topp.\n\nExpandera till angränsande årskurser och ämnen först efter att ha dominerat din primära nisch.',
    },
  ],
  ...
  platformTips: [
    ...
    },
    {
      ...
      content: 'Gumroad:s sökalgoritm ger aktualitetslyft till nyligen uppdaterade resurser. Utveckla en systematisk uppdateringsrotation: granska dina äldsta eller lägst presterande resurser varje månad, förbättra innehållet, förnya förhandsgranskningen och uppdatera beskrivningen. Varje uppdatering triggar en aktualitetssignal som kan bumpa resursen högre. Kombinera med evenemangstiming — uppdatera 1–2 veckor före en stor Gumroad-rea för maximal effekt under den mest trafikerade perioden.',
    },
    {
      heading: 'Använd anpassade paketrabatter som flerköpsincitament',
      content: 'Gumroad:s anpassade paketfunktion låter köpare välja flera resurser med en säljar-konfigurerad rabatt. Sätt rabatten mellan 15% och 25%. Nämn paketmöjligheten i varje produktbeskrivning ("Spara med min anpassade paketrabatt — lägg till valfria av mina resurser i din varukorg") och inkludera en påminnelsesida i dina nedladdningsfiler. köpare som upptäcker paketrabatt efter sitt första köp återvänder ofta, särskilt under reatillfällen när rabatten staplas.',
    },
  ],
  ...
  monetization: [
    {
      ...
      content: 'Den mest hållbara Gumroad-intäkten kommer från resursserier som säljare köper under hela läsåret. En "Månatliga mattecentra"-serie för årskurs 1 med 10 delar skapar naturliga återkommande köp. En progressiv fonologiserie med 6 nivåer skapar sekventiella köp. Serier fungerar eftersom de minskar säljarens beslutsfattande — när kvaliteten valideras av första delen är efterföljande köp automatiska. Planera innehållsskapande kring serier från början: identifiera färdighetsprogressioner, säsongsenheter eller tematiska bågar som delar sig naturligt i 4–12 delar.',
    },
    {
      heading: 'Maximera intäkt under Gumroad:s plattformsövergripande reaer',
      content: 'Gumroad:s reaer är den enskilt största intäktsmöjligheten, där 2–3 readagar ofta genererar en full normal månads intäkt. Maximera genom att säkerställa att varje listning är optimerad, all taggning komplett, din tilläggsrabatt satt (20–25%), och nya färdiga resurser publicerade under rean. Analysera efteråt vilka resurser som hade störst försäljningstoppar — dessa hade starkast önskelisteackumulering och indikerar kategorier där mer innehåll ger överproportionerad avkastning.',
    },
    {
      heading: 'Expandera över årskurser för att multiplicera din adresserbara marknad',
      content: 'När din butik dominerar en specifik årskurs och ämne, är det mest effektiva att skapa motsvarande resurser för angränsande årskurser. Dina årskurs 1 additionsarbetsblad har bevisat marknadsefterfrågan. Att skapa årskurs 2 additionsarbetsblad utnyttjar allt du lärt dig. Många säljare rekommenderar resurser till kollegor på andra årskurser. En heltäckande K–3 mattebutik attraherar årskursteam. Arbetsbladsgeneratorerna gör detta effektivt — justera svårighetsinställningar och talintervall för olika årskurser.',
    },
  ],

  examples: [
    {
      heading: 'Exempel: Optimera en underpresterande Gumroad-butik med 15 listningar',
      content: 'En andreklasssäljare har 15 matteresurser på Gumroad som tjänar $80–$120 per månad. Hennes resurser är välgjorda men listningarna är underoptimerade. Hon börjar med att granska sina titlar mot faktiska Gumroad-söktermer och upptäcker att hon använder egna namnkonventioner ("Mattekul Paket 3") istället för lärarsöktermer ("Second Grade Multiplication Introduction Worksheets — Arrays and Equal Groups"). Hon skriver om alla 15 titlar. Sedan uppdaterar hon förhandsgranskningarna från ensidiga till 4-sidors PDF:er. Hon lägger till standardanpassningstaggar och skapar 4 butikssektioner organiserade efter mattefärdighet. Hon lägger till en recensionsförfrågansida i varje resurs. Inom 3 månader ökar hennes intäkt till $220–$280 utan nya resurser — enbart optimering. Konverteringsgraden förbättras tack vare bättre förhandsgranskningar, och sökrankningar förbättras genom bättre titlar och växande recensioner.',
    },
    {
      heading: 'Exempel: Skala en Gumroad-butik från 30 till 80 resurser med data',
  ...
  faq: [
    {
      question: 'Hur bestämmer Gumroad:s sökalgoritm vilka resurser som rankar först?',
    ...
    {
      question: 'Vilken är den bästa rabatten att erbjuda under Gumroad:s reaer?',
    ...
    {
      question: 'Bör jag specialisera min Gumroad-butik på ett ämne eller täcka flera?',
    ...
    {
      question: 'Vad är återbetalningspolicyn för kommersiella licenser som används för Gumroad-resurser?',
      answer: 'Varje generator erbjuder en gratis provversion med vattenstämpel så att du kan utvärdera fullständigt före köp. Skapa kompletta arbetsblad, testa alla konfigurationer, verifiera 300 DPI tryckkvalitet och bekräfta att formatet uppfyller Gumroad:s standarder. Eftersom du kan grundligt testa hela produkten innan köp är alla kommersiella licensförsäljningar slutgiltiga.',
    },
  ],
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Skapar vokabulärkorsord som säljare söker efter per ämne och årskurs. Populära för läscentra, vokabulärrepetition och ämnesförstärkningsaktiviteter.',
    },
  ],
