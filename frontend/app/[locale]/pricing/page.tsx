...
const pricingContent: Record<string, {
  ...
  es: {
    metaTitle: 'Precios | Generadores de fichas desde $49 — Pago único',
    metaDescription: 'Pruebe los 33 generadores gratis con marca de agua. Apps individuales a $49, packs por categoría desde $99. Pago único, licencia comercial, sin suscripción.',
    keywords: ['precios generador fichas', 'licencia comercial imprimibles', 'generador fichas comprar Etsy', 'pago único generador imprimibles', 'packs generadores fichas precio'],
  ...
  sv: {
    metaTitle: 'Priser | Arbetsbladsgeneratorer från 49 $ — Engångsbetalning',
    metaDescription: 'Prova alla 33 generatorer gratis med vattenstämpel. Enskilda appar 49 $, kategoribuntar 149 $. Engångsbetalning, kommersiell licens, inget abonnemang.',
    ...
    buyApp: 'Köp för $49',
    buyBundle: 'Köp paket för $149',
    saveVsIndividual: 'Spara vs. enskild',
    catalogTitle: 'Välj dina appar',
    catalogSubtitle: 'Köp enskilda appar för $49 eller spara med ett kategoripaket för $149.',
  },
  da: {
