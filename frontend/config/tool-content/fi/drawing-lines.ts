...
const content: ToolContent = {
  ...
  visuals: {
    ...
    sampleGallery: [
      { src: '/samples/finnish/drawing%20lines/viivojen-piirtämisharjoitus-1.webp', alt: 'Viivanjäljitystehtäväarkki kaaremallilla, joka yhdistää vastaavat eläinkuvaparit vaakasuunnassa', caption: 'Kaaremalli — sulavat viivapolut 4 värikkäällä kuvaparilla vaakasuunnassa' },
      { src: '/samples/finnish/drawing%20lines/viivojen-piirtämisharjoitus-2.webp', alt: 'Viivanjäljitystehtäväarkki diagonaalimallilla, joka yhdistää viisi kuvaparia pystysuunnassa', caption: 'Diagonaalimalli — vinottaiset viivat 5 kuvaparilla risteävän koordinaation harjoitukseen' },
      { src: '/samples/finnish/drawing%20lines/viivojen-piirtämisharjoitus-3.webp', alt: 'Viivanjäljitystehtäväarkki pystysuoralla mallilla, joka yhdistää luontoteemaisia kuvapareja pystysuunnassa', caption: 'Pystysuora malli — ylhäältä-alas-viivat aloittelijan hienomotoriseen harjoitukseen' },
    ],
