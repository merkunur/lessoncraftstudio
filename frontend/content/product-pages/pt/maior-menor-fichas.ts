...
/**
 * Atividades de Maior e Menor (More Less) - Brazilian Portuguese Content
 *
 * File: frontend/content/product-pages/pt/maior-menor-fichas.ts
 * URL: /pt/apps/maior-menor-fichas
 *
...
export default moreLessPtContent;
