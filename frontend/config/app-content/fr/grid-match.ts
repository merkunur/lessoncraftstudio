...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Générateur de quadrillage | LessonCraftStudio',
  ...
  hero: {
    title: 'Générateur de quadrillage — Créez des imprimables à vendre sur Etsy & KDP',
  ...
  ctaHeading: 'Créer des fiches de dessin sur quadrillage',
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          'Concevez des activités de puzzles grille prêtes à l\'emploi pour les fins de cours, le travail du matin ou les ateliers d\'enrichissement. Les vendeurs qui cherchent sur Gumroad des activités de perception visuelle apprécient les puzzles qui arrivent prêts à imprimer avec corrigés. Créez des ensembles liés au programme : puzzles d\'images d\'animaux pour les sciences, puzzles de monuments pour les études sociales, puzzles d\'aliments pour la nutrition. La difficulté configurable vous permet de différencier au sein d\'un même produit — incluez des versions faciles, moyennes et difficiles des mêmes puzzles thématiques pour que les vendeurs puissent adapter selon le niveau de l\'utilisateur.',
      ...
      },
      {
        ...
        description:
          'Utilisez la fonctionnalité Télécharger des Images Personnalisées pour créer des puzzles grille à partir de n\'importe quelle photo ou illustration. Les puzzles à base de photos de famille constituent des cadeaux personnalisés uniques. Les vendeurs peuvent télécharger des photos de classe pour des activités de fin d\'année. Les puzzles photo d\'animaux de compagnie, de vacances et d\'équipe créent tous des produits uniques en leur genre. Proposez la création de puzzles grille personnalisés comme service premium sur Etsy où les clients soumettent leurs photos et vous livrez des fiches de puzzles imprimées avec corrigés — un produit personnalisé à forte marge avec un temps de production minimal.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Les cases-indices sont des positions de la grille où la tuile d\'image reste visible comme indice. Définissez 1–5 cases-indices à l\'aide du curseur dans le panneau Options de la Grille (la valeur par défaut est 1). Plus d\'indices rendent le puzzle plus facile car les utilisateurs disposent de plus de points de référence. Pour une grille 3×3 avec 1 indice, les utilisateurs doivent associer 8 tuiles — assez difficile. Avec 5 indices, seulement 4 tuiles doivent être associées — beaucoup plus accessible. Ce simple contrôle vous permet de créer des ensembles de difficulté progressive à partir de la même image.',
    },
    {
