...
const content: BlogContent = {
  ...
  cta: {
    heading: 'Opret Juleprintables Nu',
    description: 'Generér professionelle juleaktiviteter med alle 33 generatorer. Prøv gratis med vandmærke.',
    buttonText: 'Start Juleproduktionen',
    buttonUrl: '/apps',
  },
};
