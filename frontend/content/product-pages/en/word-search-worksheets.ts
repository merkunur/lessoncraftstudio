    ...
    items: [
      {
        ...
        answerKeySrc: '/samples/english/wordsearch/sample-1-answer.jpeg',
        altText: 'Word search worksheets free printable - portrait vocabulary puzzles for kindergarten and first grade kids',
        pdfDownloadUrl: '/samples/english/wordsearch/sample-1.pdf',
      },
      {
        id: '2',
        worksheetSrc: '/samples/english/wordsearch/sample-2.jpeg',
        answerKeySrc: '/samples/english/wordsearch/sample-2-answer.jpeg',
        altText: 'Word search generator printable worksheets - word puzzles for kids with colorful themed images',
        pdfDownloadUrl: '/samples/english/wordsearch/sample-2.pdf',
      },
      {
        id: '3',
        worksheetSrc: '/samples/english/wordsearch/sample-3.jpeg',
        answerKeySrc: '/samples/english/wordsearch/sample-3-answer.jpeg',
        altText: 'Free word search worksheets - sight words worksheets and phonics practice for first grade kids',
        pdfDownloadUrl: '/samples/english/wordsearch/sample-3.pdf',
      },
      {
        id: '4',
...
The editing canvas remembers your preferences. Undo and redo buttons fix mistakes instantly. Zoom controls help you see small details. Layer controls bring elements forward or send them backward. Lock elements in place once positioned correctly. These editing tools rival expensive design software. Create professional free printable worksheets without expensive subscriptions.`,
      ...
      },
      {
        id: '3',
        icon: '🌍',
        title: 'Free Word Search Puzzles Generator: Create Printable Worksheets and Kindergarten Worksheets in 11 Languages',
...
Teachers use custom uploads for specialized vocabulary. Upload pictures of science equipment for STEM word searches. Add images of musical instruments for music class. Include sports equipment for PE vocabulary. Upload alphabet letters you created for ABC worksheets. This feature transforms generic worksheets into personalized learning materials. Students engage more with familiar images. The word search becomes relevant to their actual experiences.`,
      ...
      },
      {
        id: '5',
        icon: '💰',
        title: 'Printable Worksheets and First Grade Worksheets: Free Worksheet for Kids with Commercial License',
