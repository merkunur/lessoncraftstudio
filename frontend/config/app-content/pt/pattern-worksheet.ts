...
const content: AppContent = {
  seo: {
    primaryKeyword: 'criar e vender fichas de padrões em grelha',
    secondaryKeywords: [
    ...
    lsiKeywords: [
      'produtos digitais fichas de sequências lógicas para empreendedores',
      'fichas de reconhecimento de padrões imprimíveis uso comercial',
      'gerador de fichas de padrões nove tipos de sequências',
    ],
  ...
  businessUseCases: {
    title: 'Como Vender Fichas de Padrões Online',
    cases: [
      {
        title: 'Pacotes de completar padrões na Etsy',
        description:
          'Crie pacotes temáticos de completar padrões aproveitando a maior variedade disponível: nove tipos de padrões multiplicados por dois modos de pergunta dão 18 estilos de exercício distintos por tema. Agrupe animais da quinta, dinossauros, criaturas marinhas e veículos como pacotes temáticos separados com 20 a 30 fichas cada um. Estruture cada pacote com dificuldade progressiva — exercícios AB em caixa em branco primeiro, avançando para ABC e ABCD, depois repetindo a progressão em modo escolha múltipla. Inclua os gabaritos autogerados como ficheiros bónus. O formato totalmente visual com zero texto torna cada pacote vendível em todo o mundo sem tradução. Defina o preço dos pacotes temáticos individuais entre $3–$5 e dos pacotes progressivos multi-tema entre $14–$20.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Cada exercício da página tem definições independentes para tipo de padrão, modo de pergunta e tema de imagens. Pode configurar o Exercício 1 como AB caixa em branco com animais da quinta, o Exercício 2 como ABC escolha múltipla com veículos, e o Exercício 3 como ABCD caixa em branco com criaturas marinhas — tudo na mesma página. Isto significa que uma só ficha pode servir como atividade diferenciada completa com dificuldade progressiva integrada, sem necessidade de páginas separadas para cada tipo de padrão ou modo de pergunta.',
    },
    {
    ...
    {
      question: 'Como funciona o gabarito para as fichas de padrões?',
      answer:
        'O gabarito vive num separador de canvas separado, mostrando a ficha completada com todas as caixas em branco preenchidas com os elementos corretos do padrão. Para os exercícios em escolha múltipla, a resposta correta está claramente indicada. Ambos os canvas são editáveis de forma independente, pelo que pode personalizar o gabarito separadamente da ficha. A ficha e o gabarito descarregam-se como ficheiros separados, oferecendo aos compradores um pacote de produto completo com soluções verificadas.',
    },
    {
      question: 'Em que difere o Gerador de Fichas de Padrões do Trem de Padrões?',
      answer:
        'O Gerador de Fichas de Padrões usa um layout em grelha padrão com 1 a 8 exercícios configurados de forma independente por página, nove tipos de padrões (AB a ABCD) e dois modos de pergunta (caixa em branco e escolha múltipla). O Trem de Padrões apresenta um só padrão em 11 vagões de trem temáticos num formato visual distintivo com cinco tipos de padrões (AB a AABB) e um número de pistas ajustável. As Fichas de Padrões destacam-se em volume, variedade e páginas de dificuldade mista; o Trem de Padrões destaca-se em envolvimento visual com o seu formato único de vagões.',
    },
    {
    ...
    {
      question: 'O Gerador de Fichas de Padrões é sensível ao idioma?',
      answer:
        'Não. O Gerador de Fichas de Padrões é uma aplicação puramente visual — as fichas contêm apenas imagens em filas de grelha com zero texto na saída, pelo que são idênticas em todos os idiomas. Mudar o idioma apenas afeta as etiquetas da interface do gerador e as etiquetas de conteúdo da biblioteca de imagens, não a ficha em si. A Licença Comercial inclui 10 temas coloridos; o Acesso Completo desbloqueia os 104 temas e os 11 idiomas de interface.',
    },
    {
  ...
  visuals: {
    ...
    videoTitle: 'Como Criar Fichas de Padrões com Nove Tipos de Padrões e Dois Modos de Pergunta — Tutorial Passo a Passo',
  },
};
