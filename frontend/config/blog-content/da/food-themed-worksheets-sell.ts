...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'mad tema arbejdsark sælg',
    ...
    titleTag: 'Madtema Arbejdsark: En Appetitlig Niche | LessonCraftStudio',
  ...
  keyTakeaways: [
    'Madtema Arbejdsark er en profitabel niche for danske sælgere',
  ...
  internalLinks: [
    { pageType: 'app', slug: 'coloring-worksheets', anchorText: 'Mad Farvelægning' },
    { pageType: 'app', slug: 'matching-worksheets', anchorText: 'Mad Matchning' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Mad Ordsøgning' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Madtema Arbejdsark',
