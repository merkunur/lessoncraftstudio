...
const content: AppContent = {
  seo: {
    primaryKeyword: 'generatore caccia al tesoro schede',
    secondaryKeywords: [
    ...
    lsiKeywords: [
      ...
      'generatore schede direzionali uso commerciale',
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'generatore-caccia-tesoro',
      anchorText: 'Creatore di Schede Caccia al Tesoro',
    },
    {
      pageType: 'start',
  ...
  visuals: {
    heroImages: {
      primary: '/samples/italian/treasure hunt/Treasure Hunt 1.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/italian/treasure hunt/Treasure Hunt 1.webp',
      ...
      {
        src: '/samples/italian/treasure hunt/north south.webp',
      ...
      {
        src: '/samples/italian/treasure hunt/Treasure Hunt 1 answer_key.webp',
