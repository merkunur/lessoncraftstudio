  ...
  proTips: [
    {
      ...
      description: 'Os dois controlos de dificuldade independentes — tamanho de grelha (2×2 a 4×4) e caselas-dica (1–5) — criam um amplo espectro de níveis de desafio a partir de uma única imagem. Uma grelha de 2×2 com 3 dicas deixa apenas 1 peça por associar: um aquecimento trivial. Uma grelha de 4×4 com 1 dica requer associar 15 peças: um desafio genuíno de raciocínio espacial. Crie pacotes de dificuldade graduada começando fácil e reduzindo progressivamente as dicas enquanto aumenta o tamanho da grelha. Os pacotes diferenciados vendem-se melhor do que os de dificuldade única porque os professores precisam de puzzles para salas de aula com competências mistas.',
    },
    {
    ...
    },
    {
      ...
      description: 'Adapte a configuração da grelha às expectativas do comprador em cada mercado. Para recursos do TPT dirigidos ao pré-escolar e primeiro ano, use grelhas de 2×2 e 2×3 com 2–3 dicas para puzzles acessíveis. Para pacotes de atividades na Etsy dirigidos a pais de alunos do ensino básico, use grelhas de 3×3 com 1–2 dicas para um desafio equilibrado. Para cadernos de puzzles no KDP dirigidos a alunos mais velhos e adultos, use grelhas de 4×3 e 4×4 com 1 dica para desafios genuínos de raciocínio espacial. Adaptar a complexidade da grelha à idade do público assegura avaliações positivas e compras recorrentes.',
    },
  ],
