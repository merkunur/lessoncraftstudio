...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Tri d\'Images | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Tri d\'Images professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche de tri d\'images par catégorie',

    },
    sampleGallery: [
      { src: '/samples/english/picture sort/Picture Sort 1.jpeg', alt: 'Exercice de tri par catégorie', caption: 'Trier par catégorie' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Tri d\'Images thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Tri d\'Images est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'picture-sort', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Tri d\'Images Gratuit' },
