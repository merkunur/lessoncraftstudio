...
const content: BlogContent = {
  ...
  hero: {
    title: 'Neujahrs-Druckvorlagen: Januar-Neustart nutzen',
    tagline: 'Die Neustart-Motivation im Januar fuer Druckvorlagen-Verkaeufe nutzen',
    description: 'Der Januar ist fuer viele Menschen ein Neuanfang — auch fuer Eltern und Lehrer. Neue Vorsaetze, neue Lernziele und frische Energie treiben die Nachfrage nach Druckvorlagen in die Hoehe. Winterraetsel, Zielplanungs-Arbeitsblaetter und "Neues Jahr"-Aktivitaeten finden in den ersten Januarwochen begeisterte Kaeufer. Dieser Guide zeigt die besten Produkte fuer die Januar-Saison.',
  },
  ...
  cta: {
    ...
    description: 'Erstellen Sie Neujahrs-Raetsel und Winter-Wortsuchen. Kostenlose Testversion mit Wasserzeichen.',
