...
(function (global) {
  ...
  var L = {
    ...
    /* it. Preposizioni articolate. apostrophe-free JS; §A.13.54 win praises the fusion (Due parole → una), never the child. */
    it: {
      q: 'Unisci le due parole: quale forma è giusta?',
  ...
  var ContractionActivity = {
    ...
    _injectStyle: function () {
      ...
      s.textContent = [
        ...
        '.ct-say{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;}',
        '.ct-nib{flex:0 0 auto;}',
        '.ct-line-msg{flex:0 1 auto;min-height:1.1em;text-align:center;font:700 clamp(0.88rem,2.1vw,1.14rem)/1.3 Nunito,system-ui,sans-serif;color:#146B5E;margin:0;}',
