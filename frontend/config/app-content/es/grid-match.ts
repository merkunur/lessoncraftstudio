...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          'Abre el panel de Configuración de Página y elige un tamaño de página: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal o cualquier dimensión personalizada. Selecciona un color de fondo predeterminado con el selector de color. Elige un tema de fondo y ajusta su opacidad (de 0 a 1 en pasos de 0,05), luego elige un tema de borde con su propio control de opacidad independiente. Estas opciones de diseño enmarcan tu puzzle de cuadrícula antes de configurar el contenido. Nota: el formato Cuadrado no está disponible para el Puzzle de Cuadrícula.',
      },
      {
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Creador de Puzzles de Cuadrícula',
    },
    {
      pageType: 'start',
