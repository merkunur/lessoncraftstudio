...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Twee businessmodellen met verschillende voor- en nadelen',
    description: 'Twee businessmodellen met verschillende voor- en nadelen. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
