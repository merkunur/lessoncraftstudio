...
const content: GuideContent = {
  ...
  tutorial: [
    {
      heading: 'Compreenda o mercado de livros de atividades de matemática KDP',
  ...
  platformTips: [
    ...
    {
      heading: 'Otimize as suas categorias de pesquisa para visibilidade',
      content: 'O sistema de categorias de pesquisa da Amazon determina em que prateleiras virtuais o seu livro aparece. Durante a publicação, o KDP oferece duas ranhuras de categoria, mas pode solicitar até 10 categorias através do suporte do KDP após a publicação. Para livros de atividades de matemática, aponte tanto para categorias amplas (Livros de matemática infantis) como específicas (Aritmética infantil, Livros de atividades infantis). Aparecer em múltiplas categorias relevantes aumenta as suas possibilidades de posicionar em listas de categoria — um livro que posiciona no top 20 de uma subcategoria específica ganha uma insígnia de mais vendido que aumenta significativamente as taxas de cliques nos resultados de pesquisa.',
    },
  ],

  monetization: [
    {
      heading: 'Maximize as regalias através de preços estratégicos',
      content: 'Os ajustes pequenos de preço criam mudanças desproporcionadas nas regalias no KDP. Devido ao fato de os custos de impressão serem fixos por cópia, cada dólar que adiciona ao preço de catálogo gera aproximadamente 0,60 dólares em regalia adicional na taxa de 60 por cento. Um livro com preço de 7,99 em vez de 6,99 ganha aproximadamente 60 cêntimos mais por venda. Ao longo de 100 vendas por mês, esse aumento de preço de um único dólar adiciona 60 dólares em receitas mensais. Teste diferentes pontos de preço mensalmente e monitorize o impacto tanto no volume de vendas como nos ganhos totais de regalias. Muitos editores descobrem que aumentos moderados de preço (de 1 a 2 dólares acima da média da categoria) não reduzem significativamente o volume de vendas enquanto aumentam substancialmente o lucro por venda.',
    },
    {
    ...
    },
    {
      ...
      content: 'O conteúdo de matemática que cria para livros KDP pode ser reutilizado para outros canais de receitas sem criação de conteúdo adicional. Venda atividades individuais como transferências digitais no Etsy para compradores que querem PDFs personalizáveis em vez de livros físicos. Crie pacotes temáticos para o seu próprio sítio web. Os geradores de atividades produzem conteúdo que funciona tanto em formatos de transferência digital como de livro encadernado. Esta abordagem multiplataforma significa que cada hora dedicada a criar conteúdo de matemática gera receitas na Amazon, no Etsy e em canais de venda direta simultaneamente. Consulte o guia sobre vender atividades de matemática no Etsy para estratégias de otimização específicas da plataforma.',
    },
  ],

  examples: [
    {
      heading: 'Exemplo: Livro de atividades de adição para o pré-escolar',
      content: 'Um livro de atividades de adição de 52 páginas para o pré-escolar dirigido a idades de 4 a 6 anos. O interior usa corte de 8,5 × 11 polegadas com margens de 0,5 polegadas. As páginas 1 a 20 apresentam problemas de adição baseados em imagens gerados com a ferramenta de adição usando temas de animais, alimentos e veículos no intervalo numérico de 1 a 5. As páginas 21 a 40 progridem para o intervalo de 1 a 10 com grelhas de puzzles matemáticos para variedade. As páginas 41 a 48 proporcionam uma secção de revisão mista. As páginas 49 a 52 contêm chaves de respostas para todas as atividades. A capa apresenta cores primárias vivas com texto grande que diz \"Adição divertida para o pré-escolar\" e um subtítulo \"Atividades de matemática com imagens, puzzles e prática — Idades 4 a 6\". Preço de 7,99 dólares na Amazon EUA com um custo de impressão de aproximadamente 3,25 dólares, produzindo uma regalia de aproximadamente 1,54 dólares por venda. Os 7 campos de palavras-chave apontam para frases como \"caderno adição pré-escolar\", \"livro atividades matemática idades 4 5 6\" e \"problemas matemática com imagens pré-escolar infantil\".',
    },
    {
      heading: 'Exemplo: Caderno de matemática multi-operação para o primeiro ano',
      content: 'Um caderno de matemática de 68 páginas para o primeiro ano que cobre adição, subtração e comparação de números. O livro está organizado em quatro secções: adição (páginas 1 a 20, criadas com o gerador de adição no intervalo 1 a 20), subtração (páginas 21 a 40, criadas com o gerador de subtração), atividades de comparação (páginas 41 a 50, criadas com o gerador Mais ou menos), e uma secção de revisão mista com puzzles matemáticos (páginas 51 a 60, criadas com o gerador de puzzles matemáticos). As páginas 61 a 68 proporcionam chaves de respostas integrais. Usando corte de 8,5 × 11 polegadas, formatação sem sangria e interior a preto e branco. O design de capa usa um modelo consistente que coincide com o livro do pré-escolar (construindo reconhecimento de série) com o título \"Prática de matemática do primeiro ano: Adição, subtração e comparação de números\". Preço de 8,99 com um custo de impressão de aproximadamente 3,55 dólares, produzindo uma regalia de aproximadamente 1,84 dólares por venda. Este maior número de páginas e alcance multi-operação justificam o ponto de preço mais alto comparado com o livro de operação única do pré-escolar.',
    },
  ],

  faq: [
    {
      question: 'Preciso de um ISBN para publicar um livro de atividades de matemática no KDP?',
      answer: 'Não. A Amazon fornece um ISBN gratuito para cada capa mole do KDP sem custo para si. Este ISBN atribuído pela Amazon só pode ser usado para distribuição através da Amazon. Se quiser vender o seu livro através de outros retalhistas ou distribuidores, pode comprar o seu próprio ISBN à sua agência nacional de ISBN e introduzi-lo durante o processo de publicação do KDP. Para a maioria dos editores que começam no KDP, o ISBN atribuído pela Amazon é suficiente e mantém os seus custos iniciais em zero.',
    },
    {
      question: 'Qual é o número ideal de páginas para um livro de atividades de matemática KDP?',
      answer: 'Entre 40 e 80 páginas interiores funciona melhor para a maioria dos livros de atividades de matemática. Abaixo de 40 páginas, os compradores percecionam o livro como demasiado fino para o preço e deixam avaliações negativas sobre o valor. Acima de 80 páginas, os custos de impressão aumentam significativamente, reduzindo a sua regalia por venda. Um livro de 50 a 60 páginas é o ponto ideal para livros de atividades de matemática — proporciona conteúdo suficiente para prática substancial, mantém os custos de impressão manejáveis e permite preços competitivos entre 6,99 e 8,99 dólares.',
    },
    {
      question: 'Posso atualizar o meu livro KDP depois de o publicar?',
      answer: 'Sim. O KDP permite-lhe atualizar o seu manuscrito, capa, descrição, palavras-chave, preços e categorias em qualquer momento após a publicação. As mudanças de manuscrito e capa passam por um processo de revisão que tipicamente demora de 24 a 72 horas, durante o qual o seu livro permanece disponível para venda com a versão atual. As mudanças de metadados como descrição e atualização de palavras-chave geralmente surtem efeito em poucas horas. Esta flexibilidade permite-lhe corrigir erros, melhorar o conteúdo com base nos comentários dos clientes e otimizar o seu anúncio com base em dados reais de desempenho de vendas sem nunca retirar o seu livro do marketplace.',
    },
    {
      question: 'Como se comparam as regalias KDP com os ganhos do Etsy pelo mesmo conteúdo de matemática?',
      answer: 'A economia por unidade difere significativamente. No Etsy, uma transferência digital de 4,99 dólares gera aproximadamente 4,00 dólares após as comissões do Etsy com zero custo de produção por venda. No KDP, um livro de atividades de 7,99 dólares gera aproximadamente de 1,50 a 2,00 dólares após os custos de impressão e a taxa de regalia. No entanto, a Amazon tem um volume de tráfego muito maior e visibilidade orgânica através de pesquisas e recomendações. Muitos editores descobrem que as menores regalias por unidade do KDP se compensam com um maior volume de vendas. A estratégia ótima é vender em ambas as plataformas — transferências digitais no Etsy e livros físicos no KDP — alcançando diferentes segmentos de compradores a partir do mesmo conteúdo.',
    },
    {
      question: 'Devo usar interior a cores ou a preto e branco para livros de atividades de matemática?',
      answer: 'O interior a preto e branco é a escolha padrão para livros de atividades de matemática no KDP. A impressão a cores aumenta o custo por página drasticamente — um livro a cores de 50 páginas custa aproximadamente de 3 a 4 vezes mais a imprimir do que a preto e branco, o que ou força um preço de catálogo muito maior ou reduz a sua regalia a quase zero. A maioria dos livros de atividades de matemática usa interiores a preto e branco com uma capa a cores. Desenhe as páginas das suas atividades com alto contraste para que se reproduzam claramente em escala de cinzentos. Se usar ilustrações temáticas dos geradores, verifique que permaneçam visualmente distintas e atrativas na impressão a preto e branco.',
    },
    {
      question: 'Quanto tempo demora um livro KDP a aparecer na Amazon depois de o publicar?',
      answer: 'A revisão do KDP tipicamente demora de 24 a 72 horas para livros novos. Os editores estreantes podem experimentar tempos de revisão ligeiramente mais longos enquanto a Amazon verifica os detalhes da conta e o conteúdo. Após a aprovação, o seu livro geralmente aparece nos resultados de pesquisa da Amazon dentro de 24 horas, embora ocasionalmente possa demorar até 5 dias para a indexação completa em todas as funcionalidades da Amazon incluindo sugestões de pesquisa e navegação por categorias. Encomende a sua cópia de prova antes de enviar a versão final para que não esteja à espera tanto da revisão como do envio simultaneamente.',
    },
    {
      question: 'Qual é a política de reembolso para licenças comerciais usadas para criar livros KDP?',
      answer: 'Cada gerador oferece um teste grátis com marca de água para que possa avaliar completamente a ferramenta antes de comprar. Crie atividades completas com todas as funcionalidades, teste diferentes temas e configurações, verifique a qualidade de impressão a 300 DPI e confirme que o resultado cumpre os requisitos de formatação do KDP. Como pode avaliar exaustivamente o produto antes de comprar, todas as vendas de licenças comerciais são definitivas. Esta é uma prática padrão para ferramentas de produtos digitais onde a funcionalidade completa pode ser pré-visualizada antes da compra.',
    },
  ],
  ...
  nextSteps: [
    ...
    {
      slug: 'formatacao-kdp-atividades',
      title: 'Guia de formatação KDP para livros de atividades',
      description: 'A referência detalhada de formatação para converter atividades em manuscritos prontos para KDP. Cobre tamanhos de corte, especificações de margens, configurações de sangria, exportação de PDF e resolução de rejeições comuns de formatação.',
    },
    {
      slug: 'vender-atividades-matematica-etsy',
      title: 'Vender atividades de matemática no Etsy',
      description: 'Reutilize o seu conteúdo de matemática para transferências digitais no Etsy. Vender as mesmas atividades como PDFs individuais no Etsy e como livros encadernados no KDP maximiza as receitas de cada peça de conteúdo que cria.',
    },
  ],
  ...
  internalLinks: [
    ...
    { pageType: 'guide', slug: 'formatacao-kdp-atividades', anchorText: 'Guia de formatação KDP para livros de atividades' },
  ...
  toolsRecommended: [
    {
      ...
      description: 'A fonte de conteúdo principal para livros de atividades de matemática. Cria atividades de adição baseadas em imagens com ilustrações temáticas e chaves de respostas automáticas — a competência de matemática mais popular para livros de atividades KDP dirigidos desde o pré-escolar até ao segundo ano.',
    },
    {
      appId: 'subtraction',
    ...
    },
    {
      ...
      description: 'Adiciona variedade atrativa de puzzles aos livros de atividades para além das páginas padrão de exercícios. Os puzzles matemáticos com grelha quebram o formato de atividades e aumentam o valor percecionado, conduzindo a melhores avaliações na Amazon.',
    },
    {
    ...
    {
      appId: 'more-less',
      title: 'Gerador de atividades Mais ou menos',
  ...
  visuals: {
    heroImage: { src: '/samples/portuguese/addition/Adição Divertida 1.webp', alt: 'Atividade de adição mostrando problemas de matemática com imagens adequados para páginas interiores de livros de atividades Amazon KDP' },
    samples: [
