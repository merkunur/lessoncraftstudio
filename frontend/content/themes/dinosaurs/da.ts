...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Dinosaurer',
  title: 'Gratis dinosaur-arbejdsark til børn | LessonCraftStudio',
  description: 'Lav printbare dinosaur-arbejdsark til børn. T-Rex, Triceratops, Stegosaurus og mange flere. Matematik, læsning, puslespil og tegning fra førskole til 3. klasse.',
  keywords: 'dinosaur arbejdsark, dinosaur aktiviteter børn, dinosaur matematik arbejdsark, dinosaur farvelægningsark, printbare dinosaur arbejdsark, T-Rex arbejdsark',
  heading: 'Gratis dinosaur-arbejdsark til børn',
