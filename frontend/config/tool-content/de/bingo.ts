...
const content: ToolContent = {  seo: {
  ...
  whatYouCanCreate: [
    ...
    {
      title: 'Unterrichtsfertige Bingo-Spiel-Sets',
      description: 'Bauen Sie komplette Bingo-Spiel-Sets für den Unterricht mit 10 einzigartigen Spielerkarten und einem Ansageblatt pro Set. Lehrkräfte, die nach Bingo-Aktivitäten suchen, schätzen Produkte, die sofort spielbereit sind — Karten drucken, austeilen und das Spiel starten. Verwenden Sie die Wort-Füllung mit Lehrplanvokabular für Sprachübungen, die Bild-Füllung für visuelle Erkennung oder gemischte Modi für differenzierten Unterricht. Die benutzerdefinierte Ansage-Auswahl lässt Sie genau festlegen, welche Vokabelelemente im Spiel erscheinen — für präzise Lehrplananpassung.',
    },
    {
  ...
  businessIdeas: [
    ...
    {
      title: 'Lehrermarktplatz-Bingo-Aktivitätspakete',
      description: 'Laden Sie Bingo-Aktivitätspakete für den Unterricht auf den Lehrermarktplatz hoch, mit einzigartigen Spielerkarten und Ansageblättern als wichtigste Verkaufsargumente. Lehrkräfte, die nach Bingo-Aktivitäten suchen, schätzen Produkte, die sofort spielbereit sind — drucken, austeilen und das Spiel starten. Erstellen Sie lehrplanorientierte Sets: Vokabel-Bingo mit Wort-Füllung, Bilderkennung-Bingo mit Bild-Füllung und Mischform-Bingo für differenzierten Unterricht. Bieten Sie 10 einzigartige Karten pro Set mit Ansageblatt. Die Wort-Füllung mit lokalisierten Bildnamen macht Bingo zu einer Vokabelwiederholungs-Aktivität für Sprachunterricht, Sachkunde-Vokabular und thematische Einheiten.',
      platform: 'Lehrermarktplatz',
    },
    {
      title: 'Pinterest-Bingo-Karten-Traffic-Trichter',
      description: 'Bingo-Karten ergeben visuell ansprechende Pinterest-Pins — das farbenfrohe Rasterlayout mit thematischen Bildern und runden Chips schafft ein sofort erkennbares Spielformat, das Eltern und Lehrkräfte lieben. Pinnen Sie Beispiel-Bingo-Karten mit verschiedenen Themen: Tier-Bingo für Vorschul-Pinnwände, Feiertags-Bingo für saisonale Pinnwände und Wort-Bingo für Bildungs-Pinnwände. Erstellen Sie separate Pin-Serien für „Bilder-Bingo-Druckvorlagen“, „Unterrichts-Bingo-Spiele“ und „Feiertags-Bingo-Aktivitäten“. Bingo ist ein universell bekanntes Spiel, sodass Pins Zielgruppen in jedem Land und jeder Sprache ansprechen. Verlinken Sie jeden Pin zu Ihren Etsy- oder Lehrermarktplatz-Listings.',
      platform: 'Pinterest',
    },
    {
  ...
  proTips: [
    ...
    {
      title: 'Benutzerdefinierte Ansage-Auswahl für Lehrplananpassung nutzen',
      description: 'Aktivieren Sie das Kontrollkästchen „Benutzerdefinierte Auswahl verwenden“, um genau festzulegen, welche Bilder im Ansage-Pool erscheinen. Der Live-Zähler zeigt Ihre Auswahlanzahl an, während Sie aus der Bildbibliothek auswählen. Diese Funktion ist entscheidend für die Erstellung lehrplanorientierter Bingo-Spiele — wählen Sie nur die Vokabelwörter Ihrer Unterrichtseinheit, nur die Tiere eines bestimmten Lebensraums oder nur die Lebensmittel einer Ernährungseinheit. Die benutzerdefinierte Ansage-Auswahl verwandelt Bingo von einem zufälligen Spiel in ein gezieltes Lernwerkzeug — das ist das entscheidende Verkaufsargument für Lehrermarktplatz-Unterrichtsprodukte.',
    },
    {
