...
const content: BlogContent = {
  ...
  hero: {
    title: 'Créer un cahier d\'activités KDP de A à Z',
    tagline: 'Du fichier Word au livre Amazon en un week-end',
    description: 'Guide complet pour créer et publier un cahier d\'activités sur Amazon KDP. De la conception à la vente. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour créer cahier activités KDP de A à Z. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
