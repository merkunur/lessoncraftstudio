...
const content: BlogContent = {
  ...
  hero: {
    title: 'Como Usar Imagenes Tematicas para Vender Mas Fichas',
    tagline: 'Las imagenes tematicas transforman fichas genericas en productos irresistibles',
    description: 'Una ficha de suma con numeros genericos compite con miles de productos identicos. La misma ficha de suma con dinosaurios, unicornios o animales marinos se convierte en un producto unico y atractivo. Las imagenes tematicas son el diferenciador mas efectivo y accesible para vendedores de imprimibles. Le permiten crear variaciones infinitas del mismo contenido educativo.',
  },
  category: 'how-to',
