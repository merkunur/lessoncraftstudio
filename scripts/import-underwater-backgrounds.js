/**
 * Background Import Script: Underwater
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-underwater-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'underwater_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/underwater',
  displayNames: {
    en: 'Underwater',
    de: 'Unterwasser',
    fr: 'Sous-marin',
