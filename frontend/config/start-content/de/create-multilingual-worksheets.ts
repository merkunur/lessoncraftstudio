...
const content: StartContent = {
  ...
  hero: {
    title: 'Mehrsprachige Arbeitsblätter erstellen und verkaufen',
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Bildbeschriftungen werden in allen 11 Sprachen lokalisiert. Zähl-Arbeitsblätter mit deutschen Objektnamen, französischen Beschriftungen oder spanischem Vokabular schaffen wirklich gestufte internationale Produkte.',
    },
  ],
