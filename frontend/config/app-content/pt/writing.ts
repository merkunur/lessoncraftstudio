...
const content: AppContent = {
  seo: {
    primaryKeyword: 'atividades de coordenação motora para imprimir',
    secondaryKeywords: [
      'gerador de caligrafia',
      'pontilhado para imprimir',
      'atividades de escrita para imprimir',
      'treino de letra para imprimir',
    ],
    lsiKeywords: [
      'traçado',
      'letras',
