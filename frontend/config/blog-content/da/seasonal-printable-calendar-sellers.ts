...
const content: BlogContent = {
  ...
  internalLinks: [
    ...
    { pageType: 'app', slug: 'picture-bingo-worksheets', anchorText: 'Banko Generator' },
  ...
  cta: {
    heading: 'Kom I Gang Med Sæsonkalender for Printable-Sælgere i Danmark',
