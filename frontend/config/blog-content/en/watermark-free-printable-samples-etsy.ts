...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'watermark printables for Etsy',
    secondaryKeywords: [
      'watermarked samples printable marketing',
      'free trial printable samples Etsy',
      'printable product preview strategy',
    ],
    lsiKeywords: [
  ...
  cta: {
    heading: 'Generate Watermarked Samples in Seconds',
    description: 'LessonCraftStudio generators produce worksheets with professional watermarks in free trial mode. Create sample packs instantly to boost your Etsy marketing.',
    buttonText: 'Try Any Generator Free Trial',
    buttonUrl: '/apps',
  },
};
