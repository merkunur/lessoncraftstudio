...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit Traçage de Lignes | PDF Imprimables',
    metaDescription: 'Créez des fiches de traçage lignes gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit traçage lignes',
    secondaryKeywords: ["fiches graphisme lignes gratuit","traçage maternelle PDF","exercices graphomotricité gratuit","relier points à imprimer","préécriture lignes gratuit"],
    lsiKeywords: ["graphisme","tracé","coordination","préhension","dextérité","motricité","contrôle geste","préparatoire"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/drawing lines/Drawing Lines 1.jpeg',
      primaryAlt: 'Fiche traçage lignes gratuite',
    },
    sampleGallery: [
      { src: '/samples/english/drawing lines/Drawing Lines 1.jpeg', alt: 'Traçage lignes', caption: 'Tracer des lignes' }
    ],
    youtubeId: 'gQEk7dPTZUA',
    videoTitle: 'Comment créer des fiches de traçage lignes gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit Traçage de Lignes',
    tagline: 'Créez des fiches de traçage lignes et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de traçage lignes transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de traçage lignes autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de traçage lignes en 10 étapes',
    steps: [
  ...
  faq: [
    { question: 'Ce générateur de traçage lignes est-il vraiment gratuit ?', answer: 'Oui. La version gratuite inclut toutes les fonctionnalités — tous les modes, les 104 thèmes, l\'export PDF et les corrigés. La seule différence est un petit filigrane sur les fichiers exportés. Utilisez la version gratuite indéfiniment sans créer de compte.' },
  ...
  internalLinks: [
    { slug: 'gratuit-tracer-lignes-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit Traçage de Lignes' },
    { slug: 'drawing-lines', pageType: 'app' as const, anchorText: 'Générateur Traçage de Lignes — Détails complets' },
  ],
};
