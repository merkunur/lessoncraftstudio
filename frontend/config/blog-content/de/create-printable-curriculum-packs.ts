...
const content: BlogContent = {
  ...
  faq: [
    {
      ...
      answer: 'Die meisten Tipps koennen Sie innerhalb einer Stunde umsetzen. Fuer eine vollstaendige Optimierung planen Sie einen Tag ein. Die Ergebnisse zeigen sich oft innerhalb einer Woche.',
    },
    {
      question: 'Brauche ich technische Vorkenntnisse?',
      answer: 'Nein. Alle Schritte sind auch fuer Anfaenger verstaendlich. Der Arbeitsblatt-Generator von LessonCraftStudio uebernimmt den technischen Teil.',
    },
    {
      question: 'Funktioniert das auch fuer bestehende Listings?',
      answer: 'Ja, besonders gut sogar. Bestehende Listings haben bereits Etsy-Historie und profitieren ueberproportional von Optimierungen.',
    },
  ],
  internalLinks: [
  ...
  cta: {
    heading: 'Jetzt umsetzen',
    description: 'Testen Sie den Arbeitsblatt-Generator und setzen Sie die Tipps aus diesem Guide sofort um. Kostenlose Testversion mit Wasserzeichen.',
