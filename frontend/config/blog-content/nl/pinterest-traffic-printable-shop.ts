...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Pinterest is de belangrijkste externe verkeersbron voor printable verkopers',
    description: 'Pinterest is de belangrijkste externe verkeersbron voor printable verkopers. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
