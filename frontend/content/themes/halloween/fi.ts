...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'first-grade': {
      ...
      snippetAnswer: 'Halloween-aiheiset työlehdet ensimmäiselle luokalle (6–7-vuotiaat) kehittävät luovaa ongelmanratkaisua pelottavien teemojen turvallisessa tutkimisessa, vahvistavat laskutaitoa halloween-kontekstissa sekä opettavat kulttuurien välistä vertailua suomalaisen ja amerikkalaisen perinteen kautta. POPS 2014:n kulttuurikasvatuksen tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Ensimmäisellä luokalla halloween-teema siirtyy koristeaskartelusta kulttuurisen ilmiön tutkimiseen, koska kuusi- ja seitsemänvuotiaat kykenevät lukemaan ja kirjoittamaan juhlan taustasta. POPS 2014 korostaa kulttuurista moninaisuutta ja kansainvälisyyskasvatusta. Ensimmäisen luokan oppilas vertailee suomalaisia ja amerikkalaisia perinteitä: meillä on kekri, heillä halloween — mitä yhteistä, mitä erilaista? Matemaattisesti halloween tarjoaa motivoivan kontekstin: karkkien laskeminen, jakaminen, luokittelu ja tilastointi. Luova kirjoittaminen saa uuden ulottuvuuden: ensimmäisen luokan oppilas kirjoittaa oman jännityskertomuksen kokonaisilla lauseilla. Rohkeuden ja pelkojen käsittely on sosioemotionaalisesti tärkeää — halloween antaa turvallisen kontekstin pohtia pelottavia asioita. Kuvataiteellisesti asupuvun ja koristeiden suunnittelu vaatii luovaa ajattelua ja toteutustaitoa.',
      developmentalMilestones: [
        { milestone: 'Kulttuurinen vertailu (6–7-vuotiaat vertailevat suomalaisia ja kansainvälisiä perinteitä)', howWeAddress: 'Vertailutehtävät, joissa oppilas tutkii kekrin ja halloweenin yhteisiä ja erottavia piirteitä taulukon avulla, laajentavat kulttuurista ymmärrystä' },
        { milestone: 'Laskutoimitukset halloween-kontekstissa (ensimmäisen luokan oppilaat soveltavat laskutaitoa juhlavalmisteluihin)', howWeAddress: 'Karkkien laskemis-, jakamis- ja luokittelutehtävät yhdistävät matematiikan motivoivaan juhlatielanteeseen' },
        { milestone: 'Luova kirjoittaminen jännityskontekstissa (kuusi- ja seitsemänvuotiaat tuottavat lyhyitä kertomuksia)', howWeAddress: 'Jännityskertomuksen kirjoittaminen, jossa oppilas keksii hahmon, tapahtumapaikan ja yllätyksen, kehittää narratiivista kirjoitustaitoa' },
        { milestone: 'Pelkojen turvallinen käsittely (ensimmäisen luokan oppilaat pohtivat rohkeutta ja pelkoa)', howWeAddress: 'Pohdintatehtävät, joissa oppilas kirjoittaa mistä pelkää ja miten voittaa pelkonsa, yhdistävät sosioemotionaalisen oppimisen ja kirjoittamisen' },
      ],
      differentiationNotes: 'Tukea tarvitseville ensimmäisen luokan oppilaille pidä teemat positiivisina (hauska halloween, ei pelottava), rajaa laskutehtävät kymmeneen ja anna kirjoituksessa kuva-alkuistusten tueksi. Edistyneille ensimmäisen luokan oppilaille lisää kansainvälinen juhlien vertailu (halloween, kekri, Dia de los Muertos), laajenna laskut tilastointiin ja haasta kirjoittamaan pidempi jännityskertomUsI.',
      parentTakeaway: 'Ensimmäisen luokan halloween-työlehdet tekevät juhlasta oppimiskokemuksen. Laskekaa yhdessä kerIätyt karkit: montako kutakin lajia, mikä on suosikki? Tehkää yhdessä pieniI jakelulaskuja: jos jaat 12 karkkia kolmelle kaverille, montako kukin saa? Kertokaa suomalaisesta kekri-perinteestä ja vertailkaa halloweeniin. Tärkeintä on pitää juhla hauskana ja turvallisena oppimistilanteena.',
      classroomIntegration: 'Halloween-teema tarjoaa ensimmäisen luokan lokakuulle kansainvälisyyskasvatuksen teemajakson: ympäristöopissa vertaillaan juhlaperinteitä eri maissa, matematiikassa lasketaan ja tilastoidaan karkkeja, äidinkielessä kirjoitetaan jännityskertomuksia ja kuvataiteessa suunnitellaan asupuvut. POPS 2014:n kulttuurisen osaamisen ja monilukutaidon tavoitteet toteutuvat luontevasti.',
      assessmentRubric: [
        { skill: 'Kulttuurinen vertailu', emerging: 'tietää että halloween on amerikkalainen juhla', proficient: 'vertailee halloweenIa ja kekriä kahdella–kolmella kriteerillä', advanced: 'vertailee useita kulttuurien juhlia, pohtii yhteisiä arvoja ja kirjoittaa vertailutekstin' },
        { skill: 'Laskutaito juhlakontekstissa', emerging: 'laskee karkit yhteen konkreettisesti', proficient: 'luokittelee karkit ja laskee ryhmien summat itsenäisesti', advanced: 'tekee karkkitilastot, piirtää diagrammin ja vertailee määriä analyyttisesti' },
        { skill: 'Luova kirjoittaminen', emerging: 'kirjoittaa yhden lauseen jännittävästä tapahtumasta', proficient: 'kirjoittaa lyhyen jännityskertomuksen alulla, keskikohdalla ja lopulla', advanced: 'kirjoittaa monipuolisen kertomuksen käyttäen kuvailevaa kieltä, dialogia ja yllätystä' },
      ],
    },
    'second-grade': {
      ...
      snippetAnswer: 'Halloween-aiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät luovan ongelmanratkaisun taitoja suunnitteluprojektien kautta, kehittävät budjetointia ja kertolaskua juhlavalmisteluissa sekä vahvistavat kertovan tekstin kirjoittamista jännittävien tarinoiden avulla. POPS 2014:n luovan ajattelun ja äidinkielen vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla Halloween-teema muuttuu suunnitteluprojektiksi, koska seitsemän- ja kahdeksanvuotiaat kykenevät monivaiheiseen projektityöhön ja nauttivat jännittävistä tarinoista. POPS 2014:n päättötavoitteet edellyttävät luovaa ongelmanratkaisua ja monipuolista tekstien tuottamista. Toisen luokan oppilas suunnittelee Halloween-juhlat: budjetointi (koristeet, tarjoilut, asusteet), aikataulutus ja toteutus. Kertolaskun alkeet soveltuvat: 8 vierasta × 3 keksIä = 24 keksIä. Kertovan tekstin kirjoittaminen kehittyy: oppilas kirjoittaa jännittävän tarinan, jossa on alku, käänne ja loppu. Designajattelu kehittyy: oppilas suunnittelee asun materiaaleineen ja tyIövaiheineen. Kulttuurinen ymmärrys syventyy: Halloween-perinteen historia ja leviIäminen Suomeen. Matemaattisesti symmetria ja geometria yhdistyvät askarteluun: symmetriset hämähäkinverkot ja koristeet.',
      developmentalMilestones: [
        { milestone: 'Monivaiheisen juhliprojektin suunnittelu (7–8-vuotiaat hallitsevat projektityön perusvaiheet)', howWeAddress: 'Projektitehtävät, joissa oppilas suunnittelee Halloween-juhlat vaiheittain: budjetti, koristesuunnitelma, tarjoilulista ja aikataulu, kehittävät projektinhallinnan alkeita' },
        { milestone: 'Budjetointi ja kertolaskun soveltaminen (toisen luokan oppilaat laskevat juhlakustannuksia)', howWeAddress: 'Budjetointitehtävät, joissa oppilas laskee tarjoilujen ja koristeiden määrät ja hinnat kertolaskulla ja pysyy budjetissa, vahvistavat matemaattista ajattelua' },
        { milestone: 'Jännittävän tarinan kirjoittaminen (seitsemän- ja kahdeksanvuotiaat tuottavat juonellisen kertomuksen)', howWeAddress: 'Kirjoitustehtävät, joissa oppilas kirjoittaa Halloween-tarinan juonirakenteen mukaan (alku, kehittely, käänne, loppu) ja käyttää kuvailevaa kieltä, kehittävät luovaa kirjoittamista' },
        { milestone: 'Asun tai koristeen designprosessi (toisen luokan oppilaat suunnittelevat ja toteuttavat)', howWeAddress: 'Designtehtävät, joissa oppilas piirtää suunnitelman, listaa materiaalit, kirjoittaa tyIövaiheet ja arvioi lopputulosta, kehittävät suunnitteluajattelua' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa projekti yhteen osa-alueeseen (esim. vain koristeet), anna budjettiin pyöristetyt hinnat ja tarjoa tarinankirjoituksessa juonipohja. Edistyneille toisen luokan oppilaille laajenna projekti koko juhlan järjestämiseksi ryhmässa, lisää voittomarginaali-laskenta myyntipöytää varten ja haasta kirjoittamaan sarjatarina usealla luvulla.',
      parentTakeaway: 'Toisen luokan Halloween-tehtävät opettavat projektinhallintaa ja luovuutta. Suunnitelkaa yhdessä Halloween-juhlat: laskekaa budjetti, tehkää ostoslista ja toteuttakaa yhdessä. Kirjoittakaa yhdessä jännittävä tarina ja lukekaa se ääneen taskulampun valossa. Askarrelkaa asusteita kierrätysmateriaaleista. Tärkeintä on opettaa suunnittelua: mitä tarvitaan, paljonko maksaa, miten toteutetaan.',
      classroomIntegration: 'Halloween-tehtävät integroituvat toisen luokan projektioppimisjaksoon: juhlasuunnittelu yhdistää matematiikan (budjetointi, kertolasku), äidinkielen (tarinankirjoitus, ohjeteksti), kuvataiteen (koriste- ja asusuunnittelu) ja ympäristöopin (kierrätysmateriaalien käyttö). POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa Halloween-teema osoittaa luovan ongelmanratkaisun ja monilukutaidon.',
      assessmentRubric: [
        { skill: 'Projektisuunnittelu', emerging: 'osallistuu juhlan toteutukseen mutta ei suunnittele itse', proficient: 'suunnittelee juhlat vaiheittain budjetilla ja aikataululla', advanced: 'johtaa projektin suunnittelua ryhmässä, jakaa tehtävät ja seuraa edistymistä' },
        { skill: 'Kertolaskun soveltaminen budjetointiin', emerging: 'laskee yhden tuotteen hinnan mutta ei käytä kertolaskua', proficient: 'laskee tarjoilu- ja koristemäärät kertolaskulla ja pysyy budjetissa', advanced: 'optimoi budjetin vertaillen vaihtoehtoja ja laskee useita skenaarioita' },
        { skill: 'Jännittävän tarinan kirjoittaminen', emerging: 'kirjoittaa lyhyen tapahtumakuvauksen ilman juonirakennetta', proficient: 'kirjoittaa tarinan, jossa on alku, käänne ja loppu sekä kuvailevaa kieltä', advanced: 'kirjoittaa monipuolisen tarinan usealla henkilöhahmolla, yllätyksillä ja tunnelmallisilla kuvauksilla' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Halloween-aiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät kulttuurilainautumisen analyyttistä ymmärrystä ja perinteiden leviIämisen tutkimista, vahvistavat tieteellistä ajattelua pelkojen psykologian tutkimisella sekä opettavat argumentoivaa kirjoittamista kulttuuristen lainojen merkityksestä. POPS 2014:n vuosiluokkien 3–6 kulttuurisen osaamisen ja kriittisen ajattelun tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla Halloween-teema siirtyy puvustuksesta kulttuurin analyysiksi, kun kahdeksan- ja yhdeksänvuotiaat kykenevät ymmärtämään kulttuurilainautumisen prosesseja ja analysoimaan psykologisia ilmiöitä. Kulttuurilainautumisen tutkiminen: miten Halloween siirtyi Irlannista Amerikkaan ja sitten Suomeen, miten perinne muuttuu matkalla. Pelkojen psykologian tieteellinen tutkiminen: miksi kauhuelokuvat kiinnostavat, miten aivot käsittelevät pelkoa turvallisessa kontekstissa. Kertolaskusovellukset: karkkien jakaminen (9 taloa × 4 karkkia = 36 karkkia), pukujen kustannuslaskenta. Argumentoiva kirjoittaminen: onko Halloween-perinne hyvä vai huono asia Suomessa — näyttöön perustuva väittely. Tutkimusraportti vertailee Halloween-perinteitä eri maissa. Kriittinen medialukutaito kehittyy Halloween-mainonnan analyysissä.',
      developmentalMilestones: [
        { milestone: 'Kulttuurilainautumisen analyyttinen ymmärtäminen (8–9-vuotiaat tutkivat perinteiden levIäämistä)', howWeAddress: 'Kulttuurianalyysiprojektit, joissa oppilas tutkii Halloween-perinteen matkaa Euroopasta Amerikkaan ja Suomeen, analysoi muutoksia ja kirjoittaa prosessikuvauksen' },
        { milestone: 'Pelkojen psykologian tieteellinen tutkiminen (kolmannen luokan oppilaat ymmärtävät tunteita tieteellisesti)', howWeAddress: 'Psykologiatutkimusprojektit, joissa oppilas tutkii miksi pelko viehIättää turvallisessa kontekstissa, kerää tietoa lähteistä ja kirjoittaa tutkimusraportin' },
        { milestone: 'Argumentoiva kirjoittaminen kulttuurisesta lainautumisesta (kahdeksan- ja yhdeksänvuotiaat perustelevat kantansa)', howWeAddress: 'Väittelykirjoitukset, joissa oppilas pohtii Halloween-perinteen merkitystä Suomessa, kerää näyttöä puolesta ja vastaan ja kirjoittaa tasapainoisen mielipidekirjoituksen' },
        { milestone: 'Kriittinen medialukutaito Halloween-markkinoinnin analyysissä (kolmannen luokan oppilaat tunnistavat vaikutuskeinoja)', howWeAddress: 'Media-analyysitehtävät, joissa oppilas tutkii Halloween-mainontaa, tunnistaa myyntistrategioita ja kirjoittaa kriittisen analyysin kuluttajavaikutuksesta' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille yksinkertaista kulttuurianalyysi kahteen vaiheeseen, anna psykologiatutkimuksessa valmiit lähdeotteet ja tarjoa argumentoinnissa lausealoitukset. Edistyneille kolmannen luokan oppilaille laajenna kulttuurianalyysi globalisaation ilmiöksi, lisää sosiologinen näkökulma ja haasta kirjoittamaan tutkimusessee kulttuurien vuorovaikutuksesta.',
      parentTakeaway: 'Kolmannen luokan Halloween-työlehdet kehittävät kriittistä kulttuurista ajattelua. Keskustelkaa yhdessä: mistä Halloween tulee, miten se muuttui Suomeen tullessaan? Pohtikaa: miksi kauhu kiinnostaa, miten se eroaa oikeasta pelosta? Analysoikaa yhdessä kauppojen Halloween-mainoksia: mitä ne yrittIävät myydä ja miten? Tärkeintä on oppia ymmärtämään kulttuurisia ilmiöitä analyyttisesti.',
      classroomIntegration: 'Halloween-työlehdet yhdistävät kolmannen luokan ympäristöopin, äidinkielen ja historian: kulttuurilainautumisen analyysi monikulttuurisuusjaksossa, pelkopsykologian tutkimus tunnetaitojaksossa, argumentoiva kirjoittaminen mielipidekirjoitusharjoituksena ja media-analyysi monilukutaidon jaksossa. POPS 2014:n vuosiluokkien 3–6 kriittisen ajattelun ja kulttuurisen osaamisen tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Kulttuurilainautumisen ymmärrys', emerging: 'tietää että Halloween tulee ulkomailta mutta ei analysoi prosessia', proficient: 'selittää perinteen leviämisen vaiheet ja muutokset lähteisiin perustuen', advanced: 'analysoi kulttuurilainautumista laajempana ilmiönä, vertailee useita esimerkkejä ja tekee yleistyksIä' },
        { skill: 'Tieteellinen psykologiatutkimus', emerging: 'kertoo omista peloistaan mutta ei tutki ilmiötä tieteellisesti', proficient: 'tutkii pelkojen psykologiaa lähteistä, kirjoittaa raportin ja selittää mekanismeja', advanced: 'yhdistää psykologista tietoa useista lähteistä, analysoi kriittisesti ja esittää sovelluksia' },
        { skill: 'Argumentoiva kulttuurikirjoitus', emerging: 'ilmaisee mielipiteen Halloweenista ilman perustelua', proficient: 'kirjoittaa tasapainoisen mielipidekirjoituksen näyttöön perustuvilla perusteluilla', advanced: 'analysoi kulttuurista ilmiötä monipuolisesti, huomioi useita näkökulmia ja päätyy perusteltuun johtopäätökseen' },
      ],
    },
  },
