...
const content: BundleContent = {
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      { src: '/samples/italian/odd one out/trova-il-diverso-1-v10.webp', alt: 'Scheda trova l\'intruso con righe di immagini simili e una diversa', caption: 'Scheda Trova l\'Intruso' },
