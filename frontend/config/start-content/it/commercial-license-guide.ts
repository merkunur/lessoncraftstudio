...
const content: StartContent = {
  ...
  actionSteps: [
    ...
    },
    {
      ...
      description: 'Determina se venderai principalmente su Etsy, Amazon KDP, Gumroad o un altro marketplace. Questa decisione non influisce sulla tua licenza — tutte le piattaforme sono coperte — ma determina su quali formati e quantità di prodotto concentrarti.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'No. La licenza commerciale è indipendente dalla piattaforma. Una licenza copre le vendite su Etsy, Amazon KDP, Gumroad, Gumroad, Creative Fabrica, Shopify, il tuo sito web e qualsiasi altro marketplace o canale di vendita. Puoi vendere su più piattaforme contemporaneamente.',
    },
    {
