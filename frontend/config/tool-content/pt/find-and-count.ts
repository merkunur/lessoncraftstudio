...
const content: ToolContent = {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: "O tamanho da grelha controla diretamente a dificuldade do eu vejo. Uma grelha de 5×5 (25 células) cria fichas fáceis com imagens grandes e claramente visíveis — perfeita para produtos de pré-escolar. Uma grelha de 7×7 (49 células) equilibra desafio e clareza para usuários do ensino primário. Uma grelha de 10×10 (100 células) cria cenas densas e desafiantes onde encontrar objetos específicos requer esforço genuíno. Crie packs de dificuldade progressiva com secções claramente rotuladas fácil (5×5), médio (7×7) e difícil (10×10) — os compradores pagam preços premium por produtos que crescem com o usuário.",
    },
    {
