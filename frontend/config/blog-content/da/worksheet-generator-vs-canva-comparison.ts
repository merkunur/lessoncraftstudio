...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'arbejdsark generator vs Canva',
    ...
    titleTag: 'Generator vs. Canva: Hvad er Bedst? | LessonCraftStudio',
  ...
  cta: {
    heading: 'Kom I Gang Med Generator vs. Canva',
