...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare vinter-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med vintertema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Vinter-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare vinter-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'vinteroppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, snø og is, vinterdyr, vinteraktiviteter, vinterøvelser førskole, vinterens læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Vinter-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare vinter-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'vinteroppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, snø og is, vinterdyr, vinteraktiviteter, vinterøvelser barnehage, vinterens læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Vinter-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare vinter-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'vinteroppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, snø og is, vinterdyr, vinteraktiviteter, vinterøvelser 1. klasse, vinterens læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Vinter-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare vinter-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'vinteroppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, snø og is, vinterdyr, vinteraktiviteter, vinterøvelser 2. klasse, vinterens læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Vinter-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare vinter-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'vinteroppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, snø og is, vinterdyr, vinteraktiviteter, vinterøvelser 3. klasse, vinterens læring 8-9 år',
