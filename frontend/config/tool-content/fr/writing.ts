...
const content: ToolContent = {
  ...
  hero: {
    title: 'Générateur de fiches de graphisme gratuit — créez en ligne sans inscription',
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Chaque fiche d\'écriture est construite ligne par ligne, et chaque ligne possède ses propres réglages indépendants. Pour chaque ligne, sélectionnez l\'un des trois modes de pratique : le Tracé fournit des contours de lettres pleins que les utilisateurs suivent directement pour un support visuel complet. Le Tracé Progressif commence avec des lettres pleines qui s\'estompent progressivement à travers la ligne, développant l\'autonomie à chaque répétition. La Copie Guidée montre un contour léger pour une écriture quasi-autonome avec un appui visuel minimal.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    {
      title: 'Ateliers d\'Écriture Différenciés pour la vente',
      description: 'Construisez des ensembles de pratique d\'écriture par niveaux en utilisant les trois modes comme paliers de différenciation. Niveau 1 : mode Tracé avec ordre des traits fléché pour les utilisateurs apprenant la formation des lettres. Niveau 2 : Tracé Progressif pour les utilisateurs développant l\'autonomie. Niveau 3 : Copie Guidée pour les utilisateurs approchant la fluidité. Niveau 4 : lignes vierges pour l\'écriture autonome. Utilisez l\'indépendance ligne par ligne pour créer des fiches multi-modes où chaque ligne cible un niveau de compétence différent — l\'outil de différenciation ultime pour les ateliers d\'écriture. Les vendeurs paient des prix premium pour les ressources différenciées déployables auprès de plusieurs groupes de niveaux.',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Activez les niveaux de gris pour les fiches destinées aux intérieurs Amazon KDP ou à l\'impression en volume en ligne. La sortie noir et blanc coûte nettement moins cher à imprimer et les lignes de guidage restent nettes. Réservez le mode couleur pour les miniatures de listings Etsy et les téléchargements numériques où les fonds thématiques et les éléments colorés attirent les clics et génèrent des conversions.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Les tracés de pré-écriture sont des exercices de lignes basiques qui développent le contrôle moteur fin : lignes verticales (traction de haut en bas), lignes horizontales (balayage de gauche à droite), cercles (pratique de courbe continue) et lignes en zigzag (contrôle des changements de direction). Ils ciblent les utilisateurs qui ne sont pas encore prêts pour la formation des lettres — développant la force de la prise du crayon, la coordination œil-main et les mouvements musculaires spécifiques utilisés dans l\'écriture. Les exercices de pré-écriture sont prisés par les entrepreneurs de la petite enfance et les ergothérapeutes.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Les fiches d\'écriture se concentrent sur la formation des lettres — les utilisateurs tracent, copient et écrivent des lettres avec l\'instruction de l\'ordre des traits et un appui progressif. Le Train de l\'Alphabet est un exercice de reconnaissance et d\'association des lettres (relier les lettres aux images sur un train). Le Graphisme est du tracé de lignes pour le développement moteur fin sans formes de lettres. Mots Cachés, Mots Mélangés et Deviner les Mots sont des puzzles d\'orthographe et de vocabulaire. L\'écriture est le seul format qui enseigne comment former physiquement les lettres avec l\'ordre correct des traits.',
    },
    {
      question: 'Pourquoi n\'y a-t-il pas de corrigé ?',
      answer: 'Les fiches d\'écriture sont des exercices de pratique, pas des puzzles avec des solutions cachées. Les modes Tracé et Tracé Progressif eux-mêmes servent de guide — les utilisateurs tracent directement sur ou à côté des formes de lettres fournies. Il n\'y a pas de réponse dissimulée à révéler. Cela distingue le Générateur d\'Écriture des outils basés sur des puzzles comme les Mots Cachés ou le Cryptogramme, qui génèrent des corrigés montrant la solution que les utilisateurs ne pouvaient pas voir pendant l\'exercice.',
    },
    {
