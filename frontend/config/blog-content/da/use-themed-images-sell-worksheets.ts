...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'addition-worksheets', anchorText: 'Additions-Generator (100+ temaer)' },
    { pageType: 'app', slug: 'coloring-worksheets', anchorText: 'Tematisk Farvelægning' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Tematisk Ordsøgning' },
  ],
  relatedPosts: [
