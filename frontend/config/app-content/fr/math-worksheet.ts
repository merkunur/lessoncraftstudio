...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Fiches de Mathématiques | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Fiches de Mathématiques professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche de mathématiques avec opérations posées',

    },
    sampleGallery: [
      { src: '/samples/english/math worksheet/Math Worksheet 1.jpeg', alt: 'Fiche de calcul traditionnelle', caption: 'Opérations classiques' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Fiches de Mathématiques thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Fiches de Mathématiques est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'math-worksheet', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Fiches de Mathématiques Gratuit' },
