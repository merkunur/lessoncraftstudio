...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Fåglar',
  title: 'Gratis Fåglar-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara fåglar-övningar för barn. Matematik, målarbilder, ordspel och pussel med fåglartema. Förskola till årskurs 3. Gratis PDF. Ingen registrering.',
  keywords: 'fågelövningar barn, fågel arbetsblad, fågel målarbilder, fågel matematik, fågel förskola, fågel utskrivbar, fågel pussel, fågel räkning, fågel korsord, fågelarter, fåglar och bon',
  heading: 'Fågelövningar och Arbetsblad',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Fåglar-övningar Förskola | LessonCraftStudio',
      ...
      seoKeywords: 'fågelövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, fågelarter igenkänning, flyttfåglar, naturobservation, fågeluppgifter förskola, fåglars lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoKeywords: 'fågelövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, fågelarter igenkänning, flyttfåglar, naturobservation, fågeluppgifter förskoleklass, fåglars lärande 5–6 år',
    ...
    'first-grade': {
      ...
      seoKeywords: 'fågelövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, fågelarter igenkänning, flyttfåglar, naturobservation, fågeluppgifter årskurs 1, fåglars lärande 6–7 år',
    ...
    'second-grade': {
      ...
      seoKeywords: 'fågelövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, fågelarter igenkänning, flyttfåglar, naturobservation, fågeluppgifter årskurs 2, fåglars lärande 7–8 år',
    ...
    'third-grade': {
      ...
      seoDescription: 'Utskrivbara fåglar-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'fågelövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, fågelarter igenkänning, flyttfåglar, naturobservation, fågeluppgifter årskurs 3, fåglars lärande 8–9 år',
