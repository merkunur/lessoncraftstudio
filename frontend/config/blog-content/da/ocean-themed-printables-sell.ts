...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'hav tema printables sælg',
    ...
    titleTag: 'Havtema Printables: En Dyb Niche | LessonCraftStudio',
  ...
  internalLinks: [
    { pageType: 'app', slug: 'coloring-worksheets', anchorText: 'Hav Farvelægning' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Hav Ordsøgning' },
    { pageType: 'app', slug: 'matching-worksheets', anchorText: 'Hav Matchning' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Havtema Printables',
