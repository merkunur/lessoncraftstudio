...
const translations = {
  ...
  "da": {
    ...
    "cryptogram.msg.error.details": "Fejl ved generering af puslespil: {error}",
  ...
  "nl": {
    ...
    "cryptogram.msg.generate.complete": "Cryptogram succesvol gegenereerd!",
    "cryptogram.msg.cleared": "Alle inhoud is gewist.",
    "cryptogram.tab.worksheet": "Werkblad",
    "cryptogram.tab.answer": "Antwoordblad",
    "cryptogram.msg.generating": "Puzzelgegevens genereren...",
    "cryptogram.msg.generate.complete": "Werkblad succesvol gegenereerd.",
    "cryptogram.msg.generated": "Werkblad succesvol gegenereerd!",
    "cryptogram.msg.error.details": "Fout bij het genereren van de puzzel: {error}",
    "cryptogram.msg.worksheet.generated": "Werkblad succesvol gegenereerd!",
    ...
    "cryptogram.msg.generate.first": "Genereer eerst inhoud.",
    ...
    "cryptogram.msg.generate.worksheet.first": "Genereer eerst een werkblad.",
    ...
    "error.puzzle.generation": "Kon puzzel niet genereren. Probeer andere zinnen.",
  ...
  "fi": {
    ...
    "cryptogram.msg.generate.complete": "Tehtäväarkki luotu onnistuneesti.",
    "cryptogram.msg.generated": "Tehtäväarkki luotu onnistuneesti!",
  ...
  "de": {
    ...
    "cryptogram.msg.error.details": "Fehler beim Generieren des Rätsels: {error}",
  ...
  "it": {
    ...
    "cryptogram.msg.generate.complete": "Scheda esercizi generata con successo.",
    "cryptogram.msg.generated": "Scheda esercizi generata con successo!",
    "cryptogram.msg.error.details": "Errore durante la generazione del puzzle: {error}",
  ...
  "no": {
    ...
    "cryptogram.msg.generate.complete": "Arbeidsark generert.",
    "cryptogram.msg.generated": "Arbeidsark generert!",
    "cryptogram.msg.error.details": "Feil ved generering av puslespill: {error}",
  ...
  "pt": {
    ...
    "cryptogram.msg.generate.complete": "Folha de atividades gerada com sucesso.",
    "cryptogram.msg.generated": "Folha de atividades gerada com sucesso!",
    "cryptogram.msg.error.details": "Erro ao gerar o quebra-cabeça: {error}",
  ...
  "es": {
    ...
    "cryptogram.msg.generate.complete": "Hoja de ejercicios generada con éxito.",
    "cryptogram.msg.generated": "¡Hoja de ejercicios generada con éxito!",
    "cryptogram.msg.error.details": "Error al generar el rompecabezas: {error}",
  ...
  "sv": {
    ...
    "cryptogram.msg.error.details": "Fel vid generering av pusslet: {error}",
