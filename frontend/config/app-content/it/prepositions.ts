...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          'Apri il pannello di Impostazione Pagina e scegli un formato: Lettera Verticale, Lettera Orizzontale, A4 Verticale, A4 Orizzontale, Quadrato (1200×1200) o qualsiasi dimensione personalizzata. Seleziona un colore di sfondo, scegli un tema decorativo dalla libreria di immagini e regola l\'opacità per mantenere gli esercizi leggibili. Aggiungi una cornice coordinata e seleziona un modello di scheda per dare alle tue schede di preposizioni un aspetto professionale e pronto per la stampa.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Apri la Lista delle Preposizioni e seleziona quali delle otto preposizioni spaziali includere: in/dentro, su/sopra, sotto, accanto a, dietro, tra/fra, sopra e davanti a. Includi tutte e otto per un ripasso completo o riduci la selezione a due o tre per una pratica mirata su relazioni spaziali specifiche. Il generatore crea esercizi solo con le preposizioni selezionate, dandoti un controllo preciso sul contenuto della lezione.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Vai alla scheda Chiave di Risposta e clicca su Genera Chiave di Risposta per creare una versione risolta con ogni risposta di preposizione compilata. Poi apri il menu di Download ed esporta sia la scheda che la chiave di risposta in JPEG ad alta risoluzione o PDF pronto per la stampa. Attiva l\'esportazione in scala di grigi per versioni che risparmiano inchiostro. Ogni esportazione è renderizzata a oltre 400 DPI per una nitidezza perfetta, che tu stampi a casa, carichi su Etsy o includa in un libro di vocabolario spaziale su Amazon KDP.',
      },
    ],
  },

  keyFeatures: {
    title: 'Caratteristiche Principali del Generatore di Schede di Preposizioni',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Esplora una libreria di oltre 3100 illustrazioni ad alta risoluzione organizzate in 104 temi: animali, veicoli, alimenti, festività, sport, spazio, natura e molto altro. Ogni tema fornisce immagini di oggetti posizionati in relazione a una delle 8 forme geometriche. Puoi anche caricare le tue immagini personalizzate per schede con il tuo marchio. La combinazione di oggetti tematici e forme geometriche crea migliaia di permutazioni di esercizi unici — varietà sufficiente per anni di creazione di prodotti.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Il canvas Fabric.js integrato ti permette di trascinare, ridimensionare, ruotare e riposizionare ogni elemento della pagina — testo, blocchi di esercizi, immagini, forme, cornici e sfondi. Usa i controlli dei livelli per gestire l\'impilamento degli elementi, gli strumenti di allineamento per un posizionamento preciso al pixel, e il blocco per proteggere elementi posizionati mentre ne modifichi altri. Annulla e ripristina fino a 50 passaggi ti permettono di sperimentare liberamente, offrendo la flessibilità di uno strumento di grafica all\'interno di un generatore di schede di vocabolario spaziale.',
      },
    ],
  },

  businessUseCases: {
    title: 'Come Vendere Schede di Preposizioni Online',
    cases: [
      {
      ...
      {
        title: 'Libri di attività di vocabolario spaziale su Amazon KDP',
        description:
          'Compila da 50 a 100 schede di preposizioni in un libro di attività stampato in formato Amazon KDP. Usa una difficoltà progressiva, iniziando con due preposizioni (in, su) e un singolo esercizio per pagina, poi introduci gradualmente tutte e otto le preposizioni con pagine dense di otto esercizi. Alterna sezioni Completa la Frase e Scelta Multipla per una pratica varia. Aggiungi una copertina, un quadro di riferimento delle preposizioni e una sezione chiavi di risposta alla fine. I libri di vocabolario spaziale per bambini dai 4 agli 8 anni occupano una nicchia con meno concorrenza dei libri di grammatica generici.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Il generatore supporta otto preposizioni spaziali: in/dentro, su/sopra, sotto, accanto a, dietro, tra/fra, sopra e davanti a. Selezioni quali includere da una lista, potendo usare tutte e otto per un ripasso completo o ridurre la selezione a due o tre per una pratica mirata. I venditori che creano pacchetti di schede separati per ogni coppia di preposizioni possono costruire un catalogo più ampio dalla stessa applicazione, offrendo agli acquirenti opzioni di pratica mirata e aumentando il numero totale di inserzioni nel proprio negozio.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Il generatore integra un motore grammaticale per ciascuna delle 11 lingue supportate. Cerca l\'articolo corretto in base al genere del sostantivo (importante per tedesco, francese, spagnolo, portoghese e italiano), applica le regole del dativo per le preposizioni tedesche, gestisce l\'elisione francese dove gli articoli si contraggono davanti a vocali o h muta, e usa le forme plurali corrette per i nomi delle forme. Per l\'italiano, genera automaticamente le preposizioni articolate corrette (nel, nella, sul, sulla, nello, nell\'). Il risultato sono frasi fluide in ogni lingua, non traduzioni letterali forzate.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'generatore-schede-preposizioni',
      anchorText: 'Generatore di Schede di Preposizioni',
    },
    {
      pageType: 'guide',
      slug: 'creare-schede-preposizioni',
      anchorText: 'Guida per Creare Schede di Preposizioni che Vendono',
    },
    {
      pageType: 'start',
  ...
  visuals: {
    ...
    videoTitle: 'Come Creare Schede di Preposizioni con Esercizi di Immagini e Forme — Tutorial Passo a Passo',
  },
};
