...
const content: EnrichedThemeContent = {
  ...
  description: 'Utskrivbara insekter-övningar för barn. Matematik, målarbilder, ordspel och pussel med insektertema. Förskola till årskurs 3. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      ...
      seoDescription: 'Utskrivbara insekter-övningar för förskolebarn (3–4 år). Färgläggning, räkning 1–10 och finmotorik. 33 generatorer. Gratis PDF. Välj bland 3 000+ bilder.',
      seoKeywords: 'insektövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, insekters livscykel, fjärilens förvandling, småkryp, insektuppgifter förskola, insekters lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoDescription: 'Utskrivbara insektsövningar för förskoleklassbarn (5–6 år). Räkning, klassificering och ordpussel med insektsbilder. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'insektövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, insekters livscykel, fjärilens förvandling, småkryp, insektuppgifter förskoleklass, insekters lärande 5–6 år',
    ...
    'first-grade': {
      ...
      seoKeywords: 'insektövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, insekters livscykel, fjärilens förvandling, småkryp, insektuppgifter årskurs 1, insekters lärande 6–7 år',
    ...
    'second-grade': {
      ...
      seoKeywords: 'insektövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, insekters livscykel, fjärilens förvandling, småkryp, insektuppgifter årskurs 2, insekters lärande 7–8 år',
    ...
    'third-grade': {
      ...
      seoDescription: 'Utskrivbara insekter-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Hämta.',
      seoKeywords: 'insektövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, insekters livscykel, fjärilens förvandling, småkryp, insektuppgifter årskurs 3, insekters lärande 8–9 år',
