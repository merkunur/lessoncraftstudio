...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'addition-worksheets', anchorText: 'Additions-Generator (3 niveauer)' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Ordsøgning (3 niveauer)' },
    { pageType: 'app', slug: 'crossword-worksheets', anchorText: 'Krydsord (3 niveauer)' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Sværhedsgrader som Produktniveauer',
