...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'De juiste prijs maakt het verschil tussen hobbyist en ondernemer',
    description: 'De juiste prijs maakt het verschil tussen hobbyist en ondernemer. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
