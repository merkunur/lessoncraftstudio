...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    {
      title: 'Pacchetti di Cruciverba con Immagini a Tema per Collezione',
      description: 'Crea pacchetti di cruciverba con immagini organizzati per tema utilizzando le 104 collezioni — cruciverba di animali, cibo, veicoli, festività, natura e decine di altri. La Generazione Rapida per Tema seleziona automaticamente 8 immagini casuali per puzzle, quindi ogni clic produce un cruciverba unico dallo stesso tema. Crea pacchetti da 15–20 cruciverba per tema con chiavi di risposta generate automaticamente incluse. Il formato con indizi immagine rende questi cruciverba visivamente attraenti nelle miniature dei marketplace, generando tassi di clic più alti rispetto ai prodotti cruciverba solo testo.',
    },
    {
  ...
  proTips: [
    {
      title: 'Usa la Generazione Rapida per Tema per Produzione in Serie Veloce',
      description: 'La Generazione Rapida per Tema seleziona automaticamente 8 immagini casuali dal tema scelto e genera istantaneamente. Clicca Genera ripetutamente per produrre più cruciverba unici dallo stesso tema — ogni clic seleziona immagini casuali diverse, producendo parole diverse e layout di griglia diversi. Produci in serie oltre 10 cruciverba unici a tema in pochi minuti senza cambiare nessuna impostazione. Questo è il modo più veloce per creare pacchetti di cruciverba tematici per Etsy e KDP.',
    },
    {
      title: 'Usa la Modifica Manuale dei Nomi per Controllo Preciso del Vocabolario',
      description: 'Quando la Generazione Rapida per Tema produce parole troppo lunghe, troppo corte o non adatte al livello scolastico, passa alla Modifica Manuale dei Nomi. Clicca sulle singole immagini per selezionarle, poi rinomina i loro nomi visualizzati prima della generazione. Semplifica "Camion dei Pompieri" in "Camion" per puzzle più facili, o rinomina "Farfalla" in "Monarca" per vocabolario specifico di scienze. Questo colma il divario tra generazione completamente automatica e liste di parole manuali — mantieni gli indizi visivi delle immagini controllando le parole esatte nella griglia.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Il generatore utilizza un sistema doppio canvas con una scheda Foglio di Lavoro (il puzzle vuoto) e una scheda Chiave di Risposta (la griglia compilata). Il foglio di lavoro mostra la griglia del cruciverba con posizioni numerate e indizi immagine o testo — pronto per essere risolto. La chiave di risposta riproduce il layout identico e riempie ogni cella con le lettere corrette. Entrambe le versioni si esportano separatamente usando quattro pulsanti di download dedicati. La chiave di risposta si genera simultaneamente al puzzle, quindi non c\'è nessun passaggio manuale di creazione delle risposte e nessuna possibilità di soluzioni non corrispondenti.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Abilita la casella Lista Parole Personalizzata con Indizi per passare dai cruciverba con immagini ai cruciverba tradizionali con indizi di testo. Inserisci parole e i loro indizi nel formato PAROLA: testo dell\'indizio, uno per riga, con un minimo di 8 voci. Lo stesso algoritmo della griglia 15×15 posiziona le tue parole personalizzate con incroci ottimali e gli indizi di testo appaiono accanto alla griglia al posto degli indizi immagine. Questa modalità è ideale per cruciverba di vocabolario specifico per materia, pratica di ortografia, ripasso del programma o qualsiasi cruciverba dove vuoi definire il tuo contenuto senza usare la libreria di immagini.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'cruciverba-immagini-schede', anchorText: 'Cruciverba con Immagini — Dettagli Completi del Prodotto' },
  ...
  visuals: {
    heroImages: {
      primary: '/samples/italian/crossword/Cruciverba%20con%20Immagini%201.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/italian/crossword/Cruciverba%20con%20Immagini%202.webp',
      ...
      {
        src: '/samples/italian/crossword/Cruciverba%20con%20Immagini%201%20answer_key.webp',
    ...
    videoTitle: 'Come Creare Cruciverba con Immagini con Indizi Illustrati, Quattro Metodi di Input e Chiavi di Risposta Automatiche — Tutorial Passo-Passo',
  },
};
