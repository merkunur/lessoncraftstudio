...
const content: BundleContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'fichas de atividades de matemática imprimíveis para Etsy',
      'ferramentas de fichas de matemática para vendedores KDP',
    ],
    lsiKeywords: [
      'pacote de fichas de adição e subtração',
      'coleção de puzzles matemáticos imprimíveis',
      'licença comercial fichas de matemática',
  ...
  bundleBenefits: [
    ...
    },
    {
      ...
      description: 'Os seis geradores partilham o mesmo motor de design: molduras, fundos, fontes e opções de layout que combinam entre si. As suas fichas parecem pertencer a uma marca coesa, não a seis ferramentas diferentes coladas umas às outras.',
    },
    {
      title: 'Venda em todo o mundo sem tradução',
      description: 'Cinco das seis apps produzem fichas puramente visuais — apenas imagens e números, sem texto na página. Venda o mesmo PDF a compradores em qualquer país. Adição Codificada acrescenta um modo Palavra Revelada sensível ao idioma para vendedores que visam mercados em idiomas específicos.',
    },
    {
    ...
    },
    {
      ...
      description: 'Carregue os seus próprios ficheiros PNG ou JPEG em qualquer gerador para fichas personalizadas e específicas de nicho. Crie produtos em torno de temas em tendência, eventos sazonais ou pedidos específicos de clientes que nenhum modelo pré-feito pode igualar.',
    },
    {
  ...
  faq: [
    {
      ...
      answer: 'Sim. Cada gerador do pacote oferece um teste grátis com funcionalidade completa. Pode configurar definições, pré-visualizar fichas e descarregar ficheiros. As descargas de teste incluem uma marca de água. Comprar uma licença remove a marca de água para que possa vender comercialmente.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Claro. Cada gerador admite carregamentos de PNG e JPEG personalizados. Use as suas próprias ilustrações, mascotes de marca ou arte fornecida por clientes para criar fichas específicas de nicho que nenhum modelo pré-feito pode igualar.',
    },
    {
      question: 'As fichas funcionam em idiomas diferentes do português?',
      answer: 'Cinco dos seis geradores produzem fichas puramente visuais — apenas imagens e números, sem texto na página. Estas funcionam em qualquer idioma do mundo. Adição Codificada tem um modo Palavra Revelada sensível ao idioma que suporta os 11 idiomas de interface para as palavras de vocabulário descodificadas.',
    },
    {
      question: 'Qual é a diferença entre Comercial e Acesso Completo?',
      answer: 'Ambos os níveis incluem os seis geradores com descargas sem marca de água e direitos de venda comercial. Comercial dá-lhe 10 conjuntos de imagens temáticas e interface só em português. Acesso Completo desbloqueia os 104 conjuntos de imagens temáticas e os 11 idiomas de interface, incluindo vocabulário de Adição Codificada em cada idioma suportado.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sem limite. Uma vez licenciado, pode gerar tantas fichas quantas quiser nos seis geradores. Não há tarifas por descarga, limites mensais nem restrições de utilização. Muitos vendedores geram dezenas de fichas por sessão para criar pacotes temáticos de produtos. Com seis geradores e mais de 100 temas de imagens, o número de combinações únicas de fichas é praticamente ilimitado.',
    },
    {
      question: 'Preciso de software de design para usar estes geradores?',
      answer: 'Não. Os geradores funcionam inteiramente no seu navegador sem instalação, plugins nem contas necessárias. Configura definições na barra lateral, pré-visualiza o resultado em tempo real no canvas e descarrega ficheiros terminados diretamente. Não é necessário Photoshop, Canva, InDesign nem qualquer outro software. A biblioteca de molduras integrada, as opções de fundo e os controlos de layout tratam de todo o trabalho de design por si.',
    },
    {
  ...
  internalLinks: [
    ...
    { pageType: 'app', slug: 'adicao-codigo-fichas', anchorText: 'Gerador de Adição Codificada — Todos os Detalhes' },
