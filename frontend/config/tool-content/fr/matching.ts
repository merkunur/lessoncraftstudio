...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'générateur de fiches d\'appariement gratuit',
    secondaryKeywords: [
      'créer des fiches d\'appariement gratuitement en ligne',
      'fiches d\'association gratuit sans inscription',
      'générateur de fiches relier par un trait gratuit',
      'fiches d\'appariement gratuites PDF avec corrigé',
    ],
    lsiKeywords: [
  ...
  hero: {
    title: 'Fiches d\'appariement gratuites — créez en ligne',
