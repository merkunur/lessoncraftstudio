...
const content: ToolContent = {  seo: {
    primaryKeyword: 'générateur de cartes de loto gratuit images',
    secondaryKeywords: [
      'créer des cartes de loto gratuitement en ligne',
      'générateur de bingo gratuit sans inscription',
      'cartes de loto gratuites PDF avec images',
      'cartes bingo gratuites avec feuille d\'appel',
    ],
    lsiKeywords: [
  ...
  hero: {
    title: 'Cartes de loto gratuites avec images — créez en ligne',
  ...
  tutorial: {
    ...
    steps: [
      {
        title: 'Ouvrir le Générateur de Cartes Bingo',
  ...
  faq: [
    ...
    {
      question: 'Le Générateur de Cartes Bingo est-il sensible à la langue ?',
