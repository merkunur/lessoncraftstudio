...
const content: BlogContent = {
  ...
  hero: {
    title: 'Opret en Aktivitetsbog til KDP: Fra Start til Udgivelse',
    tagline: 'Din komplette guide til KDP-aktivitetsbøger',
    description: 'Amazon KDP er en af de mest profitable kanaler for printable-sælgere. Aktivitetsbøger — med arbejdsark, puslespil og farvelægning — sælger konsistent som fysiske bøger. Denne guide tager dig gennem hele processen: fra idé til publiceret bog på Amazon. Inkluderer formatering, forsidedesign, søgeordsstrategi og prissætning specifikt for det skandinaviske marked.',
  },
  category: 'how-to',
  ...
  keyTakeaways: [
    ...
    'A4-format med 80-150 sider er standard for arbejdsbøger',
    'Sort-hvid print er mere profitabelt end farve for de fleste aktivitetsbøger',
    'Danske søgeord på Amazon.de har ekstremt lav konkurrence',
    'En komplet bog kan oprettes på en dag med generatorer'
  ],
  faq: [
    { question: 'Hvor lang tid tager det at udgive en KDP-bog?', answer: 'Indholdsoprettelse: 1-2 dage med generatorer. Formatering: 2-4 timer. Forsidedesign: 1-2 timer. Amazons godkendelse: 24-72 timer. Total: 3-5 dage fra idé til live bog.' },
    { question: 'Kan jeg sælge den samme bog på dansk og engelsk?', answer: 'Ja, de tæller som to separate bøger. Opret en dansk version til Amazon.de og en engelsk version til Amazon.com. Forskellige markeder, forskellige søgeord, dobbelt indtægt.' },
  ...
  cta: {
    heading: 'Opret Din Første KDP-Aktivitetsbog',
    description: 'Generér alt indhold med LessonCraftStudios 33 generatorer. Prøv gratis med vandmærke.',
    buttonText: 'Start KDP-Produktionen',
    buttonUrl: '/apps',
  },
};
