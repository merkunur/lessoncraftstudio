...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Train de l\'Alphabet | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Train de l\'Alphabet professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Train de l\'alphabet avec wagons portant des lettres et images',

    },
    sampleGallery: [
      { src: '/samples/english/alphabet train/Alphabet Train 1.jpeg', alt: 'Train alphabet coloré', caption: 'Train de l\'alphabet illustré' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Train de l\'Alphabet thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Train de l\'Alphabet est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'prepositions', pageType: 'app' as const, anchorText: 'Générateur de Fiches de Prépositions' },
    { slug: 'alphabet-train', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Train de l\'Alphabet Gratuit' },
