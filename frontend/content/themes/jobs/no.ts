...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare yrker-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med yrkertema. Førskole til 3. klasse. Gratis PDF. Ingen registrering.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Yrker-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare yrker-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'jobb-oppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, jobbgjenkjenning, arbeidsbeskrivelser, samfunnets yrker, jobb-øvelser førskole, jobbers læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Yrker-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare yrker-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'jobb-oppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, jobbgjenkjenning, arbeidsbeskrivelser, samfunnets yrker, jobb-øvelser barnehage, jobbers læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Yrker-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare yrker-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'jobb-oppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, jobbgjenkjenning, arbeidsbeskrivelser, samfunnets yrker, jobb-øvelser 1. klasse, jobbers læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Yrker-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare yrker-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. 3 000+ tematiske bilder.',
      seoKeywords: 'jobb-oppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, jobbgjenkjenning, arbeidsbeskrivelser, samfunnets yrker, jobb-øvelser 2. klasse, jobbers læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Yrker-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare yrker-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'jobb-oppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, jobbgjenkjenning, arbeidsbeskrivelser, samfunnets yrker, jobb-øvelser 3. klasse, jobbers læring 8-9 år',
