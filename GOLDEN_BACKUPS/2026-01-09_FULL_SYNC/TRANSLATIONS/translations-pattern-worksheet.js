...
const translations = {
  "en": {
    ...
    "pattern.worksheet.generate": "Create",
    "pattern.worksheet.generate.answer": "Create Answer Key",
    "pattern.worksheet.generate.worksheet": "Create Worksheet",
    ...
    "pattern.worksheet.language.description": "Selects the language for image library content only. UI language is controlled by the main language selector in the header.",
    ...
    "pattern.worksheet.msg.answer.generated": "Answer key created!",
    ...
    "pattern.worksheet.msg.generate.content.first": "Please create content first.",
    "pattern.worksheet.msg.generate.first": "Please create a worksheet first.",
    "pattern.worksheet.msg.generate.worksheet.first": "Please create a worksheet first.",
    "pattern.worksheet.msg.generated": "Worksheet created successfully!",
  ...
  "de": {
    ...
    "pattern.worksheet.clear.all": "Alles zurücksetzen",
    ...
    "pattern.worksheet.image.library": "Bildbibliothek",
    ...
    "pattern.worksheet.language.description": "Wählt die Sprache nur für den Inhalt der Bildbibliothek aus. Die Sprache der Benutzeroberfläche wird über die Hauptsprachauswahl in der Kopfzeile gesteuert.",
    ...
    "pattern.worksheet.page.size": "Papierformat:",
  ...
  "fr": {
    ...
    "pattern.worksheet.language.description": "Sélectionne la langue pour le contenu de la bibliothèque d'images uniquement. La langue de l'interface est contrôlée par le sélecteur de langue principal dans l'en-tête.",
    ...
    "pattern.worksheet.msg.incomplete.puzzle": "L'exercice {number} est incomplet et sera créé aléatoirement.",
    ...
    "pattern.worksheet.text.tools": "Options de Texte",
  ...
  "es": {
    ...
    "pattern.worksheet.language.description": "Selecciona el idioma solo para el contenido de la biblioteca de imágenes. El idioma de la interfaz se controla mediante el selector de idioma principal en el encabezado.",
    ...
    "pattern.worksheet.msg.incomplete.puzzle": "El ejercicio {number} está incompleto y se creará aleatoriamente.",
    ...
    "pattern.worksheet.upload.button": "Seleccionar imágenes",
  ...
  "pt": {
    ...
    "pattern.worksheet.download.answer.jpeg": "Gabarito (JPEG)",
    "pattern.worksheet.download.answer.pdf": "Gabarito (PDF)",
    "pattern.worksheet.download.worksheet.jpeg": "Atividade (JPEG)",
    "pattern.worksheet.download.worksheet.pdf": "Atividade (PDF)",
    "pattern.worksheet.exercises.count": "Número de Exercícios (1-8):",
    "pattern.worksheet.generate": "Criar",
    "pattern.worksheet.generate.answer": "Criar Gabarito",
    "pattern.worksheet.generate.worksheet": "Criar Atividade",
    ...
    "pattern.worksheet.language.description": "Seleciona o idioma apenas para o conteúdo da biblioteca de imagens. O idioma da interface é controlado pelo seletor de idioma principal no cabeçalho.",
    "pattern.worksheet.msg.already.assigned": "Esta imagem já está atribuída a este exercício.",
    "pattern.worksheet.msg.answer.generated": "Gabarito criado!",
    ...
    "pattern.worksheet.msg.generate.first": "Por favor, crie primeiro uma atividade.",
    "pattern.worksheet.msg.generate.worksheet.first": "Por favor, crie primeiro uma atividade.",
    "pattern.worksheet.msg.generated": "Atividade criada com sucesso!",
    ...
    "pattern.worksheet.msg.rendering": "Criando atividade...",
    "pattern.worksheet.msg.rendering.answer": "Criando gabarito...",
    "pattern.worksheet.msg.select.asset.theme": "Selecione um tema para ver {type}s.",
    "pattern.worksheet.msg.select.theme.required": "Por favor, selecione um tema geral ou desmarque 'Usar Tema Geral da Atividade'.",
    ...
    "pattern.worksheet.overall.theme": "Tema Geral da Atividade:",
    ...
    "pattern.worksheet.page.title": "Gerador de Atividades de Padrões",
    ...
    "pattern.worksheet.tab.answer": "Gabarito",
    "pattern.worksheet.tab.worksheet": "Atividade",
    ...
    "pattern.worksheet.text.tools": "Opções de Texto",
    ...
    "pattern.worksheet.upload.button": "Escolher arquivos",
    "pattern.worksheet.upload.no.file": "Nenhum arquivo escolhido",
    "pattern.worksheet.upload.files.selected": "{count} arquivos selecionados",
    ...
    "pattern.worksheet.use.overall": "Usar Tema Geral da Atividade",
  ...
  "nl": {
    ...
    "pattern.worksheet.image.library": "Afbeeldingenverzameling",
    ...
    "pattern.worksheet.language.description": "Selecteert de taal alleen voor de inhoud van de afbeeldingenverzameling. De taal van de interface wordt geregeld door de hoofdtaalselector in de header.",
    ...
    "pattern.worksheet.msg.incomplete.puzzle": "Oefening {number} is onvolledig en zal willekeurig aangemaakt worden.",
  ...
  "sv": {
    ...
    "pattern.worksheet.download.worksheet.jpeg": "Övningsblad (JPEG)",
    "pattern.worksheet.download.worksheet.pdf": "Övningsblad (PDF)",
    ...
    "pattern.worksheet.generate.worksheet": "Skapa övningsblad",
    ...
    "pattern.worksheet.language.description": "Väljer språket endast för bildbiblioteksinnehållet. Gränssnittsspråket styrs av huvudspråkväljaren i sidhuvudet.",
    ...
    "pattern.worksheet.msg.generate.first": "Skapa ett övningsblad först.",
    "pattern.worksheet.msg.generate.worksheet.first": "Skapa ett övningsblad först.",
    "pattern.worksheet.msg.generated": "Övningsbladet har skapats!",
    "pattern.worksheet.msg.incomplete.puzzle": "Övning {number} är ofullständig och kommer att skapas slumpmässigt.",
    ...
    "pattern.worksheet.msg.rendering": "Skapar övningsblad...",
    ...
    "pattern.worksheet.msg.select.theme.required": "Välj ett övergripande tema eller avmarkera 'Använd övergripande övningsbladstema'.",
    ...
    "pattern.worksheet.tab.worksheet": "Övningsblad",
    ...
    "pattern.worksheet.use.overall": "Använd övergripande övningsbladstema",
  ...
  "da": {
    ...
    "pattern.worksheet.background.opacity": "Baggrundsgennemsigtighed:",
    ...
    "pattern.worksheet.border.opacity": "Rammegennemsigtighed:",
    ...
    "pattern.worksheet.language.description": "Vælger sproget kun til billedbiblioteksindhold. Grænsefladesproget styres af hovedsprogvælgeren i headeren.",
    ...
    "pattern.worksheet.msg.incomplete.puzzle": "Opgave {number} er ufuldstændig og vil blive oprettet tilfældigt.",
    ...
    "pattern.worksheet.text.tools": "Tekstindstillinger",
  ...
  "no": {
    ...
    "pattern.worksheet.background.opacity": "Bakgrunnssynlighet:",
    ...
    "pattern.worksheet.border.opacity": "Rammesynlighet:",
    "pattern.worksheet.border.theme": "Rammetema:",
    "pattern.worksheet.border.title": "Ramme",
    ...
    "pattern.worksheet.image.library": "Bildesamling",
    ...
    "pattern.worksheet.language.description": "Velger språket kun for bildesamlingsinnhold. Grensesnittspråket styres av hovedspråkvelgeren i toppteksten.",
    ...
    "pattern.worksheet.msg.incomplete.puzzle": "Oppgave {number} er ufullstendig og vil bli laget tilfeldig.",
    ...
    "pattern.worksheet.text.default": "Ny Tekst",
    "pattern.worksheet.text.font": "Skrifttype:",
    "pattern.worksheet.text.outline.color": "Omrissfarge:",
    "pattern.worksheet.text.outline.width": "Omriss (0-10):",
    "pattern.worksheet.text.placeholder": "Hei!",
    "pattern.worksheet.text.properties": "Egenskaper for Merket Tekst",
    "pattern.worksheet.text.size": "Størrelse:",
    "pattern.worksheet.text.tools": "Tekstinnstillinger",
    ...
    "toolbar.send.to.back": "Flytt bakest",
    "undo": "Angre (Ctrl+Z)",
    "redo": "Gjør om (Ctrl+Y)",
    "zoomIn": "Zoom inn",
    "zoomOut": "Zoom ut",
  ...
  "fi": {
    ...
    "pattern.worksheet.language.description": "Valitsee kielen vain kuvakirjaston sisällölle. Käyttöliittymän kieli ohjataan otsikon pääkielivalitsimesta.",
    ...
    "pattern.worksheet.text.tools": "Tekstivaihtoehdot",
