...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Offrez un aperçu pour construire votre audience',
    description: 'Utilisez des échantillons d\'imprimables comme lead magnet pour construire votre liste email. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour échantillons imprimables lead magnet. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
  ...
  relatedPosts: [
    { slug: 'email-list-printable-business', title: 'Liste email' },
    { slug: 'printable-bundle-strategy-etsy', title: 'Stratégie bundles' },
    { slug: 'pinterest-traffic-printable-shop', title: 'Trafic Pinterest' },
  ],
  cta: {
