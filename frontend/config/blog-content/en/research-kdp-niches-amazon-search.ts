...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'how to research KDP niches',
    secondaryKeywords: [
      'KDP niche research methodology',
      'Amazon search niche research',
      'find profitable KDP niches 2026',
    ],
    lsiKeywords: [
      'KDP competition analysis',
      'Amazon book niche demand',
      'low content book niche finder',
  ...
  cta: {
    heading: 'Found a Profitable Niche? Start Creating Content',
    description: 'Generate word searches, sudoku, crosswords, mazes, and more for your KDP books. Free trial with watermark — no signup required.',
