...
const content: StartContent = {
  ...
  mainContent: [
    ...
    {
      heading: 'Criar o Seu Primeiro Produto de Fichas Multilingue',
    ...
    {
      heading: 'Vender Fichas Multilingues no Etsy',
    ...
    {
      heading: 'Fichas Apenas Visuais: Produtos Internacionais Instantâneos',
  ...
  actionSteps: [
    ...
    },
    {
      ...
      description: 'Reveja os seus dados de vendas existentes em inglês (ou pesquise categorias de alta procura). Os tipos de fichas e temas que melhor vendem em inglês são os seus primeiros candidatos para expansão multilingue.',
    },
    {
    ...
    },
    {
      ...
      description: 'Pegue nas suas páginas para colorir, fichas de matemática e outros produtos apenas visuais existentes. Crie novas publicações com títulos e descrições em alemão usando os mesmos ficheiros PDF. Não é necessário gerar conteúdo novo.',
    },
    {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'As etiquetas de imagens localizam-se nos 11 idiomas. Fichas de contagem com nomes de objetos em alemão, etiquetas em francês ou vocabulário em espanhol criam produtos internacionais genuinamente diferenciados.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Os geradores sensíveis ao idioma (13 aplicações, incluindo caça-palavras, crucigrama e palavras desordenadas) produzem conteúdo de fichas que muda consoante o idioma selecionado — palavras, pistas e vocabulário diferentes aparecem na página. Os geradores apenas visuais (20 aplicações, incluindo colorir, matemática e Sudoku) produzem conteúdo independente do idioma — o resultado tem o mesmo aspeto independentemente da seleção de idioma.',
    },
    {
      question: 'Posso vender as mesmas fichas apenas visuais em múltiplos mercados linguísticos?',
      answer: 'Sim. As páginas para colorir, fichas de matemática, puzzles Sudoku e outros conteúdos apenas visuais usam números, imagens e formas que são universais. Pode publicar o mesmo ficheiro PDF no Etsy.de, Etsy.fr, Amazon.de e Amazon.fr com texto de publicação localizado. Não é necessário gerar conteúdo novo — apenas títulos e descrições traduzidos.',
    },
    {
      question: 'Com que idioma não inglês devo começar?',
      answer: 'O alemão é o primeiro idioma de expansão recomendado para a maioria dos vendedores. A Amazon.de é o segundo maior marketplace da Amazon a nível global, o Etsy.de tem uma base ativa de compradores de imprimíveis educativos, e a concorrência em fichas educativas em alemão é dramaticamente inferior à do inglês. O francês é o segundo idioma recomendado.',
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'O guia específico do Etsy para descargas digitais de imprimíveis. Cobre configuração de loja, SEO no Etsy, otimização de publicações e como alcançar compradores internacionais através dos domínios regionais do Etsy.',
    },
    {
      slug: 'criar-fichas-que-vendem',
      title: 'Como Criar Fichas que Vendem',
      description: 'Análise aprofundada da qualidade de criação de produtos: padrões de design, técnicas de diferenciação e os métodos que fazem as suas fichas multilingues destacarem-se da concorrência.',
    },
  ],
  ...
  internalLinks: [
    ...
    { pageType: 'app', slug: 'palavras-cruzadas-imagens-fichas', anchorText: 'Gerador de Crucigramas — Todos os Detalhes' },
