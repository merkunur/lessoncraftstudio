...
const content: BlogContent = {
  ...
  internalLinks: [
    ...
    { pageType: 'app', slug: 'tegn-og-farvelaeg-arbejdsark', anchorText: 'Tegn og Farvelæg' },
  ...
  cta: {
    heading: 'Kom I Gang Med Finmotorik-Printables',
