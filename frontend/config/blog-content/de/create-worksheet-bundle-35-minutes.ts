...
const content: BlogContent = {
  ...
  cta: {
    heading: 'Jetzt Ihr erstes Bundle erstellen',
    description: 'Testen Sie den Arbeitsblatt-Generator und erstellen Sie Ihr erstes 50-Seiten-Bundle. Kostenlose Testversion mit Wasserzeichen.',
