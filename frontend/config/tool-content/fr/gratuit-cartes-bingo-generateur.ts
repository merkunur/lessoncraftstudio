...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit de Cartes Bingo | PDF Imprimables',
    metaDescription: 'Créez des fiches de cartes bingo gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit cartes bingo',
    secondaryKeywords: ["cartes bingo à imprimer gratuit","bingo éducatif maternelle PDF","créer bingo personnalisé gratuit","jeu bingo images enfants","bingo thématique imprimable"],
    lsiKeywords: ["jeu société","loto","reconnaissance","attention","vocabulaire","animation","groupe","écoute"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/bingo/bingo_card word.jpeg',
      primaryAlt: 'Carte bingo gratuite personnalisée',
    },
    sampleGallery: [
      { src: '/samples/english/bingo/bingo_card word.jpeg', alt: 'Bingo personnalisé', caption: 'Bingo avec mots' }
    ],
    youtubeId: 'd6AOiDXoK1c',
    videoTitle: 'Comment créer des fiches de cartes bingo gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit de Cartes Bingo',
    tagline: 'Créez des fiches de cartes bingo et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de cartes bingo transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de cartes bingo autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de cartes bingo en 10 étapes',
    steps: [
  ...
  internalLinks: [
    { slug: 'gratuit-cartes-bingo-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit de Cartes Bingo' },
    { slug: 'bingo', pageType: 'app' as const, anchorText: 'Générateur de Cartes Bingo — Détails complets' },
  ],
};
