...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de l\'Intrus | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches l\'Intrus professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche trouver l\'intrus avec groupes d\'images',

    },
    sampleGallery: [
      { src: '/samples/english/odd one out/Odd One Out 1.jpeg', alt: 'Exercice trouver l\'intrus', caption: 'Trouver l\'intrus' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches l\'Intrus thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de l\'Intrus est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'odd-one-out', pageType: 'tool' as const, anchorText: 'Essayer Générateur de l\'Intrus Gratuit' },
