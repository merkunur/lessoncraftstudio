...
const content: ToolContent = {
  ...
  tutorial: {
    title: 'Come Creare Schede di Confronto Dimensioni in 8 Semplici Passaggi',
    steps: [
      {
        title: 'Apri il Generatore Schede Grande e Piccolo',
        description: 'Clicca "Prova Gratuita Ora" per avviare il generatore nel tuo browser. Lo strumento si carica istantaneamente con una barra laterale delle impostazioni a sinistra e un\'anteprima live del canvas a destra. Nessuna creazione di account, nessun download di software, nessuna installazione necessaria — inizia a creare schede di confronto dimensioni immediatamente.',
      },
      {
        title: 'Imposta il Layout di Pagina e lo Sfondo',
        description: 'Nella sezione Impostazione Pagina, seleziona la dimensione della pagina: Letter Verticale, Letter Orizzontale, A4 Verticale, A4 Orizzontale, Quadrato (1200×1200), o inserisci una dimensione personalizzata. Scegli un colore di sfondo, seleziona un tema decorativo dalla libreria immagini con opacità regolabile, e aggiungi una cornice con controllo dell\'opacità indipendente. Queste impostazioni di layout danno alle tue schede un aspetto professionale e personalizzato prima di aggiungere qualsiasi esercizio.',
      },
      {
      ...
      },
      {
        ...
        description: 'Sfoglia 104 collezioni tematiche di immagini con oltre 3.100 illustrazioni — animali, cibo, veicoli, natura, festività, professioni e decine di altri. Ogni tema fornisce immagini visivamente coordinate che funzionano insieme negli esercizi di confronto dimensioni. Oppure carica le tue immagini personalizzate per schede specifiche per argomento. Attiva o disattiva i numeri degli esercizi e le caselle indicatrici delle risposte per personalizzare il layout della scheda.',
      },
      {
  ...
  whatYouCanCreate: [
    {
      title: 'Pacchetti Tematici di Confronto Dimensioni',
      description: 'Crea set di 10–20 schede di confronto dimensioni raggruppate per tema — animali della fattoria, dinosauri, creature marine, veicoli, cibo e altro. Varia il tipo di domanda nel set per difficoltà progressiva: inizia con esercizi Cerchia il Grande con 2 immagini identiche, avanza a esercizi Cerchia il Medio con 3 immagini diverse, e concludi con esercizi di Numerazione 1–2–3. Includi chiavi di risposta auto-generate per ogni scheda. Il formato completamente visivo senza testo significa che ogni pacchetto si vende in tutto il mondo senza traduzione — un singolo annuncio serve ogni mercato su Etsy.',
    },
    {
      title: 'Quaderni di Apprendimento Precoce per KDP',
      description: 'Compila 60–100 esercizi di confronto dimensioni in un quaderno stampato per Amazon KDP. Struttura i capitoli come progressione di abilità: il Capitolo 1 copre Cerchia il Grande con 2 immagini identiche, il Capitolo 2 passa a immagini diverse, il Capitolo 3 introduce Cerchia il Piccolo, il Capitolo 4 aggiunge Cerchia il Medio con 3 immagini, e il Capitolo 5 avanza agli esercizi di numerazione. Chiavi di risposta in fondo. Il formato visivo senza testo non necessita traduzione per i marketplace KDP internazionali — pubblica lo stesso contenuto ovunque.',
    },
    {
    ...
    },
    {
      ...
      description: 'Poiché le schede Grande e Piccolo contengono solo immagini senza testo sull\'output, lo stesso identico prodotto funziona in ogni lingua senza modifiche. Crea un set di esercizi di confronto dimensioni e vendilo ad acquirenti in tutto il mondo — nessuna traduzione, nessuna versione linguistica separata, nessun annuncio duplicato da mantenere. Questo è un vantaggio concreto rispetto ai generatori di schede basati sul testo dove ogni prodotto necessita localizzazione. Una singola sessione di creazione produce un prodotto universalmente vendibile per ogni marketplace.',
    },
    {
      title: 'Bundle Confronto Modalità Immagine',
      description: 'Raddoppia la tua gamma di prodotti creando ogni tema in entrambe le modalità immagine. Un pacchetto "Immagini Identiche" mostra lo stesso animale, veicolo o alimento a dimensioni diverse per esercizi di pura percezione dimensionale. Un pacchetto "Immagini Diverse" mostra oggetti distinti a dimensioni diverse per sfide di ragionamento sulla dimensione relativa. Vendili separatamente o raggruppa entrambe le modalità insieme a un prezzo premium. Due esperienze di esercizio fondamentalmente diverse dallo stesso tema senza creazione di contenuto aggiuntiva.',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Ogni tema può produrre due set di esercizi fondamentalmente diversi. Immagini Identiche isola la pura percezione dimensionale — lo stesso gatto a tre dimensioni diverse. Immagini Diverse richiede ragionamento sulla dimensione relativa — un cane, un uccello e un pesce a scale diverse. Crea entrambe le modalità per lo stesso tema e vendile separatamente o in bundle. Due prodotti genuinamente diversi da un unico flusso di lavoro.',
    },
    {
      title: 'Evidenzia il Zero Testo per la Vendibilità Globale',
      description: 'Le schede Grande e Piccolo non contengono testo sull\'output — solo immagini e indicatori visivi. Questo è il tuo vantaggio competitivo più forte per gli annunci sui marketplace. Dichiara esplicitamente "nessuna traduzione necessaria — funziona in tutto il mondo" in ogni descrizione prodotto. Gli acquirenti di qualsiasi paese possono acquistare senza preoccuparsi della compatibilità linguistica. Pubblica lo stesso prodotto su più negozi Etsy internazionali con file identici.',
    },
    {
      title: 'Adatta il Numero di Esercizi al Gruppo di Età Target',
      description: 'Per bambini piccoli e prescuola (2–4 anni), usa 2–3 esercizi grandi per pagina con 2 immagini ciascuno per massima chiarezza. Per la scuola dell\'infanzia (4–6 anni), usa 4–6 esercizi con 2 o 3 immagini. Per la prima elementare e oltre, 6–10 esercizi per pagina creano schede di valutazione efficienti. Specifica l\'età target nei titoli e nelle descrizioni dei tuoi prodotti per un migliore targeting nelle ricerche dei marketplace.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'La modalità Immagini Identiche mostra la stessa immagine a dimensioni diverse — per esempio, tre copie di un gatto a scala piccola, media e grande. Questo isola la pura percezione dimensionale. La modalità Immagini Diverse mostra oggetti distinti a dimensioni diverse, richiedendo ragionamento sulla dimensione relativa. Le due modalità creano esercizi fondamentalmente diversi e raddoppiano efficacemente la varietà dei tuoi prodotti da un unico strumento.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sì. Il caricamento di immagini personalizzate ti permette di aggiungere qualsiasi immagine ai tuoi esercizi di confronto dimensioni. Carica foto, illustrazioni o grafiche pertinenti al tuo argomento o pubblico. Le immagini personalizzate funzionano con tutti e cinque i tipi di domanda e entrambe le modalità immagine. Questo è utile per argomenti di nicchia come confrontare dimensioni di edifici, porzioni di cibo o dimensioni dei pianeti oltre la libreria integrata di 104 temi.',
    },
    {
      question: 'Quali formati di file e dimensioni di pagina sono disponibili?',
      answer: 'Scarica come JPEG ad alta risoluzione o PDF pronto per la stampa a 300 DPI. Le dimensioni di pagina includono Letter Verticale, Letter Orizzontale, A4 Verticale, A4 Orizzontale, Quadrato (1200×1200) e dimensioni personalizzate. Attiva la scala di grigi per output ottimizzato per l\'inchiostro. I PDF sono ideali per la stampa diretta e il caricamento su KDP; i JPEG funzionano per mockup dei prodotti e social media.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Prova prima di acquistare con la nostra prova gratuita — ogni funzionalità è disponibile così puoi valutare completamente lo strumento prima dell\'acquisto. Poiché la prova gratuita ti offre accesso completo, non offriamo rimborsi sugli acquisti di licenza. Assicurati che lo strumento soddisfi le tue esigenze usando la prova gratuita prima di acquistare.',
    },
  ],

  internalLinks: [
    { pageType: 'app', slug: 'grande-piccolo-schede', anchorText: 'Schede Grande e Piccolo — Dettagli Completi del Prodotto' },
  ...
  visuals: {
    heroImages: {
      primary: '/samples/italian/big small/Grande%20o%20Piccolo%201.webp',
      primaryAlt: 'Scheda confronto dimensioni grande e piccolo con immagini tematiche a dimensioni diverse che mostra esercizio cerchia il grande',
    },
    sampleGallery: [
      {
        src: '/samples/italian/big small/Grande%20o%20Piccolo%202.webp',
      ...
      {
        src: '/samples/italian/big small/Grande%20o%20Piccolo%203.webp',
      ...
      {
        src: '/samples/italian/big small/Grande%20o%20Piccolo%204.webp',
        alt: 'Scheda confronto dimensioni con modalità immagini identiche con la stessa immagine a tre dimensioni diverse',
        caption: 'Modalità Immagini Identiche — stessa immagine a dimensioni diverse per esercizi di pura percezione dimensionale',
      },
    ],
    youtubeId: 'S2s2U6Nb7FI',
    videoTitle: 'Come Creare Schede di Confronto Dimensioni con Cinque Tipi di Domanda — Tutorial Passo dopo Passo',
  },
};
