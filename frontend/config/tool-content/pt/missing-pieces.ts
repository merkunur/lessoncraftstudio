...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      {
        title: 'Gere a Atividade de Puzzle',
        description: 'Clique em Gerar para criar o puzzle de peças faltantes. O algoritmo inteligente de extração de peças tenta até 150 colocações para encontrar peças com suficiente variância de cor (variância de luminosidade mínima de 15), mantendo pelo menos 250 píxeis de distância entre peças. Lacunas brancas com traço preto (2px) aparecem nas localizações originais da imagem fonte. As opções de solução numeradas — peças corretas mais distratoras — exibem-se com etiquetas numéricas realçadas em amarelo. As atividades verticais colocam a imagem do puzzle em cima com as opções em baixo em fila horizontal (75% do tamanho máximo); as atividades horizontais dividem a vista 50/50 com as opções à direita. O cabeçalho autogerado exibe \"Peças em Falta\" em turquesa (#06B6D4) com uma descrição em rosa (#DB2777) emoldurado em dupla borda — exterior verde-azulado (#14B8A6, 8px) e interior rosa intenso (#EC4899, 3px).',
      },
      {
        title: 'Reveja o Gabarito Autogerado',
        description: 'Clique no aba Gabarito para ver a solução gerada automaticamente. A mesma imagem do puzzle aparece com as lacunas, e etiquetas numéricas realçadas em amarelo (rgba(255,255,0,0.7)) colocam-se dentro de cada lacuna mostrando o índice de opção correto baseado em 1. O tamanho de fonte escala-se a 60% do tamanho da peça para legibilidade clara. Alterne entre os separadores de Atividade e Gabarito para comparar. O gabarito gera-se simultaneamente com a atividade — sem criação manual, sem processo de design separado, sem possibilidade de respostas incorretas. Este sistema de canvas duplo é a sua maior poupança de tempo ao criar pacotes de atividades de puzzles.',
      },
      {
  ...
  businessIdeas: [
    {
      ...
      description: 'Abra uma loja Etsy especializada em pacotes de atividades de puzzles organizados por tema usando as 104 coleções de imagens. Animais, veículos, natureza, alimentos, festividades e profissões tornam-se listagens separadas com 15–25 puzzles de peças faltantes e gabaritos incluídos. As seis formas de peça permitem-lhe criar produtos visuais distintos dos mesmos temas — pacotes de peças quadradas, pacotes de peças circulares e pacotes de variedade com formas mistas. O gabarito autogerado com etiquetas numéricas realçadas em amarelo elimina o maior consumo de tempo na produção. Varie a dificuldade desde 1 peça faltante com 2 opções até 5 peças faltantes com 6 distratoras para desafio progressivo. Preço de pacotes individuais por tema a $3–$5 e pacotes premium de formas mistas a $8–$12.',
      platform: 'Etsy',
    },
    {
      title: 'Série de Cadernos de Puzzles Visuais na Amazon KDP',
      description: 'Compile 50–100 atividades de puzzles em cadernos temáticos para Amazon KDP. Estruture uma série por dificuldade: \"Puzzles de Peças Faltantes Fáceis\" (1–2 peças, 2–3 opções), \"Quebra-Cabeças Visuais Intermédios\" (3 peças, 4 opções) e \"Puzzles de Discriminação Visual Avançados\" (4–5 peças, 5–6 opções com distratoras). Inclua páginas de gabarito no final com etiquetas numéricas realçadas em amarelo dentro de cada lacuna. Ative a escala de cinzentos para saída económica em tinta que mantém baixos os custos de impressão de KDP. O formato puramente visual publica-se identicamente em todos os mercados internacionais de KDP sem tradução — um só interior serve para todos os países.',
      platform: 'Amazon KDP',
    },
    {
      title: 'Pacotes de Atividades de Puzzles para Hotmart',
      description: 'Carregue pacotes de atividades de puzzles na Hotmart com gabaritos autogerados e dificuldade configurável como pontos de venda chave. Os vendedores que procuram atividades de discriminação visual e pensamento crítico valorizam atividades que chegam prontas para a loja com opções de dificuldade diferenciada. Crie conjuntos alinhados com o catálogo de produtos: puzzles de habitats de animais para ciências, puzzles de ajudantes comunitários para estudos sociais, puzzles de grupos de alimentos para lições de nutrição. Cada pacote inclui atividades para usuários a múltiplos níveis de dificuldade (1–5 peças faltantes, 2–6 opções) mais gabaritos para estações de autocorreção. As seis formas de peça dão variedade aos vendedores dentro de um só tipo de atividade.',
      platform: 'Hotmart',
    },
    {
      title: 'Funil de Tráfego com Puzzles no Pinterest',
      description: 'As atividades de puzzles criam pins visualmente impactantes no Pinterest — a imagem com lacunas recortadas e opções de solução numeradas em baixo cria um formato imediatamente chamativo que pais e vendedores reconhecem como educativo. Publique atividades de amostra mostrando diferentes formas de peça: cortes quadrados com temas de animais, cortes circulares com temas de festividades, cortes de elipse para variedade. Crie séries de pins separadas para \"atividades de puzzles para crianças\", \"puzzles de peças faltantes para pré-escolar\" e \"atividades de discriminação visual\". O formato puramente visual atrai pais e vendedores em todos os países. Ligue cada pin às suas listagens de produtos na Etsy ou Hotmart.',
      platform: 'Pinterest',
    },
    {
      title: 'Kit Completo de Puzzles na Hotmart',
      description: 'Agrupe atividades de puzzles dos 104 temas, das 6 formas de peça e de todos os níveis de dificuldade num kit integral na Hotmart. Inclua mais de 400 puzzles abrangendo formas quadrada, circular, retangular e elíptica em cada combinação de dificuldade desde 1 peça com 2 opções até 5 peças com 6 opções. Cada puzzle inclui o seu gabarito autogerado, duplicando a sua contagem de arquivos. O sistema de seis formas e dificuldade em dois eixos proporciona enorme variedade de cada conjunto temático de imagens. O formato de kit justifica preços premium porque os compradores obtêm uma biblioteca completa de puzzles em vez de pacotes individuais.',
      platform: 'Hotmart',
    },
    {
  ...
  faq: [
    {
      ...
      answer: 'Sim. A ferramenta oferece um teste grátis com todas as funcionalidades — as 6 formas de peça (quadrado, círculo, retângulo vertical/horizontal, elipse vertical/horizontal), 1–5 peças faltantes, 2–6 opções de solução com distratoras, o gabarito autogerado com etiquetas numéricas realçadas em amarelo, as 104 coleções temáticas de imagens com mais de 3100 ilustrações, carregamento de imagens personalizadas, fundos e bordas temáticas com opacidade independente, o sistema de dupla borda decorativa, opção de escala de cinzentos e todos os formatos de download. Sem cadastro, sem cartão de crédito. Os downloads do teste grátis incluem uma marca d\'água. Adquira uma licença comercial para remover a marca d\'água e desbloquear direitos de venda.',
    },
    {
    ...
    },
    {
      ...
      answer: 'O gerador usa um sistema de canvas duplo com um aba de Atividade e um aba de Gabarito. O gabarito exibe a mesma imagem do puzzle com as lacunas e coloca etiquetas numéricas realçadas em amarelo (rgba(255,255,0,0.7)) dentro de cada lacuna mostrando o índice de opção correto baseado em 1. O tamanho de fonte escala-se a 60% do tamanho da peça para legibilidade clara. Baixe o gabarito separadamente usando os botões dedicados de Gabarito JPEG e Gabarito PDF. O gabarito gera-se simultaneamente com a atividade — sem criação manual, sem processo de design separado.',
    },
    {
      question: 'Como funciona o sistema de dupla borda do cabeçalho?',
      answer: 'Cada puzzle gerado apresenta um cabeçalho estilizado com \"Peças em Falta\" em turquesa (#06B6D4) e uma descrição em rosa (#DB2777), emoldurado por duas bordas decorativas. A borda exterior usa verde-azulado brilhante (#14B8A6) com traço de 8px, margens de 34px e raio de borda de 12px. A borda interior usa rosa intenso (#EC4899) com traço de 3px, margens de 46,5px, raio de borda de 8px e um ligeiro desfasamento de 2px à direita e 3px para baixo. Juntas criam uma moldura polida e profissional que aumenta a qualidade visual das atividades de puzzles para listagens em lojas online.',
    },
    {
      question: 'As atividades de peças faltantes são sensíveis ao idioma?',
      answer: 'Não. Peças Faltantes é um formato de puzzle puramente visual — a saída da atividade contém apenas imagens, lacunas e opções de solução numeradas sem conteúdo dependente do idioma. O único elemento dependente do idioma é o texto do cabeçalho autogerado (\"Peças em Falta\" e a descrição), que está localizado nos 11 idiomas suportados. O puzzle em si funciona identicamente independentemente da seleção de idioma. Isto torna as atividades de peças faltantes universalmente vendíveis em todos os mercados sem tradução — um conjunto de puzzles serve para todos os mercados internacionais.',
    },
    {
      question: 'Que tamanhos de página e formatos de exportação estão disponíveis?',
      answer: 'Os tamanhos de página incluem Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) e dimensões personalizadas. Exporte como JPEG de alta resolução ou PDF pronto para imprimir a 300 DPI (multiplicador 6×, qualidade JPEG 1,0). Ative a escala de cinzentos para saída económica em tinta. Cada geração produz quatro arquivos de download: atividade JPEG, atividade PDF, gabarito JPEG e gabarito PDF. Todas as exportações estão prontas para produção em downloads digitais, cadernos impressos e atividades para a loja.',
    },
    {
      question: 'Posso vender atividades de puzzles criadas com esta ferramenta comercialmente?',
      answer: 'Sim. Com uma licença comercial, tem direitos completos para vender atividades de puzzles como downloads digitais na Etsy, cadernos impressos de puzzles visuais na Amazon KDP, recursos para a loja na Hotmart ou através de qualquer outro canal de venda. As 6 formas de peça, o sistema de dificuldade em dois eixos, a extração inteligente de peças, as peças distratoras, os gabaritos autogerados com etiquetas realçadas em amarelo, o carregamento de imagens personalizadas e as 104 coleções temáticas de imagens dão-lhe tudo o necessário para criar produtos profissionais de puzzles que competem em categorias de puzzles visuais em todos os principais mercados.',
    },
    {
      question: 'Qual é a política de reembolso?',
      answer: 'Teste antes de comprar com o nosso teste grátis — todas as funcionalidades estão disponíveis para que possa avaliar completamente a ferramenta antes de comprar. Como o teste grátis lhe dá acesso completo às 6 formas de peça, 1–5 peças faltantes, 2–6 opções de solução com distratoras, o gabarito autogerado, os 104 temas, o carregamento de imagens personalizadas, fundos e bordas temáticas, o sistema de dupla borda, a exportação em escala de cinzentos e todos os formatos de download, não oferecemos reembolsos em compras de licenças. Certifique-se de que a ferramenta se adequa às suas necessidades usando o teste grátis antes de comprar.',
    },
  ],

  internalLinks: [
    { pageType: 'app', slug: 'pecas-faltantes-atividades', anchorText: 'Puzzles de Peças em Falta — Detalhes Completos do Produto' },
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Atividade de puzzle com lacunas recortadas de uma ilustração colorida e opções de solução numeradas incluindo distratoras em baixo com cabeçalho turquesa Peças em Falta e dupla borda decorativa verde-azulado e rosa',
    },
    sampleGallery: [
      {
      ...
      {
        src: '/samples/portuguese/missing%20pieces/peças-em-falta-4.webp',
    ...
    videoTitle: 'Como Criar Atividades de Puzzles com 6 Formas de Peça, Extração Inteligente, Distratoras e Gabaritos Automáticos — Tutorial Passo a Passo',
  },
};
