...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'word-scramble-worksheets', anchorText: 'Bogstavmix Generator' },
  ...
  cta: {
    heading: 'Kom I Gang Med Bogstavmix-Printables',
