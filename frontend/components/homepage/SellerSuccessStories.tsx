...
const localeContent: Record<string, {
  ...
  de: {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Erreichen Sie Märkte, die andere Verkäufer ignorieren. Mit 3.000+ thematischen Bildern und 11 Sprachoptionen erstellen Sie einzigartige Malvorlagen.',
  ...
  fr: {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Touchez des marchés que la plupart des vendeurs ignorent. Avec plus de 3 000 images thématiques et 11 langues, créez des cahiers de coloriage uniques.',
        linkText: 'Apprendre à créer des coloriages',
  ...
  es: {
    ...
    cards: [
      ...
      {
        icon: '\uD83C\uDFA8',
        title: 'Páginas para colorear en 11 idiomas',
        description: 'Alcanza mercados que la mayoría de vendedores ignoran. Con más de 3.000 imágenes temáticas y 11 idiomas, crea libros de colorear únicos.',
        linkText: 'Aprende a crear páginas para colorear',
  ...
  pt: {
    ...
    cards: [
      ...
      {
        icon: '\uD83C\uDFA8',
        title: 'Páginas para colorir em 11 idiomas',
        description: 'Alcance mercados que a maioria dos vendedores ignora. Com mais de 3.000 imagens temáticas e 11 idiomas, crie livros para colorir únicos.',
        linkText: 'Aprenda a criar páginas para colorir',
  ...
  da: {
    ...
    cards: [
      ...
      {
        icon: '\uD83C\uDFA8',
        title: 'Farvelægningssider på 11 sprog',
        description: 'Nå markeder som de fleste sælgere ignorerer. Med over 3.000 tematiske billeder og 11 sprog kan du lave unikke farvelægningsbøger.',
        linkText: 'Lær at lave farvelægningssider',
  ...
  sv: {
    ...
    cards: [
      ...
      {
        icon: '\uD83C\uDFA8',
        title: 'Målarsidor på 11 språk',
        description: 'Nå marknader som de flesta säljare ignorerar. Med över 3 000 tematiska bilder och 11 språk skapar du unika målarböcker.',
        linkText: 'Lär dig skapa målarsidor',
  ...
  no: {
    ...
    cards: [
      ...
      {
        icon: '\uD83C\uDFA8',
        title: 'Fargeleggingssider på 11 språk',
        description: 'Nå markeder som de fleste selgere ignorerer. Med over 3 000 tematiske bilder og 11 språk lager du unike fargeleggingsbøker.',
        linkText: 'Lær å lage fargeleggingssider',
    ...
    cards: [
      ...
      {
        icon: '\uD83C\uDFA8',
        title: 'Värityskuvat 11 kielellä',
        description: 'Tavoita markkinat joita useimmat myyjät sivuuttavat. Yli 3 000 teemakuvalla ja 11 kielellä luot ainutlaatuisia värityskirjoja.',
        linkText: 'Opi luomaan värityskuvia',
        guideSlug: 'create-etsy-coloring-pages',
      },
    ],
  },
