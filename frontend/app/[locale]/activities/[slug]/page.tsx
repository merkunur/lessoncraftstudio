...
const STRAND_OVERRIDE: Record<string, Record<string, string>> = {
  ...
  'sound-boxes.phoneme-position.rf-k-2-d': { de: 'Sprache und Sprachgebrauch untersuchen', es: 'Conciencia fonémica' }, // Lautanalyse = metalinguistische Analyse der Lautstruktur (KMK); distinct from #102 Reime „Sprechen und Zuhören" (holistic listening). es: «Conciencia fonémica» (el término del tool-bank es s2; analítica/fonema ⊂ la «Conciencia fonológica» holística de rhyme-shop #102); RF no tiene auto-map es en strand-names.ts → sin override el chip filtra el default falso «Comprensión lectora»
...
export default async function ActivityPage({ params }: { params: PageParams }) {
  ...
  const ACTIVITY_WRAPPER_VERSION = '9.446';
