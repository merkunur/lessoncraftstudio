...
const startKeywords: Record<string, string[]> = {
  ...
  es: ['iniciar negocio de imprimibles', 'cómo empezar a vender imprimibles', 'guía paso a paso negocio imprimibles', 'vender fichas en Etsy principiantes', 'publicar en Amazon KDP guía', 'ingresos pasivos imprimibles'],
...
const startPageContent: Record<string, {
  ...
  es: {
    heroTitle: 'Iniciar su negocio de imprimibles — Guía paso a paso',
    heroDescription: 'Planes completos para lanzar un negocio de imprimibles en Etsy, Amazon KDP o su propia tienda. De la primera ficha a la primera venta.',
    metaTitle: 'Iniciar su negocio de imprimibles | Guía paso a paso',
    metaDescription: 'Planes completos para lanzar un negocio de imprimibles en Etsy, Amazon KDP o su propia tienda. De la primera ficha a la primera venta.',
  ...
  pt: {
    ...
    metaTitle: 'Iniciar seu negócio de imprimíveis | Guia passo a passo | LessonCraftStudio',
    metaDescription: 'Planos completos para lançar um negócio de imprimíveis no Etsy, Amazon KDP ou Hotmart. Da primeira atividade à primeira venda.',
  ...
  it: {
    ...
    metaTitle: 'Creare e vendere schede didattiche | Guida per iniziare',
    metaDescription: 'Tutto per iniziare a creare e vendere schede didattiche. Guide Etsy, KDP, marketing, prezzi, crescita e aspetti legali per il mercato italiano.',
  ...
  nl: {
    ...
    metaTitle: 'Printables-business opbouwen en groeien | LessonCraftStudio',
    metaDescription: 'Alles om uw printables-business op te bouwen. Gidsen voor Etsy, KDP, Bol.com, marketing, prijsstrategie en juridische zaken voor de Nederlandse markt.',
