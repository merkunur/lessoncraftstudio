...
const content: BlogContent = {
  ...
  cta: {
    heading: 'Opret Professionelt Formaterede Arbejdsark',
    description: 'LessonCraftStudios generatorer producerer arbejdsark i universelt format. Prøv gratis med vandmærke.',
