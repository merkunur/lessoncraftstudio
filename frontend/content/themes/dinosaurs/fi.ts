...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'third-grade': {
      ...
      snippetAnswer: 'Dinosaurusaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät paleontologisen tutkimuksen ymmärrystä fossiilinäyttöön perustuvan päättelyn kautta, vahvistavat geologisen ajan mittakaavan hahmottamista kertolaskulla sekä opettavat näyttöön perustuvaa tieteellistä argumentointia. POPS 2014:n vuosiluokkien 3–6 tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla dinosaurusteema kehittyy faskiNoivista faktoista tieteellisen päättelyn harjoitteluksi, kun kahdeksan- ja yhdeksänvuotiaat kykenevät ymmärtämään fossiilinäyttöä ja analysoimaan kilpailevia hypoteeseja. Kertolaskusujuvuus mahdollistaa mittakaavan käsittelyn: brachiosaurus oli 9 kertaa ihmisen pituinen (9 × 2 = 18 metriä). Jakolaskulla selvitetään: jos fossiloitunut jalanjälkirivi on 72 cm ja yksi askel 8 cm, montako askelta (72 ÷ 8 = 9). Paleontologinen tutkimusmenetelmä opettaa näyttöön perustuvaa päättelyä: mitä fossiilit kertovat elämäntavasta. Tutkimusraportin kirjoittaminen yhdistää usean lähteen tietoja dinosauruslajin analyysiksi. Argumentoiva kirjoittaminen sukupuuton syistä vaatii kilpailevien teorioiden arviointia. Geologisen aikajanaan sijoittaminen kehittää ajanhallinnan abstraktia ymmärrystä.',
      developmentalMilestones: [
        { milestone: 'Fossiilinäyttöön perustuvan päättelyn kehittyminen (8–9-vuotiaat päättelevät näytöstä)', howWeAddress: 'Fossiilianalyysitehtävät, joissa oppilas tutkii fossiilikuvia, päättelee elämäntavasta (kasvissYöjä/lihansYöjä), perustelee johtopäätöksensä näytöllä' },
        { milestone: 'Geologisen mittakaavan hahmottaminen kertolaskulla (kolmannen luokan oppilaat käsittelevät suuria lukuja)', howWeAddress: 'Mittakaavatehtävät, joissa oppilas laskee kokovertailuja kertolaskulla, sijoittaa lajeja aikajanalle ja hahmottaa miljoona-vuosien mittakaavan konkreettisin vertauksin' },
        { milestone: 'Kilpailevien tieteellisten hypoteesien arviointi (kahdeksan- ja yhdeksänvuotiaat vertailevat selityksiä)', howWeAddress: 'Sukupuuttokeskustelut, joissa oppilas tutkii eri teorioita (asteroidi, ilmastonmuutos, tulivuoret), arvioi näyttöä kunkin puolesta ja kirjoittaa perustellun kannaNoton' },
        { milestone: 'Usean lähteen tutkimusraportin kirjoittaminen paleontologiasta (kolmannen luokan oppilaat viittaavat lähteisiin)', howWeAddress: 'Dinosaurustutkimusprojektit, joissa oppilas valitsee lajin, kerää tietoa useista lähteistä ja kirjoittaa monikappaleraportin lähdeviittauksineen' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille rajaa vertailu kahteen dinosaurukseen valmiilla faktatiedoilla, anna kertolaskussa pienet mittakaavat ja tarjoa raporttiin kappalemalli. Edistyneille kolmannen luokan oppilaille laajenna analyysi evoluutiivisten sopeutumisten vertailuun, lisää geologisen aikajanaan tarkat aikakaudet ja haasta kirjoittamaan tieteellinen väittely kahdesta kilpailevasta teoriasta.',
      parentTakeaway: 'Kolmannen luokan dinosaurustyölehdet kehittävät tieteellistä päättelyä ja lähdekriittisyyttä. Tutkikaa yhdessä dinosaurusfaktoja: kuinka monta ihmistä tarvittaisiin T-rexin pituuden mittaamiseen (12 m ÷ 1,5 m)? Keskustelkaa: mistä tiedAmme miltä dinosaurukset näyttivät, jos kukaan ei ole nähnyt niitä? Pohtikaa näytön merkitystä tieteessä. Tärkeintä on opettaa, että tieteellinen tieto perustuu näyttöön eikä arvauksiin.',
      classroomIntegration: 'Dinosaurustyölehdet yhdistävät kolmannen luokan ympäristöopin, matematiikan ja äidinkielen: paleontologian jakso fossiilinäytöllä, mittakaavaharjoitukset kertolaskulla, tieteellinen argumentointi sukupuuttoteorioista ja tutkimusraportit lähdeviittauksineen. POPS 2014:n vuosiluokkien 3–6 tutkivan oppimisen ja kriittisen ajattelun tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Fossiilinäyttöön perustuva päättely', emerging: 'tunnistaa fossiileja mutta ei päättele niistä elämäntapaa', proficient: 'päättelee fossiilinäytöstä ravinnon, liikkumisen ja ympäristön ja perustelee johtopäätöksensä', advanced: 'arvioi kilpailevia tulkintoja fossiileista, tunnistaa näytön rajat ja esittää vaihtoehtoisia selityksiä' },
        { skill: 'Mittakaavan hahmottaminen kertolaskulla', emerging: 'laskee yksittäisiä kokovertailuja mutta ei hahmota geologista aikaa', proficient: 'laskee mittakaavoja sujuvasti kertolaskulla ja sijoittaa lajeja aikajanalle', advanced: 'soveltaa mittakaavaa luovasti eri konteksteissa ja selittää geologisen ajan konkreettisin vertauksin' },
        { skill: 'Tieteellisten hypoteesien arviointi', emerging: 'valitsee suosikkiteorian ilman näytön arviointia', proficient: 'vertailee teorioita näytön perusteella ja perustelee valintansa', advanced: 'analysoi usean teorian vahvuudet ja heikkoudet, tunnistaa epävarmuudet ja esittää synteettisen johtopäätöksen' },
      ],
    },
  },
