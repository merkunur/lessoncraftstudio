...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Camping',
  title: 'Gratis Camping-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara camping-övningar för barn. Matematik, målarbilder, ordspel och pussel med campingtema. Förskola till årskurs 3. Gratis PDF. Skriv ut direkt.',
  keywords: 'campingövningar barn, camping arbetsblad, camping målarbilder, camping matematik, camping förskola, camping utskrivbar, camping pussel, camping räkning, camping korsord, camping i naturen, friluftsliv barn',
  heading: 'Campingövningar och Arbetsblad',
  ...
  gradeContent: {
    'preschool': {
      ...
      seoKeywords: 'campingövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, friluftsliv, naturupplevelse, campingutrustning, campinguppgifter förskola, campingens lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoDescription: 'Utskrivbara campingövningar för förskoleklassbarn (5–6 år). Räkning, ordpussel och naturuppgifter med campingtema. 33 generatorer. Gratis PDF. Ladda ner.',
      seoKeywords: 'campingövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, friluftsliv, naturupplevelse, campingutrustning, campinguppgifter förskoleklass, campingens lärande 5–6 år',
    ...
    'first-grade': {
      ...
      seoKeywords: 'campingövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, friluftsliv, naturupplevelse, campingutrustning, campinguppgifter årskurs 1, campingens lärande 6–7 år',
    ...
    'second-grade': {
      ...
      seoKeywords: 'campingövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, friluftsliv, naturupplevelse, campingutrustning, campinguppgifter årskurs 2, campingens lärande 7–8 år',
    ...
    'third-grade': {
      ...
      seoDescription: 'Utskrivbara camping-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'campingövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, friluftsliv, naturupplevelse, campingutrustning, campinguppgifter årskurs 3, campingens lärande 8–9 år',
