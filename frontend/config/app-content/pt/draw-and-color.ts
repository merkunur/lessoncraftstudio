...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          'Abra o painel de Configuração de Página e escolha um formato: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) ou qualquer dimensão personalizada. Selecione uma cor de página, escolha um tema decorativo de fundo e ajuste a opacidade, depois adicione uma moldura de borda combinante com controlo de opacidade independente. Estas opções de layout dão às suas atividades de desenho em grelha um aspecto profissional e polido antes de configurar uma única grelha.',
      },
      {
        title: 'Configure as dimensões da grelha e a percentagem de pistas',
        description:
          'Defina as linhas (3 a 10) e as colunas (3 a 10) da grelha de forma independente para controlar o número de células e a proporção de aspecto. Uma grelha 3×3 com 9 células grandes é fácil para principiantes; uma grelha 10×10 com 100 células pequenas desafia os usuários avançados. Depois defina a percentagem de pistas de 10 % a 75 %. A 75 %, a maior parte da imagem de referência é visível e os usuários completam o quarto restante. A 10 %, os usuários só veem pistas dispersas e devem reconstruir quase toda a imagem — um autêntico desafio mesmo para adultos. Este único deslizador cria uma curva de dificuldade progressiva para toda a sua gama de produtos.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Use o painel Ferramentas de Texto para adicionar um título de atividade, campos de nome e data do usuário, ou instruções de desenho com fontes como Baloo 2, Fredoka, Lexend Deca, Nunito e Quicksand. O cabeçalho autogerado aparece com texto localizado no idioma selecionado. Arraste, redimensione, rode e reposicione cada elemento no canvas completo Fabric.js. Use os controlos de camadas, bloqueio/desbloqueio, ferramentas de alinhamento e zoom de 25 % a 300 % para uma colocação precisa. Ative a opção de campos de nome/data para as zonas de identificação do usuário.',
      },
      {
        title: 'Baixe a grelha de prática e a grelha de pistas',
        description:
          'Ative a exportação em escala de cinzentos para versões económicas em tinta, ideais para impressão online. Depois abra o menu Baixar e exporte a sua atividade como JPEG de alta resolução ou PDF pronto para impressão a 300 DPI. Cada download inclui tanto a grelha de prática (células vazias para desenhar) como a grelha de pistas (células de referência que mostram a imagem parcial). Não é necessário um gabarito separado — a grelha de pistas em si mesma serve como referência da solução. Cada exportação está pronta para produção: listagens da Etsy, interiores da Amazon KDP e arquivos de produtos Hotmart.',
      },
    ],
  },

  keyFeatures: {
    title: 'Características Principais do Gerador de Atividades de Desenho em Grelha',
    features: [
      {
        title: 'Sistema de grelha dupla: grelha de prática e grelha de pistas',
        description:
          'Cada imagem gera duas grelhas complementares que funcionam juntas como um exercício de desenho completo. A Grelha de Prática apresenta células vazias com contornos suaves onde os usuários desenham a sua reprodução. A Grelha de Pistas mostra uma fração configurável da imagem de referência — algumas células preenchidas, outras vazias — para que os usuários vejam pistas visuais parciais e completem o resto. Esta abordagem de grelha dupla ensina observação, raciocínio espacial e controlo da motricidade fina em simultâneo. Para os vendedores, o formato de duas grelhas cria um produto premium que se distingue das simples páginas para colorir, justificando preços mais altos na Hotmart, Etsy e KDP.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Três modos de simetria transformam o desenho padrão em grelha num exercício de raciocínio espacial. O modo Aleatório dispersa as células de pistas em posições arbitrárias para a prática geral do desenho. O modo Horizontal reflete as células de pistas da esquerda para a direita, ensinando simetria bilateral — os usuários veem uma metade e reconstroem a imagem espelhada. O modo Vertical reflete as células de pistas de cima para baixo para exercícios de simetria vertical. Cada modo espelho inclui um seletor de parte a revelar que permite escolher qual metade mostrar como pistas. As atividades de simetria vendem-se excecionalmente bem nas categorias de matemática e arte porque ligam a arte visual a conceitos matemáticos.',
      },
      {
  ...
  businessUseCases: {
    title: 'Como Vender Atividades de Desenho em Grelha Online',
    cases: [
      {
        title: 'Pacotes de atividades de desenho em grelha na Etsy',
        description:
          'Crie pacotes temáticos de desenho em grelha com dificuldade progressiva usando a percentagem de pistas como eixo de dificuldade. Agrupe cada tema em três níveis: Fácil (75 % de pistas, grelha 4×4), Médio (40 % de pistas, grelha 6×6) e Difícil (15 % de pistas, grelha 8×8). Ofereça animais da quinta, dinossauros, criaturas marinhas e veículos como pacotes temáticos separados com 15 a 25 atividades cada um. O formato de grelha dupla — grelha de prática mais grelha de pistas — cria um produto premium que se distingue das simples páginas para colorir. O estilo de contornos a preto e branco convida ao colorir depois do desenho, acrescentando outra camada de atividade que aumenta o valor percebido. Defina o preço dos pacotes temáticos individuais entre $3–$5 e dos pacotes progressivos multitema entre $12–$18.',
      ...
      {
        title: 'Centros de simetria e raciocínio espacial para Hotmart',
        description:
          'Construa conjuntos de prática de raciocínio espacial por níveis usando o modo de simetria como ferramenta de ensino. O Nível 1 usa a colocação Aleatória de pistas para a prática geral do desenho. O Nível 2 introduz o modo Espelho Horizontal onde os usuários veem a metade esquerda e desenham a metade direita, ensinando simetria bilateral. O Nível 3 usa o modo Espelho Vertical para a simetria de cima para baixo. O Nível 4 combina uma percentagem de pistas baixa (10–15 %) com o modo espelho para o desafio definitivo. Cada nível foca uma competência espacial diferente. Estes recursos ligam os padrões de arte e matemática, tornando-os valiosos tanto para vendedores de arte como para especialistas em matemática na Hotmart.',
        platform: 'Hotmart (hotmart.com)',
      },
      {
        title: 'Atividades visuais multilingues para mercados globais',
        description:
          'Como as atividades de Desenho em Grelha contêm apenas imagens em grelha com zero texto na saída, o mesmo produto funciona em todos os idiomas sem modificação. Crie um conjunto de exercícios de desenho em grelha e venda-o em todo o mundo — sem tradução necessária, sem versões de idiomas separadas para manter. O estilo de contornos a preto e branco é culturalmente neutro e universalmente compreendido. Publique produtos idênticos em lojas Etsy dirigidas a diferentes países, ou publique o mesmo interior KDP em todos os mercados internacionais da Amazon. O cabeçalho autolocalizado gere automaticamente os títulos específicos de cada idioma. Um único fluxo de trabalho produz um produto universalmente vendível.',
        platform: 'Etsy / Amazon KDP / Hotmart (global)',
      },
      {
        title: 'Ferramenta de desenho para a loja de arte e terapia',
        description:
          'Carregue imagens personalizadas para criar atividades de desenho em grelha para qualquer disciplina ou contexto terapêutico. Os vendedores de arte usam o desenho em grelha para ensinar a observação proporcional — o método célula por célula é uma técnica clássica usada no ensino das belas-artes. Os terapeutas ocupacionais usam os exercícios de reprodução em grelha para desenvolver o controlo da motricidade fina, a coordenação olho-mão e o processamento visuoespacial. A percentagem de pistas ajustável permite aos profissionais definir a dificuldade com precisão: comece a 75 % para pacientes que precisam de andaimes sólidos e reduza gradualmente as pistas à medida que as competências melhoram. Os modos de simetria acrescentam um componente explícito de raciocínio espacial às sessões de terapia.',
  ...
  faq: [
    ...
    {
      question: 'Posso adicionar campos de nome e data do usuário à atividade?',
      answer:
        'Sim. Ative a opção Incluir Campos de Nome/Data para adicionar zonas de identificação do usuário à sua atividade. Também pode usar o painel Ferramentas de Texto para adicionar um título personalizado, instruções ou qualquer outro texto com fontes como Lexend Deca, Baloo 2, Nunito, Quicksand, Fredoka, Arial e Verdana. Todos os elementos de texto são completamente editáveis no canvas — arraste, redimensione, rode e reposicione conforme necessário.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'guide',
      slug: 'criar-atividades-desenho',
      anchorText: 'Criar atividades de desenho',
    },
    {
      pageType: 'tool',
