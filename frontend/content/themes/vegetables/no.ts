...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare grønnsaker-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med grønnsakertema. Førskole til 3. klasse. Gratis PDF. Hent nå.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Grønnsaker-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare grønnsaker-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. 3 000+ tematiske bilder.',
      seoKeywords: 'grønnsaksoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, grønnsakgjenkjenning, ernæringsundervisning, kjøkkenhage, grønnsaksøvelser førskole, grønnsakers læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Grønnsaker-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare grønnsaker-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. 3 000+ bilder.',
      seoKeywords: 'grønnsaksoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, grønnsakgjenkjenning, ernæringsundervisning, kjøkkenhage, grønnsaksøvelser barnehage, grønnsakers læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Grønnsaker-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare grønnsaker-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'grønnsaksoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, grønnsakgjenkjenning, ernæringsundervisning, kjøkkenhage, grønnsaksøvelser 1. klasse, grønnsakers læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Grønnsaker-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare grønnsaker-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'grønnsaksoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, grønnsakgjenkjenning, ernæringsundervisning, kjøkkenhage, grønnsaksøvelser 2. klasse, grønnsakers læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Grønnsaker-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare grønnsaker-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'grønnsaksoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, grønnsakgjenkjenning, ernæringsundervisning, kjøkkenhage, grønnsaksøvelser 3. klasse, grønnsakers læring 8-9 år',
