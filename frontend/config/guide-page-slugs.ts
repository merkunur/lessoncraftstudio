...
export const guidePageSlugs: GuideSlugConfig[] = [
  ...
  { guideId: 'create-crossword-puzzles', slugs: { en: 'create-crossword-puzzles', de: 'kreuzwortraetsel-erstellen', fr: 'creer-mots-croises', es: 'crear-crucigramas', pt: 'criar-palavras-cruzadas', it: 'creare-cruciverba', nl: 'kruiswoordpuzzels-maken', sv: 'skapa-korsordspussel' } },
  ...
  { guideId: 'create-picture-sudoku', slugs: { en: 'create-picture-sudoku', de: 'bilder-sudoku-erstellen', fr: 'creer-sudoku-images', es: 'crear-sudoku-imagenes', pt: 'criar-sudoku-imagens', it: 'creare-sudoku-immagini', nl: 'plaatjes-sudoku-maken', sv: 'skapa-bildsudoku' } },
  ...
  { guideId: 'create-sorting-worksheets', slugs: { en: 'create-sorting-worksheets', de: 'sortier-arbeitsblaetter-erstellen', fr: 'creer-fiches-tri', es: 'crear-fichas-clasificacion', pt: 'criar-fichas-classificacao', it: 'creare-schede-classificazione', nl: 'sorteer-werkbladen-maken', sv: 'skapa-sorteringsarbetsblad' } },
  { guideId: 'create-shadow-matching-worksheets', slugs: { en: 'create-shadow-matching-worksheets', de: 'schatten-zuordnung-arbeitsblaetter-erstellen', fr: 'creer-fiches-discrimination-visuelle', es: 'crear-fichas-discriminacion-visual', pt: 'criar-fichas-discriminacao-visual', it: 'creare-schede-discriminazione-visiva', nl: 'schaduw-koppelen-werkbladen-maken', sv: 'skapa-skuggmatchnings-arbetsblad' } },
  { guideId: 'create-odd-one-out-puzzles', slugs: { en: 'create-odd-one-out-puzzles', de: 'was-passt-nicht-raetsel-erstellen', fr: 'creer-fiches-intrus', es: 'crear-fichas-intruso', pt: 'criar-fichas-intruso', it: 'creare-schede-intruso', nl: 'wat-hoort-er-niet-bij-maken', sv: 'skapa-hitta-udda-bilden-pussel' } },
  ...
  { guideId: 'email-marketing-printables', slugs: { en: 'email-marketing-printables', de: 'email-marketing-druckvorlagen', fr: 'email-marketing-imprimables', es: 'email-marketing-imprimibles', pt: 'email-marketing-imprimiveis', it: 'email-marketing-stampabili', nl: 'email-marketing-printables', sv: 'e-postmarknadsforing-printables' } },
