...
const translations = {
  "en": {
    ...
    "cryptogram.msg.generating": "Generating worksheet...",
    "cryptogram.msg.generate.complete": "Worksheet generated successfully.",
    "cryptogram.msg.generated": "Worksheet generated successfully!",
    "cryptogram.msg.error.details": "Error generating puzzle: {error}",
    "cryptogram.msg.worksheet.generated": "Worksheet generated.",
    "cryptogram.msg.generate.first": "Please generate a worksheet first.",
    "cryptogram.msg.generate.worksheet.first": "Generate a worksheet first to download.",
  ...
  "da": {
    ...
    "cryptogram.background.opacity": "Baggrundsdekning:",
    "cryptogram.border.title": "Ramme",
    "cryptogram.border.theme": "Rammetema:",
    "cryptogram.border.message": "Vælg et tema for rammer.",
    "cryptogram.border.opacity": "Rammedekning:",
    "cryptogram.text.tools": "Tekstindstillinger",
    ...
    "cryptogram.download.answer.jpeg": "Svarark (JPEG)",
    "cryptogram.download.worksheet.pdf": "Arbejdsark (PDF)",
    "cryptogram.download.answer.pdf": "Svarark (PDF)",
    ...
    "cryptogram.tab.answer": "Svarark",
    "cryptogram.msg.generating": "Opretter opgavedata...",
    "cryptogram.msg.generate.complete": "Arbejdsark oprettet.",
    "cryptogram.msg.generated": "Arbejdsark oprettet!",
    "cryptogram.msg.error.details": "Fejl ved oprettelse af puslespil: {error}",
    ...
    "cryptogram.msg.images.uploaded": "{count} brugerdefineret(e) billede(r) tilgængelig(e).",
    ...
    "error.opacity.invalid": "Ugyldig dekningsværdi.",
    ...
    "cryptogram.msg.images.uploaded": "{count} tilpasset(e) billede(r) tilgængelig(e).",
    "cryptogram.msg.pdf.error.details": "Fejl ved oprettelse af PDF: {error}",
    "title.layers": "Lag",
    "cryptogram.layers.bring.forward": "Flyt fremad",
    "cryptogram.layers.send.backward": "Flyt tilbage",
    "title.align": "Justér",
    "cryptogram.align.selected": "Justér valgte:",
    "title.align.left": "Venstrejustér",
    "title.align.center.h": "Centrér horisontalt",
    "title.align.right": "Højrejustér",
    "title.align.top": "Justér øverst",
    "title.align.center.v": "Centrér vertikalt",
    "title.align.bottom": "Justér nederst",
    "cryptogram.align.to.page": "Justér til side:",
    "title.center.page.h": "Centrér på side horisontalt",
    "title.center.page.v": "Centrér på side vertikalt",
  ...
  "nl": {
    ...
    "cryptogram.background.opacity": "Achtergronddekking:",
    "cryptogram.border.title": "Rand",
    "cryptogram.border.theme": "Randthema:",
    "cryptogram.border.message": "Selecteer een thema voor randen.",
    "cryptogram.border.opacity": "Randdekking:",
    "cryptogram.text.tools": "Tekstopties",
    ...
    "cryptogram.text.outline.color": "Omlijningskleur:",
    "cryptogram.text.outline.width": "Omlijning (0-10):",
    ...
    "cryptogram.msg.generate.complete": "Cryptogram succesvol gemaakt!",
    ...
    "error.opacity.invalid": "Ongeldige dekkingswaarde.",
  ...
  "fi": {
    ...
    "cryptogram.download.answer.jpeg": "Vastausavain (JPEG)",
    "cryptogram.download.worksheet.pdf": "Tehtävämoniste (PDF)",
    "cryptogram.download.answer.pdf": "Vastausavain (PDF)",
    ...
    "cryptogram.tab.answer": "Vastausavain",
  ...
  "fr": {
    ...
    "cryptogram.text.tools": "Options de texte",
    ...
    "cryptogram.msg.generate.complete": "Feuille d'exercices générée avec succès.",
    "cryptogram.msg.generated": "Feuille d'exercices générée avec succès !",
    "cryptogram.msg.error.details": "Erreur lors de la génération du puzzle : {error}",
  ...
  "de": {
    ...
    "cryptogram.text.tools": "Textbearbeitung",
    ...
    "cryptogram.msg.images.uploaded": "{count} benutzerdefinierte(s) Bild(er) verfügbar.",
  ...
  "it": {
    ...
    "cryptogram.text.tools": "Opzioni di testo",
    ...
    "cryptogram.page.title": "Creatore di crittogrammi illustrati",
    ...
    "cryptogram.msg.generate.complete": "Scheda didattica creata con successo.",
    ...
    "cryptogram.msg.theme.load.failed": "Errore nel caricamento del tema \"{theme}\".",
    ...
    "cryptogram.msg.select.letter": "Per favore, seleziona prima una lettera.",
    ...
    "cryptogram.msg.images.uploaded": "{count} immagine/i personalizzata/e disponibile/i.",
    ...
    "cryptogram.msg.generate.worksheet.first": "Per favore, crea prima una scheda esercizi.",
    ...
    "cryptogram.msg.pdf.error.details": "Errore nella creazione del PDF: {error}",
    ...
    "cryptogram.msg.theme.load.failed": "Impossibile caricare il tema \"{theme}\"",
    "cryptogram.msg.images.uploaded": "{count} immagine/i personalizzata/e disponibile/i.",
    "cryptogram.msg.pdf.error.details": "Errore durante la creazione del PDF: {error}",
  ...
  "no": {
    ...
    "cryptogram.background.opacity": "Bakgrunnsdekkevne:",
    "cryptogram.border.title": "Ramme",
    "cryptogram.border.theme": "Rammetema:",
    "cryptogram.border.message": "Velg et tema for å se rammer.",
    "cryptogram.border.opacity": "Rammedekkevne:",
    "cryptogram.text.tools": "Tekstinnstillinger",
    ...
    "common.grayscale": "Gråtoner",
    "cryptogram.clear.all": "Slett alt",
    "cryptogram.msg.generate.complete": "Kryptogram opprettet!",
    "cryptogram.msg.cleared": "Alt innhold slettet.",
    "cryptogram.tab.worksheet": "Arbeidsark",
    "cryptogram.tab.answer": "Fasit",
    "cryptogram.msg.generating": "Oppretter oppgavedata...",
    "cryptogram.msg.generate.complete": "Arbeidsark opprettet.",
    "cryptogram.msg.generated": "Arbeidsark opprettet!",
    "cryptogram.msg.error.details": "Feil ved oppretting av puslespill: {error}",
    "cryptogram.msg.worksheet.generated": "Arbeidsark opprettet!",
    ...
    "cryptogram.msg.generate.first": "Vennligst opprett innhold først.",
    "cryptogram.themes.all": "Alle temaer",
    ...
    "cryptogram.msg.generate.worksheet.first": "Vennligst opprett et arbeidsark først.",
    "cryptogram.msg.preparing.jpeg": "Forbereder JPEG...",
    ...
    "error.puzzle.generation": "Kunne ikke opprette oppgave. Vennligst prøv andre setninger.",
    ...
    "error.outline.invalid": "Ugyldig konturbredde.",
    "error.opacity.invalid": "Ugyldig dekkevneverdi.",
    ...
    "cryptogram.msg.pdf.error.details": "Feil ved oppretting av PDF: {error}",
    "title.layers": "Lag",
  ...
  "pt": {
    ...
    "cryptogram.text.tools": "Opções de texto",
    ...
    "cryptogram.page.title": "Criador de criptogramas ilustrados",
    ...
    "cryptogram.download.worksheet.jpeg": "Folha de trabalho (JPEG)",
    "cryptogram.download.answer.jpeg": "Folha de respostas (JPEG)",
    "cryptogram.download.worksheet.pdf": "Folha de trabalho (PDF)",
    "cryptogram.download.answer.pdf": "Folha de respostas (PDF)",
    ...
    "cryptogram.tab.worksheet": "Folha de trabalho",
    "cryptogram.tab.answer": "Folha de respostas",
    "cryptogram.msg.generating": "Criando dados do desafio...",
    "cryptogram.msg.generate.complete": "Folha de trabalho criada com sucesso.",
    "cryptogram.msg.generated": "Folha de trabalho criada com sucesso!",
    "cryptogram.msg.error.details": "Erro ao criar o quebra-cabeça: {error}",
    "cryptogram.msg.worksheet.generated": "Folha de trabalho criada com sucesso!",
    ...
    "cryptogram.msg.theme.load.failed": "Falha ao carregar o tema \"{theme}\"",
    "cryptogram.msg.images.uploaded": "{count} imagem/ns personalizada/s disponível/eis.",
    "cryptogram.msg.pdf.error.details": "Erro ao criar PDF: {error}",
  ...
  "es": {
    ...
    "cryptogram.msg.generating": "Creando datos del puzzle...",
    "cryptogram.msg.generate.complete": "Hoja de ejercicios creada con éxito.",
    "cryptogram.msg.generated": "¡Hoja de ejercicios creada con éxito!",
    "cryptogram.msg.error.details": "Error al crear el rompecabezas: {error}",
    "cryptogram.msg.worksheet.generated": "¡Hoja de ejercicios creada con éxito!",
    ...
    "cryptogram.msg.images.uploaded": "{count} imagen(es) personalizada(s) disponible(s).",
    ...
    "cryptogram.msg.generate.worksheet.first": "Por favor, crea una hoja de ejercicios primero.",
    "cryptogram.msg.preparing.jpeg": "Preparando JPEG...",
    ...
    "error.puzzle.generation": "No se pudo crear el puzzle. Por favor, prueba con frases diferentes.",
  ...
  "sv": {
    ...
    "cryptogram.text.tools": "Textalternativ",
    ...
    "cryptogram.msg.generate.complete": "Arbetsblad har skapats.",
    "cryptogram.msg.generated": "Arbetsblad skapat!",
    ...
    "cryptogram.msg.theme.load.failed": "Fel vid laddning av tema \"{theme}\".",
    ...
    "cryptogram.msg.images.uploaded": "{count} anpassad(e) bild(er) tillgänglig(a).",
