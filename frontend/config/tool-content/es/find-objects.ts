...
const content: ToolContent = {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'La clave de respuestas autogenerada con anotaciones de círculos rojos alrededor de objetos ocultos y sin pareja es tu diferenciador de venta más fuerte. Siempre incluye imágenes de vista previa de la clave de respuestas en tus listados de marketplace — muestra los círculos rojos claramente en las fotos del producto. Los productos que incluyen claves de respuestas superan consistentemente en ventas a los listados de solo fichas porque vendedores y padres quieren materiales de autocorrección que ahorren tiempo de valor percibido. El sistema de doble lienzo genera ambas versiones simultáneamente, así que incluir la clave de respuestas no te cuesta nada extra en tiempo de producción.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'En el modo Yo Espío, configura de 1 a 5 objetos ocultos (los objetivos que los usuarios necesitan encontrar) y de 8 a 12 objetos distractores (imágenes circundantes que llenan la escena). Comienza con 1–2 objetos ocultos y 8 distractores para fichas más fáciles para usuarios más jóvenes, y aumenta a 5 objetos ocultos entre 12 distractores para escenas desafiantes. En el modo Encuentra el Diferente, configura de 8 a 12 imágenes emparejadas (cada una aparece con su par correspondiente) y de 1 a 5 elementos sin pareja que los usuarios deben identificar. La cantidad de objetos es tu control principal de dificultad.',
    },
    {
