...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'brug temabilleder sælg arbejdsark',
  ...
  internalLinks: [
    { pageType: 'app', slug: 'addition-arbejdsark', anchorText: 'Additions-Generator (100+ temaer)' },
    { pageType: 'app', slug: 'farvelaegning-arbejdsark', anchorText: 'Tematisk Farvelægning' },
    { pageType: 'app', slug: 'ordsoegning-arbejdsark', anchorText: 'Tematisk Ordsøgning' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Brug Temabilleder til at Sælge Mere',
