...
const appsMetadata: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  sv: {
    title: '33 arbetsbladsgeneratorer | Matte, pussel, språk & mer',
    description: 'Utforska 33 professionella generatorer: matte, språk, visuellt lärande, kreativitet och logik. Alla gratis att prova med vattenmärke.',
    keywords: 'arbetsblad generator, ordsök generator, korsord generator, matteuppgifter generator, målarbilder skapa, sudoku skriva ut, labyrint generator, skrivmotorik uppgifter',
  },
  da: {
    title: '33 arbejdsark-generatorer | Regning, puslespil, sprog & mere',
    description: 'Udforsk 33 professionelle generatorer: regning, sprog, visuelt læringsmateriale, kreativitet og logik. Alle gratis at prøve med vandmærke.',
    keywords: 'arbejdsark generatorer, opgaver til print, plusstykker generator, ordleg generator, krydsord generator, regneopgaver, malebilleder, sudoku, bingoplader',
  },
  no: {
    title: '33 arbeidsark-generatorer | Matte, puslespill, språk & mer',
    description: 'Utforsk 33 profesjonelle generatorer: matte, språk, visuell læring, kreativitet og logikk. Alle gratis å prøve med vannmerke.',
...
const localeContent: Record<string, {
  ...
  sv: {
    heroTitle: '33 professionella arbetsbladsgeneratorer',
    heroSubtitle: 'Skapa uppgifter att skriva ut för förskoleklass och grundskola. Ordsök, matteuppgifter, målarbilder, pussel & mer. Prova alla 33 generatorer gratis med vattenmärke.',
    tryFree: 'Prova gratis',
    details: 'Detaljer',
    trustNoAccount: 'Inget konto krävs',
    trustAllFree: 'Alla 33 generatorer gratis',
    trustCommercial: 'Kommersiell licens tillgänglig',
    ctaTitle: 'Börja skapa uppgifter att skriva ut',
    ctaSubtitle: 'Prova alla 33 generatorer gratis med vattenmärke. Inget konto krävs. Se kvaliteten innan du köper.',
    ctaButton: 'Prova gratis med vattenmärke',
    categories: {
      math: { name: 'Matematik', description: '6 mattegeneratorer — additionsuppgifter, subtraktion, mattepussel & mer' },
      literacy: { name: 'Läsning & Språk', description: '7 språkgeneratorer — ordsök, korsord, skrivmotorik & mer' },
      visual: { name: 'Visuellt Lärande', description: '7 visuella generatorer — målarbilder, ritning, mönster & mer' },
      matching: { name: 'Matchning & Sortering', description: '5 matchningsgeneratorer — bingo, rutnätsmatchning, skugglek & mer' },
      puzzle: { name: 'Pussel & Logik', description: '4 pusselgeneratorer — sudoku, saknade bitar, vilken hör inte hemma & mer' },
      search: { name: 'Sök & Hitta', description: '4 sökgeneratorer — korsord, skattjakt, hitta föremål & mer' },
    },
  },
  da: {
    heroTitle: '33 professionelle arbejdsark-generatorer',
    heroSubtitle: 'Opret professionelle opgaver til print til din virksomhed. Ordleg, regneopgaver, malebilleder, puslespil & mere. Prøv alle 33 generatorer gratis med vandmærke.',
    tryFree: 'Prøv gratis',
    details: 'Detaljer',
    trustNoAccount: 'Ingen konto påkrævet',
    trustAllFree: 'Alle 33 generatorer gratis',
    trustCommercial: 'Kommerciel licens tilgængelig',
    ctaTitle: 'Begynd at lave opgaver til print i dag',
    ...
    categories: {
      math: { name: 'Regning', description: '6 professionelle regneopgave-generatorer — plusstykker, minusstykker, puslespil & mere' },
      literacy: { name: 'Læsning & Sprog', description: '7 ord- og sproggeneratorer — ordleg, bogstavleg, skrivning & mere' },
      visual: { name: 'Visuel Læring', description: '7 visuelle generatorer — malebilleder, tegning, mønstre & mere' },
      matching: { name: 'Matching & Sortering', description: '5 matchinggeneratorer — bingoplader, gittermatch, skyggematch & mere' },
      puzzle: { name: 'Puslespil & Logik', description: '4 puslespilgeneratorer — sudoku, manglende brikker, find den anderledes & mere' },
      search: { name: 'Søg & Find', description: '4 søgegeneratorer — krydsord, skattejagt, find genstande & mere' },
    },
  },
  no: {
    heroTitle: '33 profesjonelle arbeidsark-generatorer',
    heroSubtitle: 'Lag profesjonelle arbeidsark for din virksomhet. Ordleting, matteoppgaver, fargelegging, puslespill & mer. Prøv alle 33 generatorer gratis med vannmerke.',
    tryFree: 'Prøv gratis',
    details: 'Detaljer',
    ...
    categories: {
      math: { name: 'Matematikk', description: '6 profesjonelle mattegeneratorer — plusstykker, minusstykker, puslespill & mer' },
      literacy: { name: 'Lesing & Språk', description: '7 ord- og språkgeneratorer — ordleting, kryssord, skriveøvelser & mer' },
      visual: { name: 'Visuell Læring', description: '7 visuelle generatorer — fargelegging, tegning, mønstre & mer' },
      matching: { name: 'Koble & Sortere', description: '5 matchinggeneratorer — bingo, rutenett, skyggelek & mer' },
      puzzle: { name: 'Puslespill & Logikk', description: '4 puslespillgeneratorer — sudoku, manglende brikker, hvem hører ikke hjemme & mer' },
      search: { name: 'Søk & Finn', description: '4 søkegeneratorer — kryssord, skattejakt, finn gjenstandene & mer' },
    },
  },
  fi: {
