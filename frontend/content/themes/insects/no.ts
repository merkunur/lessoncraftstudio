...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare insekter-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med insektertema. Førskole til 3. klasse. Gratis PDF. Skriv ut nå.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Insekter-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare insekter-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Velg mellom 3 000+ bilder.',
      seoKeywords: 'insektoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, insekters livssyklus, sommerfuglens forvandling, småkryp, insektøvelser førskole, insekters læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Insekter-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare insekter-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'insektoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, insekters livssyklus, sommerfuglens forvandling, småkryp, insektøvelser barnehage, insekters læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Insekter-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare insekter-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'insektoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, insekters livssyklus, sommerfuglens forvandling, småkryp, insektøvelser 1. klasse, insekters læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Insekter-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare insekter-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'insektoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, insekters livssyklus, sommerfuglens forvandling, småkryp, insektøvelser 2. klasse, insekters læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Insekter-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare insekter-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'insektoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, insekters livssyklus, sommerfuglens forvandling, småkryp, insektøvelser 3. klasse, insekters læring 8-9 år',
