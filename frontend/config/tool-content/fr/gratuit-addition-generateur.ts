...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit de Fiches d\'Addition | PDF Imprimables',
    metaDescription: 'Créez des fiches de addition gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit fiches addition',
    secondaryKeywords: ["fiches addition gratuites PDF","créer fiches addition en ligne","addition avec images gratuit","fiches calcul télécharger","exercices addition imprimables gratuits"],
    lsiKeywords: ["addition maternelle","CP mathématiques","comptage avec images","compléments à 10","fluence calcul","addition manipulations","sommes jusqu'à 20","problèmes visuels"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/addition/Addition Fun 1.jpeg',
      primaryAlt: 'Fiche d\'addition gratuite avec images colorées d\'animaux',
    },
    sampleGallery: [
      { src: '/samples/english/addition/Addition Fun 3.jpeg', alt: 'Fiche addition véhicules', caption: 'Thème véhicules' },
      { src: '/samples/english/addition/Addition Fun 5.jpeg', alt: 'Trouver l\'addend', caption: 'Mode trouver l\'addend' }
    ],
    youtubeId: '6O5aCzHkh8M',
    videoTitle: 'Comment créer des fiches de addition gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit de Fiches d\'Addition',
    tagline: 'Créez des fiches de addition et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de addition transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de addition autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de addition en 10 étapes',
    steps: [
  ...
  faq: [
    { question: 'Ce générateur de addition est-il vraiment gratuit ?', answer: 'Oui. La version gratuite inclut toutes les fonctionnalités — tous les modes, les 104 thèmes, l\'export PDF et les corrigés. La seule différence est un petit filigrane sur les fichiers exportés. Utilisez la version gratuite indéfiniment sans créer de compte.' },
  ...
  internalLinks: [
    { slug: 'gratuit-addition-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit de Fiches d\'Addition' },
    { slug: 'addition', pageType: 'app' as const, anchorText: 'Générateur de Fiches d\'Addition — Détails complets' },
  ],
};
