...
(function (global) {
  ...
  function jaySVG() {
    return '<svg class="jjr-jay-svg" viewBox="0 0 100 100" role="img" aria-label="' + (LANG === 'fr' ? 'Jasper le geai' : LANG === 'de' ? 'Jasper, der Häher' : LANG === 'es' ? 'Jasper el arrendajo' : LANG === 'pt' ? 'Jasper, o gaio' : 'Jasper the jay') + '">' +
  ...
  global.JasperJustRightActivity = {
    ...
    strings: {
      title: { en: "Jasper's Just-Right Bag", de: 'Jaspers Genau-richtig-Tasche', fr: 'Jasper le geai', es: 'La mochila de Jasper', pt: 'A mochila do Jasper' },
      prompt: { en: 'Which one would you use?', de: 'Welches würdest du benutzen?', fr: 'Qu’est-ce que tu utiliserais ?', es: '¿Cuál usarías?', pt: 'Qual deles você usaria?' },
      ...
      theAsk: { en: 'Tap the picture of what you would use.', de: 'Tippe das Bild von dem an, was du benutzen würdest.', fr: 'Tape l’image de ce que tu utiliserais.', es: 'Toca la imagen de lo que usarías.', pt: 'Toque na figura do que você usaria.' },
      hintPick: { en: 'Think about what fits — tap a picture, then Check!', de: 'Lies die Situation und überlege: Was würdest du dafür benutzen?', fr: 'Pense à ce qui convient — tape une image, puis Vérifie !', es: 'Lee la situación y piensa: ¿qué usarías para eso?', pt: 'Pense no que combina — toque numa figura e depois em Verificar!' },
      ...
      hintWrong: { en: "That one doesn't quite fit — read it again.", de: 'Das passt noch nicht ganz – lies die Situation noch einmal.', fr: 'Ça ne convient pas tout à fait — relis la situation et réessaie.', es: 'Eso no va del todo. Vuelve a leer la situación.', pt: 'Esse não combina muito bem — leia de novo.' },
      win: { en: 'Yes! That is just right. 🐦', de: 'Ja! Das passt genau richtig. 🐦', fr: 'Oui ! C’est exactement ça. 🐦', es: '¡Sí! Eso es justo lo que necesitas. 🐦', pt: 'Isso! É esse mesmo. 🐦' }
    },
    defaults: {},
