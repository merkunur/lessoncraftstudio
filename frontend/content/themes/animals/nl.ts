...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Dieren',
  title: 'Gratis Dieren-oefeningen voor Kinderen | LessonCraftStudio',
  description: 'Uitprintbare dieren-oefeningen voor kinderen. Rekenen, kleurplaten, woordspellen en puzzels met dierenthema. Kleuterschool tot groep 5. Gratis PDF.',
  keywords: 'dieren werkbladen, dieren kleurplaten, dieren rekenen, dieren kleuterschool, dieren uitprintbaar, dieren puzzels, dieren tellen, dieren kruiswoord, huisdieren oefeningen, wilde dieren oefeningen',
  heading: 'Dierenoefeningen en Werkbladen',
