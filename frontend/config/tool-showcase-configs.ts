...
export const toolShowcaseConfigs: Record<string, ToolShowcaseConfig> = {
  ...
  'image-addition': {
    ...
    tiered: {
      ...
      tiers: [
        ...
        },
        {
          ...
          image: { src: img('addition', 'addition-worksheet-portrait.webp'), alt: 'Explorer addition — mixed picture sums to 10' },
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('addition', 'addition-fun-5-answer-key.webp'), alt: 'Addition answer key — full solutions' }, label: 'Solutions' },
      ],
  ...
  'image-subtraction': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('subtraction', 'subtraction-fun-1-answer-key.webp'), alt: 'Subtraction answer key — all solutions' }, label: 'Solutions' },
      ],
  ...
  'code-addition': {
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('code addition', 'image-addition-worksheet.webp'), alt: 'Image addition format — professional layout' }, label: 'Image Mode' },
        { image: { src: img('code addition', 'code-breaker-addition-4.webp'), alt: 'Code breaker format — decode challenge' }, label: 'Code Mode' },
        { image: { src: img('code addition', 'code-breaker-addition-1-answer-key.webp'), alt: 'Code breaker solution key' }, label: 'Solutions' },
      ],
  ...
  'more-less': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('more less', 'more-less-answer-key-8.webp'), alt: 'More-less solution key' }, label: 'Solutions' },
      ],
  ...
  'math-puzzle': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('math puzzle', 'math-puzzles-answer-key-1.webp'), alt: 'Math puzzle solution key' }, label: 'Solutions' },
      ],
  ...
  'math-worksheet': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('math worksheet', 'math-worksheet-1-answer-key.webp'), alt: 'Picture algebra answer key — all solutions' }, label: 'Solutions' },
      ],
  ...
  'alphabet-train': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('alphabet train', 'alphabet-train-1-answer-key.webp'), alt: 'Alphabet train solution key' }, label: 'Solutions' },
      ],
  ...
  prepositions: {
    hero: {
      ...
      images: [
        { src: img('prepositions', 'prepositions-worksheet.webp'), alt: 'Prepositions practice — spatial word matching with scenes' },
        { src: img('prepositions', 'prepositions-worksheet-2.webp'), alt: 'Cut-and-paste preposition activity' },
        { src: img('prepositions', 'prepositions-worksheet-5.webp'), alt: 'Themed spatial vocabulary worksheet' },
      ],
      pills: [
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Starter', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('prepositions', 'prepositions-worksheet-3.webp'), alt: 'Basic prepositions — on, in, under' },
        ...
        },
        {
          ...
          image: { src: img('prepositions', 'prepositions-worksheet-6.webp'), alt: 'Expanded prepositions — beside, between, behind' },
          desc: 'Expanded vocabulary with themed picture scenes',
        },
        {
          name: 'Expert', gradientClass: 'from-amber-400 to-orange-500', textColorClass: 'text-amber-700', borderColorClass: 'border-amber-300', stars: 3,
          image: { src: img('prepositions', 'prepositions-worksheet-10.webp'), alt: 'Complex prepositions — sentences and descriptions' },
    ...
    spotlight: {
      ...
      image: { src: img('prepositions', 'prepositions-worksheet-1.webp'), alt: 'Spotlight prepositions — colorful scene-based spatial word activity' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('prepositions', 'prepositions-worksheet-8.webp'), alt: 'Preposition practice sheet — themed layout' }, label: 'Practice Sheet' },
        { image: { src: img('prepositions', 'prepositions-worksheet-12.webp'), alt: 'Preposition activity — different scene theme' }, label: 'Scene Activity' },
        { image: { src: img('prepositions', 'prepositions-answer-key-1.webp'), alt: 'Preposition answer key — all solutions' }, label: 'Solutions' },
      ],
  ...
  'word-guess': {
    hero: {
      ...
      images: [
        { src: img('word guess', 'clue-grid-worksheet.webp'), alt: 'Word guess puzzle — fill in missing letters from picture clues' },
        { src: img('word guess', 'clue-grid-worksheet-2.webp'), alt: 'Picture clue word activity — themed vocabulary' },
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Spotter', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('word guess', 'clue-grid-worksheet-3.webp'), alt: 'Easy word guess — 3-letter words with picture hints' },
        ...
        },
        {
          ...
          image: { src: img('word guess', 'clue-grid-worksheet-4.webp'), alt: 'Medium word guess — themed vocabulary with multiple blanks' },
        ...
        },
        {
          ...
          image: { src: img('word guess', 'clue-grid-worksheet-1.webp'), alt: 'Hard word guess — longer words and custom lists' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('word guess', 'clue-grid-worksheet.webp'), alt: 'Word guess practice — clue grid format' }, label: 'Clue Grid' },
        { image: { src: img('word guess', 'clue-grid-worksheet-2.webp'), alt: 'Word guess variation — different theme' }, label: 'Themed Puzzle' },
        { image: { src: img('word guess', 'clue-grid-answer-key-1.webp'), alt: 'Word guess solution key' }, label: 'Solutions' },
      ],
  ...
  'word-search': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('wordsearch', 'word-search-1-answer-key.webp'), alt: 'Word search solution key' }, label: 'Solutions' },
      ],
  ...
  cryptogram: {
    hero: {
      ...
      images: [
        { src: img('cryptogram', 'cryptogram-worksheet.webp'), alt: 'Cryptogram cipher puzzle — decode pictures to letters' },
        { src: img('cryptogram', 'cryptogram-worksheet-1.webp'), alt: 'Themed cipher activity — picture code worksheet' },
        { src: img('cryptogram', 'cryptogram-worksheet-8.webp'), alt: 'Advanced cryptogram — complex picture cipher' },
      ],
      pills: [
      ...
      tiers: [
        {
          ...
          image: { src: img('cryptogram', 'cryptogram-worksheet-3.webp'), alt: 'Easy cryptogram — simple picture substitution codes' },
        ...
        },
        {
          ...
          image: { src: img('cryptogram', 'cryptogram-worksheet-6.webp'), alt: 'Medium cryptogram — themed phrase decoding' },
        ...
        },
        {
          ...
          image: { src: img('cryptogram', 'cryptogram-worksheet-10.webp'), alt: 'Hard cryptogram — full sentence cipher challenges' },
    ...
    spotlight: {
      ...
      image: { src: img('cryptogram', 'cryptogram-worksheet-2.webp'), alt: 'Spotlight cryptogram — engaging picture cipher puzzle' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('cryptogram', 'cryptogram-worksheet-12.webp'), alt: 'Cryptogram practice — professional layout' }, label: 'Cipher Sheet' },
        { image: { src: img('cryptogram', 'cryptogram-worksheet-15.webp'), alt: 'Cryptogram variation — different theme' }, label: 'Themed Cipher' },
        { image: { src: img('cryptogram', 'cryptogram-answer-key-1.webp'), alt: 'Cryptogram solution key' }, label: 'Solutions' },
      ],
      pills: ['Instant Download', 'No Prep Time', 'Full Solutions', 'Multiple Themes'],
      frameColor: '#4A148C',
    },
  ...
  'big-small': {
      ...
      tiers: [
        {
          ...
          image: { src: img('big small', 'big-small-worksheet-worksheet.webp'), alt: 'Identical images mode — spot the bigger picture' },
        ...
        },
        {
          ...
          image: { src: img('big small', 'big-small-worksheet-worksheet-5.webp'), alt: 'Different images mode — compare different pictures' },
        ...
        },
        {
          ...
          image: { src: img('big small', 'big-small-worksheet-worksheet-10.webp'), alt: 'Numbered ordering — rank three items by size' },
    ...
    spotlight: {
      ...
      image: { src: img('big small', 'big-small-worksheet-worksheet-15.webp'), alt: 'Spotlight big-small — adorable themed size comparison activity' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('big small', 'big-small-worksheet-worksheet-20.webp'), alt: 'Size comparison practice — themed layout' }, label: 'Size Sort' },
        { image: { src: img('big small', 'big-small-worksheet-worksheet-25.webp'), alt: 'Size comparison variation — different theme' }, label: 'Compare' },
        { image: { src: img('big small', 'big-small-worksheet-answer-key-1.webp'), alt: 'Big-small answer key' }, label: 'Solutions' },
      ],
  ...
  'pattern-train': {
    hero: {
      ...
      images: [
        { src: img('pattern train', 'pattern-train-worksheet.webp'), alt: 'Pattern train worksheet — complete the sequence in train cars' },
        { src: img('pattern train', 'pattern-train-worksheet-2.webp'), alt: 'Train-themed pattern activity — cut and paste' },
        { src: img('pattern train', 'pattern-train-worksheet-5.webp'), alt: 'Pattern train — multi-element sequence challenge' },
      ],
      pills: [
        { label: 'Cut & Paste', icon: '✂' },
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Starter', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('pattern train', 'pattern-train-worksheet-3.webp'), alt: 'Easy pattern train — simple AB repeating patterns' },
        ...
        },
        {
          ...
          image: { src: img('pattern train', 'pattern-train-worksheet-8.webp'), alt: 'Medium pattern train — ABC and ABB patterns' },
        ...
        },
        {
          ...
          image: { src: img('pattern train', 'pattern-train-worksheet-15.webp'), alt: 'Hard pattern train — complex multi-element patterns' },
    ...
    spotlight: {
      ...
      image: { src: img('pattern train', 'pattern-train-worksheet-1.webp'), alt: 'Spotlight pattern train — colorful cut-and-paste sequence activity' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('pattern train', 'pattern-train-worksheet-10.webp'), alt: 'Pattern train practice — themed layout' }, label: 'Train Activity' },
        { image: { src: img('pattern train', 'pattern-train-worksheet-18.webp'), alt: 'Pattern train variation — different pattern type' }, label: 'Sequence Sheet' },
        { image: { src: img('pattern train', 'pattern-train-answer-key-1.webp'), alt: 'Pattern train solution key' }, label: 'Solutions' },
      ],
  ...
  'pattern-worksheet': {
    hero: {
      ...
      images: [
        { src: img('pattern worksheet', 'pattern-worksheet.webp'), alt: 'Pattern sequence worksheet — identify the next shape' },
        { src: img('pattern worksheet', 'pattern-worksheet-1.webp'), alt: 'Visual pattern activity — complete the sequence' },
        { src: img('pattern worksheet', 'pattern-worksheet-5.webp'), alt: 'Pattern challenge — multi-element sequences' },
      ],
      pills: [
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Beginner', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('pattern worksheet', 'pattern-worksheet-3.webp'), alt: 'Easy patterns — simple shape repetitions' },
        ...
        },
        {
          ...
          image: { src: img('pattern worksheet', 'pattern-worksheet-8.webp'), alt: 'Medium patterns — color and shape combos' },
          desc: 'Color-shape combinations with growing complexity',
        },
        {
          name: 'Expert', gradientClass: 'from-amber-400 to-orange-500', textColorClass: 'text-amber-700', borderColorClass: 'border-amber-300', stars: 3,
          image: { src: img('pattern worksheet', 'pattern-worksheet-15.webp'), alt: 'Hard patterns — multi-attribute sequences' },
    ...
    spotlight: {
      ...
      image: { src: img('pattern worksheet', 'pattern-worksheet-2.webp'), alt: 'Spotlight pattern worksheet — vibrant sequence completion activity' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('pattern worksheet', 'pattern-worksheet-10.webp'), alt: 'Pattern practice — professional layout' }, label: 'Sequence Sheet' },
        { image: { src: img('pattern worksheet', 'pattern-worksheet-12.webp'), alt: 'Pattern variation — different element types' }, label: 'Pattern Activity' },
        { image: { src: img('pattern worksheet', 'pattern-answer-key-1.webp'), alt: 'Pattern worksheet solution key' }, label: 'Solutions' },
      ],
  ...
  'draw-and-color': {
    hero: {
      ...
      images: [
        { src: img('draw and color', 'grid-drawing-worksheet.webp'), alt: 'Grid drawing activity — copy animal art square by square' },
        { src: img('draw and color', 'grid-drawing-worksheet-1.webp'), alt: 'Grid art worksheet — themed picture to copy' },
        { src: img('draw and color', 'grid-drawing-worksheet-8.webp'), alt: 'Grid drawing challenge — detailed animal art' },
      ],
      pills: [
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Beginner', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('draw and color', 'grid-drawing-worksheet-5.webp'), alt: 'Easy grid drawing — large squares, simple shapes' },
        ...
        },
        {
          ...
          image: { src: img('draw and color', 'grid-drawing-worksheet-10.webp'), alt: 'Medium grid drawing — animal pictures with detail' },
          desc: 'Animal pictures with medium grid detail',
        },
        {
          name: 'Master', gradientClass: 'from-amber-400 to-orange-500', textColorClass: 'text-amber-700', borderColorClass: 'border-amber-300', stars: 3,
          image: { src: img('draw and color', 'grid-drawing-worksheet-20.webp'), alt: 'Advanced grid drawing — fine detail artwork' },
    ...
    spotlight: {
      ...
      image: { src: img('draw and color', 'grid-drawing-worksheet-2.webp'), alt: 'Spotlight grid drawing — adorable animal to copy square by square' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('draw and color', 'grid-drawing-worksheet-15.webp'), alt: 'Grid drawing practice — professional layout' }, label: 'Grid Art' },
        { image: { src: img('draw and color', 'grid-drawing-worksheet-25.webp'), alt: 'Grid drawing variation — different animal' }, label: 'Animal Art' },
        { image: { src: img('draw and color', 'grid-drawing-worksheet-30.webp'), alt: 'Grid drawing — detailed challenge' }, label: 'Challenge' },
      ],
  ...
  'drawing-lines': {
    hero: {
      ...
      images: [
        { src: img('drawing lines', 'drawing-lines-horizontal.webp'), alt: 'Horizontal line tracing — guided fine motor practice' },
        { src: img('drawing lines', 'drawing-lines-vertical.webp'), alt: 'Vertical line drawing — pre-writing preparation' },
        { src: img('drawing lines', 'drawing-lines-curve-1.webp'), alt: 'Curved line tracing — build pencil control' },
      ],
      pills: [
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Starter', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('drawing lines', 'drawing-lines-worksheet-1.webp'), alt: 'Easy line tracing — horizontal and vertical guides' },
        ...
        },
        {
          ...
          image: { src: img('drawing lines', 'drawing-lines-diagonal-1.webp'), alt: 'Medium line practice — diagonal and zigzag paths' },
        ...
        },
        {
          ...
          image: { src: img('drawing lines', 'drawing-lines-curve-2.webp'), alt: 'Advanced line drawing — curves, waves, and spirals' },
    ...
    spotlight: {
      ...
      image: { src: img('drawing lines', 'drawing-lines-curve-3.webp'), alt: 'Spotlight line drawing — guided curve tracing with cute pictures' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('drawing lines', 'drawing-lines-worksheet-5.webp'), alt: 'Line drawing practice — professional layout' }, label: 'Line Practice' },
        { image: { src: img('drawing lines', 'drawing-lines-worksheet-15.webp'), alt: 'Line tracing variation — different path types' }, label: 'Path Tracing' },
  ...
  'chart-count': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('chart count', 'picture-graph-1-answer-key.webp'), alt: 'Picture graph answer key' }, label: 'Solutions' },
      ],
      pills: ['Instant Download', 'No Prep Time', 'Full Solutions', 'Multiple Themes'],
      frameColor: '#E65100',
    },
  ...
  matching: {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('matching', 'match-up-1-answer-key.webp'), alt: 'Matching answer key' }, label: 'Solutions' },
      ],
  ...
  'grid-match': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('grid match', 'grid-match-answer-key-1.webp'), alt: 'Grid match solution key' }, label: 'Solutions' },
      ],
  ...
  bingo: {
    hero: {
      ...
      images: [
        { src: img('bingo', 'bingo-card.webp'), alt: 'Custom bingo card — themed picture bingo for any group size' },
        { src: img('bingo', 'bingo-card-1.webp'), alt: 'Picture bingo card — image-based game activity' },
        { src: img('bingo', 'bingo-card-2.webp'), alt: 'Bingo card set — multiple unique cards per theme' },
      ],
      pills: [
      ...
      tiers: [
        {
          ...
          image: { src: img('bingo', 'bingo-card-3.webp'), alt: '3x3 bingo — quick 9-square game cards' },
        ...
        },
        {
          ...
          image: { src: img('bingo', 'bingo-card-word.webp'), alt: '4x4 bingo — 16-square word mode cards' },
        ...
        },
        {
          ...
          image: { src: img('bingo', 'bingo-card-4.webp'), alt: '5x5 bingo — classic 25-square board' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('bingo', 'bingo-card-1-word.webp'), alt: 'Bingo word card — professional game material' }, label: 'Word Card' },
  ...
  'picture-sort': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('picture sort', 'picture-sort-answer-key-1.webp'), alt: 'Picture sort solution key' }, label: 'Solutions' },
      ],
  ...
  'missing-pieces': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('missing pieces', 'missing-pieces-answer-key-1.webp'), alt: 'Missing pieces solution key' }, label: 'Solutions' },
      ],
      pills: ['Instant Download', 'No Prep Time', 'Full Solutions', 'Multiple Themes'],
      frameColor: '#2E7D32',
    },
  ...
  sudoku: {
    hero: {
      ...
      images: [
        { src: img('sudoku', 'sudoku-easy.webp'), alt: 'Picture sudoku — easy 4x4 grid with animal images' },
      ...
      tiers: [
        {
          ...
          image: { src: img('sudoku', 'sudoku-worksheet.webp'), alt: 'Easy sudoku — few missing animal pictures' },
        ...
        },
        {
          ...
          image: { src: img('sudoku', 'sudoku-worksheet-5.webp'), alt: 'Medium sudoku — more blanks with themed animals' },
        ...
        },
        {
          ...
          image: { src: img('sudoku', 'sudoku-worksheet-10.webp'), alt: 'Hard sudoku — mostly empty grid logic challenge' },
    ...
    spotlight: {
      ...
      image: { src: img('sudoku', 'sudoku-worksheet-3.webp'), alt: 'Spotlight sudoku — adorable animal picture grid puzzle' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('sudoku', 'sudoku-worksheet-15.webp'), alt: 'Sudoku practice — professional layout' }, label: 'Logic Puzzle' },
        { image: { src: img('sudoku', 'sudoku-worksheet-20.webp'), alt: 'Sudoku variation — different animal set' }, label: 'Themed Grid' },
        { image: { src: img('sudoku', 'sudoku-answer-key-1.webp'), alt: 'Sudoku solution key' }, label: 'Solutions' },
      ],
      pills: ['Instant Download', 'No Prep Time', 'Full Solutions', 'Animal Themes'],
      frameColor: '#00695C',
    },
  ...
  'picture-path': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('picture path', 'picture-pathway-answer-key-1.webp'), alt: 'Picture pathway solution key' }, label: 'Solutions' },
      ],
      pills: ['Instant Download', 'No Prep Time', 'Full Solutions', 'Multiple Themes'],
      frameColor: '#1B5E20',
    },
  ...
  'find-and-count': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('find and count', 'i-spy-1-answer-key.webp'), alt: 'I Spy solution key' }, label: 'Solutions' },
      ],
      pills: ['Instant Download', 'No Prep Time', 'Full Solutions', 'Multiple Themes'],
      frameColor: '#00838F',
    },
  ...
  'find-objects': {
    hero: {
      ...
      images: [
        { src: img('find objects', 'spotworks-worksheet.webp'), alt: 'Spot the objects — eagle eye visual search challenge' },
        { src: img('find objects', 'spotworks-worksheet-1.webp'), alt: 'Object finding activity — themed scene search' },
        { src: img('find objects', 'spotworks-worksheet-8.webp'), alt: 'Visual perception challenge — find hidden details' },
      ],
      pills: [
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Rookie', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('find objects', 'spotworks-worksheet-5.webp'), alt: 'Easy object finding — clear visible items' },
        ...
        },
        {
          ...
          image: { src: img('find objects', 'spotworks-worksheet-10.webp'), alt: 'Medium object finding — camouflaged items in scenes' },
        ...
        },
        {
          ...
          image: { src: img('find objects', 'spotworks-worksheet-20.webp'), alt: 'Hard object finding — tiny hidden details' },
    ...
    spotlight: {
      ...
      image: { src: img('find objects', 'spotworks-worksheet-2.webp'), alt: 'Spotlight object finder — exciting visual search activity' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('find objects', 'spotworks-worksheet-15.webp'), alt: 'Object finding practice — professional layout' }, label: 'Search Sheet' },
        { image: { src: img('find objects', 'spotworks-worksheet-25.webp'), alt: 'Object finding variation — different theme' }, label: 'Challenge' },
        { image: { src: img('find objects', 'spotworks-answer-key-1.webp'), alt: 'Object finding solution key' }, label: 'Solutions' },
      ],
      pills: ['Instant Download', 'No Prep Time', 'Full Solutions', 'Multiple Themes'],
      frameColor: '#C62828',
    },
  ...
  crossword: {
    hero: {
      ...
      images: [
        { src: img('crossword', 'crossword-worksheet.webp'), alt: 'Picture crossword — solve using image clues instead of text' },
        { src: img('crossword', 'crossword-worksheet-1.webp'), alt: 'Themed crossword activity — picture-based vocabulary' },
        { src: img('crossword', 'crossword-worksheet-5.webp'), alt: 'Crossword challenge — larger grid with more picture clues' },
      ],
      pills: [
        { label: 'Picture Clues', icon: '📸' },
    ...
    tiered: {
      ...
      tiers: [
        {
          name: 'Starter', gradientClass: 'from-green-400 to-emerald-500', textColorClass: 'text-green-700', borderColorClass: 'border-green-300', stars: 1,
          image: { src: img('crossword', 'crossword-worksheet-3.webp'), alt: 'Easy crossword — small grid with 4-6 picture clues' },
        ...
        },
        {
          ...
          image: { src: img('crossword', 'crossword-worksheet-6.webp'), alt: 'Medium crossword — themed grid with vocabulary' },
          desc: 'Themed grids with crossing word intersections',
        },
        {
          name: 'Expert', gradientClass: 'from-amber-400 to-orange-500', textColorClass: 'text-amber-700', borderColorClass: 'border-amber-300', stars: 3,
          image: { src: img('crossword', 'crossword-worksheet-10.webp'), alt: 'Hard crossword — large grid with 10+ clues' },
    ...
    spotlight: {
      ...
      image: { src: img('crossword', 'crossword-worksheet-2.webp'), alt: 'Spotlight crossword — engaging picture-clue vocabulary puzzle' },
    ...
    gallery: {
      ...
      items: [
        { image: { src: img('crossword', 'crossword-worksheet-8.webp'), alt: 'Crossword practice — professional layout' }, label: 'Puzzle Grid' },
        { image: { src: img('crossword', 'crossword-worksheet-12.webp'), alt: 'Crossword variation — different theme' }, label: 'Themed Puzzle' },
        { image: { src: img('crossword', 'crossword-answer-key-1.webp'), alt: 'Crossword solution key' }, label: 'Solutions' },
      ],
  ...
  'treasure-hunt': {
    ...
    gallery: {
      ...
      items: [
        ...
        { image: { src: img('treasure hunt', 'treasure-hunt-1-answer-key.webp'), alt: 'Treasure hunt solution key' }, label: 'Solutions' },
      ],
...
const daToolText: Record<string, FrTextTuple> = {
  'image-addition': ['Regn med billeder!', 'Professionelle additionsopgaver med tematiske billeder', 'Differentieret læring for hvert barn', 'Tre sværhedsgrader der vokser med eleverne', 'Simpel billedtælling (1-5)', 'Blandede billeder til 10', 'Avancerede opgaver til 20', 'Hvert barn lærer i sit eget tempo', 'Additionssjov!', 'Regn med glæde', 'Professionelle opgaveark', 'Materiale skabt med omhu'],
  'image-subtraction': ['Subtraktion bliver sjovt!', 'Overstryg og sammenlign med tematiske billeder', 'Trin for trin subtraktion', 'Tre niveauer fra enkelt til udfordrende', 'Overstryg billeder (1-5)', 'Billed-tal til 10', 'Blandede tilstande til 20', 'Hver opgave opbygger selvtillid', 'Subtraktionssjov!', 'Subtraktion er sjovt', 'Professionelle opgaveark', 'Tydelige layouts til elever'],
  'code-addition': ['Knæk koden med addition!', 'Kodeadditionsopgaver med tematiske billeder', 'Tre spændende kodeniveauer', 'Fra enkle til avancerede koder', 'Enkle koder (1-5)', 'Mellemsvære koder til 10', 'Avancerede koder til 20', 'Børn elsker at knække koder', 'Hemmelig kode!', 'Matematik og mysterier', 'Kreative opgaveark', 'Opgaver der kombinerer matte og sjov'],
  'more-less': ['Mere eller mindre?', 'Sammenligningsopgaver med tematiske billeder', 'Tre sammenligningsniveauer', 'Fra enkle til avancerede sammenligninger', 'Sammenlign mængder (1-5)', 'Temagrupper til 10', 'Større, mindre og lig med', 'Sammenligning bygger matematikgrundlag', 'Sammenlign!', 'Mere eller mindre?', 'Professionelle opgaveark', 'Visuelle sammenligninger for elever'],
  'math-puzzle': ['Matematikpuslespil!', 'Mattepuslespil med tematiske billeder', 'Tre puslespilsniveauer', 'Fra enkle til udfordrende puslespil', 'Enkle puslespil (1-5)', 'Mellemsvære puslespil til 10', 'Avancerede puslespil til 20', 'Puslespil skærper tænkningen', 'Puslespilstid!', 'Tænk og løs', 'Kreative puslespil', 'Matematik der føles som leg'],
  'math-worksheet': ['Matematikopgaver!', 'Professionelle matematikopgaver med billeder', 'Tre sværhedsgrader', 'Fra grundlæggende til avanceret', 'Grundlæggende regning (1-5)', 'Blandet regning til 10', 'Avanceret regning til 20', 'Daglig øvelse gør mester', 'Matematiksjov!', 'Tal og opgaver', 'Professionelle opgaveark', 'Omhyggeligt designede opgaver'],
  'alphabet-train': ['Alle ombord!', 'Alfabettog med tematiske billeder', 'Tre spor til læring', 'Fra genkendelse til mestring', 'Store bogstaver', 'Små bogstaver', 'Komplet alfabetøvelse', 'Bogstaver er nøglen til verdenen', 'Bogstavsjov!', 'Alfabetet kalder', 'Professionelle opgaveark', 'Farverige bogstavopgaver'],
  prepositions: ['Lær præpositioner!', 'Præpositionsopgaver med tematiske billeder', 'Tre sprogniveauer', 'Fra enkle til avancerede præpositioner', 'Grundlæggende (på, i, under)', 'Flere præpositioner med billeder', 'Avancerede sætninger', 'Sprog åbner døre', 'Sproglig sjov!', 'Ord og billeder', 'Professionelle opgaveark', 'Visuelle sprogøvelser'],
  'word-guess': ['Gæt ordet!', 'Ordgætning med billedledetråde', 'Tre gætteniveauer', 'Fra enkle til udfordrende ord', 'Korte ord med hjælp', 'Mellemlange ord', 'Lange udfordrende ord', 'Hvert ord er en sejr', 'Gæt og lær!', 'Ord er magi', 'Kreative opgaveark', 'Ordpuslespil med billeder'],
  'word-scramble': ['Bland bogstaverne!', 'Bogstavrod med tematiske billeder', 'Tre udfordringsniveauer', 'Fra enkle til avancerede ord', 'Korte ord (3-4 bogstaver)', 'Mellemlange (5-6 bogstaver)', 'Lange ord (7+ bogstaver)', 'Bogstavrod er læring i forklædning', 'Bogstavrod!', 'Ord i uorden', 'Kreative opgaveark', 'Stavning som et spil'],
  'word-search': ['Find ordene!', 'Ordsøgning med tematiske ordforråd', 'Tre søgeniveauer', 'Fra enkle til udfordrende gitter', 'Lille gitter (6 ord)', 'Mellemstort (10 ord)', 'Stort gitter (15+ ord)', 'Ordsøgning skærper fokus', 'Ordsøgning!', 'Søg og find', 'Professionelle opgaveark', 'Tematiske ordsøgninger'],
  cryptogram: ['Knæk billedkoden!', 'Kryptogrammer med billedkoder', 'Tre kodeniveauer', 'Fra enkle til avancerede krypteringer', 'Enkle koder', 'Mellemsvære koder', 'Avancerede koder', 'Kodeknækning er detektivarbejde', 'Kryptogram!', 'Knæk koden', 'Kreative opgaveark', 'Hemmelige beskeder med billeder'],
  writing: ['Skriv og lær!', 'Skriveøvelser til håndsudvikling', 'Tre skriveniveauer', 'Fra streger til skrift', 'Streger og former', 'Bogstaver og tal', 'Ord og sætninger', 'Øvelse gør mester', 'Skriveøvelser!', 'Pen på papir', 'Professionelle opgaveark', 'Strukturerede skriveøvelser'],
  'big-small': ['Stort eller lille?', 'Størrelsesopgaver med tematiske billeder', 'Tre sammenligningsniveauer', 'Fra tydelige til subtile forskelle', 'Tydelige størrelsesforskelle', 'Subtile sammenligninger', 'Kompleks ordning', 'Sammenligning styrker logik', 'Størrelsessjov!', 'Stort og småt', 'Professionelle opgaveark', 'Visuelle sammenligninger'],
  'pattern-train': ['Mønstertoget!', 'Mønsteropgaver med tematiske billeder', 'Tre mønsterniveauer', 'Fra enkle til komplekse mønstre', 'AB-mønstre', 'ABC-mønstre', 'AABB-mønstre', 'Mønstre er fundamentet for matematik', 'Mønstersjov!', 'Find mønsteret', 'Professionelle opgaveark', 'Farverige mønsteropgaver'],
  'pattern-worksheet': ['Find mønsteret!', 'Mønstergåder med tematiske billeder', 'Tre sværhedsgrader', 'Fra enkle til avancerede gåder', 'Enkle mønstre', 'Mellemsvære mønstre', 'Komplekse mønstre', 'Mønstergenkendelse er en superkraft', 'Mønstergåder!', 'Tænk og find', 'Kreative opgaveark', 'Systematisk mønstergenkendelse'],
  'draw-and-color': ['Tegn og farvelæg!', 'Trin-for-trin tegning med billeder', 'Tre kreative niveauer', 'Fra guidet til fri tegning', 'Enkle former', 'Mere detaljeret', 'Kreative skabelser', 'Tegning udvikler finmotorik', 'Tegnesjov!', 'Kreativt arbejde', 'Kreative opgaveark', 'Tegneaktiviteter for alle'],
  'drawing-lines': ['Tegn linjer!', 'Linjetegning med tematiske øvelser', 'Tre linjeniveauer', 'Fra rette til komplekse linjer', 'Rette linjer', 'Buede linjer', 'Komplekse mønstre', 'Linjer forbereder til skrivning', 'Linjesjov!', 'Streg for streg', 'Professionelle opgaveark', 'Skriveforberedende øvelser'],
  coloring: ['Farvelæg med glæde!', 'Farvelægning med 100+ temaer', 'Tre farvelægningsniveauer', 'Fra enkle til detaljerede', 'Store farveområder', 'Detaljerede konturer', 'Fine detaljer', 'Farvelægning bygger fokus og kreativitet', 'Farvelægning!', 'En verden af farver', 'Professionelle opgaveark', '100+ temaer at vælge mellem'],
  'chart-count': ['Tæl og diagram!', 'Billeddiagrammer med tematiske billeder', 'Tre diagramniveauer', 'Fra enkle til avancerede', 'Enkle diagrammer', 'Flere kategorier', 'Kompleks analyse', 'Diagrammer er en vigtig færdighed', 'Diagramsjov!', 'Tæl og tegn', 'Professionelle opgaveark', 'Visuel databehandling'],
  matching: ['Find parrene!', 'Parringsopgaver med tematiske billeder', 'Tre parringssniveauer', 'Fra enkle til udfordrende par', 'Tydelig pargenkendelse', 'Subtilere parringer', 'Avanceret kategorisering', 'Parring udvikler opmærksomhed', 'Parringssjov!', 'Find paret', 'Professionelle opgaveark', 'Visuelle parringsøvelser'],
  'grid-match': ['Gitterpuslespil!', 'Gitterpuslespil med tematiske billeder', 'Tre gitterniveauer', 'Fra enkle til komplekse gittere', 'Enkelt 2x2', 'Mellemsvært 3x3', 'Avanceret 4x4', 'Gitterpuslespil styrker rumlig tænkning', 'Gittersjov!', 'Tænk i gitter', 'Professionelle opgaveark', 'Rumlig tænkning med puslespil'],
  'shadow-match': ['Match skyggerne!', 'Skyggematching med tematiske billeder', 'Tre skyggeniveauer', 'Fra tydelige til subtile skygger', 'Tydelige skygger', 'Roterede skygger', 'Komplekse puslespil', 'Skyggematching skærper blikket', 'Skyggesjov!', 'Find skyggen', 'Professionelle opgaveark', 'Visuel diskrimination for alle'],
  bingo: ['Billedbingo!', 'Bingoplader med tematiske billeder', 'Tre bingovarianter', 'Fra enkle til avancerede plader', 'Enkelt 3x3', 'Billedbingo 4x4', 'Komplet 5x5', 'Bingo gør læring til fest', 'Bingosjov!', 'Øjnene på pladen', 'Professionelle bingoplader', 'Gruppeaktiviteter for alle'],
  'picture-sort': ['Sorter billederne!', 'Sorteringsopgaver med tematiske billeder', 'Tre sorteringsniveauer', 'Fra enkle til avancerede kategorier', '2 kategorier', '3 kategorier', '4+ kategorier', 'Sortering udvikler logik', 'Sorteringssjov!', 'Del op og ordne', 'Professionelle opgaveark', 'Klassificering for alle'],
  'missing-pieces': ['Find de manglende dele!', 'Puslespilsopgaver med tematiske billeder', 'Tre puslespilsniveauer', 'Fra enkle til udfordrende', 'Tydelige manglende dele', 'Subtile manglende dele', 'Komplekse visuelle puslespil', 'Puslespil skærper opmærksomheden', 'Puslespilstid!', 'Hvad mangler?', 'Professionelle opgaveark', 'Visuel logik for alle'],
  'odd-one-out': ['Find den ulige!', 'Opgaver med tematiske billeder', 'Tre udfordringsniveauer', 'Fra tydelige til subtile forskelle', 'Tydelig forskel (3)', 'Mellemsvært (4)', 'Avanceret (6+)', 'Observation styrker kritisk tænkning', 'Hvem skiller sig ud?', 'Find forskellen', 'Professionelle opgaveark', 'Visuelt ræsonnement'],
  sudoku: ['Billede-Sudoku!', 'Sudoku med billeder i stedet for tal', 'Tre sudokuniveauer', 'Fra begynder til ekspert', 'Enkelt 4x4', 'Mellemsvært 6x6', 'Svært 9x9', 'Sudoku bygger logisk ræsonnement', 'Sudokusjov!', 'Tænk logisk', 'Professionelle opgaveark', 'Logikpuslespil for alle'],
  'picture-path': ['Følg billedstien!', 'Labyrintopgaver med tematiske billeder', 'Tre stiniveauer', 'Fra enkle til komplekse stier', 'Rette veje', 'Forgrenede veje', 'Komplekse labyrinter', 'Stifinding bygger problemløsning', 'Stisjov!', 'Følg sporet', 'Professionelle opgaveark', 'Navigeringsudfordringer'],
  'find-and-count': ['Find og tæl!', 'Søg og tæl med tematiske scener', 'Tre søgeniveauer', 'Fra lidt til meget at tælle', 'Tæl til 5 i enkle scener', 'Tæl til 10 med flere objekter', 'Tæl til 20 i livlige scener', 'Søg og tæl skærper opmærksomheden', 'Tællesjov!', 'Hvor mange ser du?', 'Professionelle opgaveark', 'Visuelle tælleaktiviteter'],
  'find-objects': ['Find dem alle!', 'Skjulte objekter i detaljerede scener', 'Tre søgeniveauer', 'Fra enkle til udfordrende scener', 'Tydelige objekter', 'Kamuflerede genstande', 'Udfordrende skjulte objekter', 'Skarpe øjne udvikler koncentration', 'Søgesjov!', 'Find genstanden', 'Professionelle opgaveark', 'Koncentrationsudfordringer'],
  crossword: ['Billedkrydsord!', 'Krydsord med billedledetråde', 'Tre krydsordsniveauer', 'Fra enkle til avancerede krydsord', 'Mini-krydsord (5 ord)', 'Mellemkrydsord (10 ord)', 'Stort krydsord (15+ ord)', 'Krydsord styrker ordforrådet', 'Krydsordsjov!', 'Fyld ruterne ud', 'Professionelle opgaveark', 'Ordpuslespil for alle'],
  'treasure-hunt': ['Skattejagt!', 'Korteventyr med skjulte skatte', 'Tre eventyrsniveauer', 'Fra enkle til komplekse kort', 'Enkle rutekort', 'Retningskort', 'Flertrins skattejagter', 'Hver skat styrker problemløsning', 'Skattejagtstid!', 'Find skatten', 'Professionelle opgaveark', 'Spændende korteventyr'],
};
...
const noToolText: Record<string, FrTextTuple> = {
  'image-addition': ['Regn med bilder!', 'Profesjonelle addisjonsoppgaver med tematiske bilder', 'Differensiert laering for hvert barn', 'Tre vanskelighetsgrader som vokser med elevene', 'Enkel bildetelling (1-5)', 'Blandede bilder til 10', 'Avanserte oppgaver til 20', 'Hvert barn laerer i sitt eget tempo', 'Addisjonslek!', 'Regn med glede', 'Profesjonelle arbeidsark', 'Materiale laget med omhu'],
  'image-subtraction': ['Subtraksjon blir goy!', 'Stryk over og sammenlign med tematiske bilder', 'Steg for steg subtraksjon', 'Tre nivaer fra enkelt til utfordrende', 'Stryk over bilder (1-5)', 'Bilde-tall til 10', 'Blandede moduser til 20', 'Hver oppgave bygger selvtillit', 'Subtraksjonslek!', 'Subtraksjon er goy', 'Profesjonelle arbeidsark', 'Tydelige oppsett for elever'],
  'code-addition': ['Knekk koden med addisjon!', 'Kodeaddisjonsoppgaver med tematiske bilder', 'Tre spennende kodenivaer', 'Fra enkle til avanserte koder', 'Enkle koder (1-5)', 'Mellomkoder til 10', 'Avanserte koder til 20', 'Barn elsker a knekke koder', 'Hemmelig kode!', 'Matematikk og mysterier', 'Kreative arbeidsark', 'Oppgaver som kombinerer matte og moro'],
  'more-less': ['Mer eller mindre?', 'Sammenligningsoppgaver med tematiske bilder', 'Tre sammenligningsnivaer', 'Fra enkle til avanserte sammenligninger', 'Sammenlign mengder (1-5)', 'Temagrupper til 10', 'Storre, mindre og lik', 'Sammenligning bygger matematikkgrunnlag', 'Sammenlign!', 'Mer eller mindre?', 'Profesjonelle arbeidsark', 'Visuelle sammenligninger for elever'],
  'math-puzzle': ['Matematikkpuslespill!', 'Mattepuslespill med tematiske bilder', 'Tre puslespillsnivaer', 'Fra enkle til utfordrende puslespill', 'Enkle puslespill (1-5)', 'Mellomvanskelige puslespill til 10', 'Avanserte puslespill til 20', 'Puslespill skjerper tenkningen', 'Puslespilltid!', 'Tenk og los', 'Kreative puslespill', 'Matematikk som foeles som lek'],
  'math-worksheet': ['Matematikkoppgaver!', 'Profesjonelle matematikkoppgaver med bilder', 'Tre vanskelighetsgrader', 'Fra grunnleggende til avansert', 'Grunnleggende regning (1-5)', 'Blandet regning til 10', 'Avansert regning til 20', 'Daglig ovelse gjor mester', 'Mattemoro!', 'Tall og oppgaver', 'Profesjonelle arbeidsark', 'Omhyggelig designede oppgaver'],
  'alphabet-train': ['Alle om bord!', 'Alfabettog med tematiske bilder', 'Tre spor til laering', 'Fra gjenkjenning til mestring', 'Store bokstaver', 'Sma bokstaver', 'Komplett alfabetovelse', 'Bokstaver er noklen til verden', 'Bokstavmoro!', 'Alfabetet kaller', 'Profesjonelle arbeidsark', 'Fargerike bokstavoppgaver'],
  prepositions: ['Laer preposisjoner!', 'Preposisjonsoppgaver med tematiske bilder', 'Tre spraknivaer', 'Fra enkle til avanserte preposisjoner', 'Grunnleggende (pa, i, under)', 'Flere preposisjoner med bilder', 'Avanserte setninger', 'Sprak apner dorer', 'Sprakmoro!', 'Ord og bilder', 'Profesjonelle arbeidsark', 'Visuelle sprakovelser'],
  'word-guess': ['Gjett ordet!', 'Ordgjetting med bildeledetrad', 'Tre gjettevanskelighetsniva', 'Fra enkle til utfordrende ord', 'Korte ord med hjelp', 'Mellomlange ord', 'Lange utfordrende ord', 'Hvert ord er en seier', 'Gjett og laer!', 'Ord er magi', 'Kreative arbeidsark', 'Ordpuslespill med bilder'],
  'word-scramble': ['Bland bokstavene!', 'Bokstavblanding med tematiske bilder', 'Tre utfordringsnivaer', 'Fra enkle til avanserte ord', 'Korte ord (3-4 bokstaver)', 'Mellomlange (5-6 bokstaver)', 'Lange ord (7+ bokstaver)', 'Bokstavblanding er laering i forkledning', 'Bokstavblanding!', 'Ord i uorden', 'Kreative arbeidsark', 'Staving som et spill'],
  'word-search': ['Finn ordene!', 'Ordsøk med tematiske ordforråd', 'Tre søkenivåer', 'Fra enkle til utfordrende rutenett', 'Lite rutenett (6 ord)', 'Mellomstort (10 ord)', 'Stort rutenett (15+ ord)', 'Ordsøk skjerper fokus', 'Ordsøk!', 'Søk og finn', 'Profesjonelle arbeidsark', 'Tematiske ordsøk'],
  cryptogram: ['Knekk bildekoden!', 'Kryptogrammer med bildekoder', 'Tre kodenivaer', 'Fra enkle til avanserte krypteringer', 'Enkle koder', 'Mellomvanskelige koder', 'Avanserte koder', 'Kodeknekking er detektivarbeid', 'Kryptogram!', 'Knekk koden', 'Kreative arbeidsark', 'Hemmelige meldinger med bilder'],
  writing: ['Skriv og laer!', 'Skriveovelser for handsutvikling', 'Tre skrivenivaer', 'Fra streker til skrift', 'Streker og former', 'Bokstaver og tall', 'Ord og setninger', 'Ovelse gjor mester', 'Skriveovelser!', 'Penn pa papir', 'Profesjonelle arbeidsark', 'Strukturerte skriveovelser'],
  'big-small': ['Stort eller lite?', 'Storrelsesoppgaver med tematiske bilder', 'Tre sammenligningsnivaer', 'Fra tydelige til subtile forskjeller', 'Tydelige storrelsesforskjeller', 'Subtile sammenligninger', 'Kompleks ordning', 'Sammenligning styrker logikk', 'Storrelsesmoro!', 'Stort og smatt', 'Profesjonelle arbeidsark', 'Visuelle sammenligninger'],
  'pattern-train': ['Monstertoget!', 'Monsteroppgaver med tematiske bilder', 'Tre monsternivaer', 'Fra enkle til komplekse monstre', 'AB-monstre', 'ABC-monstre', 'AABB-monstre', 'Monstre er fundamentet for matematikk', 'Monstermoro!', 'Finn monsteret', 'Profesjonelle arbeidsark', 'Fargerike monsteroppgaver'],
  'pattern-worksheet': ['Finn monsteret!', 'Monstergater med tematiske bilder', 'Tre vanskelighetsgrader', 'Fra enkle til avanserte gater', 'Enkle monstre', 'Mellomvanskelige monstre', 'Komplekse monstre', 'Monstergjenkjenning er en superkraft', 'Monstergater!', 'Tenk og finn', 'Kreative arbeidsark', 'Systematisk monstergjenkjenning'],
  'draw-and-color': ['Tegn og fargelegg!', 'Steg-for-steg tegning med bilder', 'Tre kreative nivaer', 'Fra guidet til fri tegning', 'Enkle former', 'Mer detaljert', 'Kreative skapelser', 'Tegning utvikler finmotorikk', 'Tegnemoro!', 'Kreativt arbeid', 'Kreative arbeidsark', 'Tegneaktiviteter for alle'],
  'drawing-lines': ['Tegn linjer!', 'Linjetegning med tematiske ovelser', 'Tre linjenivaer', 'Fra rette til komplekse linjer', 'Rette linjer', 'Buede linjer', 'Komplekse monstre', 'Linjer forbereder til skriving', 'Linjemoro!', 'Strek for strek', 'Profesjonelle arbeidsark', 'Skriveforberedende ovelser'],
  coloring: ['Fargelegg med glede!', 'Fargelegging med 100+ temaer', 'Tre fargeleggingsnivaer', 'Fra enkle til detaljerte', 'Store fargeomrader', 'Detaljerte konturer', 'Fine detaljer', 'Fargelegging bygger fokus og kreativitet', 'Fargelegging!', 'En verden av farger', 'Profesjonelle arbeidsark', '100+ temaer a velge mellom'],
  'chart-count': ['Tell og diagram!', 'Bildediagrammer med tematiske bilder', 'Tre diagramnivaer', 'Fra enkle til avanserte', 'Enkle diagrammer', 'Flere kategorier', 'Kompleks analyse', 'Diagrammer er en viktig ferdighet', 'Diagrammoro!', 'Tell og tegn', 'Profesjonelle arbeidsark', 'Visuell databehandling'],
  matching: ['Finn parene!', 'Parringsoppgaver med tematiske bilder', 'Tre parringsnivaer', 'Fra enkle til utfordrende par', 'Tydelig pargjenkjenning', 'Subtilere parringer', 'Avansert kategorisering', 'Parring utvikler oppmerksomhet', 'Parringsmoro!', 'Finn paret', 'Profesjonelle arbeidsark', 'Visuelle parringsovelser'],
  'grid-match': ['Rutenettpuslespill!', 'Rutenettpuslespill med tematiske bilder', 'Tre rutenettnivaer', 'Fra enkle til komplekse rutenett', 'Enkelt 2x2', 'Mellomvanskelig 3x3', 'Avansert 4x4', 'Rutenettpuslespill styrker romlig tenkning', 'Rutenettmoro!', 'Tenk i rutenett', 'Profesjonelle arbeidsark', 'Romlig tenkning med puslespill'],
  'shadow-match': ['Match skyggene!', 'Skyggematching med tematiske bilder', 'Tre skyggenivaer', 'Fra tydelige til subtile skygger', 'Tydelige skygger', 'Roterte skygger', 'Komplekse puslespill', 'Skyggematching skjerper blikket', 'Skyggemoro!', 'Finn skyggen', 'Profesjonelle arbeidsark', 'Visuell diskriminering for alle'],
  bingo: ['Bildebingo!', 'Bingobrett med tematiske bilder', 'Tre bingovarianter', 'Fra enkle til avanserte brett', 'Enkelt 3x3', 'Bildebingo 4x4', 'Komplett 5x5', 'Bingo gjor laering til fest', 'Bingomoro!', 'Oynene pa brettet', 'Profesjonelle bingobrett', 'Gruppeaktiviteter for alle'],
  'picture-sort': ['Sorter bildene!', 'Sorteringsoppgaver med tematiske bilder', 'Tre sorteringsnivaer', 'Fra enkle til avanserte kategorier', '2 kategorier', '3 kategorier', '4+ kategorier', 'Sortering utvikler logikk', 'Sorteringsmoro!', 'Del opp og ordne', 'Profesjonelle arbeidsark', 'Klassifisering for alle'],
  'missing-pieces': ['Finn de manglende delene!', 'Puslespillsoppgaver med tematiske bilder', 'Tre puslespillsnivaer', 'Fra enkle til utfordrende', 'Tydelige manglende deler', 'Subtile manglende deler', 'Komplekse visuelle puslespill', 'Puslespill skjerper oppmerksomheten', 'Puslespilltid!', 'Hva mangler?', 'Profesjonelle arbeidsark', 'Visuell logikk for alle'],
  'odd-one-out': ['Finn den ulike!', 'Oppgaver med tematiske bilder', 'Tre utfordringsnivaer', 'Fra tydelige til subtile forskjeller', 'Tydelig forskjell (3)', 'Mellomvanskelig (4)', 'Avansert (6+)', 'Observasjon styrker kritisk tenkning', 'Hvem skiller seg ut?', 'Finn forskjellen', 'Profesjonelle arbeidsark', 'Visuelt resonnement'],
  sudoku: ['Bilde-Sudoku!', 'Sudoku med bilder i stedet for tall', 'Tre sudokunivaer', 'Fra nybegynner til ekspert', 'Enkelt 4x4', 'Mellomvanskelig 6x6', 'Vanskelig 9x9', 'Sudoku bygger logisk resonnement', 'Sudokumoro!', 'Tenk logisk', 'Profesjonelle arbeidsark', 'Logikkpuslespill for alle'],
  'picture-path': ['Folg bildestien!', 'Labyrintoppgaver med tematiske bilder', 'Tre stinivaer', 'Fra enkle til komplekse stier', 'Rette veier', 'Forgrenede veier', 'Komplekse labyrinter', 'Stifinnning bygger problemlosning', 'Stimoro!', 'Folg sporet', 'Profesjonelle arbeidsark', 'Navigeringsutfordringer'],
  'find-and-count': ['Finn og tell!', 'Sok og tell med tematiske scener', 'Tre sokenivaer', 'Fra litt til mye a telle', 'Tell til 5 i enkle scener', 'Tell til 10 med flere objekter', 'Tell til 20 i livlige scener', 'Sok og tell skjerper oppmerksomheten', 'Tellemoro!', 'Hvor mange ser du?', 'Profesjonelle arbeidsark', 'Visuelle telleaktiviteter'],
  'find-objects': ['Finn dem alle!', 'Skjulte objekter i detaljerte scener', 'Tre sokenivaer', 'Fra enkle til utfordrende scener', 'Tydelige objekter', 'Kamuflerte gjenstander', 'Utfordrende skjulte objekter', 'Skarpe oyne utvikler konsentrasjon', 'Sokemoro!', 'Finn gjenstanden', 'Profesjonelle arbeidsark', 'Konsentrasjonsutfordringer'],
  crossword: ['Bildekryssord!', 'Kryssord med bildeledetrader', 'Tre kryssordnivaer', 'Fra enkle til avanserte kryssord', 'Mini-kryssord (5 ord)', 'Mellomkryssord (10 ord)', 'Stort kryssord (15+ ord)', 'Kryssord styrker ordforradet', 'Kryssordmoro!', 'Fyll rutene', 'Profesjonelle arbeidsark', 'Ordpuslespill for alle'],
  'treasure-hunt': ['Skattejakt!', 'Karteventyr med skjulte skatter', 'Tre eventyrnivaer', 'Fra enkle til komplekse kart', 'Enkle rutekart', 'Retningskart', 'Flertrinns skattejakter', 'Hver skatt styrker problemlosning', 'Skattejakttid!', 'Finn skatten', 'Profesjonelle arbeidsark', 'Spennende karteventyr'],
};

const fiToolText: Record<string, FrTextTuple> = {
  'image-addition': ['Laske kuvilla!', 'Ammattimaiset yhteenlaskutehtavat temaattisilla kuvilla', 'Eriytetty oppiminen jokaiselle lapselle', 'Kolme vaikeustasoa jotka kasvavat oppilaiden mukana', 'Yksinkertainen kuvien laskeminen (1-5)', 'Sekoitetut kuvat 10 asti', 'Edistyneet tehtavat 20 asti', 'Jokainen lapsi oppii omaan tahtiinsa', 'Yhteenlaskuhauskaa!', 'Laske ilolla', 'Ammattimaiset tyolehdet', 'Huolella luotu materiaali'],
  'image-subtraction': ['Vahennyslaskusta tulee hauskaa!', 'Yliviivaa ja vertaa temaattisilla kuvilla', 'Askel askeleelta vahennyslasku', 'Kolme tasoa yksinkertaisesta haastavaan', 'Yliviivaa kuvia (1-5)', 'Kuva-luvut 10 asti', 'Sekoitetut tilat 20 asti', 'Jokainen tehtava rakentaa itseluottamusta', 'Vahennyslaskuhauskaa!', 'Vahennyslasku on hauskaa', 'Ammattimaiset tyolehdet', 'Selkeat asettelut oppilaille'],
  'code-addition': ['Murra koodi yhteenlaskulla!', 'Koodiyhteenlaskutehtavat temaattisilla kuvilla', 'Kolme jannittavaa kooditasoa', 'Yksinkertaisista edistyneisiin koodeihin', 'Yksinkertaiset koodit (1-5)', 'Valikoodit 10 asti', 'Edistyneet koodit 20 asti', 'Lapset rakastavat koodien murtamista', 'Salainen koodi!', 'Matematiikka ja mysteerit', 'Luovat tyolehdet', 'Tehtavat jotka yhdistava matikan ja hauskuuden'],
  'more-less': ['Enemman vai vahemman?', 'Vertailutehtavat temaattisilla kuvilla', 'Kolme vertailutasoa', 'Yksinkertaisista edistyneisiin vertailuihin', 'Vertaa maaria (1-5)', 'Teemaryhmat 10 asti', 'Suurempi, pienempi ja yhta suuri', 'Vertailu rakentaa matematiikan perustan', 'Vertaa!', 'Enemman vai vahemman?', 'Ammattimaiset tyolehdet', 'Visuaaliset vertailut oppilaille'],
  'math-puzzle': ['Matematiikkapulmapelit!', 'Matikkapulmapelit temaattisilla kuvilla', 'Kolme pulmapelitasoa', 'Yksinkertaisista haastaviin pulmapeleihin', 'Yksinkertaiset pulmapelit (1-5)', 'Keskivaikeat pulmapelit 10 asti', 'Edistyneet pulmapelit 20 asti', 'Pulmapelit teravat ajattelua', 'Pulmapeliaika!', 'Ajattele ja ratkaise', 'Luovat pulmapelit', 'Matematiikka joka tuntuu leikilta'],
  'math-worksheet': ['Matematiikkatehtavat!', 'Ammattimaiset matematiikkatehtavat kuvilla', 'Kolme vaikeustasoa', 'Perusteista edistyneeseen', 'Peruslaskutoimitukset (1-5)', 'Sekoitetut laskutoimitukset 10 asti', 'Edistyneet laskutoimitukset 20 asti', 'Paivittainen harjoittelu tekee mestarin', 'Matikkahauskaa!', 'Lukuja ja tehtavia', 'Ammattimaiset tyolehdet', 'Huolellisesti suunnitellut tehtavat'],
  'alphabet-train': ['Kaikki kyytiin!', 'Aakksjuna temaattisilla kuvilla', 'Kolme rataa oppimiseen', 'Tunnistamisesta hallintaan', 'Isot kirjaimet', 'Pienet kirjaimet', 'Taydelliset aakkosharjoitukset', 'Kirjaimet ovat avain maailmaan', 'Kirjainhauskaa!', 'Aakkoset kutsuvat', 'Ammattimaiset tyolehdet', 'Varikkaat kirjaintehtavat'],
  prepositions: ['Opi prepositioita!', 'Prepositiotehtavat temaattisilla kuvilla', 'Kolme kielitasoa', 'Yksinkertaisista edistyneisiin prepositioihin', 'Perusprepositiot (paalla, sisalla, alla)', 'Lisaa prepositioita kuvilla', 'Edistyneet lauseet', 'Kieli avaa ovia', 'Kielihauskaa!', 'Sanoja ja kuvia', 'Ammattimaiset tyolehdet', 'Visuaaliset kieliharjoitukset'],
  'word-guess': ['Arvaa sana!', 'Sanan arvaaminen kuvavihjein', 'Kolme arvaustasoa', 'Yksinkertaisista haastaviin sanoihin', 'Lyhyet sanat avulla', 'Keskipitkat sanat', 'Pitkat haastavat sanat', 'Jokainen sana on voitto', 'Arvaa ja opi!', 'Sanat ovat taikaa', 'Luovat tyolehdet', 'Sanapulmapelit kuvilla'],
  'word-scramble': ['Sekoita kirjaimet!', 'Kirjainsekoitus temaattisilla kuvilla', 'Kolme haastetasoa', 'Yksinkertaisista edistyneisiin sanoihin', 'Lyhyet sanat (3-4 kirjainta)', 'Keskipitkat (5-6 kirjainta)', 'Pitkat sanat (7+ kirjainta)', 'Kirjainsekoitus on oppimista valepuvussa', 'Kirjainsekoitus!', 'Sanoja epajärjestyksessa', 'Luovat tyolehdet', 'Oikeinkirjoitus pelina'],
  'word-search': ['Löydä sanat!', 'Sanahaku temaattisilla sanastoilla', 'Kolme hakutasoa', 'Yksinkertaisista haastaviin ruudukkoihin', 'Pieni ruudukko (6 sanaa)', 'Keskikokoinen (10 sanaa)', 'Suuri ruudukko (15+ sanaa)', 'Sanahaku terävöittää keskittymistä', 'Sanahaku!', 'Etsi ja löydä', 'Ammattimaiset työarkit', 'Temaattiset sanahaut'],
  cryptogram: ['Murra kuvakoodi!', 'Kryptogrammit kuvakoodein', 'Kolme kooditasoa', 'Yksinkertaisista edistyneisiin salakirjoituksiin', 'Yksinkertaiset koodit', 'Keskivaikeat koodit', 'Edistyneet koodit', 'Koodinmurtaminen on etsivätyo', 'Kryptogrammi!', 'Murra koodi', 'Luovat tyolehdet', 'Salaiset viestit kuvilla'],
  writing: ['Kirjoita ja opi!', 'Kirjoitusharjoituksia kaden kehitykseen', 'Kolme kirjoitustasoa', 'Viivoista kirjoitukseen', 'Viivoja ja muotoja', 'Kirjaimia ja numeroita', 'Sanoja ja lauseita', 'Harjoitus tekee mestarin', 'Kirjoitusharjoitukset!', 'Kyna paperilla', 'Ammattimaiset tyolehdet', 'Jäsennellyt kirjoitusharjoitukset'],
  'big-small': ['Iso vai pieni?', 'Kokotehtavat temaattisilla kuvilla', 'Kolme vertailutasoa', 'Selkeista subtileihin eroihin', 'Selkeat kokoerot', 'Hienoiset vertailut', 'Monimutkainen jarjestaminen', 'Vertailu vahvistaa logiikkaa', 'Kokohauskaa!', 'Isoa ja pienta', 'Ammattimaiset tyolehdet', 'Visuaaliset vertailut'],
  'pattern-train': ['Kuviojuna!', 'Kuviotehtavat temaattisilla kuvilla', 'Kolme kuviotasoa', 'Yksinkertaisista monimutkaisiin kuvioihin', 'AB-kuviot', 'ABC-kuviot', 'AABB-kuviot', 'Kuviot ovat matematiikan perusta', 'Kuviohauskaa!', 'Loyda kuvio', 'Ammattimaiset tyolehdet', 'Varikkaat kuviotehtavat'],
  'pattern-worksheet': ['Loyda kuvio!', 'Kuvioarvotuksia temaattisilla kuvilla', 'Kolme vaikeustasoa', 'Yksinkertaisista edistyneisiin arvoituksiin', 'Yksinkertaiset kuviot', 'Keskivaikeat kuviot', 'Monimutkaiset kuviot', 'Kuvioiden tunnistaminen on supervoima', 'Kuvioarvoituksia!', 'Ajattele ja loyda', 'Luovat tyolehdet', 'Jarjestelmalliset kuvioharjoitukset'],
  'draw-and-color': ['Piirra ja varita!', 'Askel askeleelta piirtaminen kuvilla', 'Kolme luovaa tasoa', 'Ohjatusta vapaaseen piirtamiseen', 'Yksinkertaiset muodot', 'Yksityiskohtaisempi', 'Luovat luomukset', 'Piirtaminen kehittaa hienomotoriikkaa', 'Piirtohauskaa!', 'Luovaa tyota', 'Luovat tyolehdet', 'Piirtoaktiviteetteja kaikille'],
  'drawing-lines': ['Piirra viivoja!', 'Viivapiirtaminen temaattisilla harjoituksilla', 'Kolme viivatasoa', 'Suorista monimutkaisiin viivoihin', 'Suorat viivat', 'Kaartuvat viivat', 'Monimutkaiset kuviot', 'Viivat valmistavat kirjoittamiseen', 'Viivahauskaa!', 'Viiva viivalta', 'Ammattimaiset tyolehdet', 'Kirjoitusta valmistavat harjoitukset'],
  coloring: ['Varita ilolla!', 'Varitys 100+ teemalla', 'Kolme varitystasoa', 'Yksinkertaisista yksityiskohtaisiin', 'Suuret varialueet', 'Yksityiskohtaiset aariviivat', 'Hienot yksityiskohdat', 'Varitys rakentaa keskittymista ja luovuutta', 'Varitys!', 'Varien maailma', 'Ammattimaiset tyolehdet', '100+ teemaa valittavana'],
  'chart-count': ['Laske ja kaavio!', 'Kuvakaaviot temaattisilla kuvilla', 'Kolme kaaviotasoa', 'Yksinkertaisista edistyneisiin', 'Yksinkertaiset kaaviot', 'Useampia kategorioita', 'Monimutkainen analyysi', 'Kaaviot ovat tarkea taito', 'Kaaviohauskaa!', 'Laske ja piirra', 'Ammattimaiset tyolehdet', 'Visuaalinen tietojen kasittely'],
  matching: ['Loyda parit!', 'Paritustehtavat temaattisilla kuvilla', 'Kolme paritustasoa', 'Yksinkertaisista haastaviin pareihin', 'Selvä parien tunnistaminen', 'Hienostuneemmat paritukset', 'Edistynyt luokittelu', 'Paritus kehittaa tarkkavaisuutta', 'Paritushauskaa!', 'Loyda pari', 'Ammattimaiset tyolehdet', 'Visuaaliset paritusharjoitukset'],
  'grid-match': ['Ruudukkopulmapeli!', 'Ruudukkopulmat temaattisilla kuvilla', 'Kolme ruudukkotasoa', 'Yksinkertaisista monimutkaisiin ruudukkoihin', 'Yksinkertainen 2x2', 'Keskivaikea 3x3', 'Edistynyt 4x4', 'Ruudukkopulmapelit vahvistavat tilallista ajattelua', 'Ruudukkohauskaa!', 'Ajattele ruudukossa', 'Ammattimaiset tyolehdet', 'Tilallinen ajattelu pulmapeleilla'],
  'shadow-match': ['Yhdista varjot!', 'Varjojen yhdistaminen temaattisilla kuvilla', 'Kolme varjotasoa', 'Selkeista subtileihin varjoihin', 'Selkeat varjot', 'Kaannetyt varjot', 'Monimutkaiset pulmapelit', 'Varjojen yhdistaminen terävöittaa katsetta', 'Varjohauskaa!', 'Loyda varjo', 'Ammattimaiset tyolehdet', 'Visuaalinen erottelu kaikille'],
  bingo: ['Kuvabingo!', 'Bingolaudat temaattisilla kuvilla', 'Kolme bingovarianttia', 'Yksinkertaisista edistyneisiin lautoihin', 'Yksinkertainen 3x3', 'Kuvabingo 4x4', 'Taysi 5x5', 'Bingo tekee oppimisesta juhlaa', 'Bingohauskaa!', 'Silmat laudalla', 'Ammattimaiset bingolaudat', 'Ryhmaaktiviteetteja kaikille'],
  'picture-sort': ['Lajittele kuvat!', 'Lajittelutehtavat temaattisilla kuvilla', 'Kolme lajittelutasoa', 'Yksinkertaisista edistyneisiin kategorioihin', '2 kategoriaa', '3 kategoriaa', '4+ kategoriaa', 'Lajittelu kehittaa logiikkaa', 'Lajitteluhauskaa!', 'Jaa ja jarjesta', 'Ammattimaiset tyolehdet', 'Luokittelu kaikille'],
  'missing-pieces': ['Loyda puuttuvat osat!', 'Palapelitehtavat temaattisilla kuvilla', 'Kolme palapelitasoa', 'Yksinkertaisista haastaviin', 'Selkeat puuttuvat osat', 'Hienoiset puuttuvat osat', 'Monimutkaiset visuaaliset palapelit', 'Palapelit teravat tarkkavaisuutta', 'Palapeliaika!', 'Mika puuttuu?', 'Ammattimaiset tyolehdet', 'Visuaalinen logiikka kaikille'],
  'odd-one-out': ['Loyda erilainen!', 'Tehtavat temaattisilla kuvilla', 'Kolme haastetasoa', 'Selkeista subtileihin eroihin', 'Selkea ero (3)', 'Keskivaikea (4)', 'Edistynyt (6+)', 'Havainnointi vahvistaa kriittista ajattelua', 'Kuka erottuu?', 'Loyda ero', 'Ammattimaiset tyolehdet', 'Visuaalinen paattely'],
  sudoku: ['Kuva-Sudoku!', 'Sudoku kuvilla lukujen sijaan', 'Kolme sudokutasoa', 'Aloittelijasta asiantuntijaan', 'Yksinkertainen 4x4', 'Keskivaikea 6x6', 'Vaikea 9x9', 'Sudoku rakentaa loogista paattelya', 'Sudokuhauskaa!', 'Ajattele loogisesti', 'Ammattimaiset tyolehdet', 'Logiikkapulmapelit kaikille'],
  'picture-path': ['Seuraa kuvapolkua!', 'Sokkelotehtavat temaattisilla kuvilla', 'Kolme polkutasoa', 'Yksinkertaisista monimutkaisiin polkuihin', 'Suorat reitit', 'Haarautuvat reitit', 'Monimutkaiset sokkelot', 'Reitinloytaminen rakentaa ongelmanratkaisua', 'Polkuhauskaa!', 'Seuraa jalki', 'Ammattimaiset tyolehdet', 'Navigointihaasteet'],
  'find-and-count': ['Loyda ja laske!', 'Etsi ja laske temaattisissa kohtauksissa', 'Kolme etsintatasoa', 'Vahasta paljoon laskettavaa', 'Laske 5 asti yksinkertaisissa kohtauksissa', 'Laske 10 asti useammilla kohteilla', 'Laske 20 asti vilkkaissa kohtauksissa', 'Etsi ja laske terävöittaa tarkkavaisuutta', 'Laskemishauskaa!', 'Kuinka monta naet?', 'Ammattimaiset tyolehdet', 'Visuaaliset laskemisaktiviteetit'],
  'find-objects': ['Loyda kaikki!', 'Piilotetut esineet yksityiskohtaisissa kohtauksissa', 'Kolme etsintatasoa', 'Yksinkertaisista haastaviin kohtauksiin', 'Selkeat esineet', 'Naamioidut esineet', 'Haastavat piilotetut esineet', 'Tarkka silma kehittaa keskittymista', 'Etsintahauskaa!', 'Loyda esine', 'Ammattimaiset tyolehdet', 'Keskittymishaasteet'],
  crossword: ['Kuvaristikko!', 'Ristikot kuvavihjein', 'Kolme ristikkotasoa', 'Yksinkertaisista edistyneisiin ristikkoihin', 'Miniristikko (5 sanaa)', 'Keskikokoinen ristikko (10 sanaa)', 'Suuri ristikko (15+ sanaa)', 'Ristikot vahvistavat sanavarastoa', 'Ristikkohauskaa!', 'Tayta ruudut', 'Ammattimaiset tyolehdet', 'Sanapulmapelit kaikille'],
  'treasure-hunt': ['Aarteenetsinta!', 'Karttaseikkailut piilotetuilla aarteilla', 'Kolme seikkailutasoa', 'Yksinkertaisista monimutkaisiin karttoihin', 'Yksinkertaiset reittikartat', 'Suuntakartat', 'Monivaiheisia aarteenetsintoja', 'Jokainen aarre vahvistaa ongelmanratkaisua', 'Aarteenetsinta-aika!', 'Loyda aarre', 'Ammattimaiset tyolehdet', 'Jannittavat karttaseikkailut'],
};
...
const toolAltTemplates: Record<string, {
  ...
  no: {
    sample: (name, n) => `${name} — Arbeidsark eksempel ${n}`,
    tier: (name, tierName) => `${name} — ${tierName} arbeidsark`,
    spotlight: (name) => `${name} — Utvalgt arbeidsark`,
    gallery: (label) => `${label} — Profesjonelt arbeidsark`,
    answerKey: (label) => `${label} — Fasit`,
  },
  fi: {
    sample: (name, n) => `${name} — Tyolehti esimerkki ${n}`,
    tier: (name, tierName) => `${name} — ${tierName} tyolehti`,
    spotlight: (name) => `${name} — Esitelty tyolehti`,
    gallery: (label) => `${label} — Ammattimainen tyolehti`,
    answerKey: (label) => `${label} — Vastausavain`,
  },
};
...
export function getToolShowcaseConfig(toolId: string, locale: string = 'en'): ToolShowcaseConfig | null {
  ...
  if (locale === 'da') return localizeToolShowcase(enConfig, toolId, danishImages, daToolText, 'da') ?? enConfig;
  if (locale === 'no') return localizeToolShowcase(enConfig, toolId, norwegianImages, noToolText, 'no') ?? enConfig;
  if (locale === 'fi') return localizeToolShowcase(enConfig, toolId, finnishImages, fiToolText, 'fi') ?? enConfig;
  return enConfig;
}
