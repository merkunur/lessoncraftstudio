...
const content: BlogContent = {
  seo: {
    primaryKeyword: "skolestart printables sælg august",
    secondaryKeywords: [
      "skolestart arbejdsark Etsy salg",
      "august september printbar rush",
      "folkeskole start printables"
    ],
    lsiKeywords: [
      "skolesæson printbar efterspørgsel",
      "august salg spike",
  ...
  internalLinks: [
    ...
    {
      pageType: "app",
      slug: "alfabet-arbejdsark",
      anchorText: "Alfabet-Generator"
    },
    {
      pageType: "app",
      slug: "haandskrift-arbejdsark",
      anchorText: "Håndskrift-Generator"
    }
  ],
  relatedPosts: [
    {
  ...
  cta: {
    heading: "Forbered Din Skolestarts-Produktlinje",
    description: "Opret professionelle arbejdsark for børnehaveklasse til 3. klasse. Prøv gratis med vandmærke — ingen tilmelding.",
