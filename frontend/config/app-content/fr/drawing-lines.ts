...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Traçage de Lignes | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Traçage de Lignes professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche de traçage de lignes entre images',

    },
    sampleGallery: [
      { src: '/samples/english/drawing lines/Drawing Lines 1.jpeg', alt: 'Exercice traçage lignes', caption: 'Tracer des lignes' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Traçage de Lignes thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Traçage de Lignes est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'drawing-lines', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Traçage de Lignes Gratuit' },
