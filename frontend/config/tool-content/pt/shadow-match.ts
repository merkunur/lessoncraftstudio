...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Ative ou desative a caixa «Mostrar Etiquetas» (ativa por predefinição) para exibir os identificadores A, B, C, D nas imagens ou primeiras metades e os identificadores 1, 2, 3, 4 nas siluetas ou segundas metades. Com etiquetas ativas, os alunos escrevem pares letra-número como respostas — apoio estruturado para alunos mais novos. Com etiquetas desativas, a ficha torna-se um desafio de correspondência puramente visual sem apoio alfanumérico — ideal para cadernos de puzzles ou atividades avançadas onde as respostas escritas não são necessárias. Marque «Incluir Campos Nome/Data» para adicionar linhas de nome e data do aluno ao rodapé da ficha para responsabilidade na sala de aula.',
      },
      {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Quando a opção Mostrar Etiquetas está desativa, a ficha torna-se um desafio de correspondência puramente visual sem identificadores A/B/C/D e 1/2/3/4. Isto cria uma página de puzzle mais limpa e de aspeto mais profissional, ideal para cadernos de puzzles impressos e downloads digitais premium. Sem etiquetas, os alunos devem confiar inteiramente na correspondência visual — identificando siluetas apenas pela forma ou reconectando metades divididas por continuidade visual. As fichas sem etiquetas são percebidas como de maior valor em produtos de cadernos de puzzles porque parecem mais polidas e apresentam um verdadeiro desafio.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'O gerador oferece dois modos distintos numa só ferramenta. O modo Associação de Sombras coloca 4 imagens a cores etiquetadas A–D na linha superior e 4 siluetas negras autogeradas etiquetadas 1–4 na linha inferior — os alunos associam cada imagem à sua sombra emparelhando letras com números. As siluetas são criadas mediante processamento a nível de píxel (alfa > 10 → preto puro), não filtros CSS. O modo Complete a Imagem divide 4 imagens em metades — primeiras metades etiquetadas A–D, segundas metades etiquetadas 1–4 — e os alunos reconectam as peças para completar cada imagem. Escolha a direção de corte horizontal (cima/baixo) ou vertical (esquerda/direita) no modo Complete a Imagem.',
    },
    {
