...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit de Fiches de Soustraction | PDF Imprimables',
    metaDescription: 'Créez des fiches de soustraction gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit fiches soustraction',
    secondaryKeywords: ["fiches soustraction gratuites","soustraction avec images PDF","exercices soustraction maternelle","créer fiches soustraction","retrancher exercices imprimables"],
    lsiKeywords: ["soustraction posée","différence","retrancher","mode barrer","calcul soustractif","complément","technique opératoire","problèmes"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/subtraction/Subtraction Fun 1.jpeg',
      primaryAlt: 'Fiche de soustraction gratuite avec mode barrer',
    },
    sampleGallery: [
      { src: '/samples/english/subtraction/Subtraction Fun 2.jpeg', alt: 'Soustraction thème fruits', caption: 'Thème fruits' }
    ],
    youtubeId: '6O5aCzHkh8M',
    videoTitle: 'Comment créer des fiches de soustraction gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit de Fiches de Soustraction',
    tagline: 'Créez des fiches de soustraction et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de soustraction transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de soustraction autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de soustraction en 10 étapes',
    steps: [
  ...
  faq: [
    { question: 'Ce générateur de soustraction est-il vraiment gratuit ?', answer: 'Oui. La version gratuite inclut toutes les fonctionnalités — tous les modes, les 104 thèmes, l\'export PDF et les corrigés. La seule différence est un petit filigrane sur les fichiers exportés. Utilisez la version gratuite indéfiniment sans créer de compte.' },
  ...
  internalLinks: [
    { slug: 'gratuit-soustraction-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit de Fiches de Soustraction' },
    { slug: 'subtraction', pageType: 'app' as const, anchorText: 'Générateur de Fiches de Soustraction — Détails complets' },
  ],
};
