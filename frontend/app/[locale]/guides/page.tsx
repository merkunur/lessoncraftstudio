...
const guidesKeywords: Record<string, string[]> = {
  ...
  es: ['guías crear y vender imprimibles', 'vender fichas educativas en Etsy', 'SEO de Etsy para imprimibles', 'crear cuaderno de actividades KDP', 'negocio de imprimibles guía', 'vender productos digitales Etsy'],
  pt: ['guias criar atividades para imprimir', 'como vender atividades no Etsy', 'como publicar livro atividades KDP', 'guia negócio de imprimíveis', 'criar e vender atividades', 'SEO Etsy atividades educativas'],
  it: ['guide creare schede didattiche', 'come creare crucipuzzle', 'tutorial schede matematica', 'guida generatore esercizi', 'creare e vendere schede', 'guide stampabili didattici'],
...
const guideSubcategories = [
  ...
  },
  {
    ...
    labelKey: 'generatorPlatformGuides',
    guideIds: new Set([
      'word-search-generator-kdp', 'sudoku-generator-kdp', 'crossword-generator-kdp',
      'coloring-page-generator-etsy', 'math-worksheet-generator-tpt', 'word-search-generator-etsy',
      'bingo-card-generator-etsy', 'cryptogram-generator-kdp', 'word-scramble-generator-kdp',
      'activity-book-generator-kdp', 'matching-worksheet-generator-etsy', 'tracing-worksheet-generator-etsy',
      'pattern-worksheet-generator-etsy', 'coloring-book-generator-kdp', 'writing-worksheet-generator-etsy',
      'find-count-generator-etsy', 'shadow-match-generator-etsy', 'maze-generator-etsy',
...
const guidesContent: Record<string, {
  ...
  es: {
    heroTitle: '65 guías: crear y vender imprimibles en Etsy y KDP',
    heroDescription: 'Guías paso a paso sobre SEO de Etsy, formato KDP, estrategias de precios, selección de nicho y más. Todo para su negocio de imprimibles.',
    metaTitle: '65 guías: crear y vender imprimibles en Etsy y KDP',
    metaDescription: 'Guías paso a paso sobre SEO de Etsy, formato KDP, estrategias de precios, selección de nicho y más. Todo para su negocio de imprimibles.',
  ...
  it: {
    ...
    metaTitle: 'Guide per creare schede didattiche | LessonCraftStudio',
    metaDescription: '65 guide passo passo per creare schede di matematica, crucipuzzle, cruciverba e altro. Tutorial per ogni generatore, consigli per vendere su Etsy e KDP.',
  ...
  nl: {
    ...
    metaTitle: 'Gidsen voor printables-verkopers | LessonCraftStudio',
    metaDescription: 'Complete gidsen voor het verkopen van printables op Etsy, Amazon KDP en Bol.com. Platformstrategieën, productcreatie, marketing en bedrijfsgroei.',
  ...
  da: {
    heroTitle: 'Guider til at sælge opgaver til print',
    heroDescription: '65 trin-for-trin-guider til at oprette, liste og sælge opgaver til print på Etsy, Amazon KDP, TPT og mere.',
    metaTitle: '65 guider: Opret og sælg opgaver til print på Etsy & KDP',
    metaDescription: 'Trin-for-trin-guider om Etsy SEO, KDP-formatering, prisstrategier, nichevalg og mere. Alt du behøver for at bygge en printable-forretning.',
