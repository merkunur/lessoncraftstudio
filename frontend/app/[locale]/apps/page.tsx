...
const appsMetadata: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  sv: {
    ...
    description: 'Utforska 33 professionella utskriftsgeneratorer. Ords\ökningar, mattearbetsblad, m\ålarbilder, pussel & mer. Prova gratis med vattenst\ämpel. S\älj p\å Etsy & Amazon KDP.',
    keywords: 'utskriftsgenerator, Etsy utskrifter, KDP arbetsblad, s\älja utskrifter online, ords\ökningsgenerator, arbetsbladsskapare, utskriftsf\öretag',
  },
  da: {
