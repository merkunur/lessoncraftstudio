...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      {
        title: 'Configure la Dificultad del Puzzle con Dos Controles Independientes',
      ...
      {
        title: 'Seleccione una Forma de Pieza entre 6 Opciones',
        description: 'Elija una forma de pieza que defina el carácter visual de cada hueco y opción de solución. Las formas cuadrado (predeterminado) y círculo ofrecen cortes geométricos limpios con bordes inmediatamente reconocibles. Las formas rectángulo vertical (80% ancho, 100% alto) y rectángulo horizontal (100% ancho, 80% alto) crean huecos alargados que revelan proporciones diferentes de la imagen fuente. Las formas elipse vertical y elipse horizontal ofrecen cortes curvos más suaves con las mismas proporciones dimensionales que sus equivalentes rectangulares. Cada forma interactúa de manera diferente con la ilustración fuente, de modo que la misma imagen produce seis experiencias de puzzle distintas con todas las formas disponibles.',
      },
      {
        title: 'Seleccione una Imagen de la Biblioteca o Suba la Tuya',
        description: 'Abra el panel de Biblioteca de Imágenes y navegue 104 colecciones temáticas con más de 3.100 ilustraciones coloridas — animales, comida, vehículos, naturaleza, festividades, profesiones y docenas más. Filtra por tema usando el menú desplegable o busque por palabra clave. Haga clic en una imagen para seleccionarla como fuente de su puzzle. Las imágenes con colores variados y regiones distintas producen las fichas de rompecabezas más atractivas porque el algoritmo inteligente de extracción encuentra piezas con mayor varianza de color. Alternativamente, use el panel de Subir Imágenes Personalizadas para cargar sus propios archivos PNG, JPG o GIF para diseños de puzzles personalizados — fotos familiares, arte propio, contenido de marca o imágenes específicas del mercado.',
      },
      {
        title: 'Configure el Diseño de Página y las Decoraciones',
        description: 'En la sección de Configuración de Página, seleccione su tamaño de página: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Cuadrado (1200×1200) o introduzca una dimensión personalizada. Elija un color de fondo de página. Seleccione un fondo decorativo temático y un borde decorativo temático de la biblioteca integrada, cada uno con un control de opacidad independiente (0–1, paso 0,05). Los fondos y bordes temáticos funcionan de forma independiente, permitiéndote combinar un fondo sutil con un borde decorativo llamativo o cualquier combinación que se ajusta al estilo de su producto.',
      },
      {
        title: 'Genere la Ficha de Rompecabezas',
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Cree paquetes de actividades de rompecabezas organizados por tema y forma de pieza usando las 104 colecciones de imágenes. Un solo tema de animales produce seis estilos distintos de ficha con todas las formas de pieza — cortes cuadrados para puzzles geométricos limpios, cortes circulares para desafíos redondeados, cortes rectangulares verticales y horizontales para huecos alargados, y variantes de elipse para puzzles con bordes curvos más suaves. Empaqueta 15–25 fichas de rompecabezas por paquete con claves de respuestas autogeneradas incluidas. Varía la dificultad ajustando el número de piezas faltantes (1–5) y opciones de solución (2–6) para desafío progresivo dentro de cada paquete. La extracción inteligente se recalcula en cada generación, permitiéndote crear múltiples puzzles únicos de la misma imagen fuente simplemente regenerando.',
    },
    {
      title: 'Cuadernos de Puzzles Visuales para KDP con Dificultad Progresiva',
      description: 'Compila 50–100 fichas de rompecabezas en cuadernos impresos para Amazon KDP. Estructura capítulos por dificultad: el Capítulo 1 use 1 pieza faltante con 2 opciones para identificación simple, el Capítulo 2 use 3 piezas faltantes con 4 opciones para razonamiento espacial intermedio, y el Capítulo 3 use 5 piezas faltantes con 6 opciones incluyendo distractoras para discriminación visual avanzada. Incluya páginas de clave de respuestas al final mostrando etiquetas numéricas resaltadas en amarillo dentro de cada hueco. Active la escala de grises para salida con ahorro de tinta que se imprime perfectamente en blanco y negro. El formato puramente visual no requiere traducción, por lo que un solo interior sirve para todos los mercados internacionales de KDP.',
    },
    {
      title: 'Actividades de Discriminación Visual para venta en línea con Claves de Respuestas',
      description: 'Cree fichas de rompecabezas listas para venta en línea para trabajo matutino, usuarios que terminan antes y centros de enriquecimiento con claves de respuestas impresas para estaciones de autocorrección. Construye sets alineados con el catálogo de productos: puzzles de animales para unidades de ciencias, puzzles de vehículos para temas de transporte, puzzles de alimentos para lecciones de nutrición. El sistema de dificultad en dos ejes le permite crear versiones diferenciadas del mismo puzzle — 1 pieza faltante con 2 opciones para usuarios con dificultades, 5 piezas faltantes con 6 opciones para usuarios avanzados. Cada ficha se exporta con su clave de respuestas autogenerada, eliminando el tiempo de preparación del vendedor y permitiendo estaciones de práctica independiente.',
    },
    {
  ...
  businessIdeas: [
    {
      ...
      description: 'Abra una tienda Etsy especializada en paquetes de fichas de rompecabezas organizados por tema usando las 104 colecciones de imágenes. Animales, vehículos, naturaleza, comida, festividades y profesiones se convierten en listados separados con 15–25 puzzles de piezas faltantes y claves de respuestas incluidas. Las seis formas de pieza le permiten crear productos visuales distintos de los mismos temas — paquetes de piezas cuadradas, paquetes de piezas circulares y paquetes de variedad con formas mixtas. La clave de respuestas autogenerada con etiquetas numéricas resaltadas en amarillo elimina la mayor pérdida de tiempo en producción. Varía la dificultad desde 1 pieza faltante con 2 opciones hasta 5 piezas faltantes con 6 distractoras para desafío progresivo. Precio de paquetes individuales por tema a $3–$5 y paquetes premium de formas mixtas a $8–$12.',
      platform: 'Etsy',
    },
    {
      title: 'Serie de Cuadernos de Puzzles Visuales en Amazon KDP',
      description: 'Compila 50–100 fichas de rompecabezas en cuadernos temáticos para Amazon KDP. Estructura una serie por dificultad: "Puzzles de Piezas Faltantes Fáciles" (1–2 piezas, 2–3 opciones), "Rompecabezas Visuales Intermedios" (3 piezas, 4 opciones) y "Puzzles de Discriminación Visual Avanzados" (4–5 piezas, 5–6 opciones con distractoras). Incluya páginas de clave de respuestas al final con etiquetas numéricas resaltadas en amarillo dentro de cada hueco. Active la escala de grises para salida con ahorro de tinta que mantiene bajos los costos de impresión de KDP. El formato puramente visual se publica idénticamente en todos los mercados internacionales de KDP sin traducción — un solo interior sirve para todos los países.',
      platform: 'Amazon KDP',
    },
    {
      title: 'Paquetes de Actividades de Rompecabezas para Hotmart',
      description: 'Suba paquetes de actividades de rompecabezas a Hotmart con claves de respuestas autogeneradas y dificultad configurable como puntos de venta clave. Los vendedores que buscan actividades de discriminación visual y pensamiento crítico valoran fichas que llegan listas para venta en línea con opciones de dificultad diferenciada. Cree sets alineados con el catálogo de productos: puzzles de hábitats de animales para ciencias, puzzles de ayudantes comunitarios para estudios sociales, puzzles de grupos de alimentos para lecciones de nutrición. Cada paquete incluya fichas para usuarios a múltiples niveles de dificultad (1–5 piezas faltantes, 2–6 opciones) más claves de respuestas para estaciones de autocorrección. Las seis formas de pieza dan variedad a los vendedores dentro de un solo tipo de actividad.',
      platform: 'Hotmart',
    },
    {
      title: 'Embudo de Tráfico con Rompecabezas en Pinterest',
      description: 'Las fichas de rompecabezas crean pines visualmente impactantes en Pinterest — la imagen con huecos recortados y opciones de solución numeradas debajo cree un formato inmediatamente llamativo que padres y vendedores reconocen como educativo. Publique fichas de muestra mostrando diferentes formas de pieza: cortes cuadrados con temas de animales, cortes circulares con temas de festividades, cortes de elipse para variedad. Cree series de pines separadas para "fichas de rompecabezas para niños", "puzzles de piezas faltantes para preescolar" y "actividades de discriminación visual". El formato puramente visual atrae a padres y vendedores en todos los países. Enlaza cada pin a sus listados de productos en Etsy o Hotmart.',
      platform: 'Pinterest',
    },
    {
      title: 'Kit Completo de Rompecabezas en Hotmart',
      description: 'Agrupa fichas de rompecabezas de los 104 temas, las 6 formas de pieza y todos los niveles de dificultad en un kit integral en Hotmart. Incluya más de 400 puzzles abarcando formas cuadrada, circular, rectangular y elíptica a cada combinación de dificultad desde 1 pieza con 2 opciones hasta 5 piezas con 6 opciones. Cada puzzle incluya su clave de respuestas autogenerada, duplicando su conteo de archivos. El sistema de seis formas y dificultad en dos ejes proporciona enorme variedad de cada conjunto temático de imágenes. El formato de kit justifica precios premium porque los compradores obtienen una biblioteca completa de rompecabezas en lugar de paquetes individuales.',
      platform: 'Hotmart',
    },
    {
  ...
  proTips: [
    ...
    {
      title: 'Incluya Claves de Respuestas en Cada Listado para Superar a la Competencia',
      description: 'La clave de respuestas autogenerada con etiquetas numéricas resaltadas en amarillo (rgba(255,255,0,0.7)) dentro de cada hueco es lo que convierte sus fichas de rompecabezas en un producto completo y autocorregible. Incluya siempre claves de respuestas en sus paquetes de productos y muéstralas en las imágenes de vista previa del listado. Los productos que incluyen claves de respuestas superan consistentemente en ventas a los listados de solo puzzles porque vendedores y padres quieren materiales autocorregibles. El sistema de doble lienzo genere ambas versiones simultáneamente, por lo que incluir la clave de respuestas no te cuesta tiempo de producción adicional.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'El generador toma una imagen de la biblioteca o su imagen subida y recorta 1–5 piezas, dejando huecos blancos con contornos de trazo negro (2px) en las ubicaciones originales. Luego muestra 2–6 opciones de solución numeradas — las piezas correctas más piezas distractoras extraídas de otras áreas no superpuestas de la misma imagen. Los usuarios examinan los huecos y las opciones numeradas, luego identifican qué opción rellena cada espacio basándose en color, patrón y detalle visual. La clave de respuestas muestra etiquetas numéricas resaltadas en amarillo dentro de cada hueco indicando la coincidencia correcta.',
    },
    {
      question: '¿Cuáles son las 6 formas de pieza disponibles?',
      answer: 'Puede elegir entre cuadrado (predeterminado), círculo, rectángulo vertical (80% ancho, 100% alto), rectángulo horizontal (100% ancho, 80% alto), elipse vertical y elipse horizontal. Cada forma cree un desafío visual diferente. Cuadrado y círculo ofrecen cortes geométricos limpios, mientras que las variantes de rectángulo y elipse crean formas alargadas o curvas que interactúan de manera diferente con la imagen fuente. Cada forma interactúa de manera única con la misma ilustración, por lo que una imagen fuente produce seis experiencias de puzzle distintas con todas las formas disponibles.',
    },
    {
      question: '¿Cómo funcionan los dos controles independientes de dificultad?',
      answer: 'La dificultad se controla con dos configuraciones independientes. El número de piezas faltantes (1–5) determine cuántos huecos se recortan de la imagen — más piezas significa más demanda de razonamiento espacial. El número de opciones de solución (2–6) determine cuántas opciones numeradas evalúan los usuarios — cuando las opciones exceden las piezas faltantes, las extras son piezas distractoras que requieren comparación visual cuidadosa. Un puzzle con 1 pieza faltante y 2 opciones es fácil; 5 piezas faltantes con 6 opciones incluyendo distractoras es genuinamente desafiante. Ajuste ambos ejes independientemente para crear niveles de dificultad precisos para cualquier grupo de edad.',
    },
    {
      question: '¿Qué son las piezas distractoras y cómo se generan?',
      answer: 'Las piezas distractoras son opciones de solución adicionales que no coinciden con ningún hueco del puzzle. Se extraen de diferentes áreas de la misma imagen fuente usando hasta 200 intentos de colocación cada una, asegurando que no se superpongan con las piezas correctas ni entre sí. Las distractoras evitan que los usuarios resuelvan por eliminación — deben comparar cuidadosamente colores, patrones y detalles visuales para distinguir las opciones correctas de alternativas de apariencia similar. El número de distractoras es igual a la diferencia entre opciones de solución y piezas faltantes.',
    },
    {
    ...
    },
    {
      ...
      answer: 'El generador usa un sistema de doble lienzo con una pestaña de Ficha y una pestaña de Clave de Respuestas. La clave de respuestas muestra la misma imagen del puzzle con huecos y coloque etiquetas numéricas resaltadas en amarillo (rgba(255,255,0,0.7)) dentro de cada hueco mostrando el índice de opción correcto basado en 1. El tamaño de fuente se escala al 60% del tamaño de la pieza para legibilidad clara. Descargue la clave de respuestas por separado usando los botones dedicados de Clave de Respuestas JPEG y Clave de Respuestas PDF. La clave se genera simultáneamente con la ficha — sin creación manual, sin proceso de diseño separado.',
    },
    {
      question: '¿Cómo funciona el sistema de doble borde del encabezado?',
      answer: 'Cada puzzle generado presenta un encabezado estilizado con "Piezas Faltantes" en turquesa (#06B6D4) y una descripción en rosa (#DB2777), enmarcado por dos bordes decorativos. El borde exterior use verde azulado brillante (#14B8A6) con trazo de 8px, márgenes de 34px y radio de borde de 12px. El borde interior use rosa intenso (#EC4899) con trazo de 3px, márgenes de 46,5px, radio de borde de 8px y un ligero desplazamiento de 2px a la derecha y 3px hacia abajo. Juntos crean un marco pulido y profesional que aumenta la calidad visual de las fichas de rompecabezas para listados en tiendas en línea.',
    },
    {
  ...
  internalLinks: [
    ...
    { pageType: 'tool', slug: 'generador-discriminación-visual', anchorText: 'Generador de Asociación de Sombras' },
