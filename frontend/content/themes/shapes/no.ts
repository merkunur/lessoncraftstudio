...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare former-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med formertema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Former-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare former-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'formoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, geometriske former, romlig oppfatning, trekant firkant sirkel, formøvelser førskole, formers læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Former-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare former-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'formoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, geometriske former, romlig oppfatning, trekant firkant sirkel, formøvelser barnehage, formers læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Former-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare former-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'formoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, geometriske former, romlig oppfatning, trekant firkant sirkel, formøvelser 1. klasse, formers læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Former-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare former-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'formoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, geometriske former, romlig oppfatning, trekant firkant sirkel, formøvelser 2. klasse, formers læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Former-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare former-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'formoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, geometriske former, romlig oppfatning, trekant firkant sirkel, formøvelser 3. klasse, formers læring 8-9 år',
