...
const content: StartContent = {
  ...
  actionSteps: [
    ...
    {
      step: 'Mehrsprachige Serien aufbauen',
  ...
  toolsRecommended: [
    {
      ...
      description: 'Die beste mehrsprachige Demonstration — versteckte Wörter ändern sich vollständig basierend auf der Sprachauswahl. Generieren Sie thematische Wortsuche-Rätsel in allen 11 Sprachen mit Vokabeln aus der integrierten Übersetzungsdatenbank.',
    },
    {
      appId: 'crossword-worksheets',
      title: 'Kreuzworträtsel-Generator',
      description: 'Kreuzworträtsel-Antworten und Hinweise passen sich vollständig an jede Sprache an. Gitterlayouts werden neu generiert, um unterschiedliche Wortlängen über Sprachen hinweg aufzunehmen und wirklich lokalisierte Rätsel zu produzieren.',
    },
    {
      appId: 'word-scramble-worksheets',
      title: 'Buchstabensalat-Generator',
      description: 'Verwürfelte Wörter passen sich an das Vokabular jeder Sprache an. Deutsche zusammengesetzte Wörter, französische akzentuierte Wörter und spanisches Vokabular werden alle korrekt innerhalb sprachspezifischer Regeln verwürfelt.',
    },
    {
      appId: 'alphabet-train-worksheets',
      title: 'Buchstabenzug-Generator',
      description: 'Zeichensätze und alphabetische Reihenfolge passen sich für jede Sprache an. Sprachen mit zusätzlichen Zeichen (deutsches ß, schwedisches åäö, dänisches æøå) produzieren unterschiedliche Zug-Zusammensetzungen.',
    },
    {
    ...
    },
    {
      ...
      title: 'Zählen-und-Finden-Generator',
      description: 'Bildbeschriftungen werden in allen 11 Sprachen lokalisiert. Zähl-Arbeitsblätter mit deutschen Objektnamen, französischen Beschriftungen oder spanischem Vokabular schaffen wirklich differenzierte internationale Produkte.',
    },
  ],

  faq: [
    {
      question: 'Kann ich die mehrsprachige Arbeitsblatt-Ausgabe testen, bevor ich eine Lizenz kaufe?',
      answer: 'Ja. Jeder Generator bietet eine kostenlose Testversion mit Wasserzeichen. Wechseln Sie die Sprachauswahl zu einer der 11 unterstützten Sprachen und generieren Sie Muster-Arbeitsblätter, um die Übersetzungsqualität und das Ausgabeformat zu bewerten. Die kostenlose Testversion mit Wasserzeichen ermöglicht es Ihnen, mehrsprachige Funktionen vollständig zu testen, bevor Sie sich entscheiden.',
    },
    {
      question: 'Muss ich Deutsch oder Französisch sprechen, um Arbeitsblätter in diesen Sprachen zu verkaufen?',
      answer: 'Nein. Sprachsensitive Generatoren übernehmen die gesamte Vokabelübersetzung intern mithilfe einer verifizierten Datenbank. Sie müssen die Zielsprache nicht sprechen, um genaue mehrsprachige Arbeitsblatt-Inhalte zu erstellen. Sie benötigen grundlegende Übersetzungshilfe für Angebots-Titel und -Beschreibungen auf Etsy oder Amazon, aber der Arbeitsblatt-Inhalt selbst erfordert keine Sprachkenntnisse von Ihnen.',
    },
    {
      question: 'Sind die Übersetzungen genau genug für Bildungsinhalte?',
      answer: 'Die Übersetzungsdatenbank enthält über 3.000 professionell verifizierte Vokabeleinträge in allen 11 Sprachen. Jede Übersetzung wurde auf Genauigkeit überprüft, einschließlich korrekter diakritischer Zeichen (deutsche Umlaute, französische Akzente, portugiesische Tilden, schwedische Zeichen). Dieser datenbankgestützte Ansatz liefert zuverlässigere Ergebnisse als maschinelle Übersetzung für Bildungsvokabular.',
    },
    {
      question: 'Was ist der Unterschied zwischen sprachsensitiven und rein visuellen Generatoren?',
      answer: 'Sprachsensitive Generatoren (13 Apps, darunter Wortsuche, Kreuzworträtsel und Buchstabensalat) produzieren Arbeitsblatt-Inhalte, die sich basierend auf der ausgewählten Sprache ändern — verschiedene Wörter, Hinweise und Vokabeln erscheinen auf der Seite. Rein visuelle Generatoren (20 Apps, darunter Ausmalen, Mathe und Sudoku) produzieren Inhalte, die sprachunabhängig sind — die Ausgabe sieht unabhängig von der Sprachauswahl identisch aus.',
    },
    {
      question: 'Kann ich dieselben rein visuellen Arbeitsblätter auf mehreren Sprachmärkten verkaufen?',
      answer: 'Ja. Ausmalseiten, Mathe-Arbeitsblätter, Sudoku-Rätsel und andere rein visuelle Inhalte verwenden Zahlen, Bilder und Formen, die universell sind. Sie können dieselbe PDF-Datei auf Etsy.de, Etsy.fr, Amazon.de und Amazon.fr mit lokalisiertem Angebotstext listen. Keine neue Inhaltsgenerierung erforderlich — nur übersetzte Titel und Beschreibungen.',
    },
    {
      question: 'Mit welcher nicht-englischen Sprache sollte ich beginnen?',
      answer: 'Deutsch ist die empfohlene erste Expansionssprache für die meisten Verkäufer. Amazon.de ist der zweitgrößte Amazon-Marktplatz weltweit, Etsy.de hat eine aktive Käuferbasis für Bildungs-Druckvorlagen, und die Konkurrenz bei deutschsprachigen Bildungs-Arbeitsblättern ist dramatisch geringer als auf Englisch. Französisch ist die empfohlene zweite Sprache.',
    },
    {
      question: 'Brauche ich separate kommerzielle Lizenzen für jede Sprache?',
      answer: 'Nein. Eine kommerzielle Lizenz deckt alle von diesem Generator unterstützten Sprachen ab. Sie kaufen eine Lizenz pro Generator und können kommerzielle Inhalte in allen 11 unterstützten Sprachen erstellen. Es gibt keine Pro-Sprache-Lizenzanforderung.',
    },
    {
      question: 'Wie ist die Rückgaberegelung für kommerzielle Lizenzen?',
      answer: 'Jeder Generator bietet eine kostenlose Testversion mit Wasserzeichen, sodass Sie alle Funktionen testen, Muster-Arbeitsblätter erstellen und die Ausgabequalität bewerten können, bevor Sie kaufen. Da Sie das Produkt vor dem Kauf vollständig evaluieren können, sind alle kommerziellen Lizenzverkäufe endgültig. Dies ist Standardpraxis für digitale Produkttools, bei denen das vollständige Produkt vor dem Kauf getestet werden kann.',
    },
  ],
