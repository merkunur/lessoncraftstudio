...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Abbina schede abbinamento ombre con puzzle a griglia, schede di abbinamento, attività pezzi mancanti e fogli di negozificazione immagini usando temi coordinati attraverso più generatori. Abbinamento Ombre sviluppa il riconoscimento delle silhouette e la discriminazione visiva. Completa l\'Immagine sviluppa il ragionamento spaziale e la percezione parte-intero. Grid Match sfida il posizionamento spaziale delle tessere. Le schede di abbinamento esercitano le abilità di abbinamento traccia-una-linea. Ogni formato mira a un\'abilità cognitiva diversa mantenendo coerenza tematica. I pacchetti multi-formato richiedono prezzi premium e offrono agli utenti pratica variata di percezione visiva attraverso un tema unificato.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Il generatore offre due modalità distinte in un unico strumento. La modalità Abbinamento Ombre posiziona 4 immagini colorate etichettate A–D nella riga superiore e 4 silhouette nere generate automaticamente etichettate 1–4 nella riga inferiore — gli utenti abbinano ogni immagine alla sua ombra accoppiando lettere con numeri. Le silhouette vengono create attraverso elaborazione pixel-level (alpha > 10 → nero puro), non filtri CSS. La modalità Completa l\'Immagine divide 4 immagini in metà — prime metà etichettate A–D, seconde metà etichettate 1–4 — e gli utenti ricollegano i pezzi per completare ogni immagine. Scegli il taglio orizzontale (sopra/sotto) o verticale (sinistra/destra) nella modalità Completa l\'Immagine.',
    },
    {
  ...
  visuals: {
    heroImages: {
      primary: '/samples/italian/shadow%20match/abbina-le-ombre-1.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/italian/shadow%20match/abbina-le-ombre-2.webp',
      ...
      {
        src: '/samples/italian/shadow%20match/abbina-le-ombre-3-answer-key.webp',
      ...
      {
        src: '/samples/italian/shadow%20match/abbina-le-ombre-4.webp',
