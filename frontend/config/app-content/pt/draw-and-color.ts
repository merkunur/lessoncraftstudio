...
const content: AppContent = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          `Defina as linhas (3 a 10) e as colunas (3 a 10) da grelha de forma independente para controlar o número de células e a proporção de aspeto. Uma grelha 3×3 com 9 células grandes é fácil para principiantes; uma grelha 10×10 com 100 células pequenas desafia os usuários avançados. Depois defina a percentagem de pistas de 10 % a 75 %. A 75 %, a maior parte da imagem de referência é visível e os usuários completam o quarto restante. A 10 %, os usuários só veem pistas dispersas e devem reconstruir quase toda a imagem — um autêntico desafio mesmo para adultos. Este único deslizador cria uma curva de dificuldade progressiva para toda a sua gama de produtos.`,
      },
      {
  ...
  faq: [
    ...
    {
      question: `Posso adicionar campos de nome e data do usuário à ficha?`,
      answer:
        `Sim. Ative a opção Incluir Campos de Nome/Data para adicionar zonas de identificação do usuário à sua ficha. Também pode usar o painel Ferramentas de Texto para adicionar um título personalizado, instruções ou qualquer outro texto com fontes como Lexend Deca, Baloo 2, Nunito, Quicksand, Fredoka, Arial e Verdana. Todos os elementos de texto são completamente editáveis no canvas — arraste, redimensione, rode e reposicione conforme necessário.`,
    },
    {
