...
const content: ToolContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Activa la opción Código de Colores para mostrar las vocales en un color y las consonantes en otro en las fichas de letras. Esta ayuda visual fonética permite a los usuarios distinguir patrones de vocales y consonantes mientras descifran. Selecciona Todo Negro para fichas monocromáticas tradicionales. El código de colores es exclusivo de Letras Revueltas y añade una fuerte dimensión de diferenciación para vendedores que apuntan a compradores enfocados en fonética.',
    },
    {
