...
const content: AppContent = {
  seo: {
    primaryKeyword: 'gerador de fichas de objetos ocultos',
    secondaryKeywords: [
  ...
  keyFeatures: {
    title: 'Características Principais do Gerador de Fichas de Objetos Ocultos',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'O canvas Fabric.js proporciona controlo total sobre cada elemento da sua ficha de objetos ocultos. Arraste, redimensione, rode e reposicione imagens, texto e conteúdo gerado livremente. Os controlos de camada gerem a ordem de empilhamento. Adicione texto personalizado com seis opções de fonte (Fredoka, Lexend Deca, Baloo 2, Nunito, Quicksand, Arial), tamanho e cor ajustáveis, e largura de contorno de texto de 0 a 10 com granularidade de 0,5. Os temas de fundo e de moldura têm controlos de opacidade independentes. Zoom de 25% a 300% usando controlos de botão (Aproximar +25%, Afastar −25%, Repor 100%). Desfazer e refazer até 20 estados do histórico com Ctrl+Z e Ctrl+Y.',
      },
    ],
  },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Em vez de colocar imagens numa grelha fixa, o modo Eu Vejo usa um algoritmo findBestPosition() que testa 50 posições aleatórias para cada imagem e seleciona a localização com menor sobreposição. Quando o espaço é limitado, o algoritmo reduz adaptativamente o tamanho da imagem para encaixar mais objetos sem saturar a cena. Isto cria cenas de objetos ocultos de aspeto natural onde as imagens se dispersam organicamente pela página, tornando a experiência de busca mais envolvente do que os layouts previsíveis baseados em grelha.',
    },
    {
  ...
  internalLinks: [
    ...
    },
    {
      pageType: 'app',
      slug: 'ligar-fichas',
      anchorText: 'Gerador de Fichas de Ligar',
    },
    {
      pageType: 'app',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Ficha de objetos ocultos Eu Vejo com imagens dispersas usando algoritmo sem sobreposição, legenda inferior mostrando objetos a encontrar e cabeçalho decorativo',
    },
    sampleGallery: [
      {
      ...
      },
      {
        ...
        alt: 'Ficha Encontra o Diferente com imagens emparelhadas em linhas e elementos sem par a identificar',
      ...
      },
      {
        ...
        alt: 'Gabarito de ficha de objetos ocultos com círculos vermelhos desenhados à volta dos objetos-alvo',
        caption: 'Gabarito autogerado — círculos vermelhos marcam objetos ocultos e sem par',
      },
    ],
    youtubeId: '8Y3jrVr1Phs',
    videoTitle: 'Como Criar Fichas de Objetos Ocultos com Modos Eu Vejo e Encontra o Diferente — Tutorial Passo a Passo',
  },
};
