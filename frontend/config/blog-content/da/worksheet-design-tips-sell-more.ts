...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'arbejdsark design tips sælg mere',
    ...
    titleTag: 'Arbejdsark Design-Tips: Sælg Mere | LessonCraftStudio',
  ...
  hero: {
    ...
    tagline: 'Professionelt design øger konverteringen',
    description: 'Designkvaliteten af dine arbejdsark afgør om kunder køber eller scroller videre. Professionelt design signalerer kvalitet og retfærdiggør højere priser. Denne guide giver dig konkrete designtips der øger konverteringen.',
  },
  category: 'how-to',
  ...
  cta: {
    heading: 'Kom I Gang Med Arbejdsark Design-Tips',
