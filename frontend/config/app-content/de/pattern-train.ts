...
const content: AppContent = {
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      {
        title: "Differenzierte Mathe- und visuelle Lernstationen für Gumroad",
        description:
          "Erstellen Sie gestufte Mustererkennungs-Übungssets mit Musterkomplexität als Differenzierungsachse: Stufe 1 (AB-Muster, 8–10 Hinweise) für grundlegende Abwechslung, Stufe 2 (AAB/ABB-Muster, 6–8 Hinweise) für asymmetrische Gruppierung, Stufe 3 (ABC-Muster, 5–6 Hinweise) für Drei-Element-Rotation und Stufe 4 (AABB-Muster, 4–5 Hinweise) für komplexe erweiterte Zyklen. Jede Stufe trainiert eine andere kognitive Fähigkeit — von der Erkennung einfacher Abwechslung bis zur Identifikation komplexer mehrelementiger Sequenzen aus begrenzten Informationen. Das Zugwaggon-Format erzeugt ein ansprechendes visuelles Thema, das als Shop-Lernstation funktioniert. Verpacken Sie jede Stufe mit thematischen Übungen und separaten Lösungsschlüsseln für den Komfort der Verkäufer. Käufer auf Gumroad zahlen Premiumpreise für gestufte Ressourcen, die sofort über mehrere Fähigkeitsgruppen einsetzbar sind.",
        platform: 'Gumroad',
      },
      {
