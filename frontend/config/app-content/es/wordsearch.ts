...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          'Abra el panel de Configuración de Página y elija un tamaño: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal o cualquier dimensión personalizada. Seleccione un color de fondo, elija un tema de fondo decorativo de la biblioteca de imágenes y ajuste la opacidad para mantener la cuadrícula legible. Añada un marco de borde a juego con control de opacidad independiente. Estas opciones de diseño le dan a sus fichas de sopa de letras un aspecto profesional y pulido antes de añadir una sola palabra.',
      },
      {
        title: 'Elija la fuente de contenido',
        description:
          'Abra el panel de Contenido y seleccione una de las tres fuentes. El modo Biblioteca de Imágenes le permite explorar 104 temas y seleccionar imágenes — el nombre de cada imagen se convierte en una palabra oculta en la cuadrícula. Use el Botón de Tema Aleatorio para seleccionar automáticamente un tema sorpresa y generar variedad rápidamente. El Modo Edición Manual le permite seleccionar imágenes de la biblioteca y luego editar sus nombres de visualización antes de generar, perfecto para vocabulario simplificado o palabras enfocadas en fonética. El modo Lista de Palabras Personalizada prescinde de las imágenes y te deja escribir hasta 8 palabras directamente, ideal para listas de vocabulario semanales, términos específicos de una asignatura o práctica de idiomas extranjeros.',
      },
      {
        title: 'Configure el tamaño de cuadrícula y las direcciones de las palabras',
        description:
          'Establezca las dimensiones de la cuadrícula ajustando filas y columnas de forma independiente de 5 a 30 (por defecto 12×12). Las cuadrículas pequeñas como 5×5 o 6×6 funcionan bien para principiantes; las cuadrículas grandes como 20×20 o 30×30 crean desafíos serios. Luego active o desactive las palabras en diagonal y las palabras invertidas (al revés). Con ambas activadas, las palabras pueden colocarse en ocho direcciones — horizontal, vertical, diagonal y sus inversiones. Desactivar las diagonales limita la colocación solo a horizontal y vertical, creando puzzles más fáciles para usuarios más jóvenes o menos experimentados.',
      },
      {
        title: 'Elija el modo de visualización y añada toques personalizados',
        description:
          'Elija entre tres modos de visualización de palabras/imágenes: Mostrar Palabras e Imágenes (por defecto), Mostrar Solo Imágenes o Mostrar Solo Palabras. Cada modo controla qué aparece junto a la cuadrícula como pistas. Use el panel de Herramientas de Texto para añadir un título de ficha, campos de nombre y fecha, instrucciones o cualquier texto personalizado. Elija entre siete fuentes, incluyendo Lexend Deca, Baloo 2, Fredoka y Quicksand. Ajuste el tamaño de fuente, el color y el contorno para máxima legibilidad. Use el lienzo Fabric.js para arrastrar, redimensionar y reposicionar cada elemento.',
      },
      {
        title: 'Genere la clave de respuesta con código de colores y descargue',
        description:
          'Vaya a la pestaña de Clave de Respuesta y haga clic en Generar Clave de Respuesta para crear una versión resuelta donde cada palabra oculta se resalta en uno de seis colores alternados — rosa, azul, verde, dorado, coral y lavanda — haciendo cada palabra visualmente distinta. Active la exportación en escala de grises para versiones económicas en tinta. Luego abra el menú de Descargue y exporte tanto la ficha como su clave de respuesta en JPEG de alta resolución o PDF listo para imprimir. Cada exportación se renderiza a más de 400 DPI para una nitidez perfecta, ya sea para impresión doméstica, subida a Etsy o un libro de sopa de letras de Amazon KDP.',
      },
    ],
  },
    ...
    features: [
      {
        ...
        description:
          'Cada puzzle incrusta palabras ocultas dentro de una cuadrícula de letras de relleno aleatorias. Los usuarios escanean filas, columnas y diagonales para encontrar cada palabra — el formato clásico de sopa de letras que estimula simultáneamente el escaneo visual, el reconocimiento de patrones y el recuerdo de vocabulario. En modo Biblioteca de Imágenes o Edición Manual, las imágenes aparecen junto a la cuadrícula como pistas visuales, conectando el reconocimiento de imágenes con la identificación de palabras. El modo Lista de Palabras Personalizada cree sopas de letras puramente textuales sin imágenes, ampliando el formato a cualquier tema o conjunto de vocabulario.',
      },
      {
        title: 'Tamaño de cuadrícula personalizable de 5×5 a 30×30',
        description:
          'Ajuste filas y columnas de forma independiente de 5 a 30, creando cuadrículas tan compactas como 5×5 (25 casillas) o tan expansivas como 30×30 (900 casillas). Las cuadrículas pequeñas crean puzzles rápidos y accesibles, ideales para usuarios más jóvenes o actividades de calentamiento. Las cuadrículas grandes crean búsquedas densas y desafiantes que mantienen ocupados a los resolvedores experimentados durante más tiempo. La cuadrícula por defecto de 12×12 equilibra la dificultad y el espacio de página para la mayoría de audiencias. Esta gama le permite crear paquetes con dificultad progresiva — desde cuadrículas pequeñas de iniciación hasta desafíos masivos de nivel experto — todo con la misma herramienta.',
      },
      {
        title: 'Controles de dirección de palabras: activadores de diagonal e invertida',
        description:
          'Dos activadores independientes controlan dónde pueden colocarse las palabras en la cuadrícula. Active las palabras en diagonal para permitir la colocación a lo largo de ambos ejes diagonales además del horizontal y vertical. Active las palabras invertidas para permitir la colocación al revés en cada dirección habilitada. Con ambas activadas, las palabras pueden aparecer en ocho direcciones posibles; con ambas desactivadas, solo se usan los placements horizontal de izquierda a derecha y vertical de arriba abajo. Estos controles crean una gama de dificultad masiva, desde cuadrículas simples de dos direcciones hasta puzzles complejos de ocho direcciones, dándote un control preciso sobre el nivel de desafío.',
      },
      {
        title: 'Tres fuentes de contenido: Biblioteca de Imágenes, Edición Manual y Lista de Palabras Personalizada',
        description:
          'La fuente Biblioteca de Imágenes obtiene las palabras de colecciones de imágenes temáticas — seleccione animales, vehículos o comida y la palabra oculta es el nombre de la imagen. El Modo Edición Manual añada una capa de personalización: seleccione imágenes de la biblioteca y luego edita sus nombres de visualización antes de generar, perfecto para ortografías simplificadas o vocabulario alternativo. El modo Lista de Palabras Personalizada prescinde de las imágenes y te deja escribir hasta 8 palabras directamente, permitiendo fichas de sopa de letras para cualquier asignatura, dictado o lista de vocabulario sin ilustraciones correspondientes.',
      },
      {
        title: 'Relleno alfabético adaptado al idioma con caracteres específicos',
        description:
          'Las letras de relleno de la cuadrícula se adaptan automáticamente al alfabeto y la frecuencia de caracteres del idioma seleccionado. Las cuadrículas en alemán incluyen ä, ö, ü y ß con frecuencias ponderadas que reflejan el texto alemán natural. Las cuadrículas en francés incluyen à, â, é, è, ê, ë, î, ï, ô, ù, û y ç. Las cuadrículas en español incluyen ñ, á, é, í, ó y ú. Cada idioma soportado obtiene letras de relleno auténticas, haciendo los puzzles lingüísticamente naturales en lugar de obviamente generados en inglés. Esta funcionalidad es única de Sopa de Letras — afecta no solo las palabras ocultas sino todo el fondo de la cuadrícula.',
      },
      {
        title: 'Clave de respuesta con código de colores y 6 colores de resaltado',
        description:
          'La clave de respuesta resalta cada palabra encontrada en uno de seis colores alternados: rosa, azul, verde, dorado, coral y lavanda. Cada palabra recibe un color distinto para identificación visual instantánea, facilitando la auto-verificación por los usuarios o la corrección rápida por los vendedores. El formato con código de colores es visualmente atractivo y profesional — un claro paso adelante frente a las simples claves de \"rodea la palabra\". Active la exportación en escala de grises cuando necesites versiones económicas en tinta para impresión en blanco y negro.',
      },
      {
        title: 'Exportación PDF y JPEG lista para imprimir a más de 400 DPI',
        description:
          'Descargue fichas y claves de respuesta como imágenes JPEG de alta resolución o documentos PDF listos para imprimir. El motor de exportación use un multiplicador 6x, produciendo más de 400 DPI en tamaños de página estándar. Los formatos Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal y dimensiones personalizadas están todos soportados. Active la exportación en escala de grises para versiones económicas en tinta ideales para impresión en volumen o libros de puzzles en blanco y negro. Cada exportación está lista para producción: listados de Etsy, interiores de Amazon KDP y archivos de productos Hotmart.',
      },
      {
        title: 'Edición completa del lienzo con herramientas de texto e imagen',
        description:
          'El lienzo Fabric.js integrado le permite arrastrar, redimensionar, rotar y reposicionar cada elemento de la página — texto, cuadrículas de puzzle, imágenes, bordes y fondos. Añada texto personalizado con siete fuentes, inserta elementos decorativos y use los controles de capas para un apilamiento preciso. Las herramientas de alineación posicionan los elementos al píxel, y el bloqueo/desbloqueo protege los elementos terminados mientras editas otros. Deshacer y rehacer ilimitados le permiten experimentar libremente, ofreciendo la flexibilidad de una herramienta de diseño gráfico dentro de un generador de sopa de letras.',
      },
    ],
  },
    ...
    cases: [
      {
        ...
        description:
          'Cree conjuntos de 10 a 20 fichas de sopa de letras agrupadas por tema y dificultad — animales de granja en una cuadrícula pequeña 8×8 sin diagonales, criaturas marinas en una cuadrícula 15×15 con diagonales activadas, dinosaurios en una cuadrícula 20×20 con palabras invertidas — y ofrécelos como descargue instantánea en Etsy. Incluya las claves de respuesta con código de colores como archivos extra. El formato de cuadrícula visual con pistas de imagen se destaca frente a las simples listas de palabras en los resultados de búsqueda de Etsy. Fija el precio de paquetes temáticos individuales entre $3–$5 y de mega-paquetes multi-tema con dificultad progresiva entre $12–$18.',
        platform: 'Etsy (etsy.com)',
      },
      {
        title: 'Libros de sopa de letras en Amazon KDP',
        description:
          'Compila de 50 a 100 puzzles de sopa de letras en un libro impreso en formato Amazon KDP. Use tamaños de cuadrícula progresivos como curva de dificultad: comience con cuadrículas 6×6 solo horizontal, avanza a través de cuadrículas 12×12 con diagonales y termina con cuadrículas 25×25 con palabras invertidas activadas. Agrupa los capítulos por tema (animales, comida, vehículos, naturaleza) para una variedad navegable. Añada una portada, una guía de dificultad y una sección de claves de respuesta con código de colores al final. Los libros de sopa de letras se venden de forma constante todo el año con mínima publicidad.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Puede configurar filas y columnas de forma independiente de 5 a 30. El valor por defecto es 12×12. Una cuadrícula 5×5 cree un puzzle rápido y fácil con solo 25 casillas; una cuadrícula 30×30 cree una búsqueda densa y desafiante con 900 casillas. Ajustar el tamaño de cuadrícula es la forma principal de controlar la dificultad, junto con los ajustes de dirección de las palabras.',
    },
    {
      question: '¿Qué hacen los activadores de dirección diagonal e invertida?',
      answer:
        'El activador de diagonal permite que las palabras se coloquen a lo largo de ambos ejes diagonales además del horizontal y vertical. El activador de invertida permite que las palabras se coloquen al revés en cada dirección habilitada. Con ambas activadas, las palabras pueden aparecer en ocho direcciones posibles. Con ambas desactivadas, las palabras solo aparecen de izquierda a derecha horizontalmente y de arriba abajo verticalmente. Estos activadores le permiten afinar la dificultad desde cuadrículas simples de dos direcciones hasta puzzles complejos de ocho direcciones.',
    },
    {
      question: '¿Cuáles son las tres fuentes de contenido?',
      answer:
        'El modo Biblioteca de Imágenes use ilustraciones temáticas donde el nombre de la imagen se convierte en una palabra oculta en la cuadrícula. El Modo Edición Manual le permite seleccionar imágenes y luego personalizar sus nombres de visualización antes de generar — perfecto para vocabulario alternativo u ortografías simplificadas. El modo Lista de Palabras Personalizada prescinde de las imágenes y te deja escribir hasta 8 palabras directamente, permitiendo fichas de sopa de letras para cualquier asignatura sin ilustraciones correspondientes.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Cuando seleccione un idioma, las letras de relleno de la cuadrícula cambian automáticamente para corresponderse con el alfabeto de ese idioma con distribuciones de frecuencia ponderadas. Las cuadrículas en alemán incluyen ä, ö, ü y ß. Las cuadrículas en francés incluyen é, è, ç, à y otros caracteres acentuados. Las cuadrículas en español incluyen ñ, á, é, í, ó y ú. Esto hace los puzzles lingüísticamente auténticos — las letras de relleno parecen naturales en lugar de obviamente generadas en inglés.',
    },
    {
      question: '¿Cómo funciona la clave de respuesta con código de colores?',
      answer:
        'La clave de respuesta resalta cada palabra encontrada en uno de seis colores alternados: rosa, azul, verde, dorado, coral y lavanda. Cada palabra recibe un color distinto para ser visualmente distinguible incluso cuando las palabras se cruzan o se superponen en la cuadrícula. Puede activar la exportación en escala de grises para versiones de clave de respuesta económicas en tinta. La clave de respuesta se genera como un archivo descargable separado.',
    },
    {
      question: '¿Cuál es el número máximo de palabras por puzzle?',
      answer:
        'Puede colocar hasta 8 palabras o imágenes en una sola cuadrícula de sopa de letras. Este límite garantiza que las palabras encajen limpiamente en la cuadrícula sin superposición excesiva. Para listas de palabras más largas, cree varias fichas y agrúpalas como conjunto — esto también aumenta el valor percibido de sus paquetes de productos.',
    },
    {
      question: '¿El generador de Sopa de Letras es sensible al idioma?',
      answer:
        'Sí. Como las palabras ocultas son los nombres de las imágenes en el idioma seleccionado, cambiar el idioma cambie por completo el contenido del puzzle. Además, las letras de relleno de la cuadrícula cambian para corresponderse con el conjunto de caracteres del idioma objetivo con frecuencias ponderadas apropiadas. La Licencia Comercial es solo en inglés; el Acceso Completo desbloquea los 11 idiomas, haciendo de cada versión lingüística un producto distinto con palabras diferentes y letras de relleno diferentes.',
    },
    {
  ...
  visuals: {
    ...
    videoTitle: 'Cómo Crear Fichas de Sopa de Letras con Palabras Ocultas en Cuadrícula — Tutorial Paso a Paso',
  },
};
