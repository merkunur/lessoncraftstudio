...
export const TOOL_MINI_URL: Record<ToolKey, string> = {
  ...
  'folding-wall': '/mini-tools/folding-wall.html',
  'counting-cups': '/mini-tools/counting-cups.html',
  'number-hotel': '/mini-tools/number-hotel.html',
  'number-drum': '/mini-tools/number-drum.html',
  'landing-strip': '/mini-tools/landing-strip.html',
  'rounding-hill': '/mini-tools/rounding-hill.html',
  ...
  'shape-stretcher': '/mini-tools/shape-stretcher.html',
  'the-queue': '/mini-tools/the-queue.html',
};
...
export const TOOL_ACTIVITY_PREFIX: Record<ToolKey, string> = {
  ...
  'folding-wall': 'folding-wall',
  'counting-cups': 'counting-cups',
  'number-hotel': 'number-hotel',
  'number-drum': 'number-drum',
  'landing-strip': 'landing-strip',
  'rounding-hill': 'rounding-hill',
  'pair-gate': 'pair-gate',
  'doubling-mirror': 'doubling-mirror',
  'missing-question': 'missing-question',
  'the-gap': 'the-gap',
  'shape-stretcher': 'shape-stretcher',
  'the-queue': 'the-queue',
};
...
interface ToolContentFile {
  ...
  'folding-wall'?: ToolEntry;
  'counting-cups'?: ToolEntry;
  'number-hotel'?: ToolEntry;
  'number-drum'?: ToolEntry;
  'landing-strip'?: ToolEntry;
  'rounding-hill'?: ToolEntry;
  'pair-gate'?: ToolEntry;
  'doubling-mirror'?: ToolEntry;
  'missing-question'?: ToolEntry;
  'the-gap'?: ToolEntry;
  'shape-stretcher'?: ToolEntry;
  'the-queue'?: ToolEntry;
