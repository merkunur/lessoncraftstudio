...
export const prepositionsFrContent: ProductPageContent = {
  ...
  seo: {
    ...
    description: 'Créez des fiches d\'exercices sur les prépositions spatiales en quelques clics. Votre abonnement Full Access à 240 € par an vous permet de générer des exercices illimités. Téléchargez des PDF haute qualité en moins de 3 minutes.',
