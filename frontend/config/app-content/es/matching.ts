...
const content: AppContent = {
  seo: {
    primaryKeyword: 'crear y vender fichas de asociación imprimibles',
    secondaryKeywords: [
    ...
    features: [
      {
        ...
        description:
          'Un solo generador cubre cuatro actividades de asociación distintas. El modo Letra Inicial coloca las imágenes a la izquierda y su primera letra a la derecha — con tres submodos: temas aleatorios, imágenes aleatorias del tema elegido o selección manual de imágenes. El modo Imagen+Palabra muestra pares de imágenes etiquetadas en ambos lados para refuerzo de vocabulario. El modo Imagen/Palabra Mixto usa selectores desplegables por fila, donde cada lado puede mostrar independientemente una imagen o una palabra, creando dificultad variada dentro de una misma ficha. El modo Palabra Personalizada asocia las imágenes con tus propias palabras escritas para práctica de ortografía, cuestionarios de vocabulario o ejercicios de idiomas extranjeros. Cada modo genera un desafío cognitivo diferente a partir de la misma biblioteca de imágenes.',
      },
      {
        title: 'Clave de Respuesta Generada Automáticamente con Líneas de Conexión entre los Pares Asociados',
        description:
          'Cada ficha de asociación genera automáticamente una clave de respuesta complementaria en una pestaña de lienzo separada. La clave de respuesta reproduce exactamente el diseño de la ficha y añade líneas de conexión horizontales (color #555, grosor de trazo 2) trazadas entre cada correspondencia correcta. Sin trazado manual de líneas, sin creación de archivos separados — la clave de respuesta siempre está sincronizada con la ficha. Este enfoque de doble lienzo ahorra un tiempo de producción considerable a los vendedores que crean packs de actividades de asociación donde cada ficha necesita su propia clave de respuesta. Descarga la clave de respuesta como answer_key.jpeg o answer_key.pdf junto a la ficha de trabajo.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Explora 104 colecciones de imágenes temáticas que cubren animales, comida, vehículos, naturaleza, profesiones, festividades, deportes, estaciones y muchas más. Cada tema proporciona un conjunto coordinado de ilustraciones coloridas que funcionan perfectamente en actividades de asociación. Filtra por tema usando el menú desplegable o busca imágenes específicas por palabra clave. Haz clic en cualquier imagen para añadirla a tu ficha. La Licencia Comercial incluye 10 temas coloridos para empezar; el Acceso Completo desbloquea los 104 temas para máxima variedad creativa en todos los modos de asociación.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Descarga fichas de asociación y claves de respuesta como imágenes JPEG de alta resolución o documentos PDF listos para imprimir renderizados a 300 DPI. Cuatro botones de descarga dedicados exportan worksheet.jpeg, worksheet.pdf, answer_key.jpeg y answer_key.pdf por separado. Los tamaños de página incluyen Carta Vertical (612×792), Carta Horizontal (792×612), A4 Vertical (595×842), A4 Horizontal (842×595), Cuadrado (1200×1200) y dimensiones completamente personalizadas. Activa el modo escala de grises para versiones que ahorran tinta y preservan el tóner. Cada exportación está lista para la producción: descargas digitales, cuadernos impresos y materiales de clase.',
      },
      {
        title: 'Edición Completa del Lienzo con Herramientas de Texto, Alineación y Controles de Capas',
        description:
          'El lienzo Fabric.js proporciona control total sobre cada elemento de tu ficha de asociación. Arrastra, redimensiona, rota y reposiciona imágenes, texto y contenido generado libremente. Los controles de capas gestionan el orden de apilamiento — trae elementos al frente o envíalos al fondo. Bloquea elementos terminados mientras editas otros. Añade texto personalizado con siete opciones de fuente (Lexend Deca, Baloo 2, Nunito, Quicksand, Fredoka, Arial, Verdana), tamaño y color ajustables, y grosor de contorno de texto de 0 a 10 con granularidad de 0,5. Seis opciones de alineación más centrado en la página mantienen los diseños precisos. Zoom del 25% al 300% para trabajo de detalle. Deshacer y rehacer hasta 20 estados de historial con Ctrl+Z y Ctrl+Y.',
      },
    ],
  },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Sí. Los modos Letra Inicial e Imagen+Palabra usan los nombres localizados de las imágenes de la Biblioteca de Imágenes, por lo que cambiar de idioma modifica las palabras y las primeras letras que aparecen en la ficha. Por ejemplo, una imagen de gato muestra «C» en modo Letra Inicial en inglés, pero «K» en alemán (Katze) y «G» en español (Gato). El encabezado localizado «¡Asocia!» también cambia con el idioma seleccionado. La Licencia Comercial incluye 10 temas coloridos; el Acceso Completo desbloquea los 104 temas y los 11 idiomas para contenido textual localizado.',
    },
    {
      question: '¿Hay una prueba gratuita?',
      answer:
        'Sí. Puedes acceder a todas las funciones — los cuatro modos de asociación, el número de pares configurable, la clave de respuesta generada automáticamente, la biblioteca de imágenes completa, los temas de fondo y de borde, los campos de nombre/fecha, los números de elemento, las viñetas decorativas y todos los formatos de descarga — sin crear una cuenta, sin tarjeta de crédito y sin instalar ningún software. Las descargas de la prueba gratuita incluyen una pequeña marca de agua. Una licencia comercial elimina la marca de agua y otorga derechos de venta completos.',
    },
    {
      question: '¿Puedo añadir temas de fondo y de borde a las fichas de asociación?',
      answer:
        'Sí. El panel Configuración de Página incluye tanto un selector de tema de fondo con un control deslizante de opacidad (de 0 a 1 en pasos de 0,05) como un selector de tema de borde con su propio control deslizante de opacidad independiente. Los temas de fondo añaden patrones decorativos detrás del contenido de asociación, mientras que los temas de borde enmarcan la página. Ambos tienen controles de opacidad separados para crear fondos sutiles con bordes prominentes, o cualquier combinación que se adapte a tu diseño. Estos elementos visuales aumentan la calidad percibida de tus fichas de asociación para los anuncios en marketplaces.',
    },
    {
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Creador de Fichas de Asociación',
    },
    {
      pageType: 'start',
    ...
    },
    {
      ...
      anchorText: 'Ideas de Imprimibles de Animales de Granja para Fichas de Trabajo',
    },
  ],
