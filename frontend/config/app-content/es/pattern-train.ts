...
const content: AppContent = {
  seo: {
    ...
    metaDescription:
      'Crea fichas tren de patrones para Etsy, KDP y TPT. Cinco tipos de patrones, 11 vagones temáticos, pistas ajustables. Prueba gratis con marca de agua.',
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Explora 104 colecciones de imágenes temáticas con más de 3100 ilustraciones — animales, comida, vehículos, naturaleza y docenas más — o deja que el tema seleccione automáticamente imágenes coordinadas, elige manualmente desde la biblioteca, o sube tus propias imágenes personalizadas. Cada tema proporciona elementos visuales coordinados que lucen coherentes en todos los vagones del tren. Usa el panel Herramientas de Texto para añadir un título, instrucciones o texto decorativo con fuentes como Lexend Deca, Baloo 2, Nunito, Quicksand y Fredoka. Arrastra, redimensiona y reposiciona cada elemento en el lienzo Fabric.js completo.',
      },
      {
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Accede a más de 3100 ilustraciones en 104 colecciones temáticas — animales, comida, vehículos, naturaleza, profesiones, festividades y docenas más. Cada tema proporciona un conjunto coordinado de imágenes que lucen coherentes en los vagones del tren. La Licencia Comercial incluye 10 temas coloridos para empezar; el Acceso Completo desbloquea los 104 temas para máxima variedad de productos. La biblioteca temática crea oportunidades naturales de agrupación: trenes de patrones de animales de granja, secuencias de criaturas marinas, reconocimiento de patrones de dinosaurios — cada tema se convierte en un listado de producto distinto con atractivo visual inmediato.',
      },
      {
    ...
    cases: [
      {
        ...
        description:
          'Crea packs de trenes de patrones temáticos con dificultad progresiva construida a partir de dos ejes independientes: tipo de patrón y número de pistas. Empieza con patrones AB mostrando 10 pistas para el nivel más fácil, luego reduce las pistas a 6 o 4 para variaciones más difíciles del mismo patrón. Avanza hacia patrones AAB, ABB, ABC y AABB en cada nivel de pistas. Agrupa animales de granja, dinosaurios, criaturas marinas y vehículos como packs temáticos separados de 15 a 25 fichas cada uno más claves de respuesta. El formato único en vagones de tren se destaca de los competidores en cuadrícula en los resultados de búsqueda de Etsy. Fija el precio de los packs temáticos individuales a 3 $–5 $ y de los packs progresivos multi-tema a 12 $–18 $.',
        platform: 'Etsy (etsy.com)',
      },
      {
        title: 'Cuadernos de aprendizaje temprano en Amazon KDP',
        description:
          'Compila de 60 a 100 ejercicios de trenes de patrones en un cuaderno impreso con formato Amazon KDP. Estructura el libro como una progresión de complejidad de patrones: el Capítulo 1 cubre patrones AB con muchas pistas, el Capítulo 2 introduce AAB y ABB, el Capítulo 3 avanza a patrones ABC de tres elementos, el Capítulo 4 presenta las secuencias extendidas AABB, y el Capítulo 5 reduce el número de pistas en todos los tipos de patrones para las páginas de desafío. El formato completamente visual con imágenes en los vagones y cero texto significa que no se necesita traducción para los mercados KDP internacionales — publica el mismo interior en todos los países. Los cuadernos de trenes de patrones llenan un nicho específico de matemáticas tempranas con demanda constante durante todo el año.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Hay tres opciones disponibles: la selección automática por tema elige imágenes coordinadas del tema seleccionado automáticamente, la selección manual te permite explorar la biblioteca de 104 temas y elegir imágenes específicas, y la subida personalizada te permite añadir tus propias imágenes. Cada tema proporciona un conjunto visualmente coordinado — animales, vehículos, comida, naturaleza y docenas más. El tipo de patrón determina cuántas imágenes distintas se necesitan: AB usa 2, AAB y ABB usan 2, ABC usa 3, y AABB usa 2.',
    },
    {
      question: '¿Cómo funciona la clave de respuesta para las fichas tren de patrones?',
      answer:
        'La clave de respuesta vive en una pestaña de lienzo separada, mostrando el tren completo con los 11 vagones llenos — incluyendo la posición que estaba vacía en la ficha. Ambos lienzos son editables de forma independiente, por lo que puedes personalizar la clave de respuesta por separado. La ficha y la clave de respuesta se descargan como archivos separados, ofreciendo a los compradores un paquete de producto completo con soluciones verificadas.',
    },
    {
      question: '¿En qué se diferencian las fichas tren de patrones de las fichas de patrones en cuadrícula?',
      answer:
        'El Tren de Patrones muestra las secuencias en un tren temático con 11 vagones en un formato visual distintivo, mientras que las fichas de patrones en cuadrícula usan filas y columnas estándar. El formato tren es más visualmente atractivo y crea productos que se destacan en los listados de los marketplaces. El Tren de Patrones también ofrece un número de pistas ajustable (4–10) para un control preciso de la dificultad y una colocación dinámica de la posición del vagón que falta — funcionalidades no disponibles en los diseños en cuadrícula estándar.',
    },
    {
      question: '¿Puedo usar mis propias imágenes personalizadas en el tren?',
      answer:
        'Sí. La función de subida de imágenes personalizadas te permite añadir cualquier imagen a los ejercicios del tren de patrones. Sube fotos, ilustraciones o gráficos relevantes para tu tema o audiencia específica. Las imágenes personalizadas funcionan con los cinco tipos de patrones y aparecen en los vagones del tren junto a o en lugar de las imágenes de la biblioteca. Esto es útil para crear fichas específicas de un tema más allá de las 104 colecciones temáticas integradas.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Al darte la prueba gratis acceso a todas las funciones, no ofrecemos reembolsos en las compras de licencia comercial. Puedes probar cada tipo de patrón, cada ajuste de número de pistas, cada tema, cada formato de exportación y cada formato de página antes de comprar. La prueba gratis es la política de reembolso — asegúrate de que la herramienta se adapta a tus necesidades antes de adquirir una licencia.',
    },
  ],
