...
(function (global) {
  ...
  global.BramBoardShopActivity = {
    ...
    strings: {
      title: { en: "Bram's Board Shop", de: 'Brams Bretter-Werkstatt', fr: 'L’atelier de Bram' },
      prompt: { en: 'Measure the order.', de: 'Miss die Bestellung aus.', fr: 'Mesure la commande.' },
      measure: { en: 'Measure it 📏', de: 'Ausmessen 📏', fr: 'Mesurer 📏' },
      replay: { en: '🔊 Read again', de: '🔊 Noch einmal vorlesen', fr: '🔊 Relire' },
      sayWelcome: { en: 'A new order! Show me the lengths.', de: 'Eine neue Bestellung! Zeig mir die Längen.', fr: 'Une nouvelle commande ! Montre-moi les longueurs.' },
      sayModel: { en: 'Put each length on its piece. One piece is the mystery — mark it.', de: 'Leg jede Länge auf ihr Stück. Ein Stück ist das Rätsel – markiere es.', fr: 'Pose chaque longueur sur son morceau. Un morceau est le mystère — marque-le.' },
      sayDial: { en: 'Now — how many centimetres? Dial it in!', de: 'Und jetzt – wie viele Zentimeter? Tippe es ein!', fr: 'Et maintenant — combien de centimètres ? Compose la réponse !' },
      sayWin: { en: 'Measured and cut! Perfect fit. 🪵', de: 'Gemessen und gesägt! Passt genau. 🪵', fr: 'Mesuré et coupé ! Ça tombe pile. 🪵' },
      sayWait: { en: "Hmm, let's measure again.", de: 'Hmm, lass uns noch einmal messen.', fr: 'Hmm, remesurons ensemble.' },
      pickTile: { en: 'Now tap the piece where it belongs.', de: 'Tippe nun auf das Stück, wo sie hingehört.', fr: 'Touche maintenant le morceau où elle va.' },
      hintCheck: { en: 'Place the lengths, mark the mystery, dial the cm.', de: 'Leg die Längen hin, markiere das Rätsel, tippe die cm ein.', fr: 'Pose les longueurs, marque le mystère, compose les cm.' },
      ariaMystery: { en: 'mystery length', de: 'Rätsel-Länge', fr: 'longueur mystère' },
      ariaHolds: { en: 'holds {n} centimetres', de: 'ist {n} Zentimeter lang', fr: 'mesure {n} centimètres' },
      ariaEmpty: { en: 'empty piece — tap to place a length or mark the mystery', de: 'leeres Stück – tippe, um eine Länge zu platzieren oder das Rätsel zu markieren', fr: 'morceau vide — touche pour poser une longueur ou marquer le mystère' },
      ariaTileCm: { en: '{n} centimetres', de: '{n} Zentimeter', fr: '{n} centimètres' },
      ariaRecap: { en: 'your model: {eq} centimetres', de: 'dein Modell: {eq} Zentimeter', fr: 'ton modèle : {eq} centimètres' },
