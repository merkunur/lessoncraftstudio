...
/* =====================================================================
   ...
   3-digit subtraction, decompose-a-ten). Serves `mini tools/` + drives the DOM:
     ...
     • no stored answer/diff flag; ≥7 distinct + reshuffle; no overflow.
   ===================================================================== */
'use strict';
...
(async () => {
  ...
  console.log('PLACE-VALUE-REGROUP-SUBTRACT LOCAL TEST PASSED — decompose-a-ten: hundreds/tens/ones columns + "Break a ten" + Tuck + keypad render; typing the difference without breaking does NOT resolve (borrow required); breaking 342−5 gives 3 tens + 12 ones with 5 marked take-away + hides the button; type the answer → resolves + caption "342 − 5 = 337"; ≥7 distinct + reshuffle; no overflow 280→768.');
  process.exit(0);
