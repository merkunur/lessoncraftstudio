...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Chaque outil a ses forces',
    description: 'Comparez les générateurs de fiches et Canva pour créer des imprimables. Vitesse, qualité et coût. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour générateur fiches vs Canva comparaison. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
  ...
  relatedPosts: [
    { slug: 'printable-business-no-design-skills', title: 'Sans compétences design' },
