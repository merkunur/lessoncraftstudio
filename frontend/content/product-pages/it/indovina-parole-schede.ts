...
export const wordGuessItContent: ProductPageContent = {
  ...
  // Hero Section
  hero: {
    title: 'Schede Gratuite Indovina la Parola per Bambini',
    subtitle: 'Scheda Gratuita per Scuola dell\'Infanzia e Stampabili Gratuiti Primaria',
    description: `Crea schede didattiche professionali per indovinare le parole con il nostro generatore specializzato. Il tuo abbonamento Accesso Completo ti permette di creare schede didattiche illimitate senza costi aggiuntivi per singola scheda. Genera schede didattiche scuola primaria personalizzate perfette per la scuola dell'infanzia e le classi della primaria. Scarica materiale didattico di alta qualità in formato PDF in meno di 3 minuti.
...
Personalizza completamente ogni elemento sulla tua scheda didattica. Aggiungi sfondi tematici e bordi decorativi. Inserisci testi personalizzati con diversi font. Regola i colori, le dimensioni e le posizioni. Modifica tutto direttamente sulla pagina con semplici clic, trascinamenti e ridimensionamenti. Non servono competenze di grafica o design.`,
    previewImageSrc: '/samples/italian/word-guess/sample-1.jpeg',
    ctaLabels: {
  ...
  samples: {
    ...
    items: [
      {
        id: '1',
        worksheetSrc: '/samples/italian/word-guess/sample-1.jpeg',
        answerKeySrc: '/samples/italian/word-guess/sample-1-answer.jpeg',
        altText: 'Scheda gratuita indovina la parola - alfabeto per scuola dell\'infanzia',
        pdfDownloadUrl: '/samples/italian/word-guess/sample-1.pdf',
      },
      {
        id: '2',
        worksheetSrc: '/samples/italian/word-guess/sample-2.jpeg',
        answerKeySrc: '/samples/italian/word-guess/sample-2-answer.jpeg',
        altText: 'Schede gratuite indovina la parola - scheda per bambini vocabolario',
        pdfDownloadUrl: '/samples/italian/word-guess/sample-2.pdf',
      },
      {
        id: '3',
        worksheetSrc: '/samples/italian/word-guess/sample-3.jpeg',
        answerKeySrc: '/samples/italian/word-guess/sample-3-answer.jpeg',
        altText: 'Stampabili gratuiti indovina la parola - lettere dell\'alfabeto',
        pdfDownloadUrl: '/samples/italian/word-guess/sample-3.pdf',
      },
      {
        id: '4',
        worksheetSrc: '/samples/italian/word-guess/sample-4.jpeg',
        answerKeySrc: '/samples/italian/word-guess/sample-4-answer.jpeg',
        altText: 'Scheda per scuola dell\'infanzia - indovina parola scheda gratuita',
        pdfDownloadUrl: '/samples/italian/word-guess/sample-4.pdf',
      },
    ],
  },
  ...
  features: {
    ...
    items: [
      {
        id: '1',
        title: 'Crea Schede Gratuite in 3 Clic - Scheda Gratuita per Scuola dell\'Infanzia',
...
Ogni scheda viene generata automaticamente con layout professionale. Gli esercizi sono distribuiti uniformemente sulla pagina. Le immagini hanno dimensioni appropriate per i bambini. Gli spazi per le risposte sono chiari e facili da compilare. Il formato è coerente e standardizzato, il che aiuta i bambini a concentrarsi sul contenuto invece che sul formato.`,
      ...
      {
        id: '2',
        title: 'Modifica la Tua Scheda Gratuita per Bambini - Schede Italiano Classe Prima',
...
La modifica funziona direttamente sulla pagina. Non serve cambiare schermata o aprire menu complessi. Clicca su un elemento e appare una barra degli strumenti con tutte le opzioni di modifica. Cambia colori, dimensioni, font e posizioni immediatamente. Vedi i risultati in tempo reale mentre modifichi. Annulla e ripeti funzioni per sperimentare senza paura di errori.`,
      ...
      {
        id: '3',
        title: 'Carica Immagini per Schede Gratuite Pregrafismo e Tabelline',
...
Questa funzione è perfetta per insegnanti che lavorano con programmi specializzati. Crea schede didattiche per pregrafismo usando immagini specifiche di tracciati. Prepara schede matematica con manipolativi fotografati dalla tua classe. Sviluppa esercizi di alfabeto con oggetti familiari ai tuoi studenti. Il nome del file diventa automaticamente la parola da indovinare.`,
      ...
      {
        id: '4',
        title: 'Stampabili Gratuiti in 11 Lingue - Alfabeto e Lettere dell\'Alfabeto Multilingue',
...
Gli insegnanti di alfabeto e lettere dell'alfabeto usano questa funzione per insegnare lingue straniere. Crea schede in italiano per studenti madrelingua. Crea le stesse schede in inglese per lezioni di italiano L2. Usa lo stesso formato visivo con vocabolario diverso. I bambini sviluppano competenze multilingue usando materiali familiari.`,
      ...
      {
        id: '5',
        title: 'Licenza Commerciale - Vendi Schede Gratuite Scuola Primaria su Teachers Pay Teachers',
...
La qualità professionale a 300 DPI è perfetta per prodotti digitali. Gli acquirenti si aspettano alta risoluzione per la stampa domestica. Le nostre schede soddisfano questo standard senza lavoro extra da parte tua. Scarica direttamente in PDF pronto per la vendita. Aggiungi semplicemente copertina e descrizione del prodotto.`,
      ...
      {
        id: '6',
        title: '3000+ Immagini per Scheda Gratuita per Bambini - Disegni da Colorare e Numeri',
...
Ogni immagine è progettata per uso educativo. Stile chiaro e semplice perfetto per bambini piccoli. Nessun dettaglio eccessivo che distrae. Colori vivaci che mantengono l'attenzione. Dimensioni appropriate per stampa su fogli standard. Tutte le immagini funzionano bene anche come disegni da colorare quando esportate in scala di grigi.`,
      ...
      {
        id: '7',
        title: 'Qualità Professionale 300 DPI - Scheda per Scuola dell\'Infanzia Stampabile Gratuita',
        description: `Tutte le schede sono generate a 300 DPI, la risoluzione standard professionale per stampa di alta qualità. Questo significa che le tue schede appaiono nitide e chiare su qualsiasi stampante, dalla stampante domestica economica alla stampante laser professionale.

La risoluzione 300 DPI è essenziale per venditori su piattaforme come Teachers Pay Teachers. Gli acquirenti si aspettano qualità professionale per i loro acquisti digitali. Le nostre schede soddisfano questo standard automaticamente senza lavoro extra da parte tua.

Esporta in formato PDF o JPEG secondo le tue necessità. Il PDF mantiene qualità vettoriale per testi perfettamente nitidi. JPEG è ideale per anteprime digitali e condivisione online. Entrambi i formati sono ottimizzati per dimensioni file ragionevoli mantenendo qualità eccellente.`,
        icon: '🎯',
        highlighted: false,
      },
    ],
    ...
    steps: [
      {
        id: '1',
        number: 1,
        title: 'Scegli Immagini per Scheda Gratuita per Bambini - Alfabeto, Tabelline e Numeri',
...
Terza opzione: carica le tue immagini personalizzate. Clicca sul pulsante carica e seleziona file dal tuo computer. Supporta JPEG, PNG e GIF. Carica più file contemporaneamente. Le tue immagini appaiono immediatamente nel pannello delle immagini caricate. Il nome del file diventa automaticamente la parola da indovinare.`,
      ...
      },
      {
        id: '2',
        number: 2,
        title: 'Configura Impostazioni per Schede Gratuite Pregrafismo - Livelli di Difficoltà',
...
Escludi lettere specifiche dagli indizi per maggiore sfida. Digita lettere nel campo esclusione. Ad esempio, digita "AEIOU" per escludere tutte le vocali dagli indizi. I bambini devono indovinare senza vedere vocali. Questo rende gli esercizi significativamente più difficili.`,
      ...
      },
      {
        id: '3',
        number: 3,
        title: 'Genera la Tua Scheda Gratuita - Stampabili Gratuiti Italiano con Alfabeto',
...
Rivedi la scheda generata. Controlla che le parole siano appropriate per il tuo livello. Verifica che il livello di difficoltà sia corretto. Se qualcosa non è perfetto, modifica le impostazioni e genera nuovamente. La rigenerazione richiede solo 2-3 secondi.`,
      ...
      },
      {
        id: '4',
        number: 4,
        title: 'Modifica sulla Pagina - Scheda per Scuola dell\'Infanzia con Disegni da Colorare',
...
Aggiungi sfondi decorativi tematici. Seleziona un tema dal menu sfondi. Appaiono opzioni correlate al tema. Clicca su uno sfondo per applicarlo. Regola opacità con lo slider per non sopraffare il contenuto. Sfondi stagionali sono perfetti per schede tematiche.`,
      ...
      },
      {
        id: '5',
        number: 5,
        title: 'Scarica Schede Gratuite con Tabelline e Stampabili Gratuiti - PDF Alta Qualità',
    ...
    items: [
      {
        id: '1',
        icon: '👶',
        title: 'Insegnanti Scuola dell\'Infanzia - Scheda Gratuita per Bambini con Alfabeto',
...
La funzione di difficoltà regolabile è essenziale per la scuola dell'infanzia. Inizia l'anno con indizi facili che mostrano metà delle lettere. I bambini guadagnano confidenza completando parole con molto supporto. Man mano che le competenze migliorano, riduci gradualmente gli indizi.`,
      ...
      },
      {
        id: '2',
        icon: '📚',
        title: 'Insegnanti Scuola Primaria - Schede Gratuite Italiano Classe Prima con Tabelline',
...
Le tabelline si prestano perfettamente a schede per indovinare parole. Crea esercizi dove i bambini devono scrivere prodotti di moltiplicazione. Ad esempio, mostra "SEI × QUATTRO" e gli studenti completano "VENTIQUATTRO". Combina pratica matematica con rinforzo ortografico.`,
      ...
      },
      {
        id: '3',
        icon: '🏠',
        title: 'Genitori Homeschool - Stampabili Gratuiti con Pregrafismo e Disegni da Colorare',
...
La licenza commerciale permette ai genitori che fanno istruzione parentale di monetizzare materiali creati. Molte mamme che fanno istruzione parentale vendono curriculum su piattaforme come Teachers Pay Teachers. Crea serie complete di schede per alfabeto, numeri, colori, forme.`,
      ...
      },
      {
        id: '4',
        icon: '🌍',
        title: 'Insegnanti Lingue Straniere - Scheda Gratuita Multilingue con Alfabeto',
...
Programmi di immersione bilingue beneficiano enormemente. Mattine in italiano, pomeriggi in inglese. Usa schede didattiche in italiano per lezioni mattutine. Genera le stesse schede in inglese per rinforzo pomeridiano. Formato coerente riduce carico cognitivo.`,
      ...
      },
      {
        id: '5',
        icon: '💪',
        title: 'Insegnanti di Sostegno - Schede Gratuite Differenziate per Scuola dell\'Infanzia',
...
Il formato coerente riduce carico cognitivo per studenti con autismo o ADHD. Le stesse istruzioni visive ogni volta. La stessa struttura della pagina. Prevedibilità riduce ansia. Gli studenti sanno esattamente cosa fare senza bisogno di leggere nuove istruzioni ogni volta.`,
      ...
      },
      {
        id: '6',
        icon: '💼',
        title: 'Imprenditori Educativi - Vendi Schede Gratuite per Bambini su Teachers Pay Teachers',
...
La velocità di creazione di 3 minuti significa alta produttività. Crea 20 prodotti diversi in un'ora. Carica su piattaforme durante weekend. Guadagni passivi mentre insegni durante settimana. Molti insegnanti guadagnano 500-5000 dollari mensili.`,
  ...
  faq: {
    ...
    items: [
      {
        id: '1',
        question: 'Questo Generatore di Schede Gratuite Scuola Primaria Richiede Abbonamento?',
...
L'abbonamento Accesso Completo include tutti i 33 generatori di schede disponibili sulla piattaforma. Crea non solo schede per indovinare parole ma anche schede matematica, tabelline, disegni da colorare, pregrafismo, alfabeto e molto altro. Un prezzo unico copre accesso completo a tutti gli strumenti.`,
      ...
      {
        id: '2',
        question: 'Posso Stampare Schede Gratuite Italiano Classe Prima su Stampante Normale?',
...
Scegli tra esportazione colore o scala di grigi. Scala di grigi risparmia fino all'80% di inchiostro. Particolarmente utile per famiglie e insegnanti che stampano molte schede. I formati PDF e JPEG funzionano con tutte le stampanti moderne.`,
      ...
      {
        id: '3',
        question: 'Serve Competenza per Creare Scheda Gratuita per Bambini con Alfabeto?',
...
L'interfaccia è intuitiva e semplice. Se sai navigare siti web normali, puoi usare il generatore. I menu sono chiari. Le opzioni sono ben etichettate. Le anteprime mostrano esattamente come apparirà la scheda finale. La modifica sulla pagina è opzionale, non obbligatoria.`,
      ...
      {
        id: '4',
        question: 'Quali Lingue Sono Disponibili per Stampabili Gratuiti con Alfabeto?',
...
Le schede didattiche con alfabeto e lettere dell'alfabeto funzionano perfettamente in tutte le 11 lingue. Ogni lingua ha nomi immagini autentici tradotti da madrelingua. Non sono traduzioni automatiche generiche. Vocabolario appropriato e naturale per ogni lingua.`,
      ...
      {
        id: '5',
        question: 'Posso Vendere Schede Gratuite Italiano Classe Prima e Tabelline?',
...
Regola difficoltà per età appropriata. Bambini scuola dell'infanzia necessitano molti indizi lettere. Man mano che competenze crescono, riduci gradualmente indizi. Studenti con bisogni speciali di qualsiasi età beneficiano con difficoltà regolata per livello abilità individuale.`,
      ...
      {
        id: '7',
        question: 'Posso Caricare Immagini per Scheda Gratuita per Bambini Personalizzata?',
...
Carica foto di oggetti classe per vocabolario contestuale. Fotografa manipolativi matematici per schede matematica. Il nome file diventa parola da indovinare. Rinomina file prima di caricare per controllare vocabolario. Oppure usa funzione modifica manuale nomi dopo caricamento.`,
      ...
      {
        id: '8',
        question: 'Quanto Tempo Serve per Creare Stampabili Gratuiti Scuola Primaria?',
...
Confronta con metodi tradizionali che richiedono 30-60 minuti per scheda. Per insegnante che crea 10 schede settimanali, risparmio è enorme. Nostro generatore: 30 minuti settimanali invece di 450 minuti.`,
      ...
      {
        id: '9',
        question: 'Le Schede Gratuite Includono Chiavi di Risposta?',
...
Le chiavi risposta risparmiano tempo prezioso correzione. Non devi completare manualmente ogni scheda per sapere risposte. Il sistema conosce già tutte parole dalle immagini selezionate. Genera chiave automaticamente durante processo download. Zero lavoro extra da parte tua.`,
      ...
      {
        id: '10',
        question: 'Posso Creare Schede Gratuite su Materie Specifiche come Tabelline?',
...
Per schede matematica, usa vocabolario matematico. Parole come "addizione", "sottrazione", "uguale". Le tabelline si prestano perfettamente. Lista parole personalizzate con prodotti moltiplicazione scritti. I bambini praticano ortografia numeri mentre rinforzano fatti moltiplicazione.`,
      ...
      {
        id: '11',
        question: 'Come Personalizzo Schede Gratuite con Disegni da Colorare?',
        answer: `Personalizza schede gratuite aggiungendo immagini dalla libreria o caricando le tue. Clicca su qualsiasi elemento per modificarlo. Trascina, ridimensiona e ruota immagini a piacere. Aggiungi testi personalizzati con diversi font e colori.

Per disegni da colorare, esporta in scala di grigi. Le immagini diventano contorni che i bambini possono colorare. Combina esercizi di indovinare parole con attività creative di colorazione.`,
      },
      {
        id: '12',
        question: 'Posso Usare Scheda per Scuola dell\'Infanzia nella Mia Classe?',
        answer: `Sì, le schede per scuola dell'infanzia sono progettate specificamente per bambini di 3-6 anni. Layout semplici con immagini grandi. Spazi ampi per scrivere lettere. Livelli di difficoltà regolabili per adattarsi a diversi livelli di sviluppo.

Inizia con molti indizi lettere per bambini più piccoli. Riduci gradualmente gli indizi man mano che le competenze migliorano. Il formato coerente aiuta i bambini a concentrarsi sul contenuto.`,
      },
      {
        id: '13',
        question: 'Le Schede Gratuite Funzionano per Studenti con Bisogni Speciali?',
        answer: `Sì, le schede sono eccellenti per studenti con bisogni educativi speciali. Regola difficoltà per ogni studente individualmente. Genera schede con 1-2 esercizi per pagina per immagini più grandi. Spazi per scrivere più ampi per controllo motorio limitato.

Il formato prevedibile riduce carico cognitivo. Studenti con autismo o ADHD beneficiano dalla struttura coerente. Le stesse istruzioni visive ogni volta riducono ansia.`,
      },
      {
        id: '14',
        question: 'Posso Combinare Stampabili Gratuiti con Altri Generatori?',
        answer: `Assolutamente sì. L'abbonamento Accesso Completo include tutti i 33 generatori. Combina schede indovina parole con cruciverba, cerca parole, anagrammi e altro. Crea pacchetti completi per unità tematiche.

Usa lo stesso vocabolario su diversi tipi di schede. I bambini praticano le stesse parole in modi diversi. Questo rinforza apprendimento attraverso ripetizione variata.`,
      },
      {
        id: '15',
        question: 'Le Schede Gratuite per Bambini Supportano Livelli di Difficoltà?',
        answer: `Sì, quattro livelli di difficoltà disponibili. Nessun indizio per valutazione. Facile con metà lettere mostrate. Normale con un quarto lettere. Difficile con pochissimi indizi. Seleziona livello appropriato per ogni studente o classe.

Escludi lettere specifiche per maggiore sfida. Ad esempio, escludi tutte le vocali dagli indizi. Questo rende esercizi significativamente più difficili per studenti avanzati.`,
      },
      {
        id: '16',
        question: 'Come Scarico Scheda Gratuita in PDF o JPEG?',
        answer: `Clicca pulsante "Scarica" quando la scheda è completa. Scegli formato PDF per stampa professionale o JPEG per condivisione digitale. Entrambi supportano risoluzione 300 DPI. Scegli colore o scala di grigi secondo necessità.

Il download include automaticamente versione studente e chiave risposta. File pronti per stampa immediata o caricamento su piattaforme digitali.`,
      },
      {
        id: '17',
        question: 'Le Schede Gratuite Italiano Includono Vocabolario Tematico?',
        answer: `Sì, la libreria include oltre 3000 immagini organizzate per temi. Animali, cibo, veicoli, scuola, casa, sport, natura e molto altro. Seleziona un tema intero o scegli immagini singole. Cerca immagini specifiche con funzione ricerca.

Crea schede tematiche per unità di studio. Vocabolario contestuale aiuta bambini a ricordare e comprendere nuove parole. Collega apprendimento a esperienze familiari.`,
      },
      {
        id: '18',
        question: 'Posso Creare Scheda per Bambini con Lista Parole Personalizzate?',
        answer: `Sì, la funzione lista parole personalizzate permette vocabolario specifico senza immagini. Digita le parole che vuoi usare. Il generatore crea esercizi con quelle parole esatte. Perfetto per vocabolario specializzato o termini tecnici.

Combina lista parole personalizzate con immagini caricate per controllo totale. Crea schede su qualsiasi argomento immaginabile. Nessun limite alla creatività.`,
      },
    ],
  },
