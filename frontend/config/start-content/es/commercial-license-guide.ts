...
const content: StartContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'No. La licencia comercial es independiente de la plataforma. Una licencia cubre ventas en Etsy, Amazon KDP, Gumroad, Gumroad, Creative Fabrica, Shopify, tu propia web y cualquier otro marketplace o canal de ventas. Puedes vender en múltiples plataformas simultáneamente.',
    },
    {
