  ...
  relatedApps: {
    ...
    items: [
      ...
      },
      {
        ...
        icon: '🔗',
        description: 'Vul kruiswoordpuzzels aan met matching activiteiten voor woordherkenning en visuele associatie.',
      },
      {
        id: '5',
        slug: 'writing',
        ...
        icon: '✏️',
        description: 'Train handschrift en letters leren naast kruiswoordpuzzel woordenschat oefening.',
      },
      {
        id: '6',
        slug: 'word-guess',
        ...
        category: 'Taal',
        icon: '❓',
        description: 'Combineer met woordraad puzzels voor extra woordherhaling en spelling vaardigheden.',
      },
    ],
  },
};
