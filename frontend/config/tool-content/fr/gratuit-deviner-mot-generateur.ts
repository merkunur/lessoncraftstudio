...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit Deviner le Mot | PDF Imprimables',
    metaDescription: 'Créez des fiches de deviner le mot gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit deviner mot',
    secondaryKeywords: ["jeu deviner mot gratuit","fiches vocabulaire images gratuit","mot mystère maternelle PDF","devinette éducative enfants","indice visuel mot gratuit"],
    lsiKeywords: ["devinette","inférence","vocabulaire","compréhension","expression","langage","indice","lecture"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/word guess/Word Guess 1.jpeg',
      primaryAlt: 'Jeu deviner le mot gratuit',
    },
    sampleGallery: [
      { src: '/samples/english/word guess/Word Guess 1.jpeg', alt: 'Deviner le mot', caption: 'Indices visuels' }
    ],
    youtubeId: '36keBFzJbPo',
    videoTitle: 'Comment créer des fiches de deviner le mot gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit Deviner le Mot',
    tagline: 'Créez des fiches de deviner le mot et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de deviner le mot transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de deviner le mot autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de deviner le mot en 10 étapes',
    steps: [
  ...
  internalLinks: [
    { slug: 'gratuit-deviner-mot-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit Deviner le Mot' },
    { slug: 'word-guess', pageType: 'app' as const, anchorText: 'Générateur Deviner le Mot — Détails complets' },
  ],
};
