...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'De data achter Etsy Ads voor digitale producten',
    description: 'De data achter Etsy Ads voor digitale producten. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
