...
export const patternWorksheetsEnContent: ProductPageContent = {
  ...
  seo: {
    ...
    images: [
      {
        url: 'https://www.lessoncraftstudio.com/samples/english/pattern/sample-1.jpeg',
        width: 2480,
        height: 3508,
        caption: 'Free pattern worksheets for kindergarten - AB pattern recognition worksheet for kids',
      },
      {
        url: 'https://www.lessoncraftstudio.com/samples/english/pattern/sample-2.jpeg',
        width: 2480,
        height: 3508,
        caption: 'Free printable pattern worksheets - ABC pattern worksheet for first grade math',
      },
      {
        url: 'https://www.lessoncraftstudio.com/samples/english/pattern/sample-3.jpeg',
        width: 2480,
        height: 3508,
        caption: 'Pattern recognition worksheet for kids - ABCD pattern completion free printables',
      },
      {
        url: 'https://www.lessoncraftstudio.com/samples/english/pattern/sample-4.jpeg',
        width: 2480,
        height: 3508,
        caption: 'Worksheet for kindergarten - visual pattern recognition math worksheet free',
      },
      {
        url: 'https://www.lessoncraftstudio.com/samples/english/pattern/sample-5.jpeg',
        width: 2480,
        height: 3508,
...
Full Access subscription includes commercial licensing for Teachers Pay Teachers sales. Create and sell pattern worksheets, math worksheets, and kindergarten worksheets without extra licensing fees. Pattern worksheet generator saves 85% of traditional worksheet creation time compared to design software and clipart searches.`,
    ...
    items: [
      {
        id: '1',
        icon: '⚡',
        title: 'Create Free Pattern Recognition Worksheets for Kids in 3 Clicks',
      ...
      },
      {
        id: '2',
        icon: '✏️',
        title: 'Edit Free Worksheet for Kindergarten Pattern Recognition on Canvas',
      ...
      },
      {
        id: '3',
        icon: '📤',
        title: 'Upload Custom Images to Free Math Worksheets for Kids',
      ...
      },
      {
        id: '4',
        icon: '🌍',
        title: 'Free Phonics and Alphabet Worksheets in 11 Languages',
      ...
      },
      {
        id: '5',
        icon: '💰',
        title: 'Commercial License for Sight Words and Tracing Worksheets',
      ...
      },
      {
        id: '6',
        icon: '🎨',
        title: '3000+ Images for Kindergarten Worksheets and Coloring Worksheets',
      ...
      },
      {
        id: '7',
        icon: '🖨️',
        title: 'Professional 300 DPI First Grade Worksheets and Math Practice',
    ...
    items: [
      {
        id: '1',
        icon: '👩‍🏫',
        title: 'Kindergarten Worksheets for Teachers',
      ...
      },
      {
        id: '2',
        icon: '📚',
        title: 'First Grade Worksheets for Math Teachers',
      ...
      },
      {
        id: '3',
        icon: '🏠',
        title: 'Free Worksheets for Homeschool Kids',
      ...
      },
      {
        id: '4',
        icon: '🌍',
        title: 'Sight Words Worksheets for ESL Teachers',
      ...
      },
      {
        id: '5',
        icon: '💜',
        title: 'Tracing Worksheets for Special Education',
      ...
      },
      {
        id: '6',
        icon: '💰',
        title: 'Coloring Worksheets for Teachers Pay Teachers',
  ...
  faq: {
    ...
    items: [
      {
        id: '1',
        question: 'Are Pattern Recognition Worksheets Really Free for Kids?',
      ...
      {
        id: '2',
        question: 'Can I Print Kindergarten Worksheets at Home?',
      ...
      {
        id: '3',
        question: 'Do I Need Design Skills for First Grade Worksheet Creation?',
      ...
      {
        id: '4',
        question: 'Are Free Worksheets for Kindergarten Classroom Use?',
      ...
      {
        id: '5',
        question: 'What Languages Support Phonics and Alphabet Worksheets?',
      ...
      {
        id: '6',
        question: 'Can I Sell Sight Words Worksheets on Teachers Pay Teachers?',
      ...
      {
        id: '7',
        question: 'How Do I Customize Tracing Worksheets and Coloring Pages?',
      ...
      {
        id: '8',
        question: 'What Age Groups Need Free Worksheet for Kids Practice?',
      ...
      {
        id: '9',
        question: 'Can I Upload Images to Math Worksheets for Kindergarten?',
      ...
      {
        id: '10',
        question: 'How Long Does Free Printable Worksheet Creation Take?',
      ...
      {
        id: '11',
        question: 'Do Pattern Recognition Worksheets Include Answer Keys?',
      ...
      {
        id: '12',
        question: 'Can I Create Themed Free Worksheets for Kids?',
