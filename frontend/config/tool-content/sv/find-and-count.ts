...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Välj sidstorlek: Standard (800×1000), Letter, A4, Kvadrat (1200×1200) eller anpassad. Välj sidbakgrundsfärg. Välj bakgrundstema och ramtema med oberoende opacitetsreglage.',
      },
      {
      ...
      },
      {
        ...
        description: 'Växla gråskala för bläckvänliga versioner. Ladda ner: arbetsblad-JPEG, arbetsblad-PDF, facit-JPEG, facit-PDF med 300 DPI. Byt teman, justera rutnät, ändra uppgiftstyper och generera igen för snabb variation.',
      },
    ],
  },
  ...
  whatYouCanCreate: [
    {
      title: 'Tematiska sökaktivitetspaket med blandade uppgiftstyper',
      description: 'Skapa sökarbetsbladpaket med de 104 bildsamlingarna. Mixa alla fyra uppgiftstyper per paket. Paketera 15–20 arbetsblad med autogenererade facit. Slumpmässig fördelning gör varje generering unik.',
    },
    {
      title: 'A–Ö Bokstavsletning fonikpaket med lokalspecifika alfabet',
      description: 'Skapa kompletta alfabet sökpaket — ett arbetsblad per bokstav. Svenska paket inkluderar 29 bokstäver med Å, Ä och Ö. De lokalspecifika alphabeten med accentuerade bokstäver gör att du kan skapa språkspecifika fonikpaket som konkurrenter med enbart engelska verktyg inte kan matcha.',
    },
    {
      title: 'KDP sökaktivitets arbetsböcker med progressiv svårighet',
  ...
  businessIdeas: [
    ...
    {
      title: 'Flerspråkig sökproduktlinje för internationella marknader',
      description: 'Hitta och Räkna Generatorn är språkkänslig — bildetiketter, Bokstavsletning begynnelsebokstäver och rubriktext ändras alla. Skapa genuint lokaliserade sökarbetsblad. Sälj språkspecifika paket.',
  ...
  proTips: [
    ...
    {
      title: 'Använd rutnätsdensitet som primär svårighetskontroll',
    ...
    },
    {
      ...
      description: 'Det autogenererade facit med röda cirkel-, rut-, kors- och räkneannoteringer är din starkaste differentieringspunkt. Visa alltid facit. Dubbelarbetsyte-systemet genererar båda samtidigt.',
    },
    {
  ...
  faq: [
    ...
    {
      question: 'Varför är Hitta och Räkna språkkänslig till skillnad från rent visuella verktyg?',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Hitta och räkna sökarbetsblad med spridda bilder på ett konfigurerbart rutnät med blå rubrikram och fyra uppgiftsinstruktioner',
    },
    sampleGallery: [
      {
    ...
    videoTitle: 'Hur du Skapar Hitta och Räkna Sökarbetsblad med Dolda Objekt-Läge, Bokstavsletning och Fyra Uppgiftstyper — Steg-för-Steg Handledning',
  },
};
