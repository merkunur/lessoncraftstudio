    ...
    fields: {
      say: {
        ...
        sentences: [
          ...
          { id: 'f6', text: '“Ten,” {name} {gap} right after the teacher’s question.', plainVerbOK: true, fit: { whispered: false, shouted: false, asked: false, answered: true, explained: false, promised: false } },
          { id: 'f7', text: '“First dig a hole, then drop in the seed,” {name} {gap} step by step.', plainVerbOK: true, fit: { whispered: false, shouted: false, asked: false, answered: false, explained: true, promised: false } },
