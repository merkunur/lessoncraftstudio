    ...
    items: [
      {
        id: '1',
        icon: '⚡',
        title: 'Create Free Matching Worksheets for Kindergarten in 3 Clicks',
      ...
      },
      {
        id: '2',
        icon: '🎯',
        title: 'Free Worksheet for Kids: Four Matching Modes for Alphabet Worksheets',
      ...
      },
      {
        id: '3',
        icon: '✏️',
        title: 'Free Printables: Edit Everything on Your Matching Worksheet for Kids',
