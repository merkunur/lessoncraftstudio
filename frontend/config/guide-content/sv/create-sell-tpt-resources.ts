...
const content: GuideContent = {
  ...
  introduction: "Gumroad skiljer sig från alla andra plattformar för att sälja utskriftsbart pedagogiskt innehåll. På Etsy är dina köpare en blandning av föräldrar, hemundervisare, säljare och generella konsumenter som bläddrar en massiv generell marknadsplats. På Amazon KDP köper konsumenter fysiska böcker. På Gumroad är dina köpare nästan uteslutande produktlinjessäljare, skoladministratörer, produktkatalogsspecialister och hemundervisande säljare — personer som vet exakt vad de behöver och utvärderar resurser genom en professionell lins.\n\nDenna distinktion formar allt. köpare som söker på Gumroad filtrerar efter årskurs, ämnesområde, resurstyp och utbildningsstandarder. De förväntar sig professionell formatering med tydliga lärandemål, kompletta facit och instruktioner för produktlinjesimplementering. De utvärderar resurser via förhandsgranskningsfunktionen. Och de delar rekommendationer med kollegor, vilket skapar mun-till-mun-momentum.\n\nGumroad:s avgiftsstruktur belönar engagerade säljare. Den kostnadsfria Basic-planen låter dig behålla 45% av varje försäljning — Gumroad tar 55% provision. Premium-planen kostar $59,95 per år men ökar din andel till 80%, med Gumroad som tar bara 20%. För alla säljare som förväntar sig mer än ungefär $150 i årlig försäljning betalar Premium sig snabbt.\n\nGumroad tillhandahåller också inbyggda funktioner som andra plattformar saknar. Du kan tagga resurser med specifika utbildningsstandarder (Common Core, statliga standarder, NGSS), tilldela detaljerade årskursintervall, kategorisera efter ämne och resurstyp, och erbjuda anpassade paket som låter köpare välja flera resurser med rabatt.\n\nDenna guide täcker den kompletta processen: kontouppstart, resursskapande, filpaketering, listningsoptimering, förhandsgranskningsskapande, prisstrategi och lanseringstaktik. För säljare som redan är aktiva på Etsy eller KDP fokuserar denna guide på vad som gör Gumroad annorlunda — de lärarspecifika kraven, plattformsunikt funktion och pedagogiska målgruppsförväntningar som kräver en Gumroad-specifik metod.",

  tutorial: [
    {
      heading: "Förstå Gumroad-marknadsplatsen för pedagogiska resurser",
    ...
    {
      heading: "Formatera och paketera resurser för Gumroad-uppladdning",
      content: "Gumroad accepterar uppladdade filer i ZIP-format, och varje produktlistning kan innehålla flera filer i ZIP:en. Din primära resursfil bör vara en PDF — det universella formatet som varje säljare kan öppna och skriva ut.\n\nOrganisera dina resursfiler logiskt. För ett enkelt arbetsbladspaket kan din ZIP innehålla en enda PDF med alla sidor i ordning: omslagssida, innehållsförteckning, lärarnoteringar, arbetsblad, facit och användarvillkor. Tydlig filnamngivning är viktigt — märk filer beskrivande.\n\nInkludera både US Letter (8,5 x 11 tum) och A4-storlekar när det är möjligt. Många Gumroad-köpare undervisar på internationella skolor. Att erbjuda båda storlekarna i en enda nedladdning tar bort ett köphinder.\n\nGumroad har filstorleksgränser. Håll din totala ZIP under maxgränsen genom att optimera dina PDF:er. Om ditt resurspaket överstiger gränsen, dela det i logiska delar.\n\nSkapa en separat förhandsgranskningsfil för varje resurs. Förhandsgranskningen är en komprimerad version som potentiella köpare kan visa före köp. Typiskt fungerar 3 till 5 sidor bra: omslagssidan, en eller två exempel-aktivitetssidor och en sida som listar allt som ingår.",
    },
    {
      heading: "Skriv Gumroad-listningar som rankar i lärarsökningar",
      content: "Din Gumroad-listningstitel är den enskilt viktigaste faktorn för sökupptäckbarhet. Gumroad:s sökalgoritm väger titeln tungt. En effektiv Gumroad-titel följer denna struktur: [Ämne/Färdighet] + [Resurstyp] + [Årskurs] + [Kvalificerande detalj]. Till exempel: \"Addition Worksheets with Picture Math — First Grade — No Prep Printable.\"\n\nDin produktbeskrivning tjänar två syften: hjälpa Gumroad:s sökalgoritm och övertyga säljare att köpa. Strukturera med tydliga sektioner. Börja med en kort översikt. Följ med en detaljerad lista av vad som ingår. Beskriv sedan hur säljare kan använda resursen. Avsluta med tekniska detaljer.\n\nAnvänd Gumroad:s ämnes-, årskurs- och resurstypsfilter korrekt. Välj det mest specifika ämnesområdet. Var ärlig om årskursintervallet — köpare som köper en resurs märkt \"Årskurs K–5\" men finner den bara lämplig för årskurs 1 lämnar negativ feedback.\n\nTagga dina resurser med utbildningsstandarder. Gumroad tillåter anpassning till Common Core, Next Generation Science Standards och statliga standarder. säljare filtrerar ofta sökresultat efter standard. En resurs taggad med \"CCSS.MATH.CONTENT.1.OA.C.6\" visas när säljare söker den specifika standarden.\n\nSkriv nyckelordsrika taggar. Om din titel säger \"Addition Worksheets\" bör dina taggar inkludera variationer som \"math practice,\" \"number sense,\" \"adding,\" \"sum\" och \"basic operations.\"",
    },
    {
  ...
  platformTips: [
    {
      ...
      content: "Standardanpassning är en av de mest kraftfulla upptäckbarhetsfunktionerna unika för Gumroad. säljare planerar ofta undervisning efter standard, och Gumroad låter dem söka och filtrera efter specifika standardkoder. Att tagga dina resurser med lämpliga Common Core eller statliga standarder gör dem omedelbart synliga. Detta är en upptäcktskanal som inte existerar på Etsy eller KDP. Även om standardtaggning tar 10–15 minuter extra per resurs överväger den långsiktiga upptäckbarhetsförmånen tidsinvesteringen vida.",
    },
    {
      heading: "Använd förhandsgranskningsfiler som ditt primära konverteringsverktyg",
      content: "Gumroad-köpare är grundligare utvärderare än köpare på de flesta andra plattformar eftersom de spenderar produktlinjes- eller professionella utvecklingsbudgetar. Förhandsgranskningsfilen är där köpbeslut fattas — köpare som klickar sig till din listning öppnar nästan alltid förhandsgranskningen innan de köper. Investera betydande ansträngning i att visa de bästa sidorna med ren formatering. Inkludera en komplett exempel-aktivitetssida så säljare kan utvärdera den faktiska upplevelsen. En stark förhandsgranskning konverterar bättre än en polerad beskrivning ensam.",
    },
    {
      heading: "Bygg paket strategiskt för att öka genomsnittligt ordervärde",
      content: "Gumroad:s anpassade paketfunktion låter köpare kombinera flera enskilda resurser med en säljar-satt rabatt. Strukturera dina resurser så att de naturligt grupperas i logiska samlingar: en serie additionsarbetsblad efter svårighetsnivå, en uppsättning vokabuläraktiviteter, eller en samling aktiviteter. När säljare hittar en resurs de gillar uppmuntrar paketrabatter dem att köpa relaterade resurser i samma transaktion. Sätt din paketrabatt mellan 15% och 25%. Nämn paketmöjligheten i dina produktbeskrivningar.",
    },
  ],
  ...
  monetization: [
    ...
    {
      heading: "Utnyttja Gumroad:s försäljningsevenemang för intäktstoppar",
      content: "Gumroad arrangerar plattformsövergripande försäljningsevenemang flera gånger per år. Dessa evenemang genererar massiva trafiktoppar. Säljare kan erbjuda ytterligare rabatt som staplas med Gumroad:s rabatt. Under stora evenemang rapporterar många säljare att de tjänar en betydande andel av sin månatliga intäkt på bara 2–3 dagar. Förbered genom att säkerställa att dina listningar är fullständigt optimerade innan evenemanget börjar. En större katalog under evenemang innebär fler potentiella köp per köpare.",
    },
  ],

  examples: [
    {
      heading: "Exempel: Grundskolesäljare i matematik bygger en Gumroad-butik",
      content: "En tredjeklasssäljare använder Additions- och Mattepussel-generatorerna för att skapa riktade matteövningsresurser. Hon börjar med att skapa 5 resurspaket, vart och ett fokuserat på en specifik mattestandard: tvåsiffrig addition med omgruppering (12 arbetsblad), tresiffrig addition utan omgruppering (10 arbetsblad), blandad additionsövning (15 arbetsblad), mattepusselutmaningssidor (8 pussel) och ett kombinerat repetitionspaket (20 sidor). Varje resurs inkluderar omslagssida, lärarnoteringar med implementeringsförslag, arbetsblad och komplett facit. Hon uppgraderar till Premium-planen omedelbart. Hon prissätter sina arbetsbladspaket till $4–$5 och repetitionspaketet till $8, med 20% anpassad paketrabatt. Hon taggar varje resurs med lämpliga Common Core-mattestandarder för årskurs 3. Efter sin första månad med 5 listningar genererar hon 22 försäljningar totalt $108. Hon lägger till 2 nya resurser per månad och expanderar till subtraktion och multiplikation. Vid månad 6 genererar hennes 17-listningsbutik $280–$350 per månad.",
    },
    {
      heading: "Exempel: Flerplattformssäljare lägger till Gumroad till Etsy och KDP",
      content: "En printable-säljare som redan är aktiv på Etsy och KDP expanderar till Gumroad. Hon anpassar sitt befintliga ordsöknings- och matchningsaktivitetsinnehåll genom att lägga till lärarspecifika element: standardanpassningstaggar, årskursriktning, produktlinjesimplementeringsnoteringar och en användarvillkorssida. Istället för att ladda upp sina Etsy-listningar oförändrade omstrukturerar hon innehållet. Hennes Etsy-produkt (ett 10-sidors ordsökningspaket till $6,50) blir en Gumroad-produkt med tillagd omslagssida, lärarnoteringar, facit och standardtaggar (prissatt till $5). Hon skapar Gumroad-specifika förhandsgranskningar med 3 exempelsidor. Hennes differentiering: Etsy för föräldrar och hemundervisare, KDP för konsumenter som vill ha tryckta böcker, och Gumroad för produktlinjessäljare. Inom 3 månader genererar hon $150–$200 per månad från Gumroad, utöver sin befintliga Etsy- och KDP-inkomst med minimalt nytt innehållsskapande.",
    },
  ],
  ...
  faq: [
    ...
    {
      question: "Hur skiljer sig Gumroad från att sälja arbetsblad på Etsy?",
      answer: "Gumroad skiljer sig på tre grundläggande sätt. Först målgruppen: varje Gumroad-köpare är en säljare, medan Etsy-köpare är en blandning. Sedan funktionerna: Gumroad erbjuder standardanpassningstaggar, årskursfiltrering och ämneskategorisering som Etsy saknar. Slutligen förväntningarna: Gumroad-köpare utvärderar genom en professionell säljarelins och förväntar sig omslagssidor, facit, lärarnoteringar och standardanpassning.",
    },
    {
      question: "Kan jag sälja samma innehåll på Gumroad och andra plattformar?",
    ...
    {
      question: "Vad gör att en Gumroad-listning rankar högre i sökresultat?",
      answer: "Gumroad:s sökalgoritm beaktar: nyckelordsrelevans i titel, beskrivning och taggar; försäljningshistorik och konverteringsgrad; köparbetyg och recensioner; listningens aktualitet; och fullständighet av kategorisering. Titeln bär tyngst nyckelordsvikt. Starka förhandsgranskningar förbättrar konverteringsgraden. Regelbunden uppdatering av resurser kan ge förnyad synlighet.",
    },
    {
      question: "Vad är återbetalningspolicyn för kommersiella licenser som används för att skapa Gumroad-resurser?",
      answer: "Varje generator erbjuder en gratis provversion med vattenstämpel så att du kan utvärdera verktyget fullständigt före köp. Skapa kompletta arbetsblad, testa olika konfigurationer och teman, verifiera tryckkvaliteten vid 300 DPI för Gumroad resurs-PDF:er och bekräfta att formatet uppfyller Gumroad:s krav. Eftersom du kan grundligt testa hela produkten innan köp är alla kommersiella licensförsäljningar slutgiltiga.",
    },
  ],
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: "Producerar engagerande målaraktiviteter populära för centra, tidiga slutare och kompletterande produktlinjesanvändning. Högefterfrågad resurstyp på Gumroad.",
    },
  ],
