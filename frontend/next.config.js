...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Danish: shadow-match-worksheets → skygge-match-arbejdsark
      {
        source: '/da/apps/shadow-match-worksheets',
      ...
      // Danish: writing-worksheets → skriveopgaver-arbejdsark
      {
        source: '/da/apps/writing-worksheets',
      ...
      // Norwegian: cryptogram-worksheets → kryptogram-arbeidsark
      {
        source: '/no/apps/cryptogram-worksheets',
      ...
      // Finnish: big-small-worksheets → iso-pieni-tyoarkit
      {
        source: '/fi/apps/big-small-worksheets',
      ...
      // Finnish: math-puzzle-worksheets → matematiikkapulmat-tyoarkit
      {
        source: '/fi/apps/math-puzzle-worksheets',
      ...
      // Finnish: pattern-worksheets → kuviotehtava-tyoarkit
      {
        source: '/fi/apps/pattern-worksheets',
