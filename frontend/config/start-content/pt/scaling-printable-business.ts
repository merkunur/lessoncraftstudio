...
const content: StartContent = {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Escalamento agnóstico de plataforma — produtos de sudoku idênticos funcionam no Etsy, Amazon KDP, Gumroad e em todos os marketplaces internacionais sem adaptação de formato. Os puzzles puramente numéricos cruzam todas as barreiras linguísticas.',
    },
    {
