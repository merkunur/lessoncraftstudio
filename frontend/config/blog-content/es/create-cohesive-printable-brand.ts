...
const content: BlogContent = {
  ...
  relatedPosts: [
    ...
    { slug: 'batch-create-worksheets-efficiently', title: 'Crear en Lote' },
    { slug: 'printable-bundle-strategy-etsy', title: 'Estrategia de Paquetes' }
  ],
  cta: {
    heading: 'Ponga en Practica lo Aprendido',
    description: '33 generadores profesionales para crear fichas listas para vender. Prueba gratuita con marca de agua, sin registro.',
