...
const content: AppContent = {
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      {
        src: '/samples/portuguese/picture%20path/caminho-de-imagen-1-answer-key.webp',
