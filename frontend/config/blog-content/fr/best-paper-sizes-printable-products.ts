...
const content: BlogContent = {
  ...
  hero: {
    title: 'A4 vs Letter : quel format pour vos imprimables ?',
    tagline: 'L\'A4 est le standard en France et en Europe',
    description: 'A4 ou Letter ? Les formats papier optimaux pour vos imprimables selon le marché cible. L\'A4 est standard en France. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour meilleurs formats papier imprimables A4. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
  ...
  relatedPosts: [
    ...
    { slug: 'kdp-activity-book-formatting-guide', title: 'Formater pour KDP' },
    { slug: 'printable-file-formats-pdf-jpeg-guide', title: 'Formats de fichiers' },
  ],
  cta: {
