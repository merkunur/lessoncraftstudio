...
const content: ToolContent = {  seo: {
  ...
  tutorial: {
    ...
    steps: [
      {
        title: 'Ouvrir le Générateur de Mots Croisés en Images',
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      {
        src: '/samples/french/crossword/mots-croisés-en-images-1-answer-key.webp',
