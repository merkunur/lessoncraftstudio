...
const content: ToolContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Las celdas pista son posiciones de la cuadrícula donde la pieza de la imagen permanece visible como referencia. Establece de 1 a 5 celdas pista usando el control deslizante en el panel de Opciones de Cuadrícula (por defecto 1). Más pistas hacen el puzzle más fácil porque los usuarios tienen más puntos de referencia para identificar dónde pertenecen las piezas. Para una cuadrícula de 3×3: 1 pista significa 8 piezas por asociar (desafiante), 3 pistas significan 6 piezas (moderado), 5 pistas significan 4 piezas (fácil). Para una cuadrícula de 4×4: 1 pista significa 15 piezas por asociar (muy desafiante), 5 pistas significan 11 piezas (aún considerable). Este único control crea sets de dificultad graduada a partir de una sola imagen.',
    },
    {
