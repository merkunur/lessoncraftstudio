...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    ...
    {
      title: 'Attività di Logica e Ragionamento per la Classe con Chiavi di Risposta',
      description: 'Crea schede sudoku con immagini pronte per la classe per il lavoro del mattino, studenti che finiscono in anticipo e centri di arricchimento con chiavi di risposta stampate per postazioni di auto-correzione. Il sudoku con immagini sviluppa la deduzione logica e il ragionamento spaziale in un formato accessibile ai pre-lettori che non hanno ancora padroneggiato i numeri. Crea set collegati al programma scolastico: sudoku sulla classificazione degli animali per unità di scienze, puzzle logici sui gruppi alimentari per lezioni sulla nutrizione, attività di ragionamento sugli aiutanti della comunità per studi sociali. Ogni scheda si esporta con la sua chiave di risposta auto-generata che mostra la griglia completa, eliminando il tempo di preparazione dell\'insegnante.',
    },
    {
      title: 'Pacchetti di Puzzle di Introduzione alla Logica per Piccoli Studenti',
