 ...
 */
const legacyAppIdToEnglishSlug = {
 ...
 */
function generateLegacyAppIdRedirects() {
  const redirects = [];
  ...
  for (const [legacyAppId, englishSeoSlug] of Object.entries(legacyAppIdToEnglishSlug)) {
    ...
    for (const locale of SUPPORTED_LOCALES) {
      ...
      const localizedSlug = appConfig.slugs[locale] || englishSeoSlug;
