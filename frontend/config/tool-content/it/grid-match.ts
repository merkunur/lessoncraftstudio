...
const content: ToolContent = {
  ...
  visuals: {
    heroImages: {
      primary: '/samples/italian/grid%20match/Puzzle%20a%20Griglia%201.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/italian/grid%20match/Puzzle%20a%20Griglia%202.webp',
      ...
      {
        src: '/samples/italian/grid%20match/Puzzle%20a%20Griglia%203.webp',
      ...
      {
        src: '/samples/italian/grid%20match/Puzzle%20a%20Griglia%201%20answer_key.webp',
