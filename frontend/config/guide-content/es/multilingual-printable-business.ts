...
const content: GuideContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'La mayoría de las consultas de clientes sobre imprimibles son sencillas y siguen patrones predecibles: problemas de descarga, preguntas de impresión o aclaraciones sobre el producto. Prepara respuestas plantilla en cada idioma en que vendes cubriendo estos escenarios comunes. Las herramientas de traducción manejan eficazmente las comunicaciones rutinarias. Para problemas complejos, contar con un contacto nativo disponible (incluso en régimen freelance) proporciona una red de seguridad sin necesitar personal de soporte multilingüe a tiempo completo.',
    },
    {
  ...
  internalLinks: [
    ...
    { pageType: 'guide', slug: 'precios-material-educativo', anchorText: 'Estrategias de precios para material educativo' },
  ...
  toolsRecommended: [
    {
      ...
      description: 'Crea sopas de letras en 11 idiomas — demuestra cómo una sola herramienta produce contenido multilingüe al instante. Inicia una prueba gratis con marca de agua para ver la producción multilingüe en acción.',
    },
    {
      appId: 'word-guess',
      title: 'Generador de adivinar palabras',
      description: 'Genera fichas de vocabulario con adivinanzas de palabras en múltiples idiomas. Muestra cómo el contenido educativo sensible al idioma puede llegar a mercados internacionales. Inicia una prueba gratis con marca de agua.',
    },
    {
      appId: 'matching',
    ...
    },
    {
      ...
      description: 'Crea fichas de matemáticas de sumas que cruzan las barreras lingüísticas naturalmente ya que los números son universales. Los productos de matemáticas son puntos de partida ideales para la expansión multilingüe. Inicia una prueba gratis con marca de agua.',
    },
  ],
