...
const content: BlogContent = {
  ...
  internalLinks: [
    ...
    { pageType: 'app', slug: 'picture-bingo-worksheets', anchorText: 'Fastelavn Banko Generator' },
    { pageType: 'app', slug: 'coloring-worksheets', anchorText: 'Fastelavn Farvelægning' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Nytårs-Printables',
