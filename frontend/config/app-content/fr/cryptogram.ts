...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Cryptogrammes | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Cryptogrammes professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Puzzle cryptogramme avec lettres substituées',

    },
    sampleGallery: [
      { src: '/samples/english/cryptogram/Cryptogram 1.jpeg', alt: 'Cryptogramme à décoder', caption: 'Décoder le message' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Cryptogrammes thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Cryptogrammes est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'cryptogram', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Cryptogrammes Gratuit' },
