...
const content: ToolContent = {
  ...
  businessIdeas: [
    ...
    {
      title: 'Gumroad I Spy Activity Packs',
      description: 'Upload I Spy activity packs to Gumroad with name/date fields and auto-generated answer keys as key selling points. Buyers searching for counting and observation activities value worksheets that arrive ready-to-use with solutions included. Create themed sets: farm animal I Spy, community helper I Spy, food group I Spy, and seasonal I Spy for holiday-themed packs. The four task types let you create differentiated versions — circle-only worksheets for the beginner tier and mixed-task worksheets with counting for advanced puzzles. Letter Spotting bundles serve the phonics and alphabet awareness market.',
      platform: 'Gumroad',
    },
    {
  ...
  visuals: {
    ...
    sampleGallery: [
      {
        src: '/samples/english/find%20and%20count/find-and-count-portrait.webp',
      ...
      {
        src: '/samples/english/find%20and%20count/find-and-count-landscape.webp',
