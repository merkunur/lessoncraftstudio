...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: "Construye fichas de clasificación listas para venta en línea para centros de clasificación, trabajo matutino y práctica independiente con campos de nombre/fecha y claves de respuestas impresas. Crea sets alineados con el catálogo de productos: vivos vs no vivos para ciencias, comida saludable vs no saludable para nutrición, animales diurnos vs nocturnos para hábitats, ropa de clima caliente vs frío para estaciones. El modo temático genera fichas rápidamente para sets masivos del mercado, mientras que el modo manual te permite seleccionar imágenes específicas que coincidan con tus objetivos de la lección. La clave de respuestas autogenerada ahorra tiempo de preparación al vendedor y hace posibles estaciones de clasificación con autocorrección.",
    },
    {
    ...
    },
    {
      ...
      description: "Construye colecciones estacionales rotativas usando temas de festividades y naturaleza de la biblioteca de 104 temas. Decoraciones navideñas vs comida navideña, disfraces de Halloween vs dulces de Halloween, actividades de verano vs actividades de invierno, flores de primavera vs hojas de otoño — los emparejamientos estacionales de categorías crean actividades de clasificación naturales que padres y vendedores buscan activamente. Publica cada colección 4–6 semanas antes de la festividad para máxima visibilidad en el mercado. Incluye versiones simples (4–6 imágenes) y avanzadas (10–12 imágenes) en cada set estacional para máxima cobertura de rango de edad.",
    },
  ],
  ...
  proTips: [
    ...
    },
    {
      ...
      description: "La clave de respuestas autogenerada con imágenes 6× más grandes organizadas en cajas de categoría es lo que convierte tus fichas de clasificación en un producto completo con autocorrección en lugar de solo una actividad de clasificación. Siempre incluye claves de respuestas en tus paquetes de productos y muéstralas en las imágenes de vista previa del listado. Los productos que incluyen claves de respuestas consistentemente superan en ventas a los listados de solo fichas porque vendedores y padres quieren materiales con autocorrección que no requieran tiempo adicional de preparación. El sistema de doble lienzo genera ambas versiones simultáneamente, así que incluir la clave de respuestas no te cuesta nada extra.",
    },
    {
