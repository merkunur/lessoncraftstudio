...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'coloring-worksheets', anchorText: 'Rum Farvelægning' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Rum Ordsøgning' },
    { pageType: 'app', slug: 'addition-worksheets', anchorText: 'Rum Addition' },
  ],
  relatedPosts: [
