...
const content: AppContent = {
  ...
  howItWorks: {
    title: 'Cómo Crear Fichas de Asociación de Sombras en 5 Pasos',
    steps: [
      {
  ...
  keyFeatures: {
    title: 'Características Clave del Generador de Fichas de Asociación de Sombras',
    features: [
      {
  ...
  businessUseCases: {
    title: 'Cómo Vender Fichas de Asociación de Sombras en Línea',
    cases: [
      {
