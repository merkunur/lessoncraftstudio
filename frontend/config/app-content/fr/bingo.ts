...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Générateur de cartes de loto | LessonCraftStudio',
  ...
  hero: {
    title: 'Générateur de cartes de loto — Créez des imprimables à vendre sur Etsy & KDP',
  ...
  ctaHeading: 'Créer des cartes de loto',
