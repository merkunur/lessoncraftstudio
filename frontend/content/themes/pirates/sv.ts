...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Pirater',
  title: 'Gratis Pirater-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara pirater-övningar för barn. Matematik, målarbilder, ordspel och pussel med piratertema. Förskola till årskurs 3. Gratis PDF. Skriv ut direkt.',
  keywords: 'piratövningar barn, pirat arbetsblad, pirat målarbilder, pirat matematik, pirat förskola, pirat utskrivbar, pirat pussel, pirat räkning, pirat korsord, piratäventyr, skattjaktslekar',
  heading: 'Piratövningar och Arbetsblad',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Pirater-övningar Förskola | LessonCraftStudio',
      ...
      seoKeywords: 'piratövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, skattjakt, kartläsning, sjöäventyr, piratuppgifter förskola, piraternas lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoDescription: 'Utskrivbara piratövningar för förskoleklassbarn (5–6 år). Skatträkning, kartläsning och ordpussel med pirattema. 33 generatorer. Gratis PDF. Gratis PDF.',
      seoKeywords: 'piratövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, skattjakt, kartläsning, sjöäventyr, piratuppgifter förskoleklass, piraternas lärande 5–6 år',
    ...
    'first-grade': {
      ...
      seoDescription: 'Utskrivbara piratövningar för elever i årskurs 1 (6–7 år). Skattjakt med ordproblem, kartläsning och räkning inom 20. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'piratövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, skattjakt, kartläsning, sjöäventyr, piratuppgifter årskurs 1, piraternas lärande 6–7 år',
    ...
    'second-grade': {
      ...
      seoDescription: 'Utskrivbara pirater-övningar för årskurs 2 (7–8 år). Multiplikation, ordspel, logik och problemlösning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'piratövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, skattjakt, kartläsning, sjöäventyr, piratuppgifter årskurs 2, piraternas lärande 7–8 år',
    ...
    'third-grade': {
      ...
      seoDescription: 'Utskrivbara pirater-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'piratövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, skattjakt, kartläsning, sjöäventyr, piratuppgifter årskurs 3, piraternas lärande 8–9 år',
