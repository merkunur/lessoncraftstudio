...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          `Abre el panel de Configuración de Página y elige un tamaño: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Ficha por defecto (800×1000) o Cuadrado (1200×1200). Selecciona un color de fondo, elige un tema decorativo de la biblioteca de imágenes y ajusta la opacidad para mantener la cuadrícula del puzzle legible. Añade un marco de borde a juego para darle a tus fichas un aspecto profesional y pulido.`,
      },
      {
        title: 'Configura la cuadrícula y la operación matemática',
        description:
          `Abre el panel de Configuración del Puzzle y establece el número de filas (2–4) y columnas (2–4) para determinar cuántas piezas forman el puzzle — desde una sencilla cuadrícula 2×2 con 4 piezas hasta una desafiante 4×4 con 16 piezas. Selecciona la operación: Suma genera problemas donde dos números suman el valor de la pieza, Resta crea problemas donde un número menos otro equivale a la solución, y el modo Suma y Resta mixto mezcla ambas operaciones en toda la cuadrícula. Las soluciones son una secuencia desordenada de 2 a N (donde N es el total de piezas), garantizando que cada respuesta sea única.`,
      },
      {
        title: 'Elige una imagen de la biblioteca temática',
        description:
          `Abre el panel de Biblioteca de Imágenes y explora 104 temas — desde animales y comida hasta vehículos y festividades. Usa la barra de búsqueda para encontrar imágenes al instante. Selecciona la imagen que quieres como imagen del puzzle; el generador la divide automáticamente en las celdas de la cuadrícula que configuraste. También puedes subir tus propias imágenes personalizadas para crear puzzles completamente únicos que se ajusten a tu marca, tema de clase o línea de productos de temporada.`,
      },
      {
      ...
      },
      {
        ...
        description:
          `Cambia a la pestaña Clave de Respuesta y haz clic en Generar Clave de Respuesta para crear una versión resuelta del puzzle mostrando la cuadrícula completada con los problemas resueltos junto a la imagen ensamblada. Exporta tanto la ficha como la clave de respuesta en JPEG de alta resolución o PDF listo para imprimir. Activa el modo escala de grises para versiones que ahorran tinta. Cada exportación se renderiza a más de 400 DPI para que tus puzzles se vean nítidos ya sea impresos en casa, subidos a Etsy o incluidos en un cuaderno de actividades de Amazon KDP.`,
      },
    ],
  },
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          `Compila de 50 a 100 fichas de puzzles matemáticos en un cuaderno de actividades impreso con formato para Amazon KDP. Usa dificultad progresiva — comienza con puzzles 2×2 solo de suma y avanza hasta cuadrículas 4×4 con operaciones mixtas — para crear un recorrido de aprendizaje estructurado que mantenga a los niños comprometidos a lo largo de decenas de páginas. Añade una portada, instrucciones que expliquen el formato del puzzle y una sección de claves de respuesta al final. Los cuadernos de puzzles matemáticos ocupan un nicho menos saturado que los cuadernos de fichas estándar, dándote una ventaja competitiva. Considera publicar volúmenes separados para cada grado o tipo de operación, ya que los títulos específicos se posicionan mejor en los resultados de búsqueda de Amazon.`,
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        `Sí, cada puzzle usa una imagen que se divide en celdas de la cuadrícula. Puedes seleccionar cualquier imagen de la biblioteca integrada de más de 3100 ilustraciones en 104 temas, o subir tu propia imagen personalizada. El generador se encarga de la división automáticamente según las dimensiones de cuadrícula elegidas.`,
    },
    {
    ...
    },
    {
      ...
      answer:
        `No. Las fichas de puzzles matemáticos son completamente visuales — el contenido usa imágenes y números, no palabras. Un puzzle creado en cualquier configuración de idioma funciona en todo el mundo. La opción de idioma solo cambia las etiquetas de la interfaz de la aplicación, no el contenido de la ficha en sí, haciendo que tus productos sean vendibles instantáneamente en cualquier mercado.`,
    },
    {
    ...
    },
    {
      ...
      answer:
        `Como la prueba gratis te da acceso a todas las funciones, no ofrecemos reembolsos en las compras de licencia comercial. Puedes probar cada operación, cada tamaño de cuadrícula, cada tema y cada formato de exportación antes de comprar. La prueba gratis es la política de reembolso — asegúrate de que la herramienta se ajusta a tus necesidades antes de adquirir una licencia.`,
    },
  ],
