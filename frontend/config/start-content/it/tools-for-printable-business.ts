...
const content: StartContent = {
  ...
  actionSteps: [
    ...
    },
    {
      ...
      description: "Scegli una piattaforma per iniziare: Etsy per i download digitali, Amazon KDP per i libri di attività o Gumroad per le prodotti stampabili. Crea il tuo account venditore e familiarizza con il processo di inserzione prima di caricare prodotti.",
    },
    {
    ...
    },
    {
      ...
      description: "Adatta i tuoi prodotti esistenti per una seconda piattaforma di vendita. I download digitali Etsy possono diventare tascabili KDP. I contenuti KDP possono diventare risorse Gumroad. Stessi strumenti di produzione, nuovo pubblico, flusso di entrate aggiuntivo.",
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "Sì. Ogni generatore produce output PDF indipendente dalla piattaforma. Le stesse schede possono essere pubblicate come download digitali Etsy, formattate in tascabili Amazon KDP, caricate su Gumroad o vendute su Gumroad e sul tuo sito web. Uno strumento di produzione, più piattaforme di vendita, più flussi di entrate.",
    },
    {
