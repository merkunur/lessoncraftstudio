...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Mehr-oder-Weniger-Generator | LessonCraftStudio',
  ...
  hero: {
    title: 'Mehr-oder-Weniger-Generator — Druckvorlagen für Etsy & KDP erstellen',
