...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'vender fichas de práctica de escritura en Teachers Pay Teachers',
    ...
    metaDescription:
      'Crea fichas escritura para Etsy, KDP y TPT. 3 modos progresivos, 5 fuentes, flechas de trazos, trazado progresivo, 104 temas. Prueba gratis con marca de agua.',
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Cada ficha de escritura se construye fila por fila, y cada fila tiene sus propios ajustes independientes. Para cada fila, selecciona uno de los tres modos de práctica: Trazado proporciona contornos de letras sólidos que los alumnos trazan directamente, Trazado Progresivo comienza con letras sólidas que se desvanecen progresivamente a lo largo de la fila para desarrollar la autonomía, y Copia Guiada muestra un contorno tenue que los alumnos reproducen al lado. Combina los tres modos en una sola ficha para crear dificultad progresiva de arriba hacia abajo — traza las letras nuevas arriba, practica las letras con opacidad decreciente en el medio y prueba la copia guiada abajo.',
      },
      {
        title: 'Selecciona el estilo de fuente y la fuente de contenido',
        description:
          'Elige entre cinco estilos de fuente por fila: Imprenta Regular para escritura de molde estándar, Imprenta Regular con Flechas con flechas numeradas direccionales que muestran el orden exacto de los trazos, Imprenta de Trazado para letras punteadas diseñadas para la práctica de trazado, Imprenta de Trazado con Flechas combinando contornos punteados con flechas del orden de los trazos, y Cursiva (Great Vibes) para la práctica de escritura cursiva. Luego define la fuente de contenido: el modo Biblioteca de Imágenes usa Letra Inicial (primera letra del nombre de una imagen) o Nombre Completo (palabra entera) de 104 colecciones temáticas. El modo Texto Personalizado te permite escribir cualquier palabra, frase u oración. El modo Vacío crea líneas pautadas en blanco para escritura libre.',
      },
      {
        title: 'Configura las mayúsculas, los trazos de pre-escritura y el texto decorativo',
        description:
          'Define el uso de mayúsculas para cada fila: mayúsculas, minúsculas o tipo título. Para las filas en Texto Personalizado, activa los ejercicios de trazos de pre-escritura — líneas verticales, líneas horizontales, círculos o líneas en zigzag — para añadir calentamientos de motricidad fina antes de la práctica de letras. Ajusta la altura de fila para controlar el espaciado entre líneas. Usa el panel de Herramientas de Texto para añadir un título a la ficha, campos de nombre y fecha del alumno o instrucciones con siete fuentes, incluyendo Lexend Deca, Baloo 2, Fredoka y Quicksand. Arrastra, redimensiona y reposiciona cada elemento en el lienzo completo Fabric.js.',
      },
      {
        title: 'Descarga como JPEG o PDF',
        description:
          'Abre el menú de Descarga y exporta tu ficha de escritura como JPEG de alta resolución o PDF listo para imprimir. El motor de exportación renderiza a escala 6× (~300 DPI) para que las letras y las líneas guía se impriman nítidas y limpias. Activa la exportación en escala de grises para versiones económicas en tinta ideales para impresión en el aula. No hay clave de respuesta para las fichas de escritura — los modos de práctica en sí mismos sirven como guía. Cada exportación está lista para producción: listados de Etsy, interiores de Amazon KDP y archivos de productos TPT.',
      },
    ],
  },
    ...
    features: [
      {
        ...
        description:
          'Los tres modos de práctica crean una progresión de aprendizaje natural en una sola ficha. El modo Trazado proporciona contornos de letras sólidos que los alumnos siguen directamente — soporte visual completo para letras nuevas o desconocidas. El Trazado Progresivo comienza con letras sólidas en el lado izquierdo de la fila y reduce progresivamente su visibilidad hacia la derecha, reforzando la confianza a medida que los alumnos dependen menos de la guía con cada repetición. La Copia Guiada muestra solo un contorno tenue, exigiendo una formación de letras casi autónoma con soporte visual mínimo. Esta progresión de trazado a copia reproduce las metodologías probadas de enseñanza de la escritura y ofrece a los vendedores un eje de diferenciación integrado para paquetes de productos por niveles.',
      },
      {
        title: 'Orden de los trazos guiado por flechas para la formación correcta de letras',
        description:
          'Los estilos Imprenta Regular con Flechas e Imprenta de Trazado con Flechas superponen flechas direccionales numeradas en cada letra, mostrando a los alumnos exactamente cómo formar cada trazo en la secuencia correcta. La flecha 1 indica dónde empezar, la flecha 2 muestra el siguiente trazo, y así sucesivamente — eliminando toda incertidumbre sobre la dirección y el orden de los trazos. Esta función es única entre los generadores de escritura: los alumnos aprenden no solo cómo se ve la letra, sino precisamente cómo trazarla. Las fichas con orden de trazos flechado alcanzan precios premium en TPT y Etsy porque enseñan la técnica correcta en lugar de simplemente proporcionar líneas para trazar.',
      },
      {
        title: 'Cinco estilos de fuente incluyendo imprenta y cursiva',
        description:
          'Elige entre cinco estilos de fuente distintos por fila: Imprenta Regular para letras de molde estándar, Imprenta Regular con Flechas con guías de orden de trazos numerados, Imprenta de Trazado para letras punteadas diseñadas para la práctica de trazado, Imprenta de Trazado con Flechas combinando contornos punteados con flechas del orden de los trazos, y Cursiva (Great Vibes) para la práctica de escritura cursiva. Cada estilo corresponde a una etapa diferente del desarrollo de la escritura. Combina varios estilos de fuente en una sola ficha — letras con flechas arriba para instrucción, letras de trazado en el medio para práctica e imprenta regular abajo como referencia.',
      },
      {
        title: 'Ejercicios de trazos de pre-escritura para el desarrollo de la motricidad fina',
        description:
          'Antes de abordar la formación de letras, los trazos de pre-escritura desarrollan las habilidades motrices fundamentales necesarias para la escritura. Cuatro tipos de trazos están disponibles: líneas verticales (trazos de arriba hacia abajo), líneas horizontales (barridos de izquierda a derecha), círculos (control de curva continua) y líneas en zigzag (práctica de cambios de dirección). Estos ejercicios fortalecen la coordinación ojo-mano, el agarre del lápiz y los movimientos musculares específicos usados en la escritura. Los paquetes de pre-escritura orientados al desarrollo de la motricidad fina constituyen un nicho de producto diferenciado en Etsy y TPT, separado de las fichas de trazado de letras.',
      },
      {
        title: 'Independencia por fila para fichas de modos combinados',
        description:
          'Cada fila de la ficha funciona de forma independiente: su propio modo de práctica, estilo de fuente, fuente de contenido y configuración de mayúsculas. Esto significa que una sola ficha puede combinar el modo Trazado con fuente Imprenta con Flechas para una letra nueva, Trazado Progresivo con Imprenta de Trazado para una letra practicada, y Copia Guiada con Cursiva para una letra de repaso — verdadera diferenciación en una sola página. La independencia por fila te permite crear fichas que progresan de la práctica asistida a la escritura autónoma sin cambiar de página, y da a los vendedores la flexibilidad de diseñar diseños únicos que se distinguen de los competidores basados en plantillas.',
      },
      {
        title: 'Integración de la Biblioteca de Imágenes con 104 colecciones temáticas',
        description:
          'Accede a más de 3100 ilustraciones en 104 colecciones temáticas — animales, comida, vehículos, naturaleza, profesiones y docenas más. En el modo Letra Inicial, los alumnos practican escribir la primera letra de cada nombre de imagen con la imagen como referencia visual. En el modo Nombre Completo, los alumnos escriben la palabra entera, conectando la práctica de escritura con el enriquecimiento del vocabulario. La integración de imágenes temáticas hace que las fichas de escritura sean más atractivas que las páginas de práctica en blanco y crea oportunidades naturales de agrupación por tema (animales de granja, criaturas marinas, dinosaurios) para los listados en plataformas de venta.',
      },
      {
        title: 'Exportación PDF y JPEG lista para imprimir a alta resolución',
        description:
          'Descarga fichas como imágenes JPEG de alta resolución o documentos PDF listos para imprimir. El motor de exportación renderiza con un multiplicador 6×, produciendo ~300 DPI en tamaños de página estándar — esencial para fichas de escritura donde las líneas guía finas y los detalles de las letras deben imprimirse de forma nítida. Los formatos Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal y dimensiones personalizadas están todos soportados. Activa la exportación en escala de grises para versiones económicas en tinta ideales para impresión en el aula o cuadernos en blanco y negro. Cada exportación está lista para producción: listados de Etsy, interiores de Amazon KDP y archivos de productos TPT.',
      },
      {
        title: 'Edición completa del lienzo con herramientas de texto y decoración',
        description:
          'El lienzo Fabric.js integrado te permite arrastrar, redimensionar, rotar y reposicionar cada elemento de la página — texto, filas de práctica, imágenes, bordes y fondos. Añade texto personalizado con siete fuentes, incluyendo Lexend Deca, Baloo 2, Nunito, Quicksand y Fredoka. Ajusta el tamaño de fuente, el color y el contorno para máxima legibilidad. Los controles de capas gestionan el orden de apilamiento, el bloqueo/desbloqueo protege los elementos terminados mientras editas otros, y las herramientas de alineación colocan los elementos en posición. El sistema de tres líneas guía (línea superior, línea media punteada, línea inferior) mantiene las filas de escritura correctamente formateadas al organizar tu diseño.',
      },
    ],
  },
  ...
  faq: [
    {
      question: '¿Cuáles son los tres modos de práctica y cómo funcionan?',
      answer:
        'El modo Trazado proporciona contornos de letras sólidos que los alumnos trazan directamente — soporte visual completo para aprender letras nuevas. El Trazado Progresivo comienza con letras sólidas en el lado izquierdo de la fila y las desvanece progresivamente hacia la derecha, permitiendo a los alumnos pasar del trazado a la escritura autónoma dentro de una sola fila. La Copia Guiada muestra un contorno tenue de cada letra que los alumnos reproducen al lado con asistencia visual mínima. Estos tres modos crean una progresión natural del soporte completo a la escritura autónoma, y puedes combinar los tres en una sola ficha gracias a la independencia por fila.',
    },
    {
      question: '¿Cuáles son los cinco estilos de fuente y cuándo usar cada uno?',
      answer:
        'Imprenta Regular proporciona letras de molde estándar para la práctica general de escritura. Imprenta Regular con Flechas añade flechas direccionales numeradas mostrando el orden exacto de los trazos — ideal para introducir letras nuevas. Imprenta de Trazado muestra letras con contornos punteados diseñadas específicamente para ejercicios de trazado. Imprenta de Trazado con Flechas combina los contornos punteados con flechas del orden de los trazos para trazado guiado con instrucción de formación. Cursiva (Great Vibes) proporciona letras de escritura cursiva para la práctica de caligrafía cursiva. Cada fuente corresponde a un objetivo pedagógico diferente, y puedes combinar varias fuentes en una sola ficha.',
    },
    {
      question: '¿Cómo funciona el orden de los trazos guiado por flechas?',
      answer:
        'Los estilos Imprenta Regular con Flechas e Imprenta de Trazado con Flechas superponen flechas direccionales numeradas en cada letra. La flecha 1 muestra dónde empezar el primer trazo y en qué dirección moverse, la flecha 2 indica el segundo trazo, y así sucesivamente. Las flechas enseñan a los alumnos la secuencia correcta de formación de cada letra — no solo cómo se ve la letra, sino precisamente cómo trazarla con el orden y la dirección de trazos correctos. Esto transforma una simple ficha de trazado en una herramienta de instrucción.',
    },
    {
      question: '¿Cómo funciona el modo Trazado Progresivo?',
      answer:
        'El modo Trazado Progresivo comienza cada fila con letras completamente visibles y sólidas en el lado izquierdo y reduce progresivamente la opacidad de cada letra sucesiva a medida que la fila continúa hacia la derecha. Al final de la fila, las letras son apenas visibles o han desaparecido por completo. Este desvanecimiento gradual refuerza la confianza del alumno al reducir el soporte visual de forma incremental — cada repetición requiere un poco más de memoria autónoma que la anterior. Sirve como puente entre el trazado completo y la escritura autónoma.',
    },
    {
      question: '¿Qué son los trazos de pre-escritura y para quién son?',
      answer:
        'Los trazos de pre-escritura son ejercicios de líneas básicas que desarrollan el control motor fino necesario para la escritura: líneas verticales (trazos de arriba hacia abajo), líneas horizontales (barridos de izquierda a derecha), círculos (práctica de curva continua) y líneas en zigzag (control de cambios de dirección). Estos ejercicios apuntan a alumnos que aún no están preparados para la formación de letras — desarrollan la fuerza del agarre del lápiz, la coordinación ojo-mano y los movimientos musculares específicos usados en la escritura. Los trazos de pre-escritura están disponibles en el modo Texto Personalizado.',
    },
    {
    ...
    {
      question: '¿Cuáles son las opciones de fuente de contenido para cada fila?',
      answer:
        'Cuatro fuentes de contenido están disponibles por fila. Biblioteca de Imágenes — el modo Letra Inicial practica la primera letra de cada nombre de imagen con la imagen como referencia visual. Biblioteca de Imágenes — el modo Nombre Completo escribe la palabra entera. El modo Texto Personalizado te permite escribir cualquier palabra, frase u oración para la fila. El modo Vacío crea líneas pautadas en blanco con el sistema de tres líneas guía para la práctica de escritura libre.',
    },
    {
      question: '¿Por qué no hay clave de respuesta para las fichas de escritura?',
      answer:
        'Las fichas de escritura son ejercicios de práctica, no puzzles con soluciones correctas o incorrectas. Los modos Trazado y Trazado Progresivo en sí mismos sirven como guía — los alumnos trazan directamente sobre o al lado de las formas de letras proporcionadas. No hay ninguna respuesta oculta que revelar. La ficha ES la referencia. Esto es diferente de los generadores basados en puzzles como la Sopa de Letras o el Criptograma, donde una clave de respuesta muestra la solución que los alumnos no podían ver durante el ejercicio.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'generador-fichas-escritura',
      anchorText: 'Creador de Fichas de Escritura',
    },
    {
      pageType: 'start',
