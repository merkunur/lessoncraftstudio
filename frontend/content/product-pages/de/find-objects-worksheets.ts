...
export const findObjectsDeContent: ProductPageContent = {
  ...
  seo: {
    ...
    appId: 'find-objects',
    title: 'Suchbilder Arbeitsblätter | Kostenlose Vorschul-Arbeitsblätter Generator',
    ...
    items: [
      {
        ...
        answerKeySrc: '/samples/german/find-objects/sample-1-answer.jpeg',
        altText: 'Suchbilder Arbeitsblätter Grundschule kostenlos - Ich-Sehe-Was Aktivität für Vorschulkinder',
        pdfDownloadUrl: '/samples/german/find-objects/sample-1.pdf',
      },
      {
        id: '2',
        worksheetSrc: '/samples/german/find-objects/sample-2.jpeg',
        answerKeySrc: '/samples/german/find-objects/sample-2-answer.jpeg',
        altText: 'Kostenlose Arbeitsblätter Suchbilder - Welches-Passt-Nicht Arbeitsblatt für Kinder',
        pdfDownloadUrl: '/samples/german/find-objects/sample-2.pdf',
      },
      {
        id: '3',
        worksheetSrc: '/samples/german/find-objects/sample-3.jpeg',
        answerKeySrc: '/samples/german/find-objects/sample-3-answer.jpeg',
        altText: 'Vorschul-Arbeitsblätter Suchbilder zum Ausdrucken - Kostenloses Arbeitsblatt visuelle Wahrnehmung',
        pdfDownloadUrl: '/samples/german/find-objects/sample-3.pdf',
      },
      {
        id: '4',
        worksheetSrc: '/samples/german/find-objects/sample-4.jpeg',
        answerKeySrc: '/samples/german/find-objects/sample-4-answer.jpeg',
        altText: 'Arbeitsblätter Grundschule Suchbilder Generator - Kostenlose Druckvorlagen für Kindergarten',
        pdfDownloadUrl: '/samples/german/find-objects/sample-4.pdf',
      },
      {
        id: '5',
        worksheetSrc: '/samples/german/find-objects/sample-5.jpeg',
        answerKeySrc: '/samples/german/find-objects/sample-5-answer.jpeg',
        altText: 'Arbeitsblatt für Kinder Suchbilder - Kostenloses Arbeitsblatt Ich-Sehe-Was Grundschule',
        pdfDownloadUrl: '/samples/german/find-objects/sample-5.pdf',
      },
    ],
  },
...
Das Rückgängig-System speichert bis zu 20 Arbeitsschritte. Fehler lassen sich jederzeit korrigieren. Die Zoom-Funktion ermöglicht präzises Arbeiten. Ebenensteuerung bringt Objekte nach vorne oder hinten. Sperren Sie einzelne Objekte gegen versehentliche Änderungen. Diese Bearbeitungswerkzeuge machen Vorschul-Arbeitsblätter professionell. Auch Schwungübungen gelingen mit präziser Positionierung.`,
        highlighted: false,
      },
      {
        id: '3',
...
Der Welches-Passt-Nicht-Modus lässt Kinder 1-3 ungepaarte Bilder unter 8-12 Bildpaaren identifizieren. Beide Modi passen die Schwierigkeit für verschiedene Klassenstufen an. Vorschul-Arbeitsblätter verwenden weniger Objekte mit deutlichen visuellen Unterschieden. Diese Flexibilität macht Mathe-Arbeitsblätter für alle Altersgruppen zugänglich.`,
        highlighted: false,
      },
      {
        id: '9',
    ...
    items: [
      {
        id: '1',
        icon: '👶',
        title: 'Erzieher in der Vorschule - Vorschul-Arbeitsblätter und Schwungübungen für Frühes Lernen',
...
Erstellen Sie kontrastreiche Arbeitsblätter für Schüler mit visuellen Verarbeitungsherausforderungen. Verwenden Sie einfarbige Hintergründe statt thematischer Bilder. Vergrößern Sie versteckte Objekte für Schüler die zusätzliche visuelle Unterstützung benötigen. Kombinieren Sie Suchbilder mit Malvorlagen und kostenlose Arbeitsblätter für sensorische Pausen. Schüler vervollständigen visuelle Unterscheidung dann malen ihr Arbeitsblatt aus. Die Anpassungsoptionen unterstützen diverse Förderbedürfnisse effektiv.`,
      ...
      },
      {
        ...
        description: `Lehrer-Unternehmer generieren passives Einkommen durch Verkauf druckbarer Arbeitsblätter. Die kommerzielle Lizenz deckt alle mit Ihrem Vollzugriff Abonnement erstellten Arbeitsblätter ab. Keine zusätzlichen Gebühren über 240€ jährlich hinaus. Erstellen Sie ganze Produktlinien in Stunden statt Wochen. Viele Verkäufer verdienen 500-5000€ monatlich mit Bildungsdrucksachen.
...
Gestalten Sie thematische Arbeitsblatt-Pakete die mehrere Aktivitätstypen kombinieren. Paketieren Sie Suchbilder mit Arbeitsblätter Grundschule für verschiedene Fähigkeiten. Erstellen Sie saisonale Pakete für Schulanfang, Halloween, Weihnachten und Frühling. Kombinieren Sie Suchbilder mit Einmaleins-Übungen für mathe-thematische Produktlinien. Professionelle 300 DPI Qualität sichert Kundenzufriedenheit für bezahlte Produkte.`,
  ...
  faq: {
    ...
    items: [
      ...
      {
        id: '7',
        question: 'Wie passe ich Einmaleins- und Rechen-Arbeitsblätter für die 1. Klasse an verschiedene Niveaus an?',
  ...
  relatedApps: {
    ...
    items: [
      ...
      },
      {
        ...
        icon: '✍️',
        description: 'Ergänzen Sie Suchbilder mit Schwungübungen für vollständige Vorschul-Arbeitsblätter. Beide Apps trainieren Feinmotorik und visuelle Wahrnehmung.',
      },
      {
        id: '3',
        slug: 'alphabet-train',
      ...
      },
      {
        ...
        category: 'Logik',
        icon: '🔗',
        description: 'Ergänzen Sie Suchbilder mit Vorschul-Arbeitsblätter für Matching-Übungen. Beide trainieren visuelle Unterscheidung.',
      },
      {
        id: '6',
        slug: 'math-puzzle',
