...
const translations = {
  ...
  "fr": {
    ...
    "mathpuzzle.error.no.data": "Aucune donnée de puzzle à afficher. Veuillez d'abord générer une feuille.",
  ...
  "es": {
    ...
    "mathpuzzle.error.no.data": "No hay datos del rompecabezas para mostrar. Por favor, genere primero una hoja.",
  ...
  "pt": {
    ...
    "mathpuzzle.error.no.data": "Nenhum dado do quebra-cabeça para exibir. Por favor, gere primeiro uma planilha.",
  ...
  "nl": {
    ...
    "backgroundOpacity": "Achtergrond-doorschijnendheid:",
    "backgroundTheme": "Achtergrondthema:",
    "borderOpacity": "Rand-doorschijnendheid:",
    ...
    "mathpuzzle.error.no.data": "Geen puzzelgegevens om weer te geven. Genereer eerst een werkblad.",
    ...
    "mathpuzzle.msg.generate.complete": "Puzzel succesvol gegenereerd!",
    "mathpuzzle.msg.generate.content": "Genereer eerst inhoud.",
    "mathpuzzle.msg.generate.first": "Maak eerst een werkblad.",
    "mathpuzzle.msg.generate.worksheet.first": "Maak eerst een werkblad.",
    "mathpuzzle.msg.generating.data": "Puzzelgegevens genereren...",
    "mathpuzzle.msg.generation.error": "Fout bij genereren van puzzel: {error}",
  ...
  "sv": {
    ...
    "mathpuzzle.error.no.data": "Ingen pusseldata att visa. Generera först ett arbetsblad.",
  ...
  "da": {
    ...
    "mathpuzzle.error.no.data": "Ingen puslespildata at vise. Generer først et arbejdsark.",
    ...
    "mathpuzzle.generate": "Generer",
    "mathpuzzle.generate.answer": "Generer facitliste",
    "mathpuzzle.generate.worksheet": "Generer opgaveark",
    ...
    "mathpuzzle.msg.answer.generated": "Facitliste genereret!",
    ...
    "mathpuzzle.msg.generate.complete": "Puslespil genereret!",
    "mathpuzzle.msg.generate.content": "Generer indhold først.",
    "mathpuzzle.msg.generate.first": "Generer et opgaveark først.",
    "mathpuzzle.msg.generate.worksheet.first": "Generer et opgaveark først.",
    "mathpuzzle.msg.generating.data": "Genererer puslespilsdata...",
    "mathpuzzle.msg.generation.error": "Fejl ved generering af puslespil: {error}",
    ...
    "mathpuzzle.msg.rendering.answer": "Genererer facitliste...",
    "mathpuzzle.msg.rendering.worksheet": "Genererer opgaveark...",
    ...
    "mathpuzzle.msg.worksheet.success": "Opgaveark genereret!",
    ...
    "mathpuzzle.text.tools": "Tekstværktøjer",
  ...
  "no": {
    ...
    "mathpuzzle.error.no.data": "Ingen puslespilldata å vise. Vennligst generer et arbeidsark først.",
