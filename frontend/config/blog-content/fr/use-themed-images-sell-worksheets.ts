...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Le visuel attire, le contenu retient',
    description: 'Comment utiliser des images thématiques (animaux, espace, nature) pour augmenter l\'attrait de vos fiches. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour utiliser images thématiques vendre fiches. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
