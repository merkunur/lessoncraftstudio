...
const content: BundleContent = {
  ...
  visuals: {
    ...
    sampleGallery: [
      { src: '/samples/dutch/alphabet train/Alfabet%20Trein%201.webp', alt: 'Alfabet trein werkblad met letter-afbeelding koppeling op treinwagons', caption: 'Alfabet Trein Werkblad' },
      ...
      { src: '/samples/dutch/word guess/Woordraad%201.webp', alt: 'Woordraad werkblad met afbeeldingsaanwijzingen en lettervakjes', caption: 'Woordraad Werkblad' },
      { src: '/samples/dutch/word scramble/Woordscramble%201.webp', alt: 'Woordscramble werkblad met kleurgecodeerde lettertegels', caption: 'Woordscramble Werkblad' },
      ...
      { src: '/samples/dutch/cryptogram/Cryptogram%201.webp', alt: 'Cryptogram puzzel met afbeeldingscijfer codering', caption: 'Cryptogram Werkblad' },
      { src: '/samples/dutch/writing/Schrijfoefeningen%201.webp', alt: 'Schrijfoefeningen werkblad met begeleide letterstreken', caption: 'Schrijfoefeningen Werkblad' },
    ],
