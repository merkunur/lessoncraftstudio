...
import { generateLocalizedAltText } from '@/lib/localized-seo-templates';
 ...
 * Uses shared localized templates for proper per-locale alt text
 */
function generateDefaultAltText(appId: string, locale: string, index: number): string {
  ...
  return generateLocalizedAltText(appName, locale, index + 1);
}
...
export default function SampleGallery({
  ...
  return (
    <section id="samples-gallery" className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Section header */}
        <div className="text-center mb-16 gallery-fade-in-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-sm font-medium text-blue-200 mb-6 gallery-fade-in-scale">
          ...
          {samplesWithPdf > 0 && (
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/20 border border-emerald-400/30 text-emerald-300 gallery-fade-in">
        ...
        {/* Main Preview Area */}
        <div className="relative max-w-4xl mx-auto gallery-fade-in-up-delay">
          ...
          <div className="relative mt-8 gallery-fade-in-up-delay-2">
            {/* Scroll-fade left */}
            {canScrollLeft && (
