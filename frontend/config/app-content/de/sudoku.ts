...
const content: AppContent = {
  seo: {
    primaryKeyword: 'Bilder-Sudoku-Arbeitsblätter erstellen und verkaufen',
    secondaryKeywords: [
    ...
    lsiKeywords: [
      'digitale Bilder-Sudoku-Druckvorlagen passives Einkommen',
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Bilder-Sudoku-Arbeitsblatt-Ersteller',
    },
    {
      pageType: 'start',
