...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'printable filformater PDF JPEG guide',
    ...
    titleTag: 'Filformater for Printables: PDF vs. JPEG Guide | LessonCraftStudio',
  ...
  cta: {
    heading: 'Kom I Gang Med Filformater for Printables',
