...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'vender fichas de reconhecimento de padrões no Teachers Pay Teachers',
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Selecione um dos cinco tipos de padrões repetitivos no painel Conteúdo. AB alterna dois elementos (A-B-A-B-A-B) para as sequências mais simples. AAB agrupa dois de um elemento seguido de um de outro (A-A-B-A-A-B). ABB inverte esse agrupamento (A-B-B-A-B-B). ABC rota três elementos diferentes (A-B-C-A-B-C) para uma identificação mais complexa. AABB emparelha dois de cada antes de repetir (A-A-B-B-A-A-B-B). Cada tipo foca um nível diferente de competência de reconhecimento de padrões — desde a alternância simples de dois elementos até sequências de múltiplos elementos.',
      },
      {
        title: 'Configure o número de pistas e os campos nome/data',
        description:
          'Defina o número de pistas visíveis de 4 a 10 para controlar a dificuldade da ficha. Os 3 primeiros vagões são sempre mostrados, e o vagão em falta é colocado dinamicamente entre as posições restantes. Mostrar 10 pistas deixa apenas um vagão em branco entre 10 visíveis — o padrão é muito evidente, ideal para principiantes. Mostrar apenas 4 pistas obriga os alunos a identificar o padrão a partir de informação mínima — um verdadeiro desafio de raciocínio. Ative os campos opcionais de nome e data recortáveis para a identificação dos alunos nas fichas impressas.',
      },
      {
    ...
    features: [
      {
        ...
        description:
          'Os padrões são apresentados num trem temático com 11 vagões dispostos em três filas (5 em cima, 3 centro-esquerda, 3 centro-direita). Cada vagão contém uma imagem da sequência repetitiva, criando um formato visualmente atrativo que se distingue das fichas de padrões em grelha padrão. A disposição em trem confere aos produtos um aspeto distintivo nas listagens das plataformas — os compradores que navegam na Etsy ou no TPT veem imediatamente algo diferente dos exercícios típicos em linhas e colunas. A ilustração temática do trem acrescenta valor de produção que justifica preços premium.',
      },
      {
        title: 'Cinco tipos de padrões repetitivos para dificuldade progressiva',
        description:
          'Cinco tipos de padrões cobrem todo o espetro de complexidade de sequências repetitivas. AB alterna dois elementos no padrão mais simples possível. AAB e ABB introduzem agrupamentos assimétricos onde um elemento aparece duas vezes antes ou depois do outro. ABC rota três elementos diferentes, obrigando os alunos a acompanhar uma unidade de repetição mais longa. AABB emparelha dois de cada elemento num ciclo alargado. Esta progressão cria uma escala de dificuldade natural desde a alternância simples no pré-escolar até sequências avançadas de múltiplos elementos — oferecendo aos vendedores um eixo de diferenciação integrado para pacotes de produtos por níveis.',
      },
      {
        title: 'Número de pistas ajustável de 4 a 10 para controlo de dificuldade',
        description:
          'O controlo do número de pistas determina quantas das 11 posições de vagões mostram imagens face à única posição em branco. Os 3 primeiros vagões são sempre revelados, estabelecendo a base do padrão. Com 10 pistas, apenas um vagão está em branco entre 10 elementos visíveis — o padrão é muito evidente. Com 4 pistas, os alunos veem informação mínima e devem raciocinar cuidadosamente para identificar a sequência a partir de dados limitados. Esta única definição cria uma ampla gama de dificuldade a partir de cada tipo de padrão, multiplicando efetivamente a variedade dos seus produtos: um padrão AB com 10 pistas é ideal para principiantes, enquanto um padrão ABC com 4 pistas desafia os alunos avançados.',
      },
      {
        title: 'Posição do vagão em falta dinâmica com colocação inteligente',
        description:
          'A posição do vagão em branco é selecionada dinamicamente entre as posições 3 a 10 conforme o número de pistas configurado, garantindo que o elemento em falta caia sempre dentro da secção repetitiva do padrão e não no início óbvio. As 3 primeiras posições estão sempre preenchidas para estabelecer visualmente o padrão antes de apresentar o desafio. Esta colocação inteligente cria puzzles justos e resolúveis de cada vez — os alunos têm contexto suficiente para identificar o padrão antes de encontrar o vagão em branco. O posicionamento dinâmico também significa que duas fichas com o mesmo tipo de padrão podem ter posições diferentes do vagão em falta, acrescentando variedade natural aos pacotes de produtos.',
      },
      {
        title: 'Biblioteca de Imagens com 104 coleções temáticas',
        description:
          'Aceda a mais de 3100 ilustrações em 104 coleções temáticas — animais, alimentos, veículos, natureza, profissões, festividades e dezenas mais. Cada tema fornece um conjunto coordenado de imagens que ficam coerentes nos vagões do trem. A Licença Comercial inclui 10 temas coloridos para começar; o Acesso Completo desbloqueia os 104 temas para máxima variedade de produtos. A biblioteca temática cria oportunidades naturais de agrupamento: trens de padrões de animais da quinta, sequências de criaturas marinhas, reconhecimento de padrões de dinossauros — cada tema torna-se numa listagem de produto distinta com apelo visual imediato.',
      },
      {
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          'Compile de 60 a 100 exercícios de trens de padrões num caderno impresso em formato Amazon KDP. Estruture o livro como uma progressão de complexidade de padrões: o Capítulo 1 cobre padrões AB com muitas pistas, o Capítulo 2 introduz AAB e ABB, o Capítulo 3 avança para padrões ABC de três elementos, o Capítulo 4 apresenta as sequências alargadas AABB, e o Capítulo 5 reduz o número de pistas em todos os tipos de padrões para as páginas de desafio. O formato totalmente visual com imagens nos vagões e zero texto não necessita de tradução para os mercados KDP internacionais — publique o mesmo interior em todos os países. Os cadernos de trens de padrões ocupam um nicho específico de matemática precoce com procura constante ao longo do ano.',
        platform: 'Amazon KDP (kdp.amazon.com)',
      },
      {
        title: 'Centros diferenciados de matemática e reconhecimento visual para TPT',
        description:
          'Construa conjuntos de prática de reconhecimento de padrões por níveis usando a complexidade do padrão como eixo de diferenciação: Nível 1 (padrões AB, 8–10 pistas), Nível 2 (padrões AAB/ABB, 6–8 pistas), Nível 3 (padrões ABC, 5–6 pistas) e Nível 4 (padrões AABB, 4–5 pistas). Cada nível foca uma exigência cognitiva diferente — desde reconhecer a alternância simples até identificar sequências complexas de múltiplos elementos a partir de informação limitada. O formato em vagões de trem cria um tema visual atrativo que funciona como atividade de centro na sala de aula. Acompanhe cada nível com exercícios temáticos e gabaritos separados para conveniência do professor.',
      ...
      },
      {
        ...
        description:
          'Carregue imagens personalizadas para criar fichas trem de padrões adaptadas a qualquer disciplina ou unidade — use etapas de crescimento de plantas para uma aula de ciências, imagens de artefactos históricos para ciências sociais, ou símbolos de notas musicais para uma aula de música. Os cinco tipos de padrões permitem-lhe adaptar o exercício ao objetivo de aprendizagem: AB para a introdução, ABC e AABB para a avaliação. Ajuste o número de pistas conforme o nível de cada aluno — mais pistas para os alunos com dificuldades, menos para os avançados. Imprima séries personalizadas em minutos para grupos pequenos ou turmas inteiras. O separador de gabarito separado poupa tempo de correção, e o formato visual em trem atrai os alunos que consideram as fichas em grelha monótonas.',
  ...
  faq: [
    {
      question: 'Quais são os cinco tipos de padrões e como se diferenciam?',
      answer:
        'AB alterna dois elementos (A-B-A-B) para o padrão repetitivo mais simples. AAB agrupa dois de um elemento seguido de um de outro (A-A-B-A-A-B). ABB inverte esse agrupamento (A-B-B-A-B-B). ABC rota três elementos diferentes (A-B-C-A-B-C), obrigando os alunos a acompanhar uma unidade de repetição mais longa. AABB emparelha dois de cada elemento (A-A-B-B-A-A-B-B) num ciclo alargado. A progressão de AB a AABB cria uma escala de dificuldade natural desde a alternância simples de dois elementos até sequências complexas de múltiplos elementos.',
    },
    {
      question: 'Como é que o número de pistas controla a dificuldade?',
      answer:
        'O número de pistas determina quantos dos 11 vagões do trem mostram imagens. Os 3 primeiros vagões são sempre visíveis para estabelecer o padrão. Com 10 pistas, apenas um vagão está em branco entre 10 preenchidos — o padrão é muito evidente. Com 4 pistas, os alunos veem informação mínima e devem raciocinar cuidadosamente para identificar a sequência. Esta única definição transforma qualquer tipo de padrão de um exercício simples num verdadeiro desafio de raciocínio, multiplicando efetivamente a variedade de produtos a partir de cada tipo de padrão.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Sim. Pode aceder a todas as funcionalidades — os cinco tipos de padrões, o número de pistas ajustável, a biblioteca de imagens, a geração de gabarito e todos os formatos de exportação — sem criar uma conta, inserir cartão de crédito ou instalar qualquer software. Os downloads do teste grátis incluem uma pequena marca d\'água. Uma licença comercial remove a marca d\'água e concede direitos completos de venda.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Sim. Com uma licença comercial, tem todos os direitos para vender as suas fichas trem de padrões como downloads digitais na Etsy, como cadernos impressos na Amazon KDP, como recursos educativos no TPT ou através de qualquer outro canal de venda. Os cinco tipos de padrões, o número de pistas ajustável e o formato único em vagões de trem oferecem-lhe uma forte diferenciação e vendibilidade global nas categorias das plataformas de venda.',
    },
    {
      question: 'Qual é a política de reembolso?',
      answer:
        'Como o teste grátis lhe dá acesso a todas as funcionalidades, não oferecemos reembolsos em compras de licenças comerciais. Pode testar cada tipo de padrão, cada definição de número de pistas, cada tema, cada formato de exportação e cada tamanho de página antes de comprar. O teste grátis é a política de reembolso — certifique-se de que a ferramenta se adequa às suas necessidades antes de adquirir uma licença.',
    },
  ],
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'gerador-trem-padroes',
      anchorText: 'Criador de Fichas Trem de Padrões',
    },
    {
      pageType: 'start',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Ficha trem de padrões com vagões temáticos mostrando um padrão repetitivo AB com um vagão em branco para os alunos completarem',
    },
    sampleGallery: [
      {
