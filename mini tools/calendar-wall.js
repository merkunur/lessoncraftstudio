...
(function () {
  ...
  var CalendarWall = {
    ...
    instruction: {en:"The month your class can point at: every date visible, the school days counted, and the days that matter marked.",de:"Der Morgenkreis zum Anfassen: Datum, Schultage und das Wetter von heute — alles an einer Tafel.",fr:"Les rituels du matin, vivants : la date, les jours d’école et la météo du jour — tout sur un seul affichage.",it:"La routine del calendario, dal vivo: la data, i giorni di scuola e il tempo che fa oggi — tutto davanti alla classe.",es:"La rutina de la mañana completa: la fecha, los días de escuela y el clima de hoy — todo en una sola pantalla.",pt:"A rodinha da manhã ganha vida: a data, os dias de aula e o tempo de hoje — tudo em um só mural.",nl:"De dagopening op het digibord: de datum, de schooldagen en het weer van vandaag — alles op één bord.",sv:"Samlingen, fast levande: datumet, skoldagarna och dagens väder — allt på ett och samma ställe.",da:"Jeres morgensamling — lyslevende: datoen, skoledagene og dagens vejr, samlet på én væg.",no:"Samlingsstunden, levende: datoen, skoledagene og været i dag — alt på én vegg.",fi:"Aamupiiri herää eloon: päivämäärä, koulupäivät ja tämän päivän sää — kaikki yhdellä seinällä."},
    ...
    teacherKey: {en:"Teacher: mark days",de:"Lehrkraft: Tage markieren",fr:"Enseignant·e : marquer des jours",it:"Insegnante: segna i giorni",es:"Docente: marcar días",pt:"Professor(a): marcar dias",nl:"Leerkracht: dagen markeren",sv:"Lärare: markera dagar",da:"Lærer: markér dage",no:"Lærer: merk dager",fi:"Opettaja: merkitse päiviä"},
    teacherOn: {en:"Marking is on",de:"Markieren ist an",fr:"Marquage activé",it:"Segnatura attiva",es:"Marcado activado",pt:"Marcação ativada",nl:"Markeren staat aan",sv:"Markering på",da:"Markering til",no:"Merking på",fi:"Merkintä päällä"},
    daySheet: {en:"What is on this day",de:"Was an diesem Tag ist",fr:"Ce qu’il y a ce jour-là",it:"Cosa c’è in questo giorno",es:"Qué hay este día",pt:"O que há neste dia",nl:"Wat er op deze dag is",sv:"Vad som händer den här dagen",da:"Hvad der sker denne dag",no:"Hva som skjer denne dagen",fi:"Mitä tänä päivänä on"},
    addMark: {en:"Add a mark",de:"Markierung hinzufügen",fr:"Ajouter un repère",it:"Aggiungi un segno",es:"Añadir una marca",pt:"Adicionar uma marca",nl:"Een markering toevoegen",sv:"Lägg till en markering",da:"Tilføj en markering",no:"Legg til et merke",fi:"Lisää merkintä"},
    markName: {en:"Name it (optional)",de:"Benennen (optional)",fr:"Nommer (facultatif)",it:"Dagli un nome (facoltativo)",es:"Ponle nombre (opcional)",pt:"Dê um nome (opcional)",nl:"Geef het een naam (optioneel)",sv:"Ge den ett namn (valfritt)",da:"Giv den et navn (valgfrit)",no:"Gi det et navn (valgfritt)",fi:"Anna nimi (valinnainen)"},
    runsFor: {en:"Runs for",de:"Dauert",fr:"Dure",it:"Dura",es:"Dura",pt:"Dura",nl:"Duurt",sv:"Varar",da:"Varer",no:"Varer",fi:"Kestoa"},
    ...
    removeMark: {en:"Remove",de:"Entfernen",fr:"Retirer",it:"Rimuovi",es:"Quitar",pt:"Remover",nl:"Verwijderen",sv:"Ta bort",da:"Fjern",no:"Fjern",fi:"Poista"},
    removeAsk: {en:"Remove “{t}”?",de:"„{t}“ entfernen?",fr:"Retirer « {t} » ?",it:"Rimuovere “{t}”?",es:"¿Quitar “{t}”?",pt:"Remover “{t}”?",nl:"“{t}” verwijderen?",sv:"Ta bort ”{t}”?",da:"Fjern ”{t}”?",no:"Fjerne ”{t}”?",fi:"Poistetaanko ”{t}”?"},
    undoRemove: {en:"Put it back",de:"Zurückholen",fr:"Le remettre",it:"Rimettilo",es:"Devolverlo",pt:"Colocar de volta",nl:"Terugzetten",sv:"Lägg tillbaka",da:"Læg tilbage",no:"Legg tilbake",fi:"Palauta"},
    cdSleeps: {en:"{n} sleeps",de:"noch {n}× schlafen",fr:"{n} dodos",it:"{n} notti",es:"{n} noches",pt:"{n} noites",nl:"nog {n} nachtjes",sv:"{n} nätter",da:"{n} gange at sove",no:"{n} netter",fi:"{n} yötä"},
    cdSchool: {en:"{n} school days",de:"{n} Schultage",fr:"{n} jours d’école",it:"{n} giorni di scuola",es:"{n} días de escuela",pt:"{n} dias de aula",nl:"{n} schooldagen",sv:"{n} skoldagar",da:"{n} skoledage",no:"{n} skoledager",fi:"{n} koulupäivää"},
    ...
    cdSetTarget: {en:"Count down to this",de:"Bis hierhin zählen",fr:"Compter jusqu’à ce jour",it:"Conta fino a questo giorno",es:"Contar hasta este día",pt:"Contar até este dia",nl:"Hier naartoe aftellen",sv:"Räkna ner till detta",da:"Tæl ned til dette",no:"Tell ned til dette",fi:"Laske tähän"},
    cdClearTarget: {en:"Stop counting down",de:"Nicht mehr zählen",fr:"Arrêter le compte",it:"Smetti di contare",es:"Dejar de contar",pt:"Parar de contar",nl:"Niet meer aftellen",sv:"Sluta räkna ner",da:"Stop nedtællingen",no:"Stopp nedtellingen",fi:"Lopeta laskenta"},
    cdCountTogether: {en:"Count them together",de:"Gemeinsam abzählen",fr:"Les compter ensemble",it:"Contiamoli insieme",es:"Contémoslos juntos",pt:"Vamos contar juntos",nl:"Samen tellen",sv:"Räkna dem tillsammans",da:"Tæl dem sammen",no:"Tell dem sammen",fi:"Lasketaan yhdessä"},
    ...
    eventsGate: {en:"Marks stay on the wall all year for subscribers.",de:"Bei Abonnenten bleiben die Markierungen das ganze Jahr an der Tafel.",fr:"Chez les abonnés, les repères restent au mur toute l’année.",it:"Per gli abbonati i segni restano al muro tutto l’anno.",es:"Para los suscriptores, las marcas se quedan en el mural todo el año.",pt:"Para assinantes, as marcas ficam no mural o ano todo.",nl:"Bij abonnees blijven de markeringen het hele jaar op het bord.",sv:"För prenumeranter sitter markeringarna kvar hela året.",da:"Hos abonnenter bliver markeringerne på væggen hele året.",no:"Hos abonnenter blir merkene på veggen hele året.",fi:"Tilaajilla merkinnät säilyvät seinällä koko vuoden."}
  },
      ...
      if (cd) {
        ...
        if (cd.today) {
          ...
          chip.innerHTML = glyph +
            '<span class="cwl-cdbig">' + this.fmt('cdSleeps', { n: cd.sleeps }) + '</span>' +
            '<span class="cwl-cdsmall">' + this.fmt('cdSchool', { n: cd.schoolDays }) + '</span>' +
            (cd.title ? '<span class="cwl-cdname">' + this._esc(cd.title) + '</span>' : '');
        }
    ...
    _paintCounter: function (host) {
      ...
      if (!this.premium) box.appendChild(this._gateLine('freeCounterGate'));
    ...
    _addRow: function (key, wall) {
      ...
      spanIn.addEventListener('change', function () { self._draftSpan = Math.max(1, Math.min(MODEL.MAX_SPAN, +spanIn.value || 1)); });
      var spanUnit = api.el('span', '');
      spanUnit.textContent = api.t('daysUnit');
    ...
    _paintPanel: function () {
      ...
      for (var d = 0; d < 7; d++) {
        (function (i) {
          ...
          b.type = 'button';
          b.textContent = self._weekdayName(ref, 'narrow');
