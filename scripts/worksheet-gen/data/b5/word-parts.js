  ...
  en: {
    ...
    prefixKey: {
      ...
      rows: [
        ...
        { base: 'spell', prefix: 'mis', word: 'misspell', gloss: 'to spell a word so the letters are not right' },
        { base: 'count', prefix: 'mis', word: 'miscount', gloss: 'to count the coins and get a number that is not right' },
    ...
    strings: {
      ...
      'family-in-sentence': { title: 'Root Words in Sentences', instruction: 'Write the four words above each stone into the sentences below it, one word in each gap.' },
    },
  },
};
