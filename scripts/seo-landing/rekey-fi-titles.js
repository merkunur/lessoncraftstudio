...
module.exports = { FI_JSON, GRADE_LABEL, META_CAP, META_FLAVOR, NO_CARRY_EXCLUDED_TYPES, NO_CARRY_FORBIDDEN_MODES, NUMERIC_TYPES, RANGE_BY_LEVEL, RANGE_BY_STANDARD, REPO_ROOT, TAIL_NUMERIC, TAIL_OTHER, TAXONOMY, TYPE_MAP, buildMeta, buildTitle, cap, loadTaxonomyThemes, noCarry, rangeFor, resolveOp, resolveQual, themeDisplay };
