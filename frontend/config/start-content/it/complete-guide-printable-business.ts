...
const content: StartContent = {
  ...
  actionSteps: [
    {
      ...
      description: "Scegli una materia (matematica, alfabetizzazione, colorare), una fascia d'età (scuola dell'infanzia, ultimo anno di materna, prima elementare) e un tipo di acquirente (genitori, venditori, istruzione domiciliare). Ricerca la tua nicchia su Etsy per verificare la domanda e valutare la concorrenza.",
    },
    {
    ...
    },
    {
      ...
      description: "Una volta che hai 20+ prodotti e vendite costanti su Etsy, espanditi su Amazon KDP e Gumroad. Adatta i tuoi prodotti esistenti al formato e alle aspettative del pubblico di ciascuna piattaforma.",
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "Etsy è la piattaforma di partenza consigliata grazie al suo ampio pubblico integrato per i prodotti stampabili. Amazon KDP è eccellente per i formati di libri di attività. Gumroad è ideale se i tuoi prodotti si rivolgono ai venditori con contenuti allineati al mercato. Molti venditori di successo pubblicano su più piattaforme contemporaneamente.",
    },
    {
    ...
    },
    {
      ...
      answer: "Ogni generatore produce file PDF pronti per la stampa e file JPEG ad alta risoluzione. Il PDF è il formato standard per i prodotti stampabili su Etsy e Gumroad. Il JPEG viene usato per le pagine interne di Amazon KDP e per le miniature dei prodotti. Entrambi i formati sono inclusi in ogni download.",
    },
    {
