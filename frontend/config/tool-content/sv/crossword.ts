...
const content: ToolContent = {  seo: {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Öppna panelen Sidinställning och välj sidstorlek: Letter stående, Letter liggande, A4 stående, A4 liggande eller ange ett anpassat mått. Välj en bakgrundsfärg med färgväljaren. Välj ett bakgrundstema och justera dess opacitet, välj sedan ett ramtema med sin egen oberoende opacitetskontroll. Dessa layoutval ramar in ditt korsordspussel innan du konfigurerar innehåll eller inmatningsmetod.',
      },
      {
  ...
  proTips: [
    {
      title: 'Använd snabb temagenerering för snabb batchproduktion',
      description: 'Snabb temagenerering väljer automatiskt 8 slumpmässiga bilder från det valda temat och genererar direkt. Klicka på Generera upprepade gånger för att producera flera unika korsord från samma tema — varje klick väljer olika slumpmässiga bilder, producerar olika ord och olika rutnätslayouter. Batchproducera 10+ unika tematiska korsord på minuter utan att ändra några inställningar. Detta är det snabbaste sättet att bygga tematiska korsordspaket för Etsy och KDP.',
    },
    {
      title: 'Använd manuell bildnamnredigering för exakt ordkontroll',
      description: 'När snabb temagenerering producerar ord som är för långa, för korta eller inte åldersanpassade, byt till manuell bildnamnredigering. Klicka på enskilda bilder för att välja dem, byt sedan namn på deras visningsnamn innan generering. Förenkla "Brandbil" till "Bil" för enklare pussel, eller byt namn på "Fjäril" till "Monark" för naturvetenskapsspecifikt ordförråd. Detta överbryggar klyftan mellan helt automatisk generering och helt manuella ordlistor — du behåller de visuella bildledtrådarna samtidigt som du kontrollerar de exakta orden i rutnätet.',
    },
    {
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      {
        src: '/samples/swedish/crossword/bildkorsord-4.webp',
    ...
    videoTitle: 'Hur du skapar bildkorsord med bildledtrådar, fyra inmatningsmetoder och automatiska facit — steg-för-steg-guide',
  },
};
