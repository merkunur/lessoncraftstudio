...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare sirkus-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med sirkustema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Sirkus-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare sirkus-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Sirkus-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare sirkus-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
    ...
    'first-grade': {
      seoTitle: 'Gratis Sirkus-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare sirkus-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
    ...
    'second-grade': {
      seoTitle: 'Gratis Sirkus-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare sirkus-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
    ...
    'third-grade': {
      seoTitle: 'Gratis Sirkus-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare sirkus-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
