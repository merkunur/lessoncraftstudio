...
const translations = {
  "en": {
    ...
    "mathpuzzle.error.no.data": "No puzzle data to render. Please generate a worksheet first.",
  ...
  "fr": {
    ...
    "mathpuzzle.error.no.data": "Aucune donnée de puzzle à afficher. Veuillez d'abord créer une feuille.",
    ...
    "mathpuzzle.generate.worksheet": "Créer la feuille",
    ...
    "mathpuzzle.msg.generate.first": "Veuillez d'abord créer une feuille d'exercices.",
    "mathpuzzle.msg.generate.worksheet.first": "Veuillez d'abord créer une feuille d'exercices.",
    ...
    "mathpuzzle.msg.worksheet.success": "Feuille d'exercices créée avec succès !",
    ...
    "selectImagesToUpload": "Sélectionner image(s) à télécharger :",
    ...
    "mathpuzzle.generate.new": "Nouvelle feuille",
  ...
  "es": {
    ...
    "mathpuzzle.msg.worksheet.success": "¡Ficha de ejercicios creada con éxito!",
  ...
  "it": {
    ...
    "error.puzzle.generation": "Impossibile creare il rompicapo. Prova con impostazioni diverse.",
    ...
    "mathpuzzle.error.no.data": "Nessun dato del puzzle da visualizzare. Crea prima un foglio.",
    ...
    "mathpuzzle.generate": "Crea",
    "mathpuzzle.generate.answer": "Crea soluzioni",
    "mathpuzzle.generate.worksheet": "Crea scheda",
    ...
    "mathpuzzle.msg.answer.generated": "Foglio soluzioni creato!",
    ...
    "mathpuzzle.msg.generate.complete": "Rompicapo creato con successo!",
    "mathpuzzle.msg.generate.content": "Crea prima il contenuto.",
    "mathpuzzle.msg.generate.first": "Crea prima una scheda esercizi.",
    "mathpuzzle.msg.generate.worksheet.first": "Crea prima una scheda esercizi.",
    "mathpuzzle.msg.generating.data": "Creazione dati del rompicapo...",
    "mathpuzzle.msg.generation.error": "Errore nella creazione del rompicapo: {error}",
    ...
    "mathpuzzle.msg.worksheet.success": "Scheda esercizi creata con successo!",
  ...
  "pt": {
    ...
    "mathpuzzle.error.no.data": "Nenhum dado do quebra-cabeça para exibir. Por favor, crie primeiro uma folha de trabalho.",
  ...
  "sv": {
    ...
    "mathpuzzle.error.no.data": "Ingen pusseldata att visa. Skapa först ett arbetsblad.",
    ...
    "mathpuzzle.text.tools": "Textalternativ",
    ...
    "undo": "Ångra (Ctrl+Z)",
    "redo": "Gör om (Ctrl+Y)",
    "mathpuzzle.generate.new": "Nytt arbetsblad",
  ...
  "da": {
    ...
    "mathpuzzle.error.no.data": "Ingen puslespildata at vise. Opret først et arbejdsark.",
    "mathpuzzle.download.answer.jpeg": "Svarark (JPEG)",
    "mathpuzzle.download.answer.pdf": "Svarark (PDF)",
    ...
    "mathpuzzle.generate.answer": "Opret svarark",
    ...
    "mathpuzzle.msg.answer.generated": "Svarark oprettet!",
    ...
    "mathpuzzle.msg.rendering.answer": "Opretter svarark...",
    ...
    "undo": "Fortryd (Ctrl+Z)",
    "redo": "Gentag (Ctrl+Y)",
    "mathpuzzle.generate.new": "Nyt regneark",
  ...
  "no": {
    ...
    "error.puzzle.generation": "Kunne ikke lage puslespill. Prøv andre innstillinger.",
    ...
    "mathpuzzle.background.opacity": "Bakgrunnsdekkevne:",
    "mathpuzzle.background.title": "Bakgrunn",
    "mathpuzzle.border.message": "Velg et tema for å se rammer.",
    "mathpuzzle.border.opacity": "Rammedekkevne:",
    "mathpuzzle.border.title": "Ramme",
    "mathpuzzle.clear.all": "Slett alt",
    "mathpuzzle.columns.label": "Kolonner (2–4):",
    ...
    "mathpuzzle.msg.rendering.answer": "Lager fasit...",
    "mathpuzzle.msg.rendering.worksheet": "Lager oppgaveark...",
    ...
    "mathpuzzle.text.size": "Størrelse:",
    "mathpuzzle.text.tools": "Tekstinnstillinger",
    "mathpuzzle.themes.all": "Alle temaer",
  ...
  "fi": {
    ...
    "mathpuzzle.border.message": "Valitse teema nähdäksesi reunukset.",
    "mathpuzzle.border.opacity": "Reunuksen läpinäkyvyys:",
    "mathpuzzle.border.title": "Reunus",
    ...
    "mathpuzzle.msg.border.failed": "Reunuskuvan lataus epäonnistui.",
    "mathpuzzle.msg.borders.error": "Virhe reunusten lataamisessa.",
    ...
    "mathpuzzle.msg.loading.borders": "Ladataan reunuksia...",
    ...
    "mathpuzzle.msg.using.upload": "Kirjastokuvaa ei valittu. Käytetään \\\"{imageName}\\\" latauksistasi.",
    ...
    "mathpuzzle.upload.custom": "Lataa omia kuvia",
    "mathpuzzle.upload.select": "Valitse ladattavat kuvat:",
    "mathpuzzle.uploaded.label": "Lataamasi kuvat (tämä istunto):",
    "mathpuzzle.uploaded.placeholder": "Lataamasi kuvat näkyvät täällä.",
