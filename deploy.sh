...
NODE_OPTIONS="--max-old-space-size=16384" nice -n 10 timeout 3600 npm run build || { echo "BUILD FAILED (OOM or >60 min) — check the log for 'heap out of memory' vs a genuine hang. Aborting."; exit 1; }
