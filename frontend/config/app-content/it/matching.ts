...
const content: AppContent = {
  ...
  ctaHeading: 'Crea schede di associazione',
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Imposta il numero di coppie di abbinamento a 4, 5 o 6 tramite il menu a tendina nel pannello Impostazioni Scheda. Il valore predefinito è 6 coppie, ideale per schede standard. Riduci a 4 o 5 coppie per utenti più piccoli che necessitano di immagini più grandi e più spazio, o per schede con parole personalizzate più lunghe che richiedono più margine. Il numero di coppie si applica in modo coerente nelle quattro modalità di abbinamento, dandoti controllo sulla difficoltà della scheda e la densità visiva senza ridisegnare il formato.',
      },
      {
