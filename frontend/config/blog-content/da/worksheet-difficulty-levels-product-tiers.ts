...
Start med LessonCraftStudios gratis prøveversion med vandmærke og test alle funktioner, før du investerer i en kommerciel licens.' }
  ...
  internalLinks: [
    { pageType: 'app', slug: 'addition-arbejdsark', anchorText: 'Additions-Generator (3 niveauer)' },
    { pageType: 'app', slug: 'ordsoegning-arbejdsark', anchorText: 'Ordsøgning (3 niveauer)' },
    { pageType: 'app', slug: 'krydsord-arbejdsark', anchorText: 'Krydsord (3 niveauer)' },
  ],
  relatedPosts: [
