...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Vind de zoekwoorden die uw concurrenten missen',
    description: 'Vind de zoekwoorden die uw concurrenten missen. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
