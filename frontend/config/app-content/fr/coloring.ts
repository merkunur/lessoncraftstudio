...
const content: AppContent = {
  seo: {
    ...
    lsiKeywords: [
      'produits numériques pages de coloriage pour entrepreneurs',
      'cahiers de coloriage imprimables à usage commercial',
      'générateur de coloriage avec canevas libre et dessin à main levée',
    ],
  ...
  howItWorks: {
    title: 'Comment Créer des Pages de Coloriage Personnalisées en 5 Étapes',
    steps: [
      {
        title: 'Définir la mise en page',
        description:
          'Ouvrez le panneau Mise en Page et choisissez un format de page : Letter Portrait, Letter Paysage, A4 Portrait, A4 Paysage, Carré (1200×1200) ou toute dimension personnalisée. Sélectionnez une couleur de page à l\'aide du sélecteur de couleurs — le blanc est la valeur par défaut pour des pages de coloriage nettes. Choisissez un thème de bordure décorative depuis la bibliothèque de bordures pour encadrer votre page. Ces choix de mise en page établissent la base de votre fiche de coloriage avant d\'ajouter le moindre contenu.',
      },
      {
        title: 'Parcourir la Bibliothèque d\'Images et ajouter des images',
        description:
          'Ouvrez le panneau Bibliothèque d\'Images et parcourez 104 collections thématiques avec plus de 3 100 illustrations colorées — animaux, nourriture, véhicules, nature, fêtes et des dizaines d\'autres. Utilisez le menu déroulant des thèmes pour filtrer par catégorie ou tapez dans la barre de recherche pour trouver des images spécifiques. Cliquez sur n\'importe quelle image pour la placer directement sur votre canevas. Vous pouvez également téléverser des images PNG, JPG ou GIF personnalisées à l\'aide du bouton d\'importation. Chaque image ajoutée devient un objet de canevas entièrement déplaçable et redimensionnable.',
      },
      {
        title: 'Arranger, redimensionner et superposer les images sur le canevas',
        description:
  ...
  keyFeatures: {
    title: 'Fonctionnalités Clés du Générateur de Pages de Coloriage',
    features: [
      {
        title: 'Concepteur de pages de coloriage sur canevas libre',
        description:
          'Contrairement aux générateurs de fiches basés sur des grilles, le Générateur de Pages de Coloriage vous offre un canevas complètement ouvert où chaque élément est placé exactement où vous le souhaitez. Aucun modèle, aucun emplacement, aucune mise en page prédéterminée — juste une page vierge et votre vision créative. Glissez les images n\'importe où, superposez-les, pivotez-les, redimensionnez-les librement. Cette approche en forme libre signifie que chaque page de coloriage que vous créez est unique et impossible à reproduire avec des outils basés sur des modèles. Pour les vendeurs, cela se traduit par des produits originaux qui se démarquent dans les catégories saturées des places de marché.',
      },
      {
        title: 'Outil de dessin à main levée avec couleur et taille de pinceau réglables',
        description:
      ...
      },
      {
        ...
        description:
          'Parcourez 104 collections d\'images thématiques couvrant les animaux, la nourriture, les véhicules, la nature, les métiers, les fêtes, les sports, les saisons et des dizaines d\'autres. Chaque thème fournit un ensemble coordonné d\'illustrations colorées qui fonctionnent ensemble sur une page de coloriage. Utilisez le menu déroulant des thèmes pour filtrer par catégorie ou recherchez des images spécifiques par mot-clé. Cliquez sur n\'importe quelle image pour l\'ajouter instantanément à votre canevas. La Licence Commerciale inclut 10 thèmes en couleur pour démarrer ; l\'Accès Complet déverrouille les 104 thèmes pour une variété créative maximale. Téléversez des images personnalisées en complément du contenu de la bibliothèque pour des compositions entièrement originales.',
      },
      {
        title: 'Thèmes de bordures décoratives depuis la bibliothèque de bordures',
        description:
          'Encadrez vos pages de coloriage avec des thèmes de bordures décoratives chargés depuis la bibliothèque de bordures intégrée. Les bordures ajoutent une finition visuelle et définissent la zone imprimable de chaque page. Sélectionnez une bordure depuis le panneau Mise en Page pour l\'appliquer instantanément. Les bordures sont séparées du contenu de la page — elles encadrent le canevas sans interférer avec vos images, texte ou dessins. Les bordures décoratives augmentent la qualité perçue des pages de coloriage pour les listages de places de marché et donnent à chaque page une apparence finie et professionnelle.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Le canevas Fabric.js offre un contrôle total sur chaque élément de votre page de coloriage. Glissez, redimensionnez, pivotez et repositionnez les images, le texte et les dessins librement. Les contrôles de calques gèrent l\'ordre d\'empilement — amenez les éléments vers l\'avant ou renvoyez-les vers l\'arrière. Verrouillez les éléments terminés pendant que vous en éditez d\'autres. Ajoutez du texte personnalisé avec sept options de polices, taille et couleur réglables, et largeur de contour de texte de 0 à 10 avec une granularité de 0,5 pour des titres gras et lisibles. Zoomez de 25 % à 300 % pour un travail de précision. Annulez et rétablissez jusqu\'à 20 états d\'historique avec Ctrl+Z et Ctrl+Y. La commande Tout Effacer inclut une boîte de dialogue de confirmation pour éviter les suppressions accidentelles.',
      },
    ],
  },

  businessUseCases: {
    title: 'Comment Vendre des Pages de Coloriage Personnalisées en Ligne',
    cases: [
      {
        title: 'Lots de pages de coloriage thématiques sur Etsy',
        description:
          'Créez des packs de pages de coloriage thématiques en utilisant les 104 collections d\'images — animaux de la ferme, créatures marines, dinosaures, faune de la jungle, fêtes et des dizaines d\'autres. Chaque thème fournit suffisamment d\'illustrations pour 10 à 20 pages de coloriage uniques. Activez l\'export en niveaux de gris pour une sortie prête à imprimer, ajoutez des bordures décoratives pour un aspect soigné et incluez des pages avec des lignes d\'écriture pour une valeur éducative ajoutée. Proposez les thèmes en lots individuels à 3 €–5 € chacun, ou combinez plusieurs thèmes en méga packs à 12 €–18 €. Le canevas libre garantit que chaque page est originale et impossible à recréer avec des générateurs basés sur des modèles.',
        platform: 'Etsy (etsy.fr)',
      },
      {
        title: 'Cahiers de coloriage sur Amazon KDP',
        description:
          'Compilez 60 à 100 pages de coloriage dans un cahier imprimé formaté pour Amazon KDP. L\'option d\'export en niveaux de gris produit des pages économiques en encre prêtes pour les intérieurs de livres en noir et blanc. Structurez votre livre par thème : le chapitre 1 couvre les animaux de la ferme, le chapitre 2 la vie marine, le chapitre 3 les véhicules, et ainsi de suite. Utilisez l\'outil de dessin à main levée pour ajouter des pages de titre personnalisées et des séparateurs de sections. Le canevas libre vous permet de contrôler la densité d\'images par page — une grande image pour les jeunes enfants, plusieurs petites images pour les coloristes plus âgés. Les cahiers de coloriage ont une demande toute l\'année avec des pics saisonniers autour des fêtes.',
  ...
  faq: [
    {
      question: 'En quoi le canevas libre diffère-t-il des générateurs basés sur des grilles ?',
      answer:
        'Le Générateur de Pages de Coloriage utilise un canevas complètement ouvert sans grilles, modèles ni emplacements. Vous placez les images n\'importe où sur la page en les cliquant dans la bibliothèque, puis les glissez, redimensionnez, pivotez et superposez librement. C\'est fondamentalement différent des outils basés sur des grilles qui verrouillent les images dans des positions fixes. L\'approche en forme libre vous donne un contrôle créatif total sur chaque mise en page, rendant chaque page de coloriage unique et originale.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Ouvrez le panneau Bibliothèque d\'Images, sélectionnez un thème dans le menu déroulant ou tapez un terme de recherche dans la barre de recherche. Les images apparaissent dans une grille — cliquez sur n\'importe quelle image pour l\'ajouter directement à votre canevas. L\'image apparaît comme un objet de canevas déplaçable et redimensionnable que vous pouvez glisser, pivoter et superposer avec d\'autres éléments. La bibliothèque contient plus de 3 100 illustrations colorées réparties dans 104 collections thématiques. Vous pouvez également téléverser des images PNG, JPG ou GIF personnalisées.',
    },
    {
      question: 'Puis-je téléverser mes propres images ?',
      answer:
        'Oui. Le panneau Bibliothèque d\'Images inclut un bouton d\'importation personnalisée qui accepte les fichiers PNG, JPG et GIF. Les images téléversées sont ajoutées au canevas comme les images de la bibliothèque — entièrement déplaçables, redimensionnables et pivotables. Combinez vos propres créations avec les illustrations de la bibliothèque pour des pages de coloriage entièrement originales. Les images personnalisées sont particulièrement utiles pour des pages de coloriage spécifiques à une marque ou des sujets non couverts par les thèmes intégrés.',
    },
    {
      question: 'Comment fonctionnent les thèmes de bordures décoratives ?',
      answer:
        'Dans le panneau Mise en Page, sélectionnez un thème de bordure depuis la bibliothèque de bordures. La bordure encadre votre canevas et ajoute une finition visuelle à la page de coloriage terminée. Les bordures sont appliquées comme des éléments de canevas visibles dans l\'éditeur. Elles définissent la limite visuelle de la page sans interférer avec vos images, texte ou dessins. Différents thèmes de bordures conviennent à différents publics — bordures ludiques pour les pages de coloriage d\'enfants, bordures élégantes pour les cahiers de coloriage pour adultes.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'generateur-pages-coloriage',
      anchorText: 'Créateur de Pages de Coloriage',
    },
    {
      pageType: 'start',
  ...
  visuals: {
    ...
    videoTitle: 'Comment Créer des Pages de Coloriage Personnalisées avec Dessin à Main Levée et Export en Niveaux de Gris — Tutoriel Étape par Étape',
  },
};
