...
const localeContent: Record<string, {
  ...
  de: {
    ...
    titleLine2: '-- Keine Designkenntnisse nötig',
    subtitle: 'Tausende Verkäufer verdienen 500--5.000 $/Monat mit dem Verkauf von Druckvorlagen auf Etsy, Amazon KDP und TPT. LessonCraftStudio erstellt professionelle Produkte in Minuten statt Stunden.',
    ...
    proofWorksheets: 'Über 10.000 Arbeitsblätter erstellt',
    proofCountries: 'Verkäufer in 40+ Ländern',
    proofGenerators: '33 professionelle Generatoren',
  },
  fr: {
    badge: 'L\'opportunité business des imprimables',
    titleLine1: 'Lancez un business ',
    titleHighlight: 'd\'imprimables rentable',
    titleLine2: '-- Aucune compétence en design',
    subtitle: 'Des milliers de vendeurs gagnent 500 a 5 000 $/mois en vendant des imprimables educatifs sur Etsy, Amazon KDP et TPT. LessonCraftStudio crée des produits professionnels en minutes.',
  ...
  es: {
    ...
    trustImages: '3,000+ imágenes',
    trustLicense: 'Uso comercial incluido',
    answerKey: 'Con respuestas',
    previewTitles: ['Sumas', 'Sopa de letras'],
    proofWorksheets: 'Más de 10,000 fichas generadas',
    proofCountries: 'Vendedores en 40+ países',
    proofGenerators: '33 generadores profesionales',
  },
  it: {
    badge: 'L\'opportunità business degli stampabili',
  ...
  pt: {
    badge: 'A oportunidade de negócio dos imprimíveis',
    titleLine1: 'Inicie um negócio ',
    titleHighlight: 'de imprimíveis lucrativo',
    titleLine2: '-- Sem habilidades de design',
    subtitle: 'Milhares de vendedores ganham $500--$5.000/mês vendendo imprimíveis educativos no Etsy, Amazon KDP e TPT. LessonCraftStudio cria produtos profissionais em minutos.',
    ...
    proofCountries: 'Vendedores em 40+ países',
  ...
  da: {
    ...
    titleLine2: '-- Ingen designfærdigheder påkrævet',
    subtitle: 'Tusindvis af sælgere tjener $500--$5.000/måned på at sælge pædagogiske printables på Etsy, Amazon KDP og TPT. LessonCraftStudio skaber professionelle produkter på minutter.',
    ctaPrimary: 'Se hvordan det virker',
    ctaSecondary: 'Prøv gratis med vandmærke',
    ...
    proofCountries: 'Sælgere i 40+ lande',
    proofGenerators: '33 professionelle generatorer',
  },
  sv: {
    badge: 'Utskriftsföretagets möjlighet',
    titleLine1: 'Starta ett lönsamt ',
    titleHighlight: 'utskriftsföretag',
    titleLine2: '-- Inga designkunskaper krävs',
    subtitle: 'Tusentals säljare tjänar $500--$5.000/manad på att sälja pedagogiska utskrifter på Etsy, Amazon KDP och TPT. LessonCraftStudio skapar professionella produkter på minuter.',
    ctaPrimary: 'Se hur det fungerar',
    ctaSecondary: 'Prova gratis med vattenstempel',
    trustLanguages: '11 språk',
    trustImages: 'Över 3.000 bilder',
    trustLicense: 'Kommersiell licens',
    answerKey: 'Facit',
    previewTitles: ['Addition', 'Ordsök'],
    proofWorksheets: 'Över 10.000 arbetsblad skapade',
    proofCountries: 'Säljare i 40+ länder',
    proofGenerators: '33 professionella generatorer',
  },
  no: {
    badge: 'Utskriftsvirksomhetens mulighet',
    titleLine1: 'Start en lønnsom ',
    titleHighlight: 'utskriftsvirksomhet',
    titleLine2: '-- Ingen designkunnskaper nødvendig',
    subtitle: 'Tusenvis av selgere tjener $500--$5.000/måned på å selge pedagogiske utskrifter på Etsy, Amazon KDP og TPT. LessonCraftStudio lager profesjonelle produkter på minutter.',
    ctaPrimary: 'Se hvordan det fungerer',
    ctaSecondary: 'Prøv gratis med vannmerke',
    trustLanguages: '11 språk',
    ...
    subtitle: 'Tuhannet myyjät tienaavat $500--$5.000/kk myymällä opetuksellisia tulostettavia Etsyssä, Amazon KDP:ssa ja TPT:ssa. LessonCraftStudio luo ammattimaiset tuotteet minuuteissa.',
    ...
    proofWorksheets: 'Yli 10.000 tehtävää luotu',
    proofCountries: 'Myyjiä 40+ maassa',
