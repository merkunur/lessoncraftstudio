#!/usr/bin/env node
/* =====================================================================
   register-folding-sheet.js — the five wiring points for TOOL #35.
   ...
   Usage: node scripts/register-folding-sheet.js
   ===================================================================== */
'use strict';
const fs = require('fs');
...
const PREV = 'class-graph';        /* the key this one is inserted after */
const E = require('./_folding-sheet-content.js');
