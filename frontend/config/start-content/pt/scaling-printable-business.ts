...
const content: StartContent = {
  seo: {
    ...
    lsiKeywords: [
      ...
      'distribuição multiplataforma para fichas',
  ...
  actionSteps: [
    ...
    },
    {
      ...
      description: 'Gera produtos de amostra em inglês ou alemão usando geradores de fichas multilingues. Cria cinco publicações no teu idioma escolhido no marketplace apropriado. Avalia o desempenho durante 60 a 90 dias antes de te expandires a idiomas adicionais.',
    },
    {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Escalamento agnóstico de plataforma — produtos de sudoku idênticos funcionam no Etsy, Amazon KDP, Teachers Pay Teachers e em todos os marketplaces internacionais sem adaptação de formato. Os puzzles puramente numéricos cruzam todas as barreiras linguísticas.',
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'O kit de ferramentas completo para gerir um negócio de imprimíveis em escala: geradores de fichas, ferramentas de design, analíticas e ferramentas de gestão de plataformas organizadas por fase de crescimento.',
    },
  ],
