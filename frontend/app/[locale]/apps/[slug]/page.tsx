...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/tren-alfabeto-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/treno-alfabeto-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/trem-alfabeto-fichas',
  ...
  // Math Worksheets - Finnish product page SEO (new Finnish slug)
  if (params.slug === 'matematiikka-tyoarkit' && params.locale === 'fi') {
    return {
      title: 'Matematiikka Tehtävät Alakoulu Generaattori | Tulostettavat Tehtävät Lapsille Ilmainen Yhteenlasku ja Vähennyslasku Tehtävät',
      ...
      alternates: {
        canonical: 'https://www.lessoncraftstudio.com/fi/apps/matematiikka-tyoarkit',
        languages: {
          ...
          'fi': 'https://www.lessoncraftstudio.com/fi/apps/matematiikka-tyoarkit',
          'x-default': 'https://www.lessoncraftstudio.com/en/apps/math-worksheets',
        },
      },
      openGraph: {
        title: 'Matematiikka Tehtävät Alakoulu Generaattori | LessonCraftStudio',
        description: 'Luo ammattimaisia visuaalisia matematiikkatehtäviä minuuteissa. Peruspaketti-tilauksesi antaa sinulle rajattoman matematiikkatehtävien luonnin ilman maksuja per tehtävä.',
        url: 'https://www.lessoncraftstudio.com/fi/apps/matematiikka-tyoarkit',
        siteName: 'LessonCraftStudio',
        type: 'website',
      },
    };
  ...
  // Legacy: Redirect old Finnish math-worksheets slug to new slug (for backwards compatibility)
  if (params.slug === 'math-worksheets' && params.locale === 'fi') {
    return {
      title: 'Matematiikka Tehtävät Alakoulu Generaattori - Tulostettavat Tehtävät',
      description: 'Luo ammattimaisia visuaalisia matematiikkatehtäviä minuuteissa.',
      robots: {
        index: false, // Don't index old URL
        follow: true,
      },
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/bingo-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/sudoku-fichas-ninos',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/grande-pequeno-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/grande-piccolo-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/grande-pequeno-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/dibujo-cuadricula-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/disegno-griglia-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/desenho-grade-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/buscar-objetos-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/trova-oggetti-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/encontrar-objetos-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/rompecabezas-cuadricula-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/griglia-abbinamento-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/quebra-cabeca-grade-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/crucigramas-imagenes-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/cruciverba-immagini-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/palavras-cruzadas-imagens-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/criptogramas-imagenes-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/crittogramma-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/criptograma-imagens-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/preposiciones-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/preposizioni-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/preposicoes-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/buscar-contar-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'de': 'https://www.lessoncraftstudio.com/de/apps/mathe-arbeitsblaetter',
          'fr': 'https://www.lessoncraftstudio.com/fr/apps/exercices-maths-fiches',
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/acertijos-matematicos-fichas',
          'x-default': 'https://www.lessoncraftstudio.com/en/apps/math-worksheets',
        },
      },
      openGraph: {
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/letras-revueltas-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/graficos-conteo-fichas',
          'x-default': 'https://www.lessoncraftstudio.com/en/apps/chart-count-worksheets',
        },
      },
      openGraph: {
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'de': 'https://www.lessoncraftstudio.com/de/apps/bilder-additions-arbeitsblaetter',
          'fr': 'https://www.lessoncraftstudio.com/fr/apps/addition-codee-fiches',
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/suma-codigo-fichas',
          'x-default': 'https://www.lessoncraftstudio.com/en/apps/code-addition-worksheets',
        },
      },
      openGraph: {
  ...
  // Cryptogram Worksheets - Portuguese (Brazilian) product page SEO
  if (params.slug === 'criptograma-imagens-fichas' && params.locale === 'pt') {
    return {
      ...
      openGraph: {
        title: 'Criptograma com Imagens | Atividades para Imprimir de Alfabetização | LessonCraftStudio',
        description: 'Crie atividades de criptograma com imagens profissionais. Perfeito para professores de educação infantil e ensino fundamental.',
        url: 'https://www.lessoncraftstudio.com/pt/apps/criptograma-imagens-fichas',
        siteName: 'LessonCraftStudio',
        type: 'website',
      },
    };
  ...
  // Legacy: Redirect old Portuguese cryptogram-worksheets slug to new slug (for backwards compatibility)
  if (params.slug === 'cryptogram-worksheets' && params.locale === 'pt') {
    return {
      title: 'Criptograma com Imagens - Gerador de Atividades',
      robots: {
        index: false,
        follow: true,
      },
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'de': 'https://www.lessoncraftstudio.com/de/apps/mathe-raetsel-arbeitsblaetter',
          'fr': 'https://www.lessoncraftstudio.com/fr/apps/puzzle-maths-fiches',
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/rompecabezas-matematicos-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/puzzle-matematici-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/quebra-cabeca-matematica-fichas',
          'x-default': 'https://www.lessoncraftstudio.com/en/apps/math-puzzle-worksheets',
        },
      },
      openGraph: {
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/piezas-faltantes-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/pezzi-mancanti-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/pecas-faltantes-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/mayor-menor-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/confronto-numeri-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/maior-menor-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/tren-patrones-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/treno-sequenze-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/trem-padroes-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/fichas-patrones',
          'it': 'https://www.lessoncraftstudio.com/it/apps/schede-pattern',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/fichas-padroes-sequencias',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/laberintos-imagenes-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/percorso-illustrato-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/labirinto-caminhos-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/clasificar-imagenes-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/classificazione-immagini-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/classificacao-imagens-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/asociacion-sombras-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/abbinamento-ombre-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/combinar-sombras-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/busqueda-tesoro-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/caccia-tesoro-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/caca-ao-tesouro-fichas',
  ...
  // Word Guess - Portuguese (Brazilian) product page SEO (new Portuguese slug)
  if (params.slug === 'adivinhar-palavras-fichas' && params.locale === 'pt') {
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/adivinar-palabras-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/indovina-parole-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/adivinhar-palavras-fichas',
          'x-default': 'https://www.lessoncraftstudio.com/en/apps/word-guess-worksheets',
        },
      },
      openGraph: {
        title: 'Gerador de Atividades de Adivinhar Palavras | LessonCraftStudio',
        description: 'Crie atividades de adivinhar palavras profissionais em menos de 3 minutos. Perfeito para professores de educação infantil e ensino fundamental.',
        url: 'https://www.lessoncraftstudio.com/pt/apps/adivinhar-palavras-fichas',
        siteName: 'LessonCraftStudio',
        type: 'website',
      },
    };
  ...
  // Legacy: Redirect old Portuguese word-guess-worksheets slug to new slug (for backwards compatibility)
  if (params.slug === 'word-guess-worksheets' && params.locale === 'pt') {
    return {
      title: 'Atividades de Adivinhar Palavras - Gerador de Atividades',
      robots: {
        index: false,
        follow: true,
      },
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/lectoescritura-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/scrittura-schede',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/caligrafia-fichas',
    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'de': 'https://www.lessoncraftstudio.com/de/apps/bilddiagramm-arbeitsblaetter',
          'fr': 'https://www.lessoncraftstudio.com/fr/apps/graphique-images-fiches',
          'es-MX': 'https://www.lessoncraftstudio.com/es/apps/graficos-imagenes-fichas',
          'pt-BR': 'https://www.lessoncraftstudio.com/pt/apps/grafico-imagens-atividades',
...
// FIXED: Uses proper locale/slug mapping to prevent cross-language URL pollution
export async function generateStaticParams() {
  const { getAllProductPageSlugs } = await import('@/config/product-page-slugs');
