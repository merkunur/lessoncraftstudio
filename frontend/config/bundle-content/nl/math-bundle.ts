...
const content: BundleContent = {
  ...
  visuals: {
    heroImages: {
      primary: '/samples/dutch/addition/Optellen%201.webp',
      primaryAlt: 'Optelwerkblad met thematische afbeeldingen die visuele telopgaven tonen',
    },
    sampleGallery: [
      { src: '/samples/dutch/addition/Optellen%201.webp', alt: 'Optelwerkblad met thematische dierenafbeeldingen', caption: 'Optelling Werkblad' },
      { src: '/samples/dutch/subtraction/Aftrekken%201.webp', alt: 'Aftrekwerkblad met doorstrepen telmethode', caption: 'Aftrekken Werkblad' },
      { src: '/samples/dutch/code%20addition/Codekraker%20Optellen%201.webp', alt: 'Code-optelling puzzel met letterdecodering', caption: 'Code-Optelling Puzzel' },
      { src: '/samples/dutch/more%20less/Meer%20of%20Minder%201.webp', alt: 'Groter dan kleiner dan vergelijkingswerkblad', caption: 'Meer of Minder Werkblad' },
      { src: '/samples/dutch/math%20puzzle/Rekenpuzzel%201.webp', alt: 'Legpuzzel-raster rekenpuzzel met vergelijkingen', caption: 'Rekenpuzzel Werkblad' },
      { src: '/samples/dutch/math%20worksheet/Rekenwerkblad%201.webp', alt: 'Visuele algebra puzzel met afbeeldingsvariabelen', caption: 'Rekenwerkblad Puzzel' },
    ],
