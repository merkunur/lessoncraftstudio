...
const content: ToolContent = {
  ...
  tutorial: {
    title: 'Como Criar Fichas de Adição em 8 Passos Simples',
    steps: [
      {
  ...
  businessIdeas: [
    ...
    },
    {
      ...
      description: 'Ofereça uma amostra de teste grátis com marca d\'água de 5 fichas de adição como lead magnet no Instagram ou Pinterest. Recolha endereços de correio eletrónico e depois ofereça os seus pacotes temáticos completos. As fichas visuais criam publicações atrativas que geram tráfego. Desenhe a sua amostra com os temas mais apelativos visualmente para maximizar o potencial de partilha nas redes. Inclua uma capa com o link da sua loja e uma breve descrição do seu catálogo completo de produtos. Os pins do Pinterest com fichas de matemática coloridas geram consistentemente altas taxas de cliques nas categorias de educação e parentalidade.',
    },
  ],
  ...
  proTips: [
    {
      ...
      description: 'Ao criar produtos para vender, inclua sempre pelo menos algumas fichas em Modo Misto nos seus pacotes. O Modo Misto combina Imagem + Imagem, Imagem + Número e Encontrar o Parcela numa única página, oferecendo aos compradores mais variedade e fazendo com que o seu produto pareça mais completo em comparação com concorrentes que oferecem apenas um estilo. Os compradores nos marketplaces costumam comparar pacotes lado a lado, e as páginas em Modo Misto demonstram a amplitude do conteúdo de relance, o que aumenta as taxas de conversão.',
    },
    {
    ...
    },
    {
      ...
      description: 'O PDF é ideal para impressão direta, mas o JPEG permite-lhe criar imagens de maquete para os seus listings de loja. Descarregue ambos os formatos. Use o JPEG para miniaturas de produtos e pré-visualizações nas redes sociais, e inclua o PDF como o produto entregável real.',
    },
    {
    ...
    },
    {
      ...
      description: 'Uma ficha branca simples e uma ficha com uma moldura temática e um fundo subtil parecem completamente diferentes nos listings de produtos. Adicionar um toque visual demora 30 segundos e pode justificar um preço mais alto. Ajuste a opacidade do fundo para manter os exercícios legíveis. Escolhas de bordas consistentes em todo um pacote criam um aspeto profissional e cuidado que motiva os compradores a adquirir a sua coleção completa.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'A biblioteca de imagens inclui mais de 100 coleções temáticas que cobrem animais, alimentos, veículos, desportos, natureza, festividades, material escolar e muito mais. Cada tema contém múltiplas imagens individuais para que as suas fichas tenham sempre um aspeto variado, mesmo dentro de um único tema. Novos temas são adicionados periodicamente à biblioteca. Cada tema é cuidadosamente ilustrado com um estilo artístico coerente para um acabamento profissional.',
    },
    {
      question: 'Que modos de exercício suporta o gerador?',
      answer: 'Existem quatro modos: Imagem + Imagem (ambos os parcelas como grupos de imagens), Imagem + Número (imagens mais um número), Encontrar o Parcela (um parcela está oculto) e Modo Misto (combina aleatoriamente os três na mesma ficha). O Modo Misto é especialmente popular para criar páginas de atividades variadas e atrativas. Os vendedores costumam usar diferentes modos para criar pacotes de dificuldade escalonada.',
    },
    {
      question: 'Posso criar fichas noutros idiomas além do português?',
      answer: 'Sim. O gerador suporta 11 idiomas: português, inglês, alemão, francês, espanhol, italiano, neerlandês, sueco, dinamarquês, norueguês e finlandês. Mude o idioma do conteúdo para gerar fichas com etiquetas de imagens e instruções no idioma que preferir.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'adicao-fichas', anchorText: 'Fichas de Adição — Detalhes Completos do Produto' },
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Ficha de adição com imagens de animais mostrando exercícios de matemática baseados em imagens',
    },
    sampleGallery: [
      {
        src: '/samples/portuguese/addition/Adição Divertida 1.webp',
        alt: 'Ficha de adição com tema de animais no modo Imagem + Imagem',
        caption: 'Modo Imagem + Imagem com tema de animais',
      },
      {
        src: '/samples/portuguese/addition/Adição Divertida 1.webp',
        alt: 'Ficha de adição com imagens de alimentos no modo Encontrar o Parcela',
        caption: 'Modo Encontrar o Parcela com tema de alimentos',
      },
      {
        src: '/samples/portuguese/addition/Adição Divertida 4.webp',
        alt: 'Ficha de adição em modo misto com imagens de veículos e moldura decorativa',
        caption: 'Modo misto com veículos e moldura decorativa',
      },
    ],
    youtubeId: '6O5aCzHkh8M',
    videoTitle: 'Como Criar Fichas de Adição — Tutorial em Vídeo',
  },
};
