...
const content: GuideContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'flersproget arbejdsark-virksomhed',
      'udvid printables globalt',
    ],
    lsiKeywords: [
      'sprogudvidelse internationale markeder lokaliseringsstrategi europæiske printable-markeder',
      'tysk pædagogisk marked fransk arbejdsark-efterspørgsel spansk printable-købere',
      'flersproget katalog omsætningsmultiplikation markedsdiversificering tværnationalt salg',
      'oversættelsesworkflow globalt uddannelsesmarked sprogspecifikke markedspladser international SEO',
  ...
  toolsRecommended: [
    {
      ...
      description: 'Skab ordsoegning på 11 sprog — demonstrerer hvordan et enkelt værktøj producerer flersproget indhold øjeblikkeligt. Start en gratis prøveversion med vandmærke for at se flersproget output i aktion.',
    },
    {
      appId: 'word-guess',
      title: 'Ordgæt-generator',
      description: 'Generér vokabularbaserede ordgæt-arbejdsark på tværs af flere sprog. Viser hvordan sprogfølsomt pædagogisk indhold kan nå internationale markeder. Start en gratis prøveversion med vandmærke.',
    },
    {
      appId: 'matching',
      title: 'Matching arbejdsark-generator',
      description: 'Byg matchingsarbejdsark med visuelle temaer der fungerer universelt på tværs af sprog. Billedbaseret indhold oversættes naturligt på tværs af markeder med minimal tilpasning. Start en gratis prøveversion med vandmærke.',
    },
    {
      appId: 'addition',
      title: 'Additions arbejdsark-generator',
      description: 'Skab matematik additionsarbejdsark der krydser sprogbarrierer naturligt da tal er universelle. Matematikprodukter er ideelle udgangspunkter for flersproget udvidelse. Start en gratis prøveversion med vandmærke.',
    },
  ],
