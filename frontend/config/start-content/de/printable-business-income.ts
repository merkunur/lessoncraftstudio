...
const content: StartContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: `Jede Plattform bedient unterschiedliche Käufertypen. Etsy erreicht Digital-Download-Shopper, die nach druckbaren Aktivitäten suchen. Amazon KDP erreicht Buchkäufer, die Aktivitätsbuch-Kategorien durchstöbern. Gumroad erreicht Käufer, die nach Druckprodukte suchen. Die beste Startplattform hängt von Ihrem Produktformat ab — digitale Downloads sprechen für Etsy, gedruckte Aktivitätsbücher für KDP, Druckprodukte für Gumroad. Die meisten erfolgreichen Verkäufer verkaufen schließlich auf mehreren Plattformen.`,
    },
    {
      question: `Kann ich die gleichen Arbeitsblätter gleichzeitig auf mehreren Plattformen verkaufen?`,
      answer: `Ja. Ihre kommerzielle Lizenz ist plattformunabhängig. Das gleiche Arbeitsblatt-Bundle kann als Etsy-Digital-Download gelistet, als Amazon KDP-Taschenbuch formatiert, auf Gumroad hochgeladen und auf Gumroad oder Ihrer eigenen Website verkauft werden. Jede Plattform erreicht unterschiedliche Käufer, sodass Multi-Plattform-Verkauf Ihre Gesamtzielgruppe erhöht, ohne zusätzliche Inhaltserstellung zu erfordern.`,
    },
    {
