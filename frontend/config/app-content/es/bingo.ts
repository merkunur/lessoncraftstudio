...
const content: AppContent = {
  seo: {
    primaryKeyword: 'crear y vender tarjetas de bingo con imágenes',
    secondaryKeywords: [
      ...
      'vender tarjetas de bingo imprimibles en Teachers Pay Teachers',
    ],
    lsiKeywords: [
    ...
    metaDescription:
      'Crea tarjetas de bingo con imágenes para Etsy, KDP y TPT. Lotes de tarjetas únicas, export ZIP, hojas de cantado, 104 temas. Prueba gratis con marca de agua.',
  },
    ...
    features: [
      {
        ...
        description:
          'Establece las filas y las columnas de forma independiente de 3 a 5, creando cuadrículas de 3×3 (9 celdas) hasta 5×5 (25 celdas). El valor predeterminado es 4×4 (16 celdas), ideal para tarjetas de bingo estándar. Una cuadrícula 3×3 es perfecta para partidas rápidas con menos elementos a seguir, mientras que una cuadrícula 5×5 ofrece la experiencia clásica de bingo con 25 celdas para partidas más largas. El área de la cuadrícula utiliza el 60 % de la altura disponible del lienzo (máximo 500 px) para proporciones óptimas de la tarjeta. Los controles independientes de filas y columnas te permiten crear cuadrículas no cuadradas como 3×5 o 5×3 para formatos de tarjetas de bingo únicos que destacan en los listados de los marketplaces.',
      },
      {
        title: 'Generación por lotes de 1 a 10 tarjetas de bingo únicas por ficha',
        description:
          'Genera de 1 a 10 tarjetas de bingo únicas en un solo lote. Cada tarjeta toma una selección aleatoria diferente del banco de imágenes, garantizando que dos tarjetas del mismo lote nunca tengan la misma disposición. Esto es esencial para el bingo: cada jugador necesita una tarjeta diferente para que el juego funcione. La primera tarjeta se muestra en el lienzo para una vista previa inmediata. Todas las tarjetas generadas están disponibles para la exportación por lotes. Este enfoque por lotes significa que puedes producir un conjunto completo de 10 tarjetas de bingo únicas con un solo clic en lugar de generarlas y guardarlas una por una.',
      },
      {
        title: 'Exportación ZIP por lotes de todas las tarjetas generadas como archivos JPEG individuales',
        description:
          'Exporta todas las tarjetas de bingo generadas en una sola descarga bingo_cards.zip. Cada tarjeta se guarda como un archivo JPEG individual de alta resolución dentro del archivo ZIP, nombrado secuencialmente para una organización fácil. Esta exportación por lotes elimina el tedioso proceso de descargar las tarjetas una por una — genera 10 tarjetas únicas, haz clic en un botón y recibe un conjunto completo de tarjetas de bingo listo para empaquetar en tu producto del marketplace. La exportación ZIP utiliza JSZip para una compresión fiable en todos los navegadores y funciona junto con los botones estándar de descarga individual en JPEG y PDF.',
      },
      {
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      {
        title: 'Actividades de bingo para el aula en TPT',
        description:
          'Construye sets de bingo listos para jugar con tarjetas únicas para cada jugador y hojas de cantado para el profesor. Los profesores que buscan actividades de bingo en TPT valoran los productos listos para usar — imprime las tarjetas, repártelas y empieza a jugar inmediatamente. Crea sets alineados con el currículo: bingo de vocabulario con el modo relleno de palabras, bingo de reconocimiento de imágenes con el modo relleno de imagen, y bingo en modo mixto para instrucción diferenciada. Incluye 10 tarjetas únicas por set (suficiente para un grupo pequeño) con una hoja de cantado. El modo relleno de palabras con los nombres localizados de las imágenes convierte el bingo en una actividad de repaso de vocabulario.',
        platform: 'Teachers Pay Teachers (teacherspayteachers.com)',
      },
      {
        title: 'Colecciones de bingo estacionales y de festividades',
        description:
          'Las 104 colecciones de imágenes temáticas cubren cada ocasión estacional y festiva — Navidad, Halloween, Pascua, San Valentín, vuelta al colegio, vacaciones de verano y más. El bingo es un juego naturalmente social que tiene picos durante las festividades cuando las familias y las aulas buscan actividades grupales. Publica los sets de bingo de Halloween en septiembre, las colecciones de Navidad en octubre y los packs de San Valentín en enero. Cada set estacional incluye múltiples tamaños de cuadrícula, variantes de relleno de imagen y de palabras, y hojas de cantado. Los productos de bingo estacionales obtienen precios premium durante sus ventanas de mayor demanda.',
  ...
  faq: [
    {
      ...
      answer:
        'Las filas y las columnas son configurables de forma independiente de 3 a 5, creando cuadrículas de 3×3 (9 celdas) hasta 5×5 (25 celdas). El valor predeterminado es 4×4 con 16 celdas. También puedes crear cuadrículas no cuadradas como 3×5 (15 celdas) o 5×3 (15 celdas) para formatos de tarjetas de bingo únicos. Las cuadrículas más pequeñas son ideales para partidas rápidas, mientras que las cuadrículas 5×5 ofrecen la experiencia clásica de bingo con más elementos a seguir.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Activa la casilla «Usar selección personalizada» en el panel Ajustes de la Tarjeta de Bingo para elegir manualmente qué imágenes específicas aparecen en el banco de cantado. Cuando está activada, haz clic en las imágenes en la Biblioteca de Imágenes para añadirlas a tu selección personalizada — un contador en tiempo real muestra «Seleccionados para cantado personalizado: X» a medida que eliges. Esto te da un control preciso sobre qué elementos aparecen en el juego de bingo, útil para actividades alineadas con el currículo o eventos temáticos que requieren vocabulario específico.',
    },
    {
