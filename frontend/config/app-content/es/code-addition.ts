...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Generador de mensajes cifrados | LessonCraftStudio',
  ...
  hero: {
    title: 'Generador de mensajes cifrados — Crea imprimibles para vender en Etsy y KDP',
    ...
    steps: [
      {
        ...
        description:
          'Abra el panel de Configuración de Página y elija un tamaño: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Cuadrado (1200×1200) o cualquier dimensión personalizada. Seleccione un color de fondo o elija un tema decorativo de la biblioteca de imágenes y ajuste la opacidad para mantener las ecuaciones legibles. Añada un marco de borde a juego para darle a sus fichas un aspecto profesional y pulido antes de empezar a añadir contenido.',
      },
      {
        title: 'Elija el modo y configure el código',
        description:
          'Abra la Configuración de Ejercicios y seleccione el Modo Clásico para descifrar código puro o el Modo Palabra Revelada para incorporar una palabra secreta. En Modo Clásico, establezca los valores mínimos y máximos de los sumandos (1–20) y elija cuántos símbolos-imagen únicos aparecen por ficha (2–5). En Modo Palabra Revelada, escriba una palabra secreta de hasta diez letras — la aplicación genera una ecuación por letra cuya suma corresponde a esa letra, más tres ecuaciones distractoras con sumas incorrectas para aumentar el desafío. Si el rango de números no puede producir suficientes sumas únicas para la palabra, la aplicación amplía automáticamente el rango.',
      },
      {
        title: 'Elija imágenes de la biblioteca temática',
        description:
          'Abra el panel de Biblioteca de Imágenes y explore 104 temas — desde animales y dinosaurios hasta espacio y festividades. Use la barra de búsqueda para encontrar imágenes específicas al instante. Las imágenes que selecciones se convierten en los símbolos-código de su ficha: cada imagen corresponde a un número oculto que los usuarios deben deducir. También puede subir sus propias imágenes PNG o JPEG para puzzles personalizados y de temporada.',
      },
      {
        title: 'Añada texto, títulos y opciones',
        description:
          'Use el panel de Herramientas de Texto para añadir un título, campos de nombre y fecha, instrucciones o cualquier texto personalizado. Elija entre siete fuentes claros, incluyendo Lexend Deca, Baloo 2, Fredoka y Quicksand. Active o desactive los números de ejercicio, muestra u oculta el encabezado y el borde, y habilita el modo escala de grises para impresión económica. Cada opción actualiza la vista previa del lienzo en tiempo real para que ajustes el diseño antes de exportar.',
      },
      {
        title: 'Genere la clave de respuesta y descargue',
        description:
          'Vaya a la pestaña de Clave de Respuesta y haga clic en Generar para crear una versión resuelta de su ficha. La clave de respuesta superpone cada número oculto directamente sobre su símbolo-imagen, haciendo las soluciones perfectamente claras para vendedores y padres. Exporte tanto la ficha como la clave de respuesta en JPEG de alta resolución o PDF listo para imprimir. Cada archivo se renderiza a más de 400 DPI para que sus puzzles de descifrar código se vean nítidos tanto impresos en casa como subidos a Etsy y Amazon KDP.',
      },
    ],
  },
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Active el modo Palabra Revelada y escriba una palabra secreta de hasta diez letras. El generador crea una ecuación de suma por cada letra de la palabra — la suma de cada ecuación corresponde a una letra específica en un cuadro de decodificación. Los usuarios resuelven las ecuaciones, buscan cada suma en el cuadro y deletrean la palabra oculta. Tres ecuaciones distractoras con sumas incorrectas se añaden automáticamente, dando a los usuarios problemas extra que no corresponden a ninguna letra y obligándolos a verificar cada respuesta. Si el rango de números no puede producir suficientes sumas únicas para todas las letras, la aplicación ajusta inteligentemente ampliando el rango o aumentando el número de sumandos de dos hasta cuatro.',
      },
      {
        title: 'Alfabetos sensibles al idioma para 11 lenguas',
        description:
          'El modo Palabra Revelada está completamente adaptado a cada idioma. En español, el alfabeto incluya á, é, í, ó, ú y ñ. El alemán añade Ä, Ö, Ü y ß. El francés incluya à, â, ç, è, é y más. Cada uno de los once idiomas admitidos — español, inglés, alemán, francés, portugués, italiano, neerlandés, sueco, danés, noruego y finés — use su propio alfabeto correcto para que las palabras secretas con caracteres acentuados funcionen de forma natural. Esto hace de la Suma Codificada el único generador de fichas en el mercado que produce puzzles de descifrar código multilingües, abriendo una enorme oportunidad para vendedores que apuntan a mercados de habla no inglesa.',
      },
      {
        title: 'Rangos de números y cantidad de símbolos configurables',
        description:
          'Establezca los valores mínimos y máximos de los sumandos de 1 a 20 para controlar la dificultad de los problemas. Elija entre dos y cinco símbolos-imagen únicos por ficha para ajustar la complejidad de la deducción — dos símbolos crean un puzzle accesible para usuarios más pequeños, mientras que cinco símbolos exigen un seguimiento cuidadoso a través de muchas ecuaciones. La combinación de rango de números y cantidad de símbolos le da un control preciso sobre la dificultad, permitiéndote crear conjuntos progresivos de fichas de fácil a experto en minutos.',
      },
      {
        title: '104 temas visuales con más de 3100 imágenes',
        description:
          'Explore una biblioteca de más de 3100 ilustraciones seleccionadas organizadas en 104 temas, incluyendo animales de granja, vida marina, vehículos, espacio, comida, deportes, dinosaurios, festividades y más. Cada imagen es de alta resolución y diseñada para una impresión clara y atractivo. En Suma Codificada, las imágenes sirven como los propios símbolos-código — los usuarios ven un gato, un cohete y un cupcake y deben deducir que el gato vale 3, el cohete 7 y el cupcake 5. Los puzzles temáticos son irresistibles para los niños y muy vendidos como productos imprimibles.',
      },
      {
        title: 'Clave de respuesta automática con superposición de números',
        description:
          'Genere una clave de respuesta completa con un solo clic. La clave de respuesta reproduce el diseño de su ficha y superpone el número oculto directamente sobre cada símbolo-imagen, haciendo la solución inmediatamente obvia. En modo Palabra Revelada, la clave también muestra la palabra decodificada e identifica qué ecuaciones eran distractoras. Exporte la clave como archivo separado para incluirla fácilmente en ediciones del vendedor, guías para padres o paquetes de productos comerciales.',
      },
      {
        title: 'Exportación lista para imprimir a 400+ DPI con opción escala de grises',
        description:
          'Descargue fichas y claves de respuesta como imágenes JPEG de alta resolución o documentos PDF listos para imprimir. El motor de exportación renderiza con un multiplicador 6x, produciendo más de 400 DPI en tamaños estándar. Habilita el modo escala de grises para versiones que se imprimen perfectamente en blanco y negro sin sacrificar la claridad de las imágenes. Los formatos Carta, A4, Cuadrado y personalizado están todos soportados, cubriendo todos los formatos de impresión comunes tanto para uso doméstico como comercial.',
      },
      {
        title: 'Edición completa del lienzo con deshacer y rehacer',
        description:
          'El lienzo Fabric.js integrado le permite arrastrar, redimensionar, rotar y reposicionar cada elemento de la página — texto, imágenes, bloques de ejercicio, bordes y fondos. Amplía y reduce con indicador de porcentaje para una colocación precisa, y use Ctrl+Z y Ctrl+Y para deshacer y rehacer ilimitados. Bloquea elementos en su lugar una vez posicionados, o desbloquea todo para rediseñar sobre la marcha. Orden de capas, herramientas de alineación y agrupación de objetos le dan la flexibilidad de una herramienta de diseño gráfico dentro de un generador de fichas.',
      },
    ],
  },
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'El modo Palabra Revelada le permite escribir una palabra secreta de hasta diez letras. El generador crea una ecuación por letra — la suma de cada ecuación corresponde a una letra específica en un cuadro de decodificación. Los usuarios resuelven las ecuaciones, buscan cada suma en el cuadro y deletrean la palabra oculta. Tres ecuaciones distractoras con sumas incorrectas se añaden automáticamente, así que los usuarios deben verificar cada respuesta. Combine la práctica de suma con ortografía y vocabulario en una sola actividad atractiva.',
    },
    {
      question: '¿Cómo se corresponden los símbolos-imagen con los números?',
      answer:
        'Al generar una ficha, la aplicación asigna aleatoriamente un número único a cada imagen seleccionada. Por ejemplo, con tres imágenes y un rango de 1–10, el gato podría valer 3, el cohete 7 y la estrella 5. La asignación es aleatoria cada vez que genere, así que incluso con las mismas imágenes y configuración, cada ficha produce un puzzle diferente. La clave de respuesta revela la correspondencia superponiendo cada número sobre su imagen.',
    },
    {
      question: '¿Qué rangos de números puedo configurar para los problemas de suma codificada?',
      answer:
        'Puede establecer los valores mínimos y máximos de 1 a 20. El rango debe ser lo suficientemente amplio para proporcionar números únicos a todos sus símbolos — si seleccione cinco símbolos, necesita al menos cinco números distintos en su rango. La aplicación valida esto automáticamente y te indicará si necesita ajustar el rango.',
    },
    {
      question: '¿Cuántos símbolos puedo usar por ficha?',
      answer:
        'Puede elegir entre dos y cinco símbolos-imagen únicos por ficha. Menos símbolos crean puzzles más fáciles que los usuarios más pequeños pueden resolver; más símbolos crean desafíos complejos que requieren rastrear múltiples incógnitas a través de muchas ecuaciones. Ajustar la cantidad de símbolos es la forma más sencilla de escalar la dificultad sin cambiar el rango de números.',
    },
    {
      question: '¿La Suma Codificada es sensible al idioma?',
      answer:
        'Sí — la Suma Codificada es la única aplicación sensible al idioma en la categoría Dominio de Matemáticas. En Modo Clásico, las fichas son puramente visuales y funcionan en cualquier idioma. Sin embargo, el modo Palabra Revelada use el alfabeto del idioma seleccionado para asignar sumas a letras. El español incluye á, é, í, ó, ú y ñ; el francés incluya à, â, ç, é y otros caracteres acentuados. Los once idiomas admitidos tienen sus alfabetos completos y correctos integrados.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'La clave de respuesta reproduce el diseño de la ficha y superpone el número oculto directamente sobre cada símbolo-imagen. En modo Palabra Revelada, la clave también muestra la palabra decodificada y marca qué ecuaciones eran distractoras. Puede exportarla como archivo JPEG o PDF separado, facilitando su inclusión en paquetes de productos comerciales o su distribución a padres.',
    },
    {
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Generador de Acertijos Matemáticos',
    },
    {
      pageType: 'bundle',
    ...
    },
    {
      ...
      anchorText: 'Cómo Crear Fichas de Suma que se Venden',
    },
    {
      pageType: 'guide',
    ...
    },
    {
      ...
      anchorText: 'Ideas de Imprimibles de Espacio para Fichas Educativas',
    },
    {
      pageType: 'idea',
    ...
    {
      pageType: 'tool',
      slug: 'generador-suma-codificada',
  ...
  visuals: {
    ...
    videoTitle: 'Cómo Crear Fichas de Suma Codificada — Tutorial Paso a Paso',
  },
};
