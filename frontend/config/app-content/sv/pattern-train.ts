...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Mönserseriegenerator | LessonCraftStudio',
  ...
  hero: {
    title: 'Mönserseriegenerator — Skapa utskrifter att sälja på Etsy och KDP',
  ...
  visuals: {
    heroImages: {
      primary: '/samples/swedish/pattern%20train/pattern-train-worksheet.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/swedish/pattern%20train/pattern-train-worksheet-1.webp',
      ...
      {
        src: '/samples/swedish/pattern%20train/pattern-train-worksheet-2.webp',
      ...
      {
        src: '/samples/swedish/pattern%20train/pattern-train-answer-key.webp',
