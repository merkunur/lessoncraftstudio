...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit de Lettres Mélangées | PDF Imprimables',
    metaDescription: 'Créez des fiches de lettres mélangées gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit lettres mélangées',
    secondaryKeywords: ["anagrammes gratuit à imprimer","reconstituer mots exercice","lettres mélangées PDF","jeu lettres enfants gratuit","orthographe ludique"],
    lsiKeywords: ["anagramme","reconstitution","orthographe","vocabulaire","mot mystère","déchiffrage","lettres","linguistique"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/word scramble/Word Scramble 1.jpeg',
      primaryAlt: 'Lettres mélangées gratuites',
    },
    sampleGallery: [
      { src: '/samples/english/word scramble/Word Scramble 1.jpeg', alt: 'Lettres mélangées', caption: 'Reconstituer les mots' }
    ],
    youtubeId: '36keBFzJbPo',
    videoTitle: 'Comment créer des fiches de lettres mélangées gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit de Lettres Mélangées',
    tagline: 'Créez des fiches de lettres mélangées et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de lettres mélangées transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de lettres mélangées autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de lettres mélangées en 10 étapes',
    steps: [
  ...
  faq: [
    { question: 'Ce générateur de lettres mélangées est-il vraiment gratuit ?', answer: 'Oui. La version gratuite inclut toutes les fonctionnalités — tous les modes, les 104 thèmes, l\'export PDF et les corrigés. La seule différence est un petit filigrane sur les fichiers exportés. Utilisez la version gratuite indéfiniment sans créer de compte.' },
  ...
  internalLinks: [
    { slug: 'gratuit-melange-mots-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit de Lettres Mélangées' },
    { slug: 'word-scramble', pageType: 'app' as const, anchorText: 'Générateur de Lettres Mélangées — Détails complets' },
  ],
};
