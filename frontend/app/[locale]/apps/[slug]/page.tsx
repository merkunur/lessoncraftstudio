    ...
    return {
      ...
      alternates: {
        ...
        languages: {
          ...
          'es': 'https://www.lessoncraftstudio.com/es/apps/adivinar-palabras-fichas',
          'it': 'https://www.lessoncraftstudio.com/it/apps/indovina-parole-schede',
          'pt': 'https://www.lessoncraftstudio.com/pt/apps/adivinhar-palavras-fichas',
...
export async function generateStaticParams() {
  ...
  const apps = [
    ...
    'malebog-arbejdsark', // Product page slug (Danish) - language-specific SEO slug for coloring
    ...
    'moenstertog-arbejdsark', // Product page slug (Danish) - language-specific SEO slug for pattern-train
    'moenstre-arbejdsark', // Product page slug (Danish) - language-specific SEO slug for pattern-worksheet
