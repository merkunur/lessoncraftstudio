...
const content: BundleContent = {
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      { src: '/samples/english/code%20addition/code-breaker-addition-1.webp', alt: 'Code addition puzzle with letter decoding', caption: 'Code Addition Puzzle' },
      { src: '/samples/english/more%20less/more-less-10.webp', alt: 'Greater than less than comparison worksheet', caption: 'More or Less Worksheet' },
      { src: '/samples/english/math%20puzzle/math-puzzles.webp', alt: 'Jigsaw grid math puzzle with equations', caption: 'Math Puzzle Worksheet' },
      { src: '/samples/english/math%20worksheet/math-worksheet-10.webp', alt: 'Visual algebra puzzle with image variables', caption: 'Math Worksheet Puzzle' },
    ],
