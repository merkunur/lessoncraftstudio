        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="pl-3"><Link href="/en/tools/activity-book-planner" className="hover:text-white inline-flex items-center gap-1.5 text-gray-400"><span aria-hidden="true">↳</span><span>KDP Activity Book Planner</span><span className="text-[9px] font-bold uppercase tracking-wider bg-primary text-white rounded px-1 py-0.5">New</span></Link></li>
              <li className="pl-3"><Link href="/en/tools/profit-hub" className="hover:text-white inline-flex items-center gap-1.5 text-gray-400"><span aria-hidden="true">↳</span><span>Printable Profit Hub</span><span className="text-[9px] font-bold uppercase tracking-wider bg-primary text-white rounded px-1 py-0.5">New</span></Link></li>
