...
const content: BlogContent = {
  seo: {
    ...
    secondaryKeywords: [
      'new parent worksheets sell Etsy',
      'first time parent printables business',
      'early learning printables market opportunity',
    ],
    lsiKeywords: [
      'toddler learning materials sell online',
  ...
  cta: {
    heading: 'Create Products New Parents Love',
    description: 'Build age-appropriate matching, coloring, and counting activities. Free trial with watermark to test designs.',
