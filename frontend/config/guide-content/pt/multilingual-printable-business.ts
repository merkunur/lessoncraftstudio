...
const content: GuideContent = {
  ...
  internalLinks: [
    ...
    { pageType: 'guide', slug: 'rendimentos-passivos-atividades', anchorText: 'Criar rendimentos recorrentes com atividades de exercícios' },
  ...
  toolsRecommended: [
    {
      ...
      description: 'Crie sopas de letras em 11 idiomas — demonstra como uma única ferramenta produz conteúdo multilingue instantaneamente. Inicie um teste grátis com marca de água para ver a produção multilingue em ação.',
    },
    {
      appId: 'word-guess',
      title: 'Gerador de adivinhar palavras',
      description: 'Gere atividades de vocabulário com adivinhas de palavras em múltiplos idiomas. Mostra como o conteúdo educativo sensível ao idioma pode alcançar mercados internacionais. Inicie um teste grátis com marca de água.',
    },
    {
      appId: 'matching',
      title: 'Gerador de atividades de correspondência',
      description: 'Crie atividades de correspondência com temas visuais que funcionam universalmente em todos os idiomas. O conteúdo baseado em imagens traduz-se naturalmente entre mercados com mínima adaptação. Inicie um teste grátis com marca de água.',
    },
    {
      appId: 'addition',
      title: 'Gerador de atividades de adição',
      description: 'Crie atividades de matemática de adição que atravessam as barreiras linguísticas naturalmente já que os números são universais. Os produtos de matemática são pontos de partida ideais para a expansão multilingue. Inicie um teste grátis com marca de água.',
    },
  ],
  ...
  visuals: {
    heroImage: {
      ...
      alt: 'Atividade de sopa de letras demonstrando o potencial de um negócio de imprimíveis multilingue em mercados internacionais',
    },
    samples: [
      {
        src: '/samples/portuguese/wordsearch/caça-palavras-2.webp',
        alt: 'Atividade de sopa de letras mostrando a capacidade multilingue para vendas internacionais de imprimíveis',
        caption: 'As sopas de letras podem ser geradas em 11 idiomas, ideais para a expansão multilingue',
      },
      {
        src: '/samples/portuguese/matching/encontre-os-pares-1.webp',
        alt: 'Atividade de correspondência com temas visuais que funcionam em todos os mercados linguísticos',
        caption: 'As atividades de correspondência visual usam imagens que se traduzem universalmente entre idiomas',
      },
      {
        src: '/samples/portuguese/addition/adição-divertida-1.webp',
        alt: 'Atividade de matemática de adição demonstrando apelo universal além das barreiras linguísticas',
        caption: 'As atividades de matemática atravessam as barreiras linguísticas naturalmente já que os números são universais em todos os mercados',
      },
    ],
    youtubeId: '36keBFzJbPo',
    videoTitle: 'Como criar atividades de sopa de letras multilingues para mercados internacionais',
  },
