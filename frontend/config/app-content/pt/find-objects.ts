...
const content: AppContent = {
  ...
  visuals: {
    heroImages: {
      primary: '/samples/portuguese/find%20objects/encontra-os-objetos-escondidos-1.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/portuguese/find%20objects/encontra-os-objetos-escondidos-1.webp',
      ...
      {
        src: '/samples/portuguese/find%20objects/encontra-o-diferente-1.webp',
      ...
      {
        src: '/samples/portuguese/find%20objects/encontra-os-objetos-escondidos-1-answer-key.webp',
