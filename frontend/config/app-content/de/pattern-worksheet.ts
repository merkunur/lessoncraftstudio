...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Muster-Generator | LessonCraftStudio',
  ...
  hero: {
    title: 'Muster-Generator — Druckvorlagen für Etsy & KDP erstellen',
  ...
  keyFeatures: {
    title: 'Hauptfunktionen des Muster-Arbeitsblatt-Generators',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Jede Übung auf der Seite hat ihren eigenen Mustertyp, Fragemodus und Thema — unabhängig von jeder anderen Übung konfiguriert. Ein einzelnes Arbeitsblatt kann mit einer AB-Lückenfeld-Aufwärmübung beginnen, durch ABC-Multiple-Choice-Übungen in der Mitte fortschreiten und mit einer ABCD-Lückenfeld-Herausforderung am Ende abschließen. Diese Pro-Übung-Unabhängigkeit macht separate Seiten für jede Schwierigkeitsstufe überflüssig. Verkäufer erhalten gestufte Übung auf einer Seite, und Verkäufer erstellen anspruchsvollere Produkte, die professionelles Designdenken demonstrieren — Misch-Schwierigkeits-Seiten erzielen höhere Preise als Einzel-Muster-Blätter.',
      },
      {
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          'Laden Sie eigene Bilder hoch, um Muster-Arbeitsblätter für jedes Fach oder jede Produktreihe zu erstellen — verwenden Sie Pflanzenwachstumsstufen für den Sachunterricht, geometrische Formen für den Mathematikunterricht oder Musiknotensymbole für den Musikunterricht. Neun Mustertypen lassen Sie die Übung an das Lernziel anpassen: AB zur Einführung, ABC zur Übung, ABCD zur Leistungsüberprüfung. Kombinieren Sie Lückenfeld- und Multiple-Choice-Übungen auf derselben Seite für abwechslungsreiche Übung. Aktivieren Sie Zufälligen Start und Zufällige Lückenposition, um für jeden Lernenden einzigartige Arbeitsblätter zu generieren. Der separate Lösungsschlüssel-Tab spart wahrgenommenen Mehrwert, und die Pro-Übung-Konfiguration ermöglicht gestufte Seiten für gemischte Fähigkeitsgruppen innerhalb derselben Produktionsrunde.',
