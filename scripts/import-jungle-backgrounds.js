/**
 * Background Import Script: Jungle
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-jungle-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'jungle_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/jungle',
  displayNames: {
    en: 'Jungle',
    de: 'Dschungel',
    fr: 'Jungle',
