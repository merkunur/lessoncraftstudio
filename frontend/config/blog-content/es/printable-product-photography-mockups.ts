...
const content: BlogContent = {
  seo: {
    ...
    titleTag: 'Fotografia de Producto para Imprimibles | LessonCraftStudio',
  ...
  hero: {
    ...
    tagline: 'Sus fotos son el vendedor silencioso que trabaja 24/7',
    description: 'Las fotos de producto son el factor de conversion mas importante despues del precio. Para imprimibles digitales donde el comprador no puede tocar el producto, las fotos deben comunicar calidad, contenido y valor instantaneamente. Aprenda a crear mockups profesionales y a tomar fotos de producto que convierten visitantes en compradores.',
  },
  category: 'how-to',
