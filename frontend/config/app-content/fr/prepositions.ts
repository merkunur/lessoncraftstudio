...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Fiches de Prépositions | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Fiches de Prépositions professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche de prépositions avec images montrant les positions',

    },
    sampleGallery: [
      { src: '/samples/english/prepositions/Prepositions 1.jpeg', alt: 'Exercice de prépositions illustré', caption: 'Prépositions de lieu' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Fiches de Prépositions thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Fiches de Prépositions est-il vraiment gratuit ?',
  ...
  internalLinks: [
    { slug: 'alphabet-train', pageType: 'app' as const, anchorText: 'Générateur de Train de l\'Alphabet' },
    { slug: 'wordsearch', pageType: 'app' as const, anchorText: 'Générateur de Mots Mêlés' },
    { slug: 'word-scramble', pageType: 'app' as const, anchorText: 'Générateur de Lettres Mélangées' },
    { slug: 'prepositions', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Fiches de Prépositions Gratuit' },
    { slug: 'literacy-bundle', pageType: 'bundle' as const, anchorText: 'Pack Lecture et Écriture Complet' }
  ],
};
