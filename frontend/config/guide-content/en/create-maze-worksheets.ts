...
const content: GuideContent = {
  ...
  hero: {
    ...
    tagline: 'A step-by-step tutorial for creating themed maze worksheets across three distinct game modes \u2014 ready to sell on Etsy, Amazon KDP, and Teachers Pay Teachers',
  ...
  platformTips: [
    ...
    {
      heading: 'Selling Maze Worksheets on Teachers Pay Teachers',
      content: 'Teachers Pay Teachers (TpT) buyers value maze worksheets as spatial reasoning activities that align with early math and geometry standards. Mazes also serve as classroom brain breaks \u2014 short puzzle activities that give students a mental reset between academic lessons.\n\nProduct descriptions on TpT should include: grade level range, specific skills practiced (spatial reasoning, counting, directional awareness, problem-solving), number of maze pages, maze modes included, whether answer keys are included, and any alignment to educational standards (spatial reasoning appears in geometry standards across most frameworks).\n\nPreview files: TpT allows preview uploads. Include 2\u20133 sample maze pages showing different modes \u2014 one Picture Pathway, one Classic Maze, and one Choose the Right Path. This demonstrates the variety in your product and helps teachers see exactly what they are buying.\n\nTpT-specific positioning: Frame mazes as "problem-solving centers" or "spatial reasoning stations." Teachers search for activities to fill specific classroom needs: "early finisher activities," "brain break puzzles," "indoor recess activities," "sub tub fillers," and "morning work." Maze worksheets fit all of these use cases.\n\nBundling on TpT: Create themed bundles by season or subject. A "Fall Maze Activity Pack" with harvest, pumpkin, and forest themes, or a "Transportation Maze Bundle" with vehicles, planes, and boats. Teachers buy bundles to stock their resource libraries for extended periods.',
    },
  ],
  ...
  faq: [
    ...
    {
      question: 'Does the generator create answer keys for all maze modes?',
      answer: 'Yes. Every maze mode generates an automatic answer key showing the correct solution path highlighted from start to finish. Classic Maze answer keys include an additional feature: the total count of each collectible image along the solution path. Answer keys export as both PDF and JPEG, separate from the worksheet file.',
    },
    {
      question: 'Can I sell the maze worksheets I create on Etsy and Amazon KDP?',
      answer: 'Yes. A commercial license gives you full rights to sell generated maze worksheets on any platform including Etsy, Amazon KDP, Teachers Pay Teachers, Gumroad, Creative Fabrica, and your own website. There are no royalty fees or per-sale charges. You keep 100% of your sales revenue after marketplace fees.',
    },
    {
      question: 'What is the refund policy for commercial licenses?',
      answer: 'Every generator offers a free trial with watermark so you can test all three game modes, create sample mazes at every grid size, and evaluate output quality before purchasing. Because you can fully evaluate the product before buying, all commercial license sales are final. This is standard practice for digital product tools where the full product can be previewed before purchase.',
    },
  ],
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'Word search puzzles are one of the highest-demand printable products. Combine with mazes for comprehensive puzzle activity bundles.',
    },
    {
      slug: 'create-matching-worksheets',
      title: 'Create Matching Worksheets',
      description: 'Expand your puzzle catalog with matching activities that use the same themed images. Bundle matching worksheets with mazes for variety packs.',
    },
  ],
  ...
  toolsRecommended: [
    {
      ...
      description: 'The primary tool for this guide. Create maze worksheets in three game modes with themed images, configurable grid sizes, wall customization, collectible counting, and automatic answer keys.',
    },
    {
      appId: 'sudoku',
      title: 'Picture Sudoku Generator',
      description: 'A Puzzles and Logic companion that creates visual sudoku puzzles. Bundle picture sudoku with mazes for comprehensive puzzle activity collections.',
    },
    {
      appId: 'treasure-hunt',
  ...
  visuals: {
    heroImage: { src: '/samples/english/picture-path/sample-1.jpeg', alt: 'Maze worksheet showing a themed picture path activity with start and end images for kids' },
    samples: [
      { src: '/samples/english/picture-path/sample-1.jpeg', alt: 'Picture pathway maze worksheet with themed images for preschool and kindergarten', caption: 'Picture Pathway mode: children follow a visual path from start image to end image through themed decorations' },
      { src: '/samples/english/picture-path/sample-2.jpeg', alt: 'Classic maze worksheet with collectible counting and answer key', caption: 'Classic Maze mode with collectible images and automatic answer key showing solution path and counts' },
    ],
