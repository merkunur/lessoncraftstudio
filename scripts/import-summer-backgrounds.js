/**
 * Background Import Script: Summer
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-summer-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'summer_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/summer',
  displayNames: {
    en: 'Summer',
    de: 'Sommer',
    fr: 'Été',
