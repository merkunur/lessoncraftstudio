...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'first-grade': {
      ...
      snippetAnswer: 'Vartaloaiheiset työlehdet ensimmäiselle luokalle (6–7-vuotiaat) opettavat kehon järjestelmien perusteita (luusto, lihakset, aistit), vahvistavat mittaamista omien kehotilastojen kautta sekä kehittävät terveyslukutaitoa. POPS 2014:n ympäristöopin ja terveystiedon tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Ensimmäisellä luokalla vartaloteema saa anatomisen syvyyden, koska kuusi- ja seitsemänvuotiaat kykenevät ymmärtämään, että kehossa on eri järjestelmiä jotka tekevät eri asioita. POPS 2014:n ympäristöoppi edellyttää, että oppilaat tutustuvat ihmiskehon rakenteeseen ja toimintaan. Ensimmäisen luokan oppilas lukee tietotekstejä aisteista, luustosta ja lihaksista itsenäisesti. Matemaattisesti mittaaminen konkretisoituu omien kehotilastojen kautta: pituus, käden pituus, sykeen laskeminen. Vertailu kehittyy, kun oppilas mittaa omia mittojaan ja vertailee luokkakavereihin: kenen käsi on pisin? Aistikokeet (maku-, kuulo-, tuntoharjoitukset) yhdistävät luonnontieteen ja kokemuksellisuuden. Terveystietoisuus kasvaa, kun oppilas ymmärtää miten keho toimii ja miten sitä kannattaa hoitaa. Kirjoittaminen etenee kehokuvauslauseisiin.',
      developmentalMilestones: [
        { milestone: 'Kehon järjestelmien perusymmärrys (6–7-vuotiaat tunnistavat kehon pääjärjestelmät)', howWeAddress: 'Anatomiakarttatehtävät, joissa oppilas nimeää kehon osia ja yhdistää ne toimintoon, rakentavat kokonaisymmärrystä kehosta' },
        { milestone: 'Omien kehotilastojen mittaaminen (ensimmäisen luokan oppilaat mittaavat pituutta, painoa ja syketta)', howWeAddress: 'Mittaustehtävät, joissa oppilas mittaa käden pituuden, sykeen ja pituuden ja kirjaa tulokset, yhdistävät mittaamisen itsetuntemukseen' },
        { milestone: 'Aistien tutkiminen kokeellisesti (kuusi- ja seitsemänvuotiaat tekevät aistikokeita)', howWeAddress: 'Aistikoetehtävät (makutesti, tuntolaatikko, kuulotesti), joissa oppilas kirjaa tulokset, yhdistävät tieteen ja kokemuksellisuuden' },
        { milestone: 'Terveyslukutaidon alkeet (ensimmäisen luokan oppilaat ymmärtävät terveyden perusperiaatteita)', howWeAddress: 'Terveyspohdintatehtävät, joissa oppilas kirjoittaa miten keho pysyy terveenä (uni, liikunta, ravinto), kehittävät terveyslukutaitoa' },
      ],
      differentiationNotes: 'Tukea tarvitseville ensimmäisen luokan oppilaille tarjoa anatomiakartat yksinkertaistettuina viidellä kehon osalla, anna mittaamisessa aikuisen avustus ja käytä terveyspohdinnassa valmiita lausepohjia. Edistyneille ensimmäisen luokan oppilaille laajenna anatomia sisäelimiin (sydän, keuhkot, aivot), lisää sykemittauksen vertailu levossa ja liikunnan jälkeen ja haasta kirjoittamaan terveysopas kolmella kappaleella.',
      parentTakeaway: 'Ensimmäisen luokan vartalotyölehdet tekevät omasta kehosta tutkimuskohteen. Mittatkaa yhdessä lapsen pituus ja käden pituus ja verratkaa vanhemman mittoihin. Tunnustelkaa luita ja lihaksia: missä tuntuu kova luu, missä pehmIää lihas? Laskekaa syke levossa ja juoksun jälkeen: miksi se muuttuu? Tärkeintä on opettaa ihmettelemään omaa kehoa ja ymmärtämään, miten se toimii.',
      classroomIntegration: 'Vartalotyölehdet ovat ensimmäisen luokan ympäristöopin ja terveystiedon monipuolinen työväline: tunnilla tutkitaan kehon osia, mitataan ja vertaillaan, aistipisteissä tehdään kokeita ja kirjoitustuokiossa tuotetaan terveystekstejä. Liikuntatunnilla harjoitellaan sykeen laskemista. POPS 2014:n ympäristöopin, terveystiedon ja tutkivan oppimisen tavoitteet yhdistyvät.',
      assessmentRubric: [
        { skill: 'Kehon osien ja järjestelmien tuntemus', emerging: 'nimeää viisi kehon osaa kuvasta', proficient: 'nimeää kehon pääjärjestelmät (luusto, lihakset, aistit) ja selittää niiden tehtävän', advanced: 'kuvaa järjestelmien yhteistyötä (lihakset liikuttavat luita, aivot ohjaavat) ja selittää yhteyden terveyteen' },
        { skill: 'Mittaaminen ja vertailu', emerging: 'mittaa yhden kehomitan aikuisen avustuksella', proficient: 'mittaa itsenäisesti kolme kehomittaa ja vertailee tuloksia luokkakaveriin', advanced: 'mittaa järjestelmällisesti, taulukoi luokan tulokset ja tekee johtopäätöksiä vaihtelusta' },
        { skill: 'Terveyslukutaito', emerging: 'nimeää yhden terveen elämäntavan', proficient: 'selittää kolme terveyden osa-aluetta (uni, liikunta, ravinto) ja niiden merkityksen', advanced: 'pohtii omia valintojaan, arvioi niiden vaikutusta terveyteen ja ehdottaa parannuksia perustellusti' },
      ],
    },
    'second-grade': {
      ...
      snippetAnswer: 'Vartaloaiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät elimistön perusjärjestelmien ymmärrystä, kehittävät terveysviestintää ja terveiden elintapojen suunnittelua sekä vahvistavat mittaamista ja datan tulkintaa kehon mittauskontekstissa. POPS 2014:n terveystiedon ja ympäristöopin vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla vartaloteema siirtyy pintatasolta elimistön toimintaan, koska seitsemän- ja kahdeksanvuotiaat kykenevät ymmärtämään yksinkertaistettuja järjestelmämalleja. POPS 2014:n päättötavoitteet edellyttävät, että oppilas ymmärtää terveyttä edistäviä valintoja ja kehon perusrakennetta. Toisen luokan oppilas tutkii pääjärjestelmiä: luusto tukee, lihakset liikuttavat, sydIän pumppaa verta, keuhkot tuovat happea. Kehon mittaukset tarjoavat matemaattisen kontekstin: sykkeen laskeminen, hengitystaajuuden mittaaminen, pituuden ja painon seuranta. Kertolaskun soveltaminen: jos sydIän lyö 10 kertaa 10 sekunnissa, montako kertaa minuutissa? Terveysviestintä kehittyy: oppilas kirjoittaa terveysohjeen tai julisteen terveellisistä elintavoista. Terveiden elintapojen suunnittelu konkretisoituu viikko-ohjelmaksi: uni, liikunta, ravinto, lepotauot.',
      developmentalMilestones: [
        { milestone: 'Elimistön pääjärjestelmien ymmärtäminen (7–8-vuotiaat hahmottavat luuston, lihasten, verenkierron ja hengityksen perusperiaatteet)', howWeAddress: 'Järjestelmätehtävät, joissa oppilas merkitsee järjestelmän osat kuvaan ja selittää niiden tehtävät, rakentavat anatomian perustaa' },
        { milestone: 'Kehon mittaukset ja datan tulkinta (toisen luokan oppilaat mittaavat sykkettä ja hengitystaajuutta)', howWeAddress: 'Mittaustehtävät, joissa oppilas mittaa sykettään levossa ja rasituksessa, kokoaa datan taulukkoon ja piirtää diagrammin, yhdistävät terveystiedon ja matematiikan' },
        { milestone: 'Terveiden elintapojen viikkosuunnittelu (seitsemän- ja kahdeksanvuotiaat suunnittelevat terveyttä tukevan viikon)', howWeAddress: 'Suunnittelutehtävät, joissa oppilas laatii viikko-ohjelman unirytmillIä, liikunnalla, ravinnolla ja levolla, kehittävät itsensä huolehtimisen taitoja' },
        { milestone: 'Terveysviestintä: ohjeen tai julisteen tuottaminen (toisen luokan oppilaat viestivät terveydestä)', howWeAddress: 'Viestintätehtävät, joissa oppilas kirjoittaa terveysohjeen tai suunnittelee terveysjulisteen luokkaan, kehittävät vaikuttavaa viestintää' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa järjestelmät kahteen (luusto ja lihakset), anna mittaamisessa selkeät ohjekuvat ja tarjoa viikkosuunnitelmaan valmis pohja täytettäväksi. Edistyneille toisen luokan oppilaille lisää ruuansulatusjärjestelmä, laajenna sykemittaus rasitustason analyysiksi ja haasta kirjoittamaan terveyskampanja luokan seinIälle.',
      parentTakeaway: 'Toisen luokan vartalotyIölehdet tekevät terveydestä tutkimuskohteen. Mittatkaa yhdessä sykettä levossa ja liikunnan jIälkeen: miksi se muuttuu? Suunnitelkaa yhdessä terveyttä tukeva viikko-ohjelma. Pohtikaa unen merkitystä: montako tuntia seitsemänvuotiaan pitäisi nukkua? Tärkeintä on opettaa, että omasta kehosta huolehtiminen on jokapIäiväinen taito.',
      classroomIntegration: 'Vartalotyyölehdet integroituvat toisen luokan terveystietoon, liikuntaan ja matematiikkaan: liikuntatunnilla mitataan sykkeitä ja hengitystaajuutta, matikkatuokiolla kootaan data diagrammeiksi, äidinkielessä kirjoitetaan terveysohjeita ja julisteita. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa vartaloteema osoittaa terveyden lukutaidon ja itsensä huolehtimisen taitoja.',
      assessmentRubric: [
        { skill: 'Elimistön järjestelmien ymmärtäminen', emerging: 'nimeää muutaman kehonosan mutta ei selitIä järjestelmien toimintaa', proficient: 'nimeää pääjärjestelmät, merkitsee ne kuvaan ja selittää perustehtIävät', advanced: 'selittää järjestelmien yhteistoiminnan ja ymmärtää miten liikunta vaikuttaa eri järjestelmiin' },
        { skill: 'Kehon mittaaminen ja datan tulkinta', emerging: 'mittaa sykeen aikuisen avustuksella ja kirjaa yhden tuloksen', proficient: 'mittaa sykeen levossa ja rasituksessa itsenäisesti, kokoaa datan taulukkoon ja piirtää diagrammin', advanced: 'analysoi sykedatan, tekee johtopäätöksiä rasituksen vaikutuksesta ja vertailee tuloksia' },
        { skill: 'Terveysviestintä', emerging: 'kertoo yhden terveysohjeen suullisesti', proficient: 'kirjoittaa selkeän terveysohjeen tai suunnittelee julisteen perusteluineen', advanced: 'suunnittelee monipuolisen terveyskampanjan faktoilla, kuvilla ja vaikuttavalla viestinnällä' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Kehoaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät elinyhteisöjen järjestelmällistä ymmärrystä (verenkierto, hengitys, ruoansulatus), vahvistavat mittaamisen ja datankäsittelyn taitoja kertolaskulla sekä opettavat terveystiedon tutkimusraportin kirjoittamista. POPS 2014:n vuosiluokkien 3–6 terveystiedon tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla kehoteema kehittyy yksittäisten osien tunnistamisesta kehoN järjestelmien yhdistetyksi analyysiksi, kun kahdeksan- ja yhdeksänvuotiaat kykenevät ymmärtämään elimistön järjestelmien yhteistyötä. Verenkiertoelimistön tutkiminen yhdistää biologian ja matematiikan: sydän lyIö noin 72 kertaa minuutissa, montako kertaa tunnissa (72 × 60 = 4320). Hengityselimistön ja verenkiertoelimistön yhteistyön ymmärtäminen kehittää järjestelmäajattelua. Ruoansulatuselimistön analysointi yhdistää ravitsemustiedon kehollisuuteen. Mittaamisen taidot kehittyvät: sykemittaus, hengitysfrekvenssi, kasvun seuranta. Tutkimusraportti omasta kehodatasta yhdistää kokeelliset mittaukset lähdetietoon. Terveysvalintojen tieteellinen perustelu (uni, liikunta, ravinto) kehittää kriittistä terveysajattelua.',
      developmentalMilestones: [
        { milestone: 'Elinyhteisöjen järjestelmällinen ymmärtäminen (8–9-vuotiaat hahmottavat järjestelmien yhteistYön)', howWeAddress: 'Järjestelmäanalyysitehtävät, joissa oppilas tutkii verenkierto-, hengitys- ja ruoansulatuselimistöä, selittää niiden yhteistyön ja piirtää järjestelmäkaavion' },
        { milestone: 'Kehodatan mittaaminen ja käsittely kertolaskulla (kolmannen luokan oppilaat keräävät ja analysoivat dataa)', howWeAddress: 'Mittaustehtävät, joissa oppilas mittaa sykkeen ja hengitysfrekvenssin, laskee kertolaskulla tunti- ja vuorokausIarvot ja esittää tulokset taulukossa' },
        { milestone: 'Tutkimusraportin kirjoittaminen omasta kehodatasta (kahdeksan- ja yhdeksänvuotiaat raportoivat tieteellisesti)', howWeAddress: 'Kehotutkimusprojektit, joissa oppilas suunnittelee mittauksen (esim. syke levossa ja rasituksessa), kerää datan ja kirjoittaa raportin lähdeviittauksineen' },
        { milestone: 'Terveysvalintojen tieteellinen perusteleminen (kolmannen luokan oppilaat argumentoivat terveystiedolla)', howWeAddress: 'Terveysargumentointitehtävät, joissa oppilas tutkii unen, liikunnan tai ravinnon vaikutuksia, kerää näyttöä ja kirjoittaa perustellun suosituksen' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille rajaa järjestelmät yhteen kerrallaan valmiilla kaaviolla, anna mittaamiseen selkeät ohjeet ja tarjoa raporttiin valmis rakenne. Edistyneille kolmannen luokan oppilaille laajenna analyysi järjestelmien vuorovaikutukseen sairauksien yhteydessä, lisää tilastollista vertailua ja haasta suunnittelemaan terveysviestintäkampanja tieteellisine perusteluineen.',
      parentTakeaway: 'Kolmannen luokan kehotyölehdet tekevät biologiasta henkilökohtaista. Mittatkaa yhdessä syke levossa ja juoksun jälkeen — mikä ero? Laskekaa kertolaskulla: jos sydän lyö 70 kertaa minuutissa, montako kertaa tunnissa? Tutkikaa yhdessä mitä tapahtuu kun syöt omenan — mistä energia tulee. Tärkeintä on ymmärtää oma keho ihmeällisenä järjestelmänä ja tehdä tietoisia terveysvalintoja.',
      classroomIntegration: 'Kehotyölehdet yhdistävät kolmannen luokan ympäristöopin, matematiikan ja terveystiedon: elinyhteisöjakso järjestelmäanalyyseinä, kehodatan mittaaminen ja kertolaskuharjoitukset, tutkimusraportti omista mittauksista ja terveysvalintojen argumentointi. POPS 2014:n vuosiluokkien 3–6 terveyden ja ihmisen biologian tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Elinyhteisöjen ymmärrys', emerging: 'nimeää yksittäisiä elimIä mutta ei hahmota järjestelmiä', proficient: 'selittää verenkierto-, hengitys- ja ruoansulatusjärjestelmän toiminnan ja niiden yhteistyön', advanced: 'analysoi järjestelmien vuorovaikutusta syvemmin ja selittää häiriöiden vaikutuksia koko elimistöön' },
        { skill: 'Kehodatan mittaaminen ja analysointi', emerging: 'mittaa sykkeen mutta ei laske pidemmän aikaVälin arvoja', proficient: 'mittaa ja laskee kertolaskulla sykeen ja hengityksen tunti- ja vuorokausIarvot', advanced: 'vertailee mittaustuloksia eri olosuhteissa, tunnistaa muuttujien vaikutuksen ja esittää johtopäätöksiä' },
        { skill: 'Terveysvalintojen tieteellinen perustelu', emerging: 'tietää että liikunta on terveellistä mutta ei selItä miksi', proficient: 'perustelee terveysvalintoja tieteellisellä tiedolla ja kirjoittaa jäsennellyn suosituksen', advanced: 'analysoi terveyssuosituksia kriittisesti, vertailee lähteitä ja suunnittelee kokonaisvaltaisen hyvinvointiohJelman' },
      ],
    },
  },
