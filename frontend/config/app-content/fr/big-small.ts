...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur Grand et Petit | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Grand et Petit professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche comparaison de tailles avec images colorées',

    },
    sampleGallery: [
      { src: '/samples/english/big small/Big Small 1.jpeg', alt: 'Exercice grand et petit illustré', caption: 'Comparer les tailles' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Grand et Petit thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur Grand et Petit est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'big-small', pageType: 'tool' as const, anchorText: 'Essayer Générateur Grand et Petit Gratuit' },
