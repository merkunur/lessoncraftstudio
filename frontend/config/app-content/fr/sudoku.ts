...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Sudoku pour Enfants | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Sudoku pour Enfants professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Sudoku 4x4 pour enfants avec images colorées',

    },
    sampleGallery: [
      { src: '/samples/english/sudoku/Sudoku 1.jpeg', alt: 'Sudoku images pour enfants', caption: 'Sudoku 4x4 avec images' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Sudoku pour Enfants thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Sudoku pour Enfants est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'sudoku', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Sudoku pour Enfants Gratuit' },
