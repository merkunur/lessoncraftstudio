...
const content: ToolContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'générateur de fiches cherche objets imprimables licence commerciale',
      'créateur de fiches objets cachés pour KDP et Etsy',
    ],
    lsiKeywords: [
      'Je Vois Je Vois Trouve l\'Intrus double mode d\'activité',
      'algorithme placement sans chevauchement dimensionnement adaptatif',
  ...
  hero: {
    title: 'Créateur de Fiches Cherche Objets',
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Sélectionnez entre deux modes dans le panneau Sélection d\'Objets. Le mode Je Vois Je Vois (par défaut) crée des scènes d\'objets cachés en placement libre où les images sont dispersées sur la page par un algorithme sans chevauchement — pas de grille, juste une scène visuelle naturelle où les élèves cherchent des objets spécifiques guidés par une légende en bas. Le mode Trouve l\'Intrus dispose des images appariées en rangées avec des éléments non appariés mélangés pour des activités de discrimination visuelle où les élèves identifient les images sans partenaire correspondant. Chaque mode produit un type différent de fiche cherche-et-trouve à partir de la même bibliothèque d\'images.',
      },
      {
        title: 'Configurer les Quantités d\'Objets pour le Contrôle de Difficulté',
        description: 'En mode Je Vois Je Vois, configurez 1–5 objets cachés (les cibles que les élèves doivent trouver) et 8–12 objets distracteurs (les images environnantes qui remplissent la scène). Commencez avec 1–2 objets cachés et 8 distracteurs pour des fiches faciles adaptées aux plus jeunes, et augmentez à 5 objets cachés parmi 12 distracteurs pour des scènes stimulantes pour les élèves avancés. En mode Trouve l\'Intrus, réglez 8–12 images appariées et 1–5 éléments non appariés (intrus). Le nombre d\'objets est votre contrôle principal de difficulté — moins de cibles pour des produits simples, plus de cibles pour des collections de défis premium.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Combinez les deux modes d\'activité dans des packs variété premium. Chaque pack comprend des scènes Je Vois Je Vois où les élèves cherchent des objets spécifiques dans une scène dispersée guidés par la légende en bas, plus des fiches Trouve l\'Intrus où les élèves identifient les éléments non appariés parmi des ensembles appariés. Cette combinaison cible deux compétences cognitives différentes — la recherche visuelle et la discrimination visuelle — dans un seul produit. Les packs mixtes se vendent à des prix plus élevés car ils offrent plus de variété d\'activités et couvrent plus d\'objectifs d\'apprentissage que les produits à mode unique.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'En mode Je Vois Je Vois, configurez 1–5 objets cachés (les cibles que les élèves doivent trouver) et 8–12 objets distracteurs (les images environnantes qui remplissent la scène). Commencez avec 1–2 objets cachés et 8 distracteurs pour des fiches faciles adaptées aux plus jeunes, et augmentez à 5 objets cachés parmi 12 distracteurs pour des scènes stimulantes. En mode Trouve l\'Intrus, configurez 8–12 images appariées (chacune apparaît avec un partenaire correspondant) et 1–5 éléments non appariés que les élèves doivent identifier. Les quantités d\'objets sont votre contrôle principal de difficulté.',
    },
    {
      question: 'Comment fonctionne le corrigé auto-généré ?',
      answer: 'Le générateur utilise un système à double canevas avec un onglet Fiche et un onglet Corrigé. La fiche montre la scène d\'objets cachés sans marquage — les élèves cherchent et entourent les objets eux-mêmes. Le corrigé reproduit la disposition identique et dessine des cercles rouges autour des objets corrects : les cibles cachées en mode Je Vois Je Vois et les éléments non appariés en mode Trouve l\'Intrus. Les cercles sont dimensionnés 3–5 px plus grands que l\'objet pour une visibilité claire. Téléchargez chaque version indépendamment avec quatre boutons dédiés : fiche JPEG, fiche PDF, corrigé JPEG et corrigé PDF.',
    },
    {
