...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'missing-pieces-worksheets', anchorText: 'Manglende Brikker Generator' },
    { pageType: 'app', slug: 'grid-match-worksheets', anchorText: 'Gitter-Matchning Generator' },
