...
const content: BlogContent = {
  seo: {
    ...
    metaDescription: 'Bestandsformaten voor Printables: PDF vs JPEG Gids. Praktische strategieën en bewezen technieken voor printable verkopers in 2026.',
  },
  hero: {
    title: 'Bestandsformaten voor Printables: PDF vs JPEG Gids',
    tagline: 'Het juiste bestandsformaat kan uw verkoop maken of breken',
    description: 'Het juiste bestandsformaat kan uw verkoop maken of breken. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
