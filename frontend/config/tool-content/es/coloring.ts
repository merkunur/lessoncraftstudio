...
const content: ToolContent = {  seo: {
  ...
  tutorial: {
    ...
    steps: [
      {
        title: 'Abre el Generador de Páginas para Colorear',
        description: 'Haz clic en "Prueba Gratis Ahora" para abrir el generador de páginas para colorear en tu navegador. La herramienta carga instantáneamente con una barra lateral de ajustes a la izquierda y un lienzo de vista previa en vivo a la derecha. Sin crear cuenta, sin descargar software, sin instalación — empieza a crear páginas para colorear de inmediato en el lienzo libre.',
      },
      {
        title: 'Configura el Diseño de Página y el Borde',
      ...
      {
        title: 'Explora la Biblioteca de Imágenes y Añade Imágenes',
        description: 'Abre el panel de Biblioteca de Imágenes y explora 104 colecciones temáticas con más de 3.100 ilustraciones a color — animales, comida, vehículos, naturaleza, festividades, profesiones y docenas más. Usa el menú desplegable de temas para filtrar por categoría o escribe en el campo de búsqueda para encontrar imágenes específicas en todos los temas. Haz clic en cualquier imagen para colocarla directamente en tu lienzo como un objeto completamente movible y redimensionable. Sube tus propias imágenes PNG, JPG o GIF junto al contenido de la biblioteca para máxima flexibilidad creativa.',
      },
      {
        title: 'Organiza Imágenes en el Lienzo Libre',
        description: 'Arrastra imágenes a cualquier parte del lienzo abierto — sin ajuste a cuadrícula, sin restricciones de plantilla, sin casillas predeterminadas. Redimensiona arrastrando las esquinas, rota a cualquier ángulo y superpone imágenes para crear composiciones en capas. Usa los controles de capas para gestionar el orden de apilamiento, bloquea elementos terminados para evitar movimientos accidentales, y usa zoom del 25% al 300% para colocación precisa. Deshaz y rehaz hasta 20 estados con Ctrl+Z y Ctrl+Y para experimentar libremente con cada diseño.',
      },
      {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Selecciona un borde decorativo temático de la biblioteca de bordes para enmarcar cada página para colorear con una apariencia consistente y profesional. Los bordes con opacidad ajustable añaden un toque visual pulido sin abrumar el contenido para colorear. Un estilo de borde consistente en todo un paquete de productos crea un aspecto cohesivo que los compradores asocian con calidad — un pequeño detalle que impacta significativamente en el valor percibido del producto y las valoraciones.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'El Generador de Páginas para Colorear te da un lienzo completamente abierto sin cuadrículas, sin plantillas, sin casillas y sin diseños predeterminados. Cada imagen se coloca exactamente donde la arrastras. Puedes superponer imágenes, rotarlas a cualquier ángulo, redimensionar libremente y crear composiciones en capas. Las herramientas de plantillas te limitan a posiciones fijas y producen resultados de aspecto idéntico. El enfoque de lienzo libre significa que cada página para colorear que creas es única e imposible de replicar con generadores de plantillas.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Cambia al modo Dibujo y dibuja directamente en el lienzo usando el pincel a mano alzada. Elige cualquier color de pincel con el selector de color y ajusta el tamaño del pincel de 1 a 50 píxeles. Los trazos a mano alzada se convierten en objetos del lienzo que puedes superponer con imágenes de la biblioteca. Dibuja bordes personalizados, garabatos decorativos, ilustraciones originales o elementos conectores. La herramienta a mano alzada crea páginas híbridas para colorear que combinan contenido curado de la biblioteca con tu propia obra original.',
    },
    {
      question: '¿Las páginas para colorear dependen del idioma?',
      answer: 'No. El Generador de Páginas para Colorear produce resultados puramente visuales sin texto en la página para colorear en sí. Cambiar el idioma en el generador solo afecta las etiquetas de la interfaz, no la ficha exportada. Esto hace que tus páginas para colorear sean universalmente vendibles sin traducción. Un solo archivo de producto sirve para todos los mercados del mundo.',
    },
    {
    ...
    },
    {
      ...
      answer: 'La biblioteca de imágenes incluye 104 colecciones temáticas con más de 3.100 ilustraciones a color — animales, comida, vehículos, naturaleza, festividades, profesiones y docenas más. Sube imágenes personalizadas en PNG, JPG o GIF junto al contenido de la biblioteca. Exporta como JPEG de alta resolución o PDF listo para imprimir a 300 DPI. Los tamaños de página incluyen Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Cuadrado (1200×1200) y dimensiones personalizadas. Activa la escala de grises para una salida con ahorro de tinta.',
    },
    {
      question: '¿Puedo vender las páginas para colorear creadas con esta herramienta de forma comercial?',
      answer: 'Sí. Con una licencia comercial, tienes derechos completos para vender páginas para colorear como descargas digitales en Etsy, libros para colorear impresos en Amazon KDP, recursos para venta en línea en Hotmart o a través de cualquier otro canal de venta. El lienzo libre, el dibujo a mano alzada, los asistentes del mercado y las 104 colecciones temáticas de imágenes te dan todo lo necesario para crear productos profesionales que compiten en categorías de páginas para colorear en todos los principales mercados.',
    },
    {
