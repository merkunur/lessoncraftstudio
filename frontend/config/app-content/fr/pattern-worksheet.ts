...
const content: AppContent = {
  seo: {
    ...
    lsiKeywords: [
      'produits numériques fiches séquences logiques pour entrepreneurs',
      'fiches de reconnaissance de motifs imprimables à usage commercial',
      'générateur de fiches séquences logiques neuf types de motifs',
    ],
    titleTag: 'Générateur Fiches Séquences Logiques | Vendre',
    metaDescription:
      'Créez des fiches de séquences logiques à vendre sur Etsy, KDP et TPT. Neuf types de motifs, deux modes de question, configuration par exercice, 104 thèmes. Essai gratuit avec filigrane.',
  },
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Créateur de Fiches de Séquences Logiques',
    },
    {
      pageType: 'start',
