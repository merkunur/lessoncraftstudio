...
const content: GuideContent = {
  ...
  examples: [
    ...
    },
    {
      ...
      content: 'En printable-sælger bemærker at søgninger efter pædagogiske arbejdsark på svensk, dansk og norsk returnerer meget få resultater på store markedspladser. Trods den relativt lille befolkning i hvert skandinavisk land er husstands-uddannelsesudgifter blandt de højeste globalt, og digitale adoptionsrater er exceptionelle. Sælgeren generator et fokuseret katalog af 15 aktivitetsarbejdsark på svensk, dansk og norsk. Fordi konkurrencen er næsten ikkeeksisterende, bliver disse produkter hurtigt de øverste søgeresultater for deres respektive kategorier. De skandinaviske produkter genererer imponerende per-produkt omsætning på grund af kombinationen af nul konkurrence og købere der er villige til at betale premiumpriser for kvalitetsindhold på deres sprog. Mens den samlede markedsstørrelse er mindre end tysk eller fransk, overstiger omsætningen per produkt betydeligt hvad de samme produkter genererer på engelsk hvor de konkurrerer mod tusindvis af alternativer. Dette demonstrerer at markedsstørrelse alene ikke bestemmer profitabilitet — forholdet mellem efterspørgsel og konkurrence er vigtigere.',
    },
  ],
