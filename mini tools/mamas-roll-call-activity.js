...
(function (global) {
  ...
  global.MamasRollCallActivity = {
    ...
    strings: {
      title: { en: "Mama's Roll Call", de: 'Mamas Morgenappell', fr: 'L’appel de Maman', es: 'El pase de lista de Mamá Pata', pt: 'A chamada da Mamãe Pata', it: 'La conta di Mamma Papera' },
      instruction: { en: 'Send Mama the number she calls, then write it.', de: 'Schick Mama die Zahl, die sie ruft – dann schreib sie auf.', fr: 'Envoie à Maman le nombre qu’elle demande, puis écris-le.', es: 'Envíale a Mamá Pata la cantidad de patitos que pida y luego escribe el número.', pt: 'Envie à Mamãe Pata a quantidade de patinhos que ela pedir e depois escreva o número.', it: 'Manda a Mamma il numero che chiama, poi scrivilo.' },
      prompt: { en: 'Send the number!', de: 'Schick die Zahl!', fr: 'Envoie le nombre !', es: '¡Envía el número!', pt: 'Envie o número!', it: 'Manda il numero!' },
      callNumeral: { en: 'Mama needs {n}!', de: 'Mama braucht {n}!', fr: 'Maman a besoin de {n} !', es: '¡Mamá necesita {n}!', pt: 'A Mamãe precisa de {n}!', it: 'Mamma ne vuole {n}!' },
      callZero: { en: 'Mama needs NONE — let them sleep!', de: 'Mama braucht KEINS – lass sie schlafen!', fr: 'Maman n’en veut AUCUN — laisse-les dormir !', es: 'Mamá no necesita ninguno… ¡déjalos dormir!', pt: 'A Mamãe não precisa de nenhum… deixe eles dormirem!', it: 'Mamma non ne vuole NESSUNO — falli dormire!' },
      callGroup: { en: 'Send a duckling for each lily-pad!', de: 'Schick für jedes Seerosenblatt ein Entenküken!', fr: 'Envoie un caneton pour chaque nénuphar !', es: '¡Envía un patito por cada hoja de nenúfar!', pt: 'Envie um patinho para cada folha de vitória-régia!', it: 'Manda un anatroccolo per ogni ninfea!' },
      callKind: { en: 'Send {n} {kind} ducklings!', de: 'Schick {n} {kind} Entenküken!', fr: 'Envoie {n} canetons {kind} !', es: '¡Envía {n} patitos {kind}!', pt: 'Envie {n} patinhos {kind}!', it: 'Manda {n} anatroccoli {kind}!' },
      countBrood: { en: 'How many came to Mama? Tap each to count.', de: 'Wie viele sind zu Mama gekommen? Tippe jedes an, um zu zählen.', fr: 'Combien sont venus vers Maman ? Touche chacun pour compter.', es: '¿Cuántos llegaron con Mamá? Toca cada uno para contarlos.', pt: 'Quantos chegaram até a Mamãe? Toque em cada um para contar.', it: 'Quanti sono arrivati da Mamma? Tocca ognuno per contarli.' },
      arriveLab: { en: 'More keep arriving — count them all!', de: 'Es kommen noch mehr – zähl sie alle!', fr: 'Il en arrive encore — compte-les tous !', es: '¡Vienen más… cuéntalos todos!', pt: 'Estão chegando mais… conte todos!', it: 'Ne arrivano altri — contali tutti!' },
      hintSend: { en: 'Tap a duckling to send it across to Mama.', de: 'Tippe ein Entenküken an, um es zu Mama hinüberzuschicken.', fr: 'Touche un caneton pour l’envoyer vers Maman.', es: 'Toca un patito para enviárselo a Mamá.', pt: 'Toque em um patinho para enviá-lo à Mamãe.', it: 'Tocca un anatroccolo per mandarlo da Mamma.' },
      hintCount: { en: 'Tap each duckling once to count it.', de: 'Tippe jedes Entenküken einmal an, um es zu zählen.', fr: 'Touche chaque caneton une fois pour le compter.', es: 'Toca cada patito una vez para contarlo.', pt: 'Toque em cada patinho uma vez para contá-lo.', it: 'Tocca ogni anatroccolo una volta per contarlo.' },
      signNav: { en: 'Sign the roll ✍', de: 'Appell unterschreiben ✍', fr: 'Signe l’appel ✍', es: 'Firma el pase ✍', pt: 'Assine a chamada ✍', it: 'Firma la conta ✍' },
      moreArrive: { en: 'More arrive ▶', de: 'Es kommen mehr ▶', fr: 'Il en arrive plus ▶', es: 'Vienen más ▶', pt: 'Chegam mais ▶', it: 'Ne arrivano altri ▶' },
      backRaft: { en: '← send more', de: '← mehr schicken', fr: '← en envoyer plus', es: '← enviar más', pt: '← enviar mais', it: '← mandane altri' },
      signHint: { en: 'Write the number in the mud to call the roll!', de: 'Schreib die Zahl in den Schlamm, um den Appell aufzurufen!', fr: 'Écris le nombre dans la boue pour faire l’appel !', es: '¡Escribe el número en el lodo para pasar lista!', pt: 'Escreva o número na lama para fazer a chamada!', it: 'Scrivi il numero nel fango per fare la conta!' },
      traceIt: { en: 'Write the {n}', de: 'Schreib die {n}', fr: 'Écris le {n}', es: 'Escribe el {n}', pt: 'Escreva o {n}', it: 'Scrivi il numero {n}' },
      strokeN: { en: 'Stroke {k}', de: 'Strich {k}', fr: 'Trait {k}', es: 'Trazo {k}', pt: 'Traço {k}', it: 'Tratto {k}' },
      thisWay: { en: 'Start that stroke first — this way!', de: 'Fang mit diesem Strich an – so herum!', fr: 'Commence par ce trait — dans ce sens !', es: 'Empieza con este trazo… ¡por aquí!', pt: 'Comece por esse traço… por aqui!', it: 'Comincia prima da quel tratto — così!' },
      sealed: { en: 'The roll is true — Mama gathers her brood! 🦆', de: 'Der Appell stimmt – Mama sammelt ihre Schar! 🦆', fr: 'L’appel est bon — Maman rassemble ses petits ! 🦆', es: '¡El pase está bien… Mamá reúne a su parvada! 🦆', pt: 'A chamada está certa — a Mamãe reúne os patinhos! 🦆', it: 'La conta è giusta — Mamma raduna i suoi piccoli! 🦆' },
      sealedZero: { en: 'Zero ducklings — and you wrote the zero! The raft sleeps in. 🌙', de: 'Null Entenküken – und du hast die Null geschrieben! Das Floß schläft weiter. 🌙', fr: 'Zéro caneton — et tu as écrit le zéro ! Le radeau dort encore. 🌙', es: 'Cero patitos… ¡y escribiste el cero! La balsa sigue durmiendo. 🌙', pt: 'Zero patinhos — e você escreveu o zero! A balsa fica dormindo. 🌙', it: 'Zero anatroccoli — e hai scritto lo zero! La zattera resta a dormire. 🌙' },
      redo: { en: "Let's call that roll again.", de: 'Lass uns den Appell noch einmal aufrufen.', fr: 'Refaisons l’appel.', es: 'Vamos a pasar lista otra vez.', pt: 'Vamos fazer a chamada de novo.', it: 'Rifacciamo la conta.' },
      tapCheck: { en: 'Tap Check! ✓', de: 'Tippe auf Prüfen! ✓', fr: 'Touche Vérifier ! ✓', es: '¡Toca Comprobar! ✓', pt: 'Toque em Verificar! ✓', it: 'Tocca Controlla! ✓' },
      sentLab: { en: 'With Mama', de: 'Bei Mama', fr: 'Avec Maman', es: 'Con Mamá', pt: 'Com a Mamãe', it: 'Con Mamma' },
      raftLab: { en: 'The raft', de: 'Das Floß', fr: 'Le radeau', es: 'La balsa', pt: 'A balsa', it: 'La zattera' }
    },
    defaults: {},
    ...
    _callCard: function () {
      ...
      if (this.act === 'count-out-distract') {
        var k = this.round.call.kind, kindWord = (LANG === 'de' && COLOR_DE[k]) ? COLOR_DE[k].adj : ((LANG === 'fr' && COLOR_FR[k]) ? COLOR_FR[k].adj : ((LANG === 'es' && COLOR_ES[k]) ? COLOR_ES[k].adj : ((LANG === 'pt' && COLOR_PT[k]) ? COLOR_PT[k].adj : ((LANG === 'it' && COLOR_IT[k]) ? COLOR_IT[k].adj : k))));
    ...
    _raftCol: function () {
      ...
      if (s.sent.length) { var rb = api.el('button', 'rc-recall'); rb.type = 'button'; rb.textContent = '↩'; rb.setAttribute('aria-label', LANG === 'de' ? 'eins zurückrufen' : (LANG === 'fr' ? 'en rappeler un' : (LANG === 'es' ? 'regresar un patito' : (LANG === 'pt' ? 'devolver um patinho' : (LANG === 'it' ? 'richiamane uno' : 'call one back'))))); rb.addEventListener('click', function () { Core.recallDuck(s, s.sent[s.sent.length - 1].id); self.msg = null; self.api.sound && self.api.sound(360); self.render(); }); sent.appendChild(rb); }
    ...
    _commit: function () {
      ...
      if (r === 'sealed') {
        ...
        speak(this._n() === 0 ? (LANG === 'de' ? 'null' : (LANG === 'fr' ? 'zéro' : (LANG === 'es' ? 'cero' : (LANG === 'pt' ? 'zero' : (LANG === 'it' ? 'zero' : 'zero'))))) : numWord(this._n()));
        this._win();
      } else {
