...
const content: GuideContent = {
  seo: {
    ...
    secondaryKeywords: [
      'kundeservice for printable-sælgere på Etsy.dk',
      'support for printbar forretning med opgaver til print',
      'håndtér kundeklager opgaver til print',
      'digital download support printables sidegesjæft',
    ],
    lsiKeywords: [
    ...
    titleTag: 'Kundeservice digitale produkter — Guide for printable-sælgere',
    metaDescription: 'Kundeservicestrategier for sælgere af opgaver til print. Problemforebyggelse, svarskabeloner, refusionshåndtering og anmeldelsesstyring på Etsy.dk.',
  },

  hero: {
    title: 'Kundeservice for din printbare forretning med digitale produkter',
