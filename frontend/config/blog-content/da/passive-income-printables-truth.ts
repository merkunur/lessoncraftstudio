...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'passiv indkomst printables sandhed',
    ...
    titleTag: 'Passiv Indkomst fra Printables: Sandheden | LessonCraftStudio',
  ...
  cta: {
    heading: 'Kom I Gang Med Passiv Indkomst fra Printables',
