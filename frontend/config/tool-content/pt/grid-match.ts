...
const content: ToolContent = {
  ...
  tutorial: {
    title: 'Como Criar Atividades de Puzzle de Quadrícula em 8 Passos',
    steps: [
      {
        title: 'Abra o Gerador de Puzzle de Quadrícula',
        description: 'Clique em \"Testar Grátis\" para abrir o gerador de puzzles de quadrícula no seu navegador. A ferramenta abre instantaneamente com uma barra lateral de definições à esquerda e um canvas de aba duplo à direita — um aba para a atividade e outro para o gabarito. Sem criar conta, sem baixar software, sem instalação — comece a criar puzzles de quadrícula imediatamente.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Combine puzzles de quadrícula com atividades de associação, atividades de peças faltantes, exercícios de discriminação visual e atividades de classificação de imagens usando temas coordenados em múltiplos geradores. Os puzzles de quadrícula ensinam raciocínio espacial e análise visual de uma única imagem. As atividades de associação desenvolvem discriminação visual entre pares de imagens. As peças faltantes desenvolvem perceção parte-todo. Cada formato exercita uma competência cognitiva diferente mantendo a consistência temática. Os pacotes multi-formato vendem-se significativamente mais do que os pacotes de formato único e proporcionam aos usuários prática variada de perceção visual através de um tema unificado.',
    },
  ],
  ...
  faq: [
    {
      ...
      answer: 'Sim. A ferramenta oferece um teste grátis com todas as funcionalidades — todos os tamanhos de grelha de 2×2 a 4×4, caselas-dica ajustáveis (1–5), aleatorização Fisher-Yates de peças, o gabarito autogerado com círculos numerados sobrepostos, as 104 coleções temáticas de imagens com mais de 3100 ilustrações, carregamento de imagens personalizadas, fundos e bordas temáticas com opacidade independente, opção de escala de cinzentos e todos os formatos de download. Sem cadastro, sem cartão de crédito. Os downloads do teste grátis incluem uma marca d\'água. Adquira uma licença comercial para remover a marca d\'água e desbloquear os direitos de venda.',
    },
    {
      question: 'Como funciona o puzzle de quadrícula?',
      answer: 'A atividade mostra uma única imagem dividida numa grelha onde algumas células mostram a peça real da imagem (caselas-dica) e as células restantes mostram marcadores \"?\". Ao lado ou abaixo da grelha, uma paleta numerada apresenta todas as peças ocultas em ordem misturada. Os usuários examinam as caselas-dica visíveis, estudam as peças numeradas na paleta e determinam qual número pertence a cada posição vazia da grelha. O puzzle requer raciocínio espacial — associar o conteúdo de cada peça individual com a sua localização correta na imagem geral. Configure a grelha de 2×2 (4 peças) a 4×4 (16 peças) e defina 1 a 5 caselas-dica para controlar a dificuldade.',
    },
    {
      question: 'Como funciona o gabarito autogerado?',
      answer: 'Quando gera uma atividade, a aplicação cria simultaneamente um gabarito de associação num aba de canvas separado. O gabarito mostra a imagem completa sem recortar com círculos numerados sobrepostos em cada célula da grelha — círculos com fundo amarelo (#ffffe0), contorno preto e números na fonte Fredoka que mostram qual peça da paleta pertence a cada posição. Alterne entre os separadores de Atividade e Gabarito para comparar. Baixe cada versão de forma independente — atividade JPEG, atividade PDF, gabarito JPEG e gabarito PDF — obtendo quatro arquivos prontos para produção a partir de uma única geração. O gabarito automático elimina a criação manual e garante precisão perfeita.',
    },
    {
