...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          '\u00d6ffnen Sie das Seiten-Setup-Panel und w\u00e4hlen Sie eine Seitengr\u00f6\u00dfe: Letter Hochformat, Standard-Arbeitsblatt (800\u00d71000) oder A4 Hochformat. W\u00e4hlen Sie eine Hintergrundfarbe oder ein dekoratives Hintergrundthema aus der Bildbibliothek und passen Sie den Deckkraft-Regler an, damit die Aufgaben lesbar bleiben. F\u00fcgen Sie einen passenden Rahmen hinzu, um Ihren Arbeitsbl\u00e4ttern ein professionelles Aussehen zu verleihen. Jede Layout-Einstellung wird sowohl auf das Arbeitsblatt als auch auf den L\u00f6sungsschl\u00fcssel \u00fcbertragen, sodass Ihr Endprodukt von Anfang bis Ende konsistent ist.',
      },
      {
      ...
      },
      {
        ...
        description:
          '\u00d6ffnen Sie das Bildbibliothek-Panel und durchst\u00f6bern Sie 104 Themen \u2014 von Bauernhoftieren und Essen bis hin zu Weltraum und Feiertagen. Nutzen Sie die Suchleiste, um bestimmte Bilder sofort zu finden. Klicken Sie, um die gew\u00fcnschten Bilder f\u00fcr Ihr Arbeitsblatt auszuw\u00e4hlen; jede Aufgabe w\u00e4hlt zuf\u00e4llig aus Ihrer Auswahl f\u00fcr abwechslungsreiche Seiten. Sie k\u00f6nnen auch eigene Bilder hochladen, um einen einzigartigen Look zu erzielen, der zu Ihrer Marke, Ihrem Klassenmaskottchen oder saisonalen Kampagnen passt.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Wechseln Sie zum L\u00f6sungsschl\u00fcssel-Tab und klicken Sie auf L\u00f6sungsschl\u00fcssel generieren, um eine ausgef\u00fcllte Version Ihres Arbeitsblatts mit allen korrekten Differenzen zu erstellen. \u00d6ffnen Sie dann das Download-Men\u00fc und exportieren Sie sowohl das Arbeitsblatt als auch den L\u00f6sungsschl\u00fcssel als hochaufl\u00f6sendes JPEG oder druckfertiges PDF. Aktivieren Sie das Graustufen-K\u00e4stchen im Download-Dropdown, um tintenfreundliche Schwarz-Wei\u00df-Versionen zu erzeugen \u2014 ideal f\u00fcr den Klassendruck oder kosteng\u00fcnstige Aktivit\u00e4tsbuch-Produktion. Jeder Export wird mit einem 6-fach-Multiplikator (400+ DPI) gerendert, sodass Ihre Arbeitsbl\u00e4tter gestochen scharf aussehen \u2014 ob zu Hause gedruckt, an eine Druckerei gesendet oder als digitales Produkt auf Etsy oder Amazon KDP hochgeladen.',
      },
    ],
  },

  keyFeatures: {
    title: 'Hauptfunktionen des Subtraktions-Arbeitsblatt-Generators',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Laden Sie Arbeitsbl\u00e4tter und L\u00f6sungsschl\u00fcssel als hochaufl\u00f6sende JPEG-Bilder oder druckfertige PDF-Dokumente herunter. Die Export-Engine rendert mit einem 6-fach-Multiplikator und erzeugt \u00fcber 400 DPI bei Standardseitengr\u00f6\u00dfen. Der integrierte Graustufen-Schalter konvertiert Ihr gesamtes Arbeitsblatt mit einem Klick in Schwarz-Wei\u00df \u2014 ideal f\u00fcr den Klassendruck, Tintenersparnis oder druckerfreundliche Aktivit\u00e4tsbuch-Innenteile f\u00fcr Amazon KDP.',
      },
      {
        title: 'Eigene Bilder hochladen',
        description:
          'Gehen Sie \u00fcber die integrierte Bibliothek hinaus und laden Sie eigene PNG- oder JPEG-Bilder direkt in die App hoch. Ideal f\u00fcr Marken-Arbeitsbl\u00e4tter, eigene Cliparts, Klassenmaskottchen oder saisonale Inhalte. Hochgeladene Bilder integrieren sich nahtlos in jeden \u00dcbungsmodus \u2014 einschlie\u00dflich Durchstreichen, wo Ihre eigenen Bilder dieselbe diagonale X-Markierungs-Visualisierung erhalten \u2014 sodass Sie die volle kreative Kontrolle behalten.',
      },
      {
        title: 'Volle Canvas-Bearbeitung mit R\u00fcckg\u00e4ngig und Wiederherstellen',
        description:
          'Die integrierte Fabric.js-Arbeitsfl\u00e4che l\u00e4sst Sie jedes Element auf der Seite verschieben, skalieren, drehen und neu positionieren \u2014 Text, Bilder, Aufgabenbl\u00f6cke, Rahmen und Hintergr\u00fcnde. Zoomen Sie f\u00fcr pr\u00e4zise Platzierung hinein und heraus und nutzen Sie den 20-stufigen R\u00fcckg\u00e4ngig-/Wiederherstellen-Stapel f\u00fcr freies Experimentieren. Fixieren Sie Elemente oder entsperren Sie alles f\u00fcr spontanes Neugestalten \u2014 die Layoutflexibilit\u00e4t eines Grafikdesign-Tools in einem Arbeitsblatt-Generator.',
      },
    ],
  },

  businessUseCases: {
    title: 'Subtraktions-Arbeitsbl\u00e4tter online verkaufen',
    cases: [
      {
      ...
      {
        title: 'Mathe-Aktivit\u00e4tsb\u00fccher auf Amazon KDP',
        description:
          'Stellen Sie 50\u2013100 Subtraktions-Arbeitsbl\u00e4tter zu einem gedruckten Aktivit\u00e4tsbuch im Amazon-KDP-Format zusammen. Strukturieren Sie das Buch mit progressiver Schwierigkeit: Beginnen Sie mit dem Durchstreich-Modus bei einem niedrigen maximalen Minuenden von 5, steigern Sie sich \u00fcber Bild \u2212 Zahl bei 10 und enden Sie mit dem Gemischten Modus bis 20. Nutzen Sie den Graustufen-Export f\u00fcr druckerfreundliche Innenteile. F\u00fcgen Sie ein Titelblatt, Anleitungen und einen L\u00f6sungsteil am Ende hinzu. KDP-Mathe-Aktivit\u00e4tsb\u00fccher f\u00fcr Kinder von 4\u20138 Jahren verkaufen sich das ganze Jahr \u00fcber konstant mit minimalem Werbebudget.',
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'subtraktions-arbeitsblatt-ersteller',
      anchorText: 'Subtraktions-Arbeitsblatt-Ersteller',
    },
    {
      pageType: 'guide',
      slug: 'subtraktions-arbeitsblaetter-erstellen',
      anchorText: 'Subtraktions-Arbeitsbl\u00e4tter erstellen, die sich verkaufen',
    },
    {
      pageType: 'guide',
  ...
  visuals: {
    ...
    videoTitle: 'Bildbasierte Subtraktions-Arbeitsbl\u00e4tter mit Durchstreich-Visualisierung erstellen',
  },
};
