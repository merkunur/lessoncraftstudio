...
const bundlesContent: Record<string, {
  ...
  it: {
    ...
    metaTitle: '6 pacchetti di generatori di schede | Risparmia fino al 70%',
    metaDescription: 'Pacchetti di generatori per categoria: matematica, lettere, disegno, abbinamento, puzzle e ricerca. Licenza commerciale, pagamento unico.',
