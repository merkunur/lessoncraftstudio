...
const content: BlogContent = {
  ...
  cta: {
    heading: 'Opret Tematiske Bankoplader Nu',
    description: 'Generér unikke bankoplader med 100+ billedtemaer. Prøv gratis med vandmærke.',
    buttonText: 'Prøv Banko-Generatoren',
    buttonUrl: '/apps',
  },
};
