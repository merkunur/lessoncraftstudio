...
const content: BlogContent = {
  ...
  cta: {
    heading: 'Opret Hjernepause-Aktiviteter Nu',
    description: 'Brug LessonCraftStudios generatorer til at oprette mini-puslespil og hurtige øvelser. Prøv gratis med vandmærke.',
