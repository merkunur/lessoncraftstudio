...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Fiches de Motifs | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Fiches de Motifs professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche de motifs visuels à compléter',

    },
    sampleGallery: [
      { src: '/samples/english/pattern worksheet/Pattern Worksheet 1.jpeg', alt: 'Exercice de motifs', caption: 'Reconnaissance de motifs' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Fiches de Motifs thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Fiches de Motifs est-il vraiment gratuit ?',
  ...
  internalLinks: [
    { slug: 'big-small', pageType: 'app' as const, anchorText: 'Générateur Grand et Petit' },
    { slug: 'pattern-train', pageType: 'app' as const, anchorText: 'Générateur de Train de Motifs' },
    { slug: 'draw-and-color', pageType: 'app' as const, anchorText: 'Générateur Dessiner et Colorier' },
    { slug: 'pattern-worksheet', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Fiches de Motifs Gratuit' },
    { slug: 'visual-bundle', pageType: 'bundle' as const, anchorText: 'Pack Apprentissage Visuel Complet' }
  ],
};
