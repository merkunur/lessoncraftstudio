...
const content: StartContent = {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Platform-agnostic scaling — identical sudoku products work on Etsy, Amazon KDP, Gumroad, and every international marketplace without format adaptation. Pure number puzzles cross every language barrier.',
    },
    {
