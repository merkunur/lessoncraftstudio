...
(function () {
  ...
  var MODEL = {
    ...
    validate: function (draft, existing) {
    ...
    cardFor: function (id, classroom, home, custom) {
      ...
      if (custom && custom.id === id) {
        ...
        speakable = true;            /* written in the classroom language, by definition */
  ...
  var PHRASES = {
    ...
    toilet:     {en:"I need the toilet",de:"Ich muss auf die Toilette",fr:"Je dois aller aux toilettes",it:"Devo andare in bagno",es:"Necesito ir al baño",pt:"Preciso ir ao banheiro",nl:"Ik moet naar de wc",sv:"Jag behöver gå på toaletten",da:"Jeg skal på toilettet",no:"Jeg må på toalettet",fi:"Minun pitää päästä vessaan"},
    stop:       {en:"Stop",de:"Halt",fr:"Arrête",it:"Basta",es:"Para",pt:"Pare",nl:"Stop",sv:"Sluta",da:"Stop",no:"Stopp",fi:"Lopeta"},
    look:       {en:"Please look at me",de:"Schau mich bitte an",fr:"Regarde-moi, s’il te plaît",it:"Guardami, per favore",es:"Mírame, por favor",pt:"Olhe para mim, por favor",nl:"Kijk alsjeblieft naar mij",sv:"Titta på mig, tack",da:"Se på mig, tak",no:"Se på meg, takk",fi:"Katso minua, kiitos"},
    ...
    cantea:     {en:"I can’t eat this",de:"Das darf ich nicht essen",fr:"Je ne peux pas manger ça",it:"Questo non posso mangiarlo",es:"Esto no lo puedo comer",pt:"Isto eu não posso comer",nl:"Dit mag ik niet eten",sv:"Det här kan jag inte äta",da:"Det her må jeg ikke spise",no:"Dette kan jeg ikke spise",fi:"Tätä en voi syödä"},
    ...
    besick:     {en:"I need to be sick",de:"Mir ist übel",fr:"J’ai envie de vomir",it:"Ho voglia di vomitare",es:"Tengo ganas de vomitar",pt:"Estou com vontade de vomitar",nl:"Ik moet overgeven",sv:"Jag måste kräkas",da:"Jeg skal kaste op",no:"Jeg må kaste opp",fi:"Minua oksettaa"},
    ...
    nose:       {en:"I need a tissue",de:"Ich brauche ein Taschentuch",fr:"J’ai besoin d’un mouchoir",it:"Ho bisogno di un fazzoletto",es:"Necesito un pañuelo",pt:"Preciso de um lenço",nl:"Ik heb een zakdoek nodig",sv:"Jag behöver en näsduk",da:"Jeg har brug for et lommetørklæde",no:"Jeg trenger et lommetørkle",fi:"Tarvitsen nenäliinan"},
    again:      {en:"Please say that again",de:"Sag das bitte noch einmal",fr:"Répète, s’il te plaît",it:"Ripeti, per favore",es:"Repítelo, por favor",pt:"Repita, por favor",nl:"Zeg dat nog eens, alsjeblieft",sv:"Säg det igen, tack",da:"Sig det igen, tak",no:"Si det en gang til, takk",fi:"Sano se uudelleen, kiitos"},
    slow:       {en:"Please say it slowly",de:"Sag es bitte langsam",fr:"Dis-le lentement, s’il te plaît",it:"Dillo piano, per favore",es:"Dilo despacio, por favor",pt:"Fale devagar, por favor",nl:"Zeg het langzaam, alsjeblieft",sv:"Säg det långsamt, tack",da:"Sig det langsomt, tak",no:"Si det sakte, takk",fi:"Sano se hitaasti, kiitos"},
    showme:     {en:"Please show me",de:"Zeig es mir bitte",fr:"Montre-moi, s’il te plaît",it:"Fammi vedere, per favore",es:"Enséñamelo, por favor",pt:"Mostre-me, por favor",nl:"Laat het me zien, alsjeblieft",sv:"Visa mig, tack",da:"Vis mig det, tak",no:"Vis meg det, takk",fi:"Näytä minulle, kiitos"},
    writeit:    {en:"Please write it down",de:"Schreib es bitte auf",fr:"Écris-le, s’il te plaît",it:"Scrivilo, per favore",es:"Escríbelo, por favor",pt:"Escreva, por favor",nl:"Schrijf het op, alsjeblieft",sv:"Skriv upp det, tack",da:"Skriv det ned, tak",no:"Skriv det ned, takk",fi:"Kirjoita se ylös, kiitos"},
    whatis:     {en:"What is this?",de:"Was ist das?",fr:"Qu’est-ce que c’est ?",it:"Che cos’è questo?",es:"¿Qué es esto?",pt:"O que é isto?",nl:"Wat is dit?",sv:"Vad är det här?",da:"Hvad er det her?",no:"Hva er dette?",fi:"Mikä tämä on?"},
    howsay:     {en:"How do you say this?",de:"Wie sagt man das?",fr:"Comment on dit ça ?",it:"Come si dice questo?",es:"¿Cómo se dice esto?",pt:"Como se diz isto?",nl:"Hoe zeg je dit?",sv:"Hur säger man det här?",da:"Hvordan siger man det her?",no:"Hvordan sier man dette?",fi:"Miten tämä sanotaan?"},
    cantear:    {en:"I can’t hear you",de:"Ich höre dich nicht",fr:"Je ne t’entends pas",it:"Non ti sento",es:"No te oigo",pt:"Não estou ouvindo",nl:"Ik hoor je niet",sv:"Jag hör dig inte",da:"Jeg kan ikke høre dig",no:"Jeg hører deg ikke",fi:"En kuule sinua"},
    ...
    working:    {en:"I am still working",de:"Ich arbeite noch",fr:"Je travaille encore",it:"Sto ancora lavorando",es:"Todavía estoy trabajando",pt:"Ainda estou trabalhando",nl:"Ik ben nog bezig",sv:"Jag håller på än",da:"Jeg er stadig i gang",no:"Jeg holder på ennå",fi:"Teen vielä"},
    helpstart:  {en:"Can you help me start?",de:"Kannst du mir beim Anfangen helfen?",fr:"Tu peux m’aider à commencer ?",it:"Mi aiuti a cominciare?",es:"¿Me ayudas a empezar?",pt:"Pode me ajudar a começar?",nl:"Wil je me helpen beginnen?",sv:"Kan du hjälpa mig att börja?",da:"Kan du hjælpe mig i gang?",no:"Kan du hjelpe meg å begynne?",fi:"Autatko minua aloittamaan?"},
    ...
    forgot:     {en:"I have forgotten",de:"Ich habe es vergessen",fr:"J’ai oublié",it:"Me ne sono dimenticato",es:"Se me ha olvidado",pt:"Eu esqueci",nl:"Ik ben het vergeten",sv:"Jag har glömt",da:"Jeg har glemt det",no:"Jeg har glemt det",fi:"Olen unohtanut"},
    ...
    whatneed:   {en:"What do I need for this?",de:"Was brauche ich dafür?",fr:"De quoi j’ai besoin pour ça ?",it:"Che cosa mi serve per questo?",es:"¿Qué necesito para esto?",pt:"Do que eu preciso para isto?",nl:"Wat heb ik hiervoor nodig?",sv:"Vad behöver jag till det här?",da:"Hvad skal jeg bruge til det her?",no:"Hva trenger jeg til dette?",fi:"Mitä tarvitsen tähän?"},
    ...
    coat:       {en:"Can I get my coat?",de:"Darf ich meine Jacke holen?",fr:"Est-ce que je peux prendre mon manteau ?",it:"Posso prendere il cappotto?",es:"¿Puedo coger mi abrigo?",pt:"Posso pegar o meu casaco?",nl:"Mag ik mijn jas halen?",sv:"Får jag hämta jackan?",da:"Må jeg hente min jakke?",no:"Kan jeg hente jakka mi?",fi:"Saanko hakea takkini?"},
    lunch:      {en:"When is lunch?",de:"Wann gibt es Mittagessen?",fr:"C’est quand le déjeuner ?",it:"Quando si mangia?",es:"¿Cuándo es la comida?",pt:"Quando é o almoço?",nl:"Wanneer is het eten?",sv:"När är lunchen?",da:"Hvornår er der frokost?",no:"Når er lunsjen?",fi:"Milloin on ruoka?"},
    hometime:   {en:"Is it home time?",de:"Ist jetzt Schluss?",fr:"C’est l’heure de rentrer ?",it:"È ora di andare a casa?",es:"¿Ya es hora de irse?",pt:"Já é hora de ir para casa?",nl:"Is het tijd om naar huis te gaan?",sv:"Är det dags att gå hem?",da:"Er det tid til at gå hjem?",no:"Er det tid for å gå hjem?",fi:"Onko jo kotiinlähtö?"},
    grownup:    {en:"When is my grown-up coming?",de:"Wann kommt jemand von zu Hause?",fr:"Quand est-ce qu’on vient me chercher ?",it:"Quando vengono a prendermi?",es:"¿Cuándo vienen a buscarme?",pt:"Quando vêm me buscar?",nl:"Wanneer komt er iemand voor mij?",sv:"När kommer någon och hämtar mig?",da:"Hvornår bliver jeg hentet?",no:"Når blir jeg hentet?",fi:"Milloin minut haetaan?"},
    waitforme:  {en:"Wait for me",de:"Warte auf mich",fr:"Attends-moi",it:"Aspettami",es:"Espérame",pt:"Espere por mim",nl:"Wacht op mij",sv:"Vänta på mig",da:"Vent på mig",no:"Vent på meg",fi:"Odota minua"},
    tellyou:    {en:"I need to tell you something",de:"Ich muss dir etwas sagen",fr:"J’ai quelque chose à te dire",it:"Ti devo dire una cosa",es:"Te tengo que decir una cosa",pt:"Preciso te contar uma coisa",nl:"Ik moet je iets vertellen",sv:"Jag måste säga en sak",da:"Jeg skal fortælle dig noget",no:"Jeg må fortelle deg noe",fi:"Minun pitää kertoa sinulle jotain"},
    ...
    partner:    {en:"Will you be my partner?",de:"Machst du mit mir zusammen?",fr:"Tu veux être avec moi ?",it:"Vuoi fare con me?",es:"¿Quieres ser mi pareja?",pt:"Quer fazer comigo?",nl:"Wil jij met mij samen?",sv:"Vill du vara med mig?",da:"Vil du være sammen med mig?",no:"Vil du være sammen med meg?",fi:"Tuletko minun pariksi?"},
    ...
    unkind:     {en:"Someone is being unkind to me",de:"Jemand ist gemein zu mir",fr:"Quelqu’un n’est pas gentil avec moi",it:"Qualcuno non è gentile con me",es:"Alguien no se porta bien conmigo",pt:"Alguém está sendo malvado comigo",nl:"Iemand is gemeen tegen mij",sv:"Någon är elak mot mig",da:"Nogen er ond ved mig",no:"Noen er slem mot meg",fi:"Joku on ilkeä minulle"},
    alone:      {en:"I want to play by myself",de:"Ich möchte allein spielen",fr:"Je veux jouer tout seul",it:"Voglio giocare da solo",es:"Quiero jugar solo",pt:"Quero brincar sozinho",nl:"Ik wil alleen spelen",sv:"Jag vill leka själv",da:"Jeg vil gerne lege alene",no:"Jeg vil leke alene",fi:"Haluan leikkiä yksin"},
    ...
    new:        {en:"I am new here",de:"Ich bin neu hier",fr:"Je suis nouveau ici",it:"Sono nuovo qui",es:"Soy nuevo aquí",pt:"Eu sou novo aqui",nl:"Ik ben hier nieuw",sv:"Jag är ny här",da:"Jeg er ny her",no:"Jeg er ny her",fi:"Olen täällä uusi"},
    ...
    cando:      {en:"I can do this",de:"Das kann ich",fr:"Je sais le faire",it:"Questo lo so fare",es:"Esto sé hacerlo",pt:"Isto eu sei fazer",nl:"Dit kan ik",sv:"Det här kan jag",da:"Det her kan jeg",no:"Dette kan jeg",fi:"Tämän minä osaan"},
    ...
    showyou:    {en:"Can I show you instead?",de:"Darf ich es dir lieber zeigen?",fr:"Est-ce que je peux te le montrer à la place ?",it:"Posso fartelo vedere invece?",es:"¿Puedo enseñártelo mejor?",pt:"Posso mostrar em vez de dizer?",nl:"Mag ik het liever laten zien?",sv:"Får jag visa i stället?",da:"Må jeg vise det i stedet?",no:"Kan jeg vise det i stedet?",fi:"Saanko näyttää sen sijaan?"},
    ...
    dontwant:   {en:"I don’t want to do this",de:"Das möchte ich nicht machen",fr:"Je ne veux pas faire ça",it:"Questo non lo voglio fare",es:"Esto no lo quiero hacer",pt:"Isto eu não quero fazer",nl:"Dit wil ik niet doen",sv:"Det här vill jag inte göra",da:"Det her vil jeg ikke",no:"Dette vil jeg ikke gjøre",fi:"En halua tehdä tätä"},
  ...
  var STRINGS = {
    ...
    deskHint:     {en:"Pick an opening, then finish it in the child’s own voice. The board always speaks as the child.",de:"Wähle einen Anfang und vervollständige ihn aus der Sicht des Kindes. Die Tafel spricht immer als das Kind.",fr:"Choisis un début, puis complète-le à la voix de l’enfant. Le tableau parle toujours comme l’enfant.",it:"Scegli un inizio e completalo con la voce del bambino. La tavola parla sempre come il bambino.",es:"Elige un comienzo y complétalo con la voz del niño. El tablero siempre habla como el niño.",pt:"Escolha um começo e complete-o na voz da criança. O quadro fala sempre como a criança.",nl:"Kies een begin en maak het af in de stem van het kind. Het bord spreekt altijd als het kind.",sv:"Välj en början och avsluta den med barnets röst. Tavlan talar alltid som barnet.",da:"Vælg en begyndelse, og gør den færdig med barnets stemme. Tavlen taler altid som barnet.",no:"Velg en begynnelse og fullfør den med barnets stemme. Tavla snakker alltid som barnet.",fi:"Valitse aloitus ja täydennä se lapsen äänellä. Taulu puhuu aina lapsena."},
    ...
    pickCat:      {en:"Which group?",de:"Welche Gruppe?",fr:"Quel groupe ?",it:"Quale gruppo?",es:"¿Qué grupo?",pt:"Qual grupo?",nl:"Welke groep?",sv:"Vilken grupp?",da:"Hvilken gruppe?",no:"Hvilken gruppe?",fi:"Mikä ryhmä?"},
    ...
    closeDesk:    {en:"Back to the board",de:"Zurück zur Tafel",fr:"Retour au tableau",it:"Torna alla tavola",es:"Volver al tablero",pt:"Voltar ao quadro",nl:"Terug naar het bord",sv:"Tillbaka till tavlan",da:"Tilbage til tavlen",no:"Tilbake til tavla",fi:"Takaisin taululle"},
    ...
    needCat:      {en:"Pick a group for it.",de:"Wähle eine Gruppe dafür.",fr:"Choisis un groupe.",it:"Scegli un gruppo.",es:"Elige un grupo.",pt:"Escolha um grupo.",nl:"Kies er een groep bij.",sv:"Välj en grupp.",da:"Vælg en gruppe.",no:"Velg en gruppe.",fi:"Valitse ryhmä."},
    ...
    printBack:    {en:"Write the words your child uses at home here, and we will learn them.",de:"Schreiben Sie hier die Wörter auf, die Ihr Kind zu Hause benutzt — wir lernen sie.",fr:"Écrivez ici les mots que votre enfant utilise à la maison, et nous les apprendrons.",it:"Scrivete qui le parole che vostro figlio usa a casa, e le impareremo.",es:"Escriban aquí las palabras que su hijo usa en casa, y las aprenderemos.",pt:"Escrevam aqui as palavras que o vosso filho usa em casa, e nós vamos aprendê-las.",nl:"Schrijf hier de woorden die uw kind thuis gebruikt, dan leren wij ze.",sv:"Skriv orden ert barn använder hemma här, så lär vi oss dem.",da:"Skriv de ord jeres barn bruger hjemme her, så lærer vi dem.",no:"Skriv ordene barnet deres bruker hjemme her, så lærer vi dem.",fi:"Kirjoittakaa tähän sanat, joita lapsenne käyttää kotona — me opettelemme ne."},
  ...
  var REVIEWED = {en:true,de:false,fr:false,it:false,es:false,pt:false,nl:false,sv:false,da:false,no:false,fi:false};
  ...
  var SayItBoard = {
    ...
    composeCustom: function (c, loc) {
      ...
      var pattern = (t && t[loc]) || (t && t.en) || '{x}';
      return pattern.replace('{x}', c.body);
    },

    /* ⚠ SUBSTRATE HONESTY (§16.6.1). A category whose locale has not
       been through a native panel DOES NOT RENDER in that locale. An
       empty or machine-drafted tab erodes trust exactly like an empty
       topic page — and on this board an unreviewed toilet phrase is the
       precise defect the whole SoT exists to end. */
    ...
    _paintDesk: function () {
      ...
      show.addEventListener('click', function () {
        var v = MODEL.validate(d, self._store.custom);
        if (!v.ok) { self.notice = { key: v.why, args: { n: v.n } }; self._paint(); return; }
        self.notice = null;
        self.lifted = MODEL.cardFor('preview', self.classroom, self._store.home,
          { id: 'preview', icon: d.icon, home: MODEL.cleanText(d.home), starter: d.starter, body: v.body, cat: d.cat });
        self.lifted.custom = { id: 'preview', icon: d.icon, starter: d.starter, body: v.body, cat: d.cat, home: MODEL.cleanText(d.home) };
        self.desk = false;
        self._paint();
      });
      ...
      keep.addEventListener('click', function () {
        ...
        if (!MODEL.canKeep(self._store, self.premium && self.premiumKnown)) {
          self._gateLine(host, 'gateKeep', { n: MODEL.FREE_CUSTOM });
          return;
        }
        self._store.seq++;
    ...
    _gateLine: function (host, key, args) {
      ...
      x.textContent = api.t('closeDesk');
      x.addEventListener('click', function () { g.remove(); });
      g.append(s, a, x);
      host.appendChild(g);
    ...
    _print: function (kind) {
      if (kind !== 'cards' && !this.premium) { this._gateLine(this._foot, 'gatePrint'); return; }
