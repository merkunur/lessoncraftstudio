...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Havet',
  title: 'Gratis hav-arbejdsark til børn | LessonCraftStudio',
  description: 'Lav printbare havtematiske arbejdsark til børn. Fisk, hvaler, delfiner og havskildpadder. Matematik, læsning, puslespil og tegning fra førskole til 3. klasse.',
  keywords: 'hav arbejdsark, havdyr aktiviteter, hav matematik arbejdsark, hav farvelægningsark, printbare hav arbejdsark, havliv arbejdsark børn',
  heading: 'Gratis hav-arbejdsark til børn',
