...
const content: AppContent = {
  seo: {
    primaryKeyword: 'crear y vender fichas de adivinar palabras',
    secondaryKeywords: [
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          'Compila de 50 a 100 puzzles de adivinar palabras en un libro de actividades impreso en formato Amazon KDP. Usa dificultad progresiva — comienza con el modo Fácil (mitad de las letras reveladas) usando palabras simples de tres letras, avanza a través de Normal y Difícil hasta Sin Pistas con expresiones complejas de varias palabras. Agrupa los capítulos por tema (animales, comida, vehículos, naturaleza) para una variedad navegable. Añade una portada, una guía de dificultad y una sección de claves de respuesta al final. Los libros de puzzles de palabras para niños de 4 a 9 años se venden de forma constante todo el año con mínima publicidad.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Sí. Como la palabra a adivinar es el nombre de la imagen en el idioma seleccionado, cambiar el idioma cambia por completo el contenido del puzzle. «Dog» en inglés se convierte en «Hund» en alemán, «chien» en francés, «perro» en español — cada uno con letras diferentes y un número de letras diferente. La Licencia Comercial es solo en inglés; el Acceso Completo desbloquea los 11 idiomas, haciendo de cada versión lingüística un producto distinto y vendible.',
    },
    {
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Creador de Fichas de Adivinar Palabras',
    },
    {
      pageType: 'guide',
