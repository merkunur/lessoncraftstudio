...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Crie conjuntos dedicados de fichas Encontra o Diferente onde os usuários identificam imagens sem par entre conjuntos emparelhados. Configure de 8 a 12 imagens emparelhadas e de 1 a 5 elementos sem par por ficha, com imagens apresentadas 50% maiores para uma comparação visual clara. Crie conjuntos alinhados com o catálogo de produtos: encontra o diferente de animais da quinta para ciências, classificação de grupos alimentares para nutrição, identificação de profissões para estudos sociais, e reconhecimento de formas para preparação matemática. Cada ficha exporta-se com o seu gabarito autogerado mostrando círculos vermelhos à volta de cada elemento sem par, eliminando o tempo de preparação do vendedor para criar páginas de soluções separadas.',
    },
    {
  ...
  businessIdeas: [
    ...
    {
      title: 'Packs de Atividades de Objetos Ocultos para a loja no Gumroad',
      description: 'Carregue packs de atividades de objetos ocultos no Gumroad com campos de nome e data e gabaritos autogerados como pontos de venda principais. Os vendedores que procuram atividades de busca visual e observação valorizam fichas que chegam prontas para a loja com soluções incluídas. Crie conjuntos alinhados com o catálogo de produtos: objetos ocultos de animais da quinta para ciências, Eu Vejo de profissões para estudos sociais, busca de grupos alimentares para nutrição, e cenas de objetos ocultos sazonais para unidades de festividades. Inclua fichas tanto de Eu Vejo como de Encontra o Diferente para pacotes escalonados por nível — Eu Vejo para prática de busca visual e Encontra o Diferente para desenvolvimento de discriminação visual.',
      platform: 'Gumroad',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'A quantidade de objetos controla diretamente a dificuldade dos objetos ocultos. Eu Vejo com 1 objeto oculto entre 8 distratores cria fichas fáceis para produtos de pré-escola. Aumentar para 3 objetos ocultos entre 10 distratores produz desafios moderados para usuários do ensino primário. A dificuldade máxima (5 objetos ocultos entre 12 distratores) cria cenas densas onde encontrar cada alvo requer um esforço genuíno. Crie packs de dificuldade progressiva com secções claramente etiquetadas de fácil, médio e difícil — os compradores pagam preços premium por produtos que crescem com o usuário.',
    },
    {
      title: 'Aproveite o Formato Puramente Visual para Vendas Mundiais sem Tradução',
      description: 'As fichas de objetos ocultos contêm apenas imagens — sem texto específico de idioma no conteúdo da ficha. A legenda de Eu Vejo mostra os objetos-alvo visualmente, e Encontra o Diferente é puramente baseado em imagens. Cada ficha que cria é vendável instantaneamente em todo o mundo sem tradução nem localização. Um único conjunto de fichas de objetos ocultos serve para cada loja internacional da Etsy, cada mercado de KDP e cada comprador de Gumroad independentemente do idioma. Enquanto os concorrentes criam versões separadas por idioma de fichas com muito texto, as suas fichas visuais funcionam em toda a parte a partir de um único conjunto de ficheiros.',
    },
    {
