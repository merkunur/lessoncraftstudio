...
/**
 * Shadow Match Worksheets - Portuguese (Brazilian) Content
 *
 * File: frontend/content/product-pages/pt/combinar-sombras-fichas.ts
 * URL: /pt/apps/combinar-sombras-fichas
 *
 * FULL SEO content from: INDIVIDUAL APP PAGES/Portuguese/shadow-match.md
 * DO NOT SHORTEN - Every paragraph is SEO-optimized
 *
 * PRICING: Full Access ($240/year = R$1.200/ano or $25/month = R$125/mês)
 */

export const shadowMatchPtContent: ProductPageContent = {
  // SEO Configuration
  seo: {
...
Acesse uma biblioteca com mais de 3000 imagens organizadas por temas. Encontre animais, frutas, veículos, profissões e muito mais. Todas as imagens são apropriadas para educação infantil e ensino fundamental. Selecione 4 imagens por ficha para criar atividades personalizadas de coordenação motora.`,
    previewImageSrc: '/samples/portuguese/shadow-match/sample-1.jpeg',
    ctaLabels: {
  ...
  samples: {
    ...
    viewAllLabel: 'Ver maior',
    noPdfLabel: 'Apenas visualização',
    ...
    items: [
      {
        ...
        answerKeySrc: '/samples/portuguese/shadow-match/sample-1-answer.jpeg',
        altText: 'Atividade grátis de combinar sombras para educação infantil com pareamento visual',
        pdfDownloadUrl: '/samples/portuguese/shadow-match/sample-1.pdf',
      },
      {
        id: '2',
        worksheetSrc: '/samples/portuguese/shadow-match/sample-2.jpeg',
        answerKeySrc: '/samples/portuguese/shadow-match/sample-2-answer.jpeg',
        altText: 'Atividade grátis para crianças - combinar sombras para coordenação motora',
        pdfDownloadUrl: '/samples/portuguese/shadow-match/sample-2.pdf',
      },
      {
        id: '3',
        worksheetSrc: '/samples/portuguese/shadow-match/sample-3.jpeg',
        answerKeySrc: '/samples/portuguese/shadow-match/sample-3-answer.jpeg',
        altText: 'Atividades grátis de combinar sombras para ensino fundamental',
        pdfDownloadUrl: '/samples/portuguese/shadow-match/sample-3.pdf',
      },
      {
        id: '4',
        worksheetSrc: '/samples/portuguese/shadow-match/sample-4.jpeg',
        answerKeySrc: '/samples/portuguese/shadow-match/sample-4-answer.jpeg',
        altText: 'Imprimíveis grátis de combinar sombras - atividade para educação infantil',
        pdfDownloadUrl: '/samples/portuguese/shadow-match/sample-4.pdf',
      },
      {
        id: '5',
        worksheetSrc: '/samples/portuguese/shadow-match/sample-5.jpeg',
        answerKeySrc: '/samples/portuguese/shadow-match/sample-5-answer.jpeg',
        altText: 'Atividade para crianças de combinar sombras - imprimíveis grátis',
        pdfDownloadUrl: '/samples/portuguese/shadow-match/sample-5.pdf',
      },
    ],
  },
...
Professores de coordenação motora selecionam formas variadas. Silhuetas distintas criam exercícios mais desafiadores. Combine objetos de categorias diferentes. Animais com frutas criam atividades interessantes. A variedade mantém alunos engajados.`,
        icon: '🖼️',
      },
      {
        id: '2',
...
Ative etiquetas A/B/C e 1/2/3 para organização. Alunos conectam letras a números correspondentes. Este formato facilita correção de atividades. Inclua campos de nome e data para identificação. Professores de 1º ano preferem fichas identificáveis.`,
        icon: '⚙️',
      },
      {
        id: '3',
...
Para atividades de vogais e alfabeto, selecione letras da biblioteca. O gerador cria silhuetas de cada letra. Crianças associam letras coloridas às sombras. Este exercício reforça reconhecimento de formas de letras. Preparação fundamental para escrita.`,
        icon: '✨',
      },
      {
        id: '4',
...
Para atividades de coordenação motora, ajuste espaçamento entre elementos. Mais espaço facilita traçado de linhas. Menos espaço aumenta o desafio. Professores de letra cursiva adicionam linhas guia. Pontilhado orienta movimento da mão.`,
        icon: '✏️',
      },
      {
        id: '5',
...
Baixe a ficha de atividade e a chave de respostas separadamente. Cada download gera arquivo individual. Atividades de alfabetização prontas para sala de aula. Desenhos para colorir combinados com exercício de pareamento. Material completo em minutos.`,
        icon: '📥',
      },
    ],
  },
...
Desenhos para colorir complementam atividades de sombra. Professores criam fichas que combinam pareamento com pintura. Alunos primeiro conectam imagens às sombras. Depois colorem as figuras livremente. Atividades multissensoriais mantêm atenção de crianças pequenas.`,
        quote: 'As atividades de combinar sombras transformaram meus centros de aprendizagem!',
      },
      {
        id: '2',
        icon: '📚',
...
Exercícios de tabuada ganham contexto visual com imagens. Professores criam fichas temáticas para cada tabela. Alunos associam grupos de objetos a resultados. Matemática visual funciona especialmente bem no 1º ano. Aprendizado concreto antes do abstrato.`,
        quote: 'O pareamento visual transforma a prática de matemática em diversão.',
      },
      {
        id: '3',
        icon: '🏠',
    ...
    items: [
      {
        ...
        category: 'Visual',
        icon: '🎯',
        description: 'Combine atividades de sombras com atividades de ligar figuras para prática completa de discriminação visual.',
      },
      {
        id: '2',
        ...
        category: 'Visual',
        icon: '🧩',
        description: 'Crie pacotes de percepção visual combinando sombras com quebra-cabeças de peças faltantes.',
      },
      {
        id: '3',
        ...
        icon: '✏️',
        description: 'Agrupe atividades de sombras com traçar linhas para desenvolvimento completo de coordenação motora fina.',
      },
      {
        id: '4',
        ...
        icon: '🎨',
        description: 'Combine sombras com desenhos para colorir para pacotes atrativos de educação infantil.',
      },
      {
        id: '5',
        ...
        category: 'Matemática',
        icon: '🔢',
        description: 'Combine atividades de sombras com contagem para prática de reconhecimento numérico e visual.',
      },
      {
        id: '6',
        ...
        icon: '🚂',
        description: 'Crie pacotes de alfabetização combinando sombras de letras com atividades do trem do alfabeto.',
      },
    ],
  },
};

export default shadowMatchPtContent;
