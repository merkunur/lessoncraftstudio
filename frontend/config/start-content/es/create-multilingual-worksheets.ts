...
const content: StartContent = {
  seo: {
    primaryKeyword: 'generador de fichas multilingüe',
    secondaryKeywords: [
  ...
  actionSteps: [
    {
      ...
      description: 'Abre el generador de sopa de letras y usa la prueba gratis con marca de agua. Genera un puzzle en español, luego cambia a alemán y genera el mismo tema. Compara los resultados para ver cómo el contenido sensible al idioma cambia entre idiomas.',
    },
    {
      step: 'Identificar Tus Productos en Inglés con Mejor Rendimiento',
      description: 'Revisa tus datos de ventas existentes en inglés (o investiga categorías de alta demanda). Los tipos de fichas y temas que mejor se venden en inglés son tus primeros candidatos para expansión multilingüe.',
    },
    {
      step: 'Crear Tu Primer Producto Sensible al Idioma en Alemán',
      description: 'Elige tu generador sensible al idioma más fuerte (se recomienda sopa de letras). Selecciona un tema popular, configura el idioma en alemán y genera de 15 a 25 páginas de puzzles. Revisa el resultado para verificar calidad profesional y completitud.',
    },
    {
      step: 'Investigar el Mercado Alemán en Etsy.de y Amazon.de',
      description: 'Busca productos equivalentes en Etsy.de y Amazon.de. Anota los precios de la competencia, los títulos de las publicaciones y cómo describen sus productos en alemán. Usa esta investigación para escribir el texto de tu propia publicación.',
    },
    {
      step: 'Crear Tu Publicación en Alemán con Texto Localizado',
      description: 'Escribe el título, la descripción y las etiquetas de tu publicación en alemán. Para Etsy, crea la publicación en tu tienda existente. Para Amazon KDP, publica en Amazon.de con título, subtítulo y palabras clave internas en alemán.',
    },
    {
  ...
  toolsRecommended: [
    {
      ...
      description: 'La mejor demostración multilingüe — las palabras ocultas cambian completamente según la selección de idioma. Genera puzzles de sopa de letras temáticos en los 11 idiomas con vocabulario de la base de datos de traducción integrada.',
    },
    {
  ...
  faq: [
    {
      ...
      answer: 'Sí. Cada generador ofrece una prueba gratis con marca de agua. Cambia el selector de idioma a cualquiera de los 11 idiomas soportados y genera fichas de muestra para evaluar la calidad de la traducción y el formato del resultado. La prueba gratis con marca de agua te permite probar completamente las funciones multilingües antes de comprometerte.',
    },
    {
      question: '¿Necesito hablar alemán o francés para vender fichas en esos idiomas?',
      answer: 'No. Los generadores sensibles al idioma manejan toda la traducción de vocabulario internamente usando una base de datos verificada. No necesitas hablar el idioma objetivo para crear contenido multilingüe preciso. Necesitarás asistencia básica de traducción para los títulos y descripciones de tus publicaciones en Etsy o Amazon, pero el contenido de las fichas en sí no requiere habilidades lingüísticas de tu parte.',
    },
    {
      question: '¿Son las traducciones lo suficientemente precisas para contenido educativo?',
    ...
    },
    {
      ...
      answer: 'No. Una licencia comercial cubre todos los idiomas soportados por ese generador. Compras una licencia por generador y puedes crear contenido comercial en los 11 idiomas soportados. No hay requisito de licencia por idioma.',
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'El manual específico de KDP para publicar libros de actividades en Amazon. Cubre formato interior, diseño de portada, investigación de palabras clave, precios y escalado de tu catálogo KDP a nivel internacional.',
    },
    {
  ...
  visuals: {
    heroImage: { src: '/samples/english/wordsearch/wordsearch portrait.webp', alt: 'Ficha de puzzle de sopa de letras que demuestra la generación de fichas multilingüe en 11 idiomas' },
    samples: [
      { src: '/samples/english/wordsearch/wordsearch portrait.webp', alt: 'Ficha de puzzle de sopa de letras con vocabulario sensible al idioma', caption: 'Sopa de Letras — La Mejor Demo Multilingüe' },
      { src: '/samples/english/crossword/crossword_worksheet.webp', alt: 'Puzzle de crucigrama con pistas y respuestas localizadas', caption: 'Crucigrama — Puzzles Completamente Localizados' },
      { src: '/samples/english/word scramble/word scramble portrait.webp', alt: 'Ficha de palabras desordenadas con vocabulario adaptado al idioma', caption: 'Palabras Desordenadas — Resultado Sensible al Idioma' },
      { src: '/samples/english/alphabet train/Alphabet Train 1.webp', alt: 'Ficha de tren del abecedario mostrando conjuntos de letras específicos por idioma', caption: 'Tren del Abecedario — Conjuntos de Letras Adaptados' },
    ],
