...
const content: ToolContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'gerador de fichas de sequências de padrões para KDP',
      'ferramenta para criar fichas de padrões em grelha',
    ],
    lsiKeywords: [
      'fichas de reconhecimento visual de padrões para Etsy',
      'gerador de fichas sem texto de padrões em grelha',
      'fichas de sequências AB ABC ABCD para vender online',
    ],
    titleTag: 'Gerador Fichas de Padrões em Grelha | Criar e Vender',
    metaDescription: 'Gere fichas de padrões em grelha com nove tipos, dois modos de pergunta, configuração por exercício, gabarito separado e 104 temas. Teste grátis com marca.',
  },
  ...
  tutorial: {
    title: 'Como Criar Fichas de Reconhecimento de Padrões em 8 Passos',
    steps: [
      {
      ...
      },
      {
        ...
        description: 'Na secção de Configuração de Página, selecione o tamanho: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) ou introduza um tamanho personalizado. Escolha uma cor de fundo, selecione um fundo temático decorativo da biblioteca de imagens com opacidade ajustável e adicione uma moldura de borda com controlo de opacidade independente. Estas opções de layout dão às suas fichas de padrões uma aparência profissional e polida antes de configurar qualquer exercício.',
      },
      {
        title: 'Definir o Número de Exercícios e as Opções Globais',
        description: 'Escolha o número de exercícios por página de 1 a 8 (5 por defeito). Ative ou desative a numeração de exercícios. Defina um tema global de ficha para aplicar imagens coordenadas em todos os exercícios, ou deixe em aberto para configurar temas individualmente por exercício. Ative o Início Aleatório para começar padrões a meio do ciclo para maior dificuldade, e a Posição Aleatória do Espaço em Branco para colocar o elemento em falta em qualquer lugar da sequência em vez de uma localização fixa.',
      },
      {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Cada exercício da página tem definições independentes para tipo de padrão, modo de pergunta e tema de imagens. O Exercício 1 pode ser AB em caixa em branco com animais da quinta, o Exercício 2 um ABC em escolha múltipla com veículos, e o Exercício 3 um ABCD em caixa em branco com criaturas marinhas — tudo na mesma página. Isto significa que uma só ficha serve como atividade diferenciada completa com dificuldade progressiva, sem necessidade de páginas separadas para cada tipo de padrão ou modo.',
    },
    {
      question: 'Em que diferem as Fichas de Padrões do Trem de Padrões?',
      answer: 'As Fichas de Padrões usam um layout padrão em grelha com 1 a 8 exercícios configurados de forma independente por página, nove tipos de padrões (AB até ABCD) e dois modos de pergunta (caixa em branco e escolha múltipla). O Trem de Padrões apresenta um só padrão em 11 vagões temáticos com cinco tipos de padrões (AB até AABB) e número de pistas ajustável. As Fichas de Padrões destacam-se em volume, variedade e páginas de avaliação de dificuldade mista. O Trem de Padrões destaca-se em envolvimento visual com o seu formato único de vagões de trem. Ambos produzem resultados sem texto.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'fichas-padroes-sequencias', anchorText: 'Fichas de Padrões — Detalhes Completos do Produto' },
  ...
  visuals: {
    ...
    videoTitle: 'Como Criar Fichas de Reconhecimento de Padrões com Nove Tipos de Padrões e Dois Modos de Pergunta — Tutorial Passo a Passo',
  },
};
