...
const content: BundleContent = {
  ...
  bundleBenefits: [
    {
      title: 'Zes Generators, Eén Aankoop',
      description: 'Elke app apart kopen kost aanzienlijk meer. De bundel verpakt alle zes wiskunde generators voor een fractie van het individuele totaal, waardoor je maximale productvariatie krijgt voor een enkele investering. Je krijgt optelling, aftrekken, codepuzzels, vergelijking, legpuzzel-rekenen en algebra beeldvergelijkingen — elke kernrekenvaardigheid waar basisschoolkopers naar zoeken — in één voordelig pakket.',
    },
    {
      title: 'Complete Wiskunde Productlijn',
      description: 'Dek elke kernrekenvaardigheid waar kopers naar zoeken — optelling, aftrekken, vergelijking, codepuzzels, legpuzzelactiviteiten en algebra beeldvergelijkingen. Vermeld tientallen verschillende producten vanuit één toolkit zonder gaten in je catalogus. Combineer verschillende generators met verschillende thema\'s om unieke productvermeldingen te maken: "Oceaandieren Optelpakket", "Ruimte Aftrekkenbundel", "Boerderij Rekenpuzzel Collectie" — elk gericht op een andere zoekopdracht en kopersbehoefte.',
    },
    {
    ...
    },
    {
      ...
      description: 'Toegang tot dieren, eten, voertuigen, feestdagen, seizoenen en tientallen meer themacategorieën over alle zes generators. Elk thema geeft je een verse productinvalshoek — vermeld "Boerderijdieren Optelling" naast "Ruimte Aftrekken" om verschillende zoekopdrachten en kopersinteressen op te vangen.',
    },
    {
      title: 'Eigen Afbeeldingen Uploaden',
      description: 'Upload je eigen PNG- of JPEG-bestanden naar elke generator voor merkgebonden, nichespecifieke werkbladen. Maak producten rond trending thema\'s, seizoensgebonden evenementen of klantspecifieke verzoeken die geen kant-en-klaar sjabloon kan evenaren.',
    },
    {
  ...
  businessUseCases: [
    {
      title: 'Etsy Wiskunde Werkblad Winkel',
      description: 'Maak een complete Etsy-winkel rond wiskunde printables. Vermeld optelpakketten, aftrekkenbundels, vergelijkingswerkbladen en puzzelcollecties als afzonderlijke producten. De bundel geeft je zes productcategorieën vanaf dag één — genoeg om een etalage te vullen die kopers serieus nemen. Gebruik de 100+ thematische beeldsets om seizoensgebonden vermeldingen te maken: terug-naar-school dieren rekenen, feestdagenthema aftrekken, lente tuin optelling. Elke themavariatie wordt een aparte vermelding die ander zoekverkeer opvangt. Etsy beloont winkels met diepe catalogi in een gerichte niche, en de wiskunde bundel geeft je de tools om tientallen verschillende productvermeldingen te maken zonder tussen aparte generators te wisselen.',
      platform: 'Etsy',
    },
    {
  ...
  whoIsThisFor: [
    ...
    },
    {
      ...
      description: 'Je produceert inhoud voor blogs, YouTube-kanalen of sociale media gericht op onderwijs. Gebruik de generators om voorbeeldwerkbladen te maken voor tutorials, leadmagnets of downloadbare bronnen die verkeer naar je betaalde producten leiden. De gratis proefversie met watermerk laat je werkbladkwaliteit tonen in je inhoud voordat je een licentie aanschaft. Inhoudmakers die werkbladgeneratie demonstreren in tutorialvideo\'s ontdekken dat live creatie-demonstraties sterke kijkersbetrokkenheid genereren en directe conversies naar hun printable productenwinkels stimuleren.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Absoluut. Elke generator ondersteunt het uploaden van eigen PNG- en JPEG-bestanden. Gebruik je eigen illustraties, merkmascotte of door klanten aangeleverde illustraties om nichespecifieke werkbladen te maken die geen kant-en-klaar sjabloon kan evenaren.',
    },
    {
      question: 'Werken de werkbladen in andere talen dan Nederlands?',
      answer: 'Vijf van de zes generators produceren puur visuele werkbladen — alleen afbeeldingen en cijfers, geen taaltekst op de pagina. Deze werken in elke taal wereldwijd. Code-Optelling heeft een taalgevoelige Woordonthulling-modus die alle 11 interfacetalen ondersteunt voor gedecodeerde woordenschatwoorden.',
    },
    {
    ...
    {
      question: 'Heb ik ontwerpsoftware nodig om deze generators te gebruiken?',
      answer: 'Nee. De generators draaien volledig in je browser zonder installatie, plugins of accounts. Je configureert instellingen in de zijbalk, bekijkt het resultaat in real-time op het canvas en downloadt voltooide bestanden direct. Geen Photoshop, Canva, InDesign of andere software nodig. De ingebouwde randenbibliotheek, achtergrondopties en indelingsbesturingen verzorgen al het ontwerpwerk voor je.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'optellen-werkbladen', anchorText: 'Optelling werkblad generator bekijken' },
    { pageType: 'app', slug: 'aftrekken-werkbladen', anchorText: 'Aftrekken werkblad generator bekijken' },
    { pageType: 'app', slug: 'rekenpuzzels-werkbladen', anchorText: 'Rekenpuzzel generator bekijken' },
  ...
  visuals: {
    ...
    sampleGallery: [
      { src: '/samples/dutch/addition/optellen-is-leuk-1.webp', alt: 'Optelwerkblad met thematische dierenafbeeldingen', caption: 'Optelling Werkblad' },
      { src: '/samples/dutch/subtraction/aftrekken-is-leuk-1.webp', alt: 'Aftrekwerkblad met doorstrepen telmethode', caption: 'Aftrekken Werkblad' },
      { src: '/samples/dutch/code%20addition/geheime-code-optellen-1.webp', alt: 'Code-optelling puzzel met letterdecodering', caption: 'Code-Optelling Puzzel' },
      { src: '/samples/dutch/more%20less/meer-minder-1.webp', alt: 'Groter dan kleiner dan vergelijkingswerkblad', caption: 'Meer of Minder Werkblad' },
      { src: '/samples/dutch/math%20puzzle/wiskundepuzzels-1.webp', alt: 'Legpuzzel-raster rekenpuzzel met vergelijkingen', caption: 'Rekenpuzzel Werkblad' },
      { src: '/samples/dutch/math%20worksheet/wiskundeblad-1.webp', alt: 'Visuele algebra puzzel met afbeeldingsvariabelen', caption: 'Rekenwerkblad Puzzel' },
    ],
