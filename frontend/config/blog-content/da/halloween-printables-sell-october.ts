...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'coloring-worksheets', anchorText: 'Halloween Farvelægning' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Halloween Ordsøgning' },
    { pageType: 'app', slug: 'picture-bingo-worksheets', anchorText: 'Halloween Banko' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Halloween-Printables',
