...
const content: BlogContent = {
  seo: {
    ...
    metaDescription: 'Productfotografie en Mockups voor Printables. Praktische strategieën en bewezen technieken voor printable verkopers in 2026.',
  },
  hero: {
    title: 'Productfotografie en Mockups voor Printables',
    tagline: 'Van platte PDF-screenshot naar professionele productpresentatie',
    description: 'Van platte PDF-screenshot naar professionele productpresentatie. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
