...
(function (global) {
  ...
  function pearlSVG(mood) {
    ...
    return '<svg class="pop-seal-svg" viewBox="0 0 100 100" role="img" aria-label="' + (LANG === 'fr' ? 'Pearl le phoque' : LANG === 'de' ? 'Pearl, die Robbe' : LANG === 'es' ? 'Pearl la foca' : LANG === 'pt' ? 'Pérola, a foca' : LANG === 'it' ? 'Perla la foca' : LANG === 'nl' ? 'Parel, de zeehond' : 'Pearl the seal') + '">' +
  ...
  global.PearlOpinionPageActivity = {
    ...
    strings: {
      title: { en: "Pearl's Opinion Page", de: 'Pearls Meinungsseite', fr: 'La page d’opinion de Pearl', es: 'La página de opiniones de Pearl', pt: 'A página de opiniões da Pérola', it: 'La pagina delle opinioni di Perla', nl: 'De meningspagina van Parel' },
      prompt: { en: 'Which reason backs up the point?', de: 'Welcher Grund stützt die Meinung?', fr: 'Quelle raison justifie l’avis ?', es: '¿Cuál razón apoya la opinión?', pt: 'Qual razão apoia a opinião?', it: 'Quale motivo sostiene questa opinione?', nl: 'Welke reden ondersteunt de mening?' },
      pearlIntro: { en: 'I made a point! Which card backs it up?', de: 'Ich habe eine Meinung! Welche Karte stützt sie?', fr: 'J’ai donné mon avis ! Quelle carte le justifie ?', es: '¡Di mi opinión! ¿Cuál tarjeta la apoya?', pt: 'Eu dei uma opinião! Qual carta apoia ela?', it: 'Ho detto la mia opinione! Quale carta la sostiene?', nl: 'Ik heb een mening! Welke kaart ondersteunt die?' },
      thePoint: { en: 'POINT:', de: 'MEINUNG:', fr: 'L’AVIS :', es: 'OPINIÓN:', pt: 'OPINIÃO:', it: 'OPINIONE:', nl: 'MENING:' },
      theAsk: { en: 'Which reason backs it up?', de: 'Welcher Grund stützt sie?', fr: 'Quelle raison justifie cet avis ?', es: '¿Cuál razón la apoya?', pt: 'Qual razão apoia a opinião?', it: 'Quale motivo la sostiene?', nl: 'Welke reden past hierbij?' },
      hintPick: { en: 'Tap the reason that backs up the point!', de: 'Tippe auf den Grund, der die Meinung stützt!', fr: 'Tape la raison qui justifie l’avis !', es: '¡Toca la razón que apoya la opinión!', pt: 'Toque na razão que apoia a opinião!', it: 'Tocca il motivo che sostiene questa opinione!', nl: 'Tik op de reden die de mening ondersteunt!' },
      hintWrong: { en: "That doesn't back it up — read the point again.", de: 'Das stützt sie nicht – lies die Meinung noch einmal.', fr: 'Ça ne le justifie pas — relis l’avis.', es: 'Esa no la apoya. Lee la opinión otra vez.', pt: 'Isso não apoia — leia a opinião de novo.', it: 'Questo non la sostiene. Leggi di nuovo questa opinione.', nl: 'Die ondersteunt de mening niet — lees de mening nog eens.' },
      win: { en: 'Yes! That reason backs up the point. 📰', de: 'Ja! Dieser Grund stützt die Meinung. 📰', fr: 'Oui ! Cette raison justifie l’avis. 📰', es: '¡Sí! Esa razón apoya la opinión. 📰', pt: 'Isso! Essa razão apoia a opinião. 📰', it: 'Sì! Questo motivo sostiene questa opinione. 📰', nl: 'Ja! Die reden ondersteunt de mening. 📰' }
    },
    defaults: {},
    ...
    render: function () {
      ...
      var sp = api.el('button', 'pop-spk'); sp.type = 'button'; sp.setAttribute('aria-label', LANG === 'fr' ? 'écouter l’avis' : LANG === 'de' ? 'Meinung vorlesen' : LANG === 'es' ? 'escuchar la opinión' : LANG === 'pt' ? 'ouvir a opinião' : LANG === 'it' ? 'ascolta questa opinione' : LANG === 'nl' ? 'Mening voorlezen' : 'hear the point'); sp.textContent = '🔊';
