...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Code Addition | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Code Addition professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche de code addition où chaque réponse révèle une lettre',

    },
    sampleGallery: [
      { src: '/samples/english/code addition/Code Addition 1.jpeg', alt: 'Fiche code addition avec message secret', caption: 'Décoder un message secret' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Code Addition thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Code Addition est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'code-addition', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Code Addition Gratuit' },
