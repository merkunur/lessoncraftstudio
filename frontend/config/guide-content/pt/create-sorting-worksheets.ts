...
const content: GuideContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: `Sim. Uma licença comercial concede-lhe direitos completos para vender fichas de classificação geradas em qualquer plataforma incluindo Etsy, Amazon KDP, Gumroad, Gumroad e o seu próprio website. Não há taxas de royalties nem encargos por venda. Fica com cem por cento das suas receitas de vendas após as comissões do marketplace.`,
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: `Outra competência prima da classificação. As fichas de intruso pedem aos usuários para identificar elementos que não pertencem, reforçando as mesmas competências de categorização que a classificação.`,
    },
    {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: `Outra ferramenta de competências de classificação onde os usuários identificam elementos que não pertencem. As fichas de intruso reforçam as mesmas competências de categorização que a classificação e agrupam-se naturalmente juntas.`,
    },
    {
      appId: 'bingo',
      title: 'Gerador de cartelas de bingo',
      description: `Usa as mesmas coleções de imagens temáticas para criar produtos de cartelas de bingo. As cartelas de bingo combinam bem com as fichas de classificação em pacotes de atividades temáticas que atraem vendedores e pais.`,
    },
  ],
