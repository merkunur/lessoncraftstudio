...
const content: ToolContent = {
  ...
  businessIdeas: [
    ...
    },
    {
      ...
      description: 'Compile 60–80 fichas de associação em cadernos temáticos para Amazon KDP. O modo Letra Inicial desenvolve a consciência fonémica enquanto os usuários associam imagens com as suas primeiras letras. Estruture uma série por tema: \"Associação do Alfabeto Animal\" cobre temas de quinta, oceano, selva e animais domésticos. \"Associação de Palavras do Quotidiano\" cobre alimentos, veículos, profissões e artigos domésticos. Inclua páginas de gabarito no final de cada capítulo. Ative a escala de cinzentos para saída económica em tinta que se imprime perfeitamente a preto e branco. Os modos sensíveis ao idioma permitem criar edições em idiomas separados a partir das mesmas imagens para mercados internacionais do KDP.',
      platform: 'Amazon KDP',
    },
    {
      title: 'Pacotes de Atividades de Associação para Centros no Gumroad',
      description: 'Carregue pacotes de atividades de associação para centros no Gumroad com campos de nome/data, números dos itens e gabaritos autogerados como pontos de venda principais. Os vendedores que procuram atividades para centros de associação valorizam fichas que chegam prontas para a loja com identificação do usuário e soluções integradas. Organize por tema curricular: associação de ajudantes da comunidade, associação de grupos alimentares, associação de vocabulário do tempo e associação de animais por habitat. Cada ficha inclui o seu próprio gabarito com linhas de ligação, eliminando o tempo de preparação do vendedor. O cabeçalho localizado \"Liga!\" adapta-se a 11 idiomas para salas de aula bilingues e internacionais.',
      platform: 'Gumroad',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'O gabarito autogerado com linhas de ligação horizontais entre os pares corretos é o que separa fichas de associação profissionais das básicas. Inclua sempre os gabaritos nas suas listagens de produtos — os vendedores procuram especificamente atividades de associação com soluções incluídas. Mostre o gabarito nas imagens de pré-visualização do seu produto ao lado da ficha do usuário. O sistema de canvas duplo produz ambas as versões simultaneamente, pelo que incluir gabaritos não adiciona tempo de produção extra.',
    },
    {
      title: 'Varie o Número de Pares para Dificuldade Diferenciada',
      description: 'Crie pacotes de associação escalonados usando o número de pares configurável. Comece com 4 pares para fichas de pré-escolar e jardim de infância com imagens maiores e mais espaço em branco. Use 5 pares para fichas do primeiro ano que equilibram conteúdo e legibilidade. Configure 6 pares para segundo ano e usuários avançados que conseguem lidar com maior densidade de conteúdo. Os pacotes diferenciados com dificuldade progressiva vendem-se melhor do que os pacotes de dificuldade única porque os vendedores precisam de fichas para salas de aula com capacidades mistas.',
    },
    {
    ...
    },
    {
      ...
      description: 'A caixa de verificação que adiciona campos \"Nome: ____\" e \"Data: ____\" transforma fichas de associação de imprimíveis genéricos em atividades estruturadas para a loja. Os vendedores no Gumroad procuram especificamente recursos \"prontos para a loja\" e \"imprimir e usar\" de associação com áreas de identificação do usuário. Combinados com números dos itens para verificação eficiente de respostas, estas funcionalidades de formato tornam as suas fichas de associação imediatamente utilizáveis em ambientes de loja sem preparação adicional do vendedor.',
    },
  ],
