...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Djurpark',
  title: 'Gratis arbetsblad med djurparkstema för barn | LessonCraftStudio',
  description: 'Skapa utskrivbara arbetsblad med djurparkstema för barn. Lejon, elefanter, giraffer och apor. Matte, läsning, pussel och färgläggning för förskola till årskurs 3.',
  keywords: 'djurpark arbetsblad, djurparksdjur aktiviteter, djurpark mattearbetsblad, djurpark målarbilder, utskrivbara djurpark arbetsblad, vilda djur arbetsblad för barn',
  heading: 'Gratis arbetsblad med djurparkstema för barn',
