...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'billed sudoku bøger KDP',
    ...
    titleTag: 'Billed-Sudoku Bøger til KDP: Niche-Guide | LessonCraftStudio',
  ...
  cta: {
    heading: 'Kom I Gang Med Billed-Sudoku Bøger til KDP',
