...
const content: StartContent = {
  ...
  actionSteps: [
    {
      step: 'Identifica su fase de crecimiento actual',
      description: 'Cuenta sus publicaciones activas y revise su tendencia de ingresos de los últimos tres meses. Determine si estás en la Fase 1 (validación, 1–25 publicaciones), Fase 2 (construcción de catálogo, 25–100), Fase 3 (optimización del sistema, 100–300) o Fase 4 (evaluación para tiempo completo, 300+). Cada fase tiene prioridades diferentes.',
    },
    {
      step: 'Audita su catálogo en busque de brechas de profundidad y amplitud',
      description: 'Mapea sus productos existentes por categoría y tema. Identifica dónde tiene profundidad (muchas variaciones en una categoría) y dónde tiene brechas. Prioriza llenar las brechas de profundidad en sus categorías probadas antes de expandirte a nuevas.',
    },
    {
      step: 'Establezca un flujo de trabajo de producción por lotes',
      description: 'Reemplaza la producción de uno en uno con sesiones por lotes. Dedica sesiones separadas a la generación de contenido, creación de mockups, escritura de publicaciones y subida a plataformas. Haga seguimiento del tiempo por paso para identificar su cuello de botella de producción.',
    },
    {
      step: 'Cree una plantilla de publicación para cada categoría de producto',
      description: 'Escriba una plantilla vendedora de descripción de publicación con marcadores de posición para tema, dificultad, recuento de páginas y otras variables. Aplique esta plantilla a cada nueva publicación en esa categoría para calidad consistente y creación de publicaciones más rápida.',
    },
    {
      step: 'Añada una segunda plataforma de venta',
      description: 'Si actualmente vende en una plataforma, elija una segunda plataforma y adapta sus 10 mejores productos para ella. Los vendedores de Etsy deberían considerar Amazon KDP para libros de actividades en tapa blanda. Los vendedores de KDP deberían considerar Etsy para PDFs de descargue digital.',
    },
    {
      step: 'Cree su primer paquete de productos',
      description: 'Seleccione de cinco a ocho productos relacionados de su catálogo y empaquétalos como un paquete temático o de categoría. Ponga precio al paquete con un descuento claro respecto a la compre individual pero superior a su precio medio de producto individual.',
    },
    {
      step: 'Pruebe un mercado en un idioma diferente',
      description: 'Genere productos de muestra en inglés o alemán usando generadores de fichas multilingües. Cree cinco publicaciones en su idioma elegido en el marketplace apropiado. Evalúa el rendimiento durante 60 a 90 días antes de expandirte a idiomas adicionales.',
    },
    {
      step: 'Revise las analíticas y duplica la apuesta en los ganadores',
      description: 'Identifica sus cinco publicaciones con mayor conversión usando las analíticas de la plataforma. Estudia qué las hace funcionar: estructura del título, palabras clave, punto de precio, tipo de producto. Cree más productos que coincidan con estos patrones ganadores.',
    },
    {
    ...
    {
      step: 'Establezca un objetivo de escalado a seis meses',
      description: 'Basándote en su fase de crecimiento actual, establezca un objetivo operativo específico para seis meses: un objetivo de número de publicaciones, un objetivo de número de plataformas y un objetivo de número de paquetes. Revise el progreso mensualmente y ajuste las prioridades de producción basándote en lo que revelan los datos.',
    },
  ],
  ...
  faq: [
    {
      ...
      answer: 'Estás listo para escalar cuando has validado su ajuste producto-mercado: al menos 10 a 15 publicaciones con ventas consistentes durante dos o más meses, una comprensión clara de qué tipos de producto y temas conectan con los compradores, y una plataforma principal donde entiendas el algoritmo de búsqueda y el comportamiento de los compradores. Si todavía estás experimentando con qué vender y dónde, concéntrate primero en la validación.',
    },
    {
      question: '¿Cuántas publicaciones necesito antes de expandirme a una segunda plataforma?',
      answer: 'Apunta a al menos 25 a 50 publicaciones bien optimizadas en su plataforma principal antes de añadir una segunda. Necesita suficientes productos para justificar el esfuerzo de adaptarte a una nueva plataforma y suficientes datos de ventas para saber qué productos priorizar para la publicación cruzada. Comience publicando en la segunda plataforma sus 10 productos de mejor rendimiento en lugar de todo su catálogo.',
    },
    {
      question: '¿Debería expandir mi catálogo con más tipos de producto o más temas en los tipos existentes?',
      answer: 'Profundiza primero, luego amplía. Agota las principales oportunidades de temas y variaciones en sus categorías de producto probadas antes de expandirte a nuevas. Un catálogo con 50 variaciones de sopas de letras en diferentes temas, dificultades e idiomas genere más ingresos totales que 10 productos en cada una de cinco categorías diferentes. La profundidad construye autoridad y oportunidades de venta cruzada dentro de un nicho.',
    },
    {
      question: '¿Cómo pongo precio a los paquetes de productos de forma efectiva?',
      answer: 'Ponga precio a los paquetes con un descuento claro comparado con comprar cada artículo individualmente, pero asegúrese de que el precio del paquete supere su precio medio de producto individual de tres a cinco veces. Si los productos individuales se venden a tres a cinco dólares, los paquetes temáticos deben estar entre 15 y 25 dólares y los mega paquetes entre 30 y 50 dólares. El descuento motiva la compre del paquete mientras que el precio total más alto aumenta sus ingresos por transacción.',
    },
    {
      question: '¿Es realista expandirse a mercados en otros idiomas sin hablar el idioma?',
      answer: 'Sí, cuando se usan generadores de fichas multilingües que producen contenido en el idioma objetivo. Los productos basados en números como fichas de matemáticas y sudoku no requieren idioma en absoluto. Los tipos de puzzle como sopas de letras y crucigramas necesitan generación de palabras en el idioma objetivo, lo que los generadores multilingües manejan automáticamente. Comience con un idioma, evalúa el rendimiento del marketplace durante 60 a 90 días, y luego expándete basándote en los resultados.',
    },
    {
      question: '¿Cuál es el mayor error que cometen los vendedores de imprimibles al intentar escalar?',
      answer: 'Dispersar esfuerzos en demasiadas plataformas y tipos de producto antes de dominar ninguno. Un vendedor con 50 publicaciones bien optimizadas en Etsy superará a un vendedor con 15 publicaciones mediocres en cada una de cuatro plataformas. Domina su plataforma principal, construye profundidad en sus categorías probadas, y luego expándete deliberadamente. El crecimiento sistemático vence al esfuerzo disperso siempre.',
    },
    {
      question: '¿Cuánto de mis ingresos debería reinvertir en el negocio?',
      answer: 'El porcentaje depende de su fase de crecimiento y circunstancias personales, pero el orden de prioridades importe más que la cantidad. Reinvierte en capacidad de producción primero (licencias adicionales de generadores y paquetes de categorías), herramientas de optimización de plataforma segundo, mejoras de diseño tercero y publicidad pagada en último lugar. Solo anuncia productos que ya hayan demostrado ventas orgánicas. Incluso una reinversión modesta se acumula significativamente cuando se dirige a las prioridades correctas.',
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      title: 'Marketing para su Negocio de Imprimibles en Internet',
  ...
  internalLinks: [
    ...
    { pageType: 'start', slug: 'marketing-negocio-imprimibles', anchorText: 'Marketing para su Negocio de Imprimibles en Internet' },
    ...
    { pageType: 'tool', slug: 'generador-dibujo-cuadricula', anchorText: 'Pruebe el Generador de Dibujo en Cuadrícula' },
  ],
  ...
  visuals: {
    ...
    videoTitle: 'Cómo Crear Fichas de Dibujo en Cuadrícula para su Negocio de Imprimibles — Demo de LessonCraftStudio',
  },
