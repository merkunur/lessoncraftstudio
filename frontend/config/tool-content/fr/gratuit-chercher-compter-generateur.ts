...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit Chercher et Compter | PDF Imprimables',
    metaDescription: 'Créez des fiches de chercher et compter gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit chercher compter',
    secondaryKeywords: ["fiches chercher compter gratuites","compter images exercice PDF","dénombrement visuel gratuit","chercher compter maternelle","recherche visuelle enfants"],
    lsiKeywords: ["dénombrement","attention","concentration","comptage","recherche","observation","discrimination","balayage"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/find and count/Find and Count 1.jpeg',
      primaryAlt: 'Fiche chercher compter gratuite',
    },
    sampleGallery: [
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de chercher et compter autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de chercher et compter en 10 étapes',
    steps: [
  ...
  faq: [
    { question: 'Ce générateur de chercher et compter est-il vraiment gratuit ?', answer: 'Oui. La version gratuite inclut toutes les fonctionnalités — tous les modes, les 104 thèmes, l\'export PDF et les corrigés. La seule différence est un petit filigrane sur les fichiers exportés. Utilisez la version gratuite indéfiniment sans créer de compte.' },
  ...
  internalLinks: [
    { slug: 'gratuit-chercher-compter-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit Chercher et Compter' },
    { slug: 'find-and-count', pageType: 'app' as const, anchorText: 'Générateur Chercher et Compter — Détails complets' },
  ],
};
