...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur Compter et Colorier | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Compter et Colorier professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche compter et colorier un graphique en barres',
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Compter et Colorier thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur Compter et Colorier est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'chart-count', pageType: 'tool' as const, anchorText: 'Essayer Générateur Compter et Colorier Gratuit' },
