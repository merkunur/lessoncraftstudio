...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'schaduw matching werkbladen verkopen op Teachers Pay Teachers',
    ],
    lsiKeywords: [
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      {
        title: 'Lesactiviteiten als Snelle Afmaaktaken voor TPT',
        description:
          'Maak kant-en-klare schaduw koppelen activiteiten met naam-/datumvelden en gedrukte antwoordbladen voor gebruik in de klas. Docenten die zoeken naar visuele discriminatie-oefeningen waarderen werkbladen die printklaar worden geleverd. Maak lesstof-gerelateerde sets: dieren-schaduwkoppeling voor biologielessen, hulpverlener-silhouetten voor maatschappijleer, voedsel-schaduwpuzzels voor gezondheidslessen. De labels-schakelaar laat je zowel ondersteunde versies (met A/B/C/D en 1/2/3/4 labels) als uitdagingsversies (labels verborgen) in hetzelfde product maken voor gedifferentieerd onderwijs. Schaduw koppelen werkbladen oefenen visuele waarneming en visuele discriminatie — vaardigheden die in elk curriculum voorkomen van kleuterschool tot groep 6.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Beide modi gebruiken een Fisher-Yates derangement-algoritme dat garandeert dat geen enkel item op zijn oorspronkelijke positie verschijnt. In de Schaduw Koppelen-modus zit geen enkel silhouet direct onder de bijbehorende afbeelding. In de Maak het Compleet-modus verschijnt geen enkele tweede helft naast de bijbehorende eerste helft. Dit zorgt ervoor dat elk werkblad een echte koppeluitdaging presenteert — leerlingen kunnen niet correct raden op basis van alleen positie. Het derangement wordt bij elke generatie opnieuw berekend, waardoor verschillende arrangementen ontstaan van dezelfde afbeeldingen.',
    },
    {
      question: 'Kan ik de A/B/C/D en 1/2/3/4 labels aan- en uitzetten?',
      answer:
        'Ja. Het selectievakje "Labels tonen" in het paneel Oefeningconfiguratie (standaard AAN) bepaalt of A, B, C, D labels op afbeeldingen of eerste helften verschijnen en 1, 2, 3, 4 labels op silhouetten of tweede helften. Wanneer labels AAN staan, schrijven leerlingen letter-nummer-paren als antwoorden. Wanneer labels UIT staan, wordt het werkblad een puur visuele koppeluitdaging zonder alfanumerieke ondersteuning — handig voor puzzelboeken of gevorderde activiteiten.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Schakel het selectievakje "Naam-/datumvelden opnemen" in het paneel Oefeningconfiguratie in om leerlingnaam- en datumregels onderaan het werkblad toe te voegen. Wanneer ingeschakeld, kunnen leerlingen hun naam en de datum direct op de gedrukte pagina schrijven — essentieel voor klasverantwoording en georganiseerde beoordeling. Wanneer uitgeschakeld, gebruikt het werkblad het volledige paginagebied voor koppelinhoud. Deze optie werkt met zowel de Schaduw Koppelen- als de Maak het Compleet-modus.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'schaduw-koppelen-maker',
      anchorText: 'Schaduw Koppelen Werkblad Maker',
    },
    {
      pageType: 'start',
    ...
    },
    {
      ...
      anchorText: 'Dinosaurus Printable Ideeën voor Werkbladen',
    },
  ],
    ...
    sampleGallery: [
      {
        ...
        caption: 'Schaduw Koppelen-modus — leerlingen koppelen afbeeldingen aan hun automatisch gegenereerde silhouetten',
      },
      {
        src: '/samples/dutch/shadow%20match/Schaduw%20Koppelen%202.webp',
        alt: 'Maak het compleet werkblad met gesplitste afbeeldingshelften die leerlingen opnieuw samenvoegen door eerste en tweede helften te koppelen',
        caption: 'Maak het Compleet-modus — leerlingen koppelen gesplitste afbeeldingshelften om plaatjes te completeren',
      },
      {
