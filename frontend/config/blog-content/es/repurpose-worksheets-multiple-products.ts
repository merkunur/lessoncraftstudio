...
const content: BlogContent = {
  ...
  hero: {
    title: 'Como Reutilizar Fichas en Multiples Productos',
    tagline: 'Un contenido, cinco productos, cinco fuentes de ingreso',
    description: 'El contenido educativo que crea puede venderse en multiples formatos y configuraciones. Una ficha de matematicas puede ser un producto individual, parte de un paquete tematico, parte de un paquete por nivel, parte de un mega bundle y compilada en un libro de KDP. Maximizar el numero de productos derivados de cada pieza de contenido es la forma mas eficiente de escalar su catalogo.',
  },
  category: 'how-to',
