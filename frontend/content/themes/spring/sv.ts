...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Vår',
  title: 'Gratis Vår-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara vår-övningar för barn. Matematik, målarbilder, ordspel och pussel med vårtema. Förskola till årskurs 3. Gratis PDF.',
