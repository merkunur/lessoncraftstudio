...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          'Open the Page Setup panel and choose a page size: Letter Portrait, Letter Landscape, A4 Portrait, A4 Landscape, Square (1200\u00d71200), or any custom dimension. Select a background color or pick a decorative background theme from the image library and adjust its opacity so equations remain easy to read. Add a coordinating border frame to give your worksheets a polished, professional finish before you begin adding content.',
      },
      {
        title: 'Choose Your Mode and Configure the Code',
        description:
          'Open Exercise Configuration and select Regular Mode for pure code-cracking or Word Reveal Mode to embed a secret word. In Regular Mode, set the minimum and maximum addend values (1\u201320) and choose how many unique image symbols appear on each sheet (2\u20135). In Word Reveal Mode, type a secret word of up to ten letters \u2014 the app generates one equation per letter whose sum maps to that letter, plus three distractor equations with wrong sums to increase the challenge. If your number range cannot produce enough unique sums for the word, the app automatically widens the range or increases addend count to keep every puzzle solvable.',
      },
      {
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Download worksheets and answer keys as high-resolution JPEG images or print-ready PDF documents. The export engine renders at a 6x multiplier, producing output above 400 DPI on standard page sizes. Enable the grayscale toggle to produce ink-friendly versions that print beautifully on black-and-white printers without sacrificing image clarity. Letter, A4, square, and custom page sizes are all supported, covering every common print format for both home and commercial use.',
      },
      {
        title: 'Full Canvas Editing with Undo and Redo',
        description:
          'The built-in Fabric.js canvas lets you drag, resize, rotate, and reposition every element on the page \u2014 text, images, exercise blocks, borders, and backgrounds. Zoom in and out with a percentage display for precision placement, and use Ctrl+Z and Ctrl+Y for unlimited undo and redo. Lock elements in place once positioned, or unlock everything to redesign on the fly. Layer ordering, alignment tools, and object grouping give you the layout flexibility of a graphic design tool inside a worksheet generator.',
      },
    ],
  },
    ...
    cases: [
      {
        ...
        description:
          'Create themed bundles of 10\u201320 code-cracking addition puzzles \u2014 dinosaur detectives, ocean explorers, space missions \u2014 and list them as instant-download packs on Etsy. Each bundle includes the worksheets plus their answer keys as separate files. The code-breaking format is visually distinctive in search results, standing out from standard addition drill sheets. Include both Regular and Word Reveal puzzles in each pack for variety. Price individual theme packs at $3\u2013$5 and multi-theme mega-bundles at $12\u2013$18.',
  ...
  visuals: {
    ...
    sampleGallery: [
      {
        src: '/samples/english/code addition/Code Breaker Addition 1.jpeg',
      ...
      {
        src: '/samples/english/code addition/Code Breaker Addition 2.jpeg',
      ...
      {
        src: '/samples/english/code addition/Code Breaker Addition 3.jpeg',
    ...
    videoTitle: 'How to Create Code-Breaking Addition Worksheets \u2014 Step-by-Step Tutorial',
  },
};
