...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'kindergarten': {
      ...
      snippetAnswer: 'Huonekaluaiheiset työlehdet esiopetukseen (5–6-vuotiaat) kehittävät spatiaalista ajattelua huoneen suunnittelutehtävillä, vahvistavat mittaamistaitoja huonekalujen kokovertailulla ja tukevat kielellisiä taitoja yhdyssanojen ja sijamuotojen harjoittelulla. Esiopetussuunnitelman matemaattisen ajattelun tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Esiopetusikäisille huonekaluteema on spatiaalisen ajattelun ja suunnittelutaidon konkreettinen harjoituskenttIä. Viisi- ja kuusivuotiaat kykenevät ensimmäistä kertaa piirtämään yksinkertaisia pohjapiirroskuvia ja sijoittamaan huonekaluja tilaan harkitusti. Tämä ylhäältäpäin näkemisen abstraktio on merkittävä kognitiivinen harppaus. Esiopetussuunnitelman matemaattinen ajattelu sisältää avaruudellisen hahmottamisen, ja huonekalujen sijoittelu pohjapiirustukseen on sen konkreettinen sovellus. Mittaaminen saa luonnollisen kontekstin: mahtuuko tuoli pöydän alle, onko sänky pidempi kuin hylly? Kielitietoisuus rikastuu, kun suomen kielen rikkaat sijamuodot (pöydällä, pöydän alla, pöydän vieressä) harjoitellaan konkreettisissa tilanteissa. YhdyssAnat (kirjahylly, sängynpääty, nojatuoli) laajentavat sanastoa suomen kielen rakenteen kautta.',
      developmentalMilestones: [
        { milestone: 'Pohjapiirustuksen ymmärtäminen (5–6-vuotiaat hahmottavat ylhäältäpäin -näkökulman)', howWeAddress: 'Pohjapiirustuksen piirto- ja tulkintatehtävät, joissa huonekalut sijoitetaan tilaan ylhäältä katsottuna, kehittävät abstraktia tilahahmotusta' },
        { milestone: 'Kokovertailu ja mittaaminen (esiopetusikäiset vertailevat esineiden mittasuhteita)', howWeAddress: 'Huonekalujen kokovertailutehtävät, joissa järjestetään esineitä koon mukaan ja mitataan niitä viivoittimella, rakentavat mittaamistaitoa' },
        { milestone: 'Sijamuotojen hallinta (viisi- ja kuusivuotiaat oppivat tarkat paikanilmaukset)', howWeAddress: 'Sijoittelutehtävät, joissa lapsi kuvaa huonekalun sijaintia (pöydän alla, hyllyn vieressä, sohvan takana), harjaannuttavat spatiaalista kieltä' },
        { milestone: 'Yhdyssanojen muodostaminen (esiopetusikäiset ymmärtävät sananmuodostusta)', howWeAddress: 'Yhdyssanatehtävät, joissa yhdistetään kaksi sanaa huonekalusanaksi (kirja+hylly, pari+sänky) ja kirjoitetaan niitä, kehittävät kielitietoisuutta' },
      ],
      differentiationNotes: 'Tukea tarvitseville esiopetusikäisille käytä kolmiulotteisia palikoita huonekalujen sijoittelun harjoitteluun ennen paperitehtävää, yksinkertaista sijamuodot kolmeen (päällä, alla, vieressä) ja rajaa yhdyssanat tutuimpiin. Edistyneille esiopetusikäisille haasta suunnittelemaan kokonainen huone pohjapiirustuksena, lisää mittayksiKöt (senttimetrit) ja pyydä kirjoittamaan huoneen kuvaus kokonaisilla lauseilla sijamuotoja käyttäen.',
      parentTakeaway: 'Huonekaluteema on esiopetusikäiselle yllättävän rikas oppimiskonteksti. Piirtäkää yhdessä lapsen huoneen pohjapiirustus ja sijoitelkaa huonekaluja. Harjoitelkaa sijamuotoja leikissä: piilota nalle pöydän alle — missä se on? Mitatkaa huonekaluja mittanauhalla: kumpi on pidempi, sänky vai pIöytä? Tärkeintä on antaa lapsen suunnitella ja sijoitella — spatiaalinen ajattelu kehittyy parhaiten konkreettisen kokeilun kautta.',
      classroomIntegration: 'Huonekaluteema integroituu esiopetuksen leikkiin ja matikkahetkiin: kotileikissä suunnitellaan huonekalujen sijoittelua, matikkapisteessä mitataan luokkahuoneen huonekaluja ja piirretään pohjapiirustusta, kielipisteessä harjoitellaan sijamuotoja ja yhdyssanoja työlehtien avulla. Esiopetussuunnitelman spatiaalisen ajattelun, kielitietoisuuden ja tutkivan oppimisen tavoitteet yhdistyvät konkreettisesti.',
      assessmentRubric: [
        { skill: 'Pohjapiirustuksen ymmärrys', emerging: 'sijoittaa yhden huonekalun pohjapiirustukseen aikuisen avulla', proficient: 'piirtää yksinkertaisen pohjapiirustuksen kolmella–neljällä huonekalulla', advanced: 'suunnittelee kokonaisen huoneen pohjapiirustuksen loogisesti ja selittää sijoitteluperusteensa' },
        { skill: 'Sijamuotojen hallinta', emerging: 'käyttää kahta sijamuotoa (päällä, alla) aikuisen tuella', proficient: 'käyttää itsenäisesti viittä–kuutta sijamuotoa oikein lauseissa', advanced: 'käyttää monipuolista sijamuotovalikoimaa sujuvasti ja kirjoittaa sijoittelukuvauksia' },
        { skill: 'Yhdyssanojen muodostaminen', emerging: 'tunnistaa yhdyssanan kahdesta osasta aikuisen avulla', proficient: 'muodostaa itsenäisesti kolme–neljä huonekaluyhdyssanaa ja kirjoittaa ne', advanced: 'muodostaa uusia yhdyssanoja luovasti, selittää niiden osat ja käyttää niitä lauseissa' },
      ],
    },
    'first-grade': {
      ...
      snippetAnswer: 'Huonekaluaiheiset työlehdet ensimmäiselle luokalle (6–7-vuotiaat) kehittävät avaruudellista hahmottamista huonesuunnittelun kautta, vahvistavat mittaamistaitoja huonekalujen mittojen tutkimisella sekä opettavat materiaalitietoisuutta ja suunnittelun perusteita. POPS 2014:n geometrian ja ympäristöopin tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Ensimmäisellä luokalla huonekaluteema siirtyy tunnistamisesta suunnitteluun ja mittaamiseen, koska kuusi- ja seitsemänvuotiaat kykenevät käyttämään viivoitinta ja hahmottamaan tilaa karttapohjaisesti. POPS 2014:n geometria sisältää avaruudellisen hahmottamisen, ja huonekalujen sijoittelu huoneeseen on sen konkreettinen sovellus. Ensimmäisen luokan oppilas piirtää yksinkertaisen pohjapiirroksen huoneesta, mittaa huonekalUjen mittoja senttimetreissä ja pohtii sijoittelun toimivuutta. Materiaalitietoisuus laajenee: puu, metalli, kangas, muovi — oppilas tutkii materiaalien ominaisuuksia ja yhdistää ne käyttötarkoitukseen. Geometriset muodot konkretisoituvat huonekaluissa: pIöytä on suorakulmio, lampunvarjostin on kartio, palloPalli on pallo. Suomalainen muotoiluperinne (Aalto, Tapiovaara) tarjoaa inspiraation lähteen kun pohditaan kaunista ja toimivaa muotoilua.',
      developmentalMilestones: [
        { milestone: 'Pohjapiirroksen piirtäminen (6–7-vuotiaat hahmottavat tilan ylhäältä päin)', howWeAddress: 'Pohjapiirrostehtävät, joissa oppilas piirtää oman huoneensa ylhäältä katsottuna ruudukkoon, kehittävät avaruudellista hahmottamista ja karttAtaitoa' },
        { milestone: 'Huonekalujen mittaaminen (ensimmäisen luokan oppilaat mittaavat todellisia esineitä senttimetreissä)', howWeAddress: 'Mittaustehtävät, joissa oppilas mittaa pulpetin, tuolin ja kirjahyllyn mitat ja kirjaa tulokset, yhdistävät konkreettisen mittaamisen dokumentointiin' },
        { milestone: 'Materiaalien tutkiminen ja vertailu (kuusi- ja seitsemänvuotiaat tunnistavat materiaaleja ja niiden ominaisuuksia)', howWeAddress: 'Materiaalitutkimustehtävät, joissa oppilas tunnistaa huonekalujen materiaalit ja vertailee niiden ominaisuuksia (kovuus, paino, tuntuma), kehittävät tutkivaa ajattelua' },
        { milestone: 'Huonekalujen geometristen muotojen tunnistaminen (ensimmäisen luokan oppilaat yhdistävät geometrian arkeen)', howWeAddress: 'Muotontehtävät, joissa oppilas tunnistaa ja nimeää huonekalujen geometriset muodot ja kirjoittaa havaintolauseita, yhdistävät geometrian reaalimaailmaan' },
      ],
      differentiationNotes: 'Tukea tarvitseville ensimmäisen luokan oppilaille anna valmis pohjapiirroksen runko täydennettäväksi, rajaa mittaaminen kolmeen esineeseen ja käytä materiaalitunnistuksessa konkreettisia näytteitä. Edistyneille ensimmäisen luokan oppilaille haasta suunnittelemaan unelmahuone mittakaavassa, lisää materiaalien vertailu koetaulukkoon ja pyydä kirjoittamaan huonekalun tuote-esittely.',
      parentTakeaway: 'Ensimmäisen luokan huonekalutyölehdet tekevät kodista oppimisympäristön. Mittatkaa yhdessä huonekalujen mittoja: mikä on pIöydän pituus, kuinka korkea tuoli on? Piirtäkää yhdessä lapsen huoneen pohjapiirros ja suunnitelkaa huonekalujen sijoittelu. Tutkikaa materiaaleja: miksi tuoli on puuta, miksi sohva on kangasta? Tärkeintä on nähdä koti geometrian ja mittaamisen laboratoriona.',
      classroomIntegration: 'Huonekaluteema integroituu ensimmäisen luokan geometrian, mittaamisen ja ympäristöopin opetukseen: matikkatuokiossa mitataan luokkahuoneen huonekaluja ja piirretään pohjapiirroksia, ympäristöopissa tutkitaan materiaaleja ja käsityössä suunnitellaan pieniIä huonekalumalleja. POPS 2014:n avaruudellisen hahmottamisen ja tutkivan oppimisen tavoitteet toteutuvat konkreettisesti.',
      assessmentRubric: [
        { skill: 'Pohjapiirroksen piirtäminen', emerging: 'piirtää huoneen huonekalut yksinkertaisena listana tai kuvana sivusta', proficient: 'piirtää pohjapiirroksen ylhäältä päin ruudukolle ja sijoittaa huonekalut oikeille paikoille', advanced: 'piirtää mittakaavaisen pohjapiirroksen, perustelee sijoittelun ja suunnittelee vaihtoehtoisia asetteluja' },
        { skill: 'Mittaaminen senttimetreissä', emerging: 'mittaa esineen pituuden aikuisen avustuksella', proficient: 'mittaa itsenäisesti useita mittoja ja kirjaa tulokset taulukkoon', advanced: 'mittaa tarkasti, vertailee esineiden mittoja, laskee eroja ja soveltaa mittoja pohjapiirrokseen' },
        { skill: 'Materiaalitietoisuus', emerging: 'tunnistaa yhden materiaalin (puu) ja sen perusominaisuuden', proficient: 'tunnistaa kolme materiaalia, vertailee ominaisuuksia ja selittää käyttötarkoituksen', advanced: 'vertailee materiaaleja systemaattisesti, selittää miksi tietty materiaali sopii tiettyyn huonekaluun ja ehdottaa vaihtoehtoja' },
      ],
    },
    'second-grade': {
      ...
      snippetAnswer: 'Huonekaluaiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät materiaalien ominaisuuksien tutkimista kokeellisesti, kehittävät mittaamisen ja mittakaavan alkeita huonekalusijoittelun kautta sekä vahvistavat suunnitteluprosessin kirjallista dokumentointia. POPS 2014:n ympäristöopin ja käsitöiden vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla huonekaluteema muuttuu materiaalitutkimukseksi ja suunnitteluprojektiksi, koska seitsemän- ja kahdeksanvuotiaat kykenevät vertailevaan koetoimintaan ja mittakaava-ajatteluun. POPS 2014:n päättötavoitteet edellyttävät materiaalien tutkimista ja käytännön suunnittelutaitoja. Toisen luokan oppilas tutkii huonekalumateriaaleja kokeellisesti: vertailee puun, metallin ja muovin ominaisuuksia (kovuus, paino, kestIävyys). Mittaaminen syventyy: oppilas mittaa huonekaluja senttimetrein ja piirtää yksinkertaisen pohjapiirroksen ruutupaperille mittakaavalla. Kertolaskun alkeet yhdistyvät: 4 tuolia × 4 jalkaa = 16 jalkaa. Suunnitteluprosessi dokumentoidaan: oppilas piirtää huonekalun suunnitelman, listaa materiaalit ja kirjoittaa työvaiheet. Kierrätyksen ja kestävän kuluttamisen näkökulma: voiko vanhan huonekalun kunnostaa uuden ostamisen sijaan?',
      developmentalMilestones: [
        { milestone: 'Materiaalien kokeellinen vertailu (7–8-vuotiaat tutkivat puun, metallin ja muovin ominaisuuksia)', howWeAddress: 'Materiaalikokeet, joissa oppilas testaa eri materiaalien kovuutta, painoa ja kestävyyttä järjestelmällisesti ja kirjaa tulokset taulukkoon, kehittävät kokeellista ajattelua' },
        { milestone: 'Mittaaminen ja pohjapiirroksen piirtäminen (toisen luokan oppilaat ymmärtävät mittakaavan alkeita)', howWeAddress: 'Mittaustehtävät, joissa oppilas mittaa huonekaluja ja huoneen mitat, piirtää pohjapiirroksen ruutupaperille ja sijoittaa huonekalut, kehittävät avaruudellista ajattelua' },
        { milestone: 'Huonekalun suunnitteluprosessin dokumentointi (seitsemän- ja kahdeksanvuotiaat kuvaavat työvaiheita)', howWeAddress: 'Designtehtävät, joissa oppilas suunnittelee yksinkertaisen huonekalun (kirjahylly, jakkara), piirtää suunnitelman ja kirjoittaa työvaiheet, yhdistävät luovuuden ja järjestelmällisyyden' },
        { milestone: 'Kestävän kuluttamisen pohdinta (toisen luokan oppilaat arvioivat kierrätyksen merkitystä)', howWeAddress: 'Pohdintatehtävät, joissa oppilas tutkii vanhan huonekalun kunnostamismahdollisuuksia, vertailee uuden ostamiseen ja kirjoittaa mielipiteensä, syventävät kestävän kehityksen ajattelua' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa materiaalikoe kahteen materiaaliin, anna pohjapiirroksen piirtämiseen valmis ruudukkopohja mittoineen ja tarjoa suunnittelutehtävään kuvallinen vaiheistus. Edistyneille toisen luokan oppilaille laajenna materiaalikoe viidelle materiaalille vertailutaulukoineen, lisää huoneen pohjapiirros oikealla mittakaavalla ja haasta suunnittelemaan huoneen sisustus budjetilla.',
      parentTakeaway: 'Toisen luokan huonekalutehtävät opettavat tutkivaa ajattelua ja käytännön taitoja. Mittatkaa yhdessä kotona huonekaluja: kuinka leveä pöytä, kuinka korkea tuoli? Piirtäkää lasten huoneen pohjapiirros ja kokeilkaa eri huonekalusijoitteluja. Tutkikaa materiaalia: onko tämä puuta vai muovia, kumpi on raskaampaa? Vierailkaa kirpputorilla ja pohtikaa: voiko tämän kunnostaa? Tärkeintä on opettaa mittaamista, suunnittelua ja kestävää ajattelua.',
      classroomIntegration: 'Huonekalutehtävät integroituvat toisen luokan käsitöihin ja ympäristöoppiin: materiaalikokeet tutkivan oppimisen jaksossa, mittaaminen ja pohjapiirros matematiikassa, suunnitelman kirjoittaminen äidinkielessä ja kierrätysprojekti kestävän kehityksen kokonaisuutena. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa huonekaluteema osoittaa kokeellisen tutkimisen, mittaamisen ja suunnittelun taidot.',
      assessmentRubric: [
        { skill: 'Materiaalien kokeellinen tutkiminen', emerging: 'vertailee materiaaleja aistinvaraisesti mutta ei kirjaa tuloksia', proficient: 'testaa kolmen materiaalin ominaisuuksia järjestelmällisesti ja kirjaa tulokset taulukkoon', advanced: 'suunnittelee oman materiaalikokeen, testaa useita ominaisuuksia ja tekee perusteltuja johtopäätöksiä' },
        { skill: 'Mittaaminen ja pohjapiirros', emerging: 'mittaa yksittäisiä huonekaluja mutta ei piirrä pohjapiirrosta', proficient: 'mittaa huoneen ja huonekalut ja piirtää pohjapiirroksen ruutupaperille', advanced: 'piirtää tarkan pohjapiirroksen mittakaavalla ja kokeil ee useita sijoitteluvaihtoehtoja' },
        { skill: 'Suunnitteluprosessin dokumentointi', emerging: 'piirtää huonekalun mutta ei kirjoita työvaiheita', proficient: 'piirtää suunnitelman, listaa materiaalit ja kirjoittaa työvaiheet selkeästi', advanced: 'dokumentoi koko prosessin, arvioi lopputulosta ja ehdottaa parannuksia' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Huonekaluaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät suunnitteluprosessin analyyttistä ymmärrystä materiaalivalintojen ja ergonomian kautta, vahvistavat mittaamismatemaattisia taitoja piirin ja pinta-alan laskemisella kertolaskun avulla sekä opettavat tuotevertailun ja tutkimusraportin kirjoittamista useasta lähteestä. POPS 2014:n vuosiluokkien 3–6 käsitöiden ja geometrian tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla huonekaluteema siirtyy tunnistamisesta suunnittelun ja analyysin tasolle, kun kahdeksan- ja yhdeksänvuotiaat kykenevät ymmärtämään suunnitteluprosesseja ja tekemIään mittauksiin perustuvia päätelmiä. Suunnitteluprosessin analysointi: tarve → luonnos → materiaali → valmistus → käyttö. Materiaalivalintojen tutkiminen: puu, metalli, muovi, kangas — miksi tietty materiaali sopii tiettyyn käyttöön. Mittaamismatemaattiset taidot: huoneen pinta-alan laskeminen, huonekalujen sijoittelun suunnittelu mittapiirustuksella, piirin ja pinta-alan kertolaskukaavat. Ergonomian perusteet: miksi tuolin korkeus vaikuttaa ryähtiin, mikä on sopiva pöydän korkeus. Tuotevertailu: saman huonekalun eri versioiden vertailu hinnan, materiaalin ja kestävyyden perusteella.',
      developmentalMilestones: [
        { milestone: 'Suunnitteluprosessin analysointi tarpeesta valmiiseen tuotteeseen (8–9-vuotiaat ymmärtävät suunnittelun vaiheet)', howWeAddress: 'Suunnitteluprojektit, joissa oppilas analysoi huonekalun suunnitteluprosessin vaiheet, piirtää oman suunnitelman ja perustelee materiaalivalintansa' },
        { milestone: 'Mittaamismatemaattisten taitojen soveltaminen huonetilasuunnitteluun (kolmannen luokan oppilaat laskevat pinta-aloja ja piirejä)', howWeAddress: 'Tilasuunnitteluprojektit, joissa oppilas mittaa huoneen, laskee pinta-alan kertolaskukaavalla, suunnittelee huonekalujen sijoittelun mittapiirustukselle ja perustelee ratkaisunsa' },
        { milestone: 'Materiaalivalintojen tutkiminen ja vertailu (kahdeksan- ja yhdeksänvuotiaat analysoivat ominaisuuksia)', howWeAddress: 'Materiaalitutkimustehtävät, joissa oppilas testaa eri materiaalien ominaisuuksia, kokoaa vertailutaulukon ja kirjoittaa raportin sopivuudesta eri käyttötarkoituksiin' },
        { milestone: 'Tuotevertailun kirjoittaminen useasta lähteestä (kolmannen luokan oppilaat arvioivat tuotteita kriteerein)', howWeAddress: 'Vertailuraportit, joissa oppilas vertailee kolmea huonekaluvaihtoehtoa hinnan, materiaalin, kestävyyden ja ergonomian perusteella ja kirjoittaa perustellun suosituksen' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille rajaa suunnitteluprosessi kolmeen vaiheeseen, anna mittaamisessa valmiit pohjat ja tarjoa vertailuraportille yksinkertainen taulukkomalli. Edistyneille kolmannen luokan oppilaille laajenna suunnittelu 3D-mallinnukseen, lisää tilavuuden laskeminen ja haasta suunnittelemaan huoneen sisustus budjetilla optimoiden tilankIäyttöä ja kestävyyttä.',
      parentTakeaway: 'Kolmannen luokan huonekalutyölehdet kehittävät suunnitteluajattelua ja mittaamistaitoja. Mittatkaa yhdessä lapsen huoneen pinta-ala: pituus × leveys. Suunnitelkaa huonekalujen sijoittelua paperille. Tutkikaa materiaaleja: miksi tuo pöytä on puuta, toinen metalläia? Vertailkaa huonekaluja kaupassa: mikä on hyvIä laatua, mikä ei? Tärkeintä on oppia yhdistämään mittaaminen, suunnittelu ja perustelut.',
      classroomIntegration: 'Huonekalutyölehdet yhdistävät kolmannen luokan käsitöitä, matematiikkaa ja äidinkieltä: suunnitteluprosessin analysointi käsitöissä, pinta-ala- ja pirilaskut mittausjaksossa, materiaalitutkimus ympäristöopissa ja tuotevertailuraportti tietokirjoittamisen jaksossa. POPS 2014:n vuosiluokkien 3–6 suunnittelun, mittaamisen ja tutkivan oppimisen tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Suunnitteluprosessin analysointi', emerging: 'tunnistaa valmiin huonekalun mutta ei analysoi suunnitteluvaiheita', proficient: 'analysoi suunnitteluprosessin vaiheet ja perustelee materiaalivalinnat', advanced: 'suunnittelee oman tuotteen koko prosessin läpi ja arvioi suunnitteluratkaisuja kriittisesti' },
        { skill: 'Mittaamismatemaattiset taidot tilasuunnittelussa', emerging: 'mittaa yksittäisiä mittoja mutta ei laske pinta-alaa', proficient: 'laskee huoneen pinta-alan kaavalla ja suunnittelee huonekalujen sijoittelun mittapiirustukselle', advanced: 'optimoi tilankäyttöä laskelmiin perustuen ja piirtää useita vaihtoehtoisia pohjaratkaisuja' },
        { skill: 'Tuotevertailun kirjoittaminen', emerging: 'valitsee mieluisimman huonekalun ilman vertailua', proficient: 'vertailee tuotteita usealla kriteerillä ja kirjoittaa perustellun suosituksen', advanced: 'analysoi tuotteita monipuolisesti, huomioi kestävyyden ja esittää optimoidun ratkaisun perusteluineen' },
      ],
    },
  },
