...
Start med LessonCraftStudios gratis prøveversion med vandmærke og test alle funktioner, før du investerer i en kommerciel licens.' }
  ...
  internalLinks: [
    { pageType: 'app', slug: 'farvelaegning-arbejdsark', anchorText: 'Hav Farvelægning' },
    { pageType: 'app', slug: 'ordsoegning-arbejdsark', anchorText: 'Hav Ordsøgning' },
    { pageType: 'app', slug: 'matchning-arbejdsark', anchorText: 'Hav Matchning' },
  ],
  relatedPosts: [
