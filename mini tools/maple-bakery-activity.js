...
(function (global) {
  ...
  var L = {
    ...
    es: {
      win: '¡Sí! {note}',
      winShare: '¡{a} galletas en cada plato!',
      winPack: '¡{a} cajas llenas!',
      nShare: 'Cuenta las galletas de UN solo plato.',
      nPack: 'Cuenta cuántas cajas quedaron llenas.',
      srShare: '{d} galletas se reparten en partes iguales en {n} platos. ¿Cuántas galletas hay en cada plato? Opciones: {choices}.',
      srPack: '{d} galletas se empacan en cajas de {n} galletas cada una. ¿Cuántas cajas hay? Opciones: {choices}.'
    },
    pt: {
      win: 'Isso! {note}',
      winShare: '{a} biscoitos em cada prato!',
      winPack: '{a} caixas cheias!',
      nShare: 'Conte os biscoitos de UM prato só.',
    ...
    // nl — native nl math ensemble (SLO-kerndoelen rekenen, groep 4): delen als
    // verdelen (bordjes) + groeperen (doosjes). Diminutieven bordjes/doosjes
    // (matcht koekjes; "bord" = ook schoolbord). {tokens} preserved.
    nl: {
      win: 'Ja — {note}',
      winShare: '{a} koekjes op elk bordje!',
      winPack: '{a} volle doosjes!',
      nShare: 'Tel de koekjes op maar één bordje.',
      nPack: 'Tel hoeveel doosjes vol zijn.',
      srShare: '{d} koekjes worden eerlijk verdeeld over {n} bordjes. Hoeveel koekjes liggen er op elk bordje? Keuzes: {choices}.',
      srPack: '{d} koekjes worden in doosjes gedaan waar er telkens {n} in gaan. Hoeveel doosjes zijn er? Keuzes: {choices}.'
    }
  };
  function txt(k, a) {
  ...
  var MapleBakeryActivity = {
    ...
    _injectStyle: function () {
      ...
      s.textContent = [
        ...
        '.mb-say{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;}',
        '.mb-maple{flex:0 0 auto;}',
        '.mb-line-msg{flex:0 1 auto;min-height:1.1em;text-align:center;font:700 clamp(0.88rem,2.1vw,1.14rem)/1.3 Nunito,system-ui,sans-serif;color:#146B5E;margin:0;}',
