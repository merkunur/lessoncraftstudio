...
(function (global) {
  ...
  var WORDS_PT = { 0: 'zero', 1: 'um', 2: 'dois', 3: 'três', 4: 'quatro', 5: 'cinco', 6: 'seis', 7: 'sete', 8: 'oito', 9: 'nove' };
  /* Brazilian: adjective FOLLOWS the noun (« patinhos amarelos »); adj = plural for the call, sg = singular for the aria. "marrom" → plural "marrons". */
  var COLOR_PT = { yellow: { adj: 'amarelos', sg: 'amarelo' }, brown: { adj: 'marrons', sg: 'marrom' } };
  var WORDS_IT = { 0: 'zero', 1: 'uno', 2: 'due', 3: 'tre', 4: 'quattro', 5: 'cinque', 6: 'sei', 7: 'sette', 8: 'otto', 9: 'nove' };
  /* Italian: adjective FOLLOWS the noun (« anatroccoli gialli »); adj = plural for the call, sg = singular for the aria. "marrone" → plural "marroni". */
  var COLOR_IT = { yellow: { adj: 'gialli', sg: 'giallo' }, brown: { adj: 'marroni', sg: 'marrone' } };
  var WORDS_NL = { 0: 'nul', 1: 'één', 2: 'twee', 3: 'drie', 4: 'vier', 5: 'vijf', 6: 'zes', 7: 'zeven', 8: 'acht', 9: 'negen' };
  /* Dutch: attributive adjective before a PLURAL noun takes -e (adj = gele/bruine, for the call "{n} {kind} eendjes"); before a bare/indefinite SINGULAR het-noun "eendje" it is UNINFLECTED (sg = geel/bruin, for the aria). */
  var COLOR_NL = { yellow: { adj: 'gele', sg: 'geel' }, brown: { adj: 'bruine', sg: 'bruin' } };
  var LANG = 'en';
  ...
  global.MamasRollCallActivity = {
    ...
    strings: {
      title: { en: "Mama's Roll Call", de: 'Mamas Morgenappell', fr: 'L’appel de Maman', es: 'El pase de lista de Mamá Pata', pt: 'A chamada da Mamãe Pata', it: 'La conta di Mamma Papera', nl: 'Mama Eend telt af' },
      instruction: { en: 'Send Mama the number she calls, then write it.', de: 'Schick Mama die Zahl, die sie ruft – dann schreib sie auf.', fr: 'Envoie à Maman le nombre qu’elle demande, puis écris-le.', es: 'Envíale a Mamá Pata la cantidad de patitos que pida y luego escribe el número.', pt: 'Envie à Mamãe Pata a quantidade de patinhos que ela pedir e depois escreva o número.', it: 'Manda a Mamma il numero che chiama, poi scrivilo.', nl: 'Stuur Mama het getal dat ze roept – schrijf het dan op.' },
      prompt: { en: 'Send the number!', de: 'Schick die Zahl!', fr: 'Envoie le nombre !', es: '¡Envía el número!', pt: 'Envie o número!', it: 'Manda il numero!', nl: 'Stuur het getal!' },
      callNumeral: { en: 'Mama needs {n}!', de: 'Mama braucht {n}!', fr: 'Maman a besoin de {n} !', es: '¡Mamá necesita {n}!', pt: 'A Mamãe precisa de {n}!', it: 'Mamma ne vuole {n}!', nl: 'Mama heeft er {n} nodig!' },
      callZero: { en: 'Mama needs NONE — let them sleep!', de: 'Mama braucht KEINS – lass sie schlafen!', fr: 'Maman n’en veut AUCUN — laisse-les dormir !', es: 'Mamá no necesita ninguno… ¡déjalos dormir!', pt: 'A Mamãe não precisa de nenhum… deixe eles dormirem!', it: 'Mamma non ne vuole NESSUNO — falli dormire!', nl: 'Mama heeft er GEEN nodig – laat ze slapen!' },
      callGroup: { en: 'Send a duckling for each lily-pad!', de: 'Schick für jedes Seerosenblatt ein Entenküken!', fr: 'Envoie un caneton pour chaque nénuphar !', es: '¡Envía un patito por cada hoja de nenúfar!', pt: 'Envie um patinho para cada folha de vitória-régia!', it: 'Manda un anatroccolo per ogni ninfea!', nl: 'Stuur voor elk lelieblad een eendje!' },
      callKind: { en: 'Send {n} {kind} ducklings!', de: 'Schick {n} {kind} Entenküken!', fr: 'Envoie {n} canetons {kind} !', es: '¡Envía {n} patitos {kind}!', pt: 'Envie {n} patinhos {kind}!', it: 'Manda {n} anatroccoli {kind}!', nl: 'Stuur {n} {kind} eendjes!' },
      countBrood: { en: 'How many came to Mama? Tap each to count.', de: 'Wie viele sind zu Mama gekommen? Tippe jedes an, um zu zählen.', fr: 'Combien sont venus vers Maman ? Touche chacun pour compter.', es: '¿Cuántos llegaron con Mamá? Toca cada uno para contarlos.', pt: 'Quantos chegaram até a Mamãe? Toque em cada um para contar.', it: 'Quanti sono arrivati da Mamma? Tocca ognuno per contarli.', nl: 'Hoeveel kwamen er naar Mama? Tik ze aan om te tellen.' },
      arriveLab: { en: 'More keep arriving — count them all!', de: 'Es kommen noch mehr – zähl sie alle!', fr: 'Il en arrive encore — compte-les tous !', es: '¡Vienen más… cuéntalos todos!', pt: 'Estão chegando mais… conte todos!', it: 'Ne arrivano altri — contali tutti!', nl: 'Er komen er nog meer – tel ze allemaal!' },
      hintSend: { en: 'Tap a duckling to send it across to Mama.', de: 'Tippe ein Entenküken an, um es zu Mama hinüberzuschicken.', fr: 'Touche un caneton pour l’envoyer vers Maman.', es: 'Toca un patito para enviárselo a Mamá.', pt: 'Toque em um patinho para enviá-lo à Mamãe.', it: 'Tocca un anatroccolo per mandarlo da Mamma.', nl: 'Tik een eendje aan om het naar Mama te sturen.' },
      hintCount: { en: 'Tap each duckling once to count it.', de: 'Tippe jedes Entenküken einmal an, um es zu zählen.', fr: 'Touche chaque caneton une fois pour le compter.', es: 'Toca cada patito una vez para contarlo.', pt: 'Toque em cada patinho uma vez para contá-lo.', it: 'Tocca ogni anatroccolo una volta per contarlo.', nl: 'Tik elk eendje één keer aan om te tellen.' },
      signNav: { en: 'Sign the roll ✍', de: 'Appell unterschreiben ✍', fr: 'Signe l’appel ✍', es: 'Firma el pase ✍', pt: 'Assine a chamada ✍', it: 'Firma la conta ✍', nl: 'Lijst aftekenen ✍' },
      moreArrive: { en: 'More arrive ▶', de: 'Es kommen mehr ▶', fr: 'Il en arrive plus ▶', es: 'Vienen más ▶', pt: 'Chegam mais ▶', it: 'Ne arrivano altri ▶', nl: 'Er komen er meer ▶' },
      backRaft: { en: '← send more', de: '← mehr schicken', fr: '← en envoyer plus', es: '← enviar más', pt: '← enviar mais', it: '← mandane altri', nl: '← meer sturen' },
      signHint: { en: 'Write the number in the mud to call the roll!', de: 'Schreib die Zahl in den Schlamm, um den Appell aufzurufen!', fr: 'Écris le nombre dans la boue pour faire l’appel !', es: '¡Escribe el número en el lodo para pasar lista!', pt: 'Escreva o número na lama para fazer a chamada!', it: 'Scrivi il numero nel fango per fare la conta!', nl: 'Schrijf het cijfer in de modder om af te tekenen!' },
      traceIt: { en: 'Write the {n}', de: 'Schreib die {n}', fr: 'Écris le {n}', es: 'Escribe el {n}', pt: 'Escreva o {n}', it: 'Scrivi il numero {n}', nl: 'Schrijf de {n}' },
      strokeN: { en: 'Stroke {k}', de: 'Strich {k}', fr: 'Trait {k}', es: 'Trazo {k}', pt: 'Traço {k}', it: 'Tratto {k}', nl: 'Haal {k}' },
      thisWay: { en: 'Start that stroke first — this way!', de: 'Fang mit diesem Strich an – so herum!', fr: 'Commence par ce trait — dans ce sens !', es: 'Empieza con este trazo… ¡por aquí!', pt: 'Comece por esse traço… por aqui!', it: 'Comincia prima da quel tratto — così!', nl: 'Begin met deze haal – zo!' },
      sealed: { en: 'The roll is true — Mama gathers her brood! 🦆', de: 'Der Appell stimmt – Mama sammelt ihre Schar! 🦆', fr: 'L’appel est bon — Maman rassemble ses petits ! 🦆', es: '¡El pase está bien… Mamá reúne a su parvada! 🦆', pt: 'A chamada está certa — a Mamãe reúne os patinhos! 🦆', it: 'La conta è giusta — Mamma raduna i suoi piccoli! 🦆', nl: 'Het klopt – Mama haalt haar troep op! 🦆' },
      sealedZero: { en: 'Zero ducklings — and you wrote the zero! The raft sleeps in. 🌙', de: 'Null Entenküken – und du hast die Null geschrieben! Das Floß schläft weiter. 🌙', fr: 'Zéro caneton — et tu as écrit le zéro ! Le radeau dort encore. 🌙', es: 'Cero patitos… ¡y escribiste el cero! La balsa sigue durmiendo. 🌙', pt: 'Zero patinhos — e você escreveu o zero! A balsa fica dormindo. 🌙', it: 'Zero anatroccoli — e hai scritto lo zero! La zattera resta a dormire. 🌙', nl: 'Nul eendjes – en je schreef de nul! Het vlot slaapt door. 🌙' },
      redo: { en: "Let's call that roll again.", de: 'Lass uns den Appell noch einmal aufrufen.', fr: 'Refaisons l’appel.', es: 'Vamos a pasar lista otra vez.', pt: 'Vamos fazer a chamada de novo.', it: 'Rifacciamo la conta.', nl: 'We tellen nog een keer.' },
      tapCheck: { en: 'Tap Check! ✓', de: 'Tippe auf Prüfen! ✓', fr: 'Touche Vérifier ! ✓', es: '¡Toca Comprobar! ✓', pt: 'Toque em Verificar! ✓', it: 'Tocca Controlla! ✓', nl: 'Tik op Controleer! ✓' },
      sentLab: { en: 'With Mama', de: 'Bei Mama', fr: 'Avec Maman', es: 'Con Mamá', pt: 'Com a Mamãe', it: 'Con Mamma', nl: 'Bij Mama' },
      raftLab: { en: 'The raft', de: 'Das Floß', fr: 'Le radeau', es: 'La balsa', pt: 'A balsa', it: 'La zattera', nl: 'Het vlot' }
    },
    defaults: {},
    ...
    _callCard: function () {
      ...
      if (this.act === 'count-out-distract') {
        var k = this.round.call.kind, kindWord = (LANG === 'de' && COLOR_DE[k]) ? COLOR_DE[k].adj : ((LANG === 'fr' && COLOR_FR[k]) ? COLOR_FR[k].adj : ((LANG === 'es' && COLOR_ES[k]) ? COLOR_ES[k].adj : ((LANG === 'pt' && COLOR_PT[k]) ? COLOR_PT[k].adj : ((LANG === 'it' && COLOR_IT[k]) ? COLOR_IT[k].adj : ((LANG === 'nl' && COLOR_NL[k]) ? COLOR_NL[k].adj : k)))));
    ...
    _raftCol: function () {
      ...
      if (s.sent.length) { var rb = api.el('button', 'rc-recall'); rb.type = 'button'; rb.textContent = '↩'; rb.setAttribute('aria-label', LANG === 'de' ? 'eins zurückrufen' : (LANG === 'fr' ? 'en rappeler un' : (LANG === 'es' ? 'regresar un patito' : (LANG === 'pt' ? 'devolver um patinho' : (LANG === 'it' ? 'richiamane uno' : (LANG === 'nl' ? 'er één terugroepen' : 'call one back')))))); rb.addEventListener('click', function () { Core.recallDuck(s, s.sent[s.sent.length - 1].id); self.msg = null; self.api.sound && self.api.sound(360); self.render(); }); sent.appendChild(rb); }
      ...
      remaining.forEach(function (d) { var b = api.el('button', 'rc-duck'); b.type = 'button'; b.innerHTML = duckSVG(d.kind); b.setAttribute('aria-label', LANG === 'de' ? ((COLOR_DE[d.kind] ? COLOR_DE[d.kind].sg + ' ' : '') + 'Entenküken — zum Schicken tippen') : (LANG === 'fr' ? ((COLOR_FR[d.kind] ? 'caneton ' + COLOR_FR[d.kind].sg : 'caneton') + ' — touche pour l’envoyer') : (LANG === 'es' ? ((COLOR_ES[d.kind] ? 'patito ' + COLOR_ES[d.kind].sg : 'patito') + ' — toca para enviarlo') : (LANG === 'pt' ? ((COLOR_PT[d.kind] ? 'patinho ' + COLOR_PT[d.kind].sg : 'patinho') + ' — toque para enviar') : (LANG === 'it' ? ((COLOR_IT[d.kind] ? 'anatroccolo ' + COLOR_IT[d.kind].sg : 'anatroccolo') + ' — tocca per mandarlo') : (LANG === 'nl' ? ((COLOR_NL[d.kind] ? COLOR_NL[d.kind].sg + ' ' : '') + 'eendje — tik om te sturen') : (d.kind + ' duckling — tap to send'))))))); b.addEventListener('click', function () { Core.sendDuck(s, d.id); self.msg = null; self.api.sound && self.api.sound(520); self.render(); }); rrow.appendChild(b); });
    ...
    _commit: function () {
      ...
      if (r === 'sealed') {
        ...
        speak(this._n() === 0 ? (LANG === 'de' ? 'null' : (LANG === 'fr' ? 'zéro' : (LANG === 'es' ? 'cero' : (LANG === 'pt' ? 'zero' : (LANG === 'it' ? 'zero' : (LANG === 'nl' ? 'nul' : 'zero')))))) : numWord(this._n()));
        this._win();
      } else {
