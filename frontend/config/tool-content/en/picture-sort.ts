...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    ...
    {
      title: 'Ready-to-Sell Sorting Activities with Name/Date Fields',
      description: 'Build ready-to-sell sorting worksheets with name/date fields and printed answer keys. Create themed sets: living vs nonliving for science products, healthy vs unhealthy food for nutrition themes, day vs night animals for habitat bundles, hot vs cold weather clothing for seasonal packs. Theme mode generates worksheets quickly for bulk product creation, while manual mode lets you hand-pick specific images that match your product vision. The auto-generated answer key saves production time and makes self-checking possible.',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'The auto-generated answer key with 6× larger images organized into category boxes is what makes your sorting worksheets a complete, self-checking product rather than just a sorting activity. Always include answer keys in your product bundles and showcase them in listing preview images. Products that include answer keys consistently outsell worksheets-only listings because buyers want self-checking materials that require no additional prep time. The dual-canvas system generates both versions simultaneously, so including the answer key costs you nothing extra.',
    },
    {
