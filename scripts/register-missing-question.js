/* =====================================================================
   register-missing-question.js — the seven registration points for #55.
   Run:  node scripts/register-missing-question.js
   IDEMPOTENT: a second run must report every point as already done.

   Cloned from register-doubling-mirror.js (#54), which encodes the
   ...
   All four are verified to have landed before the step reports.
...
const PREV = 'doubling-mirror';
const CATEGORY = 'number';           /* decomposition of a whole — K.OA.A.3 */
const VER_FROM = '7.89', VER_TO = '7.90';
...
/* ---- 4. manipulatives.ts hub card -------------------------------- */
{
  /* ⚠ WRITTEN, not warned about. #49's script printed a note here and
     ...
     tool's own strings by _mk-missing-question-card.js. */
