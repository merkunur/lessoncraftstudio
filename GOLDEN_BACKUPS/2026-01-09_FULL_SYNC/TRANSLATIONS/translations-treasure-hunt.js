...
const translations = {
  en: {
    ...
    "button.createAnswer": "Create Answer Key",
    "button.createWorksheet": "Create Worksheet",
    ...
    "message.noPuzzleData": "No puzzle data created.",
    ...
    "message.selectSixImages": "Please select exactly 6 images manually, or choose a theme to create from.",
    ...
    "message.worksheetGenerated": "Worksheet created!",
    ...
    "puzzle.generateFromTheme": "Create from Theme (Overrides Manual):",
  ...
  de: {
    ...
    "message.generateContent": "Bitte zuerst Inhalt erstellen.",
    "message.generateFirst": "Bitte zuerst ein Arbeitsblatt erstellen.",
    "message.generateWorksheet": "Bitte zuerst ein Arbeitsblatt erstellen.",
    ...
    "message.maxImages": "Maximal 6 Bilder ausgewählt.",
    "message.noImages": "Keine Bilder gefunden.",
    "message.noPuzzleData": "Keine Rätseldaten erstellt.",
    ...
    "message.selectSixImages": "Bitte wähle genau 6 Bilder manuell aus, oder wähle ein Thema zum Erstellen.",
    ...
    "message.worksheetGenerated": "Arbeitsblatt erstellt!",
    ...
    "puzzle.generateFromTheme": "Aus Thema Erstellen (Überschreibt Manuelle Auswahl):",
  ...
  es: {
    ...
    "button.generateAnswer": "Crear Solución",
    "button.generateWorksheet": "Crear Actividad",
    ...
    "message.answerGenerated": "¡Solución creada!",
    ...
    "message.worksheetGenerated": "¡Actividad creada!",
    "page.title": "Creador de Búsqueda del Tesoro",
    ...
    "puzzle.generateFromTheme": "Crear desde un Tema (Reemplaza la Selección Manual):",
  ...
  it: {
    ...
    "button.generateAnswer": "Crea Soluzione",
    "button.generateWorksheet": "Crea Scheda",
    ...
    "message.answerGenerated": "Soluzione creata!",
    ...
    "message.generateContent": "Prima crea del contenuto.",
    "message.generateFirst": "Prima crea una scheda.",
    "message.generateWorksheet": "Prima crea una scheda.",
    ...
    "message.noPuzzleData": "Nessun dato del gioco creato.",
    ...
    "message.selectSixImages": "Seleziona esattamente 6 immagini manualmente, o scegli un tema per creare automaticamente.",
    ...
    "message.worksheetGenerated": "Scheda creata!",
    ...
    "puzzle.generateFromTheme": "Crea da un Tema (Sostituisce la Selezione Manuale):",
  ...
  pt: {
    ...
    "button.generateWorksheet": "Criar Folha de Atividades",
    ...
    "decoration.borderOpacity": "Transparência da Moldura:",
    ...
    "message.generateContent": "Primeiro crie o conteúdo.",
    "message.generateFirst": "Primeiro crie uma folha de atividades.",
    "message.generateWorksheet": "Primeiro crie uma folha de atividades.",
    ...
    "message.noPuzzleData": "Nenhum dado do jogo foi criado.",
    ...
    "message.selectSixImages": "Selecione exatamente 6 imagens manualmente, ou escolha um tema para criar automaticamente.",
    ...
    "message.worksheetGenerated": "Folha de atividades criada!",
  ...
  nl: {
    ...
    "common.none": "Geen",
    "none": "Geen",
    "decoration.backgroundOpacity": "Achtergrondtransparantie:",
    "decoration.backgroundTheme": "Achtergrondthema:",
    "decoration.borderOpacity": "Randtransparantie:",
    ...
    "library.title": "Afbeeldingenverzameling",
    ...
    "message.generateContent": "Maak eerst inhoud.",
    "message.generateFirst": "Maak eerst een werkblad.",
    ...
    "message.noPuzzleData": "Geen spelgegevens gemaakt.",
    ...
    "message.selectSixImages": "Selecteer precies 6 afbeeldingen handmatig, of kies een thema om automatisch te maken.",
    ...
    "message.worksheetGenerated": "Werkblad gemaakt!",
    ...
    "puzzle.generateFromTheme": "Maken vanuit Thema (Vervangt Handmatige Selectie):",
    ...
    "treasure.hunt.language.description": "Selecteert de taal alleen voor de inhoud van de afbeeldingenverzameling. De interfacetaal wordt ingesteld via de hoofdtaalkeuze in de koptekst.",
  ...
  sv: {
    ...
    "none": "Ingen",
    "none": "Ingen",
    "decoration.backgroundOpacity": "Bakgrundsgenomskinlighet:",
    "decoration.backgroundTheme": "Bakgrundstema:",
    "decoration.borderOpacity": "Ramgenomskinlighet:",
    ...
    "library.selectTheme": "Välj bibliotekstema:",
    ...
    "puzzle.selectTheme": "-- Välj ett tema för övningsbladet --",
    ...
    "settings.title": "Inställningar för övningsblad",
  ...
  da: {
    ...
    "message.generateFirst": "Opret venligst et opgaveark først.",
    "message.generateWorksheet": "Opret venligst et opgaveark først.",
    ...
    "message.noPuzzleData": "Ingen spildata oprettet.",
    ...
    "message.selectSixImages": "Vælg venligst præcis 6 billeder manuelt, eller vælg et tema til automatisk oprettelse.",
    ...
    "pageSize.letterPortrait": "Letter Stående (612×792)",
    "pageSize.square": "Kvadrat (1200×1200)",
    "puzzle.generateFromTheme": "Opret fra Tema (Erstatter Manuelt Valg):",
  ...
  no: {
    ...
    "message.generateContent": "Vennligst lag innhold først.",
    ...
    "message.noPuzzleData": "Ingen spilldata laget.",
    "message.pdfCreateError": "Feil ved laging av PDF.",
    ...
    "message.selectSixImages": "Vennligst velg nøyaktig 6 bilder manuelt, eller velg et tema for automatisk laging.",
    ...
    "pageSize.letterPortrait": "Letter Stående (612×792)",
    "pageSize.square": "Kvadrat (1200×1200)",
    "puzzle.generateFromTheme": "Lag fra tema (erstatter manuelt valg):",
    ...
    "settings.languageLabel": "Språk:",
    "treasure.hunt.language.description": "Velger språket kun for bildesamlingsinnhold. Grensesnittspråket styres av hovedspråkvelgeren i headeren.",
