...
const content: StartContent = {
  ...
  toolsRecommended: [
    {
      ...
      description: 'Le cartelle bingo sono tra i prodotti stampabili più condivisibili — perfette per feste, negozi, festività ed eventi. Ogni occasione crea un momento di marketing naturale su Pinterest e social media, generando traffico ricorrente al tuo negozio.',
    },
    {
      appId: 'word-search-worksheets',
      title: 'Generatore di Cerca Parole',
      description: 'Il cerca parole è il tipo di puzzle più cercato su ogni marketplace. Forte potenziale SEO sulla piattaforma con domanda tutto l\'anno da genitori, venditori e acquirenti di libri di attività. Il supporto multilingue apre 11 mercati linguistici da un singolo strumento.',
    },
    {
    ...
    },
    {
      ...
      description: 'Domanda sempreverde con volume di ricerca tutto l\'anno da genitori e venditori. Le schede di matematica vedono i picchi stagionali più marcati durante il ritorno a scuola e la preparazione ai test — ancore affidabili del calendario di marketing.',
    },
    {
  ...
  visuals: {
    ...
    samples: [
      { src: '/samples/italian/bingo/tombola 1.webp', alt: 'Cartella bingo che mostra il potenziale di marketing basato sugli eventi per feste e negozi', caption: 'Bingo — Altamente Condivisibile per Eventi e Festività' },
