...
const content: AppContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        `Elke afbeelding die je selecteert uit de bibliotheek (of zelf uploadt) wordt toegewezen om één onbekende variabele in het vergelijkingenstelsel voor te stellen. Dezelfde afbeelding vertegenwoordigt altijd dezelfde waarde binnen één puzzel. gebruikers zien herkenbare plaatjes in plaats van abstracte letters, waardoor het concept van variabelen concreet en toegankelijk wordt — zelfs voor jonge gebruikers die nog nooit formele algebra hebben gezien. Ouders en verkopers reageren consistent positief op deze visuele aanpak, en productvermeldingen die het afbeelding-variabelen concept benadrukken genereren doorgaans hogere kliktarieven op Etsy en Gumroad.`,
    },
    {
