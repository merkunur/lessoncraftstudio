...
const THEME_CONFIG = {
  name: 'zoo_animals',
  type: 'images',
  sourceFolderName: 'zoo animals',
  displayNames: {
    en: 'Zoo Animals',
    de: 'Zootiere',
    fr: 'Animaux du zoo',
    es: 'Animales del zoológico',
    it: 'Animali dello zoo',
    pt: 'Animais do zoológico',
    nl: 'Dierentuindieren',
    sv: 'Djurparksdjur',
    da: 'Zoodyr',
    no: 'Dyrehagedyr',
    fi: 'Eläintarhan eläimet'
  }
};
...
async function main() {
  console.log('============================================================');
  console.log('Image Import Script: Zoo Animals');
  console.log('============================================================\n');
