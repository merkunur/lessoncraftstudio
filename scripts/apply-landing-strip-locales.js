/* =====================================================================
   APPLY + GATE — TOOL #51's ten non-English string sets
   =====================================================================
   Merges `_landing-strip-strings.js` into the tool's `strings` block and
   ...
   *våningen* and `kerros` failing to match *kerroksessa* — a ban tested
   ...
   Run: node scripts/apply-landing-strip-locales.js [--dry-run]
   ===================================================================== */
'use strict';
const fs = require('fs');
...
const TOOL = path.join(__dirname, '..', 'mini tools', 'landing-strip.js');
const LOC = require(path.join(__dirname, '_landing-strip-strings.js'));
