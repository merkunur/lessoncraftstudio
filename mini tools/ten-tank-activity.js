...
(function (global) {
  ...
  var WORDS_NL = { 10: 'tien', 11: 'elf', 12: 'twaalf', 13: 'dertien', 14: 'veertien', 15: 'vijftien', 16: 'zestien', 17: 'zeventien', 18: 'achttien', 19: 'negentien' };
  var LANG = 'en';
  ...
  global.TenTankActivity = {
    ...
    strings: {
      title: { en: "Dewey's Ten-Tank", de: 'Deweys Zehner-Tank', fr: 'Le réservoir de Dewey', es: 'El tanque de decenas de Dewey', pt: 'Tanque de Dez do Dudu', it: 'La vasca di Dewey', nl: 'Dobbers tientank' },
      prompt: { en: 'Make a ten and some ones!', de: 'Mach einen Zehner und ein paar Einer!', fr: 'Fais une dizaine et des unités !', es: '¡Forma una decena y algunas unidades!', pt: 'Monte uma dezena e algumas unidades!', it: 'Fai una decina e alcune unità!', nl: 'Maak een tiental en een paar enen!' },
      buildTenHint: { en: 'Tap the tank to drop bubbles — fill it to ten!', de: 'Tippe auf den Tank und lass Blasen hinein – füll ihn bis zehn!', fr: 'Touche le réservoir pour faire tomber des bulles — remplis-le jusqu’à dix !', es: 'Toca el tanque y deja entrar las burbujas: ¡llénalo hasta diez!', pt: 'Toque no tanque para soltar bolhas — encha até dez!', it: 'Tocca la vasca: fai cadere le bolle fino a dieci!', nl: 'Tik op de tank om belletjes te laten vallen — vul hem tot tien!' },
      placeTenHint: { en: 'Pop the ready-made ten into the tank!', de: 'Setz den fertigen Zehner in den Tank!', fr: 'Mets la dizaine toute prête dans le réservoir !', es: '¡Pon en el tanque la decena ya formada!', pt: 'Solte a dezena pronta no tanque!', it: 'Metti la decina già pronta nella vasca!', nl: 'Zet het kant-en-klare tiental in de tank!' },
      placeOnesHint: { en: 'Now add the ones — tap to drop them in.', de: 'Jetzt die Einer dazu – tippe und lass sie hineinfallen.', fr: 'Ajoute maintenant les unités — touche pour les faire tomber.', es: 'Ahora las unidades: toca y déjalas caer.', pt: 'Agora ponha as unidades — toque para soltar.', it: 'Ora aggiungi le unità: tocca per farle cadere.', nl: 'Voeg nu de enen toe — tik om ze erin te laten vallen.' },
      regroupHint: { en: 'Drop ones — ten ones will make a ten!', de: 'Lass Einer hineinfallen – zehn Einer werden zu einem Zehner!', fr: 'Fais tomber des unités — dix unités feront une dizaine !', es: 'Deja caer unidades: ¡diez unidades forman una decena!', pt: 'Solte unidades — dez unidades viram uma dezena!', it: 'Fai cadere le unità: dieci unità formano una decina!', nl: 'Laat enen vallen — tien enen worden samen een tiental!' },
      decomposeHint: { en: 'Take it apart: the ten in one tray, the ones in the other.', de: 'Nimm die Zahl auseinander: den Zehner in das eine Fach, die Einer in das andere.', fr: 'Sépare le nombre : la dizaine dans un bac, les unités dans l’autre.', es: 'Separa el número: la decena en un espacio y las unidades en el otro.', pt: 'Separe: a dezena numa bandeja, as unidades na outra.', it: 'Scomponi: la decina in un vassoio e le unità in un altro.', nl: 'Haal het uit elkaar: het tiental in het ene vak, de enen in het andere.' },
      repairHint: { en: 'Dewey needs {n} — how many more ones?', de: 'Dewey braucht {n} – wie viele Einer fehlen noch?', fr: 'Dewey a besoin de {n} — combien d’unités en plus ?', es: 'Dewey necesita {n}: ¿cuántas unidades faltan?', pt: 'Dudu quer {n} — quantas unidades faltam?', it: 'Dewey ha bisogno di {n}: quante altre unità?', nl: 'Dobber heeft {n} nodig — hoeveel enen erbij?' },
      audioHint: { en: '🔊 Make the number Dewey said!', de: '🔊 Mach die Zahl, die Dewey gesagt hat!', fr: '🔊 Fais le nombre que Dewey a dit !', es: '🔊 ¡Forma el número que dijo Dewey!', pt: '🔊 Monte o número que o Dudu falou!', it: '🔊 Fai il numero che ha detto Dewey!', nl: '🔊 Maak het getal dat Dobber zei!' },
      compareHint: { en: 'Peek at both, then tap which has more!', de: 'Guck bei beiden kurz und tippe dann auf die, die mehr hat!', fr: 'Regarde les deux, puis touche celui qui en a le plus !', es: '¡Observa los dos y toca el que tiene más!', pt: 'Espie os dois e toque no que tem mais!', it: 'Sbircia tutti e due, poi tocca quale ne ha di più!', nl: 'Gluur bij allebei en tik dan op welke er meer heeft!' },
      makeOrder: { en: 'Make {n}!', de: 'Mach {n}!', fr: 'Fais {n} !', es: '¡Forma {n}!', pt: 'Monte {n}!', it: 'Fai {n}!', nl: 'Maak {n}!' },
      hearAgain: { en: '🔊 Hear it again', de: '🔊 Nochmal hören', fr: '🔊 Réécouter', es: '🔊 Escuchar otra vez', pt: '🔊 Ouvir de novo', it: '🔊 Ascolta di nuovo', nl: '🔊 Nog een keer horen' },
      tensTray: { en: 'Tens', de: 'Zehner', fr: 'Dizaines', es: 'Decenas', pt: 'Dezenas', it: 'Decine', nl: 'Tientallen' },
      onesTray: { en: 'Ones', de: 'Einer', fr: 'Unités', es: 'Unidades', pt: 'Unidades', it: 'Unità', nl: 'Enen' },
      moreMore: { en: '+{k} more', de: '+{k} mehr', fr: '+{k} de plus', es: '+{k} más', pt: '+{k} mais', it: '+{k} ancora', nl: '+{k} meer' },
      peek: { en: 'Peek', de: 'Gucken', fr: 'Regarder', es: 'Ver', pt: 'Espiar', it: 'Sbircia', nl: 'Gluren' },
      seal: { en: 'Ten! A ten and…', de: 'Zehn! Ein Zehner und …', fr: 'Dix ! Une dizaine et…', es: '¡Diez! Una decena y…', pt: 'Dez! Uma dezena e…', it: 'Dieci! Una decina e…', nl: 'Tien! Een tiental en…' },
      refuseSingle: { en: 'That\'s a ten-spot — singles go in the pond!', de: 'Das ist ein Zehner-Platz – einzelne Blasen kommen in den Teich!', fr: 'C’est une place pour une dizaine — les bulles seules vont dans la mare !', es: 'Ese espacio es para una decena: ¡las burbujas sueltas van al estanque!', pt: 'Aí é da dezena — as unidades vão no tanque!', it: 'Qui va una decina intera: le unità vanno nello stagno!', nl: 'Dit is de tiental-plek — losse belletjes gaan bij de enen!' },
      refuseTenth: { en: 'That\'d make a whole new ten — we just need a ten and some!', de: 'Das gäbe einen ganz neuen Zehner – wir brauchen nur einen Zehner und ein paar Einer!', fr: 'Ça ferait une toute nouvelle dizaine — il faut juste une dizaine et quelques unités !', es: 'Eso formaría otra decena completa: ¡solo necesitamos una decena y algunas unidades!', pt: 'Isso faria outra dezena — a gente só quer uma dezena e umas unidades!', it: 'Così si forma una nuova decina: serve una decina e alcune unità!', nl: 'Dan wordt het een heel nieuw tiental — we hebben genoeg aan één tiental en een paar!' },
      win: { en: 'A ten and some — you made it! 🦆', de: 'Ein Zehner und ein paar Einer – geschafft! 🦆', fr: 'Une dizaine et des unités — tu as réussi ! 🦆', es: '¡Una decena y algunas unidades: lo lograste! 🦆', pt: 'Uma dezena e mais um tanto — você conseguiu! 🦆', it: 'Una decina e alcune unità: ottimo lavoro! 🦆', nl: 'Een tiental en een paar enen — gelukt! 🦆' },
      hintCheck: { en: 'Make a ten and some ones!', de: 'Mach einen Zehner und ein paar Einer!', fr: 'Fais une dizaine et des unités !', es: '¡Forma una decena y algunas unidades!', pt: 'Monte uma dezena e algumas unidades!', it: 'Fai una decina e alcune unità!', nl: 'Maak een tiental en een paar enen!' },
      srcLabelTen: { en: 'a ten — ten ones together', de: 'ein Zehner – zehn Einer zusammen', fr: 'une dizaine — dix unités ensemble', es: 'una decena: diez unidades juntas', pt: 'uma dezena — dez unidades juntas', it: 'una decina: dieci unità insieme', nl: 'een tiental — tien enen samen' },
      rejectSealFirst: { en: 'Seal a ten yourself first!', de: 'Bündle erst selbst einen Zehner!', fr: 'Fais d’abord une dizaine toi-même !', es: '¡Primero forma tú una decena!', pt: 'Feche uma dezena primeiro!', it: 'Prima forma tu una decina!', nl: 'Bundel eerst zelf een tiental!' },
      snapAnnounce: { en: 'Ten ones make a ten!', de: 'Zehn Einer werden zu einem Zehner!', fr: 'Dix unités font une dizaine !', es: '¡Diez unidades forman una decena!', pt: 'Dez unidades viram uma dezena!', it: 'Dieci unità formano una decina!', nl: 'Tien enen worden een tiental!' },
      rejectFix: { en: "Not quite — count what's missing!", de: 'Fast – zähl, was noch fehlt!', fr: 'Presque — compte ce qui manque !', es: 'Casi: ¡cuenta lo que falta!', pt: 'Quase — conte o que falta!', it: 'Non proprio: conta quante ne mancano!', nl: 'Bijna — tel hoeveel er nog missen!' },
      rejectJudge: { en: 'Look again — count the ones!', de: 'Schau nochmal – zähl die Einer!', fr: 'Regarde encore — compte les unités !', es: 'Mira otra vez: ¡cuenta las unidades!', pt: 'Olhe de novo — conte as unidades!', it: 'Guarda di nuovo: conta le unità!', nl: 'Kijk nog eens — tel de enen!' },
      isMore: { en: '{n} is more!', de: '{n} ist mehr!', fr: '{n}, c’est plus !', es: '¡{n} es más!', pt: '{n} é mais!', it: '{n} è di più!', nl: '{n} is meer!' },
      tenAria: { en: 'a ten', de: 'ein Zehner', fr: 'une dizaine', es: 'una decena', pt: 'uma dezena', it: 'una decina', nl: 'een tiental' },
      judgeThis: { en: 'This one!', de: 'Das hier!', fr: 'Celui-ci !', es: '¡Este!', pt: 'Este!', it: 'Questa!', nl: 'Deze!' }
    },
    defaults: {},
    ...
    render: function () {
      ...
      if (this.round.type === 'audio' && !this._heardSpoken) { this._heardSpoken = true; var self = this; setTimeout(function () { speak((LANG === 'es' ? 'Forma ' : LANG === 'de' ? 'Mach ' : LANG === 'fr' ? 'Fais ' : LANG === 'pt' ? 'Monte ' : LANG === 'it' ? 'Fai ' : LANG === 'nl' ? 'Maak ' : 'Make ') + numWord(self.round.target)); }, 250); }
    },
    _hint: function () {
    ...
    _renderBuildTen: function (root) {
      ...
      if (this.round.type === 'audio') { var hb = api.el('button', 'tt-peekbtn'); hb.type = 'button'; hb.textContent = api.t('hearAgain'); hb.addEventListener('click', function () { speak((LANG === 'es' ? 'Forma ' : LANG === 'de' ? 'Mach ' : LANG === 'fr' ? 'Fais ' : LANG === 'pt' ? 'Monte ' : LANG === 'it' ? 'Fai ' : LANG === 'nl' ? 'Maak ' : 'Make ') + numWord(self.round.target)); }); side.appendChild(hb); }
    ...
    _tapTen: function () {
      ...
      if (res.sealed) { this.sessionSealed = true; this.api.sound && this.api.sound(880); this.announce(this.api.t('seal')); speak(LANG === 'es' ? 'Diez' : LANG === 'de' ? 'Zehn' : LANG === 'fr' ? 'Dix' : LANG === 'pt' ? 'Dez' : LANG === 'it' ? 'Dieci' : LANG === 'nl' ? 'Tien' : 'Ten'); this._afterTen(); }
      else this.render();
    },
    ...
    _tapLoose: function () {
      ...
      if (res.snapped) { this.sessionSealed = true; this.api.sound && this.api.sound(880); this.announce(this.api.t('snapAnnounce')); speak(LANG === 'es' ? 'Diez' : LANG === 'de' ? 'Zehn' : LANG === 'fr' ? 'Dix' : LANG === 'pt' ? 'Dez' : LANG === 'it' ? 'Dieci' : LANG === 'nl' ? 'Tien' : 'Ten'); if (this._onesTarget() === 0) { this._win(); return; } this.stage = 'place-ones'; this.render(); return; }
      this.render();
    },
    ...
    _win: function () {
      ...
      if (this.round.mode === 'compose' && this.round.type !== 'compare' && this.round.target >= 11) speak((LANG === 'es' ? 'una decena y ' : LANG === 'de' ? 'ein Zehner und ' : LANG === 'fr' ? 'une dizaine et ' : LANG === 'pt' ? 'uma dezena e ' : LANG === 'it' ? 'una decina e ' : LANG === 'nl' ? 'een tiental en ' : 'a ten and ') + this._onesTarget() + ' — ' + numWord(this.round.target));
