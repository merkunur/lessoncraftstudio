...
const translations = {
  ...
  de: {
    ...
    "message.answerGenerated": "Lösungsbogen erstellt!",
  ...
  pt: {
    ...
    "button.generateWorksheet": "Criar Folha de trabalho",
    ...
    "message.generateFirst": "Primeiro crie uma folha de trabalho.",
    "message.generateWorksheet": "Primeiro crie uma folha de trabalho.",
    ...
    "message.worksheetGenerated": "Folha de trabalho criada!",
  ...
  da: {
    ...
    "pageSize.letterPortrait": "Letter Stående (612×792)",
    "pageSize.square": "Kvadrat (1200×1200)",
    "puzzle.generateFromTheme": "Opret fra Tema (Erstatter Manuel Valg):",
  ...
  no: {
    ...
    "message.generateFirst": "Vennligst opprett et oppgaveark først.",
    "message.generateWorksheet": "Vennligst opprett et oppgaveark først.",
    ...
    "message.noPuzzleData": "Ingen spilldata opprettet.",
    ...
    "message.selectSixImages": "Vennligst velg nøyaktig 6 bilder manuelt, eller velg et tema for automatisk oppretting.",
    ...
    "pageSize.letterPortrait": "Letter Stående (612×792)",
    "pageSize.square": "Kvadrat (1200×1200)",
    "puzzle.generateFromTheme": "Opprett fra Tema (Erstatter Manuelt Valg):",
    ...
    "button.answerJpeg": "Vastausavain (JPEG)",
    "button.answerPdf": "Vastausavain (PDF)",
