...
window.MatchPairsCore = {
  ...
  strings: {
    title:       { en: 'Match Pairs',                                                              de: 'Paare bilden',                                                                          es: 'Forma parejas',                                                                                       it: 'Forma le coppie',                                                                                                      fr: 'Forme les paires',                                                                                                                                                  pt: 'Forme os pares',                                                                                                                                                                                                                       nl: 'Maak paren',                                                                                              sv: 'Para ihop',                                                                                               da: 'Par sammen',                                                                                              no: 'Sett sammen par' },
    instruction: { en: 'Tap two cards that go together — and watch the pairs link.',               de: 'Tippe auf zwei Karten, die zusammengehören — und sieh zu, wie sich die Paare verbinden.', es: 'Toca dos tarjetas que van juntas — y mira cómo se enlazan las parejas.',                              it: 'Tocca due carte che vanno insieme — e guarda come le coppie si collegano.',                                            fr: 'Touche deux cartes qui vont ensemble — et regarde les paires se relier.',                                                                                          pt: 'Toque em duas cartas que combinam — e veja os pares se conectarem.',                                                                                                                                                                  nl: 'Tik op twee kaarten die bij elkaar horen — en kijk hoe de paren verbinden.',                              sv: 'Tryck på två kort som hör ihop — och se hur paren kopplas ihop.',                                         da: 'Tryk på to kort, der hører sammen — og se hvordan parrene forbindes.',                                    no: 'Trykk på to kort som hører sammen — og se hvordan parene kobles.' },
    /* Banner label above the board ("Target: 5"). Per-locale; previously
       hard-coded EN in render(); hoisted at the DE fan-out. SV+DA+NO
       share `Mål` (Nordic-trio cognate). */
    targetLabel:    { en: 'Target',                                                                de: 'Ziel',                                                                                  es: 'Objetivo',                                                                                            it: 'Obiettivo',                                                                                                            fr: 'Objectif',                                                                                                                                                          pt: 'Objetivo',                                                                                                                                                                                                                             nl: 'Doel',                                                                                                    sv: 'Mål',                                                                                                     da: 'Mål',                                                                                                     no: 'Mål' },
    /* Screen-reader prefix for the card aria-label ("Card 5"). Per-locale;
       previously hard-coded EN in render(); hoisted at DE fan-out.
       SV+DA+NO share `Kort ` (full Nordic-trio cognate); FI commission
       at its time should expect this cognate cluster to require no
       additional drops since FI is non-Nordic. */
    cardAriaPrefix: { en: 'Card ',                                                                 de: 'Karte ',                                                                                es: 'Tarjeta ',                                                                                            it: 'Carta ',                                                                                                               fr: 'Carte ',                                                                                                                                                            pt: 'Carta ',                                                                                                                                                                                                                               nl: 'Kaart ',                                                                                                  sv: 'Kort ',                                                                                                   da: 'Kort ',                                                                                                   no: 'Kort ' },
