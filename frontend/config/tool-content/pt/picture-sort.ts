...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: `Construa fichas de classificação prontas para a loja para centros de classificação, trabalho matinal e prática independente com campos de nome/data e gabaritos impressos. Crie conjuntos alinhados com o catálogo de produtos: vivo vs não vivo para ciências, comida saudável vs não saudável para nutrição, animais diurnos vs noturnos para habitats, roupa de tempo quente vs frio para estações. O modo de tema gera fichas rapidamente para conjuntos em massa da loja, enquanto o modo manual permite-lhe selecionar imagens específicas que correspondam aos objetivos da lição. O gabarito autogerado poupa tempo de preparação ao vendedor e torna possíveis estações de classificação com autocorreção.`,
    },
    {
      title: `Produtos de Classificação Multilingue para Mercados Internacionais`,
      description: `O Gerador de Classificação de Imagens é sensível ao idioma — as etiquetas de categoria utilizam nomes localizados de imagens da Biblioteca de Imagens, pelo que mudar de idioma atualiza o texto na ficha. Crie fichas de classificação em inglês, alemão, francês, espanhol, português, italiano, neerlandês, sueco, dinamarquês, norueguês e finlandês a partir das mesmas imagens sem reconstruir nada. O cabeçalho localizado de Classificação de Imagens também se traduz automaticamente. Venda pacotes de classificação em idiomas específicos dirigidos a lojas Etsy internacionais e compradores multilingues do Gumroad, ou crie atividades de classificação PLE onde as etiquetas bilingues de categoria reforçam a aquisição de vocabulário.`,
    },
    {
  ...
  businessIdeas: [
    ...
    {
      title: `Pacotes de Atividades de Classificação para o Gumroad`,
      description: `Carregue pacotes de atividades de classificação no Gumroad com campos de nome/data, categorias alinhadas com o catálogo de produtos e gabaritos autogerados como pontos de venda principais. Os vendedores que procuram atividades de classificação valorizam fichas que chegam prontas para a loja com funcionalidades de responsabilidade do usuário. Crie conjuntos alinhados com o catálogo de produtos: vivo vs não vivo para ciências, comida saudável vs não saudável para nutrição, ajudantes da comunidade vs animais para estudos sociais. Cada pacote inclui fichas do usuário com molduras de categoria e grelhas de recortes misturadas mais gabaritos com imagens classificadas nos grupos corretos. O modo manual permite-lhe selecionar as imagens exatas que correspondem a cada objetivo da lição.`,
      platform: 'Gumroad',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: `O número configurável de imagens de 4 a 12 é a sua ferramenta de escalamento de dificuldade. Crie pacotes com dificuldade progressiva: comece com fichas de 4 imagens onde as categorias são óbvias e o exercício de classificação é simples, depois progrida para fichas de 8 imagens com mais elementos a classificar, e termine com fichas avançadas de 12 imagens onde os usuários devem ordenar muitos elementos em duas categorias. Os pacotes de dificuldade progressiva servem a faixa etária mais ampla e justificam preços premium porque os compradores obtêm conteúdo para múltiplos níveis num só produto.`,
    },
    {
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      },
      {
        ...
        alt: `Ficha de classificação em modo manual com imagens selecionadas individualmente e atribuídas às categorias esquerda e direita para classificação alinhada com o catálogo de produtos`,
