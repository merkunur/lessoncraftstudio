...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Het leerkrachtenplatform versus de marktplaats — waar verkoopt u het beste?',
    description: 'Samen Voor Onderwijs is het Nederlandse equivalent van Teachers Pay Teachers — een platform specifiek voor leerkrachten. Etsy is een algemene marktplaats. Beide hebben voor- en nadelen voor werkbladen verkopers. Deze vergelijking helpt u beslissen waar u uw werkbladen het beste kunt aanbieden, of dat u op beide platforms actief moet zijn.',
  },
