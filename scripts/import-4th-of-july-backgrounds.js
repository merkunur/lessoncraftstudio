...
// Theme configuration - BACKGROUNDS type
const THEME_CONFIG = {
  name: '4th_of_july_bg',  // Unique name for backgrounds (different from main images theme)
...
// Image processing settings - NO RESIZE for backgrounds (keep original aspect ratio)
...
async function main() {
  console.log('============================================================');
  console.log('Background Import Script: 4th of July');
  console.log('============================================================\n');
