...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Wat werkt en wat niet voor Etsy zoekoptimalisatie dit jaar',
    description: 'Etsy SEO verandert regelmatig, maar de basisprincipes blijven hetzelfde: relevante zoekwoorden, kwalitatieve listings en consistente activiteit. In 2026 zijn er specifieke veranderingen die printable verkopers moeten kennen om hun zichtbaarheid te behouden en te vergroten.',
  },
