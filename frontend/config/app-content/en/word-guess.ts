...
const content: AppContent = {
  ...
  ctaHeading: 'Start creating word guess worksheets',
  ...
  visuals: {
    heroImages: {
      primary: '/samples/english/word%20guess/clue-grid-worksheet.webp',
      primaryAlt: 'Word guess worksheet with image clues and blank letter grids showing hangman-style vocabulary puzzles',
    },
    sampleGallery: [
      {
        src: '/samples/english/word%20guess/clue-grid-worksheet.webp',
      ...
      {
        src: '/samples/english/word%20guess/clue-grid-worksheet-2.webp',
      ...
      {
        src: '/samples/english/word%20guess/clue-grid-answer-key.webp',
