...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      {
        title: 'Configure Etiquetas y Campos de Nombre/Fecha',
        description: 'Active o desactive la casilla "Mostrar Etiquetas" (activada por defecto) para mostrar los identificadores A, B, C, D en las imágenes o primeras mitades y los identificadores 1, 2, 3, 4 en las siluetas o segundas mitades. Con etiquetas activadas, los usuarios escriben pares letra-número como respuestas — andamiaje estructurado para usuarios más pequeños. Con etiquetas desactivadas, la ficha se convierte en un desafío de asociación puramente visual sin señales alfanuméricas — ideal para libros de puzzles o actividades avanzadas donde las respuestas escritas no son necesarias. Marca "Incluir Campos de Nombre/Fecha" para añadir líneas de nombre y fecha al pie de la ficha para responsabilidad en línea.',
      },
      {
        title: 'Seleccione 4 Imágenes de la Biblioteca o Suba las Tuyas',
        description: 'Abra el panel de Biblioteca de Imágenes y navegue 104 colecciones temáticas con más de 3.100 ilustraciones a color — animales, comida, vehículos, naturaleza, festividades, profesiones y docenas más. Filtra por tema usando el menú desplegable o busque por palabra clave. Haga clic en las imágenes para seleccionarlas — el contador muestra su progreso hacia las 4 imágenes requeridas. Ambos modos siempre usan exactamente 4 imágenes por ficha. La vista previa de imágenes seleccionadas confirma sus elecciones antes de generar. Alternativamente, use el panel de Subir Imágenes Personalizadas para cargar sus propios archivos PNG, JPG o GIF para fichas de asociación de sombras personalizadas — fotos familiares, obras de arte personalizadas, imágenes de marca o contenido específico del mercado.',
      },
      {
      ...
      },
      {
        ...
        description: 'Haga clic en la pestaña Clave de Respuestas para ver la solución generada automáticamente. En el modo Asociación de Sombras, cada celda muestra la imagen original junto a su silueta con una etiqueta como "A → 2" indicando la coincidencia correcta. En el modo Completa la Imagen, cada celda muestra la imagen original completa con su etiqueta de coincidencia. La cuadrícula use 4 columnas con espaciado consistente. Alterna entre las pestañas de Ficha y Clave de Respuestas para comparar. La clave de respuestas se genera simultáneamente con la ficha — sin creación manual, sin proceso de diseño separado, sin posibilidad de respuestas incorrectas. Este sistema de lienzo dual es su mayor ahorro de tiempo al crear paquetes de fichas de asociación de sombras.',
      },
      {
        title: 'Descargue los Cuatro Archivos',
        description: 'Active la escala de grises para versiones con ahorro de tinta ideales para impresión en volumen e interiores de KDP. Descargue los cuatro archivos desde una sola sesión: ficha JPEG, ficha PDF, clave de respuestas JPEG y clave de respuestas PDF — todo renderizado a 300 DPI (multiplicador 6×, calidad JPEG 1,0). Cada pestaña tiene su propio par de botones de descargue. Los archivos están listos para producción en listados de Etsy, interiores de Amazon KDP y archivos de productos de Hotmart sin necesidad de posprocesamiento. Haga clic en Generar de nuevo con las mismas imágenes para producir una nueva ficha con diferentes disposiciones de derangement, o cambie de imágenes y modos para creación rápida de variedad en 104 colecciones temáticas.',
      },
    ],
  },
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Cree paquetes de actividades de asociación de sombras organizados por modo y tema usando las 104 colecciones de imágenes. Un solo tema de animales produce tres tipos distintos de ficha: fichas de Asociación de Sombras para reconocimiento de siluetas, fichas de Completa la Imagen con cortes horizontales para recomposición superior/inferior, y fichas de Completa la Imagen con cortes verticales para recomposición izquierda/derecha. Empaqueta 15–20 fichas de asociación de sombras por paquete con claves de respuestas autogeneradas incluidas. El derangement Fisher-Yates se recalcula en cada generación, por lo que puede crear múltiples fichas únicas de las mismas 4 imágenes simplemente regenerando — diferentes disposiciones de derangement producen diferentes desafíos de asociación sin necesitar imágenes fuente diferentes.',
    },
    {
      title: 'Cuadernos de Percepción Visual para KDP',
      description: 'Compila 50–80 fichas de asociación de sombras en cuadernos impresos para Amazon KDP. Estructura capítulos por tipo de actividad: el Capítulo 1 use el modo Asociación de Sombras para reconocimiento de siluetas, el Capítulo 2 use Completa la Imagen con cortes horizontales para razonamiento espacial superior/inferior, y el Capítulo 3 use Completa la Imagen con cortes verticales para razonamiento espacial izquierda/derecha. Incluya páginas de clave de respuestas al final de cada capítulo mostrando los emparejamientos correctos letra-número junto a las imágenes originales. Active la escala de grises para salida con ahorro de tinta que se imprime perfectamente en blanco y negro. El formato puramente visual no requiere traducción, por lo que un solo interior sirve para todos los mercados internacionales de KDP.',
    },
    {
      title: 'Actividades Rápidas de Puzzles de Sombras para venta en línea',
      description: 'Cree fichas de asociación de sombras listas para venta en línea para trabajo matutino, usuarios que terminan antes y centros de enriquecimiento con campos de nombre/fecha y claves de respuestas impresas. Construye sets alineados con el catálogo de productos: puzzles de sombras de animales para unidades de ciencias, siluetas de vehículos para temas de transporte, asociación de sombras de alimentos para lecciones de nutrición. El selector de etiquetas le permite crear versiones con andamiaje (con etiquetas A/B/C/D y 1/2/3/4) para instrucción guiada y versiones de desafío (etiquetas ocultas) para trabajo independiente — ambas versiones de las mismas imágenes en la misma sesión de generación. Cada ficha se exporta con su clave de respuestas autogenerada, eliminando el tiempo de preparación del vendedor.',
    },
    {
      title: 'Productos de Asociación de Sombras con Fotos Personalizadas',
      description: 'Use la función de Subir Imágenes Personalizadas para crear fichas de asociación de sombras a partir de cualquier foto u obra de arte. Los puzzles de siluetas con fotos familiares son regalos personalizados únicos — los niños asocian miembros de la familia con sus siluetas negras. Puzzles de sombras con fotos de mascotas, siluetas de equipos deportivos y actividades de sombras con fotos del mercado se convierten en productos únicos. La generación de siluetas a nivel de píxel funciona con cualquier imagen subida, convirtiendo el canal alfa en contornos negros precisos. El modo Completa la Imagen con fotos personalizadas añada variedad de imagen dividida a los productos de puzzles personalizados.',
    },
    {
      title: 'Colecciones Estacionales de Asociación de Sombras',
      description: 'Construye colecciones estacionales rotativas usando temas de festividades y naturaleza de la biblioteca de 104 temas. Las fichas de asociación de sombras de Halloween son naturalmente populares — las actividades de siluetas complementan perfectamente los temas de sombras y misterio de la temporada. Navidad, Pascua, San Valentín, vuelta al cole y verano soportan paquetes dedicados de puzzles de sombras. Incluya fichas tanto de Asociación de Sombras como de Completa la Imagen en cada set estacional para máxima variedad. Publique cada colección 4–6 semanas antes de la festividad para máxima visibilidad en el mercado. El algoritmo de derangement asegura que no haya dos fichas idénticas incluso dentro del mismo tema estacional.',
    },
    {
      title: 'Paquetes de Aprendizaje Visual Multi-Formato',
      description: 'Combine fichas de asociación de sombras con puzzles de cuadrícula, fichas de asociación, actividades de piezas faltantes y fichas de clasificación de imágenes usando temas coordinados en múltiples generadores. La Asociación de Sombras desarrolla reconocimiento de siluetas y discriminación visual. El modo Completa la Imagen desarrolla razonamiento espacial y percepción parte-todo. El Puzzle de Cuadrícula desafía la colocación espacial de piezas. Las fichas de asociación ejercitan habilidades de emparejamiento trazar-una-línea. Cada formato ejercita una habilidad cognitiva diferente mientras mantiene consistencia temática. Los paquetes multi-formato se venden a precios premium y brindan a los usuarios práctica variada de percepción visual a través de un tema unificado.',
    },
  ],
  ...
  proTips: [
    {
      title: 'Elija Imágenes con Siluetas Distintivas para el Modo Asociación de Sombras',
      description: 'La calidad de las fichas de Asociación de Sombras depende de lo reconocible que sea cada silueta. Seleccione imágenes con contornos distintivos — animales con formas corporales únicas (jirafa, elefante, pulpo), vehículos con perfiles claros (avión, bicicleta, barco) y objetos con contornos identificables (guitarra, paraguas, corona). Evita imágenes con formas rectangulares similares que produzcan siluetas casi idénticas. El procesamiento a nivel de píxel preserva detalles finos como orejas, colas y asas, por lo que las imágenes con rasgos característicos producen los puzzles de sombras más atractivos.',
    },
    {
      title: 'Use Ambas Direcciones de Corte en Completa la Imagen para Máxima Variedad',
      description: 'El modo Completa la Imagen ofrece direcciones de corte horizontal (superior/inferior) y vertical (izquierda/derecha). Incluya ambas en sus paquetes de productos — los cortes horizontales crean desafíos de asociación diferentes que los cortes verticales porque se revelan diferentes detalles en cada mitad. Un animal dividido horizontalmente muestra cabeza y cuerpo por separado; el mismo animal dividido verticalmente muestra perfiles izquierdo y derecho. Usar ambas direcciones de corte duplica su conteo de fichas únicas del mismo conjunto de imágenes sin ninguna selección de imágenes adicional.',
    },
    {
      title: 'Desactive las Etiquetas para Productos Premium de Libros de Puzzles',
      description: 'Cuando el selector Mostrar Etiquetas está desactivado, la ficha se convierte en un desafío de asociación puramente visual sin identificadores A/B/C/D y 1/2/3/4. Esto cree una página de puzzle más limpia y de aspecto más profesional, ideal para libros de puzzles impresos y descargue digitales premium. Sin etiquetas, los usuarios deben confiar enteramente en la asociación visual — identificando siluetas solo por su forma o reconectando mitades divididas por continuidad visual. Las fichas sin etiquetas se perciben con mayor valor en productos de libros de puzzles porque lucen más pulidas y presentan un desafío genuino.',
    },
    {
      title: 'Aprovecha el Algoritmo de Derangement para Creación Rápida de Paquetes',
      description: 'El derangement Fisher-Yates se recalcula en cada generación, produciendo disposiciones diferentes de las mismas 4 imágenes. Esto significa que hacer clic en Generar repetidamente con configuraciones idénticas cree múltiples fichas únicas donde las siluetas o mitades aparecen en posiciones diferentes. Use esto para llenar rápidamente paquetes grandes sin necesitar imágenes fuente diferentes para cada página. Genere 5–10 fichas únicas por conjunto de imágenes, luego multiplica por 104 temas para catálogos de productos masivos con esfuerzo mínimo.',
    },
    {
      title: 'Explota el Formato Puramente Visual para Ventas Globales',
      description: 'Las fichas de Asociación de Sombras contienen solo imágenes, siluetas y mitades divididas — sin texto específico de idioma en la salida de la ficha. Cada puzzle que cree es instantáneamente vendible a nivel mundial sin traducción ni localización. Un set de puzzles de sombras sirve para todas las tiendas Etsy internacionales, todos los mercados de KDP y todos los compradores de Hotmart independientemente del idioma. Mientras los competidores crean versiones separadas por idioma de fichas con mucho texto, sus puzzles de sombras funcionan en todas partes desde un solo conjunto de archivos.',
    },
    {
      title: 'Aprovecha la Temporada de Halloween para Productos Temáticos de Sombras',
      description: 'Las actividades de sombras y siluetas tienen un atractivo estacional especial durante Halloween cuando el misterio, las sombras y los contornos oscuros son temáticamente relevantes. Cree colecciones dedicadas de asociación de sombras de Halloween usando imágenes de temas espeluznantes de la biblioteca y publícalas 4–6 semanas antes del 31 de octubre para máxima visibilidad en el mercado. El modo Asociación de Sombras con sus siluetas negras complementa naturalmente la estética de Halloween. Esta ventaja de temporalidad es única para productos temáticos de sombras y genere tasas de conversión más altas durante la ventana de compre de otoño.',
    },
    {
      title: 'Use Fondos y Bordes Temáticos para Branding Cohesivo de Producto',
      description: 'El sistema independiente de fondos y bordes temáticos con controles de opacidad separados le permite crear una identidad visual consistente en sus paquetes de fichas de asociación de sombras. Configure un fondo temático sutil al 15–25% de opacidad para calidez visual sin distraer del contenido de asociación de sombras. Superpone un borde decorativo al 80–100% de opacidad para un marco pulido. Aplique la misma combinación de fondo y borde en cada ficha de un paquete para un aspecto de producto cohesivo que los compradores asocian con calidad y profesionalismo.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'El generador ofrece dos modos distintos en una sola herramienta. El modo Asociación de Sombras coloque 4 imágenes a color etiquetadas A–D en la fila superior y 4 siluetas negras autogeneradas etiquetadas 1–4 en la fila inferior — los usuarios asocian cada imagen con su sombra emparejando letras con números. Las siluetas se crean mediante procesamiento a nivel de píxel (alfa > 10 → negro puro), no filtros CSS. El modo Completa la Imagen divide 4 imágenes en mitades — primeras mitades etiquetadas A–D, segundas mitades etiquetadas 1–4 — y los usuarios reconectan las piezas para completar cada imagen. Elija la dirección de corte horizontal (superior/inferior) o vertical (izquierda/derecha) en el modo Completa la Imagen.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'asociación-sombras-fichas', anchorText: 'Fichas de Asociación de Sombras — Detalles Completos del Producto' },
  ...
  visuals: {
    heroImages: {
      primary: '/samples/spanish/shadow%20match/empareja-las-sombras-1.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/spanish/shadow%20match/empareja-las-sombras-4.webp',
      ...
      {
        src: '/samples/spanish/shadow%20match/empareja-las-sombras-3.webp',
      ...
      {
        src: '/samples/spanish/shadow%20match/empareja-las-sombras-1-answer-key.webp',
