...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'picture-bingo-worksheets', anchorText: 'Banko Generator (festtema)' },
    { pageType: 'app', slug: 'treasure-hunt-worksheets', anchorText: 'Skattejagt Generator' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Fest Ordsøgning' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Printbare Spil til Fødselsdagsfester',
