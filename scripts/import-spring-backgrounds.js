/**
 * Background Import Script: Spring
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-spring-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'spring_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/spring',
  displayNames: {
    en: 'Spring',
    de: 'Frühling',
    fr: 'Printemps',
