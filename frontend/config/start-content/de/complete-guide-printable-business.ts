...
const content: StartContent = {
  ...
  hero: {
    title: 'Druckvorlagen-Business starten — Komplettanleitung 2026',
  ...
  actionSteps: [
    {
      ...
      description: 'Wählen Sie ein Fachgebiet (Mathe, Lesen und Schreiben, Ausmalen), eine Altersgruppe (Vorschule, Kindergarten, erste Klasse) und einen Käufertyp (Eltern, Käufer, Homeschool). Recherchieren Sie Ihre Nische auf Etsy.de, um die Nachfrage zu überprüfen und den Wettbewerb einzuschätzen.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Etsy.de ist die empfohlene Startplattform wegen des großen eingebauten Publikums für Druckvorlagen-Produkte. Amazon KDP ist ausgezeichnet für Aktivitätsbuch-Formate. Gumroad ist ideal, wenn Ihre Produkte Käufer mit katalogbezogenen Inhalten ansprechen. Viele erfolgreiche Verkäufer listen gleichzeitig auf mehreren Plattformen.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Jeder Generator erzeugt druckfertige PDF- und hochauflösende JPEG-Dateien. PDF ist das Standardformat für Druckvorlagen-Produkte auf Etsy und Gumroad. JPEG wird für Amazon KDP-Innenseiten und für Produkt-Vorschaubilder verwendet. Beide Formate sind bei jedem Download enthalten.',
    },
    {
