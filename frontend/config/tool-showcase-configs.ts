...
const nlToolText: Record<string, FrTextTuple> = {
  'addition-worksheet-maker': ['Rekenen met plaatjes!', 'Professionele optelwerkbladen met themaplaatjes', 'Gedifferentieerd leren voor elk kind', 'Drie moeilijkheidsniveaus die meegroeien', 'Eenvoudig tellen (1-5)', 'Gemengde plaatjes tot 10', 'Gevorderde opgaven tot 20', 'Elk kind leert op eigen tempo', 'Optelpret!', 'Rekenen met plezier', 'Professionele werkbladen', 'Met zorg ontworpen materiaal'],
  'subtraction-worksheet-maker': ['Aftrekken wordt leuk!', 'Doorstrepen en vergelijken met themaplaatjes', 'Stap voor stap aftrekken', 'Drie niveaus van eenvoudig tot uitdagend', 'Plaatjes doorstrepen (1-5)', 'Plaatje-getal tot 10', 'Gemengde modi tot 20', 'Elke opgave bouwt vertrouwen', 'Aftrekpret!', 'Aftrekken is leuk', 'Professionele werkbladen', 'Heldere lay-outs voor leerlingen'],
  'code-addition-worksheet-maker': ['Kraak de code!', 'Los sommen op om berichten te ontcijferen', 'Van sommen tot geheime codes', 'Drie niveaus van codekraken', 'Eenvoudige codes (1-5)', 'Grotere sommen voor langere berichten', 'Meerstapscodes tot 20', 'Elke code versterkt rekenvertrouwen', 'Code kraken!', 'Rekenen ontmoet mysterie', 'Professionele codewerkbladen', 'Rekenen met puzzels combineren'],
  'more-less-worksheet-maker': ['Meer, minder of gelijk?', 'Hoeveelheden vergelijken met plaatjes', 'Vergelijkingen beheersen', 'Drie niveaus van vergelijking', 'Welke groep heeft meer (1-5)', 'Groepen tot 10 vergelijken', 'Groter/kleiner/gelijk', 'Vergelijken bouwt rekenbasis', 'Vergelijk het!', 'Meer of minder?', 'Vergelijkingswerkbladen', 'Visuele vergelijkingen'],
  'math-puzzle-maker': ['Wiskundepuzzels!', 'Uitdagende rekenpuzzels met themaplaatjes', 'Van eenvoudig naar meesterbrein', 'Drie puzzelniveaus', 'Eenvoudige puzzels', 'Gemiddelde puzzels', 'Uitdagende puzzels', 'Elke puzzel scherpt het denken', 'Puzzelplezier!', 'Rekenen als puzzel', 'Rekenpuzzels', 'Uitdagend materiaal'],
  'math-worksheet-maker': ['Rekenwerkbladen!', 'Professionele rekenoefeningen met themaplaatjes', 'Dagelijkse rekenoefening', 'Drie niveaus voor differentiatie', 'Basisoefeningen', 'Gemiddelde oefeningen', 'Gevorderde oefeningen', 'Dagelijks oefenen bouwt vertrouwen', 'Rekenpret!', 'Elke dag beter', 'Professionele werkbladen', 'Heldere lay-outs'],
  'alphabet-train-maker': ['Instappen voor het ABC!', 'Letters herkennen met de alfabettrein', 'Van A tot Z', 'Drie niveaus van letterherkenning', 'Hoofdletters herkennen', 'Kleine letters koppelen', 'Complete alfabetoefening', 'Elke letter brengt dichter bij lezen', 'ABC-trein!', 'Letters leren is leuk', 'Alfabetwerkbladen', 'Kleurrijke treinwerkbladen'],
  'prepositions-worksheet-maker': ['Waar is het?', 'Voorzetsels leren met plaatjes', 'Positiewoorden beheersen', 'Drie niveaus van positiebegrip', 'Basisposities', 'Uitgebreide posities', 'Complexe beschrijvingen', 'Positiewoorden versterken taalbegrip', 'Voorzetsels!', 'Waar bevindt het zich?', 'Voorzetselwerkbladen', 'Visuele positieoefeningen'],
  'word-guess-maker': ['Raad het woord!', 'Woordraadspelletjes met plaatjesaanwijzingen', 'Van eenvoudig naar uitdagend', 'Drie niveaus van woordraden', 'Eenvoudige woorden', 'Langere woorden', 'Uitdagende woorden', 'Elke gok versterkt woordenschat', 'Raad het!', 'Woorden ontdekken', 'Woordraadwerkbladen', 'Spannende woordpuzzels'],
  'word-scramble-maker': ['Letterpuzzels!', 'Door elkaar gehusselde letters ordenen', 'Van eenvoudig naar complex', 'Drie niveaus van woordontwarring', 'Korte woorden (3-4 letters)', 'Gemiddelde woorden (5-6)', 'Lange woorden (7+)', 'Elke puzzel versterkt spelling', 'Letterzaak!', 'Ontwar de letters', 'Letterpuzzelwerkbladen', 'Spelling oefenen als spelletje'],
  'word-search-maker': ['Vind de woorden!', 'Verborgen woorden zoeken in roosters', 'Van klein naar groot zoeken', 'Drie niveaus van woordzoekplezier', 'Klein rooster (6 woorden)', 'Gemiddeld rooster (10 woorden)', 'Groot rooster (15+ woorden)', 'Elk woord versterkt herkenning', 'Woordzoeker!', 'Zoek en vind', 'Woordzoekpuzzels', 'Thematische woordzoekers'],
  'cryptogram-maker': ['Ontcijfer het geheim!', 'Geheime boodschappen met lettervervanging', 'Van eenvoudig naar meester', 'Drie niveaus van geheimschrift', 'Eenvoudige lettervervanging', 'Complexere codes', 'Meester-uitdagingen', 'Ontcijferen versterkt logisch denken', 'Cryptogram!', 'Kraak de code', 'Cryptogramwerkbladen', 'Geheime berichten'],
  'writing-worksheet-maker': ['Schrijven en leren!', 'Schrijfoefenwerkbladen voor handschrift', 'Van lijnen naar letters', 'Drie niveaus van schrijfvaardigheid', 'Lijnen overtrekken', 'Letters vormen', 'Woorden schrijven', 'Oefening maakt de meester', 'Schrijfpret!', 'Pen op papier', 'Schrijfwerkbladen', 'Gestructureerde schrijfoefeningen'],
  'big-small-worksheet-maker': ['Groot of klein?', 'Groottevergelijking met afbeeldingen', 'Maten vergelijken', 'Drie niveaus van groottebegrip', 'Duidelijke verschillen', 'Subtielere vergelijkingen', 'Complexe ordening', 'Vergelijken bouwt wiskundig denken', 'Groot & Klein!', 'Vergelijk de maten', 'Groottewerkbladen', 'Visuele vergelijkingen'],
  'pattern-train-maker': ['Ontdek het patroon!', 'Patronen herkennen met de patroontrein', 'Van eenvoudig naar complex', 'Drie niveaus van patroonherkenning', 'AB-patronen', 'ABC-patronen', 'AABB-patronen', 'Patroonherkenning is rekenbasis', 'Patroontrein!', 'Volg het patroon', 'Patroonwerkbladen', 'Kleurrijke patronen'],
  'pattern-worksheet-maker': ['Herken het patroon!', 'Patronen herkennen en voortzetten', 'Patroondenken ontwikkelen', 'Drie niveaus van patroonuitdaging', 'Eenvoudige AB-patronen', 'Gemiddelde ABC-patronen', 'Complexe patronen', 'Patronen zien is wiskundig denken', 'Patronenplezier!', 'Ontdek de regelmaat', 'Patroonwerkbladen', 'Systematisch oefenen'],
  'draw-and-color-maker': ['Teken en kleur!', 'Stapsgewijs tekenen met themaplaatjes', 'Van eenvoudig naar gedetailleerd', 'Drie niveaus van tekenuitdaging', 'Eenvoudige vormen', 'Gedetailleerdere tekeningen', 'Creatieve creaties', 'Tekenen ontwikkelt fijne motoriek', 'Teken het!', 'Creatief bezig', 'Tekenwerkbladen', 'Stapsgewijze activiteiten'],
  'drawing-lines-maker': ['Lijnen trekken!', 'Fijne motoriek met lijnactiviteiten', 'Van recht naar gebogen', 'Drie niveaus van lijnvaardigheid', 'Rechte lijnen', 'Gebogen lijnen', 'Complexe patronen', 'Lijnen bereidden voor op schrijven', 'Lijnenplezier!', 'Trek de lijn', 'Lijnwerkbladen', 'Schrijfvoorbereiding'],
  'coloring-page-maker': ['Kleur je wereld!', 'Kleurplaten met 100+ thema\'s', 'Kleuren voor iedereen', 'Van eenvoudig tot gedetailleerd', 'Grote vlakken', 'Gedetailleerde contouren', 'Fijne details', 'Kleuren ontwikkelt creativiteit', 'Kleurenpret!', 'Laat je creativiteit los', 'Kleurplaten', '100+ thema\'s'],
  'chart-count-maker': ['Gegevens worden leuk!', 'Plaatjesgrafieken maken en lezen', 'Data leren met plaatjes', 'Drie niveaus van grafiekvaardigheid', 'Eenvoudige grafieken', 'Meer categorieën', 'Complexe gegevensanalyse', 'Grafieken lezen is belangrijk', 'Grafiekenplezier!', 'Tellen en tekenen', 'Grafiekwerkbladen', 'Visuele gegevensverwerking'],
  'matching-worksheet-maker': ['Vind het paar!', 'Koppelactiviteiten met themaplaatjes', 'Van eenvoudig naar complex', 'Drie niveaus van koppeluitdaging', 'Duidelijke paren', 'Subtielere koppeling', 'Uitdagende categorisatie', 'Koppelen ontwikkelt discriminatie', 'Koppelpret!', 'Zoek de paren', 'Koppelwerkbladen', 'Visuele koppelactiviteiten'],
  'grid-match-maker': ['Koppel het raster!', 'Rasterpuzzels met themaplaatjes', 'Van eenvoudig naar complex', 'Drie niveaus van rasterpuzzel', 'Eenvoudige herkenning', 'Gemiddelde puzzels', 'Complexe uitdagingen', 'Rasterpuzzels ontwikkelen ruimtelijk inzicht', 'Rasterpuzzel!', 'Denk in rasters', 'Rasterwerkbladen', 'Ruimtelijk denken'],
  'shadow-match-maker': ['Vind de schaduw!', 'Schaduwen koppelen aan afbeeldingen', 'Van duidelijk naar subtiel', 'Drie niveaus van schaduwherkenning', 'Duidelijke schaduwen', 'Subtielere vormen', 'Uitdagende silhouetten', 'Schaduwkoppelen bereidt voor op lezen', 'Schaduwpret!', 'Koppel de schaduw', 'Schaduwwerkbladen', 'Visuele discriminatie'],
  'bingo-card-maker': ['BINGO!', 'Thematische bingokaarten voor de klas', 'Bingo voor elk thema', 'Drie niveaus van bingoplezier', 'Eenvoudige plaatjesbingo', 'Woordbingo', 'Gemengde uitdagingen', 'Bingo maakt leren een feestje', 'Bingopret!', 'Ogen op de kaart', 'Bingokaarten', 'Groepsactiviteiten'],
  'picture-sort-maker': ['Sorteer het!', 'Afbeeldingen sorteren en categoriseren', 'Van eenvoudig naar complex', 'Drie niveaus van sorteeruitdaging', 'Twee categorieën', 'Drie categorieën', 'Complexe classificatie', 'Sorteren ontwikkelt logisch denken', 'Sorteerpret!', 'Indelen en ordenen', 'Sorteerwerkbladen', 'Classificatieactiviteiten'],
  'missing-pieces-maker': ['Maak het af!', 'Ontbrekende stukjes vinden en invullen', 'Van eenvoudig naar complex', 'Drie niveaus van puzzeluitdaging', 'Duidelijk ontbrekend', 'Subtielere stukjes', 'Uitdagende puzzels', 'Puzzelen scherpt de waarneming', 'Puzzelpret!', 'Wat ontbreekt er?', 'Puzzelwerkbladen', 'Visuele logica'],
  'odd-one-out-maker': ['Welke is anders?', 'De vreemde eend vinden', 'Van duidelijk naar subtiel', 'Drie niveaus van observatie', 'Duidelijk afwijkend', 'Subtielere verschillen', 'Complexe uitzonderingen', 'Observatie versterkt kritisch denken', 'Vreemde eend!', 'Vind het verschil', 'Observatiewerkbladen', 'Visueel redeneren'],
  'sudoku-maker': ['Sudoku-plezier!', 'Plaatjes-sudoku voor jonge denkers', 'Van klein naar groot', 'Drie niveaus van sudoku', 'Mini-sudoku (4 plaatjes)', 'Gemiddeld (6 plaatjes)', 'Uitdagend (9 plaatjes)', 'Sudoku ontwikkelt logica', 'Sudoku!', 'Denk logisch', 'Sudokuwerkbladen', 'Logicapuzzels'],
  'picture-path-maker': ['Vind de weg!', 'Paden volgen en navigeren', 'Van eenvoudig naar complex', 'Drie niveaus van paduitdaging', 'Rechte paden', 'Bochtige paden', 'Complexe labyrinten', 'Paden volgen is probleemoplossing', 'Padavontuur!', 'Volg het spoor', 'Padwerkbladen', 'Navigatie-uitdagingen'],
  'find-and-count-maker': ['Ik zie, ik zie!', 'Zoek en tel met kleurrijke scènes', 'Van weinig naar veel', 'Drie niveaus van zoek-en-tel', 'Tellen tot 5', 'Tellen tot 10', 'Tellen tot 20', 'Zoeken en tellen scherpt waarneming', 'Zoek & tel!', 'Hoeveel zie je?', 'Telwerkbladen', 'Visuele telactiviteiten'],
  'find-objects-maker': ['Vind ze allemaal!', 'Verborgen voorwerpen in gedetailleerde scènes', 'Van eenvoudig naar complex', 'Drie niveaus van zoekuitdaging', 'Duidelijk zichtbaar', 'Gecamoufleerd', 'Uitdagend verborgen', 'Scherpe ogen ontwikkelen concentratie', 'Zoekpret!', 'Vind het voorwerp', 'Zoekwerkbladen', 'Concentratie-uitdagingen'],
  'crossword-maker': ['Los het op!', 'Plaatjeskruiswoorden met themawoorden', 'Van klein naar groot', 'Drie niveaus van kruiswoord', 'Mini (5 woorden)', 'Gemiddeld (10 woorden)', 'Groot (15+ woorden)', 'Kruiswoorden versterken woordenschat', 'Kruiswoordpret!', 'Vul de vakjes', 'Kruiswoordwerkbladen', 'Woordpuzzels'],
  'treasure-hunt-maker': ['Schattenjacht!', 'Kaartavonturen met verborgen schatten', 'Van eenvoudig naar complex', 'Drie niveaus van schatzoeken', 'Eenvoudige kaarten', 'Complexere kaarten', 'Uitdagende schatkaarten', 'Elke schat versterkt probleemoplossing', 'Schatzoeken!', 'Vind de schat', 'Schattenjachtwerkbladen', 'Kaartavonturen'],
};
