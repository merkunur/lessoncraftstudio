...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare fugler-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med fuglertema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Fugler-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare fugler-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'fugleoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, fuglearter gjenkjenning, trekkfugler, naturobservasjon, fugleøvelser førskole, fuglers læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Fugler-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare fugler-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'fugleoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, fuglearter gjenkjenning, trekkfugler, naturobservasjon, fugleøvelser barnehage, fuglers læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Fugler-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare fugler-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'fugleoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, fuglearter gjenkjenning, trekkfugler, naturobservasjon, fugleøvelser 1. klasse, fuglers læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Fugler-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare fugler-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'fugleoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, fuglearter gjenkjenning, trekkfugler, naturobservasjon, fugleøvelser 2. klasse, fuglers læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Fugler-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare fugler-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'fugleoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, fuglearter gjenkjenning, trekkfugler, naturobservasjon, fugleøvelser 3. klasse, fuglers læring 8-9 år',
