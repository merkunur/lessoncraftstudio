...
const content: ToolContent = {
  ...
  visuals: {
    heroImages: { primary: '/samples/english/find and count/find and count portrait.webp', primaryAlt: 'Etsi ja laske -hakutehtava hajautetuilla kuvilla saadettavassa ruudukossa sinisella otsikkoreunuksella ja neljalla tehtyvatyypin ohjeella ymparoi nelio rasti ja laske' },
    sampleGallery: [
      { src: '/samples/english/find and count/find and count portrait.webp', alt: 'Etsi ja laske -hakutehtava vaaka-tilassa leveanmmalla ruudukkoasettelulla ja hajautetuilla teemakuvilla harhautusesineiden joukossa', caption: 'Piilotetut esineet -tila — klassinen haku ymparoi-, nelio-, rasti- ja laske-tehtyvatyypeilla hajautetulla kuvaruudukolla' },
      { src: '/samples/english/find and count/find and count landscape.webp', alt: 'Etsi ja laske -vastausavain punaisilla ympaera-, nelio- ja rastimerkinnoeilla oikeiden kohdekuvien paella ja maeaeraenayttoeilla', caption: 'Automaattisesti generoitu vastausavain — punaiset merkinnaeaemerkitsevat ympaerat, nelioeae, rastit ja laskemissummat kullekin kohdekohteelle' },
    ],
