...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare camping-opgaver til børn. Matematik, farvelægning, ordspil og puslespil med campingtema. Førskole til 3. klasse. Gratis PDF. Ingen tilmelding.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Camping-opgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare camping-opgaver til førskolebørn (3–4 år). Farvelægning, tælling 1–10 og finmotorik. 33 generatorer. Gratis PDF. Vælg tema og hent gratis PDF.',
      seoKeywords: 'campingopgaver førskole, finmotorik øvelse, farvelægning og sporing, størrelsessortering, simpel tælling, friluftsliv, naturoplevelse, campingudstyr, campingøvelser førskole, campingens læring 3-4 år',
    ...
    'kindergarten': {
      ...
      seoDescription: 'Printbare camping-opgaver til børnehaveklassen (5–6 år). Tælling, bogstaver, mønstre og visuel opfattelse. 33 generatorer. Gratis PDF. Ingen tilmelding.',
      seoKeywords: 'campingopgaver børnehaveklasse, begyndelsesbogstaver øvelse, bogstavgenkendelse, tælling til 20, mønstergenkendelse, friluftsliv, naturoplevelse, campingudstyr, campingøvelser børnehaveklasse, campingens læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Camping-opgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare camping-opgaver til 1. klasse (6–7 år). Addition, subtraktion, læsning og skrivning. 33 generatorer. Gratis PDF. Vælg tema og hent gratis PDF.',
      seoKeywords: 'campingopgaver 1. klasse, addition subtraktion, syntetisk læsning, selvstændig skrivning, sætningsopbygning, friluftsliv, naturoplevelse, campingudstyr, campingøvelser 1. klasse, campingens læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Camping-opgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare camping-opgaver til 2. klasse (7–8 år). Multiplikation, ordspil, logik og problemløsning. 33 generatorer. Gratis PDF. 3.000+ billeder. Hent nu.',
      seoKeywords: 'campingopgaver 2. klasse, multiplikation øvelser, dataanalyse børn, faktatekster læsning, positionstal forståelse, friluftsliv, naturoplevelse, campingudstyr, campingøvelser 2. klasse, campingens læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Camping-opgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare camping-opgaver til 3. klasse (8–9 år). Flertrinsproblemer, krydsord, kryptogrammer og avancerede opgaver. 33 generatorer. Gratis PDF. Hent nu.',
      seoKeywords: 'campingopgaver 3. klasse, multiplikation division, brøker introduktion, forskningsrapport, kritisk tænkning, friluftsliv, naturoplevelse, campingudstyr, campingøvelser 3. klasse, campingens læring 8-9 år',
