...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Générateur cherche et trouve | LessonCraftStudio',
  ...
  hero: {
    title: 'Générateur cherche et trouve — Créez des imprimables à vendre sur Etsy & KDP',
  ...
  ctaHeading: 'Créer des jeux de cherche et trouve',
