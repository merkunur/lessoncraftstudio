...
/**
 * Grid Match Worksheets - Dutch Content
 *
 * File: frontend/content/product-pages/nl/raster-puzzel-werkbladen.ts
 * URL: /nl/apps/raster-puzzel-werkbladen (Dutch SEO-optimized slug)
 *
 * FULL SEO content from: INDIVIDUAL APP PAGES/Dutch/grid-match.md
...
export const gridMatchNlContent: ProductPageContent = {
    ...
    steps: [
      {
        id: '1',
        number: 1,
        title: 'Stap 1: Kies Je Afbeelding - Kleurplaten en Thema\'s voor Werkbladen Kleuters',
        description: `Begin met het selecteren van een afbeelding voor je puzzel. Open het accordeonmenu Afbeeldingenbibliotheek. Blader door meer dan 3000 illustraties. Kies een thema zoals dieren of voertuigen. Kleurplaten stijl afbeeldingen werken uitstekend voor werkbladen kleuters. Gebruik de zoekfunctie voor specifieke onderwerpen. Typ bijvoorbeeld "appel" of "auto" in het zoekveld.

Je kunt ook eigen afbeeldingen uploaden. Klik op Upload Eigen Afbeeldingen. Selecteer foto's van je computer. Meerdere bestanden tegelijk uploaden is mogelijk. Klassenfoto's maken werkbladen persoonlijker. Combineer eigen uploads met bibliotheekplaatjes.`,
        icon: '🖼️',
      },
      {
        id: '2',
        number: 2,
        title: 'Stap 2: Configureer Rasterinstellingen - Sommen tot 20 en Tafels Oefenen Moeilijkheid',
        description: `Open het accordeonmenu Rasteropties. Kies het aantal rijen tussen 2 en 4. Selecteer het aantal kolommen tussen 2 en 4. Een 2x2 raster is eenvoudig voor beginners. Een 4x4 raster biedt meer uitdaging. Stel het aantal ontbrekende vakjes in. Meer ontbrekende stukjes verhoogt de moeilijkheid.

De rastergrootte beïnvloedt educatieve waarde. Grotere rasters ondersteunen sommen tot 20 door tellen. Kinderen tellen vakjes voor wiskundige oefening. Tafels oefenen wordt visueel met telbare elementen. Een 3x3 raster heeft 9 vakjes perfect voor basisvermenigvuldiging.`,
        icon: '⚙️',
      },
      {
        id: '3',
        number: 3,
        title: 'Stap 3: Genereer Je Werkblad - Veilig Leren Lezen met Visuele Puzzels',
        description: `Klik op de knop Nieuw Werkblad genereren. De generator maakt direct een complete puzzel. Je ziet het werkblad verschijnen op het canvas. De afbeelding wordt automatisch in vakjes verdeeld. Ontbrekende stukjes verschijnen onderaan of zijkant. Het antwoordblad is beschikbaar via Antwoordsleutel genereren.

Grid match ondersteunt veilig leren lezen principes. Kinderen herkennen visuele patronen. Dit versterkt letterherkenning vaardigheden. Combineer puzzels met letters leren thema's. Kies alfabet afbeeldingen uit de bibliotheek.`,
        icon: '✨',
      },
      {
        id: '4',
        number: 4,
        title: 'Stap 4: Bewerk op Canvas - Rekenen Werkbladen en Fijne Motoriek Instructies Toevoegen',
        description: `Het gegenereerde werkblad is volledig bewerkbaar. Klik op elk element om het te selecteren. Versleep objecten naar nieuwe posities. Roteer afbeeldingen met de rotatiegreep. Schaal elementen groter of kleiner. Verwijder onnodige onderdelen met de Delete knop. Gebruik Ongedaan maken voor foutcorrecties.

Voeg tekstelementen toe voor instructies. Open het accordeonmenu Teksttools. Typ je instructietekst in het invoerveld. Kies een kindvriendelijk lettertype. Pas kleur en grootte aan voor leesbaarheid. Rekenen werkbladen krijgen telinstructies. Fijne motoriek oefeningen krijgen bewegingsaanwijzingen.`,
        icon: '✏️',
      },
      {
        id: '5',
        number: 5,
        title: 'Stap 5: Download en Print - Werkbladen Groep 3 en Oefenbladen Gratis Exporteren',
        description: `Klik op de Download knop in de bovenste balk. Kies tussen vier exportopties. Werkblad JPEG voor snelle preview. Werkblad PDF voor professioneel printen. Antwoordblad JPEG voor digitaal gebruik. Antwoordblad PDF voor afdrukken met antwoorden.

Activeer Grijstinten voor inkbesparing. Dit converteert kleuren naar zwart-wit. Perfect voor massaal printen in de klas. Werkbladen groep 3 en oefenbladen gratis downloaden in hoge resolutie. 300 DPI kwaliteit garandeert scherpe afdrukken. Zowel Letter als A4 formaat beschikbaar.`,
        icon: '📥',
      },
    ],
  },
...
export default gridMatchNlContent;
