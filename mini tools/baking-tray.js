...
(function () {
  ...
  var BakingTray = {
    ...
    strings: {
      title:        { en: 'The Baking Tray', de: 'Das Brötchenblech', fr: 'La plaque de brioches', it: 'La teglia dei panini', es: 'La bandeja de panecillos', pt: 'A assadeira de pãezinhos', nl: 'Het breekbrood', sv: 'Bullplåten', da: 'Bagepladen', no: 'Bolleplata', fi: 'Pullapelti' },
      instruction:  { en: 'Break the tray where both pieces are facts the class already knows.', de: 'Die Brötchen dort auseinanderbrechen, wo beide Teile Aufgaben sind, die die Klasse schon kann.', fr: 'Casser la plaque là où les deux morceaux sont des rangées que la classe connaît déjà.', it: 'Spezzate i panini dove tutti e due i pezzi stanno in una tabellina che la classe sa già.', es: 'Separa los panecillos donde te queden dos trozos que la clase ya se sepa.', pt: 'Quebre a assadeira onde os dois pedaços forem contas que a turma já sabe de cor.', nl: 'Breek het brood daar waar allebei de stukken tafelsommen zijn die de klas al kent.', sv: 'Bryt isär bullarna där båda bitarna är uppgifter som klassen redan kan.', da: 'Knæk pladen dér, hvor I kan begge stykker i forvejen.', no: 'Bryt plata der begge bitene er noe klassen kjenner fra før.', fi: 'Katkaise pelti niin, että jokainen pala on sellainen, jonka luokka jo osaa. Katkaistessa ei katoa yhtään pullaa.' },

      hintWhole:    { en: 'Where can you break it so that both pieces are facts you already know?', de: 'An welcher Rille brecht ihr auseinander, damit beide Teile Aufgaben sind, die ihr schon könnt?', fr: 'Regarder les creux : lequel donne deux morceaux déjà connus ?', it: 'Dove spezzate i panini, così tutti e due i pezzi li sapete già dire?', es: '¿Dónde puedes separar los panecillos de manera que los dos trozos ya te los sepas?', pt: 'Onde vocês podem quebrar para os dois pedaços serem contas que vocês já sabem?', nl: 'Bij welke naad breek je, zodat je allebei de stukken al kent?', sv: 'Var kan ni bryta isär bullarna, så att båda bitarna är uppgifter ni redan kan?', da: 'Hvor vil I knække pladen? Der er ikke ét rigtigt sted — sig, hvad I kan i forvejen, og knæk dér.', no: 'Bollene henger sammen hele veien. Hvor kan dere bryte, slik at dere kjenner begge bitene fra før?', fi: 'Mistä saumasta voitte katkaista pellin niin, että kumpikin pala on sellainen, jonka jo osaatte?' },
      hintCut:      { en: 'Same buns as before, in two pieces. Read each piece, then break it again or push them back together and break it somewhere else.', de: 'Dieselben Brötchen wie vorher, jetzt in zwei Teilen. Lest beide Teile vor, brecht noch einmal auseinander oder schiebt sie wieder zusammen und brecht an einer anderen Rille.', fr: 'Les mêmes brioches qu’avant, en deux morceaux. Lire chaque morceau, puis casser encore dans un creux du même sens, ou les remettre ensemble et casser ailleurs.', it: 'Sono gli stessi panini di prima, adesso in due pezzi. Leggeteli tutti e due, poi spezzate ancora oppure rimetteteli insieme e spezzate in un altro punto.', es: 'Los mismos panecillos, ahora en dos trozos. Lee cada uno; luego vuelve a separar uno de los dos, o júntalos y sepáralos en otra línea.', pt: 'Os mesmos pãezinhos de antes, agora em dois pedaços. Leiam cada pedaço; depois quebrem de novo, ou encostem os dois de volta e quebrem em outro lugar.', nl: 'Dezelfde broodjes als eerst, nu in twee stukken. Lees ze allebei hardop, breek daarna bij nog één naad, of duw ze weer tegen elkaar en breek bij een andere.', sv: 'Lika många bullar som förut, nu i två bitar. Läs båda bitarna. Skjut ihop dem och bryt isär på ett annat ställe — eller bryt isär en gång till, om det går.', da: 'Det er de samme boller som før, nu i to stykker. Sig hvert stykke højt. Knæk så et af stykkerne igen, eller skub dem sammen og knæk et andet sted.', no: 'Like mange boller som før, i to biter. Si hver bit høyt. Så kan dere bryte på nytt, eller skyve bitene sammen igjen og bryte et annet sted.', fi: 'Samat pullat kuin äsken, nyt kahtena palana. Lukekaa kumpikin pala. Sitten voitte katkaista uudestaan samaan suuntaan tai työntää palat takaisin kiinni ja katkaista toisesta saumasta.' },
      hintCut3:     { en: 'Same buns as before, in three pieces. Read each one.', de: 'Dieselben Brötchen wie vorher, jetzt in drei Teilen. Lest jedes Teil vor.', fr: 'Les mêmes brioches qu’avant, en trois morceaux. Lire chaque morceau. Pour casser autrement, refermer d’abord un creux.', it: 'Sono gli stessi panini di prima, adesso in tre pezzi. Leggeteli tutti e tre. Adesso si può soltanto rimettere insieme e spezzare in un altro punto.', es: 'Los mismos panecillos, ahora en tres trozos. Lee cada uno; para seguir, junta dos.', pt: 'Os mesmos pãezinhos de antes, agora em três pedaços. Leiam cada um; para continuar, encostem dois de volta.', nl: 'Dezelfde broodjes als eerst, nu in drie stukken. Lees ze alle drie hardop. Verder breken kan niet meer: duw ze weer tegen elkaar om het anders te doen.', sv: 'Lika många bullar som förut, nu i tre bitar. Läs varje bit, och skjut ihop två av dem när ni vill.', da: 'Det er de samme boller som før, nu i tre stykker. Sig hvert stykke højt. Længere kan pladen ikke knækkes — skub to stykker sammen igen, hvis I vil prøve et andet sted.', no: 'Like mange boller som før, i tre biter. Si hver bit høyt. Nå kan dere ikke bryte mer – skyv sammen igjen når dere vil prøve et annet sted.', fi: 'Samat pullat kuin äsken, nyt kolmena palana. Lukekaa jokainen pala. Enempää ei voi katkaista — työntäkää jokin sauma takaisin kiinni, jos haluatte kokeilla toisin.' },
      ...
      hintSquare:   { en: 'The same number of rows as there are in each row. Turn it, then say where you would break it.', de: 'Gleich viele Reihen wie Brötchen in jeder Reihe. Dreht das Blech — und sagt dann, wo ihr auseinanderbrecht.', fr: 'Autant de rangées que de brioches dans chaque rangée. Tourner la plaque, regarder si quelque chose change, puis dire dans quel creux casser.', it: 'Le righe sono tante quanti i panini di ogni riga. Girate la teglia, poi dite dove spezzereste.', es: 'Hay tantas filas como panecillos en cada fila. Gira la bandeja y di dónde separarías los panecillos.', pt: 'O mesmo tanto de fileiras e de pãezinhos em cada fileira. Girem a assadeira e digam onde vocês quebrariam.', nl: 'Even veel rijen als broodjes in elke rij. Draai het brood, en zeg daarna waar je gaat breken.', sv: 'Lika många rader som det finns i varje rad. Vrid plåten och säg sedan var ni skulle bryta isär.', da: 'Der er lige så mange rækker, som der er boller i rækken. Pladen ser ens ud, når den drejes, så her er det jer, der vælger, hvor den skal knækkes.', no: 'Like mange rader som det er boller i hver rad. Å snu denne plata gir ingen nye brytelinjer – si heller hvor dere ville brutt, og hvorfor.', fi: 'Rivejä on saman verran kuin yhdessä rivissä on pullia. Käännä pelti: saumat ovat samat kuin äsken — vain tällä pellillä käy niin. Sanokaa sitten, mistä saumasta katkaisisitte.' },
      ...
      sceneWhole:   { en: 'A tray of buns: {r} [r|row|rows] of {c}.', de: 'Ein Blech Brötchen: {r} [r|Reihe mit|Reihen zu je] {c}.', fr: 'Une plaque de brioches : {r} [r|rangée|rangées] de {c}.', it: 'Una teglia di panini: {r} [r|riga|righe] da {c}.', es: 'Una bandeja de panecillos: {r} [r|fila|filas] de {c}.', pt: 'Uma assadeira de pãezinhos: {r} [r|fileira|fileiras] de {c}.', nl: 'Een breekbrood: {r} [r|rij|rijen] van {c}.', sv: 'En plåt bullar: {r} [r|rad med {c}|rader med {c} i varje].', da: 'Bagepladen i ét stykke: {r} [r|række|rækker] med {c} [c|bolle|boller] [r|i rækken|i hver række].', no: 'Hele bolleplata: {r} [r|rad|rader] med {c} [c|bolle|boller].', fi: 'Pellillinen pullia: {r} [r|rivi|riviä], [r|jossa|joissa kussakin] on {c}.' },
      sceneCut2:    { en: 'A tray of buns in two pieces: {a} [a|row|rows] of {c}, and {b} [b|row|rows] of {c}.', de: 'Ein Blech Brötchen in zwei Teilen: {a} [a|Reihe mit|Reihen zu je] {c} und {b} [b|Reihe mit|Reihen zu je] {c}.', fr: 'Une plaque de brioches en deux morceaux : {a} [a|rangée|rangées] de {c} et {b} [b|rangée|rangées] de {c}.', it: 'Una teglia di panini in due pezzi: {a} [a|riga|righe] da {c} e {b} [b|riga|righe] da {c}.', es: 'Una bandeja de panecillos en dos trozos: {a} [a|fila|filas] de {c} y {b} [b|fila|filas] de {c}.', pt: 'Uma assadeira de pãezinhos em dois pedaços: {a} [a|fileira|fileiras] de {c} e {b} [b|fileira|fileiras] de {c}.', nl: 'Hetzelfde breekbrood in twee stukken: boven {a} [a|rij|rijen] van {c}, onder {b} [b|rij|rijen] van {c}.', sv: 'En plåt bullar i två bitar: {a} [a|rad med {c}|rader med {c} i varje] och {b} [b|rad med {c}|rader med {c} i varje].', da: 'Bagepladen i to stykker: {a} [a|række|rækker] med {c} [c|bolle|boller] [a|i rækken|i hver række] og {b} [b|række|rækker] med {c} [c|bolle|boller] [b|i rækken|i hver række].', no: 'Bolleplata i to biter, like mange boller som før: {a} [a|rad|rader] med {c} [c|bolle|boller] og {b} [b|rad|rader] med {c} [c|bolle|boller].', fi: 'Pellillinen pullia kahtena palana: {a} [a|rivi|riviä], [a|jossa|joissa kussakin] on {c}, ja {b} [b|rivi|riviä], [b|jossa|joissa kussakin] on {c}.' },
      sceneCut3:    { en: 'A tray of buns in three pieces: {a} [a|row|rows] of {c}, {b} [b|row|rows] of {c}, and {d} [d|row|rows] of {c}.', de: 'Ein Blech Brötchen in drei Teilen: {a} [a|Reihe mit|Reihen zu je] {c}, {b} [b|Reihe mit|Reihen zu je] {c} und {d} [d|Reihe mit|Reihen zu je] {c}.', fr: 'Une plaque de brioches en trois morceaux : {a} [a|rangée|rangées] de {c}, {b} [b|rangée|rangées] de {c} et {d} [d|rangée|rangées] de {c}.', it: 'Una teglia di panini in tre pezzi: {a} [a|riga|righe] da {c}, {b} [b|riga|righe] da {c} e {d} [d|riga|righe] da {c}.', es: 'Una bandeja de panecillos en tres trozos: {a} [a|fila|filas] de {c}, {b} [b|fila|filas] de {c} y {d} [d|fila|filas] de {c}.', pt: 'Uma assadeira de pãezinhos em três pedaços: {a} [a|fileira|fileiras] de {c}, {b} [b|fileira|fileiras] de {c} e {d} [d|fileira|fileiras] de {c}.', nl: 'Hetzelfde breekbrood in drie stukken: boven {a} [a|rij|rijen] van {c}, in het midden {b} [b|rij|rijen] van {c}, onder {d} [d|rij|rijen] van {c}.', sv: 'En plåt bullar i tre bitar: {a} [a|rad med {c}|rader med {c} i varje], {b} [b|rad med {c}|rader med {c} i varje] och {d} [d|rad med {c}|rader med {c} i varje].', da: 'Bagepladen i tre stykker: {a} [a|række|rækker] med {c} [c|bolle|boller] [a|i rækken|i hver række], {b} [b|række|rækker] med {c} [c|bolle|boller] [b|i rækken|i hver række] og {d} [d|række|rækker] med {c} [c|bolle|boller] [d|i rækken|i hver række].', no: 'Bolleplata i tre biter, like mange boller som før: {a} [a|rad|rader] med {c} [c|bolle|boller], {b} [b|rad|rader] med {c} [c|bolle|boller] og {d} [d|rad|rader] med {c} [c|bolle|boller].', fi: 'Pellillinen pullia kolmena palana: {a} [a|rivi|riviä], [a|jossa|joissa kussakin] on {c}, {b} [b|rivi|riviä], [b|jossa|joissa kussakin] on {c}, ja {d} [d|rivi|riviä], [d|jossa|joissa kussakin] on {c}.' },
      sceneCol2:    { en: 'A tray of buns in two pieces: {r} [r|row|rows] of {a}, and {r} [r|row|rows] of {b}.', de: 'Ein Blech Brötchen in zwei Teilen: {r} [r|Reihe mit|Reihen zu je] {a} und {r} [r|Reihe mit|Reihen zu je] {b}.', fr: 'Une plaque de brioches en deux morceaux : {r} [r|rangée|rangées] de {a} et {r} [r|rangée|rangées] de {b}.', it: 'Una teglia di panini in due pezzi: {r} [r|riga|righe] da {a} e {r} [r|riga|righe] da {b}.', es: 'Una bandeja de panecillos en dos trozos: {r} [r|fila|filas] de {a} y {r} [r|fila|filas] de {b}.', pt: 'Uma assadeira de pãezinhos em dois pedaços: {r} [r|fileira|fileiras] de {a} e {r} [r|fileira|fileiras] de {b}.', nl: 'Hetzelfde breekbrood in twee stukken: links {r} [r|rij|rijen] van {a}, rechts {r} [r|rij|rijen] van {b}.', sv: 'En plåt bullar i två bitar: {r} [r|rad med {a}|rader med {a} i varje] och {r} [r|rad med {b}|rader med {b} i varje].', da: 'Bagepladen i to stykker: {r} [r|række|rækker] med {a} [a|bolle|boller] [r|i rækken|i hver række] og {r} [r|række|rækker] med {b} [b|bolle|boller] [r|i rækken|i hver række].', no: 'Bolleplata i to biter, like mange boller som før: {r} [r|rad|rader] med {a} [a|bolle|boller] og {r} [r|rad|rader] med {b} [b|bolle|boller].', fi: 'Pellillinen pullia kahtena palana: {r} [r|rivi|riviä], [r|jossa|joissa kussakin] on {a}, ja {r} [r|rivi|riviä], [r|jossa|joissa kussakin] on {b}.' },
      sceneCol3:    { en: 'A tray of buns in three pieces: {r} [r|row|rows] of {a}, {r} [r|row|rows] of {b}, and {r} [r|row|rows] of {d}.', de: 'Ein Blech Brötchen in drei Teilen: {r} [r|Reihe mit|Reihen zu je] {a}, {r} [r|Reihe mit|Reihen zu je] {b} und {r} [r|Reihe mit|Reihen zu je] {d}.', fr: 'Une plaque de brioches en trois morceaux : {r} [r|rangée|rangées] de {a}, {r} [r|rangée|rangées] de {b} et {r} [r|rangée|rangées] de {d}.', it: 'Una teglia di panini in tre pezzi: {r} [r|riga|righe] da {a}, {r} [r|riga|righe] da {b} e {r} [r|riga|righe] da {d}.', es: 'Una bandeja de panecillos en tres trozos: {r} [r|fila|filas] de {a}, {r} [r|fila|filas] de {b} y {r} [r|fila|filas] de {d}.', pt: 'Uma assadeira de pãezinhos em três pedaços: {r} [r|fileira|fileiras] de {a}, {r} [r|fileira|fileiras] de {b} e {r} [r|fileira|fileiras] de {d}.', nl: 'Hetzelfde breekbrood in drie stukken: links {r} [r|rij|rijen] van {a}, in het midden {r} [r|rij|rijen] van {b}, rechts {r} [r|rij|rijen] van {d}.', sv: 'En plåt bullar i tre bitar: {r} [r|rad med {a}|rader med {a} i varje], {r} [r|rad med {b}|rader med {b} i varje] och {r} [r|rad med {d}|rader med {d} i varje].', da: 'Bagepladen i tre stykker: {r} [r|række|rækker] med {a} [a|bolle|boller] [r|i rækken|i hver række], {r} [r|række|rækker] med {b} [b|bolle|boller] [r|i rækken|i hver række] og {r} [r|række|rækker] med {d} [d|bolle|boller] [r|i rækken|i hver række].', no: 'Bolleplata i tre biter, like mange boller som før: {r} [r|rad|rader] med {a} [a|bolle|boller], {r} [r|rad|rader] med {b} [b|bolle|boller] og {r} [r|rad|rader] med {d} [d|bolle|boller].', fi: 'Pellillinen pullia kolmena palana: {r} [r|rivi|riviä], [r|jossa|joissa kussakin] on {a}, {r} [r|rivi|riviä], [r|jossa|joissa kussakin] on {b}, ja {r} [r|rivi|riviä], [r|jossa|joissa kussakin] on {d}.' },

      turnBtn:      { en: 'Turn the tray', de: 'Blech drehen', fr: 'Tourner la plaque', it: 'Gira la teglia', es: 'Girar la bandeja', pt: 'Girar a assadeira', nl: 'Brood draaien', sv: 'Vrid plåten', da: 'Drej pladen', no: 'Snu plata', fi: 'Käännä pelti' },
      turnAria:     { en: 'Turn the tray a quarter turn.', de: 'Das Blech um eine Vierteldrehung drehen.', fr: 'Tourner la plaque d’un quart de tour : les creux changent de sens.', it: 'Girare la teglia di un quarto di giro.', es: 'Girar la bandeja: un cuarto de giro.', pt: 'Girar a assadeira de lado.', nl: 'Het brood een kwartslag draaien: de rijen en wat er in elke rij ligt wisselen om.', sv: 'Vrid plåten ett kvarts varv.', da: 'Drej pladen en kvart omdrejning.', no: 'Snu plata en kvart omdreining.', fi: 'Käännä pelti neljänneskäännös.' },
      rowsDown:     { en: 'One row fewer.', de: 'Eine Reihe weniger.', fr: 'Enlever une rangée.', it: 'Una riga in meno.', es: 'Una fila menos.', pt: 'Uma fileira a menos.', nl: 'Eén rij minder.', sv: 'En rad mindre.', da: 'Én række færre på pladen.', no: 'Én rad mindre.', fi: 'Yksi rivi vähemmän.' },
      rowsUp:       { en: 'One row more.', de: 'Eine Reihe mehr.', fr: 'Ajouter une rangée.', it: 'Una riga in più.', es: 'Una fila más.', pt: 'Uma fileira a mais.', nl: 'Eén rij meer.', sv: 'En rad till.', da: 'Én række mere på pladen.', no: 'Én rad til.', fi: 'Yksi rivi enemmän.' },
      colsDown:     { en: 'One fewer in each row.', de: 'Eins weniger in jeder Reihe.', fr: 'Enlever une brioche dans chaque rangée.', it: 'Un panino in meno in ogni riga.', es: 'Un panecillo menos en cada fila.', pt: 'Um pãozinho a menos em cada fileira.', nl: 'Eén broodje minder in elke rij.', sv: 'En bulle mindre i varje rad.', da: 'Én bolle færre i rækken.', no: 'Én bolle mindre i hver rad.', fi: 'Yksi pulla vähemmän joka rivissä.' },
      colsUp:       { en: 'One more in each row.', de: 'Eins mehr in jeder Reihe.', fr: 'Ajouter une brioche dans chaque rangée.', it: 'Un panino in più in ogni riga.', es: 'Un panecillo más en cada fila.', pt: 'Um pãozinho a mais em cada fileira.', nl: 'Eén broodje meer in elke rij.', sv: 'En bulle till i varje rad.', da: 'Én bolle mere i rækken.', no: 'Én bolle til i hver rad.', fi: 'Yksi pulla enemmän joka rivissä.' },

      rowCombAria:  { en: 'Where to break the tray across.', de: 'Wo zwischen den Reihen auseinanderbrechen.', fr: 'Les creux entre les rangées.', it: 'Dove spezzare fra le righe.', es: 'Dónde separar los panecillos: arriba y abajo.', pt: 'Onde quebrar, entre as fileiras.', nl: 'De naden die van links naar rechts lopen.', sv: 'Var bullarna bryts isär tvärs över, mellan raderna.', da: 'Vælg, hvor pladen skal knækkes mellem to rækker.', no: 'Velg hvilken rad brytelinja skal gå under.', fi: 'Minkä rivin jälkeen pelti katkaistaan.' },
      colCombAria:  { en: 'Where to break the tray down.', de: 'Wo zwischen den Spalten auseinanderbrechen.', fr: 'Les creux entre les colonnes.', it: 'Dove spezzare fra le colonne.', es: 'Dónde separar los panecillos: izquierda y derecha.', pt: 'Onde quebrar, entre as colunas.', nl: 'De naden die van boven naar beneden lopen.', sv: 'Var bullarna bryts isär uppifrån och ner, mellan kolumnerna.', da: 'Vælg, hvor pladen skal knækkes tværs igennem alle rækker.', no: 'Velg hvilken bolle i raden brytelinja skal gå etter.', fi: 'Minkä sarakkeen jälkeen pelti katkaistaan.' },
      ...
      breakRow:     { en: 'Break after row {k}: {a} [a|row|rows] above, {b} [b|row|rows] below.', de: 'Nach Reihe {k} auseinanderbrechen: oben {a} [a|Reihe|Reihen], unten {b} [b|Reihe|Reihen].', fr: 'Casser après la rangée {k} : {a} [a|rangée|rangées] au-dessus, {b} [b|rangée|rangées] en dessous.', it: 'Spezzare dopo la riga {k}: sopra {a} [a|riga|righe], sotto {b} [b|riga|righe].', es: 'Separar después de la fila {k}: {a} [a|fila|filas] arriba y {b} [b|fila|filas] abajo.', pt: 'Quebrar depois da fileira {k}: em cima, {a} [a|fileira|fileiras]; embaixo, {b} [b|fileira|fileiras].', nl: 'Breken bij naad {k}: {a} [a|rij|rijen] erboven, {b} [b|rij|rijen] eronder.', sv: 'Bryt isär efter rad {k}: {a} [a|rad|rader] ovanför, {b} [b|rad|rader] nedanför.', da: 'Knæk efter række {k}: {a} [a|række|rækker] over og {b} [b|række|rækker] under.', no: 'Bryt under rad {k}: {a} [a|rad|rader] over og {b} [b|rad|rader] under.', fi: 'Katkaise rivin {k} jälkeen: ylhäällä {a} [a|rivi|riviä], alhaalla {b} [b|rivi|riviä].' },
      ...
      breakCol:     { en: 'Break after column {k}: {a} in each row on the left, {b} in each row on the right.', de: 'Nach Spalte {k} auseinanderbrechen: links {a} in jeder Reihe, rechts {b} in jeder Reihe.', fr: 'Casser après la colonne {k} : {a} [a|brioche|brioches] dans chaque rangée à gauche, {b} [b|brioche|brioches] dans chaque rangée à droite.', it: 'Spezzare dopo la colonna {k}: a sinistra {a} [a|panino|panini] in ogni riga, a destra {b} [b|panino|panini] in ogni riga.', es: 'Separar después de la columna {k}: a la izquierda, {a} [a|panecillo|panecillos] en cada fila; a la derecha, {b} [b|panecillo|panecillos] en cada fila.', pt: 'Quebrar depois da coluna {k}: à esquerda, {a} [a|pãozinho|pãezinhos] em cada fileira; à direita, {b} [b|pãozinho|pãezinhos] em cada fileira.', nl: 'Breken bij naad {k}: links {a} [a|broodje|broodjes] in elke rij, rechts {b} [b|broodje|broodjes] in elke rij.', sv: 'Bryt isär efter kolumn {k}: {a} [a|bulle|bullar] i varje rad till vänster, {b} [b|bulle|bullar] i varje rad till höger.', da: 'Knæk efter den {k}. bolle i rækken: {a} [a|bolle|boller] til venstre og {b} [b|bolle|boller] til højre [r|i rækken|i hver række].', no: 'Bryt etter bolle {k} i hver rad: {a} [a|bolle|boller] til venstre og {b} [b|bolle|boller] til høyre.', fi: 'Katkaise sarakkeen {k} jälkeen: vasemmalla {a} [a|pulla|pullaa] joka rivissä, oikealla {b} [b|pulla|pullaa] joka rivissä.' },
      ...
      pushRow:      { en: 'Push the two pieces at row {k} back together.', de: 'Die beiden Teile nach Reihe {k} wieder zusammenschieben.', fr: 'Remettre les deux morceaux ensemble, dans le creux après la rangée {k}.', it: 'Rimettere insieme i due pezzi dopo la riga {k}.', es: 'Juntar los trozos después de la fila {k}.', pt: 'Encostar os dois pedaços de volta, depois da fileira {k}.', nl: 'De stukken boven en onder naad {k} weer tegen elkaar duwen.', sv: 'Skjut ihop de två bitarna vid rad {k}.', da: 'Skub stykkerne sammen igen efter række {k}.', no: 'Skyv bitene sammen igjen under rad {k}.', fi: 'Työnnä rivin {k} sauma takaisin kiinni.' },
      pushCol:      { en: 'Push the two pieces at column {k} back together.', de: 'Die beiden Teile nach Spalte {k} wieder zusammenschieben.', fr: 'Remettre les deux morceaux ensemble, dans le creux après la colonne {k}.', it: 'Rimettere insieme i due pezzi dopo la colonna {k}.', es: 'Juntar los trozos después de la columna {k}.', pt: 'Encostar os dois pedaços de volta, depois da coluna {k}.', nl: 'De stukken links en rechts van naad {k} weer tegen elkaar duwen.', sv: 'Skjut ihop de två bitarna vid kolumn {k}.', da: 'Skub stykkerne sammen igen efter den {k}. bolle i rækken.', no: 'Skyv bitene sammen igjen etter bolle {k} i hver rad.', fi: 'Työnnä sarakkeen {k} sauma takaisin kiinni.' },

      saidTurned:   { en: 'Turned. {r} [r|row|rows] of {c}.', de: 'Gedreht. {r} [r|Reihe mit|Reihen zu je] {c}.', fr: 'Plaque tournée. {r} [r|rangée|rangées] de {c}.', it: 'Teglia girata. {r} [r|riga|righe] da {c}.', es: 'Ya está girada. Una bandeja de panecillos: {r} [r|fila|filas] de {c}.', pt: 'Assadeira girada. {r} [r|fileira|fileiras] de {c}.', nl: 'Gedraaid. {r} [r|rij|rijen] van {c}.', sv: 'Vriden ett kvarts varv. {r} [r|rad med {c}|rader med {c} i varje].', da: 'Drejet. Nu {r} [r|række|rækker] med {c} [c|bolle|boller] [r|i rækken|i hver række].', no: 'Snudd. Like mange boller, lest den andre veien: {r} [r|rad|rader] med {c} [c|bolle|boller].', fi: 'Käännetty. {r} [r|rivi|riviä], [r|jossa|joissa kussakin] on {c}.' },

      printBtn:     { en: 'Print this tray', de: 'Dieses Blech drucken', fr: 'Imprimer la fiche de cette plaque', it: 'Stampa questa teglia', es: 'Imprimir esta bandeja', pt: 'Imprimir esta assadeira', nl: 'Dit brood afdrukken', sv: 'Skriv ut plåten', da: 'Print pladen', no: 'Skriv ut denne plata', fi: 'Tulosta pelti' },
      gateTitle:    { en: 'The sheets to print', de: 'Die Blätter zum Ausdrucken', fr: 'La fiche à imprimer', it: 'I fogli da stampare', es: 'La bandeja en papel', pt: 'A folha para imprimir', nl: 'De bladen om af te drukken', sv: 'Bladen att skriva ut', da: 'Arket til print', no: 'Arkene du kan skrive ut', fi: 'Tulostettavat arkit' },
      ...
      gateBody:     { en: 'A page to break on paper: the whole tray first, then the same tray again broken at each different line, with a rule under every one to write on.', de: 'Ein Blatt zum Brechen auf Papier: zuerst das ganze Blech, dann dasselbe Blech noch einmal, jedes an einer anderen Rille auseinandergebrochen, mit einer Zeile zum Aufschreiben unter jedem.', fr: 'Une fiche à casser sur le papier : d’abord la plaque entière, puis la même plaque cassée dans plusieurs creux différents, dans un sens comme dans l’autre, avec une ligne pour écrire sous chaque dessin.', it: 'Fogli da spezzare sulla carta: prima la teglia intera, poi la stessa teglia spezzata in punti diversi, con sotto ognuna una linea su cui scrivere.', es: 'Una hoja para separar los panecillos en papel: primero la bandeja entera y luego la misma bandeja separada en varias líneas distintas, con un renglón debajo de cada una para escribir.', pt: 'Uma folha para quebrar no papel: primeiro a assadeira inteira e depois a mesma assadeira de novo, cada vez quebrada em um lugar diferente, com uma pauta embaixo de cada uma para escrever.', nl: 'Een blad om op papier te breken: eerst het hele brood, daarna hetzelfde brood telkens bij een andere naad gebroken, van links naar rechts én van boven naar beneden, met onder elke tekening een lijn om op te schrijven.', sv: 'Ett blad att bryta isär på papper: först hela plåten, sedan samma plåt igen och igen, varje bild bruten vid en annan skåra, med en linje under varje bild att skriva på.', da: 'Et ark til at knække på papir: først den hele plade, så den samme plade igen, knækket ved hver af de revner, der er — med en skrivelinje under hver.', no: 'En side å bryte på papir: først hele bolleplata, så den samme plata om igjen for hver brytelinje, med ei skrivelinje under hvert bilde.', fi: 'Arkit, joilla pelti katkaistaan kynällä: ensin koko pelti, sitten sama pelti erikseen jokaisesta saumasta katkaistuna, ja jokaisen alla viiva, jolle kirjoitetaan.' },
      gateCta:      { en: 'See the Teacher plan', de: 'Zum Lehrkraft-Abo', fr: 'Voir l’offre Enseignant', it: 'Il piano Insegnante', es: 'Ver el plan Docente', pt: 'Ver o plano Professor', nl: 'Bekijk het Leerkracht-pakket', sv: 'Se Lärarplanen', da: 'Se Lærerabonnementet', no: 'Se Lærerabonnementet', fi: 'Katso Opettaja-tilaus' },

      setGroove:    { en: 'Deeper groove every fifth seam', de: 'Jede fünfte Rille tiefer', fr: 'Creux plus profond toutes les cinq brioches', it: 'Solco più profondo ogni cinque panini', es: 'Línea más marcada cada cinco panecillos', pt: 'Marca mais funda a cada cinco pãezinhos', nl: 'Elke vijfde naad wat dieper', sv: 'Var femte skåra djupare', da: 'Dybere revne efter hver femte bolle', no: 'Dypere rille ved hver femte brytelinje', fi: 'Syvempi ura joka viidennessä saumassa' },
      setRange:     { en: 'Allow 11 and 12', de: 'Auch 11 und 12', fr: 'Rangées et colonnes jusqu’à 12', it: 'Anche 11 e 12', es: 'Permitir bandejas de 11 y de 12', pt: 'Permitir até 12 fileiras e 12 colunas', nl: 'Tot 12 rijen en 12 in elke rij', sv: 'Tillåt 11 och 12 rader eller kolumner', da: 'Tillad op til 12 rækker og 12 boller i rækken', no: 'Tillat opptil 12 rader og 12 boller i hver rad', fi: 'Salli riveiksi ja sarakkeiksi myös 11 ja 12' }
    },
    ...
    _seamKey: function (axis, k, P, OX, OY, trayW, trayH) {
      ...
      if (cracked) {
        ...
        b.setAttribute('aria-label', this._fmt(axis === 'row' ? 'breakRow' : 'breakCol',
          { k: k, a: sp[0], b: sp[1], r: st.rows, c: st.cols }));
  ...
  function injectBakingTrayCSS() {
    ...
    var css = ''
      ...
      /* ⚠ THE LONGEST LOCALES SET THE NARROW LAYOUT, NOT ENGLISH. Spanish
         and Portuguese hint lines wrap to four lines at 320px and pushed
         the bottom control 17px past the fold — a cut-off control, on the
         two locales whose prose is longest. English fitted comfortably
         and proved nothing. Tightened here rather than by moving the
         gate's threshold. */
      + '@media (max-width:400px){'
      + '  .btr-wrap{gap:6px;}'
      + '  .btr-hint{font-size:15px;line-height:1.3;margin-top:0;}'
      + '  .btr-foot{gap:8px;}'
      + '  .btr-foot2{margin-top:0;}'
      + '  .btr-chip{padding:0 14px;}'
      + '}'
      + '@media (min-width:1367px) and (min-height:880px){'
      + '  body.btr-wide .btr-arena{max-width:620px;}'
      + '  body.btr-wide .btr-hint{max-width:640px;font-size:18px;}'
      + '}'
      /* ⚠ 1160, NOT 1080. This tier fired at exactly 1080px of height and
         granted an 800px arena PLUS grown chrome — which fits English and
         cuts off GERMAN and FINNISH by 24px, because their hints wrap to
         another line. The min-height floor is the thing that was wrong,
         measured against the longest locales; a 1920x1080 screen now
         correctly falls back to the 620px tier, which fits all eleven. */
