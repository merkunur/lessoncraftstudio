...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'generador de criptogramas con imágenes',
    secondaryKeywords: [
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Usa la Asignación Automática para asociar instantáneamente imágenes aleatorias del tema seleccionado a todas las letras del alfabeto sin asignar con un solo clic — la forma más rápida de construir un cifrado completo. Alternativamente, usa la Asignación Manual para elegir manualmente qué imagen específica representa cada letra, con una vista general de todas las asociaciones actuales. También puedes subir imágenes propias y asignarlas a cualquier letra para control creativo total.',
      },
      {
      ...
      },
      {
        ...
        description: 'Cambia a la pestaña de Clave de Respuestas y genera una versión resuelta que incluye una leyenda de letras completa — cada letra del alfabeto emparejada con su imagen asignada en orden alfabético para referencia definitiva. Activa el modo Escala de Grises para impresión con ahorro de tinta. Descarga tanto la ficha como la clave de respuestas como PDF listo para imprimir o JPEG de alta resolución a más de 400 DPI con un multiplicador de renderizado 6x.',
      },
    ],
  },
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Genera de 50 a 100 páginas de criptogramas con estructura de dificultad progresiva. Comienza con puzzles con mucho andamiaje de 8 a 10 Letras a Revelar para calentamiento, avanza a 3–5 revelaciones para los capítulos intermedios y termina con desafíos expertos de cero revelaciones. Agrupa los capítulos por tema para variedad navegable e incluye leyendas de letras con claves de respuesta al final. Usa el modo escala de grises para costes de impresión más bajos. Los cuadernos de criptogramas con imágenes ocupan un nicho menos competitivo en KDP que los cuadernos de sopas de letras o crucigramas, dándote mayor visibilidad con menor inversión en publicidad.',
    },
    {
    ...
    },
    {
      ...
      description: 'Cambia el idioma y regenera el mismo diseño de criptograma en los 11 idiomas disponibles. Tanto el texto del mensaje secreto como el conjunto de letras del alfabeto cambian según el idioma — un criptograma en alemán codifica una frase alemana con ä, ö, ü, ß en el alfabeto; un criptograma en francés usa é, è, ç, à; uno en español incluye ñ, á, é, í, ó, ú. Cada versión en un idioma diferente es un puzzle de cifrado genuinamente distinto con palabras diferentes, asociaciones de letras diferentes y una experiencia de resolución diferente. Una sola sesión de diseño produce 11 productos distintos.',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'La Asignación Automática completa todo el cifrado con un solo clic asociando imágenes aleatorias del tema seleccionado a cada letra sin asignar. Para producción en lote, selecciona un tema, escribe tu frase, pulsa Asignación Automática, ajusta Letras a Revelar y genera. Puedes producir un puzzle de cifrado temático completo en menos de dos minutos. Reserva la Asignación Manual para productos premium donde asociaciones específicas de imagen-letra refuerzan el tema.',
    },
    {
    ...
    },
    {
      ...
      description: 'Como el criptograma es sensible al idioma, cambiar de idioma modifica tanto el mensaje secreto como el conjunto del alfabeto. Un criptograma en alemán incluye ä, ö, ü, ß; uno en francés incluye é, è, ç, à; uno en español incluye ñ, á, é, í, ó, ú. Cada versión es un producto de cifrado fundamentalmente diferente. Un flujo de trabajo de diseño produce 11 listings distintos para 11 mercados de compradores diferentes.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'La Asignación Automática asocia instantáneamente imágenes aleatorias del tema seleccionado a todas las letras del alfabeto sin asignar con un solo clic — rápida para producción en lote. La Asignación Manual te permite elegir manualmente qué imagen específica representa cada letra, con una vista general de todas las asociaciones actuales. Puedes combinar ambas: asignación automática para la mayoría y luego intercambiar manualmente letras específicas por imágenes que encajen mejor con tu tema.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Descarga fichas y claves de respuesta como imágenes JPEG de alta resolución o archivos PDF optimizados para impresión a más de 400 DPI con un multiplicador de renderizado 6x. Los tamaños de página disponibles incluyen Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal y dimensiones personalizadas. Activa la escala de grises para impresión con ahorro de tinta. Los PDF son ideales para impresión directa y subida a KDP; los JPEG funcionan muy bien para maquetas de productos y publicaciones en redes sociales.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'criptogramas-imagenes-fichas', anchorText: 'Criptogramas con Imágenes — Detalles Completos del Producto' },
