...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'printable product series Etsy',
    secondaryKeywords: [
      'cross-sell printable products Etsy',
      'printable product line strategy',
      'themed printable series sales',
    ],
    lsiKeywords: [
  ...
  relatedPosts: [
    { slug: 'themed-image-collections-unique-products', title: 'Use Themed Image Collections to Create Unique Products' },
  ...
  cta: {
    heading: 'Build Your First Product Series Today',
    description: 'LessonCraftStudio offers 104 themed image collections and 33 generators to help you create complete product series efficiently. Try any generator free trial with watermark.',
