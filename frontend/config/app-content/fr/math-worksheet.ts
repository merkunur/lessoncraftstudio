...
const content: AppContent = {
  ...
  howItWorks: {
    title: 'Comment Créer des Puzzles Algébriques Illustrés en 5 Étapes',
    steps: [
      {
        title: 'Définir la mise en page',
        description:
          'Ouvrez le panneau Mise en Page et choisissez un format : Letter Portrait, Letter Paysage, A4 Portrait, A4 Paysage, Fiche par Défaut (800×1000), Carré (1200×1200) ou toute dimension personnalisée. Sélectionnez une couleur de fond, choisissez un thème de fond décoratif dans la bibliothèque d\'images et ajustez l\'opacité pour garder les équations lisibles. Ajoutez un cadre de bordure assorti pour donner à vos fiches un aspect professionnel et prêt à imprimer.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Ouvrez le panneau Bibliothèque d\'Images et parcourez 104 thèmes — des animaux et la nourriture aux véhicules et aux fêtes. Utilisez la barre de recherche pour trouver des images spécifiques instantanément. Choisissez votre mode de sélection : Sélectionner les Images Individuellement pour choisir au moins 8 images spécifiques, ou Utiliser le Thème Complet pour inclure toutes les images d\'un thème. Chaque puzzle puise dans votre sélection pour attribuer des images comme symboles de variables. Vous pouvez également télécharger vos propres images pour un rendu unique correspondant à votre marque.',
      },
      {
  ...
  keyFeatures: {
    title: 'Fonctionnalités Clés du Générateur de Puzzles Algébriques',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Parcourez une bibliothèque de plus de 3 100 illustrations en haute résolution organisées en 104 thèmes : animaux de la ferme, vie marine, véhicules, espace, nourriture, sport, dinosaures, fêtes et bien plus. Chaque image sert de variable algébrique dans les équations. Comme le contenu est entièrement visuel — images et nombres, sans texte — vos fiches fonctionnent dans toutes les langues et tous les pays du monde sans modification.',
      },
      {
  ...
  businessUseCases: {
    title: 'Comment Vendre des Puzzles Algébriques Illustrés en Ligne',
    cases: [
      {
      ...
      },
      {
        ...
        description:
          'Utilisez le générateur pour produire des packs hebdomadaires de puzzles algébriques et distribuez-les via votre propre boutique Shopify, Gumroad ou Payhip. Un modèle d\'abonnement — nouveau pack thématique chaque semaine — génère des revenus récurrents et fidélise une clientèle de familles en instruction à domicile et de centres de soutien scolaire. Avec quatre niveaux de difficulté, deux modes d\'opération, des plages de nombres configurables et 104 thèmes, vous avez assez de combinaisons pour des années de contenu unique.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Vous définissez une valeur minimale et maximale pour les solutions, avec une plage par défaut de 0 à 20. Des plages plus petites (par exemple 1–5) créent des puzzles plus simples pour les débutants, tandis que des plages plus larges produisent une arithmétique plus difficile dans les équations. Vous pouvez également activer l\'option Autoriser les Résultats Négatifs pour les apprenants avancés prêts à pratiquer les nombres signés.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Non. Ces fiches sont purement visuelles — le contenu utilise des images et des nombres, pas des mots. Un puzzle créé dans une langue fonctionne dans toutes les langues. Le paramètre de langue ne change que les libellés de l\'interface, pas le contenu de la fiche, rendant vos produits vendables instantanément sur tous les marchés. Cette indépendance linguistique est un véritable avantage concurrentiel pour les vendeurs, car un seul PDF de puzzle algébrique peut être proposé sur des places de marché en Amérique du Nord, en Europe et en Asie sans modification ni coût de production supplémentaire.',
    },
    {
  ...
  visuals: {
    ...
    videoTitle: 'Comment Créer des Puzzles Algébriques Illustrés — Tutoriel Étape par Étape',
  },
};
