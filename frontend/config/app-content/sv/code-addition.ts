...
const content: AppContent = {
  ...
  faq: [
    ...
    {
      question: 'Vilka talintervall kan jag ställa in för kodadditionsövningar?',
      answer:
        'Du kan ställa in minimum- och maximumvärden från 1 till 20. Intervallet måste vara tillräckligt brett för att ge unika nummer för alla dina symboler — om du väljer fem symboler behöver du minst fem olika nummer i ditt intervall. Appen validerar detta automatiskt och anger om du behöver justera intervallet.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Ja — Kodaddition är den enda språkkänsliga appen i kategorin Matematik Mästarpaket. I Klassiskt Läge är arbetsbladen rent visuella och fungerar på alla språk. Dock använder Avslöja Ord läget det valda språkets alfabet för att koppla summor till bokstäver. Svenskan innehåller å, ä och ö; tyskan innehåller Ä, Ö, Ü och ß; franskan innehåller à, â, ç, é och andra tecken med accenter. Alla elva stödda språk har sina egna fullständiga och korrekta alfabet inbyggda.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'idea',
      slug: 'rymden-utskriftsbara-ideer',
      anchorText: 'Rymden utskriftsbara idéer för pedagogiska arbetsblad',
    },
    {
      pageType: 'idea',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Kodadditions arbetsblad med djurbilder som döljer hemliga nummer i ett kodknäckningspussel',
    },
    sampleGallery: [
      {
      ...
      {
        src: '/samples/swedish/code%20addition/image_addition_worksheet%20(3).webp',
    ...
    videoTitle: 'Skapa Kodadditions Arbetsblad — Steg-för-Steg Guide',
  },
};
