...
(function (global) {
  ...
  function _pvrTitle(id) {
    id = id || '';
    if (/add-compose-hundred/.test(id)) return { title: { en: 'Tuck Makes a Hundred', de: 'Tuck bündelt einen Hunderter', fr: 'Tuck fait une centaine', es: 'Tuck forma una centena', pt: 'Tuck agrupa uma centena' }, instruction: { en: 'Tap “Make a hundred” to bundle 10 tens, then type the total.', de: 'Tippe auf „Hunderter bündeln", um 10 Zehner zu bündeln, und tippe dann das Ergebnis ein.', fr: 'Appuie sur « Grouper une centaine » pour faire un paquet de 10 dizaines, puis écris la réponse.', es: 'Toca «Formar una centena» para agrupar 10 decenas y luego escribe el total.', pt: 'Toque em «Agrupar uma centena» para juntar 10 dezenas e depois escreva o total.' } };
    if (/subtract-decompose-hundred/.test(id)) return { title: { en: 'Tuck Breaks a Hundred', de: 'Tuck entbündelt einen Hunderter', fr: 'Tuck casse une centaine', es: 'Tuck desarma una centena', pt: 'Tuck desagrupa uma centena' }, instruction: { en: 'Break a hundred, then a ten — then take some away and type the answer.', de: 'Entbündle einen Hunderter, dann einen Zehner – nimm dann welche weg und tippe das Ergebnis ein.', fr: 'Casse une centaine, puis une dizaine — enlève, puis écris la réponse.', es: 'Desarma una centena y luego una decena. Después quita algunas unidades y escribe la respuesta.', pt: 'Desagrupe uma centena e depois uma dezena. Em seguida, tire algumas unidades e escreva a resposta.' } };
    if (/subtract/.test(id)) return { title: { en: 'Tuck Breaks a Ten', de: 'Tuck entbündelt einen Zehner', fr: 'Tuck casse une dizaine', es: 'Tuck desarma una decena', pt: 'Tuck desagrupa uma dezena' }, instruction: { en: 'Tap “Break a ten”, then take some away and type the answer.', de: 'Tippe auf „Zehner entbündeln", nimm dann welche weg und tippe das Ergebnis ein.', fr: 'Appuie sur « Casser une dizaine », enlève, puis écris la réponse.', es: 'Toca «Desarmar una decena», quita algunas unidades y escribe la respuesta.', pt: 'Toque em «Desagrupar uma dezena», tire algumas unidades e escreva a resposta.' } };
  ...
  var _PVR_DE = {
    ...
    makeHundred:  { en: '🔁 Make a hundred', de: '🔁 Hunderter bündeln', fr: '🔁 Grouper une centaine', es: '🔁 Formar una centena', pt: '🔁 Agrupar uma centena', it: '🔁 Fai il cambio' },
