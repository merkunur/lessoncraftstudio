...
(function (global) {
  ...
  global.WallyCapitalCraneActivity = {
    ...
    strings: {
      title: { en: "Wally's Capital Crane", de: 'Wallys Großbuchstaben-Kran', fr: 'Wally et la grue à majuscules', es: 'La grúa de mayúsculas de Wally', pt: 'Wally e seu guindaste', it: 'La gru delle maiuscole di Wally' },
      instruction: { en: 'Tap the special name that needs a capital letter.', de: 'Tippe das Nomen an, das großgeschrieben wird.', fr: 'Touche le nom propre qui a oublié sa majuscule.', es: 'Toca el nombre propio que necesita mayúscula.', pt: 'Toque no nome próprio que precisa de letra maiúscula.', it: 'Tocca il nome proprio che ha bisogno della maiuscola.' },
      prompt: { en: 'Tap the word that needs a capital letter.', de: 'Welches Wort ist ein Nomen und wird großgeschrieben?', fr: 'Quel mot est un nom propre et prend une majuscule ?', es: '¿Qué palabra es un nombre propio y necesita mayúscula?', pt: 'Toque na palavra que precisa de letra maiúscula.', it: 'Quale parola è un nome proprio e vuole la maiuscola?' },
      wallyIntro: { en: 'Special names get a BIG letter — lift it up with the crane!', de: 'Nomen schreibt man groß — mein Kran hebt den Buchstaben hoch!', fr: 'Personne, ville ou pays : ma grue lui met sa majuscule !', es: 'Persona, ciudad o país: ¡mi grúa le pone su mayúscula!', pt: 'Nome próprio começa com letra maiúscula!', it: 'Persona, città o paese: la mia gru mette la maiuscola!' },
      hintPick: { en: 'Holidays, places, and products are special names — they need a capital.', de: 'Nomen (Namenwörter für Menschen, Tiere und Dinge) schreibt man immer groß. Welches Wort ist ein Nomen?', fr: 'Cherche le nom d’une personne, d’une ville ou d’un pays : il prend une majuscule.', es: 'Busca el nombre de una persona, una ciudad o un país: lleva mayúscula.', pt: 'Nomes de pessoas e lugares são nomes próprios — começam com maiúscula.', it: 'Cerca il nome di una persona, di una città o di un paese: vuole la maiuscola.' },
      hintWrong: { en: 'That one is fine. Find the special name (a holiday, place, or product).', de: 'Fast! Das ist kein Nomen. Suche das Wort für einen Menschen, ein Tier oder ein Ding.', fr: 'Ce mot n’est pas un nom propre. Cherche plutôt le nom d’une personne, d’une ville ou d’un pays.', es: 'Esa palabra no es un nombre propio. Busca el nombre de una persona, una ciudad o un país.', pt: 'Esse está certo. Ache o nome próprio (de uma pessoa ou de um lugar).', it: 'Quella parola non è un nome proprio. Cerca il nome di una persona o di un luogo.' },
      win: { en: 'Yes! That special name gets a big capital letter. 🏗️', de: 'Stark! Du hast das Nomen großgeschrieben! 🏗️', fr: 'Bravo ! Wally a soulevé la majuscule ! 🏗️', es: '¡Muy bien! Wally levantó la mayúscula. 🏗️', pt: 'Isso! Esse nome próprio ganha uma letra maiúscula bem grande. 🏗️', it: 'Sì! Il nome proprio prende una bella maiuscola. 🏗️' }
    },
    defaults: {},
