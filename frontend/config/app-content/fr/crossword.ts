...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Mots Croisés | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Mots Croisés professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Mots croisés avec indices en images',

    },
    sampleGallery: [
      { src: '/samples/english/crossword/Crossword 1.jpeg', alt: 'Mots croisés thématiques', caption: 'Mots croisés avec images' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Mots Croisés thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Mots Croisés est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'crossword', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Mots Croisés Gratuit' },
