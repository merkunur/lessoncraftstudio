...
const THEME_CONFIG = {
  name: 'zoo_animals_bw',
  type: 'images',
  sourceFolderName: 'zoo animals bw',
  displayNames: {
    en: 'Zoo Animals BW',
    de: 'Zootiere SW',
    fr: 'Animaux du zoo NB',
    es: 'Animales del zoológico BN',
    it: 'Animali dello zoo BN',
    pt: 'Animais do zoológico PB',
    nl: 'Dierentuindieren ZW',
    sv: 'Djurparksdjur SV',
    da: 'Zoodyr SH',
    no: 'Dyrehagedyr SH',
    fi: 'Eläintarhan eläimet MV'
  }
};
...
async function main() {
  console.log('============================================================');
  console.log('Image Import Script: Zoo Animals BW');
  console.log('============================================================\n');
