...
const content: BlogContent = {
  ...
  faq: [
    {
      question: 'Cuanto deberia gastar en Etsy Ads por mes?',
      answer: 'Para empezar, $30-90 mensuales ($1-3 diarios). No gaste mas del 15-20% de sus ingresos mensuales de Etsy en anuncios. Aumente solo cuando tenga datos que confirmen un ROAS positivo.',
    },
    {
      question: 'Etsy Ads funciona mejor que Pinterest para imprimibles?',
      answer: 'Son complementarios. Etsy Ads genera resultados inmediatos pero cuesta dinero. Pinterest es sin costo pero tarda 3-6 meses en generar trafico significativo. Use ambos si su presupuesto lo permite.',
    },
    {
      question: 'Puedo usar Etsy Ads desde el primer dia?',
      answer: 'Tecnicamente si, pero no es recomendable. Sin resenas ni historial, estara pagando por clics que no convierten. Espere al menos 2-3 meses y 10+ resenas antes de activar anuncios.',
    }
  ],
  internalLinks: [
  ...
  cta: {
    heading: 'Cree Productos que Conviertan con Anuncios',
    description: 'Fichas profesionales que maximizan su retorno publicitario. 33 generadores con prueba gratuita con marca de agua.',
