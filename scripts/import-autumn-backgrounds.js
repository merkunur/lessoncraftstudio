/**
 * Background Import Script: Autumn
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-autumn-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'autumn_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/autumn',
  displayNames: {
    en: 'Autumn',
    de: 'Herbst',
    fr: 'Automne',
