...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Seleziona tra due modalità. La modalità Oggetti Nascosti (predefinita) crea scene Vedo Vedo negoziche — immagini sparse su una griglia configurabile dove gli utenti cercano oggetti specifici. La modalità Trova le Lettere attiva una griglia alfabetica specifica per lingua con lettere accentate e genera scene Vedo Vedo usando immagini che iniziano con la lettera selezionata. L\'intestazione auto-generata commuta automaticamente tra "Vedo Vedo" e "Trova le Lettere" (localizzato in tutte le 11 lingue) in base alla tua selezione.',
      },
      {
        title: 'Configura la Densità della Griglia per il Controllo della Difficoltà',
        description: 'Imposta le dimensioni della griglia usando righe (5–10) e colonne (5–10) — predefinito 6×6 (36 celle). Una griglia 5×5 (25 celle) crea schede facili con immagini grandi e ben visibili per i più piccoli. Una griglia 10×10 (100 celle) crea scene Vedo Vedo dense e impegnative per utenti avanzati. Ogni cella mostra un\'immagine alla dimensione massima di 80px, con una riduzione del 5% nella modalità Trova le Lettere. La dimensione della griglia è il tuo controllo principale della difficoltà — griglie più piccole per prodotti per la scuola dell\'infanzia, griglie più grandi per la primaria e oltre.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Sfrutta le etichette immagini sensibili alla lingua per creare schede Vedo Vedo in 11 lingue dalla stessa libreria di immagini. Le stesse immagini producono etichette diverse quando cambi lingua — "Cat" diventa "Gatto" (italiano), "Katze" (tedesco), "Chat" (francese) e le iniziali del Trova le Lettere si aggiornano di conseguenza. Crea pacchetti Vedo Vedo multilingue dove ogni versione linguistica usa le stesse immagini tematiche ma etichette e istruzioni completamente localizzate. Questo è prezioso per venditori ESL/italiano come lingua straniera, negozi bilingue e famiglie homeschool internazionali. Vendi pacchetti specifici per lingua o mega-pacchetti multilingue a prezzi premium.',
    },
    {
      title: 'Pacchetti Attività di Osservazione e Conteggio per il negozio',
      description: 'Costruisci schede Vedo Vedo pronte per il negozio con campi nome/data e chiavi di risposta stampate per postazioni di auto-verifica. Il tipo di attività conta chiede agli utenti di scrivere quante istanze di ogni oggetto trovano — combinando ricerca visiva con pratica numerica in una sola scheda. Crea set adiacenti al curricolo: conteggio animali della fattoria per scienze, identificazione figure professionali per studi sociali, conteggio gruppi alimentari per educazione alimentare e conteggio oggetti stagionali per unità sulle festività. Ogni scheda viene esportata con la sua chiave di risposta auto-generata, eliminando il tempo di preparazione per creare pagine di soluzioni separate.',
    },
    {
      title: 'Pacchetti Multi-Formato Cerca e Trova',
      description: 'Abbina schede Vedo Vedo con puzzle oggetti nascosti, attività cerca parole, sfide di cruciverba e schede caccia al tesoro usando temi coordinati tra più generatori. Vedo Vedo sviluppa la scansione visiva, l\'identificazione degli oggetti e le abilità di conteggio. Cerca parole costruisce il riconoscimento delle lettere e il vocabolario. Cruciverba sfida l\'ortografia e la conoscenza delle definizioni. Ogni formato mira a un\'abilità cognitiva diversa mantenendo la coerenza tematica. I pacchetti multi-formato comandano prezzi premium perché genitori e venditori pagano di più per collezioni complete cerca-e-trova rispetto ai pacchetti a singola attività.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Imposta le righe da 5 a 10 e le colonne da 5 a 10 nel pannello Configurazione Pagina. Il predefinito è 6×6 (36 celle). Una griglia 5×5 (25 celle) crea schede più facili con immagini più grandi — ideale per i più piccoli. Una griglia 10×10 (100 celle) crea scene Vedo Vedo dense e impegnative per utenti avanzati. Ogni cella mostra un\'immagine alla dimensione massima di 80px, con una riduzione del 5% nella modalità Trova le Lettere. Gli oggetti bersaglio appaiono 1–5 volte ciascuno, con le celle rimanenti riempite da immagini distrattore casuali dal tema.',
    },
    {
      question: 'Come funziona la chiave di risposta auto-generata?',
      answer: 'Il generatore usa un sistema a doppio canvas con una scheda Scheda di Lavoro e una scheda Chiave di Risposta. La scheda mostra la scena di immagini sparse senza marcature — gli utenti cercano e completano i compiti da soli. La chiave di risposta riproduce l\'identico layout e sovrappone annotazioni visive rosse: cerchi attorno agli oggetti cerchia, quadrati attorno agli oggetti quadrato, croci sugli oggetti barra, e conteggi quantità per gli oggetti conta. Scarica ogni versione indipendentemente usando quattro pulsanti dedicati: scheda JPEG, scheda PDF, chiave di risposta JPEG e chiave di risposta PDF.',
    },
    {
