...
(function (global) {
  ...
  global.WallyCapitalCraneActivity = {
    ...
    strings: {
      title: { en: "Wally's Capital Crane", de: 'Wallys Großbuchstaben-Kran', fr: 'Wally et la grue à majuscules', es: 'La grúa de mayúsculas de Wally', pt: 'Wally e seu guindaste' },
      instruction: { en: 'Tap the special name that needs a capital letter.', de: 'Tippe das Nomen an, das großgeschrieben wird.', fr: 'Touche le nom propre qui a oublié sa majuscule.', es: 'Toca el nombre propio que necesita mayúscula.', pt: 'Toque no nome próprio que precisa de letra maiúscula.' },
      prompt: { en: 'Tap the word that needs a capital letter.', de: 'Welches Wort ist ein Nomen und wird großgeschrieben?', fr: 'Quel mot est un nom propre et prend une majuscule ?', es: '¿Qué palabra es un nombre propio y necesita mayúscula?', pt: 'Toque na palavra que precisa de letra maiúscula.' },
      wallyIntro: { en: 'Special names get a BIG letter — lift it up with the crane!', de: 'Nomen schreibt man groß — mein Kran hebt den Buchstaben hoch!', fr: 'Personne, ville ou pays : ma grue lui met sa majuscule !', es: 'Persona, ciudad o país: ¡mi grúa le pone su mayúscula!', pt: 'Nome próprio começa com letra maiúscula!' },
      hintPick: { en: 'Holidays, places, and products are special names — they need a capital.', de: 'Nomen (Namenwörter für Menschen, Tiere und Dinge) schreibt man immer groß. Welches Wort ist ein Nomen?', fr: 'Cherche le nom d’une personne, d’une ville ou d’un pays : il prend une majuscule.', es: 'Busca el nombre de una persona, una ciudad o un país: lleva mayúscula.', pt: 'Nomes de pessoas e lugares são nomes próprios — começam com maiúscula.' },
      ...
      win: { en: 'Yes! That special name gets a big capital letter. 🏗️', de: 'Stark! Du hast das Nomen großgeschrieben! 🏗️', fr: 'Bravo ! Wally a soulevé la majuscule ! 🏗️', es: '¡Muy bien! Wally levantó la mayúscula. 🏗️', pt: 'Isso! Esse nome próprio ganha uma letra maiúscula bem grande. 🏗️' }
    },
    defaults: {},
