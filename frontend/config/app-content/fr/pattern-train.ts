...
const content: AppContent = {
  seo: {
    primaryKeyword: 'fiches suite logique à imprimer',
    secondaryKeywords: [
      'algorithme maternelle fiche',
      'exercices suites logiques GS CP',
      'reproduire un algorithme fiche',
      'motifs à compléter',
    ],
    lsiKeywords: [
      'algorithme',
  ...
  ctaHeading: 'Créer des fiches de suites logiques',

  howItWorks: {
    title: 'Comment Créer des Fiches Train de Suites Logiques en 5 Étapes',
    steps: [
      {
        title: 'Définir la mise en page',
        description:
          'Ouvrez le panneau Mise en Page et choisissez un format de page : Letter Portrait, Letter Paysage, A4 Portrait, A4 Paysage, Carré (1200×1200) ou toute dimension personnalisée. Sélectionnez une couleur de page, choisissez un thème de fond décoratif depuis la bibliothèque d\'images et ajustez son opacité pour garder le train bien visible. Ajoutez un cadre de bordure assorti avec un contrôle d\'opacité indépendant. Ces choix de mise en page donnent à vos fiches train de suites logiques un aspect professionnel et soigné avant de configurer les paramètres du motif.',
      },
      {
        title: 'Choisir le type de motif',
        description:
          'Sélectionnez l\'un des cinq types de motifs répétitifs depuis le panneau Contenu. AB alterne deux éléments (A-B-A-B-A-B) pour les séquences les plus simples. AAB regroupe deux d\'un élément puis un d\'un autre (A-A-B-A-A-B). ABB inverse ce regroupement (A-B-B-A-B-B). ABC fait tourner trois éléments différents (A-B-C-A-B-C) pour une identification plus complexe. AABB associe deux de chaque avant de recommencer (A-A-B-B-A-A-B-B). Chaque type cible un niveau différent de compétence en reconnaissance de motifs — de l\'alternance simple à deux éléments aux séquences multi-éléments.',
      },
      {
  ...
  keyFeatures: {
    title: 'Fonctionnalités Clés du Générateur de Fiches Train de Suites Logiques',
    features: [
      {
  ...
  businessUseCases: {
    title: 'Comment Vendre des Fiches Train de Suites Logiques en Ligne',
    cases: [
      {
        title: 'Lots de reconnaissance de motifs sur Etsy',
        description:
          'Créez des packs de trains de suites logiques thématiques avec une difficulté progressive construite à partir de deux axes indépendants : le type de motif et le nombre d\'indices. Commencez par des motifs AB avec 10 indices pour le niveau le plus facile, puis réduisez les indices à 6 ou 4 pour des variations plus difficiles du même motif. Avancez vers les motifs AAB, ABB, ABC et AABB à chaque niveau d\'indices. Regroupez animaux de la ferme, dinosaures, créatures marines et véhicules comme des lots thématiques séparés avec 15 à 25 fiches chacun plus les corrigés. Le format unique en wagons de train se démarque des concurrents en grille dans les résultats de recherche Etsy. Prix : packs thématiques individuels à 3 €–5 € et lots progressifs multi-thèmes à 12 €–18 €.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Le train affiche 11 wagons sur trois rangées : 5 wagons sur la rangée du haut, 3 au milieu-gauche et 3 au milieu-droite. Chaque wagon contient une image de la séquence répétitive. L\'illustration thématique du train relie visuellement les wagons, créant une mise en page engageante qui se différencie des fiches de motifs classiques en grille. Ce format distinctif aide les produits à se démarquer dans les résultats de recherche des places de marché.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Le corrigé vit sur un onglet de canevas séparé, montrant le train complet avec les 11 wagons remplis — y compris la position qui était vide sur la fiche. Les deux canevas sont indépendamment modifiables, vous pouvez donc personnaliser le corrigé séparément. La fiche et le corrigé se téléchargent comme des fichiers séparés, offrant aux acheteurs un pack produit complet avec des solutions vérifiées.',
    },
    {
      question: 'En quoi les fiches train de suites logiques diffèrent-elles des fiches de motifs en grille ?',
      answer:
        'Le Train de Suites Logiques affiche les séquences sur un train thématique avec 11 wagons dans un format visuel distinctif, tandis que les fiches de motifs en grille utilisent des lignes et colonnes standard. Le format train est plus visuellement engageant et crée des produits qui se démarquent dans les listages des places de marché. Le Train de Suites Logiques propose aussi un nombre d\'indices ajustable (4–10) pour un contrôle précis de la difficulté et un placement dynamique de la position manquante — des fonctionnalités non disponibles dans les mises en page en grille standard.',
    },
    {
      question: 'Puis-je utiliser mes propres images personnalisées sur le train ?',
      answer:
        'Oui. La fonctionnalité de téléversement d\'images personnalisées vous permet d\'ajouter n\'importe quelle image aux exercices de trains de suites logiques. Téléversez des photos, des illustrations ou des graphiques pertinents pour votre sujet ou public spécifique. Les images personnalisées fonctionnent avec les cinq types de motifs et apparaissent sur les wagons du train aux côtés ou à la place des images de la bibliothèque. C\'est utile pour créer des fiches sur des sujets spécifiques au-delà des 104 collections thématiques intégrées.',
    },
    {
      question: 'Y a-t-il un essai gratuit ?',
      answer:
        'Oui. Vous pouvez accéder à toutes les fonctionnalités — les cinq types de motifs, le nombre d\'indices ajustable, la bibliothèque d\'images, la génération de corrigé et tous les formats d\'export — sans créer de compte, entrer de carte bancaire ni installer de logiciel. Les téléchargements de l\'essai gratuit incluent un petit filigrane. Une licence commerciale supprime le filigrane et accorde les droits de vente complets.',
    },
    {
    ...
    {
      question: 'Les suites logiques sont-elles adaptées à la maternelle GS et au CP ?',
      answer:
        'Oui. Les algorithmes simples (AB, AB) conviennent à la grande section (GS). Les motifs plus complexes (ABC, ABCD) sont adaptés au CP et CE1. Au Québec, cela correspond au préscolaire et à la 1re année du primaire.',
    },
  ],
