...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur d\'Objets Cachés | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Objets Cachés professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche objets cachés avec scène illustrée',

    },
    sampleGallery: [
      { src: '/samples/english/find objects/Hidden Objects 1.jpeg', alt: 'Jeu objets cachés', caption: 'Trouver les objets cachés' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Objets Cachés thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur d\'Objets Cachés est-il vraiment gratuit ?',
  ...
  internalLinks: [
    { slug: 'find-and-count', pageType: 'app' as const, anchorText: 'Générateur Chercher et Compter' },
    { slug: 'crossword', pageType: 'app' as const, anchorText: 'Générateur de Mots Croisés' },
    { slug: 'treasure-hunt', pageType: 'app' as const, anchorText: 'Générateur de Chasse au Trésor' },
    { slug: 'find-objects', pageType: 'tool' as const, anchorText: 'Essayer Générateur d\'Objets Cachés Gratuit' },
    { slug: 'search-bundle', pageType: 'bundle' as const, anchorText: 'Pack Chercher et Trouver Complet' }
  ],
};
