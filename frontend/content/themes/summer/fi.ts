...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'first-grade': {
      ...
      snippetAnswer: 'Kesätyölehdet ensimmäiselle luokalle (6–7-vuotiaat) kehittävät kellonaikojen ja ajan hallintaa kesäpäivän suunnittelun kautta, vahvistavat luonnontieteellistä tutkimista vesikokeiden ja kasvatusprojektien avulla sekä syventävät kertovaa kirjoittamista kesämuistojen kirjoittamisella. POPS 2014:n laaja-alaisen osaamisen tavoitteet toteutuvat. Ilmaisia tulostettavia PDF-työlehtiä LessonCraftStudiossa.',
      uniqueGradeAngle: 'Ensimmäisellä luokalla kesäteema siirtyy esiopetuksen kesäleikistä akateemiseen oppimisen ylläpitoon ja tieteelliseen tutkimiseen, koska kuusi- ja seitsemänvuotiaat tarvitsevat rakenteellista tukea oppimisTaitojen säilyttämiseen kesäloman aikana. POPS 2014:n oppimaan oppimisen tavoitteet ulottuvat kesään: oppilas tarvitsee motivoivaa materiaalia, joka ylläpitää luku-, kirjoitus- ja laskutaitoa. Kellonaikojen hallinta syventyy kesäpäivän suunnittelun kautta: herätys klo 8, uimaan klo 11, lounas klo 12:30 — kesto- ja välilaskut tulevat konkreettisiksi. Luonnontieteellinen tutkiminen saa tilaa kesällä: kasvatetaan herneitä ja mitataan kasvua senttimetreissä, tutkitaan veden ominaisuuksia kokeellisesti. Kertova kirjoittaminen kehittyy kesämuistojen kautta: oppilas kirjoittaa kokemuksistaan kokonaisilla lauseilla ja kappaleilla. Suomen kesä on ainutlaatuinen: yötön yö, mökkiKulttuuri, marjanpoiminta ja järvessä uiminen tarjoavat rikkaan oppimiskontekstin.',
      developmentalMilestones: [
        { milestone: 'Kellonaikojen ja keston hallinta (6–7-vuotiaat lukevat kelloa ja laskevat kestoja)', howWeAddress: 'Kesäpäivän aikataulutehtävät, joissa oppilas suunnittelee päivän kellonaikoineen ja laskee toimintojen kestoja, yhdistävät ajanhallinnan ja matematiikan' },
        { milestone: 'Kasvun mittaaminen ja dokumentointi (ensimmäisen luokan oppilaat seuraavat kasvatusprojektia)', howWeAddress: 'Kasvatuskoetehtävät, joissa oppilas istättaa siemenen, mittaa kasvua senttimetreissä viikottain ja piirtää kasvukäyrän, kehittävät pitkIäjänteistä tutkimista' },
        { milestone: 'Kertovan tekstin kirjoittaminen kesäkokemuksista (kuusi- ja seitsemänvuotiaat tuottavat kokemuskertomuKsia)', howWeAddress: 'Kesämuistotehtävät, joissa oppilas kirjoittaa kesän tapahtumista kokonaisilla kappaleilla ja kuvittaa tekstinsä, kehittävät kertovan kirjoittamisen taitoa' },
        { milestone: 'Akateemisten taitojen ylläpitäminen kesäloman aikana (ensimmäisen luokan oppilaat harjoittelevat säännöllisesti)', howWeAddress: 'Päivittäiset minitehtävät, joissa harjoitellaan lukemista, laskemista ja kirjoittamista viidentoista minuutin tuokioissa, ehkäisevät kesätaantumaa' },
      ],
      differentiationNotes: 'Tukea tarvitseville ensimmäisen luokan oppilaille anna kellonajat tasatunteina, yksinkertaista kasvatuskoe yhden kasvin seuraamiseen kuvallisella ohjeella ja tarjoa kesämuiston kirjoittamiseen lausepohjat. Edistyneille ensimmäisen luokan oppilaille lisää varttitunnit ja kestolaskut, haasta vertailemaan kahden kasvin kasvua eri olosuhteissa ja kirjoittamaan monisivuinen kesäpäiväkirja kuvauksineen ja pohdintoineen.',
      parentTakeaway: 'Ensimmäisen luokan kesätyölehdet ehkäisevät kesätaantumaa hauskalla tavalla. Suunnitelkaa kesäpäiviä yhdessä kellonaikoineen: milloin heräämme, kuinka kauan uimme? Kasvattakaa yhdessä herneitä tai tomaatteja ja mittakaa kasvua viikottain. Kirjoittakaa kesäpäiväkirjaa: joka ilta kolme lausetta päivän tapahtumista. Tärkeintä on pitää oppiminen läsnä arjessa ilman pakkoa — kesän kokemukset ovat luonnollinen oppimisen lähde.',
      classroomIntegration: 'Kesäteema valmistelee ensimmäisen luokan päätöstä ja loman oppimista: toukokuussa aloitetaan kasvatuskoe luokassa ja suunnitellaan kesän oppimisohjelma, äidinkielessä kirjoitetaan kesäsuunnitelmia ja harjoitellaan päiväkirjan pitämistä, matematiikassa harjoitellaan kellonaikoja kesäkontekstissa. POPS 2014:n itseohjautuvuuden ja oppimaan oppimisen tavoitteet toteutuvat, kun oppilas saa välineet kesän aikana oppimiseen.',
      assessmentRubric: [
        { skill: 'Kellonaikojen ja keston hallinta', emerging: 'tunnistaa tasatunnit kellosta ja arvioi yhden toiminnon keston', proficient: 'lukee kellon puolen tunnin tarkkuudella ja laskee kahden toiminnon välisen ajan', advanced: 'suunnittelee koko päivän aikataulun varttitunnin tarkkuudella ja laskee kestoja itsenäisesti' },
        { skill: 'Kasvun mittaaminen ja dokumentointi', emerging: 'mittaa kasvin korkeuden aikuisen avustuksella ja piirtää kuvan', proficient: 'mittaa itsenäisesti viikottain, kirjaa tulokset taulukkoon ja piirtää yksinkertaisen käyrän', advanced: 'vertailee kahden kasvin kasvua eri olosuhteissa, piirtää tarkan käyrän ja tekee johtopäätöksiä' },
        { skill: 'Kertova kirjoittaminen', emerging: 'kirjoittaa yhden–kaksi lausetta kesäkokemuksesta', proficient: 'kirjoittaa kesämuiston kolmella–viidellä lauseella sisältäen alun, tapahtuman ja lopun', advanced: 'kirjoittaa monipuolisen kertomuksen kuvauksineen, dialogeineen ja pohdintoineen' },
      ],
    },
    'second-grade': {
      ...
      snippetAnswer: 'Kesäaiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät mittaamista luontokontekstissa (lämpötila, tilavuus, etäisyys), kehittävät tutkivaa oppimista kesän luonnonilmiöiden dokumentoinnissa sekä vahvistavat päiväkirjamuotoista kirjoittamista kesän tapahtumien tallentamisessa. POPS 2014:n ympäristöopin ja äidinkielen vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla kesäteema kehittyy ensimmäisen luokan kesähavainnoista systemaattiseksi luonnontieteelliseksi tutkimukseksi, koska seitsemän- ja kahdeksanvuotiaat hallitsevat mittayksiköt, taulukoinnin ja päiväkirjamuotoisen kirjoittamisen. POPS 2014:n päättötavoitteet edellyttävät monipuolista luonnon tutkimista ja dokumentointia. Toisen luokan oppilas mittaa kesän ilmiöitä monipuolisesti: vedenlämpötila asteina, sademäärä millilitroina, uinti etäisyys metreinä, kasvin kasvu senttimetreiniä. Pitkittäisseuranta syventyy: oppilas kasvattaa kasvin ja mittaa kasvua viikoittain, kirjaa taulukkoon ja piirtää kasvukäyrän. Syy-seurausanalyysi: miksi kasvi kasvaa auringossa nopeammin, miksi järven lämpötila nousee hitaammin kuin ilman. Päiväkirjakirjoittaminen kehittyy reflektiiviseksi: oppilas kirjoittaa kesän kokemuksistaan pohtien tunteita ja oppimista. Suomalaisen kesän erityispiirteet — yötön yö, järvijärjestelmä, mökkikulttuuri — tarjoavat ainutlaatuisen tutkimuskontekstin.',
      developmentalMilestones: [
        { milestone: 'Monipuolinen mittaaminen luonnossa (7–8-vuotiaat mittaavat lämpötilaa, tilavuutta ja etäisyyttä)', howWeAddress: 'Kesämittaustehtävät, joissa oppilas mittaa vedenlämpötilan, sademäärän, kasvien korkeuden ja etäisyyksiä eri yksiköillä, kehittävät mittaamisen monipuolista hallintaa' },
        { milestone: 'Kasvin kasvun pitkittäisseuranta ja kasvukäyrän piirtäminen (toisen luokan oppilaat dokumentoivat muutoksia)', howWeAddress: 'Kasvinseurantatehtävät, joissa oppilas mittaa kasvin korkeuden viikoittain, kirjaa taulukkoon ja piirtää kasvukäyrän, kehittävät pitkittäistutkimuksen ja datan visualisoinnin taitoja' },
        { milestone: 'Syy-seuraussuhteiden tutkiminen kokeellisesti (seitsemän- ja kahdeksanvuotiaat tekevät vertailevia kokeita)', howWeAddress: 'Vertailukokeet, joissa oppilas kasvattaa kasvia eri olosuhteissa (valo vs. varjo) ja vertailee tuloksia, kehittävät kokeellista tutkimusajattelua' },
        { milestone: 'Reflektiivisen päiväkirjan kirjoittaminen (toisen luokan oppilaat pohtivat kokemuksiaan kirjallisesti)', howWeAddress: 'Kesäpäiväkirjatehtävät, joissa oppilas kirjoittaa päivän tapahtumista, pohtii tunteitaan ja oppimistaan, kehittävät reflektiivisen kirjoittamisen taitoja' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa mittaaminen kahteen yksikköön, anna kasvinseurannassa valmiit taulukkopohjat ja tarjoa päiväkirjaan lausealoitukset. Edistyneille toisen luokan oppilaille lisää yksikkömuunnokset, haasta suunnittelemaan oma vertailukoe kahdella muuttujalla ja kirjoittamaan monipuolinen tutkimusraportti kesän luonnonilmiöstä.',
      parentTakeaway: 'Toisen luokan kesätyölehdet muuttavat loman tieteelliseksi seikkailuksi. Kasvattakaa yhdessä kasvi ja mittatkaa kasvua joka viikko: piirtäkää kasvukäyrä. Mittatkaa järven lämpötila joka päivä ja pohtikaa miksi se muuttuu hitaammin kuin ilman lämpötila. Kirjoittakaa kesäpäiväkirjaa yhdessä ja pohtikaa: mikä oli parasta ja mitä opimme? Tärkeintä on tehdä kesästä tutkimusmatka.',
      classroomIntegration: 'Kesäteema on toisen luokan ympäristöopin tutkimusprojekti, joka ulottuu loma-aikaan: kasvinkasvatus ja mittaaminen ennen lomaa ja jälkeen, datan kokoaminen ja diagrammien piirtäminen syksyllä, kesäpäiväkirjan kirjoittaminen äidinkielessä ja kesätaide kuvataiteessa. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa kesäteema osoittaa mittaamisen, pitkittäistutkimuksen ja reflektiivisen kirjoittamisen taidot.',
      assessmentRubric: [
        { skill: 'Luonnon mittaaminen useilla yksiköillä', emerging: 'mittaa yhden suureen aikuisen avulla', proficient: 'mittaa lämpötilaa, tilavuutta ja pituutta itsenäisesti oikeilla yksiköillä', advanced: 'valitsee sopivan mittayksikön kontekstin mukaan ja tekee yksikkömuunnoksia' },
        { skill: 'Kasvin kasvun seuranta ja datan visualisointi', emerging: 'mittaa kasvin kerran mutta ei ylläpidä säännöllistä seurantaa', proficient: 'kirjaa mittaukset säännöllisesti taulukkoon ja piirtää kasvukäyrän', advanced: 'analysoi kasvukäyrän trendejä, vertailee eri olosuhteiden vaikutusta ja tekee johtopäätöksiä' },
        { skill: 'Reflektiivinen päiväkirjakirjoittaminen', emerging: 'luettelee päivän tapahtumia ilman pohdintaa', proficient: 'kirjoittaa päiväkirjamerkinnän tapahtumineen ja tunteiden pohdintoineen', advanced: 'kirjoittaa syvällisen reflektiivisen merkinnän, yhdistää kokemuksia oppimiseen ja asettaa tavoitteita' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Kesäaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät vesästöekosysteemien tieteellistä tutkimista järvi- ja meriympäristöjen ravintoverkkojen analyysillä, vahvistavat kertolaskupohjaista matkasuunnittelua aikataulujen, budjettien ja etäisyyksien laskemisella sekä opettavat vertailevan tutkimusraportin kirjoittamista Suomen kesän erityispiirteistä globaalissa kontekstissa. POPS 2014:n vuosiluokkien 3–6 ympäristöopin tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla kesäteema siirtyy lomamuistoista tieteelliseen ympäristötutkimukseen ja matemaattiseen suunnitteluun, kun kahdeksan- ja yhdeksänvuotiaat kykenevät ekosysteemiajatteluun ja monivaiheiseen kertolaskupohjaiseen suunnitteluun. Vesistöekosysteemien tutkiminen järvi- ja meriympäristöissä: ravintoverkkojen mallintaminen levistä kaloihin ja petokaloihin. Matkasuunnittelu kertolaskulla: 6 tunnin ajomatka × 80 km/h = 480 km, hotelli 3 yötä × 85 euroa = 255 euroa. Kesän ympäristöhaasteiden tutkiminen: sinilevä, rantaeroosio ja ilmastonmuutoksen vaikutus vesistöihin. Tutkimusraportti vertailee Suomen kesää trooppiseen kesään usean lähteen pohjalta. Suomen kesän erityispiirteet (yöttömät yöt, järvien lämpeneminen, marjastus ja sienestys) tarjoavat ainutlaatuisen kontekstin. Vedenkulutuksen ja energiankäytön laskeminen kertolaskulla yhdistää kesäteeman kestävään kehitykseen.',
      developmentalMilestones: [
        { milestone: 'Vesistöekosysteemien tieteellinen tutkiminen ravintoverkkojen kautta (8–9-vuotiaat analysoivat järjestelmiä)', howWeAddress: 'Ekosysteemiprojektit, joissa oppilas kartoittaa järven tai meren ravintoverkon, tunnistaa tuottajat, kuluttajat ja hajottajat ja selittää vuorovaikutussuhteet kirjallisesti' },
        { milestone: 'Kertolaskupohjainen matkasuunnittelu aikatauluineen ja budjetteineen (kolmannen luokan oppilaat hallitsevat monivaiheisen laskemisen)', howWeAddress: 'Matkasuunnitteluprojektit, joissa oppilas laskee etäisyyksiä, matka-aikoja, majoituskustannuksia ja ruokabudjetteja kertolaskuilla ja optimoi matkan rajoitteiden sisällä' },
        { milestone: 'Kesän ympäristöhaasteiden tutkiminen ja raportointi (kahdeksan- ja yhdeksänvuotiaat tutkivat sinilevää ja vesistöongelmia)', howWeAddress: 'Ympäristötutkimusprojektit, joissa oppilas tutkii sinilevän syitä ja seurauksia, kerää tietoa useista lähteistä ja kirjoittaa tutkimusraportin ratkaisuehdotuksineen' },
        { milestone: 'Vertaileva tutkimusraportti Suomen ja trooppisen kesän välillä (kolmannen luokan oppilaat viittaavat lähteisiin)', howWeAddress: 'Vertailuprojektit, joissa oppilas tutkii kesää eri ilmastovyöhykkeillä, kokoaa vertailutaulukon ja kirjoittaa jäsennellyn raportin lähdeviitteineen' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille rajaa ekosysteemi kolmeen elioon valmiilla ravintoketjupohjalla, anna matkasuunnitteluun valmiit laskukaavat ja tarjoa tutkimusraporttiin rakennepohja. Edistyneille kolmannen luokan oppilaille laajenna ravintoverkko kymmeneen lajiin vuorovaikutusanalyysineen, lisää vedenlaatumittauksia ja haasta suunnittelemaan kestävä lomanvietto ympäristövaikutusanalyyseineen.',
      parentTakeaway: 'Kolmannen luokan kesätyölehdet kehittävät ympäristötietoisuutta ja matemaattista suunnittelua. Suunnitelkaa yhdessä kesämatka: laskekaa kertolaskulla etäisyys, majoituskulut ja ruokabudjetti. Tutkikaa järvellä: millaisia eliöitä löytyy, miten ravintoketju toimii? Keskustelkaa sinilevästä: miksi sitä syntyy ja mitä sille voi tehdä? Tärkeintä on yhdistää kesän elämykset tieteelliseen tutkimiseen.',
      classroomIntegration: 'Kesätyölehdet integroituvat kolmannen luokan ympäristöoppiin, matematiikkaan ja äidinkieleen: vesistöekosysteemitutkimus biologian jaksossa, matkasuunnittelu kertolaskuprojektina, ympäristöhaasteiden tutkimus kestävän kehityksen jaksossa ja vertailurapportit tietokirjoittamisen jaksossa. POPS 2014:n vuosiluokkien 3–6 ekosysteemiajattelun, matemaattisen soveltamisen ja tutkivan oppimisen tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Vesistöekosysteemien tutkiminen', emerging: 'nimeää järven eliöitä mutta ei yhdistä ravintoverkkoon', proficient: 'mallintaa ravintoverkon tuottajista petokaloihin ja selittää vuorovaikutussuhteet', advanced: 'analysoi ravintoverkon häiriöitä ja ennustaa muutosten vaikutuksia ekosysteemiin perustellusti' },
        { skill: 'Kertolaskupohjainen matkasuunnittelu', emerging: 'laskee yhden kertolaskun mutta ei yhdistä useita eriä matkasuunnitelmaksi', proficient: 'laskee etäisyydet, kustannukset ja aikataulut kertolaskuilla ja optimoi matkan rajoitteiden sisällä', advanced: 'suunnittelee monimutkaisen matkan usean muuttujan kertolaskuilla ja perustelee optimaaliset valinnat analyyttisesti' },
        { skill: 'Ympäristöhaasteiden tutkimusraportti', emerging: 'tietää että sinilevä on ongelma mutta ei tutki syitä', proficient: 'tutkii ympäristöhaasteita useista lähteistä ja kirjoittaa raportin ratkaisuehdotuksineen', advanced: 'analysoi ympäristöongelmia monipuolisesti, yhdistää tieteellisen datan ja kirjalliset lähteet ja esittää perusteltuja ratkaisumalleja' },
      ],
    },
  },
