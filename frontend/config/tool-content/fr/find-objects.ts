...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'générateur de cherche et trouve gratuit',
    secondaryKeywords: [
      'créer des cherche et trouve gratuitement en ligne',
      'fiches objets cachés gratuit sans inscription',
      'générateur Je Vois Je Vois gratuit PDF',
      'cherche et trouve gratuit avec corrigé automatique',
    ],
    lsiKeywords: [
  ...
  hero: {
    title: 'Cherche et trouve gratuit — créez en ligne sans inscription',
