...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare byggeplass-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med byggeplasstema. Førskole til 3. klasse. Gratis PDF. Hent nå.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Bygging-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare bygging-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'byggeoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, STEM-læring, byggemaskiner, måling, byggeøvelser førskole, byggeriets læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Bygging-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare bygging-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'byggeoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, STEM-læring, byggemaskiner, måling, byggeøvelser barnehage, byggeriets læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Bygging-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare bygging-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'byggeoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, STEM-læring, byggemaskiner, måling, byggeøvelser 1. klasse, byggeriets læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Bygging-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare bygging-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'byggeoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, STEM-læring, byggemaskiner, måling, byggeøvelser 2. klasse, byggeriets læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Bygging-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare bygging-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'byggeoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, STEM-læring, byggemaskiner, måling, byggeøvelser 3. klasse, byggeriets læring 8-9 år',
