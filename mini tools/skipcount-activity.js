...
(function (global) {
  ...
  var L = {
    en: {
      ...
      nFill: 'Count the hops with Hopper: they go {s} at a time.',
      nStep: 'Look how much each number changes.',
      srBlank: 'blank',
    ...
    fr: {
      ...
      nFill: "Compte les bonds avec Hopper : ils vont de {s} en {s}.",
    ...
    es: {
      ...
      nFill: 'Cuenta los brincos con Hopper: siempre va de {s} en {s}.',
      nStep: 'Mira cuánto cambia cada número.',
    ...
    pt: {
      ...
      nFill: 'Conte os pulos com o Hopper: ele vai de {s} em {s}.',
      nStep: 'Veja quanto cada número muda.',
    ...
    it: {
      ...
      nFill: 'Conta i salti con Hopper: ogni salto è lungo {s}.',
      nStep: 'Guarda di quanto cambia ogni numero.',
    ...
    nl: {
      ...
      nFill: 'Tel de sprongen met Hopper: elke sprong is precies {s} groot.',
  ...
  var SkipCountActivity = {
    ...
    _injectStyle: function () {
      ...
      s.textContent = [
        ...
        '.sc-say{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;}',
        '.sc-hopper{flex:0 0 auto;}',
        '.sc-line-msg{flex:0 1 auto;min-height:1.1em;text-align:center;font:700 clamp(0.88rem,2.1vw,1.14rem)/1.3 Nunito,system-ui,sans-serif;color:#146B5E;margin:0;}',
