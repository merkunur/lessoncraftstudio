...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'vendre des fiches plus grand que moins que sur TPT',
    ...
    metaDescription:
      'Créez des fiches de comparaison de quantités à vendre sur Etsy, KDP et TPT. 3 modes de comparaison, 104 thèmes, corrigés, export 400+ DPI. Essai gratuit avec filigrane.',
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Ouvrez la Configuration des Exercices et sélectionnez l\'un des trois modes. Image contre Image présente deux groupes d\'images côte à côte que les élèves comptent et comparent. Image contre Nombre associe un groupe d\'images à un chiffre pour faire le pont entre le sens visuel et abstrait des nombres. Cocher et Barrer les Groupes remplit une boîte de deux types d\'images mélangées — les élèves cochent le groupe majoritaire et barrent le groupe minoritaire. Les modes standards supportent 1–8 exercices par page ; Cocher et Barrer supporte 1–3 exercices avec 8–20 images par boîte.',
      },
      {
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Choisissez entre les Symboles Illustrés — des versions colorées et graphiques des signes plus grand, plus petit et égal — et les Symboles Normaux qui utilisent les caractères textuels standards (>, <, =). Les symboles illustrés sont parfaits pour les jeunes apprenants qui bénéficient d\'indices visuels, tandis que les symboles normaux préparent les élèves à la notation mathématique conventionnelle.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Cliquez sur un bouton pour générer un corrigé complet qui reproduit la mise en page avec tous les symboles de comparaison corrects. L\'onglet corrigé affiche un aperçu en direct pour vérifier l\'exactitude. Exportez le corrigé en fichier JPEG ou PDF séparé pour les éditions enseignants ou les packs produits Etsy.',
      },
      {
        title: 'Export prêt à imprimer à 400+ DPI avec option niveaux de gris',
        description:
          'Téléchargez vos fiches et corrigés en JPEG haute résolution ou documents PDF prêts à imprimer. Le moteur d\'export rend à plus de 400 DPI. Activez le mode Niveaux de Gris pour convertir les fiches colorées en noir et blanc pour une impression économique en classe. Les formats Letter, A4, Carré et personnalisés sont tous pris en charge.',
      },
      {
  ...
  businessUseCases: {
    title: 'Comment Vendre des Fiches de Comparaison de Nombres en Ligne',
    cases: [
      {
        title: 'Packs thématiques de fiches de comparaison sur Etsy',
        description:
          'Créez des ensembles de 10 à 20 fiches de comparaison regroupées par thème — animaux de la ferme, dinosaures, vie marine, fêtes — et proposez-les en téléchargement instantané sur Etsy. Incluez les trois modes (Image contre Image, Image contre Nombre, Cocher et Barrer) plus les corrigés pour une ressource d\'apprentissage complète. Les packs thématiques de comparaison attirent les parents et enseignants qui cherchent des sujets spécifiques. Fixez les thèmes individuels à 3 €–5 € et les méga-packs variés à 12 €–18 €.',
      ...
      },
      {
        ...
        description:
          'Créez des ensembles à niveaux avec les trois modes comme paliers de difficulté naturels : Niveau 1 (Image contre Image avec Images Identiques), Niveau 2 (Image contre Nombre avec Images Différentes) et Niveau 3 (Cocher et Barrer les Groupes). Chaque niveau avec corrigés et fiche de suivi. Les acheteurs TPT paient des prix premium pour des ressources différenciées utilisables immédiatement dans plusieurs groupes de niveau.',
      ...
      {
        title: 'Pratique de comparaison pour la classe et le soutien scolaire',
        description:
          'Générez des fiches de comparaison personnalisées pour chaque niveau d\'élève. Imprimez des fiches Image contre Image avec Images Identiques pour les débutants et des fiches Cocher et Barrer pour les élèves avancés — tout dans la même session. Le corrigé automatique fait gagner du temps de correction. Que vous dirigiez un centre de soutien, enseigniez en grande section ou fassiez l\'école à la maison, le générateur remplace des heures de création manuelle.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Vous pouvez choisir entre les Symboles Illustrés (versions colorées et graphiques des signes plus grand, plus petit et égal) et les Symboles Normaux (caractères textuels standards >, <, =). Les symboles illustrés sont idéaux pour les jeunes apprenants. Vous pouvez aussi activer Afficher les Symboles à Entourer, ajoutant des symboles de comparaison que les élèves entourent.',
    },
    {
      question: 'Les fiches de comparaison sont-elles sensibles à la langue ?',
      answer:
        'Non. Les fiches Plus ou Moins sont purement visuelles — le contenu utilise des images et des nombres, pas des mots. Une fiche créée dans une langue fonctionne dans toutes les langues. Le paramètre de langue ne change que les libellés de l\'interface, rendant vos produits vendables dans le monde entier sans traduction.',
    },
    {
      question: 'Le générateur crée-t-il des corrigés automatiquement ?',
      answer:
        'Oui. Cliquez sur le bouton Générer le Corrigé pour créer une version complétée avec tous les symboles de comparaison corrects. Prévisualisez-le à l\'écran et téléchargez-le en fichier JPEG ou PDF séparé. Inclure des corrigés professionnels dans chaque fiche produit signale la qualité aux acheteurs des places de marché.',
    },
    {
      question: 'Puis-je exporter les fiches en niveaux de gris pour économiser l\'encre ?',
      answer:
        'Oui. Activez l\'option Niveaux de Gris dans le panneau Téléchargement pour convertir vos fiches colorées en noir et blanc avant l\'export. Parfait pour l\'impression en classe où vous souhaitez économiser l\'encre tout en offrant une pratique de comparaison de qualité. Les exports JPEG et PDF supportent le mode niveaux de gris.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'generateur-comparaison-quantites',
      anchorText: 'Créateur de Fiches de Comparaison',
    },
    {
      pageType: 'guide',
      slug: 'creer-fiches-comptage',
      anchorText: 'Comment Créer des Fiches de Comptage qui se Vendent',
    },
    {
      pageType: 'guide',
    ...
    sampleGallery: [
      {
        ...
        caption: 'Mode Image contre Image — les élèves comptent deux groupes d\'images et comparent les quantités',
      },
      {
      ...
      },
      {
        ...
        caption: 'Mode Cocher et Barrer — les élèves trouvent le groupe majoritaire dans une boîte d\'images mélangées',
      },
    ],
    youtubeId: 'eNguG63nYVs',
    videoTitle: 'Comment Créer des Fiches de Comparaison de Nombres — Tutoriel Étape par Étape',
  },
};
