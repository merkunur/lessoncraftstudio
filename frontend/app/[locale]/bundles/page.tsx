...
const bundlesContent: Record<string, {
  ...
  pt: {
    ...
    metaTitle: 'Pacotes com licença comercial | LCS',
    metaDescription: 'Pacotes de geradores com licença comercial por categoria. Matemática, leitura, visual, associação, puzzles e pesquisa. Para vender na Hotmart, Etsy e KDP.',
