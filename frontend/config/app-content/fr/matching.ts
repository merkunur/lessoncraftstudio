...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Fiches d\'Association | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Fiches d\'Association professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche d\'association image-mot avec liens à tracer',

    },
    sampleGallery: [
      { src: '/samples/english/matching/Matching 1.jpeg', alt: 'Exercice association illustré', caption: 'Association image-mot' },
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Fiches d\'Association thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Fiches d\'Association est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'matching', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Fiches d\'Association Gratuit' },
