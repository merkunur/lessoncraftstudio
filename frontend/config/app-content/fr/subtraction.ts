...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Générateur de soustraction | LessonCraftStudio',
  ...
  hero: {
    title: 'Générateur de soustraction — Créez des imprimables à vendre sur Etsy & KDP',
  ...
  ctaHeading: 'Créer des fiches de soustraction',
