...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Générateur de pièces manquantes | LessonCraftStudio',
  ...
  hero: {
    title: 'Générateur de pièces manquantes — Créez des imprimables à vendre sur Etsy & KDP',
  ...
  ctaHeading: 'Créer des puzzles à pièces manquantes',
