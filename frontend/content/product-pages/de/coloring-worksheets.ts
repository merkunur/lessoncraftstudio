...
Das Core Bundle für 144 € jährlich bietet unbegrenzten Zugang zu allen Bildern. Keine per-Bild-Gebühren oder Download-Limits. Neue Bilder werden regelmäßig hinzugefügt. Saisonale Kollektionen erscheinen vor jedem Feiertag. Kommerzielle Lizenz erlaubt Verkauf erstellter Malvorlagen auf Teachers Pay Teachers.`,
      ...
      },
      {
        id: '2',
        icon: '✏️',
        title: 'Vollständige Arbeitsflächen-Bearbeitung - Individuelle Ausmalbilder erstellen',
        description: `Jedes Element auf der Arbeitsfläche ist vollständig bearbeitbar für individuelle Malvorlagen. Verschiebe Bilder per Drag & Drop an beliebige Positionen. Ändere Größen durch Ziehen der Ecken mit proportionaler Skalierung. Drehe Elemente in jeden gewünschten Winkel für kreative Layouts.
...
Das Layout passt sich automatisch an gewählte Seitengröße an für Malvorlagen. Bilder skalieren proportional um Arbeitsfläche zu füllen. Rahmen passen sich an neue Dimensionen an. Professionelle Ergebnisse ohne manuelle Größenanpassung für Ausmalbilder.`,
        highlighted: false,
      },
      {
        id: '7',
...
Bildbasierte Malvorlagen funktionieren ohne Lesekompetenz bei Vorschul-Arbeitsblättern. Farbanweisungen verwenden Farbpunkte statt Wörter. Zählen funktioniert visuell. Frühe Erfolgserlebnisse bauen Selbstvertrauen auf. Das Core Bundle unterstützt mehrsprachige Klassenzimmer.`,
  ...
  faq: {
    ...
    items: [
      ...
      {
        id: '2',
        question: 'Kann ich Malvorlagen auf normalem Drucker drucken für kostenlose Arbeitsblätter Grundschule?',
        answer: 'Ja, alle Ausmalbilder drucken perfekt auf Standard-Schuldruckern. Die 300 DPI Auflösung garantiert scharfe Linien auf jedem Drucker. Farbdrucker produzieren lebendige Malvorlagen falls gewünscht. Schwarz-Weiß-Drucker funktionieren ideal für klassische Ausmalbilder. Aktivieren Sie den Schwarz-Weiß-Modus vor dem Herunterladen für Tintenersparnis. Konvertiert alle Bilder in reine Konturen, perfekt zum Ausmalen. Standard A4 und Letter Größen passen auf normale Drucker.',
      },
      {
        id: '3',
        question: 'Benötige ich Design-Kenntnisse für Malvorlagen und Arbeitsblätter Grundschule Erstellung?',
        answer: 'Nein, absolut keine Design-Erfahrung erforderlich. Der Generator ist speziell für Lehrkräfte ohne Designhintergrund entwickelt. Wählen Sie Bilder aus der Bibliothek oder laden Sie eigene hoch. Positionieren Sie Elemente per Drag & Drop. Klicken Sie Download für fertige Ausmalbilder. Alles ist visuell und intuitiv. Erstellen Sie professionelle Malvorlagen in drei einfachen Schritten. Kein Photoshop benötigt. Keine Grafiksoftware zu erlernen.',
      },
      {
        id: '4',
      ...
      {
        id: '7',
        question: 'Für welche Altersgruppen eignen sich Malvorlagen und Ausmalbilder?',
        answer: 'Malvorlagen funktionieren von Kindergarten bis 4. Klasse. Vorschulkinder (3-5 Jahre) nutzen große, einfache Formen. Kindergartenkinder (5-6 Jahre) arbeiten mit mehr Details. Grundschüler (6-10 Jahre) bewältigen komplexere Ausmalbilder. Passen Sie Bildkomplexität an jede Altersgruppe an. Kombinieren Sie mit altersgerechten Aktivitäten wie Schwungübungen oder Buchstaben lernen.',
      },
      {
        id: '8',
      ...
      {
        id: '11',
        question: 'Welche Dateiformate sind für den Download von Ausmalbildern verfügbar?',
        answer: 'Exportieren Sie Ihre Malvorlagen als PDF oder JPEG für Arbeitsblätter Grundschule. Beide Formate sind in 300 DPI Qualität für professionellen Druck. PDF eignet sich ideal für direkte Weitergabe und Druck von Ausmalbildern. JPEG ist perfekt für digitale Plattformen und Präsentationen. Schwarz-Weiß-Modus konvertiert Bilder in reine Konturen. Alle Downloads sind sofort druckbereit.',
      },
      {
        id: '12',
        question: 'Können mehrere Lehrkräfte ein Abonnement teilen für Arbeitsblätter?',
        answer: 'Jedes Abonnement ist für einen einzelnen Benutzer lizenziert. Schulen können jedoch Volumenlizenzen für mehrere Lehrkräfte erwerben. Kontaktieren Sie uns für Schulpreise und institutionelle Lizenzen. Jeder Benutzer erhält eigenen Zugang zu allen Generatoren. Hochgeladene Bilder und erstellte Malvorlagen bleiben privat pro Account.',
      },
    ],
  },
  ...
  relatedApps: {
    ...
    items: [
      ...
      },
      {
        ...
        icon: '🚂',
        description: 'Verbinden Sie Ausmalbilder mit Buchstaben lernen für ganzheitliche Literacy-Integration.',
      },
      {
        id: '3',
        slug: 'image-addition',
      ...
      },
      {
        ...
        icon: '🎨',
        description: 'Erweitern Sie Ausmalbilder mit Malen nach Zahlen für Zahlenverständnis und Farberkennung.',
      },
      {
        id: '5',
        slug: 'drawing-lines',
        ...
        category: 'Feinmotorik',
        icon: '📏',
        description: 'Kombinieren Sie Malvorlagen mit Linien-Übungen für motorische Entwicklung und Stiftkontrolle.',
      },
      {
        id: '6',
        slug: 'matching-app',
        ...
        icon: '🔗',
        description: 'Verbinden Sie Ausmalbilder mit Zuordnungsübungen für visuelles Lernen und Konzentration.',
      },
    ],
  },
};
