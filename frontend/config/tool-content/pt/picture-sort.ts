...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Ative a escala de cinzentos para versões económicas em tinta ideais para impressão na sala de aula e interiores de KDP. Descarregue os quatro ficheiros de uma só sessão: ficha JPEG, ficha PDF, gabarito JPEG e gabarito PDF — tudo renderizado a 300 DPI (multiplicador 6×, qualidade JPEG 1,0). Cada separador tem o seu próprio par de botões de descarga. Os ficheiros estão prontos para produção em listagens da Etsy, interiores da Amazon KDP e ficheiros de produtos do TPT sem necessidade de pós-processamento. Mude temas, ajuste o número de imagens ou alterne entre modos de tema e manual para criar rapidamente variedade no seu catálogo de fichas de classificação.',
      },
    ],
  },
  ...
  whatYouCanCreate: [
    {
      title: 'Pacotes Temáticos de Fichas de Classificação por Emparelhamento de Categorias',
      description: 'Crie pacotes de atividades de classificação organizados por emparelhamentos de categorias naturais usando as 104 coleções de imagens. Animais vs Alimentos, Terra vs Água, Frutas vs Legumes, Interior vs Exterior, Animais da Quinta vs Animais Selvagens, Artigos de Verão vs Artigos de Inverno — o seletor de categorias baseado em temas facilita a geração rápida de fichas com agrupamentos esquerda/direita bem diferenciados. Agrupe 15–20 fichas de classificação por pacote com gabaritos autogerados incluídos. Varie o número de imagens entre fichas para dificuldade progressiva: comece com 4–6 imagens para classificação simples e aumente até 10–12 imagens para desafios avançados de classificação. A grelha de recortes misturada garante que os alunos classifiquem ativamente cada imagem em vez de copiar um padrão.',
    },
    {
      title: 'Cadernos de Classificação para KDP com Dificuldade Progressiva',
      description: 'Compile 50–80 fichas de classificação em cadernos de atividades impressos para Amazon KDP. Estruture capítulos por dificuldade: os capítulos iniciais usam 4–6 imagens com diferenças óbvias entre categorias (animais vs veículos), os capítulos intermédios usam 8–10 imagens com distinções mais subtis (animais da quinta vs animais selvagens) e os capítulos avançados usam 12 imagens com categorias exigentes (comida saudável vs guloseimas). Inclua páginas de gabarito no final de cada capítulo usando o gabarito autogerado com imagens 6× maiores em caixas de categorias. Ative a escala de cinzentos para saída económica em tinta que se imprime perfeitamente a preto e branco. O formato de classificação a duas categorias funciona para todos os grupos etários desde a primeira infância até ao ensino básico.',
    },
    {
      title: 'Atividades de Classificação para Sala de Aula com Campos de Nome/Data',
      description: 'Construa fichas de classificação prontas para a sala de aula para centros de classificação, trabalho matinal e prática independente com campos de nome/data e gabaritos impressos. Crie conjuntos alinhados com o currículo: vivo vs não vivo para ciências, comida saudável vs não saudável para nutrição, animais diurnos vs noturnos para habitats, roupa de tempo quente vs frio para estações. O modo de tema gera fichas rapidamente para conjuntos em massa da sala de aula, enquanto o modo manual permite-lhe selecionar imagens específicas que correspondam aos objetivos da lição. O gabarito autogerado poupa tempo de preparação ao professor e torna possíveis estações de classificação com autocorreção.',
    },
    {
      title: 'Produtos de Classificação Multilingue para Mercados Internacionais',
      description: 'O Gerador de Classificação de Imagens é sensível ao idioma — as etiquetas de categoria utilizam nomes localizados de imagens da Biblioteca de Imagens, pelo que mudar de idioma atualiza o texto na ficha. Crie fichas de classificação em inglês, alemão, francês, espanhol, português, italiano, neerlandês, sueco, dinamarquês, norueguês e finlandês a partir das mesmas imagens sem reconstruir nada. O cabeçalho localizado de Classificação de Imagens também se traduz automaticamente. Venda pacotes de classificação em idiomas específicos dirigidos a lojas Etsy internacionais e compradores multilingues do TPT, ou crie atividades de classificação PLE onde as etiquetas bilingues de categoria reforçam a aquisição de vocabulário.',
    },
    {
      title: 'Fichas de Classificação com Fotografias Personalizadas',
      description: 'Use a função de Carregar Imagens Personalizadas para criar fichas de classificação com as suas próprias fotos ou ilustrações. Atividades de classificação familiares onde as crianças classificam fotos em categorias como «Pessoas» vs «Lugares», exercícios de classificação específicos da sala de aula usando fotos tiradas pelos alunos, atividades de classificação com marca para empresas educativas ou fichas personalizadas para educação especial com imagens familiares. O modo manual permite-lhe atribuir cada imagem carregada à categoria esquerda ou direita. Combinadas com o gabarito autogerado, as fichas de classificação com fotos personalizadas tornam-se produtos únicos e impossíveis de replicar pela concorrência.',
    },
    {
      title: 'Coleções de Classificação Sazonais e de Festividades',
      description: 'Construa coleções sazonais rotativas usando temas de festividades e natureza da biblioteca de 104 temas. Decorações de Natal vs comida de Natal, disfarces de Halloween vs doces de Halloween, atividades de verão vs atividades de inverno, flores de primavera vs folhas de outono — os emparelhamentos sazonais de categorias criam atividades de classificação naturais que pais e professores procuram ativamente. Lance cada coleção 4–6 semanas antes da festividade para máxima visibilidade no mercado. Inclua versões simples (4–6 imagens) e avançadas (10–12 imagens) em cada conjunto sazonal para máxima cobertura de faixa etária.',
    },
  ],
  ...
  businessIdeas: [
    ...
    {
      title: 'Pacotes de Atividades de Classificação para o TPT',
      description: 'Carregue pacotes de atividades de classificação no TPT com campos de nome/data, categorias alinhadas com o currículo e gabaritos autogerados como pontos de venda principais. Os professores que procuram atividades de classificação valorizam fichas que chegam prontas para a sala de aula com funcionalidades de responsabilidade do aluno. Crie conjuntos alinhados com o currículo: vivo vs não vivo para ciências, comida saudável vs não saudável para nutrição, ajudantes da comunidade vs animais para estudos sociais. Cada pacote inclui fichas do aluno com molduras de categoria e grelhas de recortes misturadas mais gabaritos com imagens classificadas nos grupos corretos. O modo manual permite-lhe selecionar as imagens exatas que correspondem a cada objetivo da lição.',
      platform: 'Teachers Pay Teachers',
    },
    {
      title: 'Funil de Tráfego com Fichas de Classificação no Pinterest',
      description: 'As fichas de classificação criam pins visualmente impactantes no Pinterest — o layout de duas categorias com molduras lado a lado e uma grelha de recortes misturada por baixo cria um formato educativo imediatamente reconhecível que pais e professores adoram. Publique fichas de amostra mostrando diferentes emparelhamentos de categorias: classificação de animais para quadros de pré-escolar, classificação de alimentos para quadros de nutrição e classificação sazonal para quadros de festividades. Crie séries de pins separadas para «fichas de classificação para pré-escolar», «atividades de classificação para jardim de infância» e «fichas de classificação de categorias imprimíveis». Ligue cada pin às suas listagens de produtos na Etsy ou no TPT.',
      platform: 'Pinterest',
    },
    {
      title: 'Kit Completo de Fichas de Classificação no Gumroad',
      description: 'Agrupe fichas de classificação dos 104 temas e ambos os modos de seleção num kit integral no Gumroad. Inclua mais de 400 fichas de classificação abrangendo cada emparelhamento principal de categorias da biblioteca de imagens, com gabaritos autogerados para cada uma. Misture fichas do modo de tema para variedade rápida com fichas do modo manual para alinhamento curricular preciso. Ofereça fichas em cada nível de dificuldade desde classificações simples de 4 imagens até exercícios avançados de 12 imagens. O formato de kit justifica preços premium porque os compradores obtêm uma biblioteca completa de atividades de classificação com gabaritos em vez de pacotes individuais.',
      platform: 'Gumroad',
    },
    {
      title: 'Produtos de Classificação Multilingue para Mercados Globais',
      description: 'O Gerador de Classificação de Imagens é sensível ao idioma — as etiquetas de categoria e o cabeçalho de Classificação de Imagens utilizam nomes localizados de imagens em 11 idiomas, facilitando a produção de fichas em inglês, alemão, francês, espanhol, português, italiano, neerlandês, sueco, dinamarquês, norueguês e finlandês a partir das mesmas imagens. Crie pacotes de classificação multilingue dirigidos a lojas Etsy internacionais, compradores bilingues do TPT e salas de aula de PLE em todo o mundo. Venda o mesmo conjunto temático em múltiplas versões de idioma sem redesenho — simplesmente mude o idioma e regenere. Os pacotes multilingues conseguem preços premium e alcançam compradores que os concorrentes monolingues não conseguem atingir.',
      platform: 'Etsy / TPT',
    },
  ],
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'O modo manual permite-lhe selecionar imagens individualmente e atribuir cada uma à categoria esquerda ou direita. Isto é essencial para criar atividades de classificação específicas do currículo onde as imagens exatas importam — selecione apenas os animais de um habitat específico, apenas os alimentos de uma unidade de nutrição ou apenas os objetos relevantes para uma lição de ciências. As fichas do modo manual conseguem preços mais altos no TPT porque demonstram alinhamento curricular intencional em vez de seleção aleatória de temas.',
    },
    {
      title: 'Varie o Número de Imagens para Produtos de Dificuldade Progressiva',
      description: 'O número configurável de imagens de 4 a 12 é a sua ferramenta de escalamento de dificuldade. Crie pacotes com dificuldade progressiva: comece com fichas de 4 imagens onde as categorias são óbvias e o exercício de classificação é simples, depois progrida para fichas de 8 imagens com mais elementos a classificar, e termine com fichas avançadas de 12 imagens onde os alunos devem ordenar muitos elementos em duas categorias. Os pacotes de dificuldade progressiva servem a faixa etária mais ampla e justificam preços premium porque os compradores obtêm conteúdo para múltiplos níveis num só produto.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'O gerador oferece modo de tema e modo manual. O modo de tema permite-lhe escolher um tema para a categoria esquerda e outro tema para a categoria direita — a aplicação seleciona automaticamente 4–6 imagens aleatórias por tema a partir da biblioteca de imagens, criando fichas com 8–12 imagens no total. O modo manual dá-lhe controlo total: selecione imagens individualmente de qualquer tema e atribua cada uma à categoria esquerda ou direita. O modo de tema é mais rápido para produção em massa; o modo manual é ideal para criar atividades de classificação específicas e alinhadas com o currículo com seleção precisa de imagens.',
    },
    {
      question: 'Como funciona o layout de classificação a duas categorias?',
      answer: 'Cada ficha de classificação tem exatamente duas categorias — esquerda e direita. A ficha apresenta duas molduras de categoria com borda tracejada na parte superior com preenchimento #FAFAFA onde os alunos classificam as suas imagens, e uma grelha de recortes misturada por baixo com todas as imagens misturadas em células brancas com bordas tracejadas #666 e cantos arredondados de 4px. As imagens aparecem em ordem aleatória em 3–4 colunas, cada uma ocupando 85% da sua célula. Os alunos recortam as imagens da grelha e colocam cada uma na moldura de categoria correta. O formato de classificação binária funciona para qualquer emparelhamento de temas.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sim. Marque a caixa «Incluir Campos de Nome/Data» no painel de Configuração de Página para adicionar linhas de nome e data à ficha. Estes campos asseguram a responsabilidade do aluno em sala de aula e tornam as suas fichas de classificação prontas para recolha e avaliação sem qualquer preparação adicional. Os campos de nome/data são um ponto de venda principal para produtos de sala de aula no TPT onde os professores esperam fichas que cheguem prontas para usar.',
    },
    {
      question: 'Que tamanhos de página e formatos de exportação estão disponíveis?',
      answer: 'Os tamanhos de página incluem Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) e dimensões personalizadas. Exporte como JPEG de alta resolução ou PDF pronto para impressão a 300 DPI (multiplicador 6×, qualidade JPEG 1,0). Ative a escala de cinzentos para saída económica em tinta. Cada geração produz quatro ficheiros de descarga: ficha JPEG, ficha PDF, gabarito JPEG e gabarito PDF. Todas as exportações estão prontas para produção em descargas digitais, cadernos de atividades impressos e fichas para a sala de aula.',
    },
    {
      question: 'Posso vender fichas de classificação criadas com esta ferramenta para fins comerciais?',
      answer: 'Sim. Com uma licença comercial, tem todos os direitos para vender fichas de classificação como descargas digitais na Etsy, cadernos de atividades impressos na Amazon KDP, recursos para a sala de aula no TPT ou através de qualquer outro canal de venda. Os dois modos de seleção, o número configurável de imagens, os gabaritos autogerados com imagens 6× maiores, as etiquetas de categoria sensíveis ao idioma, o carregamento de imagens personalizadas e as 104 coleções temáticas de imagens dão-lhe tudo o necessário para criar produtos profissionais de classificação que competem em categorias de atividades de classificação em todos os principais mercados.',
    },
    {
  ...
  visuals: {
    ...
    videoTitle: 'Como Criar Fichas de Classificação a Duas Categorias com Modos de Tema e Manual, Grelhas de Recortes Misturadas e Gabaritos Automáticos — Tutorial Passo a Passo',
  },
};
