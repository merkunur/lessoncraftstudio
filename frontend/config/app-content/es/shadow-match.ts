    ...
    steps: [
      {
        ...
        description:
          'Abre el panel de Configuración de Página y elige un tamaño de página: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Cuadrado (1200×1200) o cualquier dimensión personalizada. Selecciona un color de fondo predeterminado con el selector de color. Elige un tema de fondo y ajusta su opacidad (de 0 a 1 en pasos de 0,05), luego elige un tema de borde con su propio control de opacidad independiente. Estas opciones de diseño enmarcan tu ficha de asociación de sombras antes de configurar el contenido.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Abre el panel de Biblioteca de Imágenes y explora 104 colecciones temáticas con más de 3100 ilustraciones coloridas — animales, comida, vehículos, naturaleza, fiestas y muchas más. Filtra por tema con el menú desplegable o busca por palabra clave con retardo de 300 ms. Haz clic en las imágenes para seleccionarlas — el contador muestra tu progreso hacia las 4 imágenes requeridas. Una vista previa de las imágenes seleccionadas confirma tus elecciones antes de generar. También puedes subir imágenes personalizadas PNG, JPG o GIF a través del panel Subir Imágenes Personalizadas.',
      },
      {
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          'Combina ambos modos de ejercicio en packs de puzzles multi-modo premium que demuestran la versatilidad del generador. Cada pack incluye fichas de Asociación de Sombras (reconocimiento de siluetas), fichas de Completa la Imagen con cortes horizontales (reensamblaje arriba/abajo) y fichas de Completa la Imagen con cortes verticales (reensamblaje izquierda/derecha) — tres tipos de actividades distintos a partir de un mismo conjunto de imágenes temáticas. Este enfoque tres-en-uno justifica precios premium de $7–$12 por pack. Las claves de respuesta para cada ficha se incluyen automáticamente, añadiendo un acabado profesional que aumenta el valor percibido.',
