...
/**
 * Criptograma com Imagens (Image Cryptogram) - Brazilian Portuguese Content
 *
 * File: frontend/content/product-pages/pt/criptograma-imagens-fichas.ts
 * URL: /pt/apps/criptograma-imagens-fichas
 *
 * FULL SEO content from: INDIVIDUAL APP PAGES/Portuguese/cryptogram.md
 * DO NOT SHORTEN - Every paragraph is SEO-optimized
 *
 * PRICING: Full Access ($240/year = R$1.200/ano)
 */

export const cryptogramPtContent: ProductPageContent = {
  // SEO Metadata
  seo: {
...
O gerador de criptograma oferece recursos exclusivos para educadores. Você escolhe quantas letras revelar como pistas. Isso permite ajustar a dificuldade conforme a idade dos alunos. Crianças da educação infantil podem ter mais letras reveladas. Alunos do 1º ano e 2º ano recebem menos pistas para um desafio maior. A personalização é simples e rápida no painel lateral.`,
    ...
    steps: [
      {
        id: '1',
        number: 1,
        title: 'Digite sua Frase',
        description: `O primeiro passo é escolher o conteúdo do seu criptograma. Acesse o painel "Regras do Quebra-Cabeça" na barra lateral. Digite a frase ou palavra que deseja transformar em código. Pode ser uma mensagem motivacional para atividades educação infantil. Pode ser vocabulário de atividades de alfabetização. Use frases curtas para alunos iniciantes. Frases mais longas funcionam para turmas avançadas. Cada linha de texto aparece separadamente no quebra-cabeça.`,
        icon: '📝',
      },
      {
        id: '2',
        number: 2,
        title: 'Configure a Dificuldade',
        description: `Ajuste o nível de dificuldade conforme sua turma. O seletor "Letras para Revelar" define quantas pistas aparecem. Escolha de 0 a 10 letras reveladas. Para atividades 1º ano escolha 5 a 7 letras reveladas. Para atividades 2º ano reduza para 2 a 4 letras. Alunos mais experientes podem ter zero letras reveladas. O campo "Máximo de Linhas" controla o tamanho do quebra-cabeça. Valores entre 1 e 8 linhas estão disponíveis. Ajuste conforme o espaço disponível na página.`,
        icon: '⚙️',
      },
      {
        id: '3',
        ...
        description: `Agora você associa imagens a cada letra do alfabeto. A opção "Atribuir automaticamente" faz isso instantaneamente. O sistema escolhe imagens apropriadas de todos os temas. Para controle manual selecione um tema específico. Clique em uma letra no painel de letras. Depois clique na imagem desejada para atribuí-la. As atividades vogais ganham vida com imagens coloridas. O processo desenvolve coordenação motora visual nas crianças. Suas imagens enviadas também podem ser atribuídas.`,
        icon: '🖼️',
      },
      {
        id: '4',
        ...
        description: `Clique no botão "Criar" para gerar seu criptograma. O sistema processa sua frase e imagens instantaneamente. A aba "Atividade" mostra o quebra-cabeça com letras parcialmente reveladas. A aba "Gabarito" mostra todas as respostas. O layout inclui cabeçalho decorativo em roxo e dourado. A legenda inferior mostra todas as imagens e letras correspondentes. Combine seu criptograma com desenhos para colorir na mesma página. Adicione elementos de atividades de matemática para pacotes completos.`,
        icon: '✨',
      },
      {
        id: '5',
        number: 5,
        title: 'Baixe em PDF',
        description: `O download oferece múltiplas opções de formato. Clique em "Download" para ver as opções. Baixe a atividade em JPEG para uso digital. Baixe em PDF para impressão profissional. O gabarito pode ser baixado separadamente. A opção "Escala de Cinza" economiza tinta colorida. Todas as atividades de alfabetização exportam em 300 DPI. A qualidade atende padrões comerciais de impressão. Seus arquivos ficam prontos para distribuir aos alunos.`,
        icon: '📥',
      },
    ],
  },
  ...
  useCases: {
    ...
    items: [
      ...
      },
      {
        ...
        subtitle: 'Tabuada e Atividades de Matemática em Criptogramas',
      ...
      },
      {
        ...
        subtitle: 'Atividades para Imprimir de Alfabetização Domiciliar',
  ...
  faq: {
    ...
    items: [
      {
        id: '1',
        question: 'Como funciona o gerador de criptograma para atividades 1º ano e 2º ano?',
      ...
      {
        id: '2',
        question: 'Quais formatos posso baixar para atividades de matemática e tabuada?',
      ...
      {
        id: '3',
        question: 'Posso vender atividades de coordenação motora criadas no gerador?',
      ...
      {
        id: '4',
        question: 'Quais idiomas são suportados para desenhos para colorir e criptogramas?',
      ...
      {
        id: '5',
        question: 'Quantas atividades de tabuada posso criar por mês?',
      ...
      {
        id: '6',
        question: 'O gabarito está incluído para atividades de coordenação motora?',
      ...
      {
        id: '7',
        question: 'Posso usar minhas próprias imagens para pontilhado e letra cursiva?',
      ...
      {
        id: '8',
        question: 'Quais tamanhos de página são suportados para atividades 1º ano?',
      ...
      {
        id: '9',
        question: 'Como personalizo desenhos para colorir nos criptogramas?',
      ...
      {
        id: '10',
        question: 'A plataforma oferece atividades de matemática além de criptogramas?',
      ...
      {
        id: '11',
        question: 'Como desenvolvo coordenação motora com criptogramas?',
      ...
      {
        id: '12',
        question: 'Quanto tempo leva para criar um criptograma?',
...
export default cryptogramPtContent;
