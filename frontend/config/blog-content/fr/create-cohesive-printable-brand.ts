...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'La cohérence visuelle crée la reconnaissance',
    description: 'Construisez une identité visuelle cohérente pour vos imprimables. Couleurs, polices et style unifié. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour créer marque imprimables cohérente. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
