...
const content: AppContent = {
  seo: {
    primaryKeyword: 'skyggematching generator',
    secondaryKeywords: [
      'utskriftsbar silhuettmatching aktivitet generator til Etsy-selgere',
      'bildeskygge puslespill arbeidsark generator til KDP',
      'skyggematching arbeidsark generator kommersiell lisens',
      'selg skyggematching arbeidsark på Gumroad',
    ],
    lsiKeywords: [
      'digitale silhuettmatchings utskriftsbare nettbasert forretning',
      'kommersielt bruk skyggepuslespill arbeidsark generator',
  ...
  hero: {
    title: 'Skyggematching Arbeidsark Generator for Silhuett- og Delt-Bilde Matchingsaktiviteter',
