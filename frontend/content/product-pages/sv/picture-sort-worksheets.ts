...
export const pictureSortSvContent: ProductPageContent = {
  ...
  hero: {
    ...
    description: `Skapa professionella sorteringsaktiviteter för barn med vår bildsorteringsgenerator. Din Full Access-prenumeration ger dig obegränsad skapande av arbetsblad utan extra avgifter per arbetsblad. Generera anpassade utskrivbara sorteringsövningar perfekta för förskoleklass material och matematik arbetsblad övningar. Ladda ner högkvalitativa PDF-arbetsblad på under 3 minuter.
...
Använd sorteringsarbetsblad för förskoleklass material och lågstadiet. Kombinera med målarbilder barn för komplett inlärningspaket. Skapa arbetsblad gratis utan begränsning med din prenumeration. Full Access inkluderar kommersiell licens för att sälja dina arbetsblad på Teachers Pay Teachers eller Etsy.`,
    ...
    items: [
      {
        ...
        answer: 'Bildsorteringsgeneratorn kräver Full Access-prenumeration som kostar 2 900 kr årligen eller 300 kr månadsligan. Din prenumeration ger dig obegränsad skapande av sorteringsarbetsblad utan extra avgifter per arbetsblad. Generera så många förskoleklass material och matematik arbetsblad du behöver utan ytterligare kostnader. Full Access inkluderar Core Bundle med 10 populära generatorer plus 23 ytterligare verktyg. Full Access kostar 2 900 kr årligen och inkluderar alla 33 arbetsbladsgeneratortyper. Prenumerationen inkluderar kommersiell licensiering, 11 språkstöd och professionell 300 DPI-kvalitetsexport. Skapa arbetsblad gratis från per-arbetsblad avgifter med din prenumeration.',
      },
      {
        id: '2',
