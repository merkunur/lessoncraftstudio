...
**Version:** 3.7 (adds §23 Premium Tools v4 — the current active thrust — and its companion; corrects the §21.5 new-tool sync points, which omitted the `live-tool-slugs.ts` 410 trap; re-marks the §20.9 German fan-out as a paused backlog) **Last updated:** 2026-07-31
