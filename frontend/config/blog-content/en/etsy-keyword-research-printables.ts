...
const content: BlogContent = {
  seo: {
    ...
    secondaryKeywords: [
      'etsy keyword research printable sellers',
      'find printable keywords etsy',
      'etsy seo keywords worksheets',
    ],
    lsiKeywords: [
      'etsy search algorithm printables',
  ...
  cta: {
    heading: 'Create Products for Your Best Keywords',
    description: 'Once you find profitable keywords, generate matching worksheet products in minutes. Try the generators free with watermark.',
    buttonText: 'Start Creating Products',
    buttonUrl: '/apps',
  },
};
