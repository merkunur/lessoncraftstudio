...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'fiche graphique à images',
    secondaryKeywords: [
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Dans la section Mise en Page, sélectionnez votre format de page : Letter Portrait, Letter Paysage, A4 Portrait, A4 Paysage, Carré (1200×1200) ou entrez une dimension personnalisée. Choisissez une couleur de fond — le blanc est la valeur par défaut pour des fiches épurées. Sélectionnez un thème de fond décoratif et un thème de bordure depuis la bibliothèque intégrée, chacun avec un curseur d\'opacité indépendant (0–1, pas de 0,05). Les thèmes de fond et de bordure fonctionnent de manière indépendante, vous pouvez associer un fond aquarelle subtil avec une bordure décorative prononcée ou toute combinaison adaptée à votre style de produit.',
      },
      {
      ...
      },
      {
        ...
        description: 'Utilisez le panneau Outils Texte pour ajouter des titres, étiquettes ou consignes avec sept choix de polices : Lexend Deca, Baloo 2, Nunito, Quicksand, Fredoka, Arial et Verdana. Ajustez le contour de texte de 0 à 10 avec une granularité de 0,5 pour des titres lisibles. Glissez, redimensionnez, pivotez et repositionnez chaque élément sur le canevas Fabric.js. Utilisez les contrôles de calques pour gérer l\'ordre d\'empilement, verrouillez les éléments terminés et zoomez de 25 % à 300 % pour un placement précis. Annulez et rétablissez jusqu\'à 20 états d\'historique avec Ctrl+Z et Ctrl+Y.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Construisez des collections saisonnières rotatives en utilisant les thèmes de fêtes et de nature parmi les 104 collections de la bibliothèque. Décorations de Noël, icônes d\'Halloween, objets de Pâques, cœurs de Saint-Valentin, fournitures de rentrée, activités d\'été et paysages d\'hiver soutiennent chacun des packs de graphiques à images dédiés. Lancez chaque collection 4 à 6 semaines avant la fête pour une visibilité maximale sur les places de marché. La grille d\'images dispersées avec distribution aléatoire crée des fiches uniques à chaque génération, donc les packs saisonniers ne semblent jamais répétitifs. Les produits saisonniers génèrent un revenu annuel récurrent car les acheteurs reviennent chaque année.',
    },
    {
  ...
  businessIdeas: [
    ...
    {
      title: 'Série de Cahiers de Compétences en Données pour Amazon KDP',
      description: 'Compilez 80+ fiches graphique à images dans des cahiers thématiques pour Amazon KDP. Structurez une série par sujet : « Graphiques de Comptage d\'Animaux » couvre les thèmes ferme, océan, jungle et animaux domestiques. « Graphiques de Données du Quotidien » couvre nourriture, véhicules, métiers et objets du foyer. Incluez les pages corrigés à la fin de chaque chapitre. Activez les niveaux de gris pour une sortie économique en encre qui s\'imprime parfaitement en noir et blanc. Le format de comptage visuel avec des nombres et images universels se publie de manière identique sur toutes les places de marché KDP internationales sans traduction — un seul intérieur dessert tous les pays.',
      platform: 'Amazon KDP',
    },
    {
    ...
    {
      title: 'Kit Complet de Graphiques sur Gumroad',
      description: 'Regroupez des fiches graphique à images couvrant les 104 thèmes dans un kit complet de graphiques sur Gumroad. Incluez plus de 200 fiches couvrant tous les thèmes majeurs, chacune avec son corrigé auto-généré — plus de 400 fichiers au total. Le format kit justifie un prix premium car les acheteurs obtiennent une bibliothèque complète plutôt que des packs individuels. Ajoutez de nouvelles collections saisonnières chaque trimestre pour stimuler les rachats. Le flux de quatre fichiers par session (fiche JPEG, fiche PDF, corrigé JPEG, corrigé PDF) rend la construction du kit entier efficace et systématique.',
      platform: 'Gumroad',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'La grille 4×5 d\'images dispersées distribue aléatoirement 20 icônes de 6 types avec chaque type apparaissant 1 à 5 fois. Chaque clic sur Générer produit un défi de comptage différent même avec les mêmes 6 images sélectionnées. Utilisez cela pour créer rapidement de grands lots de fiches où aucune page n\'est identique. Générez 15 à 20 fiches par thème en quelques minutes, chacune avec sa propre distribution unique et son corrigé correspondant.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Le Générateur de Graphique à Images offre des thèmes de fond et des thèmes de bordure depuis la bibliothèque intégrée, chacun avec un curseur d\'opacité indépendant (0–1, pas de 0,05). Définissez un fond aquarelle subtil à 20 % d\'opacité tout en conservant une bordure décorative prononcée à pleine opacité, ou toute combinaison que vous préférez. Les thèmes de fond remplissent la zone de page derrière la grille d\'images et le graphique, tandis que les thèmes de bordure encadrent le bord extérieur. Ensemble, ils ajoutent une finition visuelle et augmentent la valeur perçue pour les listings de places de marché sans interférer avec le contenu de la fiche.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Oui. Téléversez des images PNG, JPG ou GIF personnalisées à l\'aide du bouton d\'importation dans le panneau Bibliothèque d\'Images. Vos images téléversées deviennent des objets de canevas entièrement déplaçables et redimensionnables sur la surface d\'édition Fabric.js. Combinez vos propres créations avec les illustrations de la bibliothèque pour une flexibilité créative maximale. Les images personnalisées sont particulièrement utiles pour des graphiques à images spécifiques à un sujet, du contenu éducatif de marque et des thèmes de niche non couverts par la bibliothèque intégrée.',
    },
    {
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche graphique à images avec grille 4×5 d\'images dispersées montrant 20 icônes de 6 types et diagramme à barres vide pour compter et représenter les données',
    },
    sampleGallery: [
      {
        src: '/samples/french/chart count/Graphique Images 1.webp',
        alt: 'Fiche graphique à images thème animaux avec 20 icônes animaux dispersées dans une grille 4×5 et diagramme à barres de 6 colonnes en dessous pour la pratique du comptage',
    ...
    videoTitle: 'Comment Créer des Fiches Graphique à Images avec Corrigés Automatiques, Grilles d\'Images Dispersées et 104 Collections Thématiques — Tutoriel Étape par Étape',
  },
};
