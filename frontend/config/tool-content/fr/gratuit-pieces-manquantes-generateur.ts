...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit Pièces Manquantes | PDF Imprimables',
    metaDescription: 'Créez des fiches de pièces manquantes gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit pièces manquantes',
    secondaryKeywords: ["puzzle pièce manquante gratuit","fiches pièces manquantes PDF","trouver morceau manquant exercice","puzzle visuel enfants gratuit","perception visuelle exercice"],
    lsiKeywords: ["puzzle","complétion","observation","spatial","attention","analyse","reconstruction","logique visuelle"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/missing pieces/Missing Pieces 1.jpeg',
      primaryAlt: 'Puzzle pièces manquantes gratuit',
    },
    sampleGallery: [
      { src: '/samples/english/missing pieces/Missing Pieces 1.jpeg', alt: 'Pièces manquantes', caption: 'Trouver la pièce' }
    ],
    youtubeId: 'VXGKFQRT2rA',
    videoTitle: 'Comment créer des fiches de pièces manquantes gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit Pièces Manquantes',
    tagline: 'Créez des fiches de pièces manquantes et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de pièces manquantes transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de pièces manquantes autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de pièces manquantes en 10 étapes',
    steps: [
  ...
  faq: [
    { question: 'Ce générateur de pièces manquantes est-il vraiment gratuit ?', answer: 'Oui. La version gratuite inclut toutes les fonctionnalités — tous les modes, les 104 thèmes, l\'export PDF et les corrigés. La seule différence est un petit filigrane sur les fichiers exportés. Utilisez la version gratuite indéfiniment sans créer de compte.' },
  ...
  internalLinks: [
    { slug: 'gratuit-pieces-manquantes-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit Pièces Manquantes' },
    { slug: 'missing-pieces', pageType: 'app' as const, anchorText: 'Générateur Pièces Manquantes — Détails complets' },
  ],
};
