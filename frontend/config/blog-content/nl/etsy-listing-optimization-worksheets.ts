...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Elke listing is een verkoopkans die geoptimaliseerd moet worden',
    description: 'Elke listing is een verkoopkans die geoptimaliseerd moet worden. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
