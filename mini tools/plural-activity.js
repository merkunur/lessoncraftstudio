  ...
  var PluralActivity = {
    ...
    _injectStyle: function () {
      ...
      s.textContent = [
        ...
        '.pl-say{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;}',
        '.pl-pearl{flex:0 0 auto;}',
        '.pl-line-msg{flex:0 1 auto;min-height:1.1em;text-align:center;font:700 clamp(.88rem,2.1vw,1.15rem)/1.3 Nunito,system-ui,sans-serif;color:#146B5E;margin:0;}',
        '.pl-line-msg.miss{color:#2A3A36;}',
        ...
        '.pl-cand{display:flex;align-items:center;justify-content:center;text-align:center;padding:12px 20px;border:3px solid #146B5E;border-radius:14px;background:#fff;cursor:pointer;min-height:52px;min-width:104px;font:800 clamp(1.05rem,3.4vw,1.6rem)/1.1 "Baloo 2",Nunito,system-ui,sans-serif;color:#0F4A40;}',
        '.pl-cand.dim{opacity:.4;}',
        '.pl-cand.lit{box-shadow:0 0 0 3px #F2C14E;background:#FFFBEF;}',
        '.pl-pearl-svg{width:clamp(36px,5.2vw,52px);height:auto;}'
