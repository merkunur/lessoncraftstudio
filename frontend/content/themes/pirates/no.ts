...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare pirater-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med piratertema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Pirater-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare pirater-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'piratoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, skattejakt, kartlesing, sjøeventyr, piratøvelser førskole, piratenes læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Pirater-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare pirater-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'piratoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, skattejakt, kartlesing, sjøeventyr, piratøvelser barnehage, piratenes læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Pirater-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare pirater-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'piratoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, skattejakt, kartlesing, sjøeventyr, piratøvelser 1. klasse, piratenes læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Pirater-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare pirater-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'piratoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, skattejakt, kartlesing, sjøeventyr, piratøvelser 2. klasse, piratenes læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Pirater-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare pirater-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'piratoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, skattejakt, kartlesing, sjøeventyr, piratøvelser 3. klasse, piratenes læring 8-9 år',
