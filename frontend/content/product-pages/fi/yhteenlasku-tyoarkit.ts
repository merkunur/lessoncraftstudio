...
Kuva-kuva -tila näyttää yhteenlaskut pelkillä kuvilla. Kuva-numero -tila yhdistää kuvat numeroihin. Puuttuva yhteenlaskettava -tila opettaa käänteistä ajattelua. Sekoitettu tila tarjoaa vaihtelua yhdessä työarkissa. Jokainen tila tukee erilaista oppimistyyliä ja kehitysvaihetta.`,
  ...
  samples: {
    ...
    items: [
      {
        id: '1',
        worksheetSrc: '/samples/finnish/addition/sample-1.jpeg',
        answerKeySrc: '/samples/finnish/addition/sample-1-answer.jpeg',
        altText: 'Yhteenlaskutehtävä pystysuunnassa kuva-kuva tilassa esiopetukseen',
        pdfDownloadUrl: '/samples/finnish/addition/sample-1.pdf',
      },
      {
        id: '2',
        worksheetSrc: '/samples/finnish/addition/sample-2.jpeg',
        answerKeySrc: '/samples/finnish/addition/sample-2-answer.jpeg',
        altText: 'Yhteenlaskutehtävä vaakasuunnassa värikkäillä kuvilla alakoululaisille',
        pdfDownloadUrl: '/samples/finnish/addition/sample-2.pdf',
      },
      {
        id: '3',
        worksheetSrc: '/samples/finnish/addition/sample-3.jpeg',
        answerKeySrc: '/samples/finnish/addition/sample-3-answer.jpeg',
        altText: 'Kuva ja numero -tila yhteenlaskutehtävä numeroiden tunnistamiseen',
        pdfDownloadUrl: '/samples/finnish/addition/sample-3.pdf',
      },
      {
        id: '4',
        worksheetSrc: '/samples/finnish/addition/sample-4.jpeg',
        answerKeySrc: '/samples/finnish/addition/sample-4-answer.jpeg',
        altText: 'Puuttuva yhteenlaskettava -tehtävä käänteisen ajattelun harjoitteluun',
        pdfDownloadUrl: '/samples/finnish/addition/sample-4.pdf',
      },
      {
        id: '5',
        worksheetSrc: '/samples/finnish/addition/sample-5.jpeg',
        answerKeySrc: '/samples/finnish/addition/sample-5-answer.jpeg',
        altText: 'Sekoitettu tila yhteenlaskutehtävä monipuoliseen harjoitteluun',
        pdfDownloadUrl: '/samples/finnish/addition/sample-5.pdf',
      },
    ],
  },
