...
export const picturePathItContent: ProductPageContent = {
  ...
  seo: {
    ...
    appId: 'picture-path',
    title: 'Schede Gratuite Percorso Illustrato | Generatore Schede per Bambini',
  ...
  // Hero Section
  hero: {
    title: 'Schede Gratuite Percorso Illustrato - Stampabili Gratuiti per Bambini',
...
Ogni modalità di gioco ti permette di creare schede didattiche completamente personalizzate. Scegli le immagini dalla nostra biblioteca di oltre 3000 immagini. Carica le tue immagini personali per schede didattiche tematiche. Modifica dimensioni della griglia, colori, e ogni elemento visivo. Perfetto per insegnanti che creano schede didattiche scuola dell'infanzia personalizzate.`,
    previewImageSrc: '/samples/italian/picture-path/sample-1.jpeg',
    ctaLabels: {
  ...
  samples: {
    ...
    items: [
      {
        id: '1',
        worksheetSrc: '/samples/italian/picture-path/sample-1.jpeg',
        answerKeySrc: '/samples/italian/picture-path/sample-1-answer.jpeg',
        altText: 'Scheda gratuita percorso illustrato - stampabili gratuiti per scuola dell\'infanzia',
        pdfDownloadUrl: '/samples/italian/picture-path/sample-1.pdf',
      },
      {
        id: '2',
        worksheetSrc: '/samples/italian/picture-path/sample-2.jpeg',
        answerKeySrc: '/samples/italian/picture-path/sample-2-answer.jpeg',
        altText: 'Schede gratuite labirinto classico - scheda per bambini attività logica',
        pdfDownloadUrl: '/samples/italian/picture-path/sample-2.pdf',
      },
      {
        id: '3',
        worksheetSrc: '/samples/italian/picture-path/sample-3.jpeg',
        answerKeySrc: '/samples/italian/picture-path/sample-3-answer.jpeg',
        altText: 'Stampabili gratuiti percorso giusto - scheda gratuita per scuola primaria',
        pdfDownloadUrl: '/samples/italian/picture-path/sample-3.pdf',
      },
      {
        id: '4',
        worksheetSrc: '/samples/italian/picture-path/sample-4.jpeg',
        answerKeySrc: '/samples/italian/picture-path/sample-4-answer.jpeg',
        altText: 'Scheda per bambini labirinti - schede gratuite pregrafismo logica',
        pdfDownloadUrl: '/samples/italian/picture-path/sample-4.pdf',
      },
      {
        id: '5',
        worksheetSrc: '/samples/italian/picture-path/sample-5.jpeg',
        answerKeySrc: '/samples/italian/picture-path/sample-5-answer.jpeg',
        altText: 'Schede gratuite percorsi - scheda gratuita per bambini coordinazione',
        pdfDownloadUrl: '/samples/italian/picture-path/sample-5.pdf',
      },
    ],
  },
