...
/* ═══════════════════════════════════════════════════════
   FAQ ACCORDION — indigo palette (same as FE page)
   ═══════════════════════════════════════════════════════ */
...
export default function MathPuzzleOTOClient({ config, locale }: Props) {
    ...
    <>
      ...
      <section className="mp-sans relative overflow-hidden bg-indigo-950 py-16 md:py-24 lg:py-28">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-indigo-200/80 leading-relaxed mb-10 max-w-2xl mx-auto">
        ...
        <section className="mp-sans py-20 md:py-28 bg-white">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {/* Upgrade (full) */}
              <div className="rounded-2xl p-6 bg-gradient-to-br from-indigo-50 to-violet-50 border-2 border-indigo-200">
                <h3 className="text-base font-bold text-indigo-700 mb-5 flex items-center gap-2">
      ...
      <section className="mp-sans py-20 md:py-28 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4 md:px-6 text-center">
          <h2 className="mp-serif text-3xl md:text-4xl text-slate-900 mb-4">Preview the Image Quality</h2>
      ...
      {config.themeCategories && (
        <section className="mp-sans py-20 md:py-28 bg-white">
          <div className="max-w-5xl mx-auto px-4 md:px-6">
            <h2 className="mp-serif text-3xl md:text-4xl text-slate-900 text-center mb-14">{config.themeCategories.headline}</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {config.themeCategories.categories.map((cat) => (
                <div key={cat.name} className="mp-feature-card bg-gradient-to-br from-indigo-50/60 to-violet-50/60 rounded-xl p-4 border border-indigo-100/60 text-center">
                  <p className="font-semibold text-slate-800 text-[0.94rem]">{cat.name}</p>
                  {cat.count > 0 && (
                    <p className="text-sm text-indigo-500 mt-0.5">{cat.count} images</p>
                  )}
                </div>
              ))}
            </div>
      ...
      {config.contentMath && (
        <section className="mp-sans relative mp-grain py-20 md:py-28 bg-indigo-950">
          <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-6 text-center">
            <h2 className="mp-serif text-3xl md:text-4xl text-white mb-6">{config.contentMath.headline}</h2>
            <p className="text-indigo-200/80 leading-relaxed text-lg">{config.contentMath.description}</p>
          </div>
        </section>
      )}
      ...
      <section className="mp-sans py-20 md:py-28 bg-white">
        <div className="max-w-3xl mx-auto px-4 md:px-6 text-center">
          <h2 className="mp-serif text-3xl md:text-4xl text-slate-900 mb-4">Unlock the Complete Library</h2>
