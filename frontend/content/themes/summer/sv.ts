...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Sommar',
  title: 'Gratis Sommar-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara sommar-övningar för barn. Matematik, målarbilder, ordspel och pussel med sommartema. Förskola till årskurs 3. Gratis PDF. Ingen registrering.',
  keywords: 'sommarövningar barn, sommar arbetsblad, sommar målarbilder, sommar matematik, sommar förskola, sommar utskrivbar, sommar pussel, sommar räkning, sommar korsord, sommaraktiviteter barn, sommarlov övningar',
  heading: 'Sommarövningar och Arbetsblad',
  ...
  gradeContent: {
    'preschool': {
      ...
      seoKeywords: 'sommarövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, sommarlovsövningar, sommaraktiviteter, ferieövningar, sommaruppgifter förskola, sommarens lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoDescription: 'Utskrivbara sommarövningar för förskoleklassbarn (5–6 år). Räkning, mätning och ordpussel med sommartema. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'sommarövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, sommarlovsövningar, sommaraktiviteter, ferieövningar, sommaruppgifter förskoleklass, sommarens lärande 5–6 år',
    ...
    'first-grade': {
      ...
      seoDescription: 'Utskrivbara sommarövningar för elever i årskurs 1 (6–7 år). Tidsräkning, ordproblem och läsförståelse med sommartema. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'sommarövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, sommarlovsövningar, sommaraktiviteter, ferieövningar, sommaruppgifter årskurs 1, sommarens lärande 6–7 år',
    ...
    'second-grade': {
      ...
      seoDescription: 'Utskrivbara sommar-övningar för årskurs 2 (7–8 år). Multiplikation, ordspel, logik och problemlösning. 33 generatorer. Gratis PDF. Ladda ner gratis PDF nu.',
      seoKeywords: 'sommarövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, sommarlovsövningar, sommaraktiviteter, ferieövningar, sommaruppgifter årskurs 2, sommarens lärande 7–8 år',
    ...
    'third-grade': {
      ...
      seoKeywords: 'sommarövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, sommarlovsövningar, sommaraktiviteter, ferieövningar, sommaruppgifter årskurs 3, sommarens lärande 8–9 år',
