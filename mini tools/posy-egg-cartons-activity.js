...
(function (global) {
  ...
  function henSVG() {
    return '<svg class="pec-hen-svg" viewBox="0 0 100 100" role="img" aria-label="' + (LANG === 'de' ? 'Posy die Henne' : LANG === 'fr' ? 'Posy la poule' : 'Posy the hen') + '">' +
  ...
  function cartonHTML(n) {
    ...
    return '<div class="pec-carton" aria-label="' + (LANG === 'de' ? 'eine Schachtel mit zehn Eiern' : LANG === 'fr' ? 'une boîte de dix œufs' : 'a carton of ten eggs') + '"><div class="pec-eggs">' + eggs + '</div><span class="pec-ten">10</span></div>';
  }
  ...
  global.PosyEggCartonsActivity = {
    ...
    strings: {
      title: { en: "Posy's Egg Cartons", de: 'Posys Eierschachteln', fr: 'Les boîtes d’œufs de Posy' },
      instruction: { en: 'Count the full cartons by tens and tap the total.', de: 'Zähle die vollen Schachteln in Zehnerschritten und tippe auf die Gesamtzahl.', fr: 'Compte les boîtes pleines de dix en dix, puis touche le total.' },
      prompt: { en: 'Count by tens. How many eggs?', de: 'Zähle in Zehnerschritten. Wie viele Eier?', fr: 'Compte de dix en dix. Combien d’œufs ?' },
      posyIntro: { en: 'Each carton holds ten eggs — count them by tens!', de: 'In jede Schachtel passen zehn Eier!', fr: 'Chaque boîte contient dix œufs !' },
      ask: { en: 'Tap the total number of eggs.', de: 'Tippe auf die Gesamtzahl.', fr: 'Touche le nombre total d’œufs.' },
      hintPick: { en: 'Count by tens: 10, 20, 30… one carton at a time.', de: 'Zähle in Zehnerschritten: 10, 20, 30 … immer eine Schachtel nach der anderen.', fr: 'Compte de dix en dix : 10, 20, 30… une boîte à la fois.' },
      hintWrong: { en: "Each carton is TEN, not one — count 10, 20, 30…", de: 'Jede Schachtel sind ZEHN Eier, nicht eins — zähle 10, 20, 30 …', fr: 'Chaque boîte, c’est DIX œufs, pas un — compte 10, 20, 30…' },
      win: { en: 'Yes! You counted by tens. 🥚', de: 'Ja! Du hast in Zehnerschritten gezählt. 🥚', fr: 'Bravo ! Tu as compté de dix en dix. 🥚' }
    },
    defaults: {},
