...
const content: StartContent = {
  seo: {
    ...
    lsiKeywords: [
      ...
      'Lehrermarktplatz Arbeitsblätter',
      'kommerzielle Lizenz Druckvorlagen-Werkzeuge',
    ],
    titleTag: 'Druckvorlagen-Geschäft starten — Komplettanleitung',
    metaDescription: 'Druckvorlagen-Geschäft starten. Schritt-für-Schritt-Anleitung für Etsy, KDP und Lehrermarktplatz mit Arbeitsblatt-Generatoren für Produkte, die sich.',
  },

  hero: {
    title: 'Die Komplettanleitung zum Start eines Druckvorlagen-Geschäfts',
    tagline: 'Von null zum ersten Verkauf — alles, was Sie über den Aufbau eines Druckvorlagen-Arbeitsblatt-Geschäfts wissen müssen',
    description: 'Diese Anleitung führt Sie durch jeden Schritt beim Aufbau eines Druckvorlagen-Arbeitsblatt-Geschäfts. Sie erfahren, wie Sie eine profitable Nische wählen, professionelle Produkte ohne Designkenntnisse erstellen, auf den richtigen Plattformen listen, gewinnbringend kalkulieren und einen Katalog aufbauen, der kontinuierliche Verkäufe generiert. Ob Sie auf Etsy.de, Amazon KDP, Lehrermarktplatz oder Ihrer eigenen Website verkaufen möchten — hier ist Ihr Ausgangspunkt.',
  },

  introduction: 'Der Markt für druckbare Arbeitsblätter wächst stetig, weil die Nachfrage nie nachlässt. Eltern unterrichten zu Hause. Lehrkräfte ergänzen den Lehrplan. Nachhilfelehrer brauchen jede Woche neues Material. Saisonale Themen wechseln, aber der Kernbedarf — strukturierte, ansprechende, druckfertige Lernaktivitäten — bleibt Jahr für Jahr konstant.\n\nEin Druckvorlagen-Geschäft zu starten erfordert keinen Lehramtsabschluss, keine Grafikdesign-Erfahrung und keine große Anfangsinvestition. Was es erfordert, ist ein klares Verständnis davon, was Käufer tatsächlich wollen, die richtigen Werkzeuge zur effizienten Erstellung professioneller Produkte und die Bereitschaft, dies als echtes Geschäft zu behandeln — nicht als Nebenprojekt.\n\nDiese Anleitung deckt den vollständigen Weg ab. Am Ende werden Sie einen konkreten Aktionsplan haben: Ihre Nische ausgewählt, Ihr erstes Produkt erstellt, Ihren Shop eingerichtet und Ihre Preisstrategie festgelegt. Keine vagen Ratschläge, kein leeres Versprechen — nur die praktischen Schritte, die Sie von der Idee zum Einkommen bringen.\n\nEin wichtiger Hinweis bevor wir beginnen: Jeder hier erwähnte Arbeitsblatt-Generator bietet eine kostenlose Testversion mit Wasserzeichen. Sie können alle Funktionen testen, Muster-Arbeitsblätter erstellen und die Qualität bewerten, bevor Sie eine kommerzielle Lizenz erwerben. Der Einstieg ist völlig risikofrei.',

  mainContent: [
    {
      heading: 'Was ist ein Druckvorlagen-Geschäft?',
      content: 'Ein Druckvorlagen-Geschäft verkauft digitale Dateien, die Kunden herunterladen und zu Hause, im Klassenzimmer oder in einem Copyshop ausdrucken. Sie erstellen das Produkt einmal — eine PDF- oder hochauflösende Bilddatei — und verkaufen es unbegrenzt oft. Es gibt kein Inventar zu verwalten, keinen Versand zu organisieren und kein physisches Produkt herzustellen.\n\nDie häufigsten Kategorien für druckbare Arbeitsblätter umfassen Rechenübungen, Leseaktivitäten, Malvorlagen, Rätsel-Arbeitsblätter, Zuordnungsspiele und Mustererkennungsübungen. Diese Produkte bedienen Eltern, Lehrkräfte, Homeschool-Familien, Nachhilfezentren und Kindertagesstätten.\n\nWas dieses Geschäftsmodell besonders attraktiv macht, ist die Kombination aus niedrigen Betriebskosten und wiederkehrender Nachfrage. Ein gut gemachtes Additions-Arbeitsblatt verkauft sich im September und es verkauft sich im März. Eine Malvorlage mit Feiertagsthema verkauft sich jedes Jahr, wenn dieser Feiertag naht. Ihr Katalog wächst kumulativ — jedes neue Produkt, das Sie hinzufügen, erhöht das Gesamtverdienstpotenzial Ihres Shops, ohne Ihre laufenden Kosten zu erhöhen.',
    },
    {
      heading: 'Warum Druckvorlagen-Arbeitsblätter ein starkes Geschäftsmodell sind',
      content: 'Mehrere Eigenschaften machen Druckvorlagen-Arbeitsblätter zu einem der zugänglichsten digitalen Produktgeschäfte überhaupt.\n\nErstens sind die Startkosten minimal. Sie benötigen ein Arbeitsblatt-Generator-Werkzeug, ein Marktplatz-Konto und Zeit. Vergleichen Sie das mit physischen Produkten, die Inventar, Lagerhaltung und Versandinfrastruktur erfordern.\n\nZweitens ist der Markt riesig und fragmentiert. Kein einzelner Verkäufer dominiert druckbare Arbeitsblätter auf Etsy.de oder Amazon KDP. Es gibt Millionen von Käufern und Tausende von Nischen — von Vorschul-Dinosaurier-Mathe bis hin zu Multiplikationsrätseln für die dritte Klasse — was bedeutet, dass immer Platz für einen neuen Verkäufer mit Qualitätsprodukten ist.\n\nDrittens ist der Produktlebenszyklus lang. Lern-Arbeitsblätter kommen nicht aus der Mode. Ein Additions-Arbeitsblatt, das Sie heute erstellen, wird auch in fünf Jahren noch relevant und verkäuflich sein. Saisonale Produkte wie Halloween-Malvorlagen oder Weihnachts-Wortsuchrätsel haben vorhersagbare jährliche Nachfragespitzen.\n\nViertens ist die Skalierung unkompliziert. Sobald Sie verstehen, wie Sie ein erfolgreiches Produkt erstellen, wiederholt sich der Prozess. Ein Mathe-Arbeitsblatt-Shop kann in den Bereich Lesen und Schreiben expandieren. Ein auf Vorschule fokussierter Katalog kann in Kindergarten und erste Klasse wachsen. Jedes neue Produkt erfordert ungefähr den gleichen Aufwand wie das erste, aber die Sichtbarkeit und Autorität Ihres Shops wächst mit jedem Listing.',
    },
    {
      heading: 'Nische und Zielgruppe wählen',
      content: 'Der größte Fehler neuer Druckvorlagen-Verkäufer ist der Versuch, alle zu bedienen. Ein Shop mit zufälligen Arbeitsblättern, die jedes Fach, jede Altersgruppe und jedes Thema abdecken, wirkt unkonzentriert und hat Schwierigkeiten, eine Stammkundschaft aufzubauen.\n\nStarten Sie mit einer Schnittmenge aus drei Faktoren: Fachgebiet, Altersgruppe und Käufertyp.\n\nBeispiele für Fachgebiete: Addition, Wortsuche, Ausmalen, Zuordnung, Muster, Handschrift.\nAltersgruppen: Kleinkind (2–3), Vorschule (3–5), Kindergarten (5–6), erste Klasse (6–7), zweite Klasse (7–8).\nKäufertypen: Eltern, Lehrkräfte, Homeschool-Familien, Nachhilfezentren, Kita-Betreuer.\n\nEine starke Startnische könnte „Vorschul-Mathe-Arbeitsblätter für Homeschool-Eltern" oder „Kindergarten-Leseaktivitäten für Lehrkräfte" sein. Diese Spezifizierung hilft Ihnen, in den Marktplatz-Suchergebnissen zu ranken und Wiederkäufer anzuziehen, die wissen, dass Ihr Shop genau ihre Bedürfnisse bedient.\n\nRecherchieren Sie Ihre gewählte Nische, bevor Sie Produkte erstellen. Suchen Sie auf Etsy.de nach Ihren Ziel-Keywords. Schauen Sie sich die bestverkauften Shops an. Notieren Sie deren Preisgestaltung, Produktvielfalt und Listing-Qualität. Sie kopieren nicht — Sie verstehen, was der Markt belohnt. Identifizieren Sie Lücken: Gibt es wenige Optionen für visuelle Muster-Arbeitsblätter? Sind mehrsprachige Inhalte unterrepräsentiert? Diese Lücken sind Ihre Chance.',
    },
    {
      heading: 'Unverzichtbare Werkzeuge für Druckvorlagen-Verkäufer',
      content: 'Professionelle Arbeitsblätter erfordern konsistente Layouts, saubere Typografie, präzise Lösungsschlüssel und visuell ansprechende Designs. Diese manuell in Grafikdesign-Software zu erstellen ist zeitaufwändig und fehleranfällig.\n\nArbeitsblatt-Generatoren lösen dieses Problem. Sie übernehmen das Layout, die Rechenlogik, die Lösungsschlüssel-Erstellung und das visuelle Design automatisch. Sie wählen die Parameter — Schwierigkeitsgrad, Zahlenbereich, Thema, Bilderset, Seitengröße — und der Generator erzeugt in Sekunden eine druckfertige Datei.\n\nLessonCraftStudio bietet 33 spezialisierte Arbeitsblatt-Generatoren in sechs Kategorien: Mathe und Zahlen, Buchstaben und Wörter, Zeichnen und Kunst, visuelles Lernen, Zuordnen und Sortieren sowie Rätsel und Spiele. Jeder Generator enthält über 100 thematische Bildersets, mehrere Seitengrößen, konfigurierbare Schwierigkeitsgrade und automatische Lösungsschlüssel-Erstellung.\n\nJeder Generator bietet eine kostenlose Testversion mit Wasserzeichen, damit Sie die Ausgabequalität bewerten, verschiedene Konfigurationen testen und Muster-Arbeitsblätter erstellen können, bevor Sie eine kommerzielle Lizenz erwerben. Die kommerzielle Lizenz erlaubt Ihnen, die erstellten Arbeitsblätter auf jeder Plattform zu verkaufen — Etsy.de, Amazon KDP, Lehrermarktplatz, Gumroad oder Ihre eigene Website.\n\nDer praktische Vorteil von Generatoren ist Geschwindigkeit. Ein Verkäufer, der manuelle Design-Tools nutzt, verbringt möglicherweise 30–60 Minuten mit einem einzigen Arbeitsblatt. Mit einem Generator können Sie ein poliertes, druckfertiges Arbeitsblatt in unter zwei Minuten erstellen. Dieser Geschwindigkeitsunterschied ist es, der Verkäufer mit großen Katalogen von denen trennt, die bei einer Handvoll Produkte stecken bleiben.',
    },
    {
    ...
    },
    {
      ...
      content: 'Vier Plattformen dominieren den Verkauf von Druckvorlagen-Arbeitsblättern, und jede hat eigene Vorteile.\n\nEtsy.de ist der größte Marktplatz für druckbare Downloads. Er hat massiven eingebauten Traffic von Käufern, die aktiv nach druckbaren Arbeitsblättern suchen. Die Listing-Gebühr beträgt $0,20 pro Artikel, und Etsy nimmt einen Prozentsatz von jedem Verkauf. Die Plattform bevorzugt Verkäufer mit großen Katalogen und guter SEO. Ihre Hauptkonkurrenz sind andere Etsy-Verkäufer, und Differenzierung kommt durch Qualität, Nischenfokus und Listing-Optimierung.\n\nAmazon KDP (Kindle Direct Publishing) bedient den Markt für Aktivitätsbücher und Arbeitsbücher. KDP-Produkte werden auf Bestellung gedruckt und von Amazon versandt, aber Sie können auch Low-Content- und No-Content-Bücher als Druckvorlagen-Produkte veröffentlichen. KDP gibt Ihnen Zugang zu Amazons enormer Kundenbasis. Der Kompromiss ist weniger Kontrolle über Preisgestaltung und Präsentation im Vergleich zu Etsy.\n\nLehrermarktplatz ist auf Bildungsressourcen spezialisiert. Das Publikum besteht hauptsächlich aus Lehrkräften und Homeschool-Familien. Käufer auf dem Lehrermarktplatz erwarten lehrplanorientierte, standardreferenzierte Produkte. Wenn Ihre Arbeitsblätter auf bestimmte Klassenstufen und Lernziele abzielen, ist der Lehrermarktplatz eine natürliche Wahl. Die Plattform nimmt eine Provision bei jedem Verkauf.\n\nGumroad bietet die einfachste Einrichtung für den Direktverkauf digitaler Downloads. Sie kontrollieren das gesamte Kundenerlebnis, legen Ihre eigenen Preise fest und behalten einen größeren Anteil an jedem Verkauf. Der Kompromiss ist, dass Gumroad keinen eingebauten Marktplatz-Traffic hat — Sie müssen Ihre eigenen Besucher über soziale Medien, E-Mail-Listen oder Content-Marketing anziehen.\n\nDer empfohlene Ansatz: Starten Sie auf Etsy.de für sofortigen Zugang zu Käufern, dann erweitern Sie auf KDP und Lehrermarktplatz, wenn Ihr Katalog wächst. Nutzen Sie Gumroad oder Ihre eigene Website für Direktverkäufe, sobald Sie ein Publikum haben.',
    },
    {
      heading: 'Preisstrategien für Druckvorlagen-Produkte',
      content: 'Die Preisgestaltung für druckbare Arbeitsblätter ist sowohl Kunst als auch Wissenschaft. Zu niedrig kalkuliert, entwerten Sie Ihre Arbeit und ziehen Schnäppchenjäger an, die selten zu Stammkunden werden. Zu hoch ohne etablierte Glaubwürdigkeit, und Käufer scrollen weiter.\n\nHier sind die Preisbereiche, die derzeit auf den großen Plattformen gut funktionieren:\n\nEinzelne Arbeitsblätter: $1,49–$2,99. Am besten für einfache, einseitige Produkte. In dieser Preisklasse sind Impulskäufe häufig.\n\nKleine Pakete (5–10 Seiten): $2,99–$5,99. Die beliebteste Preisklasse für Arbeitsblatt-Pakete auf Etsy. Käufer haben das Gefühl, einen guten Wert pro Seite zu erhalten.\n\nGroße Pakete (15–30+ Seiten): $5,99–$12,99. Diese funktionieren am besten, wenn das Paket ein klares Thema oder einen Lehrplanfokus hat, wie „Komplettes Kindergarten-Mathe-Paket" oder „Ganzjährige Malvorlagen-Sammlung".\n\nMega-Pakete (50+ Seiten): $14,99–$29,99. Höchster Umsatz pro Transaktion, aber geringstes Volumen. Diese sprechen Lehrkräfte und Homeschool-Eltern an, die umfassende Ressourcen wollen.\n\nRecherchieren Sie Ihre spezifische Nische, bevor Sie Preise festlegen. Suchen Sie auf Etsy.de nach vergleichbaren Produkten, notieren Sie die Preisspanne der Top-Verkäufer und positionieren Sie sich wettbewerbsfähig. Es ist in der Regel besser, in der Mitte des Marktes zu starten und basierend auf tatsächlichen Verkaufsdaten anzupassen, als zu raten.\n\nEine entscheidende Preis-Erkenntnis: Pakete übertreffen einzelne Arbeitsblätter durchweg beim Gesamtumsatz. Ein Verkäufer mit 10 einzelnen Blättern à $1,99 wird fast immer weniger verdienen als derselbe Verkäufer, der diese 10 Blätter als $6,99-Paket anbietet. Erstellen Sie beide Optionen — Einzellistings für Sichtbarkeit und Pakete für Umsatz.',
    },
    {
      heading: 'Listing-Optimierung und SEO für Druckvorlagen-Verkäufer',
      content: 'Ihre Arbeitsblätter können ausgezeichnet sein, aber wenn Käufer sie nicht finden können, werden sie sich nicht verkaufen. Marktplatz-SEO bestimmt Ihre Sichtbarkeit.\n\nAuf Etsy.de sind die drei wichtigsten Rankingfaktoren: Titel-Keywords, Tags und Listing-Qualitätsbewertung (die Klickrate und Konversionsrate einschließt). Schreiben Sie Titel, die die wichtigsten Keywords am Anfang platzieren. Zum Beispiel ist „Druckbare Additions-Arbeitsblätter für Kindergarten — Mathe-Übungspaket mit Lösungsschlüsseln" weit besser als „Lustige Mathe-Arbeitsblätter für Kinder".\n\nNutzen Sie alle 13 Etsy-Tags. Jeder Tag sollte eine einzigartige Phrase sein, nach der ein Käufer suchen könnte. Mischen Sie breite Begriffe („druckbare Mathe-Arbeitsblätter") mit spezifischen Long-Tail-Phrasen („Kindergarten Additions-Arbeitsblätter mit Bildern"). Wiederholen Sie nicht dieselben Wörter über Tags hinweg — Etsy kombiniert Titel- und Tag-Keywords für die Suchzuordnung.\n\nIhr Vorschaubild ist der wichtigste Einzelfaktor für die Klickrate. Zeigen Sie das tatsächliche Arbeitsblatt in einem sauberen, gut beleuchteten Mockup. Fügen Sie eine kleine Textüberlagerung hinzu, die die Seitenanzahl oder Paketgröße angibt. Vermeiden Sie überladene Vorschaubilder mit zu vielen Schriftarten oder Farben.\n\nSchreiben Sie Beschreibungen, die Käufern dienen, nicht Suchmaschinen. Beginnen Sie mit dem Produktinhalt (Seitenanzahl, behandelte Themen, bereitgestellte Formate). Erklären Sie, für wen es ist (Altersbereich, Fähigkeitsniveau). Erwähnen Sie das Dateiformat (PDF, JPEG) und Druckanleitungen. Schließen Sie mit Ihrer Rückgaberichtlinie und Lizenzbedingungen.\n\nAuf Amazon KDP optimieren Sie Buchtitel, Untertitel und Backend-Keywords. Ihr Coverbild muss den Buchinhalt und die Altersgruppe klar kommunizieren. Nutzen Sie das Beschreibungsfeld, um hervorzuheben, was Ihr Aktivitätsbuch von den Hunderten anderer in der Kategorie unterscheidet.',
    },
    {
      heading: 'Einen profitablen Druckvorlagen-Produktkatalog aufbauen',
  ...
  actionSteps: [
    {
      step: 'Ihre Startnische wählen',
      description: 'Wählen Sie ein Fachgebiet (Mathe, Lesen und Schreiben, Ausmalen), eine Altersgruppe (Vorschule, Kindergarten, erste Klasse) und einen Käufertyp (Eltern, Lehrkräfte, Homeschool). Recherchieren Sie Ihre Nische auf Etsy.de, um die Nachfrage zu überprüfen und den Wettbewerb einzuschätzen.',
    },
    {
      step: 'Arbeitsblatt-Generatoren mit kostenloser Testversion testen',
    ...
    {
      step: 'Ihren Etsy-Shop einrichten',
      description: 'Erstellen Sie ein Etsy-Verkäuferkonto, wählen Sie einen Shop-Namen, der zu Ihrer Nische passt, und schreiben Sie eine Shop-Beschreibung, die Sie als Spezialisten positioniert. Laden Sie Ihr Shop-Banner und Profilbild hoch.',
    },
    {
      step: 'Ihr erstes Listing erstellen',
    ...
    },
    {
      ...
      description: 'Sobald Sie 20+ Produkte und konstante Etsy-Verkäufe haben, expandieren Sie auf Amazon KDP und Lehrermarktplatz. Passen Sie Ihre bestehenden Produkte an das Format und die Erwartungen des jeweiligen Publikums an.',
    },
    {
  ...
  toolsRecommended: [
    {
      ...
      description: 'Der universell beliebteste Arbeitsblatt-Typ. Anpassbare Rastergrößen, thematische Wortlisten und automatische Lösungsschlüssel machen Wortsuchrätsel zu einem idealen ersten Produkt für jeden Druckvorlagen-Shop.',
    },
    {
    ...
    },
    {
      ...
      description: 'Malvorlagen gehören zu den meistverkauften Druckvorlagen-Kategorien auf Etsy. Generieren Sie Ausmal-Arbeitsblätter im Umrissstil aus über 100 thematischen Bildersets mit anpassbaren Layouts und Seitengrößen.',
    },
    {
    ...
    },
    {
      ...
      description: 'Suchbild-Arbeitsblätter sind ein stark nachgefragter Suchbegriff auf Etsy und Amazon. Erstellen Sie Such-und-Zähl-Aktivitäten mit thematischen Bildszenen und konfigurierbaren Schwierigkeitsgraden.',
    },
    {
  ...
  faq: [
    {
      question: 'Kann ich die Arbeitsblatt-Generatoren vor dem Kauf einer Lizenz testen?',
      answer: 'Ja. Jeder Generator bietet eine kostenlose Testversion mit Wasserzeichen. Sie können alle Funktionen nutzen, beliebig viele Arbeitsblätter erstellen und die Ausgabequalität bewerten, bevor Sie kaufen. Der einzige Unterschied ist, dass Testdownloads ein Wasserzeichen enthalten. Eine kommerzielle Lizenz entfernt das Wasserzeichen und erlaubt Ihnen, die erstellten Arbeitsblätter zu verkaufen.',
    },
    {
      question: 'Brauche ich Designkenntnisse, um druckbare Arbeitsblätter zu erstellen?',
      answer: 'Nein. Die Arbeitsblatt-Generatoren übernehmen Design, Layout und Formatierung vollautomatisch. Sie wählen die Parameter — Fachgebiet, Schwierigkeitsgrad, Thema, Seitengröße — und der Generator erzeugt eine professionelle, druckfertige Datei. Keine Grafikdesign-Software oder Erfahrung erforderlich.',
    },
    {
      question: 'Was kostet es, ein Druckvorlagen-Arbeitsblatt-Geschäft zu starten?',
      answer: 'Die Startkosten sind sehr niedrig. Sie benötigen ein Marktplatz-Konto (Etsy berechnet $0,20 pro Listing) und eine kommerzielle Lizenz für Ihre Arbeitsblatt-Generatoren. Es gibt kein Inventar, keine Versandausrüstung und keine laufenden Herstellungskosten. Die meisten Verkäufer starten mit einer einzelnen Generator-Lizenz und erweitern, wenn ihr Shop wächst.',
    },
    {
      question: 'Welcher Marktplatz ist der beste für den Verkauf druckbarer Arbeitsblätter?',
      answer: 'Etsy.de ist die empfohlene Startplattform wegen des großen eingebauten Publikums für Druckvorlagen-Produkte. Amazon KDP ist ausgezeichnet für Aktivitätsbuch-Formate. Lehrermarktplatz ist ideal, wenn Ihre Produkte Lehrkräfte mit lehrplanbezogenen Inhalten ansprechen. Viele erfolgreiche Verkäufer listen gleichzeitig auf mehreren Plattformen.',
    },
    {
      question: 'Wie viele Produkte brauche ich, bevor ich mit dem Verkauf beginnen kann?',
      answer: 'Sie können Ihr erstes Produkt sofort listen, aber Shops mit mehr Listings schneiden in Suchergebnissen besser ab. Streben Sie mindestens 5–10 Produkte in Ihrer ersten Woche an und fügen Sie weiterhin 2–3 neue Produkte pro Woche hinzu. Verkäufer, die 50+ Listings erreichen, sehen typischerweise konstantere tägliche Verkäufe.',
    },
    {
      question: 'Kann ich Arbeitsblätter in anderen Sprachen als Englisch verkaufen?',
      answer: 'Absolut. Alle Generatoren unterstützen 11 Sprachen: Englisch, Deutsch, Französisch, Spanisch, Portugiesisch, Italienisch, Niederländisch, Schwedisch, Dänisch, Norwegisch und Finnisch. Rein visuelle Arbeitsblätter wie Ausmalen, Zuordnung und Musteraktivitäten funktionieren in jeder Sprache ohne Änderung. Nicht-englischsprachige Märkte sind deutlich unterversorgt, was weniger Konkurrenz für mehrsprachige Verkäufer bedeutet.',
    },
    {
      question: 'Welche Dateiformate erzeugen die Arbeitsblatt-Generatoren?',
      answer: 'Jeder Generator erzeugt druckfertige PDF- und hochauflösende JPEG-Dateien. PDF ist das Standardformat für Druckvorlagen-Produkte auf Etsy und Lehrermarktplatz. JPEG wird für Amazon KDP-Innenseiten und für Produkt-Vorschaubilder verwendet. Beide Formate sind bei jedem Download enthalten.',
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'Verstehen Sie, was eine kommerzielle Lizenz abdeckt, wie sie auf verschiedene Plattformen anwendbar ist und welche Rechte Sie beim Kauf einer Lizenz für Ihre Arbeitsblatt-Generatoren erhalten.',
    },
  ],
