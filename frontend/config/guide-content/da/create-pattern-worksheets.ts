...
const content: GuideContent = {
  ...
  visuals: {
    heroImage: { src: '/samples/english/pattern worksheet/pattern_worksheet.webp', alt: 'Mønstergenkendelsesarbejdsark med tematiske billeder der viser visuelle mønsterfuldførelsesøvelser til børn' },
    samples: [
      { src: '/samples/english/pattern worksheet/pattern_worksheet.webp', alt: 'Mønstergenkendelsesarbejdsark med dyretema der viser AB og ABC mønsterøvelser', caption: 'Mønstergenkendelsesarbejdsark med tematiske billeder med flere mønstertyper og automatisk facit' },
      { src: '/samples/english/pattern worksheet/pattern_worksheet.webp', alt: 'Mønsterarbejdsark facit der viser fuldførte mønstre med korrekte billeder udfyldt', caption: 'Automatisk facit genereret sammen med hvert mønsterarbejdsark til hurtig rettelse' },
    ],
