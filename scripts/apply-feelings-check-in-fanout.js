#!/usr/bin/env node
/* =====================================================================
   apply-feelings-check-in-fanout.js — land the 11 native ensembles' work.
   ...
   Usage: node scripts/apply-feelings-check-in-fanout.js [--dry-run]
   ===================================================================== */
'use strict';
const fs = require('fs');
...
const IN_DIR = process.env.FCI_FANOUT_DIR || path.join(
  'C:', 'Users', 'rkgen', 'AppData', 'Local', 'Temp', 'claude',
  'C--Users-rkgen-lessoncraftstudio', '7b4f86e7-1753-43a3-90a9-0270bd050f56',
  'scratchpad', 'fci-fanout');
const TOOL = path.join(REPO, 'mini tools', 'feelings-check-in.js');
