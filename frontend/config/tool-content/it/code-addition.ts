...
const content: ToolContent = {  seo: {
  ...
  tutorial: {
    title: 'Come creare schede di addizione codificata in 8 semplici passaggi',
    steps: [
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Genera 50–100 pagine di puzzle codice segreto con difficoltà progressiva. Inizia con 3 simboli e 2 addendi, poi aumenta a 6+ simboli con addendi misti. Esporta in formato quadrato (1200×1200) e pubblica come libro di attività KDP unico che si distingue dai quaderni di matematica generici.',
    },
    {
      title: 'Set multilingue di puzzle codificati',
      description: 'Alterna tra le 11 lingue supportate per creare puzzle per mercati internazionali. Nella Modalità Rivela Parola il generatore usa alfabeti specifici per ogni lingua — umlaut tedeschi, accenti francesi, caratteri scandinavi — così le parole nascoste sono linguisticamente corrette. Pochissimi concorrenti offrono questo vantaggio.',
    },
    {
  ...
  businessIdeas: [
    {
      title: 'Negozio Etsy di puzzle crittaritmetici',
      description: 'Apri un negozio Etsy di nicchia dedicato ai puzzle matematici decifra il codice. È una categoria genuinamente poco servita — la maggior parte dei venditori offre esercizi di addizione standard, non puzzle crittaritmetici. Crea 15–20 pacchetti tematici al prezzo di 3–5 € ciascuno. Il fattore novità genera tassi di clic più alti nelle ricerche. Organizza il tuo negozio in collezioni stagionali — crittaritmetica di Halloween a ottobre, pacchetti codice segreto natalizi a dicembre, kit rientro a scuola ad agosto. I prodotti stagionali tendono a salire nelle ricerche Etsy durante il periodo rilevante, offrendoti finestre di traffico prevedibili.',
      platform: 'Etsy',
    },
    {
    ...
    {
      title: 'Prodotti puzzle multilingue',
      description: 'Sfrutta il supporto a 11 lingue per creare puzzle codificati per mercati non italiani. I mercati tedesco, francese e spagnolo hanno molta meno concorrenza per contenuti crittaritmetici. La Modalità Rivela Parola con caratteri accentati linguisticamente corretti ti dà un prodotto autentico che i concorrenti con traduzione automatica non possono replicare.',
      platform: 'Etsy',
    },
    {
      title: 'Pacchetti attività per feste ed eventi',
      description: 'Crea pacchetti tematici di attività decifra il codice per compleanni, feste scolastiche ed eventi stagionali. Usa la Modalità Rivela Parola con parole segrete legate alla festa come TORTA, REGALO o NATALE. Per i pacchetti compleanno, usa il nome del festeggiato come parola segreta e abbinalo a temi divertenti come dinosauri, unicorni o supereroi. I genitori e gli organizzatori di eventi cercano attività stampabili uniche su Etsy e Pinterest.',
      platform: 'Etsy',
    },
  ],
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Nella Modalità Rivela Parola scegli temi di immagini che si collegano alla parola nascosta. Se la parola segreta è TIGRE, usa simboli a tema animali. Se è RAZZO, scegli immagini spaziali. Questa coerenza tematica fa sembrare il puzzle progettato intenzionalmente anziché generato casualmente.',
    },
  ],
  ...
  internalLinks: [
    { pageType: 'app', slug: 'addizioni-immagini-schede', anchorText: 'Schede Addizione Codificata — Dettagli Prodotto Completi' },
    { pageType: 'tool', slug: 'generatore-schede-addizione', anchorText: 'Generatore Schede di Addizione' },
    { pageType: 'tool', slug: 'generatore-schede-sottrazione', anchorText: 'Generatore Schede di Sottrazione' },
    { pageType: 'tool', slug: 'generatore-puzzle-matematici', anchorText: 'Generatore Puzzle Matematici' },
    { pageType: 'tool', slug: 'generatore-esercizi-matematica', anchorText: 'Generatore Esercizi di Matematica' },
  ...
  visuals: {
    ...
    videoTitle: 'Come creare schede di addizione codificata — Video tutorial',
  },
};
