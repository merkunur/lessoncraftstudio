...
const appsMetadata: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  da: {
    title: '33 Printbare Generatorer | Etsy & KDP-v\ærkt\øjer',
    description: 'Udforsk 33 professionelle printbare generatorer. Ords\øgninger, matematikopgaver, maleb\øger, puslespil & mere. Pr\øv gratis med vandm\ærke. S\ælg p\å Etsy & Amazon KDP.',
    keywords: 'printbar generator, Etsy printables, KDP opgaver, s\ælg printables online, ords\øgningsgenerator, opgaveskaber, printable virksomhed',
  },
  no: {
