...
const content: EnrichedThemeContent = {
  ...
  description: 'Utskrivbara rymden-övningar för barn. Matematik, målarbilder, ordspel och pussel med rymdentema. Förskola till årskurs 3. Gratis PDF. Ingen registrering.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Rymden-övningar Förskola | LessonCraftStudio',
      ...
      seoKeywords: 'rymdövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, planeter, solsystemet, astronomi, rymduppgifter förskola, rymdens lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoDescription: 'Utskrivbara rymdövningar för förskoleklassbarn (5–6 år). Räkning, planetordning och ordpussel med rymdtema. 33 generatorer. Gratis PDF. Skriv ut direkt.',
      seoKeywords: 'rymdövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, planeter, solsystemet, astronomi, rymduppgifter förskoleklass, rymdens lärande 5–6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Rymden-övningar Årskurs 1 | LessonCraftStudio',
      seoDescription: 'Utskrivbara rymdövningar för elever i årskurs 1 (6–7 år). Planeter, ordproblem inom 20 och datainsamling med rymdtema. 33 generatorer. Gratis PDF. Hämta.',
      seoKeywords: 'rymdövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, planeter, solsystemet, astronomi, rymduppgifter årskurs 1, rymdens lärande 6–7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Rymden-övningar Årskurs 2 | LessonCraftStudio',
      ...
      seoKeywords: 'rymdövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, planeter, solsystemet, astronomi, rymduppgifter årskurs 2, rymdens lärande 7–8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Rymden-övningar Årskurs 3 | LessonCraftStudio',
      seoDescription: 'Utskrivbara rymden-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'rymdövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, planeter, solsystemet, astronomi, rymduppgifter årskurs 3, rymdens lärande 8–9 år',
