...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare sommer-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med sommertema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Sommer-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare sommer-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'sommeroppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, sommerferieøvelser, sommeraktiviteter, ferieøvelser, sommerøvelser førskole, sommerens læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Sommer-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare sommer-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'sommeroppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, sommerferieøvelser, sommeraktiviteter, ferieøvelser, sommerøvelser barnehage, sommerens læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Sommer-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare sommer-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'sommeroppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, sommerferieøvelser, sommeraktiviteter, ferieøvelser, sommerøvelser 1. klasse, sommerens læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Sommer-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare sommer-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'sommeroppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, sommerferieøvelser, sommeraktiviteter, ferieøvelser, sommerøvelser 2. klasse, sommerens læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Sommer-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare sommer-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'sommeroppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, sommerferieøvelser, sommeraktiviteter, ferieøvelser, sommerøvelser 3. klasse, sommerens læring 8-9 år',
