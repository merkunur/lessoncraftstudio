...
const content: AppContent = {
  ...
  hero: {
    title: 'Cryptogram Puzzle Generator — Create Printables to Sell on Etsy & KDP',
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Type the phrase or sentence you want solvers to decode. This is the secret message that will be encoded as a picture cipher. Select the target language — the phrase text should match the chosen language since solvers will decode it into readable words. The available alphabet set automatically adjusts by locale: English uses 26 letters, German includes ä, ö, ü, ß, and French includes accented characters. Every letter in your phrase will be mapped to an image in the cipher.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Adjust the Letters to Reveal setting from 0 to 10 to control how many letter-to-image mappings are pre-solved as hints on the worksheet. Zero reveals creates a pure code-breaking challenge; ten reveals provides heavy scaffolding for beginners. Add a worksheet title, name and date fields, instructions, or any custom text using five fonts: Lexend Deca, Baloo 2, Nunito, Quicksand, and Fredoka. Use the full Fabric.js canvas to drag, resize, rotate, and reposition every element.',
      },
      {
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      {
        title: 'Tiered Cryptogram Bundles on Gumroad',
        description:
          'Build leveled cryptogram practice sets using Letters to Reveal as the tiering axis: Level 1 (8 reveals, short phrases, themed images), Level 2 (5 reveals, medium phrases), Level 3 (2 reveals, longer sentences), and Level 4 (0 reveals, full code-breaking challenge). Package each level with letter legend answer keys and a progress tracker. The cipher mechanic is inherently engaging — solvers experience genuine code-breaking excitement as each decoded letter unlocks more of the message. Buyers pay premium prices for tiered puzzle packs that are ready to use across multiple difficulty levels.',
