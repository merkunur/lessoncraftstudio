...
const content: GuideContent = {
  ...
  hero: {
    ...
    tagline: "Um tutorial passo a passo para criar puzzles de sudoku 4×4 baseados em imagens que pode vender no Etsy, Amazon KDP e Gumroad",
