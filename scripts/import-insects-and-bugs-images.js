...
// Theme configuration
const THEME_CONFIG = {
  name: 'insects_and_bugs',
  type: 'images',
  sourceFolderName: 'insects and bugs',
  displayNames: {
    en: 'Insects and Bugs',
    de: 'Insekten und Käfer',
    fr: 'Insectes et bestioles',
    es: 'Insectos y bichos',
    it: 'Insetti e scarafaggi',
    pt: 'Insetos e bichos',
    nl: 'Insecten en beestjes',
    sv: 'Insekter och kryp',
    da: 'Insekter og kryb',
    no: 'Insekter og kryp',
    fi: 'Hyönteiset ja ötökät'
  }
};
...
async function main() {
  console.log('============================================================');
  console.log('Image Import Script: Insects and Bugs');
  console.log('============================================================\n');
