...
const content: StartContent = {
  ...
  actionSteps: [
    ...
    {
      step: 'Create Your First German Language-Sensitive Product',
      description: 'Choose your strongest language-sensitive generator (word search recommended). Select a popular theme, set the language to German, and generate 15\u201325 puzzle pages. Review the output for professional quality and completeness.',
    },
    {
      step: 'Research the German Market on Etsy.de and Amazon.de',
    ...
    {
      step: 'Expand to French and Spanish',
      description: 'Once your German listings are live and optimized, repeat the process for French (Amazon.fr, Etsy.fr) and Spanish (Amazon.es, US Hispanic market). Use the same workflow: language-sensitive products first, then visual-only relists.',
    },
    {
      step: 'Build Multi-Language Series',
  ...
  toolsRecommended: [
    {
      ...
      description: 'The best multilingual demonstration \u2014 hidden words change entirely based on language selection. Generate themed word search puzzles in all 11 languages with vocabulary from the built-in translation database.',
    },
    {
      appId: 'crossword-worksheets',
      title: 'Crossword Generator',
      description: 'Crossword answers and clues fully adapt to each language. Grid layouts regenerate to accommodate different word lengths across languages, producing genuinely localized puzzles.',
    },
    {
      appId: 'word-scramble-worksheets',
      title: 'Word Scramble Generator',
      description: 'Scrambled words adapt to each language\u2019s vocabulary. German compound words, French accented words, and Spanish vocabulary all scramble correctly within language-specific rules.',
    },
    {
      appId: 'alphabet-train-worksheets',
      title: 'Alphabet Train Generator',
      description: 'Letter sets and alphabetical ordering adjust for each language. Languages with additional characters (German \u00df, Swedish \u00e5\u00e4\u00f6, Danish \u00e6\u00f8\u00e5) produce different train compositions.',
    },
    {
      appId: 'matching-worksheets',
      title: 'Matching Worksheet Generator',
      description: 'In word-matching mode, vocabulary labels change per language. Match images to their German, French, or Spanish names using the built-in translation database for authentic localized content.',
    },
    {
      appId: 'find-and-count-worksheets',
      title: 'Find & Count Generator',
      description: 'Image labels localize in all 11 languages. Counting worksheets with German object names, French labels, or Spanish vocabulary create genuinely differentiated international products.',
    },
  ],

  faq: [
    {
      question: 'Can I test multilingual worksheet output before purchasing a license?',
      answer: 'Yes. Every generator offers a free trial with watermark. Switch the language selector to any of the 11 supported languages and generate sample worksheets to evaluate the translation quality and output format. The free trial with watermark lets you fully test multilingual features before committing.',
    },
    {
      question: 'Do I need to speak German or French to sell worksheets in those languages?',
      answer: 'No. Language-sensitive generators handle all vocabulary translation internally using a verified database. You do not need to speak the target language to create accurate multilingual worksheet content. You will need basic translation assistance for listing titles and descriptions on Etsy or Amazon, but the worksheet content itself requires no language skills from you.',
    },
    {
      question: 'Are the translations accurate enough for educational content?',
      answer: 'The translation database contains over 3,000 professionally verified vocabulary entries across all 11 languages. Each translation was reviewed for accuracy, including proper diacritical marks (German umlauts, French accents, Portuguese tildes, Swedish characters). This database-driven approach produces more reliable results than machine translation for educational vocabulary.',
    },
    {
      question: 'What is the difference between language-sensitive and visual-only generators?',
      answer: 'Language-sensitive generators (13 apps including word search, crossword, and word scramble) produce worksheet content that changes based on the selected language \u2014 different words, clues, and vocabulary appear on the page. Visual-only generators (20 apps including coloring, math, and Sudoku) produce content that is language-independent \u2014 the output looks identical regardless of language selection.',
    },
    {
      question: 'Can I sell the same visual-only worksheets in multiple language markets?',
    ...
    {
      question: 'Do I need separate commercial licenses for each language?',
      answer: 'No. A commercial license covers all languages supported by that generator. You purchase one license per generator and can create commercial content in all 11 supported languages. There is no per-language licensing requirement.',
    },
    {
      question: 'What is the refund policy for worksheet generator licenses?',
      answer: 'Because every generator offers a free trial with watermark, you can fully test multilingual output in all 11 languages before purchasing. We encourage thorough testing during the trial period to confirm the generators meet your multilingual production needs. Refund requests are handled on a case-by-case basis through our support team.',
    },
  ],
