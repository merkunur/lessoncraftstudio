...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'småbørn aktivitet printables sælg',
    ...
    titleTag: 'Småbørns-Printables: Et Voksende Marked | LessonCraftStudio',
  ...
  cta: {
    heading: 'Kom I Gang Med Småbørns-Printables',
