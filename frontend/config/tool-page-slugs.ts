...
export const toolPageSlugs: ToolSlugConfig[] = [
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-puzzles-matematicos', pt: 'gerador-puzzles-matematicos', it: 'generatore-puzzle-matematici', nl: 'rekenpuzzel-maker', sv: 'mattepussel-skapare'
    },
  },
  {
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-tren-abecedario', pt: 'gerador-trem-alfabeto', it: 'generatore-treno-alfabeto', nl: 'alfabettrein-maker', sv: 'alfabetstaag-skapare'
    },
  },
  {
    toolId: 'prepositions',
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-adivinar-palabras', pt: 'gerador-adivinhar-palavras', it: 'generatore-indovina-parole', nl: 'woordraadsel-maker', sv: 'gissa-ordet-skapare'
    },
  },
  {
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-sopa-letras', pt: 'gerador-caca-palavras', it: 'generatore-cerca-parole', nl: 'woordzoeker-maker', sv: 'ordsoek-skapare'
    },
  },
  {
    toolId: 'cryptogram',
    slugs: {
      ...
      es: 'generador-criptogramas', pt: 'gerador-criptogramas', it: 'generatore-crittogrammi', nl: 'cryptogram-maker', sv: 'kryptogram-skapare'
    },
  },
  {
    toolId: 'writing',
    slugs: {
      ...
      es: 'generador-fichas-escritura', pt: 'gerador-fichas-escrita', it: 'generatore-schede-scrittura', nl: 'schrijfoefeningen-maker', sv: 'skrivoevningar-skapare'
    },
  },
  {
    toolId: 'big-small',
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-dibujo-cuadricula', pt: 'gerador-desenho-quadricula', it: 'generatore-disegno-griglia', nl: 'rastertekenen-maker', sv: 'rita-och-faerglaeg-skapare'
    },
  },
  {
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-paginas-colorear', pt: 'gerador-paginas-colorir', it: 'generatore-pagine-colorare', nl: 'kleurplaten-maker', sv: 'maelarsidor-skapare'
    },
  },
  {
    toolId: 'chart-count',
    slugs: {
      ...
      es: 'generador-graficos-imagenes', pt: 'gerador-graficos-imagens', it: 'generatore-grafici-immagini', nl: 'telgrafiek-werkblad-maker', sv: 'bilddiagram-raekna-skapare'
    },
  },
  {
    toolId: 'matching',
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-puzzle-cuadricula', pt: 'gerador-puzzle-quadricula', it: 'generatore-puzzle-griglia', nl: 'raster-puzzel-maker', sv: 'rutnaetspussel-skapare'
    },
  },
  {
    toolId: 'shadow-match',
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-tarjetas-bingo', pt: 'gerador-cartelas-bingo', it: 'generatore-cartelle-bingo', nl: 'plaatjesbingo-maker', sv: 'bildbingo-skapare'
    },
  },
  {
    toolId: 'picture-sort',
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-fichas-intruso', pt: 'gerador-fichas-intruso', it: 'generatore-schede-intruso', nl: 'wat-hoort-er-niet-bij-maker', sv: 'hitta-udda-skapare'
    },
  },
  {
    toolId: 'sudoku',
    slugs: {
      ...
      es: 'generador-sudoku-infantil', pt: 'gerador-sudoku-infantil', it: 'generatore-sudoku-bambini', nl: 'kinder-sudoku-maker', sv: 'barn-sudoku-skapare'
    },
  },
  {
    toolId: 'picture-path',
    slugs: {
      ...
      es: 'generador-recorrido-imagenes', pt: 'gerador-percurso-imagens', it: 'generatore-percorso-immagini', nl: 'plaatjespad-maker', sv: 'bildvaeg-skapare'
    },
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-busca-cuenta', pt: 'gerador-procura-conta', it: 'generatore-cerca-e-conta', nl: 'zoek-en-tel-maker', sv: 'hitta-och-raekna-skapare'
    },
  },
  {
    toolId: 'find-objects',
    slugs: {
      ...
      es: 'generador-busca-objetos', pt: 'gerador-procura-objetos', it: 'generatore-cerca-oggetti', nl: 'zoek-en-vind-maker', sv: 'hitta-foeremaalen-skapare'
    },
  },
  {
    toolId: 'crossword',
  ...
  },
  {
    ...
    slugs: {
      ...
      es: 'generador-busqueda-tesoro', pt: 'gerador-caca-tesouro', it: 'generatore-caccia-tesoro', nl: 'schattenjacht-maker', sv: 'skattjakt-skapare'
    },
  },
];
