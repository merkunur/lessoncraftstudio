    ...
    steps: [
      {
        ...
        description:
          "Abre el panel de Página y Escena y elige un tamaño de página: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal o cualquier dimensión personalizada. Selecciona un color de fondo con el selector de color. Elige un tema de fondo y ajusta su opacidad (0–1 en pasos de 0,05), luego selecciona un tema de borde con su propio control de opacidad independiente. Estas opciones de diseño enmarcan tu puzzle de sudoku antes de configurar el contenido.",
      },
      {
      ...
      {
        title: 'Genera el puzzle de sudoku',
        description:
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Dos métodos de selección de imágenes garantizan flexibilidad creativa. La selección por tema te permite elegir cualquier tema del menú desplegable y el sistema selecciona automáticamente 4 imágenes al azar de esa colección — perfecto para generación rápida de puzzles. La selección manual abre la Biblioteca de Imágenes completa donde puedes explorar 104 colecciones temáticas, filtrar por tema o buscar por palabra clave para elegir exactamente 4 imágenes a mano. También puedes subir imágenes personalizadas. La aplicación aplica el requisito de 4 imágenes: no puedes generar un puzzle con menos o más de 4 imágenes únicas, ya que cada cuadrícula de sudoku 4×4 usa exactamente 4 símbolos distintos.",
      },
      {
