...
const localeContent: Record<string, {
  ...
  de: {
    ...
    subtitle: 'Sehen Sie, wie einfach es ist: Generator waehlen, Thema aussuchen, Arbeitsblatt anpassen und druckfertiges PDF exportieren.',
    videoTitle: 'LessonCraftStudio Wortsuche-Generator Demo',
  },
  fr: {
    badge: 'Voir en action',
    title: 'Creez un imprimable professionnel en moins de 3 minutes',
    subtitle: 'Decouvrez comme c\'est simple : choisir un generateur, selectionner un theme, personnaliser et exporter un PDF pret a imprimer.',
    videoTitle: 'Demo du generateur de mots meles LessonCraftStudio',
  },
  es: {
    badge: 'Ver en accion',
    title: 'Crea un imprimible profesional en menos de 3 minutos',
    subtitle: 'Mira lo facil que es: elige un generador, selecciona un tema, personaliza tu ficha y exporta un PDF listo para imprimir.',
  ...
  it: {
    ...
    subtitle: 'Guarda quanto e facile: scegli un generatore, seleziona un tema, personalizza la scheda ed esporta un PDF pronto per la stampa.',
    videoTitle: 'Demo del generatore di crucipuzzle LessonCraftStudio',
  },
  pt: {
    badge: 'Veja em acao',
    title: 'Crie um imprimivel profissional em menos de 3 minutos',
    subtitle: 'Veja como e facil: escolha um gerador, selecione um tema, personalize sua atividade e exporte um PDF pronto para impressao.',
    videoTitle: 'Demo do gerador de caca-palavras LessonCraftStudio',
  },
  nl: {
  ...
  da: {
    ...
    title: 'Opret en professionel printable paa under 3 minutter',
    subtitle: 'Se hvor nemt det er: vaelg en generator, vaelg et tema, tilpas dit opgaveark og eksporter en printbar PDF.',
    videoTitle: 'LessonCraftStudio Ordsoegning Generator Demo',
  },
  sv: {
    badge: 'Se det i aktion',
    title: 'Skapa en professionell utskrift paa under 3 minuter',
    subtitle: 'Se hur enkelt det aer: vaelj en generator, vaelj ett tema, anpassa ditt arbetsblad och exportera en utskriftsklar PDF.',
    videoTitle: 'LessonCraftStudio Ordsoek Generator Demo',
  },
  no: {
    badge: 'Se det i aksjon',
    title: 'Lag en profesjonell utskrift paa under 3 minutter',
    ...
    subtitle: 'Katso kuinka helppoa se on: valitse generaattori, valitse teema, muokkaa tehtavaa ja vie tulostusvalmas PDF.',
    videoTitle: 'LessonCraftStudio Sananetsinta Generaattori Demo',
  },
};
