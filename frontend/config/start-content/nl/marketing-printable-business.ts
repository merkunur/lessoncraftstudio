...
const content: StartContent = {
  ...
  toolsRecommended: [
    {
      ...
      description: 'Bingokaarten behoren tot de meest deelbare printable producten — perfect voor feesten, winkels, feestdagen en evenementen. Elke gelegenheid creëert een natuurlijk marketingmoment op Pinterest en sociale media, wat herhaald verkeer naar je winkel stimuleert.',
    },
    {
      appId: 'word-search-worksheets',
      title: 'Woordzoeker Generator',
      description: 'Woordzoeker is het meest gezochte puzzeltype op elke marktplaats. Sterk platform-SEO-potentieel met het hele jaar door vraag van ouders, verkopers en activiteitenboek-kopers. Meertalige ondersteuning opent 11 taalmarkten vanuit één tool.',
    },
    {
    ...
    },
    {
      ...
      description: 'Groenblijvende vraag met het hele jaar door zoekvolume van ouders en verkopers. Rekenwerkbladen zien de scherpste seizoenspieken tijdens terug-naar-school en toetsvoorbereidingsperiodes — betrouwbare marketing kalender ankerpunten.',
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'Productkwaliteit is de basis waarop alle marketing voortbouwt. Deze gids behandelt de getrapte productpakkettentechnieken en kwaliteitsstandaarden die je werkbladen het vermarkten waard maken.',
    },
  ],
