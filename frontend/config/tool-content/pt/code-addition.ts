...
const content: ToolContent = {  seo: {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Gere de 50 a 100 páginas de puzzles de descodificação matemática com dificuldade progressiva. Comece com 3 símbolos e 2 parcelas, depois aumente para 6 ou mais símbolos com parcelas mistas. Exporte em formato quadrado (1200×1200) e publique como caderno de atividades KDP único que se destaca dos cadernos de matemática genéricos.',
    },
    {
      title: 'Conjuntos de Puzzles Multilingues',
  ...
  businessIdeas: [
    ...
    },
    {
      ...
      description: 'Aproveite a compatibilidade com 11 idiomas para criar puzzles de código para mercados não lusófonos. Os mercados alemão, francês e inglês têm ainda menos concorrência em conteúdo criptaritmético. O Modo Palavra Revelada com caracteres acentuados corretos para cada idioma dá-lhe um produto autêntico que os concorrentes com traduções automáticas não conseguem igualar.',
      platform: 'Etsy',
    },
    {
      title: 'Pacotes de Atividades para Festas e Eventos',
      description: 'Crie pacotes de atividades de descodificação temáticos para aniversários, celebrações escolares e eventos festivos. Use o Modo Palavra Revelada com palavras secretas relacionadas com a festa. Os pais e organizadores de eventos procuram atividades imprimíveis originais na Etsy e no Pinterest. Para pacotes de aniversário, use o nome da criança como palavra secreta e combine com imagens temáticas como dinossauros, unicórnios ou super-heróis. Os pacotes de eventos vendem-se bem como produtos de download instantâneo porque os compradores muitas vezes compram à última hora e precisam de algo que possam imprimir imediatamente em casa.',
      platform: 'Etsy',
    },
  ],
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'No Modo Palavra Revelada, selecione temas de imagens relacionados com a palavra oculta. Se a palavra secreta é TIGRE, use símbolos de animais. Se é FOGUETÃO, escolha imagens do espaço. Esta coerência temática faz com que o puzzle pareça intencionalmente concebido em vez de gerado aleatoriamente.',
    },
  ],
