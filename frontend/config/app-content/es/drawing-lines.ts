...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'vender fichas de trazado de líneas en Teachers Pay Teachers',
    ...
    metaDescription:
      'Crea fichas de grafomotricidad para Etsy, KDP y TPT. Ocho plantillas SVG, pares de imágenes, 104 colecciones temáticas. Prueba gratis con marca de agua.',
  },
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'El lienzo integrado Fabric.js 5.3.1 te permite arrastrar, redimensionar, rotar y reposicionar cada elemento de la página — texto, plantillas de líneas, imágenes, bordes y fondos. Añade texto personalizado con fuentes como Arial, Verdana, Baloo 2, Fredoka, Lexend Deca, Nunito y Quicksand. Ajusta el tamaño de fuente, color y contorno de texto de 0 a 10 de ancho con granularidad de 0,5. Los controles de capas gestionan el orden de apilamiento, el bloqueo/desbloqueo protege los elementos terminados, y las herramientas de alineación posicionan los elementos con precisión. Haz zoom de 25 % a 400 % para una colocación precisa, con hasta 100 estados de historial de deshacer/rehacer mediante Ctrl+Z y Ctrl+Y.',
      },
    ],
  },
  ...
  faq: [
    {
      ...
      answer:
        'Las ocho plantillas cubren cuatro tipos de líneas. Cuatro plantillas de curvas crean trazados fluidos y amplios en orientación horizontal con 4 pares de imágenes cada una — cada variante de curva ofrece una forma diferente para variedad visual. Dos plantillas de diagonales producen líneas en ángulo en orientación vertical con 5 pares. Una plantilla horizontal genera líneas rectas de izquierda a derecha en vertical con 5 pares. Una plantilla vertical crea líneas de arriba hacia abajo en vertical con 4 pares. Cada tipo de línea trabaja una competencia de motricidad fina diferente, permitiendo crear series de dificultad progresiva.',
    },
    {
      question: '¿Qué tipos de líneas están disponibles y qué habilidades desarrollan?',
      answer:
        'Las líneas curvas desarrollan la flexibilidad de la muñeca y el movimiento fluido mientras los alumnos siguen arcos amplios. Las líneas diagonales construyen la coordinación cruzada con trazados en ángulo. Las líneas horizontales refuerzan el control direccional de izquierda a derecha — la misma dirección de seguimiento usada en la lectura y la escritura. Las líneas verticales practican los trazos de arriba hacia abajo esenciales para la formación de letras. Juntos, estos cuatro tipos de líneas cubren las competencias fundamentales de motricidad fina necesarias para la preparación a la escritura.',
    },
    {
      question: '¿Cómo funciona la asociación de pares de imágenes en cada plantilla?',
      answer:
        'Cada plantilla coloca pares de imágenes emparejadas a cada lado del camino de la línea. Una imagen aparece al inicio de la línea y su pareja aparece al final. Los alumnos trazan a lo largo del camino guiado para conectar las imágenes que van juntas. Las plantillas contienen 4 o 5 pares según el tipo de línea — las plantillas de curvas y vertical usan 4 pares, las plantillas de diagonales y horizontal usan 5. Las imágenes emparejadas dan a los alumnos un objetivo visual que los motiva a completar cada línea.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Las fichas de Grafomotricidad no necesitan una clave de respuesta separada porque el trazado de la línea en sí guía al alumno. La plantilla de línea SVG impresa en la ficha muestra exactamente dónde trazar — los alumnos siguen el camino visible desde una imagen hasta su pareja. El ejercicio es autocorrectivo: si la línea del alumno sigue el trazado y llega a la imagen correspondiente, lo ha completado correctamente.',
    },
    {
      question: '¿Puedo subir mis propias imágenes en vez de usar la biblioteca?',
      answer:
        'Sí. La función de subida de imágenes personalizadas te permite añadir cualquier imagen a tus fichas de trazado de líneas. Sube fotos, ilustraciones o gráficos relevantes para tu tema o público específico. Las imágenes personalizadas aparecen junto a las imágenes de la biblioteca y funcionan con las ocho plantillas y la función de autorrelleno. Esto es útil para crear fichas sobre temas específicos o productos de marca que van más allá de la biblioteca temática integrada.',
    },
    {
      question: '¿Puedo añadir un campo de nombre y fecha a la ficha?',
      answer:
        'Sí. Activa los campos de nombre y fecha desde el panel Contenido. Aparecen en fuente Fredoka a 18px en gris oscuro (#333). También puedes añadir texto personalizado con el panel Herramientas de Texto usando cualquier fuente disponible — Arial, Verdana, Baloo 2, Fredoka, Lexend Deca, Nunito y Quicksand — y reposicionarlos en cualquier lugar del lienzo.',
    },
    {
