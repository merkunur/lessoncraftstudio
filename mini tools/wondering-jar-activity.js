...
(function (global) {
  ...
  function speak(text) {
    try {
      if (global.LCSAudio && global.LCSAudio.speak) { global.LCSAudio.speak({ type: 'number', text: String(text), lang: (LANG === 'es' ? 'es-MX' : LANG === 'pt' ? 'pt-BR' : LANG === 'it' ? 'it-IT' : LANG), rate: 0.95 }); return; }
      if (global.speechSynthesis && global.SpeechSynthesisUtterance) { var u = new global.SpeechSynthesisUtterance(String(text)); u.rate = .95; u.lang = (LANG === 'es' ? 'es-MX' : LANG === 'fr' ? 'fr-FR' : LANG === 'de' ? 'de-DE' : LANG === 'pt' ? 'pt-BR' : LANG === 'it' ? 'it-IT' : LANG === 'nl' ? 'nl-NL' : 'en-US'); global.speechSynthesis.cancel(); global.speechSynthesis.speak(u); }
    } catch (e) {}
  }
  ...
  global.WonderingJarActivity = {
    ...
    strings: {
      title: { en: 'The Wondering Jar', de: 'Eulchens Rätselglas', fr: 'Le bocal mystère de la chouette', es: 'Frasco preguntón', pt: 'O Frasco dos Palpites', it: 'Il barattolo delle meraviglie', nl: 'Uiltjes raadselglas' },
      prompt: { en: 'Guess how many — then count to find out!', de: 'Schätz mal, wie viele – dann zähl nach!', fr: 'Devine combien — puis compte pour découvrir !', es: 'Estima cuántos hay… ¡luego cuéntalos!', pt: 'Dê um palpite — depois conte para descobrir!', it: 'Indovina quante sono, poi conta e scopri!', nl: 'Schat hoeveel — tel dan na!' },
      estimateHint: { en: 'How many do you think? Slide your wish, then lock it.', de: 'Wie viele sind es wohl? Schieb deinen Wunsch hin und halt ihn fest.', fr: 'Combien, à ton avis ? Fais glisser ton idée, puis valide-la.', es: '¿Cuántos crees que hay? Desliza tu estimación y déjala lista.', pt: 'Quantos você acha? Deslize seu palpite e trave.', it: 'Secondo te quante sono? Fai scivolare la tua idea, poi bloccala.', nl: 'Hoeveel denk je? Schuif je schatting en zet die vast.' },
      estimateRefHint: { en: 'This jar had {n}. How many in the new one?', de: 'In diesem Glas waren {n}. Wie viele sind wohl im neuen?', fr: 'Ce bocal en avait {n}. Et dans le nouveau, combien ?', es: 'Este frasco tenía {n}. ¿Cuántos habrá en el nuevo?', pt: 'Este frasco tinha {n}. Quantos tem no novo?', it: 'Questo ne aveva {n}. Quante nel nuovo?', nl: 'In dit glas zaten er {n}. Hoeveel in het nieuwe?' },
      binaryHint: { en: 'More or fewer than {n}? Take a guess!', de: 'Mehr oder weniger als {n}? Schätz mal!', fr: 'Plus ou moins que {n} ? Lance-toi, devine !', es: '¿Más o menos que {n}? ¿Tú qué crees?', pt: 'Mais ou menos que {n}? Dê um palpite!', it: 'Di più o di meno di {n}? Prova a indovinare!', nl: 'Meer of minder dan {n}? Schat maar!' },
      whichHint: { en: 'Which jar has more — A or B?', de: 'In welchem Glas sind mehr – A oder B?', fr: 'Quel bocal en a le plus — A ou B ?', es: '¿Cuál frasco tiene más: A o B?', pt: 'Qual frasco tem mais — A ou B?', it: 'Quale barattolo ne ha di più: A o B?', nl: 'In welk glas zitten er meer — A of B?' },
      countHint: { en: 'Tap each sweet to count them, one by one.', de: 'Tippe jedes Bonbon an und zähl eins nach dem anderen.', fr: 'Touche chaque bonbon pour les compter, un par un.', es: 'Toca cada dulce y cuéntalos uno por uno.', pt: 'Toque em cada docinho para contar, um por um.', it: 'Tocca ogni caramella per contarle, a una a una.', nl: 'Tik op elk snoepje om ze één voor één te tellen.' },
      countAHint: { en: 'Count jar A — tap each sweet.', de: 'Zähl Glas A – tippe jedes Bonbon an.', fr: 'Compte le bocal A — touche chaque bonbon.', es: 'Cuenta el frasco A: toca cada dulce.', pt: 'Conte o frasco A — toque em cada docinho.', it: 'Conta il barattolo A: tocca ogni caramella.', nl: 'Tel glas A — tik op elk snoepje.' },
      countBHint: { en: 'Now count jar B — tap each sweet.', de: 'Jetzt zähl Glas B – tippe jedes Bonbon an.', fr: 'Maintenant compte le bocal B — touche chaque bonbon.', es: 'Ahora cuenta el frasco B: toca cada dulce.', pt: 'Agora conte o frasco B — toque em cada docinho.', it: 'Ora conta il barattolo B: tocca ogni caramella.', nl: 'Tel nu glas B — tik op elk snoepje.' },
      compareHint: { en: 'Let\'s see how many there really were!', de: 'Mal sehen, wie viele es wirklich waren!', fr: 'Voyons combien il y en avait vraiment !', es: '¡Vamos a ver cuántos había de verdad!', pt: 'Vamos ver quantos tinha de verdade!', it: 'Vediamo quante erano davvero!', nl: 'Eens kijken hoeveel het er echt waren!' },
      lock: { en: 'Lock my wish 🌟', de: 'Mein Wunsch steht 🌟', fr: 'Je valide mon idée 🌟', es: '¡Ya está mi estimación! 🌟', pt: 'Travar meu palpite 🌟', it: 'Blocca la mia idea 🌟', nl: 'Zet mijn schatting vast 🌟' },
      moreBtn: { en: 'More', de: 'Mehr', fr: 'Plus', es: 'Más', pt: 'Mais', it: 'Di più', nl: 'Meer' },
      fewerBtn: { en: 'Fewer', de: 'Weniger', fr: 'Moins', es: 'Menos', pt: 'Menos', it: 'Di meno', nl: 'Minder' },
      jarABtn: { en: 'Jar A', de: 'Glas A', fr: 'Bocal A', es: 'Frasco A', pt: 'Frasco A', it: 'Barattolo A', nl: 'Glas A' },
      jarBBtn: { en: 'Jar B', de: 'Glas B', fr: 'Bocal B', es: 'Frasco B', pt: 'Frasco B', it: 'Barattolo B', nl: 'Glas B' },
      wish: { en: 'Wish', de: 'Wunsch', fr: 'Ton idée', es: 'Tu estimación', pt: 'Palpite', it: 'Idea', nl: 'Schatting' },
      counted: { en: 'Counted', de: 'Gezählt', fr: 'Comptés', es: 'Contados', pt: 'Contados', it: 'Contate', nl: 'Geteld' },
      revealSlider: { en: 'You wondered {g} — it was {a}!', de: 'Dein Wunsch war {g} – es waren {a}!', fr: 'Tu pensais {g} — il y en avait {a} !', es: 'Tu estimación fue {g}… ¡y había {a}!', pt: 'Seu palpite foi {g} — o frasco tinha {a}!', it: 'Tu pensavi {g}... erano {a}!', nl: 'Jij schatte {g} — het waren er {a}!' },
      dirSame: { en: 'Just what you thought! 🎉', de: 'Genau wie gedacht! 🎉', fr: 'Exactement comme tu pensais ! 🎉', es: '¡Tal como pensabas! 🎉', pt: 'Bem o que você pensou! 🎉', it: 'Proprio come pensavi! 🎉', nl: 'Precies wat je dacht! 🎉' },
      dirMore: { en: 'More than you thought — jars surprise us!', de: 'Mehr als gedacht – Gläser überraschen uns!', fr: 'Plus que tu pensais — les bocaux nous surprennent !', es: '¡Más de lo que pensabas! Los frascos nos sorprenden.', pt: 'Mais do que você pensou — os frascos surpreendem!', it: 'Di più di quante pensavi... i barattoli ci sorprendono!', nl: 'Meer dan je dacht — een glas kan je verrassen!' },
      dirFewer: { en: 'Fewer than you thought — now we know!', de: 'Weniger als gedacht – jetzt wissen wir\'s!', fr: 'Moins que tu pensais — maintenant on le sait !', es: '¡Menos de lo que pensabas! Ahora ya lo sabemos.', pt: 'Menos do que você pensou — agora a gente sabe!', it: 'Di meno di quante pensavi... ora lo sappiamo!', nl: 'Minder dan je dacht — nu weten we het!' },
      revealWhich: { en: 'Jar A had {a}, Jar B had {b}.', de: 'In Glas A waren {a}, in Glas B waren {b}.', fr: 'Le bocal A en avait {a}, le bocal B en avait {b}.', es: 'El frasco A tenía {a} y el frasco B tenía {b}.', pt: 'O frasco A tinha {a}, o frasco B tinha {b}.', it: 'Il barattolo A ne aveva {a}, il barattolo B ne aveva {b}.', nl: 'In glas A zaten er {a}, in glas B {b}.' },
      whichMore: { en: 'Jar {j} had more!', de: 'In Glas {j} waren mehr!', fr: 'Le bocal {j} en avait le plus !', es: '¡El frasco {j} tenía más!', pt: 'O frasco {j} tinha mais!', it: 'Il barattolo {j} ne ha di più!', nl: 'In glas {j} zaten er meer!' },
      whichSame: { en: 'They had the same — twins!', de: 'Gleich viele – wie Zwillinge!', fr: 'Ils en avaient autant — comme des jumeaux !', es: '¡Iguales, como gemelos!', pt: 'Os dois tinham a mesma quantidade — gêmeos!', it: 'Erano uguali... gemelli!', nl: 'Allebei evenveel — net een tweeling!' },
      win: { en: 'Now we know! 🦉', de: 'Jetzt wissen wir\'s! 🦉', fr: 'Maintenant on le sait ! 🦉', es: '¡Ahora ya lo sabemos! 🦉', pt: 'Agora a gente sabe! 🦉', it: 'Ora lo sappiamo! 🦉', nl: 'Nu weten we het! 🦉' },
      hintCheck: { en: 'Make a wish, count the jar, then see!', de: 'Wünsch dir was, zähl das Glas, dann schau!', fr: 'Devine combien, compte le bocal, puis regarde !', es: 'Haz tu estimación, cuenta el frasco y ¡mira!', pt: 'Dê um palpite, conte o frasco e veja!', it: 'Esprimi la tua idea, conta il barattolo, poi guarda!', nl: 'Doe een schatting, tel het glas en kijk dan!' },
      jarN: { en: 'Jar {n}', de: 'Glas {n}', fr: 'Bocal {n}', es: 'Frasco {n}', pt: 'Frasco {n}', it: 'Barattolo {n}', nl: 'Glas {n}' },
      vsLabel: { en: 'vs', de: 'gegen', fr: 'contre', es: 'y', pt: '×', it: 'contro', nl: 'tegen' }
    },
    defaults: {},
