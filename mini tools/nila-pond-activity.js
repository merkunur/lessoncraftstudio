...
(function (global) {
  ...
  function speak(text, rate) {
    try {
      var _tts = (LANG === 'pt' ? 'pt-BR' : LANG === 'it' ? 'it-IT' : LANG === 'nl' ? 'nl-NL' : LANG);
  ...
  function nilaSVG(mood) {
    ...
    return '<svg class="np-nila-svg" viewBox="0 0 108 100" role="img" aria-label="' + (LANG === 'fr' ? 'Nila la loutre' : LANG === 'de' ? 'Nila die Otterdame' : LANG === 'es' ? 'Nila la nutria' : LANG === 'pt' ? 'Nila, a lontra' : LANG === 'it' ? 'Nila la lontra' : LANG === 'nl' ? 'Nila de otter' : 'Nila the otter') + '">'
  ...
  global.NilaPondActivity = {
    ...
    strings: {
      title: { en: "Nila's Idea Pond", de: 'Nilas Ideen-Teich', fr: 'L’étang aux idées de Nila', es: 'El estanque de ideas de Nila', pt: 'O lago de ideias da Nila', it: 'Lo stagno delle idee di Nila', nl: 'De ideevijver van Nila' },
      instruction: { en: '', de: '', fr: '', es: '', pt: '', it: '', nl: '' },
      prompt: { en: "What's the big idea?", de: 'Worum geht es?', fr: 'De quoi parle ce texte ?', es: '¿De qué trata?', pt: 'Qual é a ideia principal?', it: 'Di che cosa parla?', nl: 'Waar gaat het over?' },
      readAgain: { en: '🔊 Read again', de: '🔊 Nochmal vorlesen', fr: '🔊 Écouter encore', es: '🔊 Leer otra vez', pt: '🔊 Ouvir de novo', it: '🔊 Ascolta ancora', nl: '🔊 Nog eens voorlezen' },
      commit: { en: "That's the big idea!", de: 'Das ist die Hauptsache!', fr: 'C’est l’idée principale !', es: '¡Esa es la idea principal!', pt: 'Essa é a ideia principal!', it: 'Questa è la cosa più importante!', nl: 'Dat is waar het over gaat!' },
      schoolHint: { en: 'Bring the true details home. Send back the one that was NOT in the story.', de: 'Bring die echten Details nach Hause – und schick den Fisch zurück, der nicht in der Geschichte war.', fr: 'Ramène à la maison les détails vrais. Renvoie celui qui n’était PAS dans l’histoire.', es: 'Lleva a casa los detalles verdaderos. Regresa el que NO estaba en la historia.', pt: 'Leve os detalhes verdadeiros pra casa. Devolva o que NÃO estava na história.', it: 'Porta a casa i dettagli veri. Rimanda indietro quello che non era nella storia.', nl: 'Breng de echte details naar huis — en stuur het visje terug dat niet in het verhaal zat.' },
      supplyHint: { en: 'Which one was in the story?', de: 'Welcher von diesen zwei kam in der Geschichte vor?', fr: 'Lequel était dans l’histoire ?', es: '¿Cuál de estos dos estaba en la historia?', pt: 'Qual estava na história?', it: 'Quale di questi era nella storia?', nl: 'Welk van deze twee zat in het verhaal?' },
      pondLabel: { en: 'Back to the pond', de: 'Zurück in den Teich', fr: 'Retour à l’étang', es: 'De vuelta al estanque', pt: 'Voltar ao lago', it: 'Torna allo stagno', nl: 'Terug naar de vijver' },
      slotLabel: { en: 'Detail', de: 'Detail', fr: 'Détail', es: 'Detalle', pt: 'Detalhe', it: 'Dettaglio', nl: 'Detail' },
      nilaListen: { en: 'Listen to the little story…', de: 'Hör dir die kleine Geschichte an …', fr: 'Écoute la petite histoire…', es: 'Escucha la pequeña historia…', pt: 'Escute a historinha…', it: 'Ascolta la piccola storia…', nl: 'Luister goed naar het verhaal.' },
      nilaPickFirst: { en: 'Tap a fish, then tell me the big idea!', de: 'Tipp einen Fisch an und sag mir, worum es geht.', fr: 'Touche un poisson, puis dis-moi l’idée principale !', es: 'Toca un pez y dime de qué trata.', pt: 'Toque num peixinho e me diga a ideia!', it: 'Tocca un pesce, poi dimmi la cosa più importante!', nl: 'Kies een visje en vertel me waar het over gaat.' },
      nilaWrong: { en: "Hmm — let's listen again.", de: 'Hmm – hören wir noch einmal zu.', fr: 'Hmm… on écoute encore une fois.', es: 'Mmm… escuchemos otra vez.', pt: 'Hmm — vamos ouvir de novo.', it: 'Mmm… ascoltiamo di nuovo.', nl: 'Bijna! Probeer het nog eens.' },
      nilaSchool: { en: 'Now bring the true details home!', de: 'Jetzt bring die echten Details nach Hause.', fr: 'Maintenant, ramène les détails vrais à la maison !', es: '¡Ahora lleva a casa los detalles verdaderos!', pt: 'Agora leve os detalhes verdadeiros pra casa!', it: 'Ora porta a casa i dettagli veri!', nl: 'Breng nu de echte details naar huis!' },
      nilaWin: { en: 'You found the big idea!', de: 'Du hast die Hauptsache gefunden!', fr: 'Tu as trouvé l’idée principale !', es: '¡Encontraste la idea principal!', pt: 'Achou a ideia principal!', it: 'Sì! Hai trovato la cosa più importante!', nl: 'Goed gedaan! Je hebt het gevonden!' },
      hintCheck: { en: 'Find the big idea first, then tap Check!', de: 'Finde zuerst die Hauptsache, dann tippe auf „Prüfen".', fr: 'Trouve d’abord l’idée principale, puis touche Vérifier !', es: 'Encuentra primero la idea principal y luego toca Comprobar.', pt: 'Ache a ideia principal e toque em Verificar!', it: 'Prima trova la cosa più importante, poi tocca Controlla!', nl: 'Zoek eerst het grote idee, tik dan op Controleren.' },
      retellPrefix: { en: 'So it was all about this. ', de: 'Es ging also die ganze Zeit um das hier: ', fr: 'C’est donc ça, l’idée principale : ', es: 'Así que de eso trataba todo: ', pt: 'Então era disso que tudo falava: ', it: 'Quindi parlava soprattutto di questo: ', nl: 'Het ging dus steeds hierover: ' }
    },
    defaults: {},
