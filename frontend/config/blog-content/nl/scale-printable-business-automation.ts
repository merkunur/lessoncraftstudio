...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Van handmatig werk naar geautomatiseerde productie en verkoop',
    description: 'Van handmatig werk naar geautomatiseerde productie en verkoop. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
