...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Selecciona entre dos modos. El modo Objeto Oculto (predeterminado) crea escenas clásicas de yo espío — imágenes dispersas en una cuadrícula configurable donde los usuarios buscan objetos específicos. El modo Identificación de Letras activa una cuadrícula de alfabeto específica por idioma con letras acentuadas y genera escenas yo espío usando imágenes que empiezan con la letra seleccionada. El encabezado autogenerado cambia automáticamente entre \"Yo Espío\" e \"Identificación de Letras\" (localizado en los 11 idiomas) según tu selección.',
      },
      {
        title: 'Configura la Densidad de Cuadrícula para Control de Dificultad',
        description: 'Ajusta las dimensiones de la cuadrícula usando filas (5–10) y columnas (5–10) — el valor predeterminado es 6×6 (36 celdas). Una cuadrícula de 5×5 (25 celdas) crea fichas más fáciles con imágenes más grandes para usuarios más pequeños. Una cuadrícula de 10×10 (100 celdas) crea escenas densas y desafiantes para usuarios avanzados. Cada celda muestra una imagen con un tamaño máximo de 80px, con una reducción de tamaño del 5% en el modo Identificación de Letras. El tamaño de cuadrícula es tu control principal de dificultad — cuadrículas más pequeñas para productos de preescolar, más grandes para primaria y superiores.',
      },
      {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'El tamaño de cuadrícula controla directamente la dificultad del yo espío. Una cuadrícula de 5×5 (25 celdas) crea fichas fáciles con imágenes grandes y claramente visibles — perfecta para productos de preescolar. Una cuadrícula de 7×7 (49 celdas) equilibra desafío y claridad para usuarios de primaria. Una cuadrícula de 10×10 (100 celdas) crea escenas densas y desafiantes donde encontrar objetos específicos requiere esfuerzo genuino. Crea packs de dificultad progresiva con secciones claramente etiquetadas fácil (5×5), medio (7×7) y difícil (10×10) — los compradores pagan precios premium por productos que crecen con el usuario.',
    },
    {
    ...
    },
    {
      ...
      description: 'La clave de respuesta autogenerada con anotaciones rojas de círculo, cuadrado, cruz y conteo es tu diferenciador de venta más fuerte. Siempre incluye imágenes de vista previa de la clave de respuesta en tus listados de marketplace — muestra las anotaciones rojas claramente en las fotos del producto. Los productos que incluyen claves de respuesta superan consistentemente en ventas a los listados solo con fichas porque vendedores y padres quieren materiales de autocorrección que ahorran tiempo de valor percibido. El sistema de doble lienzo genera ambas versiones simultáneamente, así que incluir la clave de respuesta no te cuesta tiempo extra de producción.',
    },
    {
      title: 'Usa el Tipo de Tarea Contar para Productos Adyacentes a Matemáticas',
      description: 'El tipo de tarea contar transforma yo espío de una actividad de búsqueda visual en un ejercicio de conteo y observación. Los usuarios buscan todas las instancias de un objeto objetivo (aparecen 1–5 aleatoriamente) y escriben el total. Esto posiciona tus fichas yo espío tanto en las categorías de \"búsqueda visual\" como de \"conteo/aritmética\" en los marketplaces. Crea packs dedicados de yo espío de conteo donde cada objeto objetivo usa el tipo de tarea contar — los compradores que buscan \"fichas de conteo\" y \"fichas yo espío\" encuentran tu producto.',
    },
    {
      title: 'Usa Escala de Grises para Productos Económicos del mercado y KDP',
      description: 'Activa escala de grises para crear fichas yo espío que ahorran tinta específicamente para el mercado del mercados y trabajo desde casa. Muchos vendedores imprimen fichas en impresoras blanco y negro y valoran productos optimizados para escala de grises. Crea packs de doble formato que incluyan versiones en color y escala de grises de las mismas fichas — los compradores perciben esto como el doble de valor. Los interiores de impresión bajo demanda de KDP también se benefician de la optimización en escala de grises ya que la impresión en color cuesta significativamente más.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Los cuatro tipos de tarea son rodear (dibujar un círculo alrededor del objeto), cuadrado (poner un cuadrado alrededor del objeto), tachar (tachar el objeto) y contar (contar cuántas instancias aparecen y escribir el número). Sí, puedes asignar un tipo de tarea diferente a cada uno de los hasta 4 objetos objetivo en una sola ficha. Por ejemplo, una ficha puede pedir a los usuarios rodear todos los gatos, tachar todos los perros, contar todas las aves y poner un cuadrado alrededor de todos los peces — cuatro tareas distintas en una sola página.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Configura filas de 5 a 10 y columnas de 5 a 10 en el panel de Configuración de Página. El valor predeterminado es 6×6 (36 celdas). Una cuadrícula de 5×5 (25 celdas) crea fichas más fáciles con imágenes más grandes — ideal para usuarios más pequeños. Una cuadrícula de 10×10 (100 celdas) crea escenas densas y desafiantes para usuarios avanzados. Cada celda muestra una imagen con un tamaño máximo de 80px, con una reducción de tamaño del 5% en el modo Identificación de Letras. Los objetos objetivo aparecen 1–5 veces cada uno, con las celdas restantes rellenadas por imágenes distractoras aleatorias del tema.',
    },
    {
