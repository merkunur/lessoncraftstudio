...
(function (global) {
  ...
  global.MosaicMendersActivity = {
    ...
    strings: {
      /* nl — native ensemble (linguïst + pedagoog groep 6). Oppervlakte door tegeltjes tellen;
         behoud van oppervlakte (dezelfde oppervlakte, andere vorm). Eenheid in de strings =
         "tegeltje" (thematisch, het is een mozaïek); prose gebruikt "vierkantje" (rekenanker).
