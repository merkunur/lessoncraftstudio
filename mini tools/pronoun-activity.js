...
(function (global) {
  ...
  var L = {
    ...
    es: {
      q: '¿Cuál palabra completa la oración?',
      win: '¡Sí! {note}', hear: '🔊 Escúchala',
      noteSubject: '¡Aquí alguien HACE la acción!',
      noteObject: '¡Aquí le pasa algo a alguien!',
      notePossessive: '¡Esto muestra de QUIÉN es algo!',
