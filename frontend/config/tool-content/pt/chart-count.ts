...
const content: ToolContent = {  seo: {
  ...
  businessIdeas: [
    ...
    {
      title: 'Kit Completo de Representação Gráfica no Gumroad',
      description: 'Combine fichas de gráficos pictóricos dos 104 temas num kit integral de representação gráfica no Gumroad. Inclua mais de 200 fichas abrangendo todos os temas principais, cada uma com o seu gabarito autogerado — mais de 400 ficheiros no total. O formato de kit justifica preços premium porque os compradores obtêm uma biblioteca completa em vez de pacotes individuais. Adicione novas coleções sazonais trimestralmente para impulsionar compras recorrentes. O fluxo de quatro ficheiros por sessão (ficha JPEG, ficha PDF, gabarito JPEG, gabarito PDF) permite criar todo o kit de forma eficiente e sistemática.',
      platform: 'Gumroad',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'A grelha 4×5 de imagens dispersas distribui aleatoriamente 20 ícones de 6 tipos com cada tipo aparecendo entre 1 e 5 vezes. Cada clique em Gerar produz um desafio de contagem diferente mesmo com as mesmas 6 imagens selecionadas. Use isto para criar rapidamente pacotes grandes de fichas onde nenhuma página é idêntica. Gere 15–20 fichas por tema em minutos, cada uma com a sua própria distribuição única e gabarito correspondente.',
    },
    {
      title: 'Use Fundos e Bordas Temáticas em Conjunto',
      description: 'Ao contrário de aplicações com apenas bordas temáticas, o Gerador de Gráficos de Contagem oferece fundos e bordas temáticas independentes com controlos de opacidade separados. Configure um fundo de aguarela subtil a 15–25 % de opacidade para adicionar calor visual sem distrair da grelha de imagens e do gráfico de barras. Sobreponha uma borda decorativa a 80–100 % de opacidade para um enquadramento polido. Esta abordagem de tema duplo cria fichas de aspeto profissional que se destacam nas listagens dos mercados. Um estilo consistente de fundo e borda em todo um pacote cria um aspeto de produto coeso.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Quando gera uma ficha, a aplicação cria simultaneamente um gabarito correspondente num separador de canvas separado. O gabarito mostra a mesma grelha de imagens e gráfico de barras, mas as células corretas do gráfico estão preenchidas com destaque amarelo (#FFC857). Alterne entre os separadores de Ficha e Gabarito para comparar. Descarregue cada versão de forma independente — ficha JPEG, ficha PDF, gabarito JPEG e gabarito PDF — obtendo quatro ficheiros prontos para produção a partir de uma única geração. O gabarito automático elimina a contagem manual e garante precisão em grandes pacotes de fichas.',
    },
    {
      question: 'Como escolho as imagens para a ficha?',
  ...
  internalLinks: [
    { pageType: 'app', slug: 'grafico-pictorico-fichas', anchorText: 'Fichas de Gráfico Pictórico — Detalhes Completos do Produto' },
  ...
  visuals: {
    ...
    videoTitle: 'Como Criar Fichas de Gráficos Pictóricos com Gabaritos Automáticos, Grelhas de Imagens Dispersas e 104 Coleções Temáticas — Tutorial Passo a Passo',
  },
};
