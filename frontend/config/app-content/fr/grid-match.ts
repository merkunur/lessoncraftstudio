...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Grilles de Correspondance | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Grilles de Correspondance professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Puzzle grille de correspondance avec images colorées',

    },
    sampleGallery: [
      { src: '/samples/english/grid match/Grid Match 1.jpeg', alt: 'Grille de correspondance', caption: 'Puzzle en grille' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Grilles de Correspondance thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Grilles de Correspondance est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'shadow-match', pageType: 'app' as const, anchorText: 'Générateur d\'Association d\'Ombres' },
    { slug: 'bingo', pageType: 'app' as const, anchorText: 'Générateur de Cartes de Bingo' },
    { slug: 'grid-match', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Grilles de Correspondance Gratuit' },
