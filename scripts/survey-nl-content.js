...
const nlBlock = tmpl.match(/\s\snl:\s*\{[\s\S]*?\},/);
if (nlBlock) {
  console.log('startCreating: ' + (nlBlock[0].match(/startCreating:\s*'([^']*)'/)?.[1] || ''));
  console.log('pairedToolPrompt present: ' + /pairedToolPrompt/.test(nlBlock[0]));
}
