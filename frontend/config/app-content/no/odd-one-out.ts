...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Finn den som ikke hører til-generator | LessonCraftStudio',
    metaDescription: 'Lag «hvem hører ikke hjemme?»-oppgaver med temabilder for logisk tenkning. Automatisk fasit. Prøv gratis.',
  },

  hero: {
    title: 'Finn den som ikke hører til-generator — Lag utskrifter å selge på Etsy og KDP',
  ...
  ctaHeading: 'Lag hvem hører ikke hjemme-oppgaver',
