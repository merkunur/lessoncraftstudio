...
const TYPE_MAP = {
  ...
  'alphabet-train':    { op: 'Alphabet-Zug',                      qual: (c) => (c.mode === 'letter-hint' ? 'mit Buchstaben-Hilfe' : '') },
...
const META_FLAVOR = {
  ...
  'alphabet-train':    (c) => (c && c.mode === 'letter-hint' ? 'ordne die Bilder nach dem Anfangsbuchstaben' : 'bringe das Alphabet in die richtige Reihenfolge'),
