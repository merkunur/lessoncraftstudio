...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Chemin d\'Images | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Chemin d\'Images professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Labyrinthe chemin d\'images avec illustrations colorées',

    },
    sampleGallery: [
      { src: '/samples/english/picture path/Picture Path 1.jpeg', alt: 'Chemin d\'images à suivre', caption: 'Suivre le bon chemin' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Chemin d\'Images thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Chemin d\'Images est-il vraiment gratuit ?',
  ...
  internalLinks: [
    { slug: 'missing-pieces', pageType: 'app' as const, anchorText: 'Générateur de Pièces Manquantes' },
    ...
    { slug: 'picture-path', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Chemin d\'Images Gratuit' },
