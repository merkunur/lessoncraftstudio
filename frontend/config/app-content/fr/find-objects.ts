...
const content: AppContent = {
  seo: {
    primaryKeyword: 'générateur fiches objets cachés à vendre',
    secondaryKeywords: [
    ...
    metaDescription: 'Créez des fiches objets cachés à vendre sur Etsy, KDP et TPT. Modes Je Vois Je Vois et Trouve l\'Intrus, placement sans chevauchement, corrigé auto. Essai gratuit avec filigrane.',
  },
  ...
  howItWorks: {
    title: 'Comment Créer des Fiches Objets Cachés en 5 Étapes',
    steps: [
      {
        title: 'Définir la mise en page',
        description:
          'Ouvrez le panneau Page & Scène et choisissez un format : Letter Portrait, Letter Paysage, A4 Portrait, A4 Paysage ou toute dimension personnalisée. Sélectionnez une couleur de fond avec le sélecteur de couleurs, choisissez un thème de fond et ajustez son opacité, puis choisissez un thème de bordure avec son propre contrôle d\'opacité indépendant. Ces choix de mise en page encadrent votre fiche d\'objets cachés avant de configurer le contenu.',
      },
      {
        title: 'Choisir le mode d\'activité',
        description:
          'Sélectionnez entre deux modes dans le panneau Sélection d\'Objets. Le mode Je Vois Je Vois (par défaut) crée des scènes d\'objets cachés en placement libre où les images sont dispersées sur la page par un algorithme sans chevauchement — pas de grille, juste une scène visuelle naturelle. Le mode Trouve l\'Intrus dispose des images appariées en rangées avec des éléments non appariés mélangés pour des activités de discrimination visuelle. Chaque mode produit un type différent de fiche cherche-et-trouve à partir de la même bibliothèque d\'images.',
      },
      {
        title: 'Sélectionner les images et configurer les quantités d\'objets',
        description:
          'Parcourez 104 collections d\'images thématiques avec plus de 3 100 illustrations colorées dans le panneau Bibliothèque d\'Images. Filtrez par thème ou recherchez par mot-clé. En mode Je Vois Je Vois, configurez 1–5 objets cachés à trouver et 8–12 objets distracteurs qui remplissent la scène. En mode Trouve l\'Intrus, réglez 8–12 images appariées et 1–5 éléments non appariés (intrus). Vous pouvez aussi importer vos propres images PNG, JPG ou GIF à utiliser avec le contenu de la bibliothèque.',
      },
      {
  ...
  keyFeatures: {
    title: 'Fonctionnalités Clés du Générateur de Fiches Cherche Objets',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Le mode Je Vois Je Vois utilise un algorithme de placement sophistiqué au lieu d\'une grille fixe. La fonction findBestPosition() essaie 50 positions aléatoires par image et sélectionne le placement avec le moins de chevauchement. Quand l\'espace se fait rare, l\'algorithme réduit adaptativement la taille des images pour en placer davantage sans encombrer la scène. Cela crée des scènes d\'objets cachés naturelles où les images sont dispersées organiquement sur toute la page — bien plus engageant que les alternatives en grille où les objets s\'alignent dans des lignes et colonnes prévisibles.',
      },
      {
        title: 'Corrigé auto-généré avec annotations en cercles',
        description:
          'Chaque fiche d\'objets cachés génère automatiquement un corrigé sur un onglet séparé. Le corrigé reproduit la disposition exacte de la fiche et dessine des cercles rouges autour des objets corrects — les cibles cachées en mode Je Vois Je Vois et les éléments non appariés en mode Trouve l\'Intrus. Les cercles sont dimensionnés 3–5 px plus grands que l\'objet pour une visibilité claire. Aucun marquage manuel, aucun fichier séparé à créer — le corrigé est toujours synchronisé avec la fiche. Cette approche à double canevas fait gagner un temps de production considérable aux vendeurs qui créent des packs d\'objets cachés.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Parcourez 104 collections d\'images thématiques couvrant les animaux, la nourriture, les véhicules, la nature, les professions, les fêtes, les sports, les saisons et des dizaines d\'autres. Chaque thème fournit un ensemble coordonné d\'illustrations colorées servant à la fois d\'objets cachés et de distracteurs dans les scènes Je Vois Je Vois, ou d\'éléments appariés et non appariés dans les fiches Trouve l\'Intrus. Filtrez par thème avec le menu déroulant ou recherchez des images par mot-clé. La Licence Commerciale inclut 10 thèmes colorés (~300 images) ; l\'Accès Complet déverrouille les 104 thèmes avec plus de 3 100 illustrations.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Le canevas Fabric.js offre un contrôle total sur chaque élément de votre fiche d\'objets cachés. Glissez, redimensionnez, pivotez et repositionnez librement images, texte et contenu généré. Les contrôles de couches gèrent l\'ordre d\'empilement. Ajoutez du texte personnalisé avec six options de police (Fredoka, Lexend Deca, Baloo 2, Nunito, Quicksand, Arial), taille et couleur réglables, et épaisseur de contour de texte de 0 à 10 par pas de 0,5. Les thèmes de fond et les thèmes de bordure ont chacun des contrôles d\'opacité indépendants. Zoom de 25 % à 300 % avec boutons de contrôle (+ 25 %, − 25 %, Réinitialiser 100 %). Annuler et rétablir jusqu\'à 20 états d\'historique avec Ctrl+Z et Ctrl+Y.',
      },
    ],
  },

  businessUseCases: {
    title: 'Comment Vendre des Fiches Objets Cachés en Ligne',
    cases: [
      {
        title: 'Packs thématiques Je Vois Je Vois sur Etsy',
        description:
          'Créez des packs de fiches Je Vois Je Vois thématiques avec les 104 collections d\'images — objets cachés animaux, Je Vois Je Vois fêtes, recherche créatures océaniques, dinosaures à trouver et des dizaines d\'autres. Chaque thème fournit assez d\'illustrations pour plusieurs scènes d\'objets cachés uniques avec une difficulté variable. Proposez 10–20 fiches d\'objets cachés par thème avec corrigés inclus, et vendez à 3 €–7 € par pack. Augmentez la difficulté en ajoutant plus d\'objets cachés (1 → 5) et plus de distracteurs (8 → 12) au fil des pages.',
        platform: 'Etsy (etsy.fr)',
      },
      {
        title: 'Cahiers d\'activités objets cachés sur Amazon KDP',
        description:
          'Compilez 40–80 fiches d\'objets cachés dans un cahier imprimé au format Amazon KDP. Structurez votre livre par difficulté progressive : les premiers chapitres cachent 1–2 objets parmi 8 distracteurs pour les débutants, les chapitres intermédiaires augmentent à 3–4 objets cachés avec 10 distracteurs, et les chapitres avancés utilisent 5 objets cachés parmi 12 distracteurs. Incluez les corrigés à la fin du livre. Le mode niveaux de gris produit des pages économiques en encre prêtes pour les intérieurs en noir et blanc. Le design uniquement visuel signifie qu\'un seul cahier fonctionne pour n\'importe quel marché linguistique.',
  ...
  internalLinks: [
    ...
    },
    {
      pageType: 'app',
      slug: 'intrus-fiches',
      anchorText: 'Générateur de Fiches Trouve l\'Intrus',
    },
    {
      pageType: 'bundle',
  ...
  visuals: {
    ...
    videoTitle: 'Comment Créer des Fiches Objets Cachés avec les Modes Je Vois Je Vois et Trouve l\'Intrus — Tutoriel Étape par Étape',
  },
};
