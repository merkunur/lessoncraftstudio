...
const content: AppContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'O modo Complete a Imagem oferece duas opções de direção de corte via botões de rádio: o corte horizontal divide as imagens em metades superior e inferior, enquanto o corte vertical divide as imagens em metades esquerda e direita. A direção de corte aplica-se às 4 imagens da atividade. O layout adapta-se automaticamente conforme a orientação da página — as páginas horizontais dispõem os elementos em 2 linhas × 4 elementos, enquanto as páginas verticais usam 2 colunas × 4 elementos para um equilíbrio visual ótimo.',
    },
    {
      question: 'Como funciona o algoritmo de derangement?',
      answer:
        'Ambos os modos utilizam um algoritmo de derangement Fisher-Yates que garante que nenhum elemento aparece na sua posição original. No modo Associação de Sombras, nenhuma silueta se situa diretamente abaixo da sua imagem correspondente. No modo Complete a Imagem, nenhuma segunda metade aparece adjacente à sua primeira metade correspondente. Isto garante que cada atividade apresenta um verdadeiro desafio de correspondência — os usuários não podem adivinhar corretamente apenas pela posição. O derangement recalcula-se em cada geração, produzindo disposições diferentes a partir das mesmas imagens.',
    },
    {
      question: 'Posso ativar ou desativar as etiquetas A/B/C/D e 1/2/3/4?',
      answer:
        'Sim. A caixa \"Mostrar Etiquetas\" no painel Configuração do Exercício (ativa por predefinição) controla se as etiquetas A, B, C, D aparecem nas imagens ou primeiras metades e se as etiquetas 1, 2, 3, 4 aparecem nas siluetas ou segundas metades. Quando as etiquetas estão ativas, os usuários escrevem pares letra-número como respostas. Quando as etiquetas estão desativas, a atividade torna-se um desafio de correspondência puramente visual sem apoio alfanumérico — útil para cadernos de puzzles ou atividades avançadas.',
    },
    {
      question: 'Por que há sempre exatamente 4 problemas por atividade?',
      answer:
        'A atividade usa um número fixo de 4 problemas de correspondência (SELECT_COUNT = 4). Isto não é configurável. Quatro elementos oferecem o equilíbrio ótimo para a correspondência de siluetas e imagens divididas: variedade suficiente para criar um verdadeiro desafio de correspondência com o derangement, mantendo cada imagem suficientemente grande para que os usuários estudem os detalhes finos das siluetas e das metades divididas. O formato constante de 4 elementos também funciona bem para produtos em pacote onde cada página tem uma densidade de conteúdo previsível.',
    },
    {
      question: 'Como funcionam os campos de nome e data?',
      answer:
        'Ative a caixa \"Incluir Campos Nome/Data\" no painel Configuração do Exercício para adicionar linhas de nome e data na parte inferior da atividade. Quando ativa, os usuários podem escrever o seu nome e a data diretamente na página impressa — essencial para a responsabilidade online e a organização das avaliações. Quando desativa, a atividade utiliza toda a área da página para o conteúdo de correspondência. Esta opção funciona com ambos os modos, Associação de Sombras e Complete a Imagem.',
    },
    {
      question: 'Como funciona o gabarito autogerado?',
      answer:
        'O gerador usa um sistema de canvas duplo com um aba de Atividade de Trabalho e um aba de Gabarito. No modo Associação de Sombras, o gabarito mostra uma grelha onde cada célula apresenta a imagem original junto à sua silueta com uma etiqueta como \"A → 2\". No modo Complete a Imagem, cada célula mostra a imagem original completa com a sua etiqueta de correspondência. A grelha usa 4 colunas com espaçamento consistente. Ambas as versões exportam-se separadamente com os quatro botões de download dedicados: atividade JPEG, atividade PDF, gabarito JPEG e gabarito PDF.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Não. A Associação de Sombras é puramente visual — o resultado da atividade contém apenas imagens, siluetas e metades divididas, sem conteúdo textual localizado. A interface da aplicação (menus, botões, texto do cabeçalho) suporta os 11 idiomas, mas a atividade gerada funciona de forma idêntica independentemente da seleção de idioma. Isto torna as atividades de associação de sombras universalmente vendáveis em todos os mercados sem tradução. A Licença Comercial inclui 10 temas coloridos; o Acesso Completo desbloqueia os 104 temas e os 11 idiomas de interface.',
    },
    {
      question: 'Posso vender atividades de associação de sombras criadas com esta ferramenta na Etsy e Amazon KDP?',
      answer:
        'Sim. Com uma licença comercial, tem todos os direitos para vender as suas atividades de associação de sombras como downloads digitais na Etsy, como cadernos impressos na Amazon KDP, como recursos educativos na Hotmart ou através de qualquer outro canal de venda. Os dois modos de exercício, as siluetas autogeradas, o algoritmo de derangement, os gabaritos automáticos e as 104 coleções de imagens temáticas dão-lhe as ferramentas criativas para produzir produtos de correspondência visual originais e vendáveis.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'guide',
      slug: 'criar-atividades-discriminacao-visual',
      anchorText: 'Criar atividades de discriminação visual',
    },
  ],
  ...
  visuals: {
    ...
    videoTitle: 'Como Criar Atividades de Associação de Sombras com Siluetas e Imagens Divididas — Tutorial Passo a Passo',
  },
};
