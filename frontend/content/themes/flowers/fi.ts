...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'kindergarten': {
      ...
      snippetAnswer: 'Kukkatyölehdet esiopetukseen (5–6-vuotiaat) kehittävät luonnontieteellistä ajattelua kasvin elinkaaren tutkimisella, vahvistavat hienomotoriikkaa yksityiskohtaisessa kasvipiirustuksessa ja tukevat matemaattista ajattelua kasvin osien laskemisen ja symmetrian kautta. Esiopetussuunnitelman ympäristökasvatuksen tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Esiopetusikäisille kukkateema avaa kasvien elinkaaren tieteellisen tarkastelun: viisi- ja kuusivuotiaat kykenevät ymmärtämään monivaiheisen prosessin siemenestä kukaksi ja jälleen siemeneksi. Tämä syklinen ajattelu on luonnontieteen perusäly ja esiopetussuunnitelman tutkivan oppimisen ydin. Suomalaisten kukkien kirjo vuodenaikojen mukaan — leskenlehdistä keväällä aurinkokukan kukkaan kesällä ja ruskaväreihin syksyllä — tarjoaa ainutlaatuisen seurantakohteen. Matemaattisesti kukat ovat symmetrian ja lukumäärien aarreaitta: kuinka monta terälehteä, onko kukka symmetrinen, miten kukat kasvavat riveissä? Kielitietoisuus kehittyy kasvisanaston kautta: varsi, lehti, terälehti, emi, hede, siemen. Hienomotoriikka saa tarkan haasteen kasvipiirustuksessa, jossa jokainen terälehti ja lehtisuoni vaatii kontrollia.',
      developmentalMilestones: [
        { milestone: 'Elinkaariajattelun ymmärtäminen (5–6-vuotiaat hahmottavat syklisen prosessin)', howWeAddress: 'Kasvin elinkaari -työlehdet, joissa järjestetään vaiheet (siemen–itu–taimi–kukka–siemen) ja piirretään kukin vaihe, kehittävät syklisIä ajattelua' },
        { milestone: 'Kasvin osien tunnistaminen ja nimeIäminen (esiopetusikäiset oppivat tieteellisen perussanaston)', howWeAddress: 'Kasvin osien nimeIämistehtävät (juuri, varsi, lehti, kukka, terälehti, siemen) kuvan avulla, rakentavat biologista sanastoa' },
        { milestone: 'Symmetrian havaitseminen luonnossa (viisi- ja kuusivuotiaat tunnistavat luonnon kuvioita)', howWeAddress: 'Kukan symmetriatehtävät, joissa piirretään toinen puolikas ja lasketaan terälehtiä, yhdistävät taiteen ja matematiikan' },
        { milestone: 'Yksityiskohtainen havainnointi ja piirtäminen (esiopetusikäiset siirtyvät skeemoista yksityiskohtiin)', howWeAddress: 'Tarkkailupiirustukset, joissa lapsi piirtää oikean kukan yksityiskohtia tarkkaillen, kehittävät havainnointitarkkuutta ja motorista kontrollia' },
      ],
      differentiationNotes: 'Tukea tarvitseville esiopetusikäisille yksinkertaista elinkaari kolmeen vaiheeseen (siemen–kasvu–kukka), käytä oikeita kasveja kuvien rinnalla ja rajaa symmetriatehtävät yksinkertaisiin kukkamuotoihin. Edistyneille esiopetusikäisille lisää kasvin kasvuolosuhteiden tutkiminen (valo, vesi, multa), haasta pitämään kasvipäiväkirjaa oman kasvatuskokeen havainnoista ja pyydä kirjoittamaan kasvin osien nimet ja tehtävät.',
      parentTakeaway: 'Kukkateema kutsuu kasvattamiseen yhdessä. Kylväkää siemeniä purkkeihin ikkunalaudalle ja seuratkaa kasvua yhdessä päivittäin: montako senttiä kasvi kasvoi, koska ensimmäinen lehti ilmestyi? Keskäretkillä tutkikaa kukkia: montako terälehteä, mikIä väri, mistä osista kukka koostuu? Piirtäkää löytämiänne kukkia. Tärkeintä on antaa lapsen ihmetellIä luonnon yksityiskohtia ja tukea hänen luontaista uteliaisuuttaan.',
      classroomIntegration: 'Kukkateema integroituu esiopetuksen kevät- ja kesäkauteen: oma kasvatuskoe on viikkojen mittainen tutkimusprojekti, luontoretkilIä havainnoidaan kukkia ja dokumentoidaan löydöt työlehdille, taideteoksiossa piirretään kukkia yksityiskohtaisesti ja matikkahetkellä lasketaan terälehtiIä ja tutkitaan symmetriaa. Esiopetussuunnitelman tutkivan oppimisen, ympäristökasvatuksen ja matemaattisen ajattelun tavoitteet yhdistyvät luonnollisesti.',
      assessmentRubric: [
        { skill: 'Kasvin elinkaaren ymmärrys', emerging: 'tunnistaa kaksi vaihetta (siemen ja kukka) aikuisen avulla', proficient: 'järjestää neljä–viisi vaihetta oikeaan järjestykseen ja selittää kunkin', advanced: 'selittää koko kiertokulun, ymmärtää syklisyyden ja kertoo kasvuolosuhteiden merkityksen' },
        { skill: 'Kasvin osien tunnistaminen', emerging: 'nimeää kaksi–kolme kasvin osaa aikuisen avulla', proficient: 'nimeää itsenäisesti viisi kasvin osaa ja osoittaa ne kuvasta', advanced: 'nimeää kaikki osat, selittää niiden tehtävät ja kirjoittaa ne' },
        { skill: 'Luonnon symmetrian havaitseminen', emerging: 'huomaa, että kukka on ”samanlainen molemmilta puolilta” aikuisen ohjaamana', proficient: 'piirtää kukan symmetrisesti peiliviivan avulla ja laskee terälehdet', advanced: 'tunnistaa symmetrian eri kukissa, vertailee kuvioita ja luo omia symmetrisiä kukkakuvioita' },
      ],
    },
    'first-grade': {
      ...
      snippetAnswer: 'Kukka-aiheiset työlehdet ensimmäiselle luokalle (6–7-vuotiaat) opettavat kasvien elinkaaren ymmärtämistä itämiskokeista kukintaan, vahvistavat mittaamistaitoja kasvun seurannassa sekä kehittävät tieteellistä dokumentointia. POPS 2014:n ympäristöopin ja tutkivan oppimisen tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Ensimmäisellä luokalla kukkateema muuttuu järjestelmälliseksi luonnontieteelliseksi tutkimukseksi, koska kuusi- ja seitsemänvuotiaat kykenevät seuraamaan pitkäkestoista prosessia ja kirjaamaan havaintoja viikkojen ajan. POPS 2014:n ympäristöopin opetussuunnitelma edellyttää, että oppilaat tutkivat kasVien kasvua ja elämänkaarta. Ensimmäisen luokan oppilas kasvattaa oman kasvin siemenestä, mittaa kasvua senttimetreissä viikoittain, kirjaa havainnot taulukkoon ja piirtää kasvudiagrammin. Kasvin osien tunnistaminen etenee päätasolle: juuri, varsi, lehdet, kukka, siemen — ja oppilas ymmärtää kunkin osan tehtävän. Luokittelu syventyy, kun kasveja ryhmiTellään elinympIäristön ja ominaisuuksien mukaan. Suomen luonnonkukkien rikkaus — sinivuokosta valkovuokkoon, kissankellosta puna-apilaan — tarjoaa tutun ja innostavan tutkimuskontekstin.',
      developmentalMilestones: [
        { milestone: 'Kasvin elinkaaren ymmärtäminen (6–7-vuotiaat hahmottavat siemenestä kukintaan -prosessin)', howWeAddress: 'Elinkaarikuvat ja järjestämistehtävät, joissa oppilas asettaa kasvin kasvun vaiheet oikeaan järjestykseen ja kirjoittaa selitykset, rakentavat prosessiajattelua' },
        { milestone: 'Kasvun mittaaminen ja dokumentointi (ensimmäisen luokan oppilaat mittaavat ja kirjaavat viikottain)', howWeAddress: 'Kasvun seurantatehtävät, joissa oppilas mittaa kasvinsa pituuden viikoittain ja piirtää kasvudiagrammin, yhdistävät mittaamisen, taulukoinnin ja diagrammiT lukutaidon' },
        { milestone: 'Kasvin osien ja niiden tehtävien tunnistaminen (kuusi- ja seitsemänvuotiaat nimeävät osat ja selittävät tehtävät)', howWeAddress: 'NimeIämistehtävät, joissa oppilas merkitsee kasvin osat kuvaan ja kirjoittaa kunkin osan tehtävän, kehittävät biologian peruskäsitteiden hallintaa' },
        { milestone: 'Kasvien luokittelu ominaisuuksien perusteella (ensimmäisen luokan oppilaat ryhmittelevät kasveja järjestelmällisesti)', howWeAddress: 'Luokittelutehtävät, joissa oppilas ryhmittelee kasveja värin, koon ja elinympIäristön mukaan, harjaannuttavat tieteellistä luokittelua' },
      ],
      differentiationNotes: 'Tukea tarvitseville ensimmäisen luokan oppilaille valitse nopeasti itäviä kasveja (papu, auringonkukka), rajaa mittaaminen kokonaisiin senttimetreihin ja anna kasvin osien nimeämiseen kuvakortit tueksi. Edistyneille ensimmäisen luokan oppilaille lisää vertailukoe (kasvu valossa vs. pimeässä), laajenna luokittelu useampiin kriteereihin ja haasta kirjoittamaan oma kasvitietoteksti kuudella lauseella.',
      parentTakeaway: 'Ensimmäisen luokan kukkatyölehdet kutsuvat yhteiseen kasvuprojektiin. Istuttakaa yhdessä siemeniä ruukkuihin ja seuratkaa kasvua viikottain: mittatkaa pituus ja piirtäkää diagrammi. Tutkikaa luonnonkukkia retkillä: minkä niminen tämä kukka on, missä se kasvaa? Leikatkaa kukka auki ja tutkikaa osia yhdessä. Tärkeintä on herättää ihmetys luonnon kasvun ihmeestä.',
      classroomIntegration: 'Kukkateema on ensimmäisen luokan kevään ympäristöopin pitkIäkestoinen projekti: luokka kasvattaa omia kasveja ikkunalaudalla, viikottain mitataan ja kirjataan työlehdille, ja lopussa analysoidaan kasvudiagrammeja yhdessä. POPS 2014:n tutkivan oppimisen, mittaamisen ja luontosuhteen tavoitteet toteutuvat konkreettisesti omien kasvien parissa.',
      assessmentRubric: [
        { skill: 'Kasvin elinkaaren ymmärtäminen', emerging: 'järjestää kolme vaihetta oikeaan järjestykseen aikuisen tuella', proficient: 'järjestää koko elinkaaren ja kirjoittaa selityksen jokaiselle vaiheelle', advanced: 'selittää elinkaaren yksityiskohtaisesti, vertailee eri kasvien elinkaaria ja ymmärtää lisääntymisen roolin' },
        { skill: 'Kasvun mittaaminen ja dokumentointi', emerging: 'mittaa kasvin pituuden aikuisen avulla ja kirjaa tuloksen', proficient: 'mittaa itsenäisesti viikoittain, kirjaa taulukkoon ja piirtää diagrammin', advanced: 'vertailee kasvunopeuksia, tekee johtopäätöksiä ja selittää kasvuun vaikuttavia tekijöitä' },
        { skill: 'Kasvin osien tunnistaminen', emerging: 'nimeää kaksi kasvin osaa kuvasta', proficient: 'nimeää kaikki pääosat ja selittää niiden tehtävät yksinkertaisesti', advanced: 'selittää osien tehtävät yksityiskohtaisesti ja yhdistää ne kasvin elinkaaren vaiheisiin' },
      ],
    },
    'second-grade': {
      ...
      snippetAnswer: 'Kukka-aiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät kasvien elinkierron ja lisääntymisen ymmärrystä siementen itIämiskokeen kautta, kehittävät kasvin osien tieteellistä nimeämistä ja dokumentointia sekä vahvistavat pölytysprosessin selittämistä kirjallisesti. POPS 2014:n ympäristöopin ja tutkivan oppimisen vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla kukkateema siirtyy estèeettisestä ihailusta tieteelliseen kasvitutkimukseen, koska seitsemän- ja kahdeksanvuotiaat kykenevät ymmärtämään elinkiertoa ja tekemIään pitkäkestoisia havaintoja. POPS 2014:n päättötavoitteet edellyttävät, että oppilas tutkii kasvien kasvua ja elinkiertoa. Toisen luokan oppilas toteuttaa siementen itämiskokeen: vertailee eri olosuhteita (valo, lämpö, kosteus) ja dokumentoi tulokset taulukkoon päivittäin. Kasvin osien tieteellinen nimeäminen syventyy: juuri, varsi, lehdet, terälehdet, hede, emi ja niiden tehtävät. Pölytysprosessin ymmärtäminen kehittyy: oppilas selittää kirjallisesti miten hyönteiset kuljettavat siitepölyä ja mikä merkitys pölytyksellä on. Matemaattisesti kasvun mittaaminen yhdistyy taulukkoon ja diagrammiin. Suomen luonnonkasvit (valkovuokko, sinivuokko, kieltämo) antavat paikallisen tutkimuskontekstin.',
      developmentalMilestones: [
        { milestone: 'Siementen itämiskokeen suunnittelu ja dokumentointi (7–8-vuotiaat tutkivat kasvuolosuhteita kokeellisesti)', howWeAddress: 'Koetehtävät, joissa oppilas kylvää siemeniä eri olosuhteisiin, mittaa itämisnopeuden ja kasvun päivittäin ja dokumentoi taulukkoon, kehittävät kokeellista tutkimusta' },
        { milestone: 'Kasvin osien tieteellinen nimeäminen ja tehtävien ymmärtäminen (toisen luokan oppilaat tunnistavat rakenteet)', howWeAddress: 'Rakennetutkimustehtävät, joissa oppilas tutkii oikeaa kukkaa, tunnistaa ja nimeää osat ja selittää niiden tehtävät, rakentavat biologista ymmärrystä' },
        { milestone: 'Pölytysprosessin selittäminen (seitsemän- ja kahdeksanvuotiaat ymmärtävät kasvien lisääntymisen alkeita)', howWeAddress: 'Prosessikuvaustehtävät, joissa oppilas selittää kirjallisesti ja kuvin miten pölytys tapahtuu ja miksi se on tärkeää, syventävät syy-seurausajattelua' },
        { milestone: 'Kasvun mittaaminen ja diagrammin piirtäminen (toisen luokan oppilaat käsittelevät kasvudataa)', howWeAddress: 'Datatehtävät, joissa oppilas mittaa kasvin kasvun viikoittain, kirjaa tulokset ja piirtää kasvudiagrammin, yhdistävät luonnontiedon ja matematiikan' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa kokeen muuttujat kahteen, anna kasvin osien tunnistuksessa kuvallinen tuki ja tarjoa pölytystekstin kirjoittamiseen lausepohjat. Edistyneille toisen luokan oppilaille laajenna koe kolmeen muuttujaan vertaillen, lisää pölyttäjien monimuotoisuuden tutkiminen ja haasta kirjoittamaan kasvin elinkierron tutkimusraportti.',
      parentTakeaway: 'Toisen luokan kukkatehtävät tekevät lapsesta kasvitutkijan. Kylväkää yhdessä siemeniä ja seuratkaa kasvua: mittatkaa ja kirjatkaa tulokset. Tutkikaa kukkia pihalta: montako terälehteä, löydättIekö heteen ja emin? Seuratkaa hyönteisiä kukilla: mitIä ne tekevät? Keskustelkaa pölytyksestä: miksi mehiläiset ovat tärkeitä? Tärkeintä on opettaa luonnon ihmeellisyyden kunnioitusta tutkimuksen kautta.',
      classroomIntegration: 'Kukkatehtävät ovat toisen luokan kevätjakson tutkimuskokonaisuus: itämiskoe ympäristöopissa, kasvun mittaaminen ja diagrammit matematiikassa, pölytysprosessin selitys äidinkielessä ja kukkien piirtäminen kuvataiteessa. Koulupihan kasvillisuuden tutkiminen yhdistää ulko-oppimisen luokkahuonetyIöhön. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa kukkateema osoittaa tutkivan oppimisen ja tieteellisen dokumentoinnin taidot.',
      assessmentRubric: [
        { skill: 'Kokeellinen kasvitutkimus', emerging: 'kylvää siemenet ohjeen mukaan mutta ei mittaa tai dokumentoi kasvua', proficient: 'toteuttaa itämiskokeen kahdella muuttujalla, mittaa ja dokumentoi tulokset taulukkoon', advanced: 'suunnittelee oman kokeen usealla muuttujalla, kontrolloi olosuhteet ja kirjoittaa tutkimusraportin' },
        { skill: 'Kasvin rakenteiden ymmärtäminen', emerging: 'tunnistaa juuret, varren ja lehdet mutta ei kukan osia', proficient: 'nimeää kukan osat (terälehdet, hede, emi) ja selittää niiden tehtävät', advanced: 'selittää kasvin osien yhteistoiminnan ja yhdistää rakenteet elinkiertoon' },
        { skill: 'Pölytysprosessin selittäminen', emerging: 'tietää että hyönteiset käyvät kukissa mutta ei selitIä miksi', proficient: 'selittää pölytysprosessin vaiheet kirjallisesti ja perustelee merkityksen', advanced: 'selittää eri pölytystavat (hyönteis-, tuuli-, vesipölytys), vertailee ja pohtii seurauksia pölyttäjien vähenemisestä' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Kukkaaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät kasvien lisääntymisjärjestelmien analyyttistä ymmärrystä, vahvistavat pölytysekologian tutkimusta data-analyysillä sekä opettavat tieteellisen tutkimusraportin kirjoittamista kasvien sopeutumisesta Suomen olosuhteisiin. POPS 2014:n vuosiluokkien 3–6 ympäristöopin tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla kukkateema siirtyy kauneuden ihailusta lisääntymisbiologian ja ekologian analyysiksi, kun kahdeksan- ja yhdeksänvuotiaat kykenevät ymmärtämään kukan rakenteen toiminnallisen merkityksen. Kukan osien tutkiminen: emi, heteet, terälehdet ja verhilehdet — miksi kukin osa on olemassa. Pölytysekologian analyysi: miten hyönteiset, tuuli ja vesi pölyttävät, millaisia sopeutumia kasvit ovat kehittäneet. Kertolaskusovellukset: siementen laskeminen (8 kukkaa × 12 siementä = 96 siementä), kasvunopeuden seuranta. Tutkimusraportti kasvien sopeutumisesta Suomen lyhyeen kasvukauteen yhdistää omia havaintoja julkaistuun tietoon. Fenologinen seuranta: kukkimisajan dokumentointi ja vertailu. Argumentoiva kirjoittaminen: pölyttäjien suojelu ja luonnon monimuotoisuus.',
      developmentalMilestones: [
        { milestone: 'Kukan rakenteen toiminnallinen ymmärtäminen (8–9-vuotiaat analysoivat osien tarkoituksen)', howWeAddress: 'Rakennetutkimustehtävät, joissa oppilas tutkii kukan osia suurennuslasilla, piirtää rakennekaavion ja selittää kirjallisesti jokaisen osan toiminnallisen merkityksen' },
        { milestone: 'Pölytysekologian analysointi datalla (kolmannen luokan oppilaat tutkivat pölytysprosesseja)', howWeAddress: 'Pölytystutkimusprojektit, joissa oppilas havainnoi pölyttäjäkäyntejä, laskee niitä kertolaskulla, vertailee eri kukkien houkuttelevuutta ja raportoi tulokset diagrammeineen' },
        { milestone: 'Tieteellisen tutkimusraportin kirjoittaminen kasvien sopeutumisesta (kahdeksan- ja yhdeksänvuotiaat yhdistävät havaintoja ja lähteitä)', howWeAddress: 'Sopeutumistutkimusprojektit, joissa oppilas tutkii Suomen kasvien sopeutumista lyhyeen kasvukauteen, kerää tietoa useista lähteistä ja kirjoittaa monikappaleraportin' },
        { milestone: 'Fenologisen seurannan toteuttaminen ja analysointi (kolmannen luokan oppilaat dokumentoivat luonnon muutoksia)', howWeAddress: 'Fenologiaprojektit, joissa oppilas seuraa kukkimisaikoja, kirjaa havainnot kalenteriin, vertaa eri vuosien tietoja ja pohtii ilmastonmuutoksen vaikutusta' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille yksinkertaista kukkarakenne neljään pääosaan, anna pölytystutkimuksessa ohjattu havainnointilomake ja tarjoa raportille rakennepohja. Edistyneille kolmannen luokan oppilaille laajenna tutkimus kasvien evoluutiivisiin sopeutumiin, lisää geneettisen monimuotoisuuden perusteet ja haasta suunnittelemaan pitkIäkestoinen pölyttäjäseurantaprojekti.',
      parentTakeaway: 'Kolmannen luokan kukkatyölehdet kehittävät tieteellistä havainnointia ja biologista ymmärrystä. Tutkikaa yhdessä kukkia suurennuslasilla: löydätteko emin, heteet? Havainnoikaa pölyttäjiä puutarhassa: montako hyönteistä vierailee 10 minuutissa? Seuratkaa kukkimisaikoja keväästä syksyyn. Tärkeintä on ymmärtää kukkien merkitys ekosysteemeille ja pölyttäjien suojelun tarve.',
      classroomIntegration: 'Kukkatyölehdet integroituvat kolmannen luokan ympäristöoppiin ja äidinkieleen: kukkarakenteen tutkimus biologiajaksossa, pölytyshavainnointi luontoretkillä, sopeutumistutkimusraportti tietokirjoittamisen jaksossa ja fenologinen seuranta koko lukuvuoden läpivievänä projektina. POPS 2014:n vuosiluokkien 3–6 luonnon tutkimisen ja ympäristökasvatuksen tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Kukan rakenteen toiminnallinen ymmärrys', emerging: 'tunnistaa kukan osia mutta ei selitIä niiden tarkoitusta', proficient: 'selittää kukan pääosien toiminnallisen merkityksen ja yhdistää ne lisääntymiseen', advanced: 'analysoi erilaisten kukkien rakenteellisia eroja ja yhdistää ne pölytystrategioihin' },
        { skill: 'Pölytysekologian tutkimus datalla', emerging: 'havaitsee pölyttäjiä mutta ei kerää dataa järjestelmällisesti', proficient: 'havainnoi ja laskee pölyttäjäkäyntejä, kokoaa datan ja tekee johtopäätöksiä', advanced: 'suunnittelee oman tutkimuksen, analysoi dataa monipuolisesti ja yhdistää tulokset julkaistuun tietoon' },
        { skill: 'Tieteellinen tutkimusraportti sopeutumisesta', emerging: 'kertoo joitakin faktoja kasveista mutta ei kirjoita jäsenneltyä raporttia', proficient: 'kirjoittaa monikappaleraportin useasta lähteestä sopeutumisesta Suomen olosuhteisiin', advanced: 'yhdistää omia havaintoja julkaistuun tietoon, arvioi lähteitä kriittisesti ja esittää omia tutkimuskysymyksiä' },
      ],
    },
  },
