...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'De relatie tussen listingaantal en omzet is niet lineair',
    description: 'De relatie tussen listingaantal en omzet is niet lineair. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
