...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare roboter-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med robotertema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Roboter-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare roboter-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'robotoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, teknologi, programmeringstenkning, STEM-læring, robotøvelser førskole, roboters læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Roboter-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare roboter-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'robotoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, teknologi, programmeringstenkning, STEM-læring, robotøvelser barnehage, roboters læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Roboter-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare roboter-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'robotoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, teknologi, programmeringstenkning, STEM-læring, robotøvelser 1. klasse, roboters læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Roboter-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare roboter-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'robotoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, teknologi, programmeringstenkning, STEM-læring, robotøvelser 2. klasse, roboters læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Roboter-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare roboter-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'robotoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, teknologi, programmeringstenkning, STEM-læring, robotøvelser 3. klasse, roboters læring 8-9 år',
