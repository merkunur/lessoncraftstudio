...
const daToolText: Record<string, FrTextTuple> = {
  ...
  wordsearch: ['Find ordene!', 'Ordsøgning med tematiske ordforråd', 'Tre søgeniveauer', 'Fra enkle til udfordrende gitter', 'Lille gitter (6 ord)', 'Mellemstort (10 ord)', 'Stort gitter (15+ ord)', 'Ordsøgning skærper fokus', 'Ordsøgning!', 'Søg og find', 'Professionelle opgaveark', 'Tematiske ordsøgninger'],
...
const noToolText: Record<string, FrTextTuple> = {
  ...
  wordsearch: ['Finn ordene!', 'Ordsok med tematiske ordforrad', 'Tre sokenivaer', 'Fra enkle til utfordrende rutenett', 'Lite rutenett (6 ord)', 'Mellomstort (10 ord)', 'Stort rutenett (15+ ord)', 'Ordsok skjerper fokus', 'Ordsok!', 'Sok og finn', 'Profesjonelle arbeidsark', 'Tematiske ordsok'],
...
const fiToolText: Record<string, FrTextTuple> = {
  ...
  wordsearch: ['Loyda sanat!', 'Sanahaku temaattisilla sanastoilla', 'Kolme hakutasoa', 'Yksinkertaisista haastaviin ruudukkoihin', 'Pieni ruudukko (6 sanaa)', 'Keskikokoinen (10 sanaa)', 'Suuri ruudukko (15+ sanaa)', 'Sanahaku terävöittaa keskittymista', 'Sanahaku!', 'Etsi ja loyda', 'Ammattimaiset tyolehdet', 'Temaattiset sanahaut'],
