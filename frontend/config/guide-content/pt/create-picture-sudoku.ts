...
const content: GuideContent = {
  ...
  hero: {
    ...
    tagline: 'Um tutorial passo a passo para criar puzzles de sudoku 4×4 baseados em imagens que pode vender no Etsy, Amazon KDP e Teachers Pay Teachers',
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Um complemento de lógica visual que cria fichas de reconhecimento de padrões. Os produtos de padrões e sudoku agrupam-se bem para coleções completas de lógica de aprendizagem precoce.',
    },
    {
      appId: 'matching',
  ...
  visuals: {
    heroImage: { src: '/samples/english/sudoku/sudoku_worksheet.webp', alt: 'Ficha de sudoku com imagens mostrando um puzzle de lógica 4×4 com imagens temáticas para aprendizes jovens' },
    samples: [
      { src: '/samples/english/sudoku/sudoku_worksheet.webp', alt: 'Puzzle de sudoku 4×4 baseado em imagens com tema de animais para crianças de pré-escolar', caption: 'Sudoku com imagens de dificuldade fácil usando o tema de animais da quinta com quatro células em branco' },
      { src: '/samples/english/sudoku/sudoku_worksheet.webp', alt: 'Chave de respostas de sudoku com imagens mostrando a grelha completa de 4×4 com todas as imagens preenchidas', caption: 'Chave de respostas automática gerada junto com cada puzzle de sudoku com imagens' },
    ],
