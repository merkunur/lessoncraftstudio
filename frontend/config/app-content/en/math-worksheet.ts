...
const content: AppContent = {
  seo: {
    primaryKeyword: 'math worksheet generator sell Etsy KDP',
    secondaryKeywords: [
    ...
    titleTag: 'Math Worksheet Generator | Sell on Etsy & KDP',
    metaDescription: 'Create math drill worksheets with all operations & auto answer keys. Try free with watermark. Commercial license for Etsy, KDP & TPT. $49 one-time.',
  },
    ...
    steps: [
      {
        ...
        description:
          'Open the Page Setup panel and pick a page size: Letter Portrait, Letter Landscape, A4 Portrait, A4 Landscape, Default Worksheet (800×1000), Square (1200×1200), or any custom dimension you need. Choose a background color, select a decorative background theme from the image library, and adjust opacity to keep the equations readable. Add a matching border frame to give worksheets a polished, print-ready appearance.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Open the Image Library panel and browse 104 themes — from animals and food to vehicles and holidays. Use the search bar to find specific images instantly. Pick your image selection mode: Select Images Individually to hand-pick at least 8 specific images, or Use Full Theme to include every image in a theme. Each puzzle draws from your selections to assign images as variable symbols. You can also upload your own custom images for a completely unique look that matches your brand or product line.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Switch to the Answer Key tab and click Generate Answer Key to create a solved version showing every image\'s numeric value. Then open the Download menu and export both the worksheet and its answer key as high-resolution JPEG or print-ready PDF. Toggle grayscale export for ink-friendly versions. Every export renders at 400+ DPI so your algebra puzzles look crisp whether printed at home, uploaded to Etsy, or included in an Amazon KDP activity book.',
      },
    ],
  },
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'The built-in Fabric.js canvas lets you drag, resize, rotate, and reposition every element on the page — text, puzzle blocks, borders, and backgrounds. Use layer controls to manage element stacking, alignment tools for pixel-perfect placement, and lock/unlock to protect positioned elements while editing others. Unlimited undo and redo let you experiment freely, giving you the layout flexibility of a graphic design tool inside a worksheet generator.',
      },
    ],
  },
  ...
  visuals: {
    ...
    videoTitle: 'How to Create Algebra Picture-Puzzle Worksheets — Step-by-Step Tutorial',
  },
};
