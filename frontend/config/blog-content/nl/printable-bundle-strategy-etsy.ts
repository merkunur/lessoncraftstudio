...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Bundels zijn de snelste weg naar hogere omzet per verkoop',
    description: 'Bundels zijn de snelste weg naar hogere omzet per verkoop. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
