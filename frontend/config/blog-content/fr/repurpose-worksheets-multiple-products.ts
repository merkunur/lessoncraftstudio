...
const content: BlogContent = {
  ...
  hero: {
    title: 'Recycler vos fiches en 5 produits différents',
    tagline: 'Un contenu, cinq sources de revenus',
    description: 'Transformez une fiche en 5 produits différents. Fiches individuelles, bundles, cahiers KDP et plus. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour recycler fiches plusieurs produits. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
