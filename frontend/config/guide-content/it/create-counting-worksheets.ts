...
const content: GuideContent = {
  ...
  platformTips: [
    ...
    {
      heading: 'Vendere Schede di Grafici per Immagini su Gumroad',
      content: 'Gumroad (Gumroad) è dove gli imprenditori cercano specificamente risorse allineate al mercato, e i grafici per immagini sono un obiettivo di apprendimento standard nei curricula di matematica dei negozi elementari.\n\nLe descrizioni dei prodotti su Gumroad dovrebbero fare riferimento a competenze specifiche: raccolta dati, rappresentazione dati, grafici per immagini, grafici a barre, conteggio e creazione di grafici. Menziona il livello scolastico (dalla scuola dell\'infanzia alla seconda elementare), il numero di schede e chiavi di risposta incluse, e l\'allineamento agli standard di dati e misure.\n\nFile di anteprima: Gumroad ti permette di caricare un file di anteprima. Includi 2–3 schede campione che mostrano la griglia di immagini sparse e il grafico a barre, più una chiave di risposta con le celle evidenziate in giallo. Gli acquirenti devono vedere il formato a doppio componente (griglia di conteggio + grafico) e la chiave di risposta inclusa prima di acquistare.\n\nPositionamento per centri di matematica: i venditori acquistano molto risorse etichettate come \"attività per centri di matematica.\" Le schede di grafici per immagini con campi nome/data integrati sono ideali per centri di matematica indipendenti dove gli utenti lavorano autonomamente sulle attività di conteggio e grafici. Posiziona i tuoi prodotti come \"pronti per il centro di matematica\" o \"stampa e usa\" per catturare questo traffico di ricerca.\n\nParole chiave specifiche per Gumroad: \"centro di matematica,\" \"dati e grafici,\" \"attività grafico per immagini,\" \"conteggio e grafici,\" \"rappresentazione dati,\" \"lavoro del mattino,\" \"valutazione\" e \"pratica indipendente.\" Questi termini corrispondono a come i venditori pensano e cercano risorse per il negozio.\n\nBundling su Gumroad: i venditori comprano bundle per intere unità. Un \"Bundle Completo Grafici Scuola dell\'Infanzia\" con 50 schede di grafici per immagini che coprono temi multipli con chiavi di risposta per ciascuna è un prodotto Gumroad efficace.',
    },
  ],
  ...
  faq: [
    {
      ...
      answer: 'Ogni scheda ha due sezioni collegate. La sezione superiore mostra una griglia 4×5 contenente 20 icone sparse da 6 tipi diversi di immagini, con ogni tipo che appare da 1 a 5 volte in una distribuzione casuale. La sezione inferiore mostra un grafico a barre a 6 colonne × 5 righe con colonne etichettate per ogni tipo di immagine e righe numerate da 1 a 5. gli utenti contano quante volte ogni tipo di immagine appare nella griglia, poi colorano o riempiono il numero corrispondente di celle nella colonna corrispondente. Questo insegna sia la raccolta dati che la rappresentazione dei dati in un\'unica attività.',
    },
    {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Estende il conteggio al confronto quantitativo. gli utenti che sanno contare immagini sparse sono pronti per confrontare \"quale gruppo ha di più?\" in schede di confronto strutturate.',
    },
    {
      appId: 'matching',
      title: 'Generatore Schede Abbinamento',
      description: 'Compagno di discriminazione visiva. Le attività di abbinamento si abbinano naturalmente alle schede di grafici per immagini — gli utenti devono riconoscere immagini identiche prima di poterle contare accuratamente.',
    },
  ],

  visuals: {
    heroImage: { src: '/samples/italian/chart%20count/grafico-con-immagini-1.webp', alt: 'Scheda di grafici per immagini con griglia 4×5 di immagini sparse e grafico a barre per pratica di conteggio e grafici' },
    samples: [
      { src: '/samples/italian/chart%20count/grafico-con-immagini-1.webp', alt: 'Scheda di grafici per immagini con 20 icone sparse in una griglia 4×5 e grafico a barre a 6 colonne sotto', caption: 'Scheda completa di grafici per immagini con griglia di immagini sparse e grafico a barre per la pratica di conteggio degli utenti' },
      { src: '/samples/italian/chart%20count/grafico-con-immagini-1-answer-key.webp', alt: 'Chiave di risposta del grafico per immagini con celle evidenziate in giallo che mostrano i conteggi corretti', caption: 'Chiave di risposta auto-generata con celle evidenziate in giallo (#FFC857) che mostrano il conteggio corretto per ogni tipo di immagine' },
    ],
