...
export const startPageSlugs: StartSlugConfig[] = [
  { startId: 'complete-guide-printable-business', slugs: { en: 'complete-guide-printable-business', de: 'komplettanleitung-druckvorlagen-geschaeft', fr: 'guide-complet-activite-imprimables', es: 'guia-completa-negocio-imprimibles', pt: 'guia-completo-negocio-imprimiveis', it: 'guida-completa-attivita-stampabili', nl: 'complete-gids-printable-bedrijf', sv: 'komplett-guide-utskriftsbart-foeretag' } },
  { startId: 'create-worksheets-that-sell', slugs: { en: 'create-worksheets-that-sell', de: 'arbeitsblaetter-erstellen-die-verkaufen', fr: 'creer-fiches-qui-se-vendent', es: 'crear-fichas-que-se-venden', pt: 'criar-fichas-que-vendem', it: 'creare-schede-che-vendono', nl: 'werkbladen-maken-die-verkopen', sv: 'skapa-arbetsblad-som-saeljer' } },
  { startId: 'printable-business-blueprint', slugs: { en: 'printable-business-blueprint', de: 'druckvorlagen-geschaeft-bauplan', fr: 'plan-activite-imprimables', es: 'plan-negocio-imprimibles', pt: 'plano-negocio-imprimiveis', it: 'piano-attivita-stampabili', nl: 'blauwdruk-printable-bedrijf', sv: 'ritning-utskriftsbart-foeretag' } },
  { startId: 'etsy-printable-business', slugs: { en: 'etsy-printable-business', de: 'etsy-druckvorlagen-geschaeft', fr: 'activite-imprimables-etsy', es: 'negocio-imprimibles-etsy', pt: 'negocio-imprimiveis-etsy', it: 'attivita-stampabili-etsy', nl: 'etsy-printable-bedrijf', sv: 'etsy-utskriftsbart-foeretag' } },
  { startId: 'amazon-kdp-activity-books', slugs: { en: 'amazon-kdp-activity-books', de: 'amazon-kdp-aktivitaetsbuecher', fr: 'livres-activites-amazon-kdp', es: 'libros-actividades-amazon-kdp', pt: 'livros-atividades-amazon-kdp', it: 'libri-attivita-amazon-kdp', nl: 'amazon-kdp-activiteitenboeken', sv: 'amazon-kdp-aktivitetsboecker' } },
  { startId: 'create-multilingual-worksheets', slugs: { en: 'create-multilingual-worksheets', de: 'mehrsprachige-arbeitsblaetter-erstellen', fr: 'creer-fiches-multilingues', es: 'crear-fichas-multilingues', pt: 'criar-fichas-multilingues', it: 'creare-schede-multilingue', nl: 'meertalige-werkbladen-maken', sv: 'skapa-flersprakiga-arbetsblad' } },
  { startId: 'commercial-license-guide', slugs: { en: 'commercial-license-guide', de: 'kommerzielle-lizenz-leitfaden', fr: 'guide-licence-commerciale', es: 'guia-licencia-comercial', pt: 'guia-licenca-comercial', it: 'guida-licenza-commerciale', nl: 'commerciele-licentie-gids', sv: 'kommersiell-licensguide' } },
  { startId: 'printable-business-income', slugs: { en: 'printable-business-income', de: 'druckvorlagen-geschaeft-einkommen', fr: 'revenus-activite-imprimables', es: 'ingresos-negocio-imprimibles', pt: 'rendimentos-negocio-imprimiveis', it: 'reddito-attivita-stampabili', nl: 'printable-bedrijf-inkomen', sv: 'utskriftsbart-foeretag-inkomst' } },
  { startId: 'tools-for-printable-business', slugs: { en: 'tools-for-printable-business', de: 'werkzeuge-fuer-druckvorlagen-geschaeft', fr: 'outils-activite-imprimables', es: 'herramientas-negocio-imprimibles', pt: 'ferramentas-negocio-imprimiveis', it: 'strumenti-attivita-stampabili', nl: 'tools-voor-printable-bedrijf', sv: 'verktyg-foer-utskriftsbart-foeretag' } },
  { startId: 'marketing-printable-business', slugs: { en: 'marketing-printable-business', de: 'marketing-druckvorlagen-geschaeft', fr: 'marketing-activite-imprimables', es: 'marketing-negocio-imprimibles', pt: 'marketing-negocio-imprimiveis', it: 'marketing-attivita-stampabili', nl: 'marketing-printable-bedrijf', sv: 'marknadsforing-utskriftsbart-foeretag' } },
  { startId: 'scaling-printable-business', slugs: { en: 'scaling-printable-business', de: 'druckvorlagen-geschaeft-skalieren', fr: 'croissance-activite-imprimables', es: 'escalar-negocio-imprimibles', pt: 'escalar-negocio-imprimiveis', it: 'scalare-attivita-stampabili', nl: 'printable-bedrijf-opschalen', sv: 'skala-upp-utskriftsbart-foeretag' } },
  { startId: 'printable-business-legal', slugs: { en: 'printable-business-legal', de: 'druckvorlagen-geschaeft-recht', fr: 'aspects-juridiques-activite-imprimables', es: 'aspectos-legales-negocio-imprimibles', pt: 'aspectos-legais-negocio-imprimiveis', it: 'aspetti-legali-attivita-stampabili', nl: 'printable-bedrijf-juridisch', sv: 'utskriftsbart-foeretag-juridik' } },
];
