...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'second-grade': {
      ...
      snippetAnswer: 'Avaruusaiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät aurinkokuntamme rakenteen ymmärrystä planeettojen vertailututkimuksella, kehittävät mittakaava-ajattelua etäisyyksien ja kokojen vertailulla sekä vahvistavat tutkimusraportin kirjoittamista avaruustutkimuksen teemalla. POPS 2014:n ympäristöopin ja tutkivan oppimisen vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla avaruusteema laajenee ihmettelystä tieteelliseksi tutkimukseksi, koska seitsemän- ja kahdeksanvuotiaat kykenevät käsittelevään suuriakin lukuja vertaillen ja ymmärtämään mittakaavan käsitteen. POPS 2014:n päättötavoitteet edellyttävät, että oppilas tutkii luonnon ilmiöitä ja ymmärtää maan aseman avaruudessa. Toisen luokan oppilas tutkii aurinkokuntaa järjestelmällisesti: kahdeksan planeetan järjestys, koko, etäisyys auringosta ja erityispiirteet. Mittakaava konkretisoituu: jos maapallo olisi herneenkokoinen, Jupiter olisi appelsiinin kokoinen. Suurten lukujen vertailu kehittyy: planeettojen etäisyydet tuhansina kilometreinä. Tutkimusraportin kirjoittaminen syventyy: oppilas valitsee planeetan, kerää tietoja ja kirjoittaa jäsennellyn raportin. Tähtitaivaan havainnointi yhdistää arjen Suomen pimeään talveen: tähtikuviot, Linnunrata ja revontulet. Avaruustutkimuksen historia motivoi: Gagarin, Armstrong, Suomen oma avaruustutkimus.',
      developmentalMilestones: [
        { milestone: 'Aurinkokunnan rakenteen järjestelmällinen ymmärtäminen (7–8-vuotiaat tutkivat planeettoja vertaillen)', howWeAddress: 'Vertailututkimustehtävät, joissa oppilas kokoaa planeettojen tiedot taulukkoon (järjestys, koko, etäisyys, erityispiirteet) ja tekee johtopäätöksiä, rakentavat tieteellistä ajattelua' },
        { milestone: 'Mittakaavan ja suurten lukujen ymmärtäminen (toisen luokan oppilaat hahmottavat avaruuden etäisyyksIä)', howWeAddress: 'Mittakaavatehtävät, joissa oppilas rakentaa aurinkokunnan pienoismallin oikeilla mittasuhteilla ja vertailee planeettojen kokoja ja etäisyyksIä, konkretisoivat abstraktit etäisyydet' },
        { milestone: 'Avaruustutkimusraportin kirjoittaminen (seitsemän- ja kahdeksanvuotiaat tuottavat jäsennellyn tietotekstin)', howWeAddress: 'Tutkimusraporttitehtävät, joissa oppilas valitsee planeetan tai avaruusilmiIön, kerää tietoja useasta lähteestä ja kirjoittaa raportin, kehittävät tiedonhankinnan ja kirjoittamisen taitoja' },
        { milestone: 'Tähtitaivaan havainnointi (toisen luokan oppilaat tunnistavat tähtikuvioita)', howWeAddress: 'Havainnointitehtävät, joissa oppilas opettelee tähtikuvioita tähtikartan avulla ja tekee havaintoja talviselta tähtitaivaalta, yhdistävät luonnontiedon ja kokemuksellisuuden' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa tutkimus nelään sisäplaneettaan, anna mittakaavamallille valmiit materiaalit ja ohjeet sekä tarjoa raportin kirjoitukseen lausepohjat. Edistyneille toisen luokan oppilaille laajenna tutkimus kääpiöplaneettoihin ja asteroideihin, lisää avaruusmatkan laskentatehtävä ja haasta kirjoittamaan tulevaisuuden avaruusmission suunnitelma.',
      parentTakeaway: 'Toisen luokan avaruustehtävät herättävät tieteellisen uteliaisuuden. Katsokaa yhdessä tähtitaivasta kirkkaana talvi-iltana: löydättIekö Otavan, Orionin? Rakentakaa aurinkokunnan pienoismalli hedelmistä: herneen kokoinen maapallo, appelsiinin kokoinen Jupiter. Katsokaa avaruusdokumentteja ja keskustelkaa: voisiko ihminen asua Marsissa? Tutkikaa suomalaista avaruustutkimusta: Suomesta on lähetetty satelliitteja! Tärkeintä on ruokkia ihmetystä ja tieteellistä ajattelua.',
      classroomIntegration: 'Avaruustehtävät ovat toisen luokan ympäristöopin tutkimusjakson huipentuma: planeettatutkimus ja tähtitaivaan havainnointi ympäristöopissa, mittakaavan ja suurten lukujen vertailu matematiikassa, tutkimusraportti äidinkielessä ja avaruustaide kuvataiteessa. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa avaruusteema osoittaa tutkivan oppimisen, tieteellisen raportoinnin ja mittakaava-ajattelun taidot.',
      assessmentRubric: [
        { skill: 'Aurinkokunnan rakenteen ymmärrys', emerging: 'tietää että maapallo kiertää aurinkoa mutta ei tunne muita planeettoja', proficient: 'nimeää planeetat järjestyksessä, vertailee niiden kokoja ja etäisyyksIä taulukon avulla', advanced: 'analysoi planeettojen ominaisuuksia monipuolisesti, vertailee elämän edellytyksiä ja perustelee miksi maapallo on ainutlaatuinen' },
        { skill: 'Mittakaava-ajattelu', emerging: 'tietää että planeetat ovat eri kokoisia mutta ei hahmota mittasuhteita', proficient: 'rakentaa pienoismallin oikeilla mittasuhteilla ja vertailee etäisyyksIä', advanced: 'selittää mittakaavan matemaattisesti ja soveltaa sitä luovasti eri konteksteissa' },
        { skill: 'Tutkimusraportin kirjoittaminen', emerging: 'luettelee muutaman faktan planeetasta ilman rakennetta', proficient: 'kirjoittaa jäsennellyn raportin useasta lähteestä johdannolla ja johtopäätöksellä', advanced: 'kirjoittaa laajan tutkimusraportin monesta näkökulmasta, arvioi lähteitä ja esittää omia pohdintoja' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Avaruusaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät aurinkokuntajärjestelmän analyyttistä ymmärrystä planeettojen ominaisuuksien vertailulla, vahvistavat suurten lukujen käsittelyä kerto- ja jakolaskulla etäisyyksien ja kokojen skaalaamisessa sekä opettavat tieteellisen tutkimusraportin kirjoittamista avaruustutkimuksen edistyksestä useasta lähteestä. POPS 2014:n vuosiluokkien 3–6 ympäristöopin ja luonnontieteen tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla avaruusteema siirtyy ihmettelystä järjestelmälliseen tutkimukseen, kun kahdeksan- ja yhdeksänvuotiaat kykenevät käsittelemIään suuria lukuja, vertailemaan ominaisuuksia taulukoissa ja kirjoittamaan tutkimusraportteja. Aurinkokuntajärjestelmän analysointi: planeettojen ominaisuuksien (koko, etäisyys, lämpötila, kuut) järjestelmällinen vertailu taulukoissa ja diagrammeissa. Suurten lukujen skaalaaminen kertolaskulla: jos Maa on 1, Jupiter on 11 × Maan halkaisija — pienoismallien rakentaminen mittakaavassa. Etäisyyksien hahmottaminen: valo kulkee 300 000 km/s, miten kaukana aurinko on valominuuteissa. Avaruustutkimuksen edistyksen tutkiminen: Sputnikista Mars-tutkimuksiin, Suomen avaruustutkimuksen rooli. Argumentoiva kirjoittaminen: pitäisikö ihmisten asuttaa Mars — näyttöön perustuva väittely. Tieteellisen tutkimusraportin kirjoittaminen yhdistää useita lähteitä.',
      developmentalMilestones: [
        { milestone: 'Aurinkokuntajärjestelmän analyyttinen ymmärrys planeettojen vertailulla (8–9-vuotiaat vertailevat järjestelmällisesti)', howWeAddress: 'Planeettavertailuprojektit, joissa oppilas kokoaa planeettojen ominaisuudet taulukkoon, piirtää vertailudiagrammeja ja kirjoittaa analyyttisen raportin järjestelmän rakenteesta' },
        { milestone: 'Suurten lukujen skaalaaminen kertolaskulla pienoismalleihin (kolmannen luokan oppilaat käsittelevät mittakaavoja)', howWeAddress: 'Skaalausprojektit, joissa oppilas laskee mittakaavoja kertolaskulla, rakentaa pienoismallin ja selittää matemaattisesti miten suhteelliset koot ja etäisyydet säilyvät' },
        { milestone: 'Avaruustutkimuksen edistyksen tutkiminen ja raportointi (kahdeksan- ja yhdeksänvuotiaat yhdistävät historiaa ja tiedettä)', howWeAddress: 'Tutkimushistoriaprojektit, joissa oppilas tutkii avaruustutkimuksen merkkipaaluja, kokoaa aikajanan ja kirjoittaa monikappaleraportin useasta lähteestä' },
        { milestone: 'Argumentoiva kirjoittaminen avaruuden asuttamisesta (kolmannen luokan oppilaat perustelevat datalla)', howWeAddress: 'Väittelykirjoitukset, joissa oppilas tutkii Mars-asuttamisen haasteita ja mahdollisuuksia, kerää näyttöä ja kirjoittaa perustellun mielipidekirjoituksen puolesta tai vastaan' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille rajaa vertailu neljään planeettaan, anna skaalauksessa valmiit kertolaskukaavat ja tarjoa raporttiin rakennepohja. Edistyneille kolmannen luokan oppilaille laajenna analyysi tähtijärjestelmiin, lisää valovuosien ja eksplaneettojen perusteet ja haasta kirjoittamaan tieteellinen posteri avaruustutkimuksen tulevaisuudesta.',
      parentTakeaway: 'Kolmannen luokan avaruustyölehdet kehittävät tieteellistä ajattelua ja suurten lukujen ymmärrystä. Rakentakaa yhdessä aurinkokuntapienoismalli: jos Maa on herne, miten suuri Jupiter on? Tutkikaa tähtitaivasta: löydätteko planeettoja? Keskustelkaa avaruustutkimuksesta: mitä Mars-tutkimuksessa on löydetty? Tärkeintä on oppia käsittelmään valtavia lukuja ja ymmärtämään tieteellisen tutkimuksen merkitystä.',
      classroomIntegration: 'Avaruustyölehdet integroituvat kolmannen luokan ympäristöoppiin, matematiikkaan ja äidinkieleen: planeettavertailu luonnontieteessä, mittakaavaskaalaus kertolaskuprojektina, avaruustutkimuksen historia aikajanaharjoituksena ja Mars-väittely mielipidekirjoitusharjoituksena. POPS 2014:n vuosiluokkien 3–6 luonnontieteen, matemaattisen ajattelun ja tietokirjoittamisen tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Aurinkokuntajärjestelmän analysointi', emerging: 'nimeää planeetat mutta ei vertaile ominaisuuksia', proficient: 'vertailee planeettojen ominaisuuksia taulukossa ja diagrammissa ja selittää järjestelmän rakenteen', advanced: 'analysoi planeettajärjestelmää kokonaisuutena, tunnistaa säännönmukaisuuksia ja soveltaa tietoa uusiin kysymyksiin' },
        { skill: 'Suurten lukujen skaalaaminen kertolaskulla', emerging: 'laskee yksinkertaisia kertolaskuja mutta ei hahmota mittakaavan merkitystä', proficient: 'laskee mittakaavoja kertolaskulla ja rakentaa pienoismalleja suhteellisesti oikein', advanced: 'soveltaa skaalausta luovasti eri konteksteissa ja selittää matemaattisesti mittakaavan periaatteen' },
        { skill: 'Tieteellinen tutkimusraportti avaruudesta', emerging: 'kertoo joitakin avaruusfaktoja mutta ei kirjoita jäsenneltyä raporttia', proficient: 'kirjoittaa monikappaleraportin useasta lähteestä lähdeviitteineen ja johtopäätöksineen', advanced: 'yhdistää tietoja kriittisesti useista lähteistä, arvioi luotettavuutta ja esittää omia tutkimuskysymyksiä' },
      ],
    },
  },
