...
const content: AppContent = {
  seo: {
    primaryKeyword: 'criar e vender fichas grande e pequeno',
    secondaryKeywords: [
    ...
    lsiKeywords: [
      'produtos digitais de fichas comparação de tamanhos para empreendedores',
      'atividade de discriminação visual de tamanhos imprimíveis online',
      'gerador de fichas grande pequeno uso comercial',
    ],
  ...
  howItWorks: {
    title: 'Como Criar Fichas de Comparação de Tamanhos em 5 Passos',
    steps: [
      {
        title: 'Configure o layout da página',
        description:
          'Abra o painel de Configuração de Página e escolha um tamanho: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) ou qualquer dimensão personalizada. Selecione uma cor de fundo, escolha um tema decorativo de fundo da biblioteca de imagens e ajuste a opacidade para manter os exercícios legíveis. Adicione uma moldura de borda combinante com controlo de opacidade independente. Estas opções de layout dão às suas fichas de comparação de tamanhos um aspeto profissional e polido antes de adicionar um único exercício.',
      },
      {
  ...
  keyFeatures: {
    title: 'Características Principais do Gerador de Fichas Grande e Pequeno',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Defina de 1 a 10 exercícios por página para uma densidade flexível da ficha. Um ou dois exercícios grandes criam páginas de prática focada; oito a dez exercícios criam fichas de avaliação completas. Escolha 2 ou 3 imagens por exercício para controlar a dificuldade — duas imagens oferecem comparações diretas grande/pequeno, enquanto três imagens introduzem a opção do médio e ativam os cinco tipos de perguntas, incluindo Circundar o Médio e os exercícios de numeração. Estas duas definições combinadas permitem-lhe criar fichas que vão desde páginas de prática focada com um único exercício até fichas de prática densas com múltiplos exercícios.',
      },
      {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Não. Grande e Pequeno é uma aplicação puramente visual — as fichas contêm apenas imagens com zero texto na saída, pelo que são idênticas em todos os idiomas. Mudar o idioma só afeta as etiquetas da interface do gerador, não o conteúdo da ficha. A Licença Comercial inclui 10 temas coloridos; o Acesso Completo desbloqueia os 104 temas e os 11 idiomas de interface.',
    },
    {
  ...
  internalLinks: [
    {
      ...
      anchorText: 'Gerador de Fichas de Trem de Padrões',
    },
    {
      pageType: 'app',
