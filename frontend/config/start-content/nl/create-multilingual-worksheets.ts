...
const content: StartContent = {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'Diepgaande kijk op productkwaliteit: ontwerpnormen, differentiatietechnieken en de methoden die je meertalige werkbladen laten opvallen ten opzichte van concurrenten.',
    },
  ],
  ...
  visuals: {
    heroImage: { src: '/samples/dutch/wordsearch/Woordzoeker%201.webp', alt: 'Woordzoeker puzzel werkblad dat meertalige werkbladgeneratie in 11 talen demonstreert' },
    samples: [
