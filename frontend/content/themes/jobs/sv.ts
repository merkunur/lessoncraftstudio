...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Yrken',
  title: 'Gratis Yrken-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara yrken-övningar för barn. Matematik, målarbilder, ordspel och pussel med yrkentema. Förskola till årskurs 3. Gratis PDF.',
  keywords: 'yrkesövningar barn, yrkes arbetsblad, yrkes målarbilder, yrkes matematik, yrkes förskola, yrkes utskrivbar, yrkes pussel, yrkes räkning, yrkes korsord, samhällsyrken övning, yrkesverktyg',
  heading: 'Yrkesövningar och Arbetsblad',
