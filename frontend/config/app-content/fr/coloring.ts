...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Pages de Coloriage | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Pages de Coloriage professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Page de coloriage thématique avec illustrations détaillées',
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Pages de Coloriage thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Pages de Coloriage est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'coloring', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Pages de Coloriage Gratuit' },
