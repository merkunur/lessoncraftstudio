...
const content: ToolContent = {
  ...
  businessIdeas: [
    ...
    {
      title: 'Pacotes de Atividades de Puzzles para TPT',
      description: 'Carregue pacotes de atividades de puzzles no TPT com gabaritos autogerados e dificuldade configurável como pontos de venda chave. Os professores que procuram atividades de discriminação visual e pensamento crítico valorizam fichas que chegam prontas para a sala de aula com opções de dificuldade diferenciada. Crie conjuntos alinhados com o currículo: puzzles de habitats de animais para ciências, puzzles de ajudantes comunitários para estudos sociais, puzzles de grupos de alimentos para lições de nutrição. Cada pacote inclui fichas para alunos a múltiplos níveis de dificuldade (1–5 peças faltantes, 2–6 opções) mais gabaritos para estações de autocorreção. As seis formas de peça dão variedade aos professores dentro de um só tipo de atividade.',
      platform: 'Teachers Pay Teachers',
    },
    {
      title: 'Funil de Tráfego com Puzzles no Pinterest',
      description: 'As fichas de puzzles criam pins visualmente impactantes no Pinterest — a imagem com lacunas recortadas e opções de solução numeradas em baixo cria um formato imediatamente chamativo que pais e professores reconhecem como educativo. Publique fichas de amostra mostrando diferentes formas de peça: cortes quadrados com temas de animais, cortes circulares com temas de festividades, cortes de elipse para variedade. Crie séries de pins separadas para «fichas de puzzles para crianças», «puzzles de peças faltantes para pré-escolar» e «atividades de discriminação visual». O formato puramente visual atrai pais e professores em todos os países. Ligue cada pin às suas listagens de produtos na Etsy ou TPT.',
      platform: 'Pinterest',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'O gerador toma uma imagem da biblioteca ou a sua imagem carregada e recorta 1–5 peças, deixando lacunas brancas com contornos de traço preto (2px) nas localizações originais. Depois exibe 2–6 opções de solução numeradas — as peças corretas mais peças distratoras extraídas de outras áreas não sobrepostas da mesma imagem. Os alunos examinam as lacunas e as opções numeradas, depois identificam que opção preenche cada espaço com base na cor, padrão e detalhe visual. O gabarito mostra etiquetas numéricas realçadas em amarelo dentro de cada lacuna indicando a correspondência correta.',
    },
    {
    ...
    },
    {
      ...
      answer: 'A dificuldade controla-se com duas configurações independentes. O número de peças faltantes (1–5) determina quantas lacunas se recortam da imagem — mais peças significa mais exigência de raciocínio espacial. O número de opções de solução (2–6) determina quantas opções numeradas avaliam os alunos — quando as opções excedem as peças faltantes, as extras são peças distratoras que requerem comparação visual cuidadosa. Um puzzle com 1 peça faltante e 2 opções é fácil; 5 peças faltantes com 6 opções incluindo distratoras é genuinamente desafiante. Ajuste ambos os eixos independentemente para criar níveis de dificuldade precisos para qualquer grupo etário.',
    },
    {
      question: 'O que são peças distratoras e como se geram?',
      answer: 'As peças distratoras são opções de solução adicionais que não coincidem com nenhuma lacuna do puzzle. Extraem-se de diferentes áreas da mesma imagem fonte usando até 200 tentativas de colocação cada uma, assegurando que não se sobrepõem com as peças corretas nem entre si. As distratoras impedem que os alunos resolvam por eliminação — devem comparar cuidadosamente cores, padrões e detalhes visuais para distinguir as opções corretas de alternativas de aparência semelhante. O número de distratoras é igual à diferença entre opções de solução e peças faltantes.',
    },
    {
