...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Stel het totale aantal sorteerafbeeldingen in van 4 tot 12, met elke categorie die tussen 2 en 10 afbeeldingen bevat. In themamodus haalt de app automatisch 4–6 afbeeldingen per thema op. In handmatige modus bepaal je precies hoeveel afbeeldingen in elke categorie komen. Minder afbeeldingen creëren eenvoudigere sorteertaken ideaal voor kleuters en de kleuterschool; meer afbeeldingen verhogen de moeilijkheid voor basisschoolgebruikers. Het uitknipraster past zijn kolomindeling aan (3–4 kolommen op basis van totaal) om schone visuele verdeling te behouden ongeacht je aantal afbeeldingen.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    {
      title: 'winkel Sorteercentrum Activiteiten met Naam-/Datumvelden',
      description: 'Bouw klasklare sorteer werkbladen voor sorteercentra, oefenactiviteit en zelfstandig oefenen met naam-/datumvelden en geprinte antwoordbladen. Maak lesstof-gerelateerde sets: levend versus niet-levend voor biologie, gezond versus ongezond eten voor voedingsleer, dagdieren versus nachtdieren voor leefgebieden, warm versus koud weer kleding voor seizoenen. Themamodus genereert snel werkbladen voor bulkklas-sets, terwijl handmatige modus je specifieke afbeeldingen laat kiezen die passen bij je lesdoelen. Het automatisch gegenereerde antwoordblad bespaart productietijd voor verkopers en maakt zelfcontrolerende sorteerstations mogelijk.',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Het automatisch gegenereerde antwoordblad met 6× grotere afbeeldingen georganiseerd in categorievakken is wat je sorteer werkbladen een compleet, zelfcontrolerend product maakt in plaats van alleen een sorteeractiviteit. Neem altijd antwoordbladen op in je productbundels en toon ze in vermeldingsvoorbeeldafbeeldingen. Producten die antwoordbladen bevatten verkopen consistent beter dan alleen-werkblad vermeldingen omdat verkopers en ouders zelfcontrolerend materiaal willen dat geen extra productietijd vereist. Het dubbele-canvassysteem genereert beide versies tegelijkertijd, dus het opnemen van het antwoordblad kost je niets extra.',
    },
    {
    ...
    },
    {
      ...
      description: 'De meest succesvolle sorteer werkblad producten gebruiken categorieparen die aansluiten bij hoe verkopers en ouders denken over classificatie: dieren versus eten, land versus water, levend versus niet-levend, gezond versus ongezond, groot versus klein, warm versus koud, dag versus nacht. Deze natuurlijke binaire tegenstellingen zijn de termen waar kopers op zoeken op Etsy, Gumroad en Amazon. Gebruik het daadwerkelijke categoriepaar in je producttitels (bijv. "Dieren versus Eten Sorteer Werkbladen") in plaats van generieke titels, en maak aparte vermeldingen voor elk groot categoriepaar om gericht zoekverkeer op te vangen.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Ja. Vink het selectievakje "Naam-/Datumvelden opnemen" aan in het paneel Pagina-instellingen om naam- en datumlijnen voor gebruikers toe te voegen aan het werkblad. Deze velden garanderen gebruikerverantwoording in klassettings en maken je sorteer werkbladen klaar voor inzameling en beoordeling door de verkoper zonder extra voorbereiding. Naam-/datumvelden zijn een belangrijk verkoopargument voor Gumroad klasproducten waar verkopers verwachten dat werkbladen direct verkoopklaar aankomen.',
    },
    {
