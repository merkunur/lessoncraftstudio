...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Lettres Mélangées | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Lettres Mélangées professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche de lettres mélangées avec images indices',

    },
    sampleGallery: [
      { src: '/samples/english/word scramble/Word Scramble 1.jpeg', alt: 'Lettres mélangées thématiques', caption: 'Reconstituer les mots' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Lettres Mélangées thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Lettres Mélangées est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'word-scramble', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Lettres Mélangées Gratuit' },
