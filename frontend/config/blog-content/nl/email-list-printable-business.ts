...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Uw emaillijst is het enige verkoopkanaal dat u volledig bezit',
    description: 'Uw emaillijst is het enige verkoopkanaal dat u volledig bezit. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
