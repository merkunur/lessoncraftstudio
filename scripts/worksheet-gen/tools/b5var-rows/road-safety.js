...
const ROWS = [
  ...
  ['k', 'K-374', 'crossing-the-road-safely-steps', BASE, 2,
    { mode: 'crossing-steps', cards: 5, offBy: 3, cardW: 200, figH: 130, minFrameH: 196, gap: 20, rowGap: 18 },
    'Crossing the Road Safely: the Steps', 'Write 1 to 5 in the boxes to show how to cross the road.'],
