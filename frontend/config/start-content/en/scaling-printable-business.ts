...
const content: StartContent = {
  ...
  actionSteps: [
    ...
    {
      step: 'Create a Listing Template for Each Product Category',
      description: 'Write a master listing description template with placeholders for theme, difficulty, page count, and other variables. Apply this template to every new listing in that category for consistent quality and faster listing creation.',
    },
    {
      step: 'Add a Second Selling Platform',
    ...
    {
      step: 'Build a Reinvestment Plan',
  ...
  toolsRecommended: [
    {
      ...
      description: 'Demonstrates the creative range possible when scaling into art-category products. Theme variety and visual appeal make Draw & Color products ideal for catalog depth expansion across dozens of themes from a single tool.',
    },
    {
      appId: 'word-search-worksheets',
      title: 'Word Search Generator',
      description: 'Highest volume potential of any puzzle type. Word search is the most searched printable puzzle category, and 100+ themes create 100+ distinct product lines. Scales exceptionally well across themes, difficulty levels, and languages.',
    },
    {
      appId: 'math-worksheet',
      title: 'Math Worksheet Generator',
      description: 'Evergreen scalability through configurable difficulty levels. One generator produces hundreds of unique math products spanning operations, grade levels, and formats \u2014 the definition of depth-first catalog expansion.',
    },
    {
      appId: 'coloring-worksheets',
      title: 'Coloring Page Generator',
      description: 'Zero language dependency means instant access to every global marketplace. Coloring pages are the fastest path to international scaling because they require no translation and appeal to buyers in every language market.',
    },
    {
      appId: 'sudoku-worksheets',
      title: 'Sudoku Generator',
      description: 'Platform-agnostic scaling \u2014 identical sudoku products work on Etsy, Amazon KDP, Teachers Pay Teachers, and every international marketplace without format adaptation. Pure number puzzles cross every language barrier.',
    },
    {
      appId: 'crossword-worksheets',
      title: 'Crossword Generator',
      description: 'Multilingual scaling from a single tool \u2014 11 languages from one generator make crossword puzzles ideal for systematic international market expansion without additional translation costs or tools.',
    },
  ],

  faq: [
    {
      question: 'How do I know when my printable business is ready to scale?',
      answer: 'You are ready to scale when you have validated your product-market fit: at least 10 to 15 listings with consistent sales over two or more months, a clear understanding of which product types and themes resonate with buyers, and a primary platform where you understand the search algorithm and buyer behavior. If you are still experimenting with what to sell and where, focus on validation first.',
    },
    {
      question: 'How many listings do I need before expanding to a second platform?',
      answer: 'Aim for at least 25 to 50 well-optimized listings on your primary platform before adding a second one. You need enough products to justify the effort of adapting to a new platform and enough sales data to know which products to prioritize for cross-listing. Start by cross-listing your top 10 performers rather than your entire catalog.',
    },
    {
      question: 'Should I expand my catalog with more product types or more themes in existing types?',
    ...
    {
      question: 'Is it realistic to expand into non-English markets without speaking the language?',
      answer: 'Yes, when using multilingual worksheet generators that produce content in the target language. Number-based products like math worksheets and sudoku require no language at all. Puzzle types like word searches and crosswords need word generation in the target language, which multilingual generators handle automatically. Start with one language, evaluate marketplace performance over 60 to 90 days, then expand based on results.',
    },
    {
      question: 'What is the biggest mistake printable sellers make when trying to scale?',
      answer: 'Spreading too thin across too many platforms and product types before mastering any single one. A seller with 50 well-optimized listings on Etsy will outperform a seller with 15 mediocre listings each on four platforms. Master your primary platform, build depth in your proven categories, then expand deliberately. Systematic growth beats scattered effort every time.',
    },
    {
      question: 'How much of my revenue should I reinvest in the business?',
      answer: 'The percentage depends on your growth phase and personal circumstances, but the priority order matters more than the amount. Reinvest in production capacity first (additional generator licenses and category bundles), platform optimization tools second, design improvements third, and paid advertising last. Only advertise products that have already demonstrated organic sales. Even modest reinvestment compounds significantly when directed at the right priorities.',
    },
    {
