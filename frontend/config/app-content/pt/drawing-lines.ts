...
const content: AppContent = {
  seo: {
    ...
    lsiKeywords: [
      'produtos digitais fichas traçar linhas para empreendedores',
  ...
  keyFeatures: {
    title: 'Características Principais do Gerador de Fichas de Grafomotricidade',
    features: [
      {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Não. A Grafomotricidade é uma aplicação puramente visual — as fichas contêm apenas imagens, traçados de linhas e bordas decorativas com zero texto na saída, pelo que são idênticas em todos os idiomas. Mudar o idioma apenas afeta as etiquetas da interface do gerador e as etiquetas de conteúdo da biblioteca de imagens, não a ficha em si. A Licença Comercial inclui 10 temas coloridos; o Acesso Completo desbloqueia os 104 temas e os 11 idiomas de interface.',
    },
    {
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Criador de Fichas de Grafomotricidade',
    },
    {
      pageType: 'start',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Ficha de grafomotricidade com modelo de linha curva a ligar pares de imagens de animais emparelhados em formato horizontal',
    },
    sampleGallery: [
      {
    ...
    videoTitle: 'Como Criar Fichas de Traçado de Linhas com Oito Modelos SVG — Tutorial Passo a Passo',
  },
};
