...
const content: AppContent = {
  ...
  faq: [
    {
      ...
      answer:
        'Jedem Buchstabe des Alphabets wird ein einzigartiges Bild zugeordnet. Ihr Geheimtext wird dann als Bildfolge dargestellt, die jeden Buchstaben ersetzt. Nutzer betrachten jedes Bild, finden heraus, welchen Buchstaben es darstellt, und schreiben den Buchstaben, um die ursprüngliche Nachricht zu rekonstruieren. Leerzeichen und Satzzeichen bleiben unverändert, sodass Nutzer Wortgrenzen erkennen können. Die Herausforderung besteht darin, die vollständige Bild-Buchstaben-Zuordnung durch Deduktion und Mustererkennung aufzubauen. Bei deutschen Kryptogrammen umfasst das Alphabet 30 Buchstaben einschließlich ä, ö, ü und ß — jeder dieser Buchstaben erhält ein eigenes Chiffre-Bild.',
    },
    {
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Kryptogramm-Rätsel erstellen',
    },
  ],
