...
const content: ToolContent = {
  ...
  whatYouCanCreate: [
    ...
    {
      title: 'KDP Cryptogram Puzzelboeken',
  ...
  businessIdeas: [
    ...
    },
    {
      ...
      description: 'Maak identieke themasets in meerdere talen en vermeld elk als apart product. Het taalgebonden alfabet betekent dat Nederlandse, Duitse, Franse, Spaanse en andere taalversies uitgebreide tekensets hebben — niet alleen vertaalde zinnen in een Engels-letter cijfer. De meeste cryptogramverkopers bedienen alleen Engels. Jij kunt vermelden op Etsy Duitsland, Frankrijk, Spanje, Italië en meer met oprecht gelokaliseerde cijferproducten.',
      platform: 'Etsy',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'De Cryptogram generator codeert hele zinnen, niet afzonderlijke woorden. Langere zinnen bieden van nature meer contextuele aanwijzingen — veelvoorkomende korte woorden zoals "de", "en" en "is" helpen oplossers de cijfercode sneller te kraken. Gebruik korte tweewoordige zinnen voor maximale moeilijkheid en lange zinnen met veelvoorkomende woorden voor een toegankelijkere puzzel. Zinslengte is een extra moeilijkheidshendel bovenop Letters Onthullen.',
    },
    {
      title: 'Gebruik Automatische Toewijzing voor Snelle Batchproductie',
      description: 'Automatische Toewijzing vult de hele cijfercode met één klik door willekeurige afbeeldingen uit het geselecteerde thema aan elke niet-toegewezen letter te koppelen. Voor batchproductie selecteer je een thema, typ je zin, klik Automatisch Toewijzen, pas Letters Onthullen aan en genereer. Je kunt in minder dan twee minuten een complete thematische cijferpuzzel produceren. Bewaar Handmatige Toewijzing voor premiumproducten waarbij specifieke afbeelding-naar-letter koppelingen het thema versterken.',
    },
    {
      title: 'Wissel Tussen Kleur en Zwart-Wit voor Dubbele Producten',
    ...
    },
    {
      ...
      description: 'Combineer cryptogram werkbladen met woordzoekers, letterpuzzels, raad-het-woord en koppelwerkbladen om uitgebreide geletterdsheidsbundels te maken. Cryptogram oefent deductie en patroonherkenning door codekraken — een fundamenteel andere vaardigheid dan visueel scannen (woordzoeker) of letterherschikking (letterpuzzel). Multi-formaat woordenschatpakketten verkopen voor meer dan elk afzonderlijk formaat alleen.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Automatische Toewijzing koppelt direct willekeurige afbeeldingen uit het geselecteerde thema aan alle niet-toegewezen alfabetletters met één klik — snel voor batchproductie. Handmatige Toewijzing laat je specifiek kiezen welke afbeelding welke letter voorstelt, met een visueel overzicht van alle huidige koppelingen. Je kunt beide mixen: automatisch het grootste deel toewijzen, dan handmatig specifieke letters wisselen voor afbeeldingen die beter bij je thema passen.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'cryptogram-werkbladen', anchorText: 'Watermerk verwijderen en verkopen met commerciële licentie' },
  ...
  visuals: {
    ...
    videoTitle: 'Hoe Je Plaatjes Cryptogram Cijferwerkbladen Maakt — Stap-voor-Stap Handleiding',
  },
};
