...
export const content: FreeToolContent = {
  ...
  seo: {
    titleTag: 'Générateur Gratuit de Train Alphabet | PDF Imprimables',
    metaDescription: 'Créez des fiches de train alphabet gratuites en PDF en quelques secondes. 104 thèmes, corrigés inclus. Aucune inscription requise — téléchargez instantanément.',
    primaryKeyword: 'générateur gratuit train alphabet',
    secondaryKeywords: ["train alphabet à imprimer","fiches lettres maternelle gratuites","alphabet illustré gratuit","apprendre lettres PDF","abc train éducatif"],
    lsiKeywords: ["reconnaissance lettres","phonèmes","prélecture","graphisme","ABC","majuscules","minuscules","lettre initiale"],
  },

  visuals: {
    heroImages: {
      primary: '/samples/english/alphabet train/Alphabet Train 1.jpeg',
      primaryAlt: 'Train alphabet gratuit coloré',
    },
    sampleGallery: [
      { src: '/samples/english/alphabet train/Alphabet Train 1.jpeg', alt: 'Train alphabet', caption: 'Train de lettres' }
    ],
    youtubeId: '36keBFzJbPo',
    videoTitle: 'Comment créer des fiches de train alphabet gratuitement',
  },

  hero: {
    title: 'Générateur Gratuit de Train Alphabet',
    tagline: 'Créez des fiches de train alphabet et téléchargez-les instantanément — aucune inscription requise',
    description: `Ce générateur gratuit de fiches de train alphabet transforme les exercices abstraits en une expérience visuelle engageante que les enfants apprécient réellement. Au lieu de fixer des éléments sans contexte, les élèves travaillent avec des images colorées — animaux, véhicules, aliments, dinosaures et plus de 100 autres thèmes — pour résoudre les exercices à leur propre rythme. Chaque fiche s'exporte en PDF prêt à imprimer avec un corrigé correspondant, prêt pour votre classe, votre leçon d'instruction en famille ou votre boutique de produits numériques.
...
Vous contrôlez chaque aspect de la fiche : difficulté, nombre d'éléments par page, orientation, polices et styles de bordure. L'éditeur canvas intégré vous permet de déplacer les éléments, d'ajouter des titres et d'ajuster les couleurs avant l'export. La version gratuite inclut toutes les fonctionnalités avec un petit filigrane. Passez au Pack Commercial pour retirer le filigrane et vendre vos créations sur Etsy, Amazon KDP ou Teachers Pay Teachers.`,
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Générez des fiches de train alphabet autour de n\'importe quel thème — animaux, espace, océan, fêtes — avec des images assorties qui captent l\'attention des jeunes apprenants.',
    },
    {
  ...
  tutorial: {
    title: 'Comment créer des fiches de train alphabet en 10 étapes',
    steps: [
  ...
  faq: [
    { question: 'Ce générateur de train alphabet est-il vraiment gratuit ?', answer: 'Oui. La version gratuite inclut toutes les fonctionnalités — tous les modes, les 104 thèmes, l\'export PDF et les corrigés. La seule différence est un petit filigrane sur les fichiers exportés. Utilisez la version gratuite indéfiniment sans créer de compte.' },
  ...
  internalLinks: [
    { slug: 'gratuit-train-alphabet-generateur', pageType: 'tool' as const, anchorText: 'Générateur Gratuit de Train Alphabet' },
    { slug: 'alphabet-train', pageType: 'app' as const, anchorText: 'Générateur de Train Alphabet — Détails complets' },
  ],
};
