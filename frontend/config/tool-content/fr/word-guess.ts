...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Choisissez parmi 7 familles de polices : Lexend Deca, Baloo 2, Nunito, Quicksand, Fredoka, Arial ou Verdana. Activez ou désactivez les champs Nom et Date. Utilisez les outils du canevas Fabric.js pour repositionner, aligner, verrouiller ou déverrouiller les éléments individuels. Les boutons annuler/rétablir et les contrôles de zoom vous permettent de peaufiner la mise en page avec précision.',
      },
      {
  ...
  faq: [
    ...
    {
      question: 'Comment fonctionnent les quatre niveaux de difficulté des indices ?',
      answer: 'Chaque niveau contrôle le nombre de lettres pré-remplies dans la grille. Sans Indices laisse la grille entièrement vide pour un rappel pur. Facile révèle la moitié des lettres pour un étayage adapté aux débutants. Normal révèle un quart des lettres pour un défi équilibré. Difficile révèle seulement un sixième des lettres pour les orthographeurs confiants. Vous pouvez mélanger les niveaux entre les pages pour créer des packs différenciés.',
    },
    {
    ...
    },
    {
      ...
      answer: 'L\'outil prend en charge 11 langues : anglais, allemand, français, espagnol, portugais, italien, néerlandais, suédois, danois, norvégien et finnois. Chaque langue utilise ses mots de vocabulaire natifs corrects. Changez de langue pour créer le même design de fiche avec des orthographes et des corrigés différents pour chaque marché.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'deviner-mots-fiches', anchorText: 'Fiches Deviner les Mots — Détails Complets du Produit' },
  ...
  visuals: {
    ...
    videoTitle: 'Comment Créer des Fiches Deviner les Mots — Tutoriel Vidéo',
  },
};
