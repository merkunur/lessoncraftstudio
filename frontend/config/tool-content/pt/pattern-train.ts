...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'gerador de fichas de trem de padrões',
    secondaryKeywords: [
      'fichas de padrões repetitivos imprimíveis para vender',
      'criar fichas de trem de padrões uso comercial',
      'gerador de fichas de sequências para KDP',
      'ferramenta para criar fichas de reconhecimento de padrões',
    ],
    lsiKeywords: [
      'fichas de reconhecimento de padrões visuais para Etsy',
      'gerador de fichas sem texto de trem de padrões',
      'fichas de sequências AB ABC para vender online',
    ],
    titleTag: 'Gerador Fichas Trem de Padrões | Criar e Vender',
    metaDescription: 'Gere fichas de trem de padrões com cinco tipos de padrões, 11 vagões temáticos e pistas ajustáveis. Exporte PDF a 300 DPI. Teste grátis com marca d\'água.',
  },
  ...
  tutorial: {
    title: 'Como Criar Fichas de Trem de Padrões em 8 Passos',
    steps: [
      {
      ...
      },
      {
        ...
        description: 'Na secção de Configuração de Página, selecione o tamanho: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) ou introduza um tamanho personalizado. Escolha uma cor de fundo, selecione um fundo temático decorativo da biblioteca de imagens com opacidade ajustável e adicione uma moldura de borda com controlo de opacidade independente. Estas opções de layout dão às suas fichas de trem de padrões uma aparência profissional e polida antes de configurar qualquer parâmetro de padrão.',
      },
      {
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Crie conjuntos de 15 a 25 fichas de trem de padrões agrupados por tema — animais da quinta, dinossauros, criaturas marinhas, veículos, alimentos e mais. Varie tanto o tipo de padrão como o número de pistas no conjunto para dificuldade progressiva: comece com padrões AB mostrando 10 pistas, avance para AAB e ABB com 7 pistas e termine com padrões ABC e AABB a 4–5 pistas. Inclua o gabarito gerado automaticamente para cada ficha. O formato completamente visual sem texto permite que cada pacote se venda em todo o mundo sem tradução — uma única listagem serve todos os mercados na Etsy.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'O trem apresenta 11 vagões em três filas: 5 vagões na fila superior, 3 no centro-esquerda e 3 no centro-direita. Cada vagão contém uma imagem da sequência repetitiva. A ilustração temática do trem liga visualmente os vagões, criando uma disposição distintiva que se diferencia das fichas de padrões em grelha padrão nas listagens dos marketplaces.',
    },
    {
    ...
    },
    {
      ...
      answer: 'As fichas de trem de padrões são completamente visuais por conceção. Apenas aparecem imagens nos vagões — nenhuma palavra escrita na saída. Isto torna as fichas universalmente utilizáveis independentemente do idioma ou nível de leitura. Para os vendedores, a ausência de texto na saída significa que o mesmo produto se vende em todo o mundo sem tradução — uma única listagem serve todos os mercados. Mudar o idioma do conteúdo afeta apenas as etiquetas da interface no gerador, não a ficha impressa.',
    },
    {
      question: 'Como funciona o gabarito?',
      answer: 'O gabarito vive num separador de canvas separado, mostrando o trem completo com os 11 vagões preenchidos — incluindo a posição que estava em branco na ficha. Ambos os canvas são editáveis de forma independente, pelo que pode personalizar o gabarito separadamente. A ficha e o gabarito descarregam-se como ficheiros separados, oferecendo aos compradores um pacote de produto completo com soluções verificadas.',
    },
    {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'trem-padroes-fichas', anchorText: 'Fichas Trem de Padrões — Detalhes Completos do Produto' },
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      },
      {
        ...
        alt: 'Ficha de trem de padrões em modo padrão ABC de três elementos com imagens de veículos em vagões temáticos',
    ...
    videoTitle: 'Como Criar Fichas de Trem de Padrões com Cinco Tipos de Padrões — Tutorial Passo a Passo',
  },
};
