...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Mots Mêlés | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Mots Mêlés professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Grille de mots mêlés avec images thématiques',
      secondary: '/samples/english/wordsearch/Word Search 2.jpeg',
      secondaryAlt: 'Corrigé de mots mêlés avec mots surlignés',
    },
    sampleGallery: [
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Mots Mêlés thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Mots Mêlés est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'wordsearch', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Mots Mêlés Gratuit' },
