...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'vendre des fiches chasse au trésor sur Teachers Pay Teachers',
    ],
    lsiKeywords: [
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Dans le panneau Configuration du Puzzle, basculez entre deux vocabulaires de direction. Le Mode Simple utilise haut, bas, gauche et droite — idéal pour les élèves de maternelle et CP qui développent leur vocabulaire spatial fondamental. Le Mode Cardinal utilise nord, sud, est et ouest — adapté au CE1 et au-delà, introduisant les directions de la boussole et les compétences de lecture de carte. Les deux ensembles de directions sont entièrement traduits dans les 11 langues prises en charge, donc changer le sélecteur de langue met à jour le texte des indices directionnels sur la fiche.',
      },
      {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Le générateur utilise un système à double canevas avec un onglet Fiche et un onglet Corrigé, chacun avec des piles annuler/rétablir séparées. La fiche affiche la grille 5×5 avec les images dispersées et les indices directionnels — prête à être résolue par les élèves. Le corrigé reproduit la disposition identique et met en surbrillance la case finale du trésor en jaune pâle (rgba(255, 250, 205, 0.8)) avec un contour gris foncé, rendant la destination immédiatement visible. Les deux versions s\'exportent séparément avec quatre boutons de téléchargement dédiés : worksheet.jpeg, answer_key.jpeg, worksheet.pdf et answer_key.pdf.',
    },
    {
