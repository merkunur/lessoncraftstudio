...
const content: StartContent = {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: "Pilier des maths avec une demande toute l'année. Se combine naturellement avec la soustraction pour une stratégie de lots. Niveaux de difficulté configurables de le marché préscolaire au CE1, avec images thématiques et corrigés automatiques.",
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "Oui. Une licence commerciale vous permet de vendre vos fiches générées sur n'importe quelle plateforme : Etsy.fr, Amazon KDP, Gumroad, Gumroad ou votre propre site web. Chaque plateforme a des exigences de formatage et des attentes de public différentes, vous devrez donc peut-être adapter les annonces et les formats de lots. Mais les fiches sous-jacentes peuvent être utilisées sur toutes les plateformes simultanément.",
    },
    {
