...
(function (global) {
  ...
  global.ShapeForgeActivity = {
    ...
    strings: {
      ...
      /* it — native ensemble (linguista + pedagoga classe prima, Indicazioni nazionali). Verbo di
         composizione = "Costruisci" (MAI "Forgia" = opaco/avanzato per la prima; il tema-forgia resta
         nel titolo/voce di Mim). Pezzo = "pezzo/pezzi" (⚠ MAI "blocchi logici"/"blocchi" = blocchi di
