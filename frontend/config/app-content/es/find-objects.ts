...
const content: AppContent = {
    ...
    steps: [
      {
        ...
        description:
          'Abre el panel Página y Escena y elige un tamaño de página: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal o cualquier dimensión personalizada. Selecciona un color de fondo con el selector de color, elige un tema de fondo y ajusta su opacidad, y luego selecciona un tema de borde con su propio control de opacidad independiente. Estas opciones de diseño enmarcan tu ficha de objetos ocultos antes de configurar cualquier contenido.',
      },
      {
        title: 'Elige Tu Modo de Actividad',
        description:
          'Selecciona entre dos modos en el panel de Selección de Objetos. El modo Yo Espío (predeterminado) crea escenas de objetos ocultos en forma libre donde los objetos se dispersan por la página usando un algoritmo de posicionamiento sin superposición — sin cuadrícula, solo una escena visual de aspecto natural. El modo Encuentra el Diferente organiza imágenes emparejadas en filas con elementos sin pareja mezclados para actividades de discriminación visual. Cada modo produce un tipo diferente de ficha de búsqueda y encuentro a partir de la misma biblioteca de imágenes.',
      },
      {
        title: 'Selecciona Imágenes y Configura la Cantidad de Objetos',
        description:
  ...
  businessUseCases: {
    ...
    cases: [
      ...
      },
      {
        ...
        description:
          'Compila de 40 a 80 fichas de objetos ocultos en un cuaderno impreso formateado para Amazon KDP. Estructura tu libro por dificultad progresiva: los primeros capítulos ocultan 1–2 objetos entre 8 distractores para principiantes, los capítulos intermedios aumentan a 3–4 objetos ocultos con 10 distractores, y los capítulos avanzados usan 5 objetos ocultos entre 12 distractores. Incluye claves de respuestas al final del libro. La escala de grises produce páginas que ahorran tinta listas para interiores en blanco y negro. El diseño puramente visual significa que un solo cuaderno funciona para cualquier mercado lingüístico.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'En lugar de colocar imágenes en una cuadrícula fija, el modo Yo Espío usa un algoritmo findBestPosition() que prueba 50 posiciones aleatorias para cada imagen y selecciona la ubicación con menor superposición. Cuando el espacio es limitado, el algoritmo reduce adaptativamente el tamaño de la imagen para encajar más objetos sin saturar la escena. Esto crea escenas de objetos ocultos de aspecto natural donde las imágenes se dispersan orgánicamente por la página, haciendo la experiencia de búsqueda más atractiva que los diseños predecibles basados en cuadrícula.',
    },
    {
  ...
  internalLinks: [
    ...
    {
      pageType: 'tool',
      slug: 'generador-busca-objetos',
      anchorText: 'Generador de Fichas de Objetos Ocultos',
    },
    {
      pageType: 'start',
