...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Vær',
  title: 'Gratis Printbare Vær-oppgaver til Barn | LessonCraftStudio',
  description: 'Printbare vær-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med værtema. Førskole til 3. klasse. Gratis PDF. Last ned gratis PDF nå.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Vær-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare vær-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'væroppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, værfenomener, temperatur, værdagbok, værøvelser førskole, værets læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Vær-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare vær-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'væroppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, værfenomener, temperatur, værdagbok, værøvelser barnehage, værets læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Vær-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare vær-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. 3 000+ bilder. Ingen registrering.',
      seoKeywords: 'væroppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, værfenomener, temperatur, værdagbok, værøvelser 1. klasse, værets læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Vær-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare vær-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Velg mellom 3 000+ bilder.',
      seoKeywords: 'væroppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, værfenomener, temperatur, værdagbok, værøvelser 2. klasse, værets læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Vær-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare vær-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'væroppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, værfenomener, temperatur, værdagbok, værøvelser 3. klasse, værets læring 8-9 år',
