...
const content: StartContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Etsy is the recommended starting platform for most new printable sellers because of its large built-in audience and mature search features. After establishing 30+ listings and consistent sales on Etsy, expand to Amazon KDP for activity book formats and Gumroad for skill-aligned products. Do not split focus across multiple platforms until you have mastered one.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes. A commercial license allows you to sell your generated worksheets on any platform: Etsy, Amazon KDP, Gumroad, Gumroad, or your own website. Each platform has different formatting requirements and audience expectations, so you may need to adapt listings and bundle formats. But the underlying worksheets can be used across all platforms simultaneously.',
    },
    {
  ...
  visuals: {
    heroImage: { src: '/samples/english/math%20puzzle/math-puzzles.webp', alt: 'Math puzzle worksheet example created with LessonCraftStudio generator' },
    samples: [
      { src: '/samples/english/math%20puzzle/math-puzzles.webp', alt: 'Math puzzle worksheet showing configurable output variety', caption: 'Math Puzzle — Configurable Difficulty' },
