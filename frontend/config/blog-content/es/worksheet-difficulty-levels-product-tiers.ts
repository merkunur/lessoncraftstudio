...
const content: BlogContent = {
  seo: {
    ...
    titleTag: 'Niveles de Dificultad en Fichas | LessonCraftStudio',
  ...
  hero: {
    ...
    tagline: 'Diferentes niveles = diferentes productos = mas ventas',
    description: 'El mismo tipo de ficha en diferentes niveles de dificultad se convierte en multiples productos. Fichas de suma facil, intermedia y avanzada son tres productos distintos que apuntan a tres compradores diferentes. Esta estrategia multiplica su catalogo sin multiplicar el esfuerzo creativo y crea oportunidades naturales de venta cruzada.',
  },
  category: 'how-to',
