...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Sommer',
  title: 'Gratis sommer-arbejdsark til børn | LessonCraftStudio',
  description: 'Opret printbare arbejdsark med sommertema til børn. Strand, solskin, is og svømning. Matematik, læsning, puslespil og malebilleder fra førskole til 3. klasse.',
  keywords: 'sommer-arbejdsark, sommeraktiviteter til børn, sommer-malebilleder, sommer-matematikarbejdsark, printbare sommer-arbejdsark til børn',
  heading: 'Gratis sommer-arbejdsark til børn',
