...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Cartes de Bingo | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Cartes de Bingo professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Carte de bingo personnalisée avec images thématiques',

    },
    sampleGallery: [
      { src: '/samples/english/bingo/bingo_card word.jpeg', alt: 'Carte bingo avec mots', caption: 'Bingo avec mots' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Cartes de Bingo thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Cartes de Bingo est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'bingo', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Cartes de Bingo Gratuit' },
