...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Siffror',
  title: 'Gratis Siffror-övningar för Barn | LessonCraftStudio',
  description: 'Utskrivbara siffror-övningar för barn. Matematik, målarbilder, ordspel och pussel med siffrortema. Förskola till årskurs 3. Gratis PDF.',
  keywords: 'sifferövningar barn, siffer arbetsblad, siffer målarbilder, siffer matematik, siffer förskola, siffer utskrivbar, siffer pussel, siffer räkning, siffer korsord, siffror 1–20, antaligenkänning',
  heading: 'Sifferövningar och Arbetsblad',
