...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur Chercher et Compter | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Chercher et Compter professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche chercher et compter avec images d\'animaux',
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Chercher et Compter thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur Chercher et Compter est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'find-and-count', pageType: 'tool' as const, anchorText: 'Essayer Générateur Chercher et Compter Gratuit' },
