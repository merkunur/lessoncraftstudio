...
(function (global) {
  ...
  function speak(text, rate) {
    try {
      ...
      if (global.speechSynthesis && global.SpeechSynthesisUtterance) { var u = new global.SpeechSynthesisUtterance(text); u.rate = rate || 0.95; u.lang = (LANG === 'es' ? 'es-MX' : LANG === 'de' ? 'de-DE' : LANG === 'fr' ? 'fr-FR' : LANG === 'pt' ? 'pt-BR' : LANG === 'nl' ? 'nl-NL' : 'en-US'); global.speechSynthesis.cancel(); global.speechSynthesis.speak(u); }
    } catch (e) {}
  }
  ...
  global.BramBoardShopActivity = {
    ...
    strings: {
      title: { en: "Bram's Board Shop", de: 'Brams Bretter-Werkstatt', fr: 'L’atelier de Bram', es: 'El taller de tablas de Bram', pt: 'A Oficina de Tábuas do Bram', it: 'La bottega di Bram', nl: 'Brams houtwerkplaats' },
      prompt: { en: 'Measure the order.', de: 'Miss die Bestellung aus.', fr: 'Mesure la commande.', es: 'Mide el pedido.', pt: 'Meça o pedido.', it: 'Leggi la richiesta.', nl: 'Meet de bestelling op.' },
      measure: { en: 'Measure it 📏', de: 'Ausmessen 📏', fr: 'Mesurer 📏', es: 'Medir 📏', pt: 'Medir 📏', it: 'Misuralo 📏', nl: 'Opmeten 📏' },
      replay: { en: '🔊 Read again', de: '🔊 Noch einmal vorlesen', fr: '🔊 Relire', es: '🔊 Léelo otra vez', pt: '🔊 Ouvir de novo', it: '🔊 Ascolta di nuovo', nl: '🔊 Nog eens voorlezen' },
      sayWelcome: { en: 'A new order! Show me the lengths.', de: 'Eine neue Bestellung! Zeig mir die Längen.', fr: 'Une nouvelle commande ! Montre-moi les longueurs.', es: '¡Un pedido nuevo! Muéstrame las medidas.', pt: 'Um pedido novo! Me mostra as medidas.', it: 'Un nuovo ordine! Mostrami le lunghezze.', nl: 'Een nieuwe bestelling! Laat me de lengtes zien.' },
      sayModel: { en: 'Put each length on its piece. One piece is the mystery — mark it.', de: 'Leg jede Länge auf ihr Stück. Ein Stück ist das Rätsel – markiere es.', fr: 'Pose chaque longueur sur son morceau. Un morceau est le mystère — marque-le.', es: 'Pon cada medida en su pieza. Una pieza es el misterio: márcala.', pt: 'Coloque cada medida na sua peça. Uma peça é o mistério: marque ela.', it: 'Metti ogni lunghezza sul suo pezzo. Un pezzo è il mistero: segnalo.', nl: 'Leg elke lengte op zijn stuk. Eén stuk is het raadsel — markeer het.' },
      sayDial: { en: 'Now — how many centimetres? Dial it in!', de: 'Und jetzt – wie viele Zentimeter? Tippe es ein!', fr: 'Et maintenant — combien de centimètres ? Compose la réponse !', es: 'Y ahora, ¿cuántos centímetros? ¡Escríbelo!', pt: 'E agora: quantos centímetros? Digite aí!', it: 'E adesso: quanti centimetri? Digita la risposta!', nl: 'En nu — hoeveel centimeter? Tik het in!' },
      sayWin: { en: 'Measured and cut! Perfect fit. 🪵', de: 'Gemessen und gesägt! Passt genau. 🪵', fr: 'Mesuré et coupé ! Ça tombe pile. 🪵', es: '¡Medido y cortado! Queda justo. 🪵', pt: 'Medido e cortado! Ficou perfeito. 🪵', it: 'Misurato e tagliato! Combacia alla perfezione. 🪵', nl: 'Opgemeten en gezaagd! Past precies. 🪵' },
      sayWait: { en: "Hmm, let's measure again.", de: 'Hmm, lass uns noch einmal messen.', fr: 'Hmm, remesurons ensemble.', es: 'Mmm, midamos otra vez.', pt: 'Hmm, vamos medir de novo.', it: 'Mmm, misuriamo di nuovo.', nl: 'Hmm, laten we nog eens meten.' },
      pickTile: { en: 'Now tap the piece where it belongs.', de: 'Tippe nun auf das Stück, wo sie hingehört.', fr: 'Touche maintenant le morceau où elle va.', es: 'Ahora toca la pieza donde va.', pt: 'Agora toque na peça onde ela vai.', it: 'Adesso tocca il pezzo giusto.', nl: 'Tik nu op het stuk waar hij hoort.' },
      hintCheck: { en: 'Place the lengths, mark the mystery, dial the cm.', de: 'Leg die Längen hin, markiere das Rätsel, tippe die cm ein.', fr: 'Pose les longueurs, marque le mystère, compose les cm.', es: 'Acomoda las medidas, marca el misterio y escribe los cm.', pt: 'Coloque as medidas, marque o mistério e digite os cm.', it: 'Metti le lunghezze, segna il mistero, digita i centimetri.', nl: 'Leg de lengtes neer, markeer het raadsel, tik de cm in.' },
      ariaMystery: { en: 'mystery length', de: 'Rätsel-Länge', fr: 'longueur mystère', es: 'largo misterioso', pt: 'comprimento misterioso', it: 'lunghezza misteriosa', nl: 'raadsel-lengte' },
      ariaHolds: { en: 'holds {n} centimetres', de: 'ist {n} Zentimeter lang', fr: 'mesure {n} centimètres', es: 'mide {n} centímetros', pt: 'mede {n} centímetros', it: 'contiene {n} centimetri', nl: 'is {n} centimeter lang' },
      ariaEmpty: { en: 'empty piece — tap to place a length or mark the mystery', de: 'leeres Stück – tippe, um eine Länge zu platzieren oder das Rätsel zu markieren', fr: 'morceau vide — touche pour poser une longueur ou marquer le mystère', es: 'pieza vacía: toca para poner una medida o marcar el misterio', pt: 'peça vazia — toque para colocar uma medida ou marcar o mistério', it: 'pezzo vuoto: tocca per mettere una lunghezza o segnare il mistero', nl: 'leeg stuk — tik om een lengte te plaatsen of het raadsel te markeren' },
      ariaTileCm: { en: '{n} centimetres', de: '{n} Zentimeter', fr: '{n} centimètres', es: '{n} centímetros', pt: '{n} centímetros', it: '{n} centimetri', nl: '{n} centimeter' },
      ariaRecap: { en: 'your model: {eq} centimetres', de: 'dein Modell: {eq} Zentimeter', fr: 'ton modèle : {eq} centimètres', es: 'tu modelo: {eq} centímetros', pt: 'seu modelo: {eq} centímetros', it: 'il tuo modello: {eq} centimetri', nl: 'jouw model: {eq} centimeter' },
