...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Usa il pannello "Strumenti testo" per aggiungere un titolo come "Cancella e Conta" o "Sottrazioni Divertenti". Scegli tra caratteri adatti ai bambini come Fredoka, Baloo 2, Quicksand e Nunito. Regola dimensione del carattere, colore e contorno opzionale del testo per una migliore leggibilità sugli sfondi. Aggiungi il nome del tuo negozio o un avviso di copyright per rendere il tuo marchio visibile su ogni scheda.',
      },
      {
  ...
  whatYouCanCreate: [
    {
      ...
      description: 'Crea un set di 10–20 schede usando la modalità Cancella in cui i bambini barrano le immagini per risolvere ogni esercizio. Raggruppale per tema — dinosauri, animali della fattoria, creature marine — e vendile come pacchetti di sottrazione visuale su Etsy o Teachers Pay Teachers. Il formato Cancella è il più richiesto dagli educatori della prima infanzia perché rende la sottrazione tangibile e comprensibile.',
    },
    {
    ...
    },
    {
      ...
      description: 'Genera tre versioni della stessa scheda a diversi livelli di difficoltà: facile (minuendo massimo 5), medio (minuendo massimo 10) e difficile (minuendo massimo 20). Gli insegnanti possono assegnare il livello giusto a ogni alunno senza dedicare tempo extra alla preparazione. Includi la modalità Trova il Sottraendo nel set avanzato per stimolare il pensiero algebrico.',
    },
    {
    ...
    },
    {
      ...
      description: 'Usa la modalità Trova il Sottraendo in esclusiva per creare schede di sottrazione del tipo "trova il numero mancante". Questo formato è molto apprezzato dagli insegnanti di prima e seconda elementare perché sviluppa il pensiero algebrico precoce. Commercializzale come linea di prodotti separata accanto ai pacchetti di sottrazione standard per ampliare il tuo catalogo.',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'La modalità Trova il Sottraendo mostra la quantità iniziale e il risultato, e il bambino deve capire quante immagini sono state tolte. È significativamente più difficile e sviluppa il pensiero algebrico precoce. Riserva questa modalità per la seconda elementare e oltre, oppure commercializzala come prodotto "Sfida" separato. Su Etsy e TpT, le schede "trova il numero mancante" attirano un segmento distinto di acquirenti.',
    },
    {
      title: 'Includi sempre la chiave di correzione',
      description: 'Clicca su "Genera chiave di correzione" prima di scaricare la tua scheda. Nelle schede Cancella, la chiave di correzione mostra chiaramente quali immagini sono barrate, rendendo la correzione istantanea. Gli acquirenti su Etsy e Teachers Pay Teachers valutano sistematicamente meglio i prodotti che includono una chiave di correzione. Ci vogliono solo pochi secondi in più e migliorano notevolmente le tue valutazioni e gli acquisti ripetuti.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Sì. Dopo aver generato una scheda, clicca su "Genera chiave di correzione" per creare un foglio di soluzioni corrispondente con tutte le risposte compilate. Per le schede Cancella, la chiave di correzione mostra chiaramente quali immagini sono barrate. Puoi scaricare la chiave di correzione come file JPEG o PDF separato.',
    },
    {
