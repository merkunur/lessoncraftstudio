...
const content: GuideContent = {
  ...
  tutorial: [
    ...
    {
      heading: 'Secção 7 — Construa o catálogo de livros de puzzles',
      content: 'O verdadeiro potencial de rendimento na publicação de livros de puzzles vem da construção de catálogo, não de livros individuais. Um único livro de puzzles pode gerar 30 a 100 dólares por mês em regalías. Um catálogo de 20 a 30 livros multiplica esse rendimento proporcionalmente enquanto cria efeitos de descoberta cruzada — os compradores que encontram e gostam de um livro exploram os seus outros títulos.\n\nA estratégia de séries é a abordagem mais eficaz. Publique séries de volumes numerados para o seu tipo de puzzle principal: \"Caça-Palavras para Adultos Volume 1\", \"Volume 2\", \"Volume 3\" e assim por diante. Os compradores que terminam um volume têm um caminho de compra claro para o próximo. A Amazon também exibe \"Outros livros nesta série\" na página do produto, proporcionando descoberta gratuita.\n\nEdições sazonais e temáticas criam picos de vendas previsíveis. Um livro de puzzles de Natal publicado em outubro tem uma janela de vendas concentrada mas intensa. Os livros de puzzles de verão para viagens vendem fortemente de maio a agosto. Os livros com tema de regresso às aulas performam de julho a setembro. Planeie o seu calendário de publicação para ter títulos sazonais prontos 4 a 6 semanas antes do pico de procura.\n\nA segmentação por idade multiplica o seu catálogo para o mercado infantil. O mesmo tema pode gerar livros separados para 4-6 anos (puzzles simples, grelhas grandes), 6-8 anos (dificuldade média, grelhas standard) e 8-12 anos (puzzles desafiantes, grelhas complexas). Cada versão por idade é um produto separado com o seu próprio posicionamento de pesquisa.\n\nÀ medida que o catálogo cresce, a gestão de qualidade torna-se crítica. Mantenha uma formatação consistente entre livros para que os compradores recorrentes tenham expectativas satisfeitas. Use modelos de capa com marca da série para reconhecimento visual. Atualize anúncios de livros existentes para referir novos títulos da série. Monitorize avaliações regularmente e responda a qualquer problema de qualidade rapidamente para proteger a reputação do seu editor.',
    },
  ],
  ...
  monetization: [
    ...
    {
      heading: 'Edições sazonais e temáticas',
      content: 'As edições sazonais criam picos de vendas previsíveis que complementam as vendas de base da sua série principal. Os livros de puzzles de Natal (publicados em outubro) captam compradores de presentes durante novembro e dezembro. Os livros de puzzles de verão e viagens vendem de maio a agosto. Os livros com tema de regresso às aulas performam fortemente de julho a setembro. Os livros de puzzles de Dia dos Namorados, Páscoa e Halloween também têm janelas de vendas concentradas. A estratégia é ter títulos sazonais publicados 4 a 6 semanas antes do pico de procura — a Amazon precisa de tempo para indexar o anúncio e o algoritmo favorece livros com algum histórico de vendas. Cada edição sazonal é um produto separado com palavras-chave sazonais específicas, expandindo o seu catálogo e a área de pesquisa coberta.',
    },
    {
      heading: 'Versões segmentadas por idade',
      content: 'A segmentação por faixa etária permite multiplicar o catálogo a partir do mesmo tema. Um tema como \"animais\" pode gerar três livros separados: uma versão para 4-6 anos com grelhas grandes de caça-palavras simples e sudoku com imagens, uma versão para 6-8 anos com dificuldade média e puzzles variados, e uma versão para 8-12 anos com puzzles desafiantes e grelhas complexas. Cada versão é um produto separado na Amazon com as suas próprias palavras-chave de pesquisa — \"livro puzzles crianças 4 6 anos\", \"livro atividades 8 10 anos\" — capturando diferentes segmentos de compradores. Os pais frequentemente compram a versão apropriada para cada filho, gerando múltiplas vendas da mesma linha de produtos. Para adultos, a segmentação por dificuldade funciona de forma semelhante: \"Fácil\", \"Médio\" e \"Difícil\" como livros separados em vez de secções dentro do mesmo livro.',
    },
  ],
  ...
  examples: [
    ...
    {
      heading: 'Exemplo: Coleção de caça-palavras para adultos — Volume 1',
      content: 'Um livro de caça-palavras de 110 páginas dirigido a adultos que apreciam livros de puzzles para relaxamento e entretenimento. O interior usa corte de 21,59 × 27,94 cm (8,5 × 11 polegadas) com margens de 1,27 cm (0,5 polegadas). O livro contém 100 puzzles de caça-palavras organizados em Fácil (puzzles 1 a 35 com grelhas de 12 × 12 e 12 palavras ocultas cada), Médio (puzzles 36 a 70 com grelhas de 16 × 16 e 18 palavras ocultas cada) e Difícil (puzzles 71 a 100 com grelhas de 20 × 20 e 25 palavras ocultas cada). Todos os caça-palavras são temáticos — animais, viagens, alimentos, natureza, desportos, filmes e mais — com o tema mostrado de forma proeminente em cada página junto à lista de palavras. As páginas 101 a 110 contêm as 100 grelhas de solução. A capa usa um design limpo e sofisticado com fundo azul suave, título grande em serifada \"Caça-Palavras para Adultos: Volume 1\", um subtítulo \"100 Puzzles Temáticos — Fácil a Difícil com Soluções Completas\" e uma pequena grelha de caça-palavras de exemplo. A marca da série é estabelecida para uso consistente nos Volumes 2 a 10. Preço de 7,99 dólares com aproximadamente 4,55 dólares em custos de impressão pelas 110 páginas, produzindo uma regalía de aproximadamente 0,24 dólares por venda — ilustrando por que muitos editores fixam preços de livros de caça-palavras para adultos entre 9,99 e 11,99 dólares para alcançar regalías viáveis de 1,50 a 2,50 dólares por venda com maior número de páginas. As palavras-chave apontam a \"caça-palavras para adultos\", \"livro caça-palavras letra grande\" e \"puzzles procurar palavras entretenimento\".',
    },
  ],

  faq: [
    {
      question: 'Quantos puzzles deve conter um livro de puzzles KDP?',
      answer: 'O padrão do mercado varia por tipo de puzzle e audiência. Os livros de caça-palavras para adultos tipicamente contêm 80 a 100 puzzles por volume. As coleções de palavras cruzadas geralmente incluem 50 a 75 puzzles. Os livros de sudoku variam de 100 a 200 puzzles porque as grelhas de sudoku são mais pequenas e alguns editores colocam 2 por página. Os livros de puzzles de variedade infantis funcionam bem com 40 a 60 puzzles. O princípio chave é que os compradores esperam conteúdo substancial — um livro de puzzles com apenas 20 a 30 puzzles gerará queixas sobre valor insuficiente independentemente do preço. Verifique os livros mais vendidos na sua subcategoria específica para calibrar o número de puzzles segundo as expectativas do comprador.',
    },
    {
      question: 'Devo colocar as soluções no final do livro ou na página seguinte após cada puzzle?',
      answer: 'Coloque todas as soluções numa secção dedicada no final do livro. Este é o formato padrão que os compradores de livros de puzzles esperam. As soluções colocadas imediatamente após cada puzzle frustram os solucionadores porque podem ver acidentalmente a resposta enquanto trabalham. O formato de soluções no final também mantém a secção de puzzles limpa e ininterrupta. Etiquete cada solução claramente com o número de página do puzzle correspondente para que os usuários possam procurar rapidamente respostas específicas. Inclua uma nota no início da secção de soluções a explicar o sistema de referência por número de página.',
    },
    {
      question: 'Posso misturar diferentes tipos de puzzles num livro, ou cada livro deve focar-se num tipo?',
      answer: 'Ambos os formatos vendem bem, mas servem mercados diferentes. Os livros de tipo único posicionam melhor para pesquisas específicas da Amazon e atraem entusiastas dedicados que preferem um formato de puzzle. Os livros de variedade atraem aficionados casuais de puzzles, compradores de presentes e leitores que querem entretenimento diverso. Muitos editores bem-sucedidos mantêm ambos: uma série de volumes numerados para o seu tipo de puzzle principal (Caça-Palavras Volume 1, 2, 3) e livros de variedade de puzzles separados que misturam múltiplos tipos. Se está começando, comece com um livro de tipo único dirigido à categoria de maior procura (caça-palavras ou palavras cruzadas) para estabelecer posicionamento, depois expanda para livros de variedade uma vez que tenha fluxos de trabalho de produção de conteúdo estabelecidos.',
    },
    {
      question: 'Qual é o melhor tamanho de corte para livros de puzzles na KDP?',
      answer: 'O formato de 21,59 × 27,94 cm (8,5 × 11 polegadas) é a opção mais popular para livros de puzzles e a que a maioria dos compradores espera. Este tamanho proporciona máximo espaço de grelha para resolução confortável de puzzles e corresponde ao formato padrão que os compradores reconhecem. Para livros de puzzles de viagem comercializados como entretenimento portátil, 15,24 × 22,86 cm (6 × 9 polegadas) é viável mas requer grelhas mais pequenas que alguns usuários consideram menos confortáveis. O tamanho de 20,32 × 25,40 cm (8 × 10 polegadas) oferece um compromisso. Para livros de puzzles em letra grande especificamente, use sempre 21,59 × 27,94 cm para maximizar o espaço disponível para texto e grelhas de tamanho grande. O tamanho de corte afeta tanto o custo de impressão como as expectativas de preço de venda, portanto considere os cálculos de regalías ao escolher.',
    },
    {
      question: 'Como devo lidar com os níveis de dificuldade num livro de puzzles?',
      answer: 'Organize o seu livro em secções claramente etiquetadas Fácil, Médio e Difícil. Cada secção deve introduzir-se com uma página separadora que mostre o nível de dificuldade de forma proeminente. Para caça-palavras, escale a dificuldade através do tamanho da grelha, número de palavras e complexidade do vocabulário. Para palavras cruzadas, escale através da objetividade das pistas e da densidade da grelha. Para sudoku, use classificações de dificuldade estabelecidas. Para livros de variedade, cicle pelos tipos de puzzles em cada nível de dificuldade para que os leitores encontrem formatos frescos à medida que progridem. Marque sempre o nível de dificuldade em cada página individual do puzzle assim como ao nível de secção, para que os leitores que saltam possam identificar imediatamente o nível de desafio de um puzzle.',
    },
    {
      question: 'Os livros de puzzles precisam de ser a cores ou podem ser a preto e branco?',
      answer: 'A grande maioria dos livros de puzzles bem-sucedidos na KDP usa interiores a preto e branco com capa a cores. A impressão a cores é dramaticamente mais cara — um interior a cores de 100 páginas custa aproximadamente 3 a 4 vezes mais do que a preto e branco, o que força um preço de venda não competitivo ou elimina completamente a sua regalía. As grelhas de puzzles, listas de palavras e pistas de palavras cruzadas reproduzem-se perfeitamente a preto e branco. A única exceção são os livros de puzzles infantis onde as ilustrações coloridas fazem parte do formato do puzzle (como conteúdo baseado em imagens), mas mesmo estes podem ser desenhados eficazmente em escala de cinzentos com arte linear de alto contraste. Desenhe para preto e branco desde o início em vez de converter conteúdo a cores para escala de cinzentos depois.',
    },
    {
      question: 'Qual é a política de reembolso para licenças comerciais usadas para criar livros de puzzles KDP?',
      answer: 'Cada gerador oferece um teste grátis com marca d\'água para que possa avaliar completamente a ferramenta antes de comprar. Crie puzzles completos com todas as funcionalidades, teste diferentes temas e configurações de grelha, verifique a qualidade de impressão a 300 DPI e confirme que o resultado cumpre os seus requisitos de formatação. Como pode avaliar exaustivamente o produto antes de comprar, todas as vendas de licenças comerciais são definitivas. Esta é uma prática padrão para ferramentas de produtos digitais onde a funcionalidade completa pode ser pré-visualizada antes da compra.',
    },
  ],
  ...
  toolsRecommended: [
    {
      ...
      description: 'A ferramenta essencial para publicação de livros de puzzles na KDP. O caça-palavras é a categoria de livros de puzzles mais popular na Amazon, e este gerador cria grelhas de caça-palavras temáticas com tamanhos, listas de palavras e níveis de dificuldade personalizáveis tanto para livros de adultos como infantis.',
    },
    {
      appId: 'crossword',
      title: 'Gerador de palavras cruzadas',
      description: 'Cria palavras cruzadas temáticas com pistas e grelhas de resposta. Os livros de palavras cruzadas são a segunda categoria de puzzles mais popular na Amazon, e o conteúdo de palavras cruzadas acrescenta valor substancial de envolvimento aos livros de puzzles de variedade.',
    },
    {
      appId: 'sudoku',
      title: 'Gerador de puzzles de sudoku',
      description: 'Produz puzzles de sudoku baseados em imagens ideais para livros de puzzles infantis. O sudoku com imagens ensina pensamento lógico sem requerer competências matemáticas, tornando-o acessível para solucionadores jovens e uma adição forte a livros de variedade de puzzles infantis.',
    },
    {
      appId: 'math-puzzle',
    ...
    },
    {
      ...
      title: 'Gerador de peças em falta',
      description: 'Cria puzzles de completar visualmente onde os solucionadores identificam o elemento em falta. Estes desafios baseados em observação complementam os livros de variedade de puzzles infantis com um tipo de puzzle que desenvolve competências de processamento visual.',
    },
  ],
