...
const content: BundleContent = {
  ...
  appsIncluded: [
    ...
    },
    {
      ...
      description: 'Create maze and path-finding worksheets in three distinct modes. Pathway mode generates a visual route through a grid of images — solvers trace the correct path following a specific image sequence, combining visual scanning with sequential thinking. Classic Maze mode produces traditional maze structures with themed image decorations at the start and finish, giving you the familiar maze format that buyers search for with added visual appeal. Choose-the-Path mode presents a branching decision tree where solvers select the correct route at each fork based on visual clues — a unique format that combines maze-solving with logical decision-making. The three-mode structure lets you create diverse maze products from a single generator: pathway puzzles for beginners, classic mazes for the broadest audience, and branching path challenges for those ready for multi-step problem-solving. Configure grid size, path complexity, and the number of decision points to control difficulty. Every mode generates a matching answer key automatically showing the correct route highlighted on the maze. All three modes produce purely visual worksheets with no text on the page, so every maze works in any language worldwide. Maze worksheets are a perennial bestseller category — they require no instruction beyond "find the path" and appeal to buyers of all ages.',
    },
  ],
  ...
  bundleBenefits: [
    ...
    },
    {
      ...
      description: 'All four generators produce automatic answer keys with every worksheet — the only bundle with complete answer key coverage across every app. Missing Pieces shows the correct placements, Odd One Out highlights the correct item in each row, Sudoku displays the completed grid, and Picture Path traces the correct route. Answer keys are a top buyer expectation on Etsy and Gumroad, and having them for every single product in the bundle means you never have to create solutions manually.',
    },
    {
      title: 'Higher-Order Cognitive Skills',
      description: 'Each generator targets a different cognitive skill within the puzzle and logic category. Missing Pieces develops spatial reasoning and visual memory. Odd One Out strengthens visual discrimination and categorical thinking. Picture Sudoku builds logical deduction and process-of-elimination reasoning. Picture Path exercises sequential thinking and decision-making. Together, these four generators cover the full spectrum of puzzle-based cognitive skills that buyers value most — positioning your products as developmental tools, not just entertainment.',
    },
    {
      title: 'Wide Age Range Appeal',
      description: 'Puzzle and logic worksheets naturally span a broader age range than basic skill-building activities. Simple Missing Pieces grids and easy Odd One Out rows work for the early-learner market, while complex Sudoku puzzles and branching maze paths challenge second and third graders. This wide appeal means more potential buyers per product listing and the ability to create grade-leveled product lines that grow with your buyer base — from "Early Learning Puzzle Pack" through "Third Grade Logic Challenge."',
    },
    {
  ...
  businessUseCases: [
    ...
    {
      title: 'Gumroad Logic Bundles',
      description: 'Gumroad buyers value logic and critical thinking resources that go beyond basic skill drills. Package worksheets from all four generators into grade-level logic packs: "Early Learning Puzzle Pack" with easy grids and simple mazes, or "Second Grade Logic Challenge" with complex Sudoku and branching path problems. The 100% answer key coverage meets buyer expectations for complete, ready-to-use resources. The cognitive skill variety — spatial reasoning, visual discrimination, logical deduction, and problem-solving — aligns with the critical thinking focus that buyers search for specifically.',
      platform: 'Gumroad',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Each generator produces print-ready PDF and high-resolution JPEG files. Choose from Letter Portrait, Letter Landscape, A4 Portrait, A4 Landscape, Square, or enter a custom size. PDF is ideal for multi-page puzzle packs on Etsy and Gumroad. JPEG works well for KDP interior pages and social media previews. All files download at print resolution — no upscaling or post-processing needed.',
    },
    {
  ...
  visuals: {
    ...
    sampleGallery: [
      { src: '/samples/english/missing%20pieces/missing-pieces.webp', alt: 'Missing pieces puzzle with image grid segments removed', caption: 'Missing Pieces Puzzle' },
      { src: '/samples/english/odd%20one%20out/find-the-odd-one-out.webp', alt: 'Odd one out worksheet with rows of similar images and one different', caption: 'Odd One Out Worksheet' },
      { src: '/samples/english/sudoku/sudoku-worksheet.webp', alt: '4x4 picture Sudoku puzzle with themed images instead of numbers', caption: 'Picture Sudoku Puzzle' },
      { src: '/samples/english/picture%20path/picture-pathway.webp', alt: 'Picture path maze with themed image route through grid', caption: 'Picture Path Maze' },
    ],
