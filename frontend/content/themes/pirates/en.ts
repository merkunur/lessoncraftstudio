...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Pirates',
  title: 'Pirate & Adventure Worksheets for Kids | LessonCraftStudio',
  description: 'Explore pirate worksheets for kids: treasure maps, ships, gold coins, and flags. Free printable activities for preschool to 3rd grade. Ahoy, fun learning ahead.',
  keywords: 'pirate coloring pages for kids, treasure map activities printable, pirate ship worksheets for kindergarten, pirate math counting worksheets, pirate vocabulary for kindergarten, gold coin counting activities, pirate themed puzzles for kids, pirate flag worksheets printable, pirate sorting activities for kids, pirate adventure learning activities',
  heading: 'Pirate and Adventure Worksheets for Kids',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Pirate Preschool Worksheets \u2014 Count Gold & Trace | LCS',
      seoDescription: 'Free printable pirate worksheets for preschool (ages 3-4). Count gold coins, trace ship words, color parrot scenes, and match treasure shadows. Get pages.',
      seoKeywords: 'preschool pirate gold coin counting worksheets one to ten treasure chest ages 3-4, trace pirate vocabulary words worksheets ship anchor parrot letter formation preschool free, color pirate ship parrot scenes worksheets large outlines fine motor preschool printable, match pirate treasure shadow silhouettes worksheets visual discrimination preschool pages, pirate treasure map path following worksheets directional thinking preschool activities',
    ...
    'kindergarten': {
      seoTitle: 'Pirate Kindergarten Worksheets \u2014 Add Coins & Decode | LCS',
      seoDescription: 'Free printable pirate worksheets for kindergarten (ages 5-6). Add gold coins, decode word searches, navigate treasure maps, and find hidden objects. Print.',
      seoKeywords: 'kindergarten pirate addition subtraction worksheets gold coin counters within 10 ages 5-6, pirate treasure word search worksheets compass island vocabulary kindergarten free, navigate pirate treasure map grid worksheets directional vocabulary kindergarten printable, find hidden objects pirate ship scene worksheets visual scanning kindergarten pages, pirate crew pattern sequence worksheets repeating alternating prediction kindergarten activities',
    ...
    'first-grade': {
      seoTitle: 'Pirate First Grade Worksheets \u2014 Word Problems & Codes | LCS',
      seoDescription: 'Free printable pirate worksheets for first grade (ages 6-7). Solve treasure math, crack cryptogram codes, read adventure passages, and plot grid maps. Get now.',
      seoKeywords: 'first grade pirate word problem worksheets multi-step treasure addition subtraction within 20 ages 6-7, pirate cryptogram code breaking worksheets symbol letter deduction first grade free, pirate adventure reading comprehension worksheets navigation passage first grade printable, plot treasure grid coordinate worksheets row column map navigation first grade pages, pirate island maze path finding worksheets sequential planning first grade activities',
    ...
    'second-grade': {
      seoTitle: 'Pirate Second Grade Worksheets \u2014 Navigate & Write | LCS',
      seoDescription: 'Free printable pirate worksheets for second grade (ages 7-8). Solve treasure math, plot grid coordinates, read explorer texts, and write sea journals. Print.',
      seoKeywords: 'second grade pirate multi-step word problem worksheets treasure addition subtraction within 100 ages 7-8, plot pirate grid coordinate worksheets letter number pairs map navigation second grade free, pirate explorer reading comprehension worksheets navigation passage inference second grade printable, pirate sea journal writing prompt worksheets structured descriptive paragraphs second grade pages, pirate treasure cryptogram decoding worksheets advanced vocabulary cartography second grade activities',
    ...
    'third-grade': {
      seoTitle: 'Pirate Third Grade Worksheets \u2014 Multiply & Research | LCS',
      seoDescription: 'Free printable pirate worksheets for third grade (ages 8-9). Multiply treasure totals, divide crew shares, research explorers, and write adventure tales. Go.',
      seoKeywords: 'third grade pirate treasure multiplication worksheets multi-step gold coin calculation ages 8-9, divide pirate treasure equally worksheets fraction crew sharing remainder third grade free, age of exploration reading comprehension worksheets multi-source historical evidence third grade printable, pirate adventure narrative writing worksheets dialogue descriptive historical detail third grade pages, pirate ship area perimeter calculation worksheets geometry deck measurement third grade activities',
