...
const content: AppContent = {
  seo: {
    primaryKeyword: 'werkbladen optellen printen',
    secondaryKeywords: [
      'sommen optellen generator',
      'oefenbladen optellen groep 3 4',
      'plus sommen printen',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Je kunt het minimum en maximum aantal elementen per groep instellen van 1 tot 10. Dit stelt je in staat om eenvoudige sommen zoals 1+1 te maken voor kleuterschool of uitdagendere sommen richting 10+10 voor groep 3 en 4 van de basisschool. De aanpassing gaat met twee eenvoudige invoervelden in het paneel Oefenconfiguratie. Deze precieze controle maakt het eenvoudig om productlijnen per niveau te maken — een kleuterpakket met bereik 1–3, een groep 1–2 pakket met bereik 1–5 en een groep 3–4 pakket met bereik 1–10.',
    },
    {
    ...
    {
      question: 'Kan ik mijn eigen afbeeldingen gebruiken in plaats van de ingebouwde bibliotheek?',
      answer:
        'Absoluut. Het paneel Afbeeldingen Uploaden stelt je in staat om je eigen PNG- of JPEG-bestanden rechtstreeks in de generator te laden. Geüploade afbeeldingen werken met alle vier de oefenmodi en verschijnen naast de bibliotheekafbeeldingen, zodat je aangepaste illustraties kunt combineren met de ingebouwde collectie voor een uniek resultaat.',
    },
    {
  ...
  visuals: {
    ...
    videoTitle: 'Optellen Werkbladen Maken met Afbeeldingen — Stap-voor-Stap Handleiding',
  },
};
