...
class HomepageContentManager {
  ...
  private async getSamples(locale: string): Promise<WorksheetSample[]> {
    ...
    const localeSamples: Record<string, Record<string, string>> = {
      de: {
        'addition': 'additionsspa-3.webp',
        'alphabet train': 'alphabet-zug-1.webp',
        'big small': 'groß-oder-klei-2.webp',
        'bingo': 'bilder-bingo-1-callout.webp',
        'chart count': 'bilddiagramm-4.webp',
        'code addition': 'code-knacker-addition-2.webp',
        'crossword': 'bilderkreuzworträtse-1.webp',
        'cryptogram': 'bilder-kryptogramm-2.webp',
        'draw and color': 'zeichnen-und-ausmale-2.webp',
        'drawing lines': 'linien-zeichnen-üben-7.webp',
        'find and count': 'ich-sehe-was-3.webp',
        'find objects': 'finde-das-unpassende-1-v7.webp',
        'grid match': 'raster-puzzle-3.webp',
        'matching': 'paare-finden-2.webp',
        'math puzzle': 'mathe-rätsel-4.webp',
        'math worksheet': 'mathe-übungsblatt-5.webp',
        'missing pieces': 'fehlende-teile-2.webp',
        'more less': 'mehr-weniger-1.webp',
        'odd one out': 'finde-das-andere-3.webp',
        'pattern train': 'musterzug-5.webp',
        'pattern worksheet': 'musterrätsel-4.webp',
        'picture path': 'bilderpfad-1.webp',
        'picture sort': 'bilder-sortieren-2.webp',
        'prepositions': 'präpositionen-4.webp',
        'shadow match': 'schatten-zuordnen-3.webp',
        'subtraction': 'subtraktion-spaß-3.webp',
        'sudoku': 'bilder-sudoku-3.webp',
        'treasure hunt': 'schatzsuche-1.webp',
        'word guess': 'wörter-rätsel-2.webp',
        'word scramble': 'buchstabensala-1.webp',
        'wordsearch': 'wörter-suchen-4.webp'
      },
      fr: {
        'addition': 'addition-amusant-2.webp',
        'alphabet train': 'Train de l\'alphabet-3.webp',
        'big small': 'grand-ou-petit-3.webp',
        'bingo': 'Loto d\'images-4-callout-3.webp',
        'chart count': 'worksheet.webp',
        'code addition': 'code-secret-addition-4.webp',
        'crossword': 'mots-croisés-en-images-1.webp',
        'cryptogram': 'cryptogramme-en-images-1.webp',
        'draw and color': 'dessine-et-colorie-6.webp',
        'drawing lines': 'pratique-de-tracer-des-lignes-5.webp',
        'find and count': 'je-vois,-je-voi-4.webp',
        'find objects': 'Trouve l\'intrus-2.webp',
        'grid match': 'puzzle-grille-2.webp',
        'matching': 'trouve-les-paires-1.webp',
        'math puzzle': 'casse-têtes-mathématiques-1.webp',
        'math worksheet': 'feuille-de-mathématique-2.webp',
        'missing pieces': 'pièces-manquantes-2.webp',
        'more less': 'plus-moins-3.webp',
        'odd one out': 'Trouve l\'intrus-2-v9.webp',
        'pattern train': 'train-à-motifs-4.webp',
        'pattern worksheet': 'puzzles-de-motifs-1.webp',
        'picture path': 'Chemin d\'images-2.webp',
        'picture sort': 'Tri d\'images-2.webp',
        'prepositions': 'prépositions-1.webp',
        'shadow match': 'Trouve l\'ombre-3.webp',
        'subtraction': 'soustractions-amusantes-4.webp',
        'sudoku': 'sudoku-en-images-3.webp',
        'treasure hunt': 'chasse-au-trésor-3.webp',
        'word guess': 'devine-le-mot-1.webp',
        'word scramble': 'mots-mêlés-2.webp',
        'wordsearch': 'mots-cachés-3.webp'
      },
      es: {
        'addition': 'suma-divertida-4.webp',
        'alphabet train': 'tren-del-alfabeto-4.webp',
        'big small': 'grande-o-pequeño-1.webp',
        'bingo': 'bingo-de-imágenes-4.webp',
        'chart count': 'gráfico-de-dibujos-4.webp',
        'code addition': 'código-secreto-suma-1.webp',
        'crossword': 'crucigrama-con-dibujos-1.webp',
        'cryptogram': 'criptograma-de-dibujos-5.webp',
        'draw and color': 'dibuja-y-colorea-12.webp',
        'drawing lines': 'practica-de-dibujar-línea-4.webp',
        'find and count': 'veo-veo-2.webp',
        'find objects': 'encuentra-el-diferente-3.webp',
        'grid match': 'puzzle-de-cuadrícula-1.webp',
        'matching': 'encuentra-parejas-4.webp',
        'math puzzle': 'rompecabezas-matemáticos-2.webp',
        'math worksheet': 'hoja-de-matemáticas-2.webp',
        'missing pieces': 'piezas-perdidas-1.webp',
        'more less': 'más-menos-2.webp',
        'odd one out': 'encuentra-el-diferente-1.webp',
        'pattern train': 'tren-de-patrones-4.webp',
        'pattern worksheet': 'rompecabezas-de-patrones-2.webp',
        'picture path': 'camino-de-imágenes-2.webp',
        'picture sort': 'clasificación-de-imágenes-1.webp',
        'prepositions': 'preposiciones-3.webp',
        'shadow match': 'empareja-las-sombras-1.webp',
        'subtraction': 'restas-divertidas-5.webp',
        'sudoku': 'sudoku-de-imágenes-1.webp',
        'treasure hunt': 'búsqueda-del-tesoro-4.webp',
        'word guess': 'adivina-la-palabra-2.webp',
        'word scramble': 'palabras-revueltas-5.webp',
        'wordsearch': 'sopa-de-letras-2.webp'
      },
      it: {
        'addition': 'addizione-divertente-2.webp',
        'alphabet train': 'Treno dell\'alfabeto-2.webp',
        'big small': 'grande-o-piccolo-3.webp',
        'bingo': 'tombola-3.webp',
        'chart count': 'grafico-con-immagini-2.webp',
        'code addition': 'codice-segreto-addizione-3.webp',
        'crossword': 'cruciverba-con-immagini-2.webp',
        'cryptogram': 'crittogramma-illustrato-1.webp',
        'draw and color': 'disegna-e-colora-3.webp',
        'drawing lines': 'pratica-del-disegno-di-linee-3.webp',
        'find and count': 'vedo-vedo-1.webp',
        'find objects': 'trova-gli-oggetti-nascosti-4.webp',
        'grid match': 'puzzle-a-griglia-8.webp',
        'matching': 'trova-le-coppie-4.webp',
        'math puzzle': 'rompicapi-matematici-5.webp',
        'math worksheet': 'scheda-di-matematica-3.webp',
        'missing pieces': 'pezzi-mancanti-3.webp',
        'more less': 'più-meno-1.webp',
        'odd one out': 'trova-il-diverso-4.webp',
        'pattern train': 'treno-dei-modelli-2.webp',
        'pattern worksheet': 'puzzle-di-schemi-1.webp',
        'picture path': 'percorso-di-immagini-3.webp',
        'picture sort': 'classificazione-immagini-4.webp',
        'prepositions': 'preposizioni-3.webp',
        'shadow match': 'abbina-le-ombre-3.webp',
        'subtraction': 'sottrazioni-divertenti-5.webp',
        'sudoku': 'sudoku-con-immagini-3.webp',
        'treasure hunt': 'caccia-al-tesoro-4.webp',
        'word guess': 'indovina-la-parola-2.webp',
        'word scramble': 'lettere-mescolate-1.webp',
        'wordsearch': 'cerca-parole-3.webp'
      },
      pt: {
        'addition': 'adição-divertida-1.webp',
        'alphabet train': 'comboio-do-alfabeto-4.webp',
        'big small': 'grande-ou-pequeno-3.webp',
        'bingo': 'bingo-de-imagenes-3-callout-2.webp',
        'chart count': 'gráfico-de-figuras-2.webp',
        'code addition': 'código-secreto-adição-3.webp',
        'crossword': 'palavras-cruzadas-1.webp',
        'cryptogram': 'criptograma-ilustrado-1.webp',
        'draw and color': 'desenha-e-pinta-4.webp',
        'drawing lines': 'prática-de-desenhar-linhas-4.webp',
        'find and count': 'vejo,-vejo-1.webp',
        'find objects': 'encontra-o-diferente.webp',
        'grid match': 'quebra-cabeça-de-grade-3.webp',
        'matching': 'encontre-os-pares-1.webp',
        'math puzzle': 'quebra-cabeças-matemático-4.webp',
        'math worksheet': 'folha-de-matemática-1.webp',
        'missing pieces': 'peças-em-falta-4.webp',
        'more less': 'mais-menos-2.webp',
        'odd one out': 'encontra-o-diferente-6.webp',
        'pattern train': 'comboio-de-padrões-5.webp',
        'pattern worksheet': 'quebra-cabeças-de-padrões-2.webp',
        'picture path': 'caminho-de-imagen-2.webp',
        'picture sort': 'classificação-de-imagens-1.webp',
        'prepositions': 'preposições-2.webp',
        'shadow match': 'combine-as-sombras-3.webp',
        'subtraction': 'subtrações-divertidas-4.webp',
        'sudoku': 'sudoku-de-imagens-1.webp',
        'treasure hunt': 'caça-ao-tesouro-3.webp',
        'word guess': 'adivinha-a-palavra-2.webp',
        'word scramble': 'letras-embaralhadas-3.webp',
        'wordsearch': 'caça-palavras-2.webp'
      },
      nl: {
        'addition': 'optellen-is-leuk-5.webp',
        'alphabet train': 'alfabettrein-2.webp',
        'big small': 'groot-of-klein-4.webp',
        'bingo': 'plaatjesbingo-1-callout.webp',
        'chart count': 'plaatjesgrafiek-2.webp',
        'code addition': 'geheime-code-optellen-2.webp',
        'crossword': 'plaatjes-kruiswoord-4.webp',
        'cryptogram': 'plaatjes-cryptogram-2.webp',
        'draw and color': 'teken-en-kleur-5.webp',
        'drawing lines': 'lijnen-tekenen-oefenen-7.webp',
        'find and count': 'ik-zie,-ik-zie-3.webp',
        'find objects': 'vind-de-verborgen-voorwerpen-3.webp',
        'grid match': 'rasterpuzzel-3.webp',
        'matching': 'zoek-de-paren-3.webp',
        'math puzzle': 'wiskundepuzzels-1.webp',
        'math worksheet': 'wiskundeblad-1.webp',
        'missing pieces': 'ontbrekende-stukjes-4.webp',
        'more less': 'meer-minder-3.webp',
        'odd one out': 'vind-de-vreemde-eend-4.webp',
        'pattern train': 'patroontje-2.webp',
        'pattern worksheet': 'patroonpuzzels-3.webp',
        'picture path': 'afbeeldingspad-2.webp',
        'picture sort': 'afbeeldingen-sorteren-1.webp',
        'prepositions': 'voorzetsels-3.webp',
        'shadow match': 'schaduw-koppelen-4.webp',
        'subtraction': 'aftrekken-is-leuk-3.webp',
        'sudoku': 'plaatjes-sudoku-4.webp',
        'treasure hunt': 'schattenjacht-2.webp',
        'word guess': 'raad-het-woord-1.webp',
        'word scramble': 'letterzaak-1.webp',
        'wordsearch': 'woordzoeker-1.webp'
      },
      sv: {
        'addition': 'blandat-läge.webp',
        'alphabet train': 'alfabetståg-portrait.webp',
        'big small': '2-identiska-bilder.webp',
        'bingo': 'bildbingo-4-callout.webp',
        'chart count': 'bilddiagram-1.webp',
        'crossword': 'bildkorsord-2.webp',
        'cryptogram': 'bildkryptogram-3.webp',
        'draw and color': 'rita-och-färglägg-1.webp',
        'drawing lines': 'kurva-1.webp',
        'find and count': 'hitta-och-räkna-landscape.webp',
        'find objects': 'hitta-den-udda-5.webp',
        'grid match': 'rutnätspussel-3.webp',
        'matching': 'matchningsspel-custom.webp',
        'math puzzle': 'mattepussel-2.webp',
        'math worksheet': 'mattetal-landscape.webp',
        'missing pieces': 'saknade-bitar-6.webp',
        'more less': 'mer-mindre-1.webp',
        'odd one out': 'hitta-udda-fågeln-2.webp',
        'pattern worksheet': 'mönsterpussel-1.webp',
        'picture path': 'bildväg-2.webp',
        'picture sort': 'sortera-bilder-1.webp',
        'prepositions': 'prepositioner-1.webp',
        'shadow match': 'skuggmatchning-3.webp',
        'subtraction': 'rolig-subtraktio-3.webp',
        'sudoku': 'sudoku-medel.webp',
        'treasure hunt': 'skattjakt-3.webp',
        'word guess': 'gissa-ordet-4.webp',
        'word scramble': 'ordmix-custom.webp',
        'wordsearch': 'ordletning-custom.webp'
      },
      da: {
        'addition': 'sjov-addition-1.webp',
        'alphabet train': 'alfabettog-5.webp',
        'big small': 'stort-eller-lille-5.webp',
        'bingo': 'billedbingo-3-callout-2.webp',
        'chart count': 'billediagram-3.webp',
        'code addition': 'hemmelig-kode-addition-3.webp',
        'crossword': 'billedkrydsord-1.webp',
        'cryptogram': 'billed-kryptogram-2.webp',
        'draw and color': 'tegn-og-farvlæg-1.webp',
        'drawing lines': 'linjetegningsøvelse-9.webp',
        'find and count': 'jeg-ser,-jeg-ser-3.webp',
        'find objects': 'find-den-ulige-4.webp',
        'grid match': 'gitterpuslespil-2.webp',
        'matching': 'find-parrene-4.webp',
        'math puzzle': 'mattepuslespil-1.webp',
        'math worksheet': 'matematikopgave-2.webp',
        'missing pieces': 'manglende-dele-6.webp',
        'more less': 'mere-mindre-4.webp',
        'odd one out': 'find-den-ulige-5.webp',
        'pattern train': 'mønstertoget-4.webp',
        'pattern worksheet': 'mønstergåder-2.webp',
        'picture path': 'billedsti-3.webp',
        'picture sort': 'sorter-billeder-4.webp',
        'prepositions': 'præpositioner-3.webp',
        'shadow match': 'gør-billederne-hele-2.webp',
        'subtraction': 'sjov-subtraktion-1.webp',
        'sudoku': 'billede-sudoku-2.webp',
        'treasure hunt': 'skattejagt-2.webp',
        'word guess': 'gæt-ordet-4.webp',
        'word scramble': 'bogstavrod-2.webp',
        'wordsearch': 'ordsøgning-4.webp'
      },
      no: {
        'addition': 'gøy-addisjon-6.webp',
        'alphabet train': 'alfabettog-4.webp',
        'big small': 'stort-eller-lite-6.webp',
        'bingo': 'bildebingo-1-callout.webp',
        'chart count': 'bildediagram-4.webp',
        'code addition': 'hemmelig-kode-addisjon-4.webp',
        'crossword': 'bildekryssord-4.webp',
        'cryptogram': 'bildekryptogram-3.webp',
        'draw and color': 'tegn-og-fargelegg-5.webp',
        'drawing lines': 'linjetegningøvelse-2.webp',
        'find and count': 'jeg-ser,-jeg-ser-3.webp',
        'find objects': 'finn-den-merkelige-1.webp',
        'grid match': 'rutenettspuslespill-2.webp',
        'matching': 'finn-parene-4.webp',
        'math puzzle': 'mattepuslespill-1.webp',
        'math worksheet': 'matematikkoppgave-3.webp',
        'missing pieces': 'manglende-deler-4.webp',
        'more less': 'mer-mindre-2.webp',
        'odd one out': 'finn-den-rare-3.webp',
        'pattern train': 'mønstertoget-5.webp',
        'pattern worksheet': 'mønstergåter-1.webp',
        'picture path': 'bildesti-1.webp',
        'picture sort': 'sorter-bilder-4.webp',
        'prepositions': 'preposisjoner-4.webp',
        'shadow match': 'fullfør-bildene-3.webp',
        'subtraction': 'moro-med-subtraksjon-3.webp',
        'sudoku': 'bilde-sudoku-1.webp',
        'treasure hunt': 'skattejakt-5.webp',
        'word guess': 'gjett-ordet-5.webp',
        'word scramble': 'bokstavblanding-4.webp',
        'wordsearch': 'ordleting-4.webp'
      },
      fi: {
        'addition': 'hauska-yhteenlasku-1.webp',
        'alphabet train': 'aakkostjuna-1.webp',
        'big small': 'iso-vai-pieni-5.webp',
        'bingo': 'kuvabingo-1-callout.webp',
        'chart count': 'kuvakaavio-4.webp',
        'code addition': 'salainen-koodi-yhteenlasku-6.webp',
        'crossword': 'kuvaristikko-1.webp',
        'cryptogram': 'kuvakryptogrammi-3.webp',
        'draw and color': 'piirrä-ja-väritä-4.webp',
        'drawing lines': 'viivojen-piirtämisharjoitus-6.webp',
        'find and count': 'minä-näen-4.webp',
        'find objects': 'löydä-outo-3.webp',
        'grid match': 'ruudukkopalapeli-3.webp',
        'matching': 'yhdistä-parit-3.webp',
        'math puzzle': 'matematiikkapulmat-4.webp',
        'math worksheet': 'matematiikkalehti-1.webp',
        'missing pieces': 'puuttuvat-palat-6.webp',
        'more less': 'enemmän-vähemmän-7.webp',
        'odd one out': 'löydä-outo-lintu-6.webp',
        'pattern train': 'kuviojuna-1.webp',
        'pattern worksheet': 'kuviotehtävät-2.webp',
        'picture path': 'kuvapolku-8.webp',
        'picture sort': 'lajittele-kuvat-5.webp',
        'prepositions': 'prepositiot-4.webp',
        'shadow match': 'täydennä-kuvat-1.webp',
        'subtraction': 'hauskaa-vähennyslaskua-4.webp',
        'sudoku': 'kuva-sudoku-2.webp',
        'treasure hunt': 'aarteenetsintä-6.webp',
        'word guess': 'arvaa-sana-6.webp',
        'word scramble': 'kirjainsekoitus-5.webp',
        'wordsearch': 'sanahaku-5.webp'
      }
    };
    ...
    appConfigs.forEach((config, index) => {
      ...
      if (config.app === 'coloring') {
        imageUrl = '/samples/english/coloring/coloring-landscape-3.webp';
      } else if (config.app === 'writing') {
        imageUrl = '/samples/english/writing/writing-custom.webp';
      } else {
