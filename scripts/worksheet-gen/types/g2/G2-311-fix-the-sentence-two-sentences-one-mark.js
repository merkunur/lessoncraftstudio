/** G2-311 — Where Does It End?. nt20-B-VAR variation of G2-274. */
'use strict';
...
module.exports = {
  ...
  i18n: { en: { title: "Where Does It End?", instruction: "Two sentences ran together. Split them and mark each one." } },
};
