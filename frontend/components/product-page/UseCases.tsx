    ...
    >
      <div className="relative h-full bg-white rounded-2xl p-6 sm:p-8 shadow-lg shadow-stone-100/60 border border-stone-200/60 hover:shadow-xl hover:border-stone-300/60 transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="flex items-start gap-4 mb-5">
          <div
            className={`flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br ${colors.bg} flex items-center justify-center text-white text-2xl shadow-lg hover:scale-110 hover:rotate-[5deg] transition-transform duration-300`}
          >
            {useCase.icon}
          </div>
