...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Passief inkomen versus actieve verkoop — de cijfers vergeleken',
    description: 'Passief inkomen versus actieve verkoop — de cijfers vergeleken. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
