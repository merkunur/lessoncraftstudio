...
const content: BundleContent = {
  ...
  bundleBenefits: [
    {
      title: 'Vijf Generators, Eén Aankoop',
    ...
    {
      title: 'Batch Bingo Kaart Export',
    ...
    },
    {
      ...
      description: `Toegang tot dieren, eten, voertuigen, feestdagen, seizoenen en tientallen meer themacategorieën over alle vijf generators. Elk thema geeft je een verse productinvalshoek — vermeld "Oceaandieren Koppelpakket" naast "Boerderij Schaduw Koppelen" en "Dinosaurus Bingokaarten" om verschillende zoekopdrachten, kopersinteressen en leeftijdsgroepen tegelijkertijd op te vangen.`,
    },
    {
      title: 'Eigen Afbeeldingen Uploaden',
      description: `Upload je eigen PNG- of JPEG-bestanden naar elke generator voor merkgebonden, nichespecifieke werkbladen. Eigen uploads zijn bijzonder krachtig voor Plaatjesbingo — upload merkafbeeldingen voor thematische feest-bingosets, feestdagenevents of bedrijfs teambuilding activiteiten.`,
    },
    {
  ...
  businessUseCases: [
    ...
    {
      title: 'Meertalige Koppelproducten',
      description: `Drie van de vijf generators ondersteunen alle 11 interfacetalen voor woordenschatlabels en categorienamen. Maak koppelwerkbladpakketten in het Duits, Frans, Spaans of elke ondersteunde taal en vermeld ze op gelokaliseerde marktplaatsen. De taalgevoelige apps — Verbindingswerkblad, Plaatjesbingo en Sorteer Werkblad — produceren werkbladen waarop labels in de doeltaal verschijnen, terwijl Rasterpuzzel en Schaduw Koppelen puur visuele pagina's bijdragen die geen vertaling nodig hebben.`,
    },
  ],
  ...
  featureComparison: [
    ...
    { feature: 'Taalgevoelige labels (3 apps)', commercial: 'Alleen Engels', fullAccess: '11 talen' },
  ...
  faq: [
    ...
    {
      question: `Welke generators zijn taalgevoelig en welke zijn puur visueel?`,
    ...
    },
    {
      ...
      answer: `Beide tiers bevatten alle vijf generators met watermerkvrije downloads en commerciële verkooprechten. Commercieel geeft je 10 thematische beeldsets en alleen Engelstalige interface en labels. Volledige Toegang ontgrendelt alle 104 thematische beeldsets en alle 11 interfacetalen, inclusief woordenschatlabels in Verbindingswerkblad, Plaatjesbingo en Sorteer Werkblad in elke ondersteunde taal. Beide tiers bevatten de batch bingo-export en antwoordbladen voor toepasselijke generators.`,
    },
    {
