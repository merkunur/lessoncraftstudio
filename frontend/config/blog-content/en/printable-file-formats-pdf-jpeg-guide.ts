...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'coloring-pages', anchorText: 'Coloring Page Generator (PDF output)' },
    ...
    { pageType: 'guide', slug: 'amazon-kdp-activity-books', anchorText: 'KDP formatting guide' },
  ],
  relatedPosts: [
