...
const content: AppContent = {
  ...
  howItWorks: {
    title: 'Como Criar Fichas de Classificação de Imagens em 5 Passos',
    steps: [
      {
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'O canvas Fabric.js oferece controlo total sobre cada elemento da sua ficha de classificação. Arraste, redimensione, rode e reposicione imagens, texto e conteúdo gerado livremente. Os controlos de camadas gerem a ordem de empilhamento — traga elementos para a frente ou envie-os para trás. Bloqueie os elementos terminados enquanto edita outros. Adicione texto personalizado com sete opções de fontes (Lexend Deca, Baloo 2, Nunito, Quicksand, Fredoka, Arial, Verdana), tamanho e cor ajustáveis, e largura de contorno de texto de 0 a 10 em passos de 0,5. Seis opções de alinhamento mais centrar na página mantêm os layouts precisos. Amplie de 25 % a 300 % para trabalho de detalhe. Anule e refaça até 20 estados de histórico com Ctrl+Z e Ctrl+Y.',
      },
    ],
  },

  businessUseCases: {
    title: 'Como Vender Fichas de Classificação de Imagens Online',
    cases: [
      {
        title: 'Pacotes Temáticos de Fichas de Classificação na Etsy',
        description:
          'Crie pacotes de atividades de classificação temáticos a partir das 104 coleções de imagens com pares de categorias naturais — animais vs alimentos, terra vs água, frutas vs legumes, interior vs exterior e dezenas mais. Cada par de temas produz múltiplas fichas de classificação únicas variando as seleções e quantidades de imagens. Agrupe 10 a 20 fichas de classificação por pacote com gabaritos incluídos, e venda entre $3 e $7 por pacote. O seletor de categorias por tema permite gerar rapidamente fichas com agrupamentos esquerdo/direito distintos, e o gabarito autogerado elimina o principal estrangulamento da produção.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Ficha de classificação de imagens a duas categorias com molduras de categoria temáticas, grelha de recortes misturada e cabeçalho localizado Classificação de Imagens',
    },
    sampleGallery: [
      {
        src: '/samples/portuguese/picture sort/Classificação de Imagens 2.webp',
        alt: 'Ficha de classificação em modo de tema com imagens classificadas nas categorias esquerda e direita',
      ...
      },
      {
        ...
        alt: 'Ficha de classificação em modo manual com imagens selecionadas individualmente atribuídas às categorias esquerda e direita',
    ...
    videoTitle: 'Como Criar Fichas de Classificação de Imagens com Classificação a Duas Categorias e Gabaritos Automáticos — Tutorial Passo a Passo',
  },
};
