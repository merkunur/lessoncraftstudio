...
var Wodb = {
  ...
  strings: {
    ...
    stemPrompt:   {en:'Tell us why. Tap an ear to hear a sentence starter.',de:'Erzähl uns, warum. Tippe auf das Ohr, dann hörst du einen Satzanfang.',fr:'Dis-nous pourquoi. Touche le haut-parleur pour écouter un début de phrase.',it:'Raccontaci perché. Tocca l’orecchio per ascoltare un avvio di frase.',es:'Cuéntanos por qué. Toca la oreja para escuchar cómo empezar la frase.',pt:'Agora conte o porquê. Toque na orelha para ouvir um começo de frase.',nl:'Vertel waarom. Tik op het oor om een startzin te horen.',sv:'Berätta varför. Tryck på örat för att höra hur du kan börja meningen.',da:'Fortæl hvorfor. Tryk på øret for at høre en sætning, du kan starte med.',no:'Fortell oss hvorfor. Trykk på øret for å høre en setningsstarter.',fi:'Kerro, miksi. Napauta korvaa, niin kuulet lauseen alun.'},
    ...
    turnedFull:   {en:'All the way round — the four are back where they started.',de:'Einmal ganz herum — die vier sind wieder da, wo sie angefangen haben.',fr:'Un tour complet — les quatre choses ont retrouvé leur place de départ.',it:'Un giro completo — le quattro sono tornate al punto di partenza.',es:'Una vuelta completa: las cuatro están otra vez donde empezaron.',pt:'Uma volta completa — as quatro coisas voltaram para onde começaram.',nl:'Helemaal rond — de vier staan weer waar ze begonnen.',sv:'Ett helt varv — de fyra är tillbaka där de började.',da:'Hele vejen rundt — de fire er tilbage, hvor de startede.',no:'Hele veien rundt — de fire er tilbake der de startet.',fi:'Täysi kierros — kaikki neljä ovat taas samoissa kulmissa kuin alussa.'},
    ...
    endOfMine:    {en:'That was the last of your own grids — {n} in all.',de:'Das waren alle deine eigenen Rätsel — insgesamt {n}.',fr:'C’est la dernière de tes propres grilles ({n} en tout).',it:'Questo era l’ultimo dei tuoi quartetti: {n} in tutto.',es:'Esta era la última de tus tarjetas: {n} en total.',pt:'Fim das suas cartelas. Ao todo: {n}.',nl:'Dit waren al je eigen denkkaarten — {n} in totaal.',sv:'Det var det sista av dina egna rutnät — {n} totalt.',da:'Det var det sidste af dine egne sæt — {n} i alt.',no:'Det var det siste av dine egne rutenett — {n} i alt.',fi:'Tämä oli viimeinen omista ruudukoistasi, yhteensä {n}.'},
    ...
    nDots:        {en:'{n} dots',de:'{n} Punkte',fr:'{n} points',it:'{n} punti',es:'{n} puntos',pt:'{n} pontos',nl:'{n} stippen',sv:'{n} prickar',da:'{n} prikker',no:'{n} prikker',fi:'{n} pistettä'},
    oneDot:       {en:'1 dot',de:'1 Punkt',fr:'1 point',it:'1 punto',es:'1 punto',pt:'1 ponto',nl:'1 stip',sv:'1 prick',da:'1 prik',no:'1 prikk',fi:'1 piste'},
    ...
    arr_rowWrapped:{en:'in two rows',de:'in zwei Reihen',fr:'sur deux lignes',it:'su due file',es:'en dos filas',pt:'em duas filas',nl:'op twee rijen',sv:'på två rader',da:'på to rækker',no:'på to rekker',fi:'kahdessa rivissä'},
    ...
    fillSolid:    {en:'filled in',de:'ausgemalt',fr:'tout en couleur',it:'a tinta unita',es:'con relleno',pt:'com o interior pintado',nl:'ingekleurd',sv:'med färg inuti',da:'fyldt ud',no:'helt fylt',fi:'väritetty sisältä'},
    ...
    rotated:      {en:'turned',de:'gedreht',fr:'dans un autre sens',it:'in un’altra posizione',es:'en otra posición',pt:'em outra posição',nl:'gedraaid',sv:'åt ett annat håll',da:'drejet',no:'dreid',fi:'käännetty'},
    ...
    sizeMedium:   {en:'medium',de:'mittelgroß',fr:'en taille moyenne',it:'di media grandezza',es:'de tamaño mediano',pt:'de tamanho médio',nl:'middelgroot',sv:'mellanstorlek',da:'mellemstørrelse',no:'middels størrelse',fi:'keskikokoinen'},
    sizeLarge:    {en:'large',de:'groß',fr:'en plus grand',it:'in grande',es:'de tamaño grande',pt:'de tamanho grande',nl:'groot',sv:'stor storlek',da:'stor størrelse',no:'stor størrelse',fi:'iso'},
  ...
  _cellName: function (cell, i) {
    ...
    if (cell.t === 'num') what = String(cell.v);
      ...
      /* ⚠ THE SAME DEFECT, A THIRD TIME, ON THE SIZE CHANNEL. Five
         panels found fill and rotation mute; the follow-up round found
         size was too — it spoke ONLY on 'sm', so a grid with one large
         shape among three mediums announced four identical descriptions.
         The keys to say it now exist in all eleven locales. */
      if (cell.size === 'sm') what += ', ' + api.t('sizeSmall');
      else if (cell.size === 'md') what += ', ' + api.t('sizeMedium');
      else what += ', ' + api.t('sizeLarge');
