/**
 * Background Import Script: Flowers
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-flowers-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'flowers_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/flowers',
  displayNames: {
    en: 'Flowers',
    de: 'Blumen',
    fr: 'Fleurs',
