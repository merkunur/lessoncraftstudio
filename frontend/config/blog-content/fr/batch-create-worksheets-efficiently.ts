...
const content: BlogContent = {
  seo: {
    ...
    titleTag: 'Créer des fiches en série efficacement | LessonCraftStudio',
  ...
  hero: {
    ...
    tagline: '10 fiches par heure au lieu de 2',
    description: 'Techniques de production par lots pour créer des fiches rapidement. Multipliez votre productivité par 5. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour créer fiches en série efficacement. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
  ...
  relatedPosts: [
    ...
    { slug: 'how-many-listings-etsy-success', title: 'Combien de fiches' },
    { slug: 'create-worksheet-bundle-35-minutes', title: 'Bundle en 35 minutes' },
  ],
  cta: {
