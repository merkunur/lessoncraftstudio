...
const content: StartContent = {
  ...
  actionSteps: [
    ...
    },
    {
      ...
      description: `Adapte os seus produtos existentes para uma segunda plataforma de venda. As descargas digitais de Etsy podem tornar-se livros de capa mole do KDP. O conteúdo de KDP pode tornar-se recursos do Gumroad. As mesmas ferramentas de produção, uma nova audiência, um fluxo de rendimentos adicional.`,
    },
    {
