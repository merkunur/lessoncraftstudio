...
/* =====================================================================
   ...
   drives the DOM:
     ...
     • no stored sum/answer flag; ≥7 distinct + reshuffle;
       no overflow 280→768.
   ===================================================================== */
'use strict';
...
(async () => {
  ...
  try {
    ...
    const loc = await page.evaluate(() => {
      const r = window.PlaceValueRegroupActivity._activityRow;
  ...
  console.log('PLACE-VALUE-REGROUP LOCAL TEST PASSED — compose-a-ten: tens/ones columns + "Make a ten" + Tuck + keypad render; typing the total without bundling does NOT resolve (regroup required); bundling 27+5 gives 3 tens + 2 ones + hides the button; type the total → resolves + caption "27 + 5 = 32"; no stored answer flag; ≥7 distinct + reshuffle; no overflow 280→768.');
  process.exit(0);
