...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'second-grade': {
      ...
      snippetAnswer: 'Matkailuaiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät maantieteellistä ajattelua karttojen ja maiden vertailun avulla, kehittävät budjetointi- ja valuuttalaskutaitoja matkasuunnitelmien kautta sekä vahvistavat kulttuurienkälisen ymmärryksen kirjoittamista matkaraporteissa. POPS 2014:n ympäristöopin ja äidinkielen vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla matkailuteema kehittyy ensimmäisen luokan paikkojen tutkimisesta kokonaiseksi matkaprojektiksi, koska seitsemän- ja kahdeksanvuotiaat hallitsevat budjetoinnin, kartanlukun ja monipuolisen kirjoittamisen. POPS 2014:n päättötavoitteet edellyttävät, että oppilas tuntee Suomen maantiedettä ja ymmärtää kulttuurien moninaisuutta. Toisen luokan oppilas suunnittelee matkan kokonaisvaltaisesti: valitsee kohteen kartalta, tutkii etäisyyden ja matka-ajan, laskee budjetin ja kirjoittaa matkasuunnitelman. Karttatyöskentely syventyy: Suomen kaupungit, maakuntien sijainnit, naapurimaiden tunnistaminen, yksinkertainen maailmankartta. Budjetointi sisältää kertolaskua: 3 yötä × 80 euroa = 240 euroa. Valuuttavertailu alkaa: miksi Ruotsissa maksetaan kruunuilla, miksi Norjassa eri kruunuilla? Kulttuurinen vertailu: miten ruotsalaiset, virolaiset tai saksalaiset elävät eri tavoin? Matkaraportti on monipuolinen tekstilaji: päiväkirjamuotoinen kertomus yhdistettynä tietotekstiin kohteesta.',
      developmentalMilestones: [
        { milestone: 'Maantieteellisen karttatyöskentelyn syveneminen (7–8-vuotiaat tunnistavat kaupunkeja ja maita kartalta)', howWeAddress: 'Karttatehtävät, joissa oppilas paikallistaa Suomen kaupunkeja, naapurimaita ja matkakohteita kartalta, mittaa etäisyyksiä ja arvioi matka-aikoja, kehittävät maantieteellistä ajattelua' },
        { milestone: 'Matkabudjetin laskeminen kertolaskuineen (toisen luokan oppilaat budjetoivat matkan)', howWeAddress: 'Budjettitehtävät, joissa oppilas laskee majoituksen, ruoan ja matkalippujen kustannukset kertolaskulla, kehittävät talousmatemaattista soveltamista' },
        { milestone: 'Kulttuurien vertailu ja ymmärtäminen (seitsemän- ja kahdeksanvuotiaat tutkivat eri maiden tapoja)', howWeAddress: 'Kulttuuritutkimustehtävät, joissa oppilas vertailee Suomen ja matkakohteen tapoja, ruokia ja juhlia taulukossa, kehittävät kulttuurienkälistä ymmärrystä' },
        { milestone: 'Matkaraportin kirjoittaminen (toisen luokan oppilaat yhdistävät päiväkirjan ja tietotekstin)', howWeAddress: 'Raporttikirjoitustehtävät, joissa oppilas kirjoittaa matkaraportin päiväkirja- ja tietotekstiosuuksineen, kehittävät monipuolista tekstien tuottamista' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa kartta Suomeen ja naapurimaihin, yksinkertaista budjetti yhteenlaskuun ja anna raporttikirjoitukseen lausepohjat. Edistyneille toisen luokan oppilaille laajenna karttatyö Euroopan tasolle, lisää valuuttamuunnoslaskut ja haasta kirjoittamaan vertaileva matkaraportti kahdesta kohteesta.',
      parentTakeaway: 'Toisen luokan matkailutyölehdet opettavat maantiedettä ja budjetointia. Suunnitelkaa yhdessä unelmamatka: minne, montako päivää, paljonko majoitus maksaa viideltä yöltä? Tutkikaa karttaa: missä kohde on, miten sinne pääsee, montako kilometriä? Vertailkaa Suomen ja kohdemaan tapoja: mitä siellä syödään, miten tervehditään? Tärkeintä on herättää uteliaisuus maailmaa kohtaan ja osoittaa, että matka vaatii matemaattista suunnittelua.',
      classroomIntegration: 'Matkailuteema on toisen luokan ympäristöopin ja äidinkielen integroiva projekti: karttatyöskentely maantiedossa, budjettilaskenta matematiikassa, kulttuurivertailu ympäristöopissa, matkaraportti äidinkielessä ja matkapostikortti kuvataiteessa. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa matkailuteema osoittaa maantieteellisen ajattelun, talousmatemaattisen soveltamisen ja monipuolisen tekstien tuottamisen taidot.',
      assessmentRubric: [
        { skill: 'Maantieteellinen karttatyöskentely', emerging: 'löytää kotikaupungin kartalta mutta ei tunnista muita paikkoja', proficient: 'paikallistaa Suomen kaupunkeja ja naapurimaita, mittaa etäisyyksiä ja arvioi matka-aikoja', advanced: 'työskentelee sujuvasti Euroopan kartalla, vertailee etäisyyksiä ja ymmärtää mittakaavan merkityksen' },
        { skill: 'Matkabudjetin laskeminen', emerging: 'laskee yhden kuluerän aikuisen avulla', proficient: 'laskee monivaiheisen matkabudjetin kertolaskuineen ja vertaa kokonaisbudjettiin', advanced: 'optimoi matkabudjetin vertaillen vaihtoehtoja, laskee valuuttamuunnoksia ja tekee kustannusarvioita' },
        { skill: 'Matkaraportin kirjoittaminen', emerging: 'luettelee paikkoja ilman jäsennystä tai kokemuksia', proficient: 'kirjoittaa matkaraportin, jossa yhdistyvät päiväkirja ja tietoteksti selkeällä rakenteella', advanced: 'kirjoittaa monipuolisen matkaraportin kulttuurivertailuineen, pohdintoineen ja suosituksineen' },
      ],
    },
    'third-grade': {
