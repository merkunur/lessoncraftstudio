...
const content: GuideContent = {
  ...
  visuals: {
    heroImage: { src: '/samples/finnish/sudoku/kuva-sudoku-2.webp', alt: 'Kuvasudoku-työarkki temaattisilla kuvilla, joka näyttää 4x4-logiikkapalapelin nuoremmille käyttäjille' },
    samples: [
      { src: '/samples/finnish/sudoku/kuva-sudoku-2.webp', alt: 'Kuvapohjainen 4x4 sudoku-palapeli eläinteemalla esikoululaisille', caption: 'Helppo vaikeustason kuvasudoku maatilan eläimet -teemalla neljällä tyhjällä solulla' },
      { src: '/samples/finnish/sudoku/kuva-sudoku-2.webp', alt: 'Kuvasudokun vastausavain, joka näyttää täydellisen 4x4-ruudukon kaikilla kuvilla täytettyinä', caption: 'Automaattinen vastausavain, joka luodaan jokaisen kuvasudoku-palapelin rinnalle' },
    ],
