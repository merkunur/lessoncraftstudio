...
const content: ToolContent = {
  ...
  businessIdeas: [
    ...
    {
      title: 'Kit Completo de Palavras Cruzadas com Imagens no Gumroad',
      description: 'Reúna palavras cruzadas com imagens dos 104 temas e múltiplos idiomas num kit completo no Gumroad. Inclua mais de 300 puzzles de palavras cruzadas abrangendo palavras cruzadas temáticas com imagens, palavras cruzadas de vocabulário personalizado e versões multilingues — cada um com o seu gabarito autogerado, duplicando a contagem de ficheiros para mais de 600 ficheiros no total. Os quatro métodos de entrada e a geração sensível ao idioma produzem mais variedade do que qualquer concorrente que ofereça modelos simples de palavras cruzadas. O formato de kit justifica preços premium porque os compradores obtêm uma biblioteca completa de puzzles de palavras cruzadas que cobre cada tema e múltiplos idiomas.',
      platform: 'Gumroad',
    },
  ],
