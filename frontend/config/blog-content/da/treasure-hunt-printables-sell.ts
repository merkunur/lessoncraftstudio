...
const content: BlogContent = {
  ...
  internalLinks: [
    ...
    { pageType: 'app', slug: 'picture-bingo-worksheets', anchorText: 'Fest Banko Generator' },
  ...
  cta: {
    heading: 'Kom I Gang Med Skattejagt-Printables',
