...
const samples: Sample[] = [
  ...
  },
  {
    ...
    pdfUrl: '/samples/english/crossword/image-crossword-worksheet.pdf',
  ...
  },
  {
    ...
    categoryNo: 'Visuelt',
    categoryFi: 'Visuaalinen',
    imageSrc: '/samples/english/matching/matching portrait.jpeg',
    pdfUrl: '/samples/english/matching/matching portrait.pdf',
  ...
  {
    id: '11',
    nameEn: 'Cryptogram Puzzles',
    nameDe: 'Kryptogramme',
    nameFr: 'Cryptogrammes',
    nameEs: 'Criptogramas',
    nameIt: 'Crittogrammi',
    namePt: 'Criptogramas',
    nameNl: 'Cryptogrammen',
    nameDa: 'Kryptogrammer',
    nameSv: 'Kryptogram',
    nameNo: 'Kryptogrammer',
    nameFi: 'Kryptogrammit',
    categoryEn: 'Language',
    categoryDe: 'Sprache',
    categoryFr: 'Langue',
    categoryEs: 'Lenguaje',
    ...
    categoryNo: 'Språk',
    categoryFi: 'Kieli',
    imageSrc: '/samples/english/cryptogram/cryptogram_worksheet.jpeg',
    pdfUrl: '/samples/english/cryptogram/cryptogram_worksheet.pdf',
    productPageSlug: 'cryptogram-worksheets',
  },
  {
    id: '12',
    nameEn: 'Picture Bingo',
    nameDe: 'Bilder-Bingo',
    nameFr: 'Bingo en images',
    nameEs: 'Bingo de imágenes',
    nameIt: 'Bingo illustrato',
    namePt: 'Bingo de imagens',
    nameNl: 'Plaatjesbingo',
    nameDa: 'Billedbingo',
    nameSv: 'Bildbingo',
    nameNo: 'Bildebingo',
    nameFi: 'Kuvabingo',
    ...
    categoryNo: 'Kreativt',
    categoryFi: 'Luova',
    imageSrc: '/samples/english/bingo/image and image.jpeg',
    pdfUrl: '/samples/english/bingo/image and image.pdf',
    productPageSlug: 'picture-bingo-worksheets',
  },
];
