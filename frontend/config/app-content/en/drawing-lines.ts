...
const content: AppContent = {
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Access 3,100+ colorful illustrations across 104 themed collections \u2014 animals, food, vehicles, nature, professions, holidays, and dozens more. Each theme provides a coordinated set of images that pair naturally in line tracing exercises: farm animals on both ends, ocean creatures matched together, vehicles connecting across curves. The Commercial tier includes 10 colorful themes for getting started; Full Access unlocks all 104 themes for maximum product variety. The themed library creates natural bundling opportunities: farm animals line tracing, dinosaur curve drawing, ocean creature diagonal practice \u2014 each theme becomes a distinct product listing.',
      },
      {
      ...
      },
      {
        ...
        description:
          'The built-in Fabric.js 5.3.1 canvas lets you drag, resize, rotate, and reposition every element on the page \u2014 text, line templates, images, borders, and backgrounds. Add custom text with fonts including Arial, Verdana, Baloo 2, Fredoka, Lexend Deca, Nunito, and Quicksand. Adjust font size, color, and text outline from 0 to 10 width with 0.5 step granularity. Layer controls manage stacking order, lock/unlock protects finished elements, and alignment tools snap elements into position. Zoom from 25% to 400% for precision placement, with up to 100 undo/redo history states via Ctrl+Z and Ctrl+Y.',
      },
    ],
  },
  ...
  visuals: {
    ...
    videoTitle: 'How to Create Line Tracing Worksheets with Eight SVG Templates \u2014 Step-by-Step Tutorial',
  },
};
