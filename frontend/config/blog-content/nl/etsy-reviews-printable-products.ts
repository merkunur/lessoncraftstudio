...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Beoordelingen zijn de belangrijkste conversiefactor op Etsy',
    description: 'Beoordelingen zijn de belangrijkste conversiefactor op Etsy. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
