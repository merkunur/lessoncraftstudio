...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Générateur d\'ombres | LessonCraftStudio',
  ...
  hero: {
    title: 'Générateur d\'ombres — Créez des imprimables à vendre sur Etsy & KDP',
  ...
  ctaHeading: 'Créer des fiches d\'ombres',
