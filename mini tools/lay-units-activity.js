...
(function (global) {
  ...
  var NUMW = {
    ...
    /* nl — native ensemble. count uses één (the numeral one, accents mandatory; bare "een" = article);
       win capitalized before the plural noun (index 1 defensive/unreachable). */
    nl: {
