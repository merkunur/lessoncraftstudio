...
const content: BlogContent = {
  ...
  internalLinks: [
    { pageType: 'app', slug: 'coloring-worksheets', anchorText: 'November Farvelægning' },
    { pageType: 'app', slug: 'picture-bingo-worksheets', anchorText: 'Mortens Aften Banko' },
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'November Ordsøgning' },
  ],
  relatedPosts: [
  ...
  cta: {
    heading: 'Kom I Gang Med Mortens Aften Printables',
