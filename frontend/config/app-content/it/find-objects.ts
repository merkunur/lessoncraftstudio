...
const content: AppContent = {
  seo: {
    ...
    titleTag: 'Generatore cerca e trova | LessonCraftStudio',
  ...
  hero: {
    title: 'Generatore cerca e trova — Crea stampabili da vendere su Etsy e KDP',
  ...
  ctaHeading: 'Crea schede cerca e trova',
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      {
        src: '/samples/italian/find%20objects/trova-gli-oggetti-nascosti-3.webp',
