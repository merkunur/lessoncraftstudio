  ...
  var WobbleMuseumActivity = {
    ...
    _injectStyle: function () {
      ...
      s.textContent = [
        ...
        '.wm-say{display:flex;align-items:center;justify-content:center;gap:7px;width:100%;}',
        '.wm-bram{flex:0 0 auto;}',
        '.wm-line-msg{flex:0 1 auto;min-height:1.1em;text-align:center;font:700 clamp(0.84rem,2.1vw,1.09rem)/1.3 Nunito,system-ui,sans-serif;color:#146B5E;margin:0;}',
