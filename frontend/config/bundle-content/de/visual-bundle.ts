...
const content: BundleContent = {
  ...
  businessUseCases: [
    ...
    {
      title: 'Gumroad Vorschul-Pakete',
      description: 'Käufer auf dem Gumroad suchen umfassende Vorschul- und Kindergarten-Aktivitätspakete, die mehrere Fähigkeiten abdecken. Bündeln Sie Größenvergleich, Mustererkennung, Linien-Nachziehen und Malaktivitäten in Altersstufen-Paketen mit Lösungsschlüsseln für anwendbare Aktivitäten. Das rein visuelle Format spricht Käufer an, die vielfältige Zielgruppen bedienen, in denen Nutzer mehrere Sprachen sprechen — Arbeitsblätter, die kein Lesen erfordern, beseitigen Sprachbarrieren vollständig. Verpacken Sie Arbeitsblätter in thematische Pakete, die Käufer für den Einsatz in der gesamten Klasse kaufen.',
      platform: 'Gumroad',
    },
    {
  ...
  visuals: {
    ...
    sampleGallery: [
      { src: '/samples/german/big%20small/big-small-worksheet-worksheet.webp', alt: 'Größenvergleichs-Arbeitsblatt mit thematischen Bildern zum Einkreisen des Größten und Kleinsten', caption: 'Groß-&-Klein-Arbeitsblatt' },
      { src: '/samples/german/pattern%20train/musterzug-1.webp', alt: 'Zugwaggon-Musterfolge-Arbeitsblatt mit fehlendem Musterelement', caption: 'Muster-Zug-Arbeitsblatt' },
      { src: '/samples/german/pattern%20worksheet/pattern-worksheet.webp', alt: 'Mustererkennung-Arbeitsblatt mit Lückentext-Folgen', caption: 'Muster-Arbeitsblatt' },
      { src: '/samples/german/draw%20and%20color/zeichnen-und-ausmale-1.webp', alt: 'Referenzbild-Zeichen-Arbeitsblatt mit Raster zur Bildreproduktion', caption: 'Rasterzeichnen-Arbeitsblatt' },
      { src: '/samples/german/drawing%20lines/linien-zeichnen-üben-1.webp', alt: 'Linien-Nachzieh-Arbeitsblatt mit gepaarten Objekten und geschwungenen Linien', caption: 'Linien-Ziehen-Arbeitsblatt' },
      ...
      { src: '/samples/german/chart%20count/bilddiagramm-1.webp', alt: 'Balkendiagramm-Zähl-Arbeitsblatt mit thematischen Bild-Datenpunkten', caption: 'Bilddiagramm-Arbeitsblatt' },
    ],
