...
const content: BlogContent = {
  ...
  hero: {
    title: 'Crear un Libro de Actividades para KDP de Inicio a Fin',
    tagline: 'Del concepto al libro publicado en Amazon en un fin de semana',
    description: 'Publicar un libro de actividades en Amazon KDP puede hacerse en un fin de semana si tiene el contenido listo. Este tutorial paso a paso cubre todo el proceso: desde planificar la estructura del libro hasta presionar el boton de publicar. Incluye requisitos de formato, creacion de portada, configuracion de KDP y estrategia de lanzamiento.',
  },
  category: 'how-to',
