...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Klik op de "Genereren"-knop om je werkblad te maken. De voorbeeldweergave wordt in realtime bijgewerkt. Wanneer je tevreden bent, gebruik je het dropdown-menu "Downloaden" om op te slaan als JPEG of PDF. Genereer en download ook een bijpassend antwoordblad met alle oplossingen ingevuld — doorgestreepte afbeeldingen duidelijk gemarkeerd.',
      },
    ],
  },
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Genereer 50–100 pagina\'s aftrekwerkbladen in gemengde modi, exporteer als hoge-resolutie PDF\'s en publiceer als low-content activiteitenwerkboek op Amazon KDP. Gebruik het vierkante formaat (1200×1200) voor KDP-activiteitenboeken en mix Doorstrepen met Afbeelding − Getal voor afwisseling. Voeg een inhoudsopgave, ouderinstructies en een compleet antwoordgedeelte achterin toe. Doorstreep-werkbladen fotograferen bijzonder goed voor KDP-vermeldingsafbeeldingen.',
    },
    {
  ...
  businessIdeas: [
    ...
    },
    {
      ...
      description: 'Stel 50+ pagina\'s beeldgebaseerde aftrekoefeningen samen in een fysiek activiteitenwerkboek. Gebruik gemengde modi en meerdere thema\'s voor afwisseling. Prijs op €6,99–€9,99 en laat Amazon druk en verzending afhandelen. Doorstreep-werkbladen fotograferen bijzonder goed voor KDP-vermeldingsafbeeldingen omdat het doorstreep-concept visueel direct duidelijk is voor potentiële kopers.',
      platform: 'Amazon KDP',
    },
    {
    ...
    },
    {
      ...
      description: 'Bied een gratis 5-pagina doorstreep-aftrekwerkblad sampler aan als leadmagnet op Pinterest. Visuele doorstreep-werkbladen maken opvallende pins die verkeer genereren. Verzamel e-mailadressen en verkoop vervolgens je volledige thematische bundels en KDP-werkboeken. Pinterest-pins met kleurrijke rekenwerkbladen genereren consistent hoge klikfrequenties in de onderwijs- en opvoedingscategorieën.',
    },
  ],
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'PDF is het beste voor direct printen, maar JPEG laat je mockup-afbeeldingen maken voor je winkelvermelding. Download beide formaten. Gebruik de JPEG voor productminiaturen en social media voorbeelden, en neem de PDF op als het daadwerkelijke leverbare product.',
    },
    {
      title: 'Combineer met Optellen voor Complete Rekenbundels',
      description: 'Maak bijpassende optellen- en aftrekkenwerkbladsets met hetzelfde thema en moeilijkheidsbereik. Verkoop ze individueel én als gecombineerde "Optellen & Aftrekken" megabundel met lichte korting. Gecombineerde megabundels rechtvaardigen aanzienlijk hogere prijzen omdat ze uitgebreide getalrelatie-dekking bieden. Maak bijpassende themasets waarbij dezelfde afbeeldingen in zowel optellen- als aftrekkenwerkbladen verschijnen. Prijs megabundels op €7–€9 voor maximale omzet per transactie.',
    },
    {
      title: 'Voeg Thematische Kaders toe voor Premium Prijzen',
      description: 'Een kaal wit werkblad en een werkblad met thematisch kader en subtiele achtergrond zien er compleet anders uit in productvermeldingen. Visuele afwerking toevoegen kost 30 seconden en kan een €1–€2 hoger prijspunt rechtvaardigen. Pas de achtergronddekking aan om de doorstreep-oefeningen leesbaar te houden. Consistente kaderkeuzes door een hele bundel creëren een professionele uitstraling.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Ja. De generator ondersteunt 11 talen: Nederlands, Engels, Duits, Frans, Spaans, Portugees, Italiaans, Zweeds, Deens, Noors en Fins. Schakel de inhoudstaal om en genereer werkbladen met afbeeldingslabels en instructies in je gekozen taal. Dit opent internationale verkoopkansen — maak Duitse aftrekwerkbladen voor de DACH-markt, Franse werkbladen voor Canadese en Europese kopers, of Spaanse werkbladen voor de grote Latijns-Amerikaanse thuisonderwijsgemeenschap.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Ja. Na het genereren van een werkblad klik je op "Genereer Antwoordblad" om een bijpassend oplossingenblad te maken met alle antwoorden ingevuld. Bij Doorstreep-werkbladen toont het antwoordblad duidelijk welke afbeeldingen zijn doorgestreept. Je kunt het antwoordblad downloaden als apart JPEG- of PDF-bestand.',
    },
    {
  ...
  visuals: {
    ...
    videoTitle: 'Hoe Je Aftrekwerkbladen Maakt — Video Handleiding',
  },
};
