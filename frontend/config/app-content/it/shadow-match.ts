...
const content: AppContent = {
  seo: {
    primaryKeyword: 'gioco delle ombre da stampare',
    secondaryKeywords: [
      'associare le ombre scheda',
      'ombre e sagome da stampare',
      'sagome da abbinare',
      'ombre scuola infanzia',
    ],
    lsiKeywords: [
      'sagoma',
      'ombra',
  ...
  visuals: {
    ...
    sampleGallery: [
      ...
      {
        src: '/samples/italian/shadow%20match/abbina-le-ombre-3.webp',
