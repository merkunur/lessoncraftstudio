...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Abre el panel de Configuración de Ejercicios y selecciona un modo de generación global. El modo Idéntico coloca tres clones de la misma imagen junto a una imagen diferente del mismo tema — los usuarios detectan el no-duplicado comparando detalles visuales finos. El modo Similar toma tres imágenes del Tema A y una imagen del Tema B — los usuarios identifican el intruso temático reconociendo diferencias categóricas. Cada modo crea un desafío cognitivo fundamentalmente diferente con la misma biblioteca de imágenes, así que elige según el nivel de dificultad y el enfoque de habilidad que desees para tu producto.',
      },
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Crea fichas del intruso listas para venta en línea para trabajo matutino, actividades para usuarios que terminan temprano y centros de enriquecimiento con campos de nombre/fecha, números de ejercicio y claves de respuestas impresas para estaciones de autoevaluación. Crea conjuntos alineados con el catálogo de productos: desafíos de clasificación animal para ciencias, discriminación de grupos alimenticios para lecciones de nutrición, identificación de ayudantes comunitarios para estudios sociales. La anulación de modo por ejercicio te permite crear versiones diferenciadas — ejercicios fáciles en modo Idéntico para usuarios con dificultades transicionando a ejercicios más difíciles en modo Similar para usuarios avanzados en la misma página. Cada ficha se exporta con su clave de respuestas autogenerada, eliminando el tiempo de preparación del vendedor.',
    },
    {
