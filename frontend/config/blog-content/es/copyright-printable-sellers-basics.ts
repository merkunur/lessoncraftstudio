...
const content: BlogContent = {
  ...
  cta: {
    heading: 'Impulse su Negocio de Imprimibles',
    description: '33 generadores profesionales para crear fichas que se venden. Prueba gratuita con marca de agua, sin registro.',
    buttonText: 'Ver Generadores',
    buttonUrl: '/apps',
  },
};
