...
const content: BlogContent = {
  seo: {
    ...
    secondaryKeywords: [
      'gumroad vs etsy fees digital downloads',
      'best platform sell digital products 2026',
      'gumroad etsy comparison printable sellers',
    ],
    lsiKeywords: [
  ...
  cta: {
    ...
    description: 'Professional worksheets ready for Etsy, Gumroad, or any marketplace. 33 generators available. Free trial with watermark — no signup required.',
