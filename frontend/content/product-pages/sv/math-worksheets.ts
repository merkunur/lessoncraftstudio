    ...
    items: [
      {
        ...
        answerKeySrc: '/samples/swedish/math/sample-1-answer.jpeg',
        altText: 'Matematik arbetsblad gratis för barn - porträttformat med bildbaserade övningar för förskoleklass',
        pdfDownloadUrl: '/samples/swedish/math/sample-1.pdf',
      },
      {
        id: '2',
        worksheetSrc: '/samples/swedish/math/sample-2.jpeg',
        answerKeySrc: '/samples/swedish/math/sample-2-answer.jpeg',
        altText: 'Gratis arbetsblad för förskoleklass - landskapsformat matematik övningar med färgglada bilder',
        pdfDownloadUrl: '/samples/swedish/math/sample-2.pdf',
      },
    ],
  },
