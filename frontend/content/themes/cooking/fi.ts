...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'first-grade': {
      ...
      snippetAnswer: 'Ruoanlaitto-aiheiset työlehdet ensimmäiselle luokalle (6–7-vuotiaat) kehittävät ohjetekstin lukemista ja seuraamista, vahvistavat mittaamista reseptikontekstissa sekä opettavat turvallisuutta ja hygieniaIä keittiIöympIäristössä. POPS 2014:n monilukutaidon ja arjen taitojen tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Ensimmäisellä luokalla ruoanlaittoteema saa opetussuunnitelmallisen syvyyden, koska kuusi- ja seitsemänvuotiaat kykenevät lukemaan reseptejä itsenäisesti ja seuraamaan monivaiheisia ohjeita järjestyksessä. POPS 2014:n monilukutaito edellyttää, että oppilaat lukevat ja tulkitsevat erilaisia tekstilajeja, ja resepti on ensimmäisen luokan oppilaalle motivoivin ohjeteksti. Matemaattisesti mittaaminen konkretisoituu: desilitrat, ruokalusikat, minuutit, lämpötilat. Murtoluvun esimuodot tulevat tutuiksi: puolikas omena, neljäsosa suklaalevystä. Järjestysajattelu kehittyy, kun oppilas ymmärtää että vaiheet on tehtävä tietyssä järjestyksessä. Turvallisuus- ja hygieniakasvatuksen merkitys korostuu, kun oppilas käsittelee oikeita välineitä. Suomalainen ruokakulttuuri — korvapuustit, karjalanpiirakat, mustikkapiirakka — tarjoaa kulttuurisesti merkityksellisen kontekstin. Kirjoittaminen etenee omien reseptien tuottamiseen.',
      developmentalMilestones: [
        { milestone: 'Reseptin itsenäinen lukeminen ja seuraaminen (6–7-vuotiaat lukevat monivaiheisen ohjetekstin)', howWeAddress: 'Reseptinlukutehtävät, joissa oppilas lukee reseptin, numeroi vaiheet ja vastaa ymmärtämiskysymyksiin, kehittävät ohjetekstin lukutaitoa' },
        { milestone: 'Mittaaminen keittiIövälineillä (ensimmäisen luokan oppilaat mittaavat desilitroja ja minuutteja)', howWeAddress: 'Mittaustehtävät, joissa oppilas valitsee oikean välineen ja mittaa ainesosan, yhdistävät mittaamisen käytännön taitoon' },
        { milestone: 'Murtoluvun esimuodot (kuusi- ja seitsemänvuotiaat ymmärtävät puolikkaan ja neljäsosan)', howWeAddress: 'Reseptitehtävät, joissa ainesosat jaetaan puolikkaisiin ja neljäsosiin, rakentavat murtoluvun konkreettista ymmärrystä' },
        { milestone: 'Turvallisuus- ja hygieniatietoisuus (ensimmäisen luokan oppilaat ymmärtävät keittiIösäännöt)', howWeAddress: 'Turvallisuustehtävät, joissa oppilas tunnistaa oikeat ja väärät toimintatavat keittiIössä, rakentavat vastuullista keittiIökäyttäytymistä' },
      ],
      differentiationNotes: 'Tukea tarvitseville ensimmäisen luokan oppilaille tarjoa reseptit kuvallisina vaiheohjeina, rajaa mittaaminen kokonaisiin desilitroihin ja anna turvallisuustehtävissä selkeät kyllä/ei-vaihtoehdot. Edistyneille ensimmäisen luokan oppilaille lisää reseptin kaksinkertaistaminen (tuplaa mittamäärät), laajenna mittaaminen grammoihin ja haasta kirjoittamaan oma resepti alusta loppuun.',
      parentTakeaway: 'Ensimmäisen luokan ruoanlaittotyölehdet tekevät lapsesta keittiIökumppanin. Antakaa lapsen lukea resepti ja ohjata teitä: hän kertoo mitä mitataan ja paljonko. Leipominen on erinomaista mittaamisharjoitusta. Opettakaa samalla turvallisuutta: miten käsitellään veistä, miksi kädet pestään. Tärkeintä on antaa lapsen olla aktiivinen tekijä, ei sivustaseuraaja — erehdyksetkin ovat oppimista.',
      classroomIntegration: 'Ruoanlaittotyölehdet yhdistyvät ensimmäisen luokan käytännön oppimiseen: työlehtihetkellä luetaan reseptejä ja ratkaistaan mittaustehtäviä, ja kokkaushetkellä toteutetaan resepti yhdessä. Leivontapäivät ovat luokan kohokohtia, joissa teoria muuttuu käytännöksi. POPS 2014:n monilukutaidon, mittaamisen ja arjen taitojen tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Reseptin lukeminen', emerging: 'seuraa yksivaiheista kuvaohjetta aikuisen tuella', proficient: 'lukee kolme–neljävaiheisen reseptin itsenäisesti ja nimeää vaiheiden järjestyksen', advanced: 'lukee monimutkaisen reseptin, ennakoi tarvittavat välineet ja aikatauluttaa vaiheet' },
        { skill: 'Mittaaminen keittiIössä', emerging: 'mittaa yhden ainesosan kokonaisena desilitrana aikuisen avustuksella', proficient: 'mittaa itsenäisesti desilitroja, ruokalusikoita ja minuutteja tarkasti', advanced: 'muuntaa mittoja, kaksinkertaistaa reseptin ja tarkistaa määrät laskemalla' },
        { skill: 'Turvallisuus ja hygienia', emerging: 'tietää että kädet pestään ennen ruoanlaittoa', proficient: 'tunnistaa viisi turvallisuussääntöä ja selittää niiden merkityksen', advanced: 'arvioi keittiIötilanteen turvallisuutta itsenäisesti ja ehdottaa parannuksia' },
      ],
    },
    'second-grade': {
