...
const content: ToolContent = {
  ...
  businessIdeas: [
    ...
    {
      title: 'Gumroad Coordinate Grid and Directional Vocabulary Packs',
      description: 'Upload treasure hunt activity packs to Gumroad targeting buyers who need coordinate grid and directional vocabulary resources. The 5×5 letter-number grid introduces grid reference skills aligned with math and geography topics. Buyers searching for direction-following activities value worksheets with structured sequential instructions and printed answer keys. Create difficulty-differentiated sets: Basic direction treasure hunts for the early-learner niche and Cardinal direction versions for the K-2 product market. Include worksheets and answer keys in both PDF and JPEG formats.',
      platform: 'Gumroad',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'The same puzzle structure produces authentic native-language treasure hunt worksheets when you switch languages. All directional clue text translates completely — not just the header, but "Start at," "Move," direction words, "square(s)," and "Where is the treasure?" all localize into 11 supported languages. Create one themed set and generate treasure hunts in all 11 languages for 11 sellable products from a single content session. Multilingual directional vocabulary bundles serve ESL/EFL buyers and international families at premium prices.',
    },
    {
