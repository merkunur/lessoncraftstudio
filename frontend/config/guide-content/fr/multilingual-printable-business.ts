...
const content: GuideContent = {
  ...
  toolsRecommended: [
    {
      ...
      description: 'Créez des mots cachés dans 11 langues — démontre comment un seul outil produit instantanément du contenu multilingue. Commencez un essai gratuit avec filigrane pour voir la production multilingue en action.',
    },
    {
      appId: 'word-guess',
      title: 'Générateur de mots à deviner',
      description: 'Générez des fiches de vocabulaire avec mots à deviner dans plusieurs langues. Montre comment du contenu éducatif sensible à la langue peut atteindre les marchés internationaux. Commencez un essai gratuit avec filigrane.',
    },
    {
      appId: 'matching',
      title: 'Générateur de fiches d\'association',
      description: 'Créez des fiches d\'association avec des thèmes visuels qui fonctionnent universellement dans toutes les langues. Le contenu basé sur les images se transfère naturellement d\'un marché à l\'autre avec une adaptation minimale. Commencez un essai gratuit avec filigrane.',
    },
    {
      appId: 'addition',
      title: 'Générateur de fiches d\'addition',
      description: 'Créez des fiches de maths d\'addition qui franchissent naturellement les barrières linguistiques car les chiffres sont universels. Les produits de maths sont des points de départ idéaux pour l\'expansion multilingue. Commencez un essai gratuit avec filigrane.',
    },
  ],
  ...
  visuals: {
    ...
    samples: [
      ...
      {
        src: '/samples/french/addition/Addition Amusante 1.webp',
    ...
    videoTitle: 'Comment créer des fiches de mots cachés multilingues pour les marchés internationaux',
  },
