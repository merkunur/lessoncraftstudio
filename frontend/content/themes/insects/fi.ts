...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'kindergarten': {
      ...
      snippetAnswer: 'Hyönteisaiheiset työlehdet esiopetukseen (5–6-vuotiaat) opettavat tutkivaa oppimista hyönteisten elinkaarien avulla, kehittävät tarkkaa havainnointia ja laskemista sekä vahvistavat luonnontieteellistä sanastoa. Esiopetussuunnitelman tutkivan oppimisen ja ympäristökasvatuksen tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Esiopetusikäisille hyönteisteema avaa muodonmuutoksen käsitteen, joka on yksi luonnontieteen kiehtovimmista ilmiöistä ja samalla täydellinen esimerkki sarjallisesta prosessista. Viisi- ja kuusivuotiaat kykenevät ymmärtämään, että toukka muuttuu koteloksi ja sitten perhoseksi — tämä monivaiheinen ketju harjoittaa sarjallista ajattelua ja muutoksen käsitteen ymmärtämistä. Esiopetussuunnitelman tutkivan oppimisen tavoite toteutuu, kun lapset seuraavat hyönteisten elinkaarta oikeassa ajassa (esim. toukkien kasvattaminen luokassa) ja dokumentoivat havainnot työlehdille. Matemaattisesti hyönteiset tarjoavat rikkaan kontekstin: kuusi jalkaa per hyönteinen mahdollistaa kertolaskuajattelun alun, ja symmetriset siipikuviot harjoittavat geometristä hahmottamista. Suomen kesä tarjoaa runsaasti havaintokohteita: leppIäkertut, muurahaispesIät ja perhoset ovat lasten ulottuvilla. Kielitietoisuus kehittyy hyönteissanaston kautta, joka on lapsille uutta ja kiehtovaa.',
      developmentalMilestones: [
        { milestone: 'Elinkaarien ymmärtäminen (5–6-vuotiaat hahmottavat monivaiheisia muutosprosesseja)', howWeAddress: 'Perhosen elinkaaritehtävät, joissa lapsi järjestää vaiheet (muna–toukka–kotelo–perhonen) ja piirtää ne, kehittävät prosessiajattelua' },
        { milestone: 'Symmetrian hahmottaminen (esiopetusikäiset ymmärtävät peilikuvan käsitteen)', howWeAddress: 'Perhosen siipien symmetriaväritystehtävät, joissa lapsi täydentää toisen puolen kuvion, harjoittavat geometristä ajattelua ja visuaalista tarkkuutta' },
        { milestone: 'Järjestelmällinen havainnointi ja dokumentointi (esiopetusikäiset oppivat kirjaamaan havaintoja)', howWeAddress: 'Hyönteishavainto-työlehdet, joissa lapsi piirtää hyönteisen, laskee jalat ja kirjoittaa nimen, kehittävät tutkimuksellista asennetta' },
        { milestone: 'Tarkka visuaalinen erottelu (viisi- ja kuusivuotiaat huomaavat pienempiä eroja)', howWeAddress: 'Etsi erot -tehtävät samankaltaisten hyönteisten välillä terävöittävät havainnointitarkkuutta, joka tukee lukemisen valmiutta' },
      ],
      differentiationNotes: 'Tukea tarvitseville esiopetusikäisille yksinkertaista elinkaari kolmeen vaiheeseen (pieni–iso–erilainen), käytä suuria selkeitä kuvia ja rajaa hyönteiset neljIään tuttuun lajiin. Edistyneille esiopetusikäisille lisää vertailu kahden hyönteisen elinkaarien välillä, pyydä kirjoittamaan havaintokirjaan kokonaisia lauseita ja haasta luomaan symmetrisiä siipikuvioita itsenäisesti.',
      parentTakeaway: 'Hyönteisteema on esiopetusikäiselle mahdollisuus tutustua luonnontieteeseen aivan kodin lähellä. Seuratkaa yhdessä muurahaisten polkua pihalla, etsikää leppIäkerttuja puutarhasta ja dokumentoikaa löydökset piirtämällä. Jos mahdollista, kasvattakaa perhosen toukkia kotona — muodonmuutoksen seuraaminen on viisi–kuusivuotiaalle unohtumatonta. Tärkeintä on tukea tutkivaa asennetta: kysy ”mitIä huomaat?” ennen kuin kerrot vastauksen.',
      classroomIntegration: 'Hyönteisteema sopii esiopetuksen kesäkauteen erityisen hyvin: ulkoilussa tehdään hyönteishavaintoja, sisällä dokumentoidaan ne työlehdille ja seurataan luokassa kasvavia toukkia. Aamupiirissä esitellään päivän hyönteinen, matikkapisteessä lasketaan jalkojen ja siipien lukumääriä, taidetuokiossa maalataan symmetrisiä perhosia ja lukunurkkauksessa luetaan hyönteistietokirjoja. Esiopetussuunnitelman tutkivan oppimisen tavoite toteutuu aidosti, kun lapset keräävät oikeaa dataa luonnosta.',
      assessmentRubric: [
        { skill: 'Elinkaaren vaiheiden järjestäminen', emerging: 'tunnistaa kaksi vaihetta (pieni ja iso) aikuisen avulla', proficient: 'järjestää neljä vaihetta oikeaan järjestykseen ja nimeää ne', advanced: 'järjestää vaiheet, selittää muutokset ja vertailee kahden hyönteisen elinkaaria' },
        { skill: 'Symmetrian täydentäminen', emerging: 'värittää molempia siipiä mutta ei peilikuvana', proficient: 'täydentää toisen siiven peilikuvaksi mallista', advanced: 'luo itsenäisesti symmetrisen kuvion ja selittää symmetrian käsitteen' },
        { skill: 'Hyönteishavaintojen dokumentointi', emerging: 'piirtää näkemänsä hyönteisen yksinkertaisesti', proficient: 'piirtää, laskee jalat ja siipien määrän ja kirjoittaa nimen', advanced: 'dokumentoi havainnon systemaattisesti: laji, paikka, käyttäytyminen ja päivämäärä' },
      ],
    },
    'first-grade': {
      ...
      snippetAnswer: 'Hyönteisaiheiset työlehdet ensimmäiselle luokalle (6–7-vuotiaat) opettavat hyönteisten elämänkiertoja tieteellisten havaintojen kautta, vahvistavat mittaamista ja vertailua sekä kehittävät luokittelua hyönteisten tunnuspiirteiden avulla. POPS 2014:n ympäristöopin ja tutkivan oppimisen tavoitteet toteutuvat.',
      uniqueGradeAngle: 'Ensimmäisellä luokalla hyönteisteema muuttuu tieteelliseksi tutkimukseksi, kun kuusi- ja seitsemänvuotiaat kykenevät ymmärtämään elämänkierron käsitteen: muna, toukka, kotelo, aikuinen. POPS 2014:n ympäristöoppi edellyttää elävän luonnon tutkimista, ja hyönteiset ovat erinomainen kohde, koska niiden elämänkierto on lyhyt ja havaittavissa luokkahuoneessa. Ensimmäisen luokan oppilas lukee tietotekstejä hyönteisistä ja kirjoittaa havaintolauseita itsenäisesti. Matemaattisesti mittaaminen konkretisoituu hyönteisten kokovertailussa: kuinka monta senttimetriä pitkä toukka on? Luokittelu syventyy tieteellisemmäksi, kun oppilaat erottavat hyönteiset hämähäkeistä jalkojen määrän perusteella. Luontosuhde vahvistuu, kun oppilaat tutkivat lähiympäristön hyönteisiä suurennuslasilla. Suomen kesä on hyönteisten juhla-aikaa, ja toukokuusta syyskuuhun luokkahuone voi olla tutkimuslaboratorio.',
      developmentalMilestones: [
        { milestone: 'Elämänkierron ymmärtäminen (6–7-vuotiaat hahmottavat muodonmuutoksen vaiheet)', howWeAddress: 'Elämänkiertotehtävät, joissa oppilas järjestää vaiheet ja kirjoittaa selitykset, kehittävät prosessiajattelua ja tieteellistä sanastoa' },
        { milestone: 'Mittaaminen ja kokovertailu (ensimmäisen luokan oppilaat mittaavat pituuksia yksinkertaisin välinein)', howWeAddress: 'Hyönteisten kokovertailutehtävät, joissa mitataan ja verrataan pituuksia senttimetreissä, yhdistävät mittaamisen luonnontiedon havainnointiin' },
        { milestone: 'Tieteellinen luokittelu tunnuspiirteiden avulla (kuusi- ja seitsemänvuotiaat erottavat hyönteiset muista niveljaälkaisistä)', howWeAddress: 'Luokittelutehtävät, joissa oppilas laskee jalat ja siipien määrän ja päättelee onko eliIö hyönteinen, rakentavat tieteellistä päättelyä' },
        { milestone: 'TutkimuspIäiväkirjan pitäminen (ensimmäisen luokan oppilaat kirjaavat havaintojaan rakenteellisesti)', howWeAddress: 'Hyönteishavainto-päiväkirja, johon oppilas piirtää, mittaa ja kirjoittaa havaintolauseen, kehittää tutkijan taitoja' },
      ],
      differentiationNotes: 'Tukea tarvitseville ensimmäisen luokan oppilaille rajaa elämänkierto kolmeen vaiheeseen, tarjoa suurennettuja kuvia tunnistamisen tueksi ja anna mittaustehtävissä kokonaiset senttimetrit ilman desimaaleja. Edistyneille ensimmäisen luokan oppilaille lisää vertailu täydellisen ja epätäydellisen muodonmuutoksen välillä, laajenna mittaaminen millimetreihin ja haasta kirjoittamaan tutkimusraportti omasta hyönteishavainnosta.',
      parentTakeaway: 'Ensimmäisen luokan hyönteistyölehdet muuttavat pihan tutkimuskenttäksi. Hankkikaa suurennuslasi ja tutkikaa yhdessä pieniIä otököitä: montako jalkaa, onko siivet, minkä värinen? Toukankasvatusprojekti on erinomainen kotikokeilu: tilatkaa neitoperhosen toukkia ja seuratkaa muodonmuutosta yhdessä. Tärkeintä on voittaa mahdollinen hyönteispelko uteliaisuudella ja opettaa, että hyönteiset ovat luonnon välttämättömiä auttajia.',
      classroomIntegration: 'Hyönteistyölehdet ovat ensimmäisen luokan ympäristöopin tutkimusprojektin runko: tunnin alussa tutkitaan hyönteistä suurennuslasilla tai kuvasta, työlehtihetkellä mitataan, luokitellaan ja ratkaistaan elämänkiertotehtäviä, ja kirjoitustuokiossa kirjataan havainnot päiväkirjaan. Luokan toukankasvatusprojekti tarjoaa pitkäkestoisen tutkimuskohteen. POPS 2014:n tutkivan oppimisen ja ympäristöopin tavoitteet yhdistyvät.',
      assessmentRubric: [
        { skill: 'Elämänkierron ymmärrys', emerging: 'tunnistaa perhosen kaksi vaihetta (toukka ja perhonen) aikuisen tuella', proficient: 'järjestää neljä vaihetta oikein ja nimeää ne', advanced: 'selittää jokaisen vaiheen merkityksen ja vertailee kahden hyönteisen elämänkiertoa' },
        { skill: 'Mittaaminen ja vertailu', emerging: 'vertailee kahden hyönteisen kokoa sanallisesti (isompi, pienempi)', proficient: 'mittaa hyönteisten pituuksia senttimetreissä ja kirjaa tulokset taulukkoon', advanced: 'mittaa tarkasti, järjestää suuruusjärjestykseen ja laskee kokoeron' },
        { skill: 'Hyönteisten tunnistaminen ja luokittelu', emerging: 'tunnistaa kolme yleistä hyönteistä kuvasta', proficient: 'erottaa hyönteiset hämähäkeistä ja nimeää perustelun (jalkojen määrä)', advanced: 'luokittelee hyönteisiä usealla perusteella ja kirjoittaa luokitteluselityksen' },
      ],
    },
    'second-grade': {
      ...
      snippetAnswer: 'Hyönteisaiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät hyönteisten elämänkierron tutkimista muodonmuutoksen vaiheiden kautta, kehittävät vertailevaa tutkimusta ja luokittelua sekä vahvistavat tieteellisen raportin kirjoittamista. POPS 2014:n ympäristöopin vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla hyönteisteema saavuttaa tutkimuksellisen syvyyden, koska seitsemän- ja kahdeksanvuotiaat kykenevät ymmärtämään monimutkaisia elämänkierron vaiheita ja tekemään vertailevia tutkimuksia. POPS 2014:n päättötavoitteet edellyttävät elävien olentojen tutkimista niiden elinympIäristöissä. Toisen luokan oppilas tutkii täydellistä muodonmuutosta (muna–toukka–kotelo–aikuinen) ja epätäydellistä muodonmuutosta ja vertailee niitä. Luokittelu etenee hyönteisten erottamiseen muista niveljaälkaisistä: kuusi jalkaa, kolme ruumiinosaa, tuntosarvet. Matemaattisesti hyönteisten lukumäärät tarjoavat suuria lukuja: tutkimusruudussa voi olla kymmeniä yksilöitä. Kertolaskun harjoittelu: 6 jalkaa × 8 hyönteistä = 48 jalkaa. Tieteellinen raportti vaatii järjestelmällistä kirjoittamista: kysymys, menetelmä, havainnot, johtopäätös. Suomen kesän hyönteisrikkaus mahdollistaa autenttiset maastohavainnot.',
      developmentalMilestones: [
        { milestone: 'Muodonmuutoksen vaiheiden ymmärtäminen (7–8-vuotiaat vertailevat täydellistä ja epätäydellistä muodonmuutosta)', howWeAddress: 'Elämänkiertotehtävät, joissa oppilas järjestää vaiheet oikein, piirtää kuvat ja vertailee kahden lajin muodonmuutosta, syventävät biologista ymmärrystä' },
        { milestone: 'Hyönteisten erottaminen muista niveljaälkaisistä (toisen luokan oppilaat käyttävät määrittelykriteereitä)', howWeAddress: 'Luokittelutehtävät, joissa oppilas erottaa hyönteiset hämähäkkeistä ja äyärijäisistä tarkoilla kriteerillä (jalkojen määrä, ruumiinosat), rakentavat tarkkaa havainnointia' },
        { milestone: 'Kertolasku hyönteiskontekstissa (seitsemän- ja kahdeksanvuotiaat harjoittelevat ryhmIälaskentaa)', howWeAddress: 'Kertolaskutehtävät, joissa lasketaan jalkojen, siipien tai silmien kokonaismäärä ryhmässä (6 jalkaa × 10 muurahaista = 60), konkretisoivat kertolaskun' },
        { milestone: 'Tieteellisen raportin rakenne (toisen luokan oppilaat kirjoittavat tutkimusraportin)', howWeAddress: 'Tutkimusraportit, joissa oppilas muotoilee kysymyksen, kuvaa menetelmän, kirjaa havainnot ja tekee johtopäätöksen, kehittävät tieteellistä kirjoittamista' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa muodonmuutos yhteen lajiin (perhonen), anna luokittelussa kuvakortit ja konkreettiset näytteet ja rajaa kertolasku 2×- ja 5×-tauluihin. Edistyneille toisen luokan oppilaille laajenna vertailu kolmeen eri muodonmuutostyyppiin, lisää hyönteisten ekologinen merkitys (pölytys, hajotus) ja haasta kirjoittamaan kattava tutkimusraportti omasta maastohavainnosta.',
      parentTakeaway: 'Toisen luokan hyönteistyölehdet tekevät kesästä tutkimuslaboratorion. Hankkikaa suurennuslasi ja tutkikaa pihalla hyönteisiä: laskekaa jalat, tutkikaa ruumiinosat, kirjatkaa havainnot. Seuratkaa perhosen muodonmuutosta kuvien tai videon avulla. Laskekaa yhdessä: jos muurahaispesIässä on 10 muurahaista ja jokaisella on 6 jalkaa, montako jalkaa yhteensä? Tärkeintä on opettaa tarkkaa havainnointia ja tieteellistä uteliaisuutta.',
      classroomIntegration: 'Hyönteistyölehdet ovat toisen luokan ympäristöopin tutkimusjakson huippu: keVIäällä ja kesällä luokka tutkii hyönteisiä koulun pihalla suurennuslaseilla, kirjaa havainnot työlehdille, piirtää elämänkierrot ja kirjoittaa tutkimusraportit. Kertolaskuharjoitukset integroituvat matematiikan tunteihin. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa hyönteisprojekti osoittaa tutkivan oppimisen ja tieteellisen ajattelun taitoja.',
      assessmentRubric: [
        { skill: 'Muodonmuutoksen ymmärtäminen', emerging: 'nimeää kaksi muodonmuutoksen vaihetta aikuisen tuella', proficient: 'järjestää kaikki vaiheet oikein ja vertailee kahden lajin muodonmuutosta', advanced: 'selittää muodonmuutoksen biologisen merkityksen ja vertailee täydellistä ja epätäydellistä muodonmuutosta' },
        { skill: 'Hyönteisten luokittelu', emerging: 'tunnistaa hyönteisen kuvasta mutta ei nimeä erottavia piirteitä', proficient: 'erottaa hyönteiset hämähäkeistä tarkoilla kriteereillä ja luokittelee alaryhmät', advanced: 'luokittelee hyönteiset usealla perusteella ja selittää luokittelun tieteellisen logiikan' },
        { skill: 'Tieteellisen raportin kirjoittaminen', emerging: 'kirjoittaa havaintoja yksittäisinä lauseina ilman rakennetta', proficient: 'kirjoittaa raportin kysymys–havainnot–johtopäätös-rakenteella', advanced: 'kirjoittaa kattavan raportin menetelmäkuvauksella, datan esittelyllä ja perustelluilla johtopäätöksillä' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Hyönteisaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät pölytysekosysteemin analyyttistä ymmärrystä, vahvistavat tieteellisen kokeen suunnittelua ja dokumentointia sekä opettavat argumentoivaa kirjoittamista hyönteisten merkityksestä ekosysteemeille. POPS 2014:n vuosiluokkien 3–6 tutkivan oppimisen tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla hyönteisteema kehittyy havainnoimisesta ekosysteemianalyysiksi, kun kahdeksan- ja yhdeksänvuotiaat kykenevät ymmärtämään pölytyksen merkityksen ruoantuotannolle ja analysoimaan elämänkiertojen monimutkaisuutta. Kertolaskusujuvuus mahdollistaa populaatiolaskut: jos yksi mehiläinen pölyttää 50 kukkaa päivässä ja pestillä on 40 mehiläistä (50 × 40 = 2000 kukkaa). Tieteellisen kokeen suunnittelu kehittyy, kun oppilas suunnittelee hyönteishavainnointikokeen muuttujineen ja kontrolleineen. Elinkiertojen vertailu vaatii järjestelmällistä analyysiä: täydellinen ja epätäydellinen muodonmuutos. Argumentoiva kirjoittaminen pölyttäjien suojelusta vaatii näyttöön perustuvaa päättelyä. Suomen hyönteistilanteen (pölyttäjäkato, luonnon monimuotoisuus) tutkiminen tarjoaa ajankohtaisen kontekstin. Tutkimusraportti yhdistää omat havainnot julkaistuun tietoon.',
      developmentalMilestones: [
        { milestone: 'Pölytysekosysteemin analyyttinen ymmärtäminen (8–9-vuotiaat hahmottavat hyönteisten roolin ruoantuotannossa)', howWeAddress: 'Pölytysketjuanalyysit, joissa oppilas seuraa pölytysprosessin vaiheet, laskee kertolaskulla tuotantovaikutuksia ja selittää ekosysteemipalvelun merkityksen' },
        { milestone: 'Tieteellisen kokeen suunnittelu ja toteutus (kolmannen luokan oppilaat ymmärtävät muuttujat)', howWeAddress: 'Kokeelliset harjoitukset, joissa oppilas suunnittelee hyönteishavainnointikokeen, määrittelee muuttujan ja kontrollin, kerää tietoja ja raportoi tulokset tieteellisesti' },
        { milestone: 'Elämänkiertojen vertaileva analysointi (kahdeksan- ja yhdeksänvuotiaat vertailevat järjestelmällisesti)', howWeAddress: 'Vertailutehtävät, joissa oppilas analysoi täydellistä ja epätäydellistä muodonmuutosta, piirtää vertailukaaviot ja kirjoittaa analyyttisen selityksen eroista' },
        { milestone: 'Argumentoiva kirjoittaminen ympäristöaiheesta (kolmannen luokan oppilaat perustelevat näyttöön perustuen)', howWeAddress: 'Pölyttäjäsuojelukirjoitukset, joissa oppilas kerää dataa pölyttäjäkadosta, analysoi syitä ja kirjoittaa perustellun toimintasuosituksen' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille rajaa kokeen suunnittelu yhteen muuttujaan, anna elinkiertovertailuun valmiit kuvakortit ja tarjoa argumentoinnissa lausealoitukset. Edistyneille kolmannen luokan oppilaille laajenna kokeellinen asetelma useampaan muuttujaan, lisää tilastollista datankäsittelyä ja haasta kirjoittamaan tieteellinen posteri pölyttäjätutkimuksesta.',
      parentTakeaway: 'Kolmannen luokan hyönteistyölehdet kehittävät tieteellistä ajattelua ja ympäristövastuullisuutta. Havainnoikaa yhdessä hyönteisiä puutarhassa: montako eri lajia löydätte 15 minuutissa? Laskekaa kertolaskulla: jos yksi päiväperhonen vierailee 30 kukassa, montako kukkaa 6 perhosta pölyttää? Tutkikaa miten hyönteishotelli toimii. Tärkeintä on ymmärtää pienten eläinten suuri merkitys ekosysteemeille.',
      classroomIntegration: 'Hyönteistyölehdet yhdistävät kolmannen luokan ympäristöopin ja äidinkielen: pölytysekosysteemin tutkimusjakso, tieteellisen kokeen suunnittelu ja raportointi, elinkiertojen vertailu analyyttisenä kirjoittamisena ja pölyttäjäsuojelu mielipidekirjoituksena. POPS 2014:n vuosiluokkien 3–6 tutkivan oppimisen ja vastuullisuuden tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Pölytysekosysteemin ymmärrys', emerging: 'tietää että hyönteiset pölyttävät kukkia mutta ei ymmärrä järjestelmän laajuutta', proficient: 'selittää pölytysketjun ruoantuotantoon asti ja laskee vaikutuksia kertolaskulla', advanced: 'analysoi pölyttäjäkadon seurauksia ekosysteemitasolla ja ehdottaa ratkaisuja dataan perustuen' },
        { skill: 'Tieteellisen kokeen suunnittelu', emerging: 'havainnoi hyönteisiä mutta ei suunnittele järjestelmällistä koetta', proficient: 'suunnittelee kokeen muuttujineen, kerää tietoja järjestelmällisesti ja raportoi tulokset', advanced: 'suunnittelee kontrolloidun kokeen, analysoi tuloksia kriittisesti ja esittää jatkotutkimuskysymyksiä' },
        { skill: 'Elämänkiertojen vertaileva analyysi', emerging: 'kuvaa yhden elinkierron mutta ei vertaile', proficient: 'vertailee kahta elinkiertotyyppiä järjestelmällisesti ja selittää erot', advanced: 'analysoi elinkiertojen evoluutiivista merkitystä ja yhdistää vertailun ekologiseen kontekstiin' },
      ],
    },
  },
