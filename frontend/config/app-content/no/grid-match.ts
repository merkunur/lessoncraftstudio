...
const content: AppContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'rutenettkobling puslespill generator kommersiell lisens',
      'selg rutenettbildepuslespill på Gumroad',
    ],
    lsiKeywords: [
      'digitale fliser koblings utskriftsbare nettbasert forretning',
      'kommersielt bruk rutenettspuslespill arbeidsark generator',
  ...
  hero: {
    title: 'Rutenettkobling Puslespill Generator for Bildeflisers Koblingsaktiviteter',
