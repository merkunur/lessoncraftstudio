...
const content: BlogContent = {
  seo: {
    primaryKeyword: 'A4 vs Letter Papiergroesse Druckvorlagen DACH',
    ...
    titleTag: 'A4 vs Letter: Beste Papiergroessen fuer Druckvorlagen | LessonCraftStudio',
  ...
  hero: {
    ...
    description: 'Im DACH-Raum ist A4 Standard. Wann Sie A4, Letter oder beides anbieten sollten. Technischer Guide fuer Druckvorlagen-Verkaeufer. Ein praxisnaher Guide mit konkreten Schritten, die Sie sofort umsetzen koennen. Fuer Einsteiger und erfahrene Verkaeufer auf Etsy.de, Eduki und Amazon KDP.',
  },
  category: 'how-to',
  introduction: 'A4 vs Letter — dieses Thema unterscheidet erfolgreiche Druckvorlagen-Verkaeufer von erfolglosen. In diesem Guide lernen Sie den konkreten Prozess, vermeiden typische Fehler und setzen die Tipps sofort um.',
  sections: [
    {
      heading: 'Warum das wichtig ist',
      content: 'Im DACH-Raum ist A4 das Standardformat — und das muessen Sie als Druckvorlagen-Verkaeufer wissen.\n\n**A4 (210 x 297 mm):** Standard in Deutschland, Oesterreich, der Schweiz und ganz Europa. Ihr Primaerformat.\n\n**US Letter (216 x 279 mm):** Standard in den USA und Kanada. Wichtig fuer internationale Verkaeufe.\n\n**Unterschied:** A4 ist schmaler und laenger als Letter. Ein A4-PDF auf Letter-Papier gedruckt hat weisse Raender unten. Ein Letter-PDF auf A4 hat seitliche Raender.\n\n**Loesung:** Bieten Sie beide Formate an oder gestalten Sie Ihre Arbeitsblaetter so, dass sie auf beiden funktionieren.',
    },
    {
  ...
  keyTakeaways: [
    'A4 vs Letter ist eine Kernkompetenz fuer mehr Verkaeufe',
