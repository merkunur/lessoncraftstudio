/* =====================================================================
   APPLY + GATE — TOOL #50's ten non-English string sets
   =====================================================================
   Merges `_number-drum-strings.js` into the tool's `strings` block and
   ...
   *våningen* and `kerros` failing to match *kerroksessa* — a ban tested
   ...
   Run: node scripts/apply-number-drum-locales.js [--dry-run]
   ===================================================================== */
'use strict';
const fs = require('fs');
...
const TOOL = path.join(__dirname, '..', 'mini tools', 'number-drum.js');
const LOC = require(path.join(__dirname, '_number-drum-strings.js'));
...
const BAN = {
  de: [['Trommel', word], ['Zahnrad', word], ['Walze', word], ['Streifen', stem], ['Spalte', stem]],
  fr: [['tambour', word], ['rouleau', word], ['bande', word], ['colonne', word], ['cadran', word]],
  es: [['tambor', word], ['rodillo', word], ['cinta', word], ['columna', word], ['engranaje', word]],
  pt: [['tambor', word], ['rolo', word], ['fita', word], ['coluna', word], ['engrenagem', word]],
  it: [['tamburo', word], ['rullo', word], ['nastro', word], ['colonna', word], ['ingranaggio', word]],
  nl: [['trommel', word], ['rol', word], ['kolom', word], ['tandwiel', word]],
  sv: [['trumma', stem], ['vals', stem], ['kolumn', stem], ['kugghjul', stem], ['remsa', stem]],
  da: [['tromme', stem], ['valse', stem], ['kolonne', stem], ['tandhjul', stem], ['strimmel', stem]],
  no: [['tromme', stem], ['valse', stem], ['kolonne', stem], ['tannhjul', stem], ['remse', stem]],
  fi: [['rumpu', stem], ['tela', stem], ['sarake', stem], ['hammasratas', stem], ['nauha', stem]]
};
...
const EXEMPT = { sheetNote: ['Streifen', 'strimmel', 'remsa', 'remse', 'strimmel'] };
...
['drum', 'gear', 'cog', 'dial', 'lever', 'roller'].forEach(function (w) {
