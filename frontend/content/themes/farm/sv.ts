...
const content: EnrichedThemeContent = {
  ...
  description: 'Utskrivbara bondgård-övningar för barn. Matematik, målarbilder, ordspel och pussel med bondgårdtema. Förskola till årskurs 3. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    ...
    'kindergarten': {
      ...
      seoDescription: 'Utskrivbara bondgårdsövningar för förskoleklassbarn (5–6 år). Räkning, gruppering och ordpussel med bondgårdstema. 33 generatorer. Gratis PDF. Ladda ner.',
    ...
    'third-grade': {
      ...
      seoDescription: 'Utskrivbara bondgård-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Hämta.',
