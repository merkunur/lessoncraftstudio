/* Builds TOOL #52's eleven ToolEntry landing records AND its hub card.
...
const HEAD = {
  en: { slug: 'rounding-hill-round-to-the-nearest-ten',
...
fs.writeFileSync(path.join(__dirname, '_rounding-hill-landing.js'),
...
const card = '  {\n    id: "rounding-hill",\n' +
  '    mini_tool_url: "/mini-tools/rounding-hill.html",\n' +
  '    title: {\n' + per(l => s('title', l)) + '\n    },\n' +
  '    tagline: {\n' + per(l => HEAD[l].tagline) + '\n    },\n' +
  '    description: {\n' + per(l => out[l].about.join(' ')) + '\n    },\n  },\n';
fs.writeFileSync(path.join(__dirname, '_rounding-hill-card.txt'), card);
