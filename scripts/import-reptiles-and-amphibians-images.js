...
// Theme configuration
const THEME_CONFIG = {
  name: 'reptiles_and_amphibians',
  type: 'images',
  sourceFolderName: 'reptiles and Amphibians',
  displayNames: {
    en: 'Reptiles and Amphibians',
    de: 'Reptilien und Amphibien',
    fr: 'Reptiles et amphibiens',
    es: 'Reptiles y anfibios',
    it: 'Rettili e anfibi',
    pt: 'Répteis e anfíbios',
    nl: 'Reptielen en amfibieën',
    sv: 'Reptiler och groddjur',
    da: 'Krybdyr og padder',
    no: 'Reptiler og amfibier',
    fi: 'Matelijat ja sammakkoeläimet'
  }
};
...
async function main() {
  console.log('============================================================');
  console.log('Image Import Script: Reptiles and Amphibians');
  console.log('============================================================\n');
