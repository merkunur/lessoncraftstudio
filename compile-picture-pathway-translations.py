...
print("="*80)
print("Picture Pathway Translation Compilation")
print("="*80)
...
base_path = "translations/picture-pathway/"

# Extract English from master template
english = extract_english_from_template(f"{base_path}picture-pathway-translation-master-template.js")

# Extract from professional translation files
german = extract_translations_from_js(f"{base_path}picture-pathway-professional-german-translation.js", "de")
french = extract_translations_from_js(f"{base_path}picture-pathway-professional-french-translation.js", "fr")
spanish = extract_translations_from_js(f"{base_path}picture-pathway-professional-spanish-translation.js", "es")
italian = extract_translations_from_js(f"{base_path}picture-pathway-professional-italian-translation.js", "it")
portuguese = extract_translations_from_js(f"{base_path}picture-pathway-professional-portuguese-translation.js", "pt")
dutch = extract_translations_from_js(f"{base_path}picture-pathway-professional-dutch-translation.js", "nl")
swedish = extract_translations_from_js(f"{base_path}picture-pathway-professional-swedish-translation.js", "sv")
danish = extract_translations_from_js(f"{base_path}picture-pathway-professional-danish-translation.js", "da")
norwegian = extract_translations_from_js(f"{base_path}picture-pathway-professional-norwegian-translation.js", "no")
finnish = extract_translations_from_js(f"{base_path}picture-pathway-professional-finnish-translation.js", "fi")
...
output_lines.append('}')
output_lines.append('')
output_lines.append('// Expose globally for BulletproofLoader and other utilities')
output_lines.append('if (typeof window !== "undefined") {')
output_lines.append('  window.translations = translations;')
output_lines.append('}')

# Write to file
output_path = "frontend/public/worksheet-generators/js/translations-picture-pathway.js"
...
print("="*80)
print("\nNext steps:")
print("1. Review the generated file: frontend/public/worksheet-generators/js/translations-picture-pathway.js")
