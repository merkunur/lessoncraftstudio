...
const content: GuideContent = {
  seo: {
    ...
    lsiKeywords: [
      ...
      'mercado educativo alemão procura fichas francesas compradores imprimíveis espanhóis',
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Gere fichas de vocabulário com adivinhas de palavras em múltiplos idiomas. Mostra como o conteúdo educativo sensível ao idioma pode alcançar mercados internacionais. Inicie um teste grátis com marca de água.',
    },
    {
      appId: 'matching',
    ...
    },
    {
      ...
      description: 'Crie fichas de matemática de adição que atravessam as barreiras linguísticas naturalmente já que os números são universais. Os produtos de matemática são pontos de partida ideais para a expansão multilingue. Inicie um teste grátis com marca de água.',
    },
  ],
  ...
  visuals: {
    heroImage: {
      ...
      alt: 'Ficha de sopa de letras demonstrando o potencial de um negócio de imprimíveis multilingue em mercados internacionais',
    },
    samples: [
      {
        src: '/samples/english/wordsearch/wordsearch portrait.webp',
        alt: 'Ficha de sopa de letras mostrando a capacidade multilingue para vendas internacionais de imprimíveis',
      ...
      },
      {
        ...
        alt: 'Ficha de correspondência com temas visuais que funcionam em todos os mercados linguísticos',
        caption: 'As fichas de correspondência visual usam imagens que se traduzem universalmente entre idiomas',
      },
      {
        src: '/samples/english/addition/Addition Fun 1.webp',
        alt: 'Ficha de matemática de adição demonstrando apelo universal além das barreiras linguísticas',
        caption: 'As fichas de matemática atravessam as barreiras linguísticas naturalmente já que os números são universais em todos os mercados',
      },
    ],
    youtubeId: '36keBFzJbPo',
    videoTitle: 'Como criar fichas de sopa de letras multilingues para mercados internacionais',
  },
