...
const content: GuideContent = {
  seo: {
    primaryKeyword: 'come creare schede di sottrazione da stampare',
    secondaryKeywords: [
      'schede sottrazione con immagini per bambini PDF',
      'creare esercizi di sottrazione da stampare',
      'generatore schede sottrazione con immagini barrate',
      'schede sottrazione scuola primaria da stampare',
    ],
    lsiKeywords: [
      'sottrazione visiva con immagini',
      'immagini barrate',
      'schede matematica da stampare',
      'esercizi sottrazione prescolare',
      'fogli risposte automatici',
    ],
    titleTag: 'Creare schede di sottrazione da stampare | Guida',
    metaDescription: 'Come creare schede di sottrazione da stampare con immagini barrate, temi visivi e fogli risposte automatici. Generatore configurabile per ogni livello.',
  },

  hero: {
    title: 'Come creare schede di sottrazione da stampare',
  ...
  platformTips: [
    ...
    {
      heading: 'Vendere Schede di Sottrazione su Gumroad',
      content: 'Gumroad si rivolge agli imprenditori scolastici che necessitano di risorse allineate al mercato. Le schede di sottrazione funzionano bene su Gumroad quando fanno chiaramente riferimento a livelli scolastici e obiettivi di apprendimento.\n\nLe descrizioni dei prodotti dovrebbero specificare: livello scolastico, competenze esercitate (sottrazione entro 10, trovare il sottraendo, togliere visivo), numero di pagine incluse, disponibilità del foglio risposte e qualsiasi allineamento a standard comuni. La sottrazione entro 10 si allinea a K.OA.A.1 e la sottrazione entro 20 si allinea a 1.OA.A.1 — fare riferimento a questi standard aiuta i venditori a trovare i tuoi prodotti.\n\nFile di anteprima: Carica 2–3 pagine di esempio che mostrano il formato delle immagini barrate. i venditori vogliono vedere esattamente come viene presentata la sottrazione visiva prima dell\'acquisto. Lo stile delle immagini barrate è abbastanza distintivo che un\'anteprima forte converte i visitatori in acquirenti.\n\nBundle su Gumroad: i venditori comprano bundle per intere unità o periodi di valutazione. Un \"Bundle Padronanza Sottrazione — Modalità Barra, Immagine – Numero e Trova il Sottraendo\" che copre tutti i tipi di esercizio per un singolo livello scolastico è un prodotto forte su Gumroad. Un bundle ancora più forte combina addizione e sottrazione per un pacchetto \"Operazioni Matematiche Complete\".\n\nParole chiave specifiche Gumroad: Usa terminologia educativa: \"centro matematico\", \"lavoro del mattino\", \"valutazione sottrazione\", \"esercizio togliere\", \"sottrazione differenziata\", \"fluenza nei fatti\". Questi corrispondono a come i venditori cercano risorse per il negozio.\n\nTempistiche: Abbi i tuoi bundle di sottrazione pubblicati prima di agosto per la domanda del ritorno a scuola. Le operazioni matematiche vengono insegnate all\'inizio dell\'anno scolastico, rendendo settembre–novembre un periodo di picco delle vendite per i materiali di sottrazione.',
    },
  ],
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Sì. Ogni scheda di sottrazione include un foglio risposte automatico che rispecchia il layout della scheda con le risposte corrette compilate. Il foglio risposte si esporta sia in PDF che in JPEG. Questo è essenziale per i venditori che correggono le schede di più utenti e per i genitori che verificano il lavoro dei figli a casa.',
    },
    {
    ...
    {
      question: 'Posso vendere le schede che creo su Etsy, Amazon KDP e Gumroad?',
      answer: 'Sì. Una licenza commerciale ti dà pieni diritti per vendere le schede generate su qualsiasi piattaforma inclusi Etsy, Amazon KDP, Gumroad, Gumroad, Creative Fabrica e il tuo sito web. Non ci sono royalty o commissioni per vendita. Tieni il 100% dei tuoi ricavi di vendita dopo le commissioni del marketplace.',
    },
    {
