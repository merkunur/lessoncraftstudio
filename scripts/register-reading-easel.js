#!/usr/bin/env node
/* =====================================================================
   register-reading-easel.js — the five wiring points for TOOL #33.
   ...
   Usage: node scripts/register-reading-easel.js
   ===================================================================== */
'use strict';
const fs = require('fs');
...
const PREV = 'pattern-bench';        /* the key this one is inserted after */
const E = require('./_reading-easel-content.js');
