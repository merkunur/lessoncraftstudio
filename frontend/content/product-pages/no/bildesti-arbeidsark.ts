...
Lag gangetabellen oppgaver eller addisjon og subtraksjon ark på barnets morsmål. Språkstøtten gjelder både grensesnitt og innholdsgenerering. Bytt mellom språk på sekunder for sammenlignende språkundervisning. Andrespråkslærere bruker dette for visuell ordforrådsbygging.`,
        highlighted: false,
      },
      {
        id: '5',
    ...
    steps: [
      {
        ...
        description: `Klikk på Bildebibliotek-fanen i venstremenyen. Velg mellom Bildesti, Klassisk Labyrint eller Velg Riktig Sti modus. Bla gjennom 3000+ temaorganiserte bilder eller bruk søkefunksjonen. Velg startbilde, sluttbilde og stibilder for labyrinten din.
...
Legg til avledende bilder for å øke vanskelighetsgraden. Perfekt for å lage fargeleggingsbilder barn kombinert med labyrintoppgaver. Bruk tallbilder for tall og telling visualisering i labyrintene. Last opp egne bilder hvis du vil personalisere for klassen din. Alle bildevalg vises i sanntid i bildepanelene dine.`,
      ...
      },
      {
        ...
        description: `Åpne Sti-konfigurasjon-seksjonen for grunnleggende innstillinger. Velg rutenett-størrelse fra 12×12 til 15×15 for ulike vanskelighetsgrader. Kryss av for navn/dato-felt hvis du vil ha personalisering. Åpne Klassisk Labyrint-innstillinger for samleobjekt-innstillinger.
...
Juster antall samleobjekter fra 1-4 bilder. Sett minimum og maksimum kopier per bilde. Perfekt for å lage gangetabellen oppgaver hvor barn samler tallbilder. Lag bokstaver lære skrive aktiviteter hvor barn samler bokstavbilder gjennom labyrinten. Velg Riktig Sti-modus har retningsinnstillinger fra bunn til topp eller side til side.`,
      ...
      },
      {
        ...
        description: `Klikk Opprett-knappen i toppmenyen og velg Nytt Arbeidsark. Generatoren lager labyrinten automatisk på 2-5 sekunder. Bildesti-modus skaper en visuell sti fra start til mål. Klassisk Labyrint-modus genererer en løsbar labyrint med samleobjekter.
...
Velg Riktig Sti-modus lager flere veier hvor bare én fører til målet. Hver generering er unik takket være tilfeldig algoritme. Perfekt for å lage arbeidsark gratis i ubegrenset antall variasjoner. Kombiner med lesetrening ved å bruke ordbilder som stielementer. Algoritmen sikrer alltid en løsbar labyrint i alle tre modusene.`,
      ...
      },
      {
        ...
        description: `Klikk på hvilket som helst element for å velge det. Dra for å flytte, roter med sirkelikonet og skaler med hjørnene. Åpne Tekstverktøy for å legge til instruksjoner eller tittel. Velg mellom 7 fonter og full fargetilpasning.

Endre veggfarge, tykkelse og gjennomsiktighet i innstillingene. Juster bakgrunn og ramme fra Sideoppsett-seksjonen. Perfekt for å lage addisjon og subtraksjon oppgaver med tallbilder i labyrinten. Lag oppgavehefter barn med konsistent design gjennom flere sider. Angre/gjør om-funksjonalitet lar deg eksperimentere risikofritt med ulike design.`,
        icon: '✏️',
      },
      {
        id: '5',
        ...
        description: `Klikk Last ned-knappen i toppmenyen. Velg mellom JPEG eller PDF format. Kryss av for gråtone hvis du vil spare blekkpatron. Last ned arbeidsark først, deretter generer og last ned fasit separat.
...
Lag tall og telling labyrinter hvor barn samler 1-5 gjenstander. Bildesti-modus fungerer best for barnehagegrupper. Velg bilder fra barnas hverdag som mat, dyr og leker. Skriv ut arbeidsark gratis i A4-størrelse for enkel håndtering. Fasitgeneratoren hjelper assistenter og foreldre med veiledning.`,
...
Personaliser med familiebilder og kjente omgivelser. Lag arbeidsark gratis for flere barn i ulike aldre samtidig. 11 språk støtter tospråklige familier perfekt. Velg Riktig Sti-modus utvikler selvstendighet og problemløsning. Last ned og skriv ut flere ark om gangen for ukesplanlegging.`,
      ...
      },
      {
        id: '4',
        icon: '🌍',
        title: 'Andrespråk og Språklærere - Oppgavehefter Barn Flerspråklig Ordforråd',
        subtitle: 'Støtt flerspråklige elever med morsmålsoppgaver',
        description: `Språklærere bruker bildesti for visuell ordforrådsbygging. Velg bilder med tydelige objekter barna skal lære å benevne. Bytt grensesnittspråk for å se bildenavn på målspråket. Lag oppgavehefter barn med tematisk ordforråd som mat, klær og dyr.

Kombiner med muntlig beskrivelse hvor barn forklarer stien verbalt. Bildesti-modus fungerer best for ordforrådsintroduksjon. Klassisk Labyrint legger til telling og tallord på målspråket. Flerspråklige klasserom lager samme labyrint på flere språk for sammenligning. Arbeidsark gratis generering gjør det mulig å lage mange språkversjoner.`,
...
Start med Bildesti for elever som trenger struktur og forutsigbarhet. Bruk tallbilder for addisjon og subtraksjon visualisering. Skriv ut samme labyrint flere ganger for repeterende øving. Gråtoneutskrift reduserer visuell støy for sensitive elever. Individualiser vanskelighetsgrad ved å endre antall samleobjekter og rutenett-størrelse.`,
      ...
      },
      {
        ...
        description: `Norske lærere selger bildesti-arbeidsark på nettbutikker som Teachers Pay Teachers og Etsy. Full Tilgang trykk-på-bestilling-lisens gir rett til kommersiell salg. Lag tematiske pakker med 10-20 labyrinter per tema. Kombiner fargeleggingsbilder barn med labyrintoppgaver for attraktive produkter.
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Absolutt, tall og telling labyrinter er perfekte for barnehagegrupper. Start med enkle 12×12 rutenett og store tallbilder 1-5. Bildesti-modus lar barna følge tall i nummerrekkefølge. Bruk få avledende elementer for 3-4 åringer. Lag tall og telling aktiviteter hvor barn teller objekter i hvert bilde. Kombiner med fysiske manipulativer for konkret matematikkforståelse.',
      },
      {
        id: '6',
        question: 'Kan Jeg Selge Oppgavehefter Barn Laget med Bildesti-Generatoren?',
        answer: 'Ja, Full Tilgang inkluderer full kommersiell trykk-på-bestilling-lisens. Selg oppgavehefter barn på nettbutikker som Teachers Pay Teachers, Etsy og egne nettsider. Lag tematiske pakker med 15-25 labyrinter per emne eller sesong. Ingen ekstra lisenskostnader utover Full Tilgang på kr 1 800 årlig. Typiske pakkepriser er 40-80 kr med 50-60% fortjeneste. Kombinasjonspakker med oppgavehefter barn og fargeleggingsark selger best.',
      },
      {
        id: '7',
      ...
      },
      {
        ...
        answer: 'Ja, alle tre spillmoduser inkluderer automatisk fasitgenerering. Klikk Lag Fasit etter å ha generert arbeidsarket. Fasiten viser løsningen tydelig markert med farget sti. Perfekt for gangetabellen oppgaver hvor riktig tallrekkefølge er kritisk. Klassisk Labyrint fasit viser alle samleobjekter markert i labyrinten. Velg Riktig Sti fasit markerer den korrekte stien blant alternativene.',
      },
      {
        id: '12',
        question: 'Kan Jeg Bruke Bildesti for Tall og Telling og Fargeleggingsbilder Barn Samtidig?',
        answer: 'Ja, kombiner tall og telling med fargeleggingsbilder barn i én aktivitet. Lag labyrint med tallbilder og fargerike motiver barn vil fargelegge. Bruk Bildesti med tall 1-10 som sti-elementer. Etter å ha løst labyrinten fargelegger barn bildene og teller objekter. Skriv ut i gråtone for optimal fargelegging mens tallene er synlige. Kombiner med fysiske telleobjekter for konkret tall og telling forståelse.',
      },
    ],
  },
