    ...
    items: [
      {
        ...
        description: 'Las fichas de restas combinan perfectamente con dibujos para colorear. Después de resolver problemas de resta, los estudiantes colorean imágenes relacionadas. Esta integración hace que la práctica matemática sea más divertida. El colorear también desarrolla habilidades motoras finas esenciales.',
        color: 'bg-pink-100',
      },
      {
        id: '2',
        icon: '✏️',
        name: 'Grafomotricidad y Lectoescritura',
        description: 'La grafomotricidad se integra naturalmente con práctica de números y restas. Las actividades de grafomotricidad desarrollan control de lápiz necesario para escribir números. Las fichas de lectoescritura complementan material de matemáticas en paquetes de aprendizaje completos.',
        color: 'bg-blue-100',
      },
      {
        id: '3',
        icon: '🔤',
        name: 'Abecedario y Aprender las Letras',
        description: 'Las fichas de abecedario funcionan excelentemente en paquetes con ejercicios de números. Aprender las letras del abecedario y números ocurre simultáneamente en preescolar. Los maestros crean paquetes matutinos que incluyen ambos tipos de contenido.',
        color: 'bg-green-100',
      },
      {
        id: '4',
        ...
        description: 'Las tablas de multiplicar se introducen después de dominar suma y resta. Combinar práctica de restas con tablas de multiplicar refuerza comprensión de operaciones inversas. Los paquetes de matemáticas que incluyen ambos desarrollan flexibilidad numérica.',
        color: 'bg-yellow-100',
      },
      {
        id: '5',
      ...
      },
      {
        id: '6',
        icon: '📊',
        name: 'Ejercicios de Matemáticas',
        description: 'Nuestros generadores de fichas de matemáticas incluyen multiplicación, división y más. Combina restas con otros tipos de ejercicios matemáticas para práctica variada. Los estudiantes desarrollan habilidades matemáticas completas con paquetes diversos.',
        color: 'bg-orange-100',
      },
    ],
  },
