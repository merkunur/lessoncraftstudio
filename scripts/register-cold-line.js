/* =====================================================================
   register-cold-line.js — wire TOOL #43 into the site
   ---------------------------------------------------------------------
   Run:  node scripts/register-cold-line.js [--dry-run]
...
const KEY = 'cold-line';
const PREV = 'comparison-planks';           /* the key this one is inserted after — #41 */
const E = require('./_cold-line-content.js');
...
LOCALES.forEach((l) => {
  const e = E[l];
  if (!e) die(`_cold-line-content.js has no entry for "${l}"`);
