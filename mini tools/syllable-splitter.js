...
var SyllableSplitter = {
  ...
  strings: {
    ...
    instruction:  {en:'Say the word, then tap the drum once for every clap you hear.',de:'Sprecht das Wort und tippt für jede Silbe einmal auf die Trommel.',fr:'Dites le mot, puis tapez une fois sur le tambour pour chaque frappe.',it:'Dite la parola, poi battete il tamburo una volta per ogni sillaba.',es:'Digan la palabra y toquen el tambor una vez por cada palmada.',pt:'Digam a palavra e batam no tambor uma vez por sílaba.',nl:'Zeg het woord en tik één keer op de trommel voor elke klankgroep.',sv:'Säg ordet och tryck på trumman en gång för varje klapp.',da:'Sig ordet, og tryk på trommen én gang for hvert klap.',no:'Si ordet, og trykk på trommen én gang for hvert klapp.',fi:'Sanokaa sana ja napauttakaa rumpua kerran jokaista tavua kohden.'},

    /* modes */
    modeClap:     {en:'Clap it',de:'Klatschen',fr:'Frapper',it:'Battere',es:'Dar palmas',pt:'Bater palmas',nl:'Klappen',sv:'Klappa',da:'Klappe',no:'Klappe',fi:'Taputa'},
    modeBuild:    {en:'Build it',de:'Zusammensetzen',fr:'Reconstruire',it:'Ricomporre',es:'Armar',pt:'Montar',nl:'Bouwen',sv:'Bygga',da:'Bygge',no:'Bygge',fi:'Kokoa'},
    modeSort:     {en:'Sort them',de:'Sortieren',fr:'Trier',it:'Ordinare',es:'Clasificar',pt:'Separar',nl:'Sorteren',sv:'Sortera',da:'Sortere',no:'Sortere',fi:'Lajittele'},
    ...
    hearWord:     {en:'Hear the word',de:'Wort anhören',fr:'Écouter le mot',it:'Ascolta la parola',es:'Escuchar la palabra',pt:'Ouvir a palavra',nl:'Woord beluisteren',sv:'Hör ordet',da:'Hør ordet',no:'Hør ordet',fi:'Kuuntele sana'},
    ...
    oralNote:     {en:'We clap what we hear — the writing can split differently.',de:'Wir klatschen, was wir hören – geschrieben kann es anders getrennt sein.',fr:'On frappe ce qu’on entend – à l’écrit, la coupure peut être différente.',it:'Battiamo quello che sentiamo – nello scritto la divisione può essere diversa.',es:'Damos palmas a lo que oímos: por escrito la separación puede ser distinta.',pt:'Batemos o que ouvimos — na escrita a divisão pode ser diferente.',nl:'We klappen wat we horen – geschreven kan de verdeling anders zijn.',sv:'Vi klappar det vi hör – i skrift kan delningen se annorlunda ut.',da:'Vi klapper det, vi hører – på skrift kan delingen være en anden.',no:'Vi klapper det vi hører – skriftlig kan delingen være annerledes.',fi:'Taputamme sen mitä kuulemme – kirjoitettuna jako voi olla toinen.'},

    /* build face */
    buildHint:    {en:'Put the parts back in order.',de:'Setzt die Teile wieder zusammen.',fr:'Remets les morceaux dans l’ordre.',it:'Rimetti i pezzi in ordine.',es:'Pon las partes en orden.',pt:'Coloquem as partes em ordem.',nl:'Zet de stukjes weer op volgorde.',sv:'Lägg delarna i ordning igen.',da:'Sæt delene i rækkefølge igen.',no:'Sett delene i rekkefølge igjen.',fi:'Järjestä osat takaisin.'},
    scramble:     {en:'Mix them up',de:'Mischen',fr:'Mélanger',it:'Mescola',es:'Mezclar',pt:'Misturar',nl:'Door elkaar',sv:'Blanda',da:'Bland',no:'Bland',fi:'Sekoita'},

    /* sort face */
    sortHint:     {en:'Drag each picture to its clap pen.',de:'Zieht jedes Bild in sein Silbengehege.',fr:'Glisse chaque image dans son enclos.',it:'Trascina ogni immagine nel suo recinto.',es:'Arrastra cada imagen a su corral.',pt:'Arraste cada imagem para o seu curral.',nl:'Sleep elk plaatje naar zijn wei.',sv:'Dra varje bild till rätt hage.',da:'Træk hvert billede hen til sin fold.',no:'Dra hvert bilde til sin innhegning.',fi:'Vedä jokainen kuva omaan aitaukseensa.'},
    ...
    /* shelves + premium */
    shelfPick:    {en:'Word sets',de:'Wortsätze',fr:'Séries de mots',it:'Gruppi di parole',es:'Grupos de palabras',pt:'Conjuntos de palavras',nl:'Woordsets',sv:'Ordgrupper',da:'Ordsæt',no:'Ordsett',fi:'Sanajoukot'},
    shelfClose:   {en:'Close',de:'Schließen',fr:'Fermer',it:'Chiudi',es:'Cerrar',pt:'Fechar',nl:'Sluiten',sv:'Stäng',da:'Luk',no:'Lukk',fi:'Sulje'},
    lockedShelf:  {en:'Premium set',de:'Premium-Satz',fr:'Série Premium',it:'Gruppo Premium',es:'Grupo Premium',pt:'Conjunto Premium',nl:'Premium-set',sv:'Premiumgrupp',da:'Premiumsæt',no:'Premiumsett',fi:'Premium-joukko'},
    gatePremium:  {en:'These sets and the sorting pens are part of Premium — your first set is always free.',de:'Diese Sätze und die Silbengehege gehören zu Premium – euer erster Satz bleibt immer kostenlos.',fr:'Ces séries et les enclos font partie de Premium – la première série reste gratuite.',it:'Questi gruppi e i recinti fanno parte di Premium: il primo gruppo resta gratuito.',es:'Estos grupos y los corrales son parte de Premium: el primer grupo siempre es gratis.',pt:'Estes conjuntos e os currais fazem parte do Premium — o primeiro conjunto é sempre gratuito.',nl:'Deze sets en de weides horen bij Premium – je eerste set blijft altijd gratis.',sv:'De här grupperna och hagarna ingår i Premium – den första gruppen är alltid gratis.',da:'Disse sæt og foldene er en del af Premium – det første sæt er altid gratis.',no:'Disse settene og innhegningene er en del av Premium – det første settet er alltid gratis.',fi:'Nämä joukot ja aitaukset kuuluvat Premiumiin – ensimmäinen joukko on aina ilmainen.'},
    ...
    siblingHwd:   {en:'Heart Words',de:'Merkwörter',fr:'Mots à cœur',it:'Parole del cuore',es:'Palabras con corazón',pt:'Palavras de coração',nl:'Hartwoorden',sv:'Hjärteord',da:'Hjerteord',no:'Hjerteord',fi:'Hjerteord'}
  },
