...
const content: AppContent = {
  ...
  ctaHeading: 'Créer des fiches plus ou moins',
  ...
  keyFeatures: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Téléchargez vos fiches et corrigés en JPEG haute résolution ou documents PDF prêts à imprimer. Le moteur d\'export rend à plus de 400 DPI. Activez le mode Niveaux de Gris pour convertir les fiches colorées en noir et blanc pour une impression économique en ligne. Les formats Letter, A4, Carré et personnalisés sont tous pris en charge.',
      },
      {
    ...
    cases: [
      {
        ...
        description:
          'Créez des ensembles de 10 à 20 fiches de comparaison regroupées par thème — animaux de la ferme, dinosaures, vie marine, fêtes — et proposez-les en téléchargement instantané sur Etsy. Incluez les trois modes (Image contre Image, Image contre Nombre, Cocher et Barrer) plus les corrigés pour une ressource d\'apprentissage complète. Les packs thématiques de comparaison attirent les parents et vendeurs qui cherchent des sujets spécifiques. Fixez les thèmes individuels à 3 €–5 € et les méga-packs variés à 12 €–18 €.',
