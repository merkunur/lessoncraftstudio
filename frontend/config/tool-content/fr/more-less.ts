...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'fiches plus grand plus petit gratuit',
    secondaryKeywords: [
      'comparer des nombres gratuit en ligne',
      'exercice comparaison quantités gratuit',
      'plus que moins que gratuit',
      'dénombrement comparaison gratuit',
    ],
    lsiKeywords: [
      'plus grand que',
      'plus petit que',
    ...
    titleTag: 'Fiches plus grand/plus petit gratuit | LCS',
    metaDescription: 'Créez des fiches de comparaison de nombres gratuitement en ligne. Images thématiques, corrections automatiques, sans inscription. Essai gratuit.',
  },

  hero: {
    title: 'Fiches plus grand/plus petit gratuites — comparer des nombres en ligne',
  ...
  tutorial: {
    title: 'Comment Créer des Fiches de Comparaison en 8 Étapes Simples',
    steps: [
      {
  ...
  whatYouCanCreate: [
    ...
    },
    {
      ...
      description: 'Comme ces fiches n\'utilisent que des images, des nombres et des symboles de comparaison, elles sont indépendantes de la langue. Créez un seul ensemble et listez-le en français, anglais, allemand, espagnol et sur tout autre marché Etsy. Aucune traduction nécessaire — les fiches fonctionnent identiquement dans le monde entier, multipliant instantanément votre marché accessible.',
    },
  ],
  ...
  businessIdeas: [
    ...
    {
      title: 'Expansion Multilingue du Marché',
      description: 'Comme les fiches de comparaison sont purement visuelles, un seul produit fonctionne dans tous les marchés linguistiques. Listez le même PDF sur Etsy Allemagne, France, Espagne, Italie et plus sans changer une seule page. La plupart des concurrents ne servent que les acheteurs anglophones — vous atteignez instantanément 5–10 fois plus de clients potentiels. Les concepts de comparaison sont universels à travers les langues et les cultures, ce qui rend l\'expansion multilingue particulièrement simple pour cette catégorie de produits. Les fiches de comparaison en allemand et en espagnol font face à une concurrence nettement moindre que les versions anglaises sur les places de marché.',
      platform: 'Etsy',
    },
    {
      title: 'Stratégie d\'Échantillon Gratuit via Pinterest',
      description: 'Offrez un échantillon d\'essai gratuit avec filigrane de 5 fiches de comparaison mettant en vedette le mode Cocher et Barrer comme lead magnet sur Pinterest. Le format visuel unique crée des épingles accrocheuses qui génèrent des clics. Collectez des adresses e-mail, puis proposez vos packs thématiques complets et cahiers KDP en upsell.',
    },
  ],
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Le mode Cocher et Barrer utilise de plus grandes boîtes visuelles contenant chacune 8–20 images mélangées. Mettre plus de 3 sur une seule page rend la fiche encombrée. Gardez 1–2 pour la maternelle et 2–3 pour la grande section. Les modes standards peuvent aller jusqu\'à 8 exercices par page.',
    },
    {
      title: 'Exportez en PDF et en JPEG',
      description: 'Le PDF est idéal pour l\'impression directe, mais le JPEG vous permet de créer des images de maquette pour vos listings de boutique et vos publications sur les réseaux sociaux. Téléchargez les deux formats. Utilisez le JPEG pour les vignettes de produits et les épingles Pinterest, et incluez le PDF comme livrable réel.',
    },
    {
  ...
  visuals: {
    ...
    videoTitle: 'Comment Créer des Fiches de Comparaison Plus ou Moins — Tutoriel Vidéo',
  },
};
