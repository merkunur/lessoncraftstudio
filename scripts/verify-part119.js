/**
 * Part 119 Verification: Finnish Theme+Grade SEO — Themes 17–20
 * Validates seoTitle, seoDescription, seoKeywords for flowers, food, forest, fruits
 */
const fs = require('fs');
const path = require('path');

const BASE = path.join(__dirname, '..', 'frontend', 'content', 'themes');
const themes = ['flowers', 'food', 'forest', 'fruits'];
