...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur Plus ou Moins | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Plus ou Moins professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche plus ou moins avec images colorées à comparer',

    },
    sampleGallery: [
      { src: '/samples/english/more less/More Less 1.jpeg', alt: 'Fiche de comparaison de quantités', caption: 'Comparer des groupes illustrés' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Plus ou Moins thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur Plus ou Moins est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'more-less', pageType: 'tool' as const, anchorText: 'Essayer Générateur Plus ou Moins Gratuit' },
