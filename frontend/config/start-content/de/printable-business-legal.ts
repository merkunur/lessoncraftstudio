...
const content: StartContent = {
  ...
  mainContent: [
    {
      heading: 'Wichtiger Hinweis: Dies ist keine Rechts- oder Steuerberatung',
    ...
    {
      heading: 'Einkommensteuer-Grundlagen für Druckvorlagen-Unternehmer',
      content: 'Einnahmen aus dem Verkauf von Druckvorlagen sind steuerpflichtiges Einkommen. Dies gilt unabhängig davon, ob Sie eine formelle Unternehmensstruktur haben, unabhängig davon, wie gering der Betrag ist, und unabhängig davon, ob die Plattform Ihnen eine Steuerbestätigung sendet. Viele neue Verkäufer sind überrascht zu erfahren, dass selbst ein paar hundert Euro an Druckvorlagenverkäufen eine Steuererklärungspflicht auslösen.\n\nIn Deutschland wird Einkommen aus selbstständiger Tätigkeit im Druckvorlagenverkauf in der Regel über die Einkommensteuererklärung mit der Anlage EÜR (Einnahmenüberschussrechnung) oder bei größeren Unternehmen über die Bilanz erfasst. Dieses Einkommen unterliegt sowohl der Einkommensteuer als auch Gewerbesteuer, wenn die Gewerbesteuerfreibeträge überschritten werden. Die Gewerbesteuerkomponente überrascht viele neue Verkäufer, weil sie zusätzlich zur regulären Einkommensteuer anfällt.\n\nVierteljährliche Steuervorauszahlungen können erforderlich sein, wenn Sie erwarten, bis zum Jahresende eine bestimmte Schwelle zu überschreiten. Anstatt alle Ihre Steuern im Mai zu zahlen, verlangt das Steuersystem generell, dass Sie laufend während des Jahres zahlen. Versäumte Vorauszahlungen können zu Nachzahlungszinsen führen, selbst wenn Sie den vollen Betrag bei der Abgabe bezahlen. Ihr Steuerberater kann Ihnen helfen festzustellen, ob Vorauszahlungen auf Ihre Situation zutreffen und wie viel Sie zurücklegen sollten.\n\nInternationale Verkäufer stehen vor ihren eigenen länderspezifischen Einkommensteuerregeln. Das Grundprinzip ist überall gleich: Geschäftseinkommen ist steuerpflichtig und muss erklärt werden. Die spezifischen Formulare, Sätze, Freibeträge und Abgabefristen variieren je nach Land. Einnahmen von mehreren Plattformen und aus mehreren Ländern müssen möglicherweise konsolidiert und gemäß den Regeln Ihres Heimatlandes gemeldet werden.\n\nDie wichtigste Gewohnheit für die Verwaltung von Einkommensteuerpflichten ist, alle Einnahmen von Anfang an nach Plattform und Monat zu erfassen. Einen Jahresumsatz bei der Steuererklärung zu rekonstruieren ist stressig und fehleranfällig. Eine einfache monatliche Umsatztabelle das ganze Jahr über zu führen macht die Steuererklärung unkompliziert.',
    },
    {
      heading: 'Absetzbare Betriebsausgaben',
      content: 'Betriebsausgaben reduzieren Ihr zu versteuerndes Einkommen, was Ihre Steuerlast verringert. Zu verstehen, welche Ausgaben potenziell absetzbar sind, hilft Ihnen sowohl bei informierten Kaufentscheidungen als auch beim Führen der Aufzeichnungen, die für die ordnungsgemäße Geltendmachung dieser Abzüge erforderlich sind.\n\nSoftware-Abonnements, die für Ihr Druckvorlagen-Geschäft genutzt werden, sind in der Regel absetzbar. Dazu gehören Design-Werkzeuge, Arbeitsblatt-Generatoren, Bildbearbeitungssoftware und alle anderen digitalen Werkzeuge, die Sie zur Erstellung oder Verwaltung Ihrer Produkte verwenden. Die kommerzielle Lizenz für Arbeitsblatt-Generatoren ist eine Betriebsausgabe, die direkt mit der Umsatzgenerierung verbunden ist — besprechen Sie die Absetzbarkeit mit Ihrem Steuerberater.\n\nPlattformgebühren sind eine bedeutende Ausgabenkategorie für Druckvorlagen-Verkäufer. Etsy-Einstellgebühren, Zahlungsabwicklungsgebühren, Kosten für beworbene Angebote und alle anderen Plattformgebühren, die direkt mit dem Verkauf Ihrer Produkte zusammenhängen, sind Betriebsausgaben. Diese Gebühren summieren sich über Hunderte von Transaktionen und können einen bedeutenden Abzug darstellen.\n\nArbeitszimmerkosten können absetzbar sein, wenn Sie einen dedizierten Raum in Ihrem Zuhause ausschließlich und regelmäßig für Ihr Druckvorlagen-Geschäft nutzen. Die Regeln rund um Arbeitszimmerabzüge sind spezifisch und variieren je nach Rechtsordnung. Manche Länder erlauben eine vereinfachte Berechnung basierend auf der Quadratmeterzahl, während andere eine detaillierte Ausgabenverfolgung erfordern. Dies ist ein Bereich, in dem professionelle Beratung besonders wertvoll ist, weil die Regeln streng sind und die Folgen einer falschen Geltendmachung erheblich sein können.\n\nProfessionelle Dienstleistungen — einschließlich Ihres Steuerberaters und Rechtsanwalts — sind absetzbare Betriebsausgaben. Die Kosten für professionelle Steuerberatung sind selbst steuerlich absetzbar, was die effektiven Kosten dieser Beratung reduziert. Fortbildungsmaterialien, die sich auf Ihr Geschäft beziehen, einschließlich Kurse, Bücher und Konferenzgebühren, können ebenfalls als absetzbare Ausgaben qualifizieren.\n\nDie goldene Regel bei Betriebsausgabenabzügen: Bewahren Sie Belege für alles auf. Digitale Belege, die in einem dedizierten Ordner nach Monat sortiert sind, reichen aus. Sie brauchen in den meisten Rechtsordnungen keine Papierbelege, aber Sie brauchen Dokumentation, die zeigt, was gekauft wurde, wann, wie viel es gekostet hat und welchen geschäftlichen Zweck es hatte.',
    },
    {
      heading: 'Geistiges Eigentum: Grundlagen für Druckvorlagen-Verkäufer',
    ...
    {
      heading: 'Internationaler Verkauf und grenzüberschreitende Steuerfragen',
  ...
  actionSteps: [
    ...
    {
      step: 'Eine monatliche Umsatzverfolgungstabelle erstellen',
    ...
    {
      step: 'Die Gewerbeanmeldungspflichten Ihrer Rechtsordnung recherchieren',
      description: 'Prüfen Sie die Anforderungen Ihres Bundeslandes und Ihrer Gemeinde für die Gewerbeanmeldung. Manche Rechtsordnungen verlangen eine Anmeldung auch für Einzelunternehmer. Frühzeitiges Verständnis Ihrer Anmeldepflichten verhindert spätere Compliance-Probleme.',
    },
    {
      step: 'Feststellen, ob Ihre Plattformen die Umsatzsteuererhebung übernehmen',
      description: 'Ermitteln Sie für jede Plattform, auf der Sie verkaufen, ob sie als Marktplatzvermittler für die Steuererhebung in den relevanten Rechtsordnungen fungiert. Dokumentieren Sie, was die Plattform in Ihrem Namen erhebt, und identifizieren Sie Lücken, in denen Sie möglicherweise selbst für die Erhebung und Abführung verantwortlich sind.',
    },
    {
      step: 'Die Nutzungsbedingungen jedes Marktplatzes lesen, den Sie nutzen',
      description: 'Lesen Sie die Nutzungsbedingungen für Etsy, Amazon KDP und jede andere Plattform, auf der Sie verkaufen. Konzentrieren Sie sich auf Abschnitte über digitale Produkte, geistiges Eigentum, Inhaltsrichtlinien und Kontodurchsetzung. Setzen Sie Lesezeichen für diese Abschnitte zur regelmäßigen Überprüfung.',
    },
    {
      step: 'Klare kommerzielle Lizenzbedingungen für Ihre Produkte formulieren',
    ...
    {
      step: 'Einen Prozentsatz des Umsatzes für Steuerpflichten zurücklegen',
      description: 'Legen Sie basierend auf dem Rat Ihres Steuerberaters einen Prozentsatz jedes Monatsumsatzes für Einkommensteuer- und Gewerbesteuerpflichten zurück. Überweisen Sie diesen Betrag monatlich auf ein separates Sparkonto, damit er verfügbar ist, wenn vierteljährliche oder jährliche Zahlungen fällig werden.',
    },
  ],
  ...
  toolsRecommended: [
    {
      appId: 'writing',
      title: 'Schreibübungen-Generator',
      description: 'Erstellung pädagogischer Arbeitsblätter, bei denen die kommerzielle Lizenz die Ausgabe auf allen Marktplätzen legal verkaufbar macht. Die Lizenz ist eine absetzbare Betriebsausgabe, die direkt mit der Umsatzgenerierung Ihres Druckvorlagen-Geschäfts verbunden ist.',
    },
    {
      appId: 'word-search-worksheets',
      title: 'Wortsuche-Generator',
      description: 'Der kommerziell beliebteste Rätseltyp für Druckvorlagen-Verkäufer. Das Verständnis der Lizenzbedingungen ist für Großverkäufer unerlässlich, die Wortsuche-Produkte über mehrere Plattformen und Rechtsordnungen vertreiben.',
    },
    {
      appId: 'math-worksheet',
      title: 'Mathe-Arbeitsblatt-Generator',
      description: 'Zeitloser kommerzieller Produktgenerator. Ein steuerlich absetzbares Geschäftswerkzeug, das unbegrenzt kommerziell lizenzierbare Mathe-Arbeitsblätter für den Vertrieb über Etsy, Amazon KDP und andere Marktplätze produziert.',
    },
    {
      appId: 'crossword-worksheets',
      title: 'Kreuzworträtsel-Generator',
      description: 'Mehrsprachige kommerzielle Produkte in 11 Sprachen. Der Verkauf von Kreuzworträtseln auf internationalen Marktplätzen erfordert das Verständnis der in diesem Leitfaden behandelten grenzüberschreitenden Steuerpflichten.',
    },
    {
      appId: 'coloring-worksheets',
      title: 'Ausmalbilder-Generator',
      description: 'International verkaufbar ohne Übersetzung, was die grenzüberschreitende Compliance vereinfacht, da Ausmalbilder keinen sprachspezifischen Inhalt enthalten. Ideal für Verkäufer, die mit minimaler zusätzlicher steuerlicher Komplexität in internationale Märkte expandieren.',
    },
    {
      appId: 'sudoku-worksheets',
      title: 'Sudoku-Generator',
      description: 'Rein zahlenbasierte Produkte, die plattformunabhängig und sprachunabhängig sind. Vereinfacht die Compliance-Verfolgung auf mehreren Plattformen, da identische Produkte ohne Anpassung auf jedem Marktplatz vertrieben werden können.',
    },
  ],

  faq: [
    {
      question: 'Muss ich mein Druckvorlagen-Geschäft registrieren, bevor ich anfange zu verkaufen?',
      answer: 'Die Registrierungspflichten variieren je nach Rechtsordnung. In Deutschland ist in der Regel eine Gewerbeanmeldung erforderlich, bevor Sie gewerblich tätig werden. Manche Gemeinden haben zusätzliche Anforderungen. Die Kleinunternehmerregelung kann für Unternehmer unter bestimmten Umsatzschwellen gelten. Prüfen Sie die Anforderungen Ihres Gewerbeamts und Finanzamts, bevor oder kurz nachdem Sie mit dem Verkauf beginnen. Ein Steuerberater oder Ihre örtliche IHK kann die spezifischen Anforderungen für Ihren Standort klären.',
    },
    {
      question: 'Muss ich Umsatzsteuer auf meine herunterladbaren Arbeitsblätter erheben?',
      answer: 'Ob Sie Umsatzsteuer auf digitale Downloads erheben müssen, hängt von Ihrem Standort und den Standorten Ihrer Käufer ab. In der EU unterliegen digitale Produkte der Mehrwertsteuer. Viele Verkaufsplattformen fungieren als Marktplatzvermittler und erheben die Umsatzsteuer in Ihrem Namen in den geltenden Rechtsordnungen. Für Verkäufe außerhalb der Marktplatzvermittler-Abdeckung konsultieren Sie einen Steuerberater bezüglich Ihrer Erhebungs- und Abführungspflichten.',
    },
    {
      question: 'Welche Betriebsausgaben kann ich als Druckvorlagen-Verkäufer absetzen?',
      answer: 'Häufig potenziell absetzbare Ausgaben umfassen Software-Abonnements, Arbeitsblatt-Generator-Lizenzen, Plattformgebühren, Zahlungsabwicklungsgebühren, Arbeitszimmerkosten falls zutreffend, professionelle Dienstleistungen wie Steuerberatung und Rechtsberatung, geschäftsbezogene Fortbildungsmaterialien und Computerausrüstung. Die Absetzbarkeit hängt jedoch von Ihrer spezifischen steuerlichen Situation und Rechtsordnung ab. Bewahren Sie Belege für alle Geschäftsausgaben auf und besprechen Sie Abzüge mit Ihrem Steuerberater.',
    },
    {
      question: 'Kann jemand meine Arbeitsblatt-Designs legal kopieren?',
      answer: 'Das Urheberrecht schützt Ihren spezifischen kreativen Ausdruck, aber nicht die zugrunde liegenden Ideen, Fakten oder gängigen Layouts. Jemand kann Ihr exaktes Arbeitsblatt-Design nicht legal kopieren, aber er kann ein eigenes Arbeitsblatt zum selben Thema in einem ähnlichen Format erstellen. Das Konzept eines Additionsarbeitsblattes ist nicht urheberrechtlich schützbar, aber Ihr besonderes Design, Ihre Themenimplementierung und visuelle Anordnung sind geschützt. Für Durchsetzungsfragen konsultieren Sie einen Anwalt für geistiges Eigentum.',
    },
    {
      question: 'Muss ich mir Sorgen um internationale Steuern machen, wenn ich auf Etsy oder Amazon verkaufe?',
      answer: 'Wenn Sie an Käufer in anderen Ländern verkaufen, können grenzüberschreitende Steuerregeln gelten. Viele Plattformen übernehmen die internationale Steuererhebung als Marktplatzvermittler, aber nicht alle Situationen sind abgedeckt. Die EU hat Mehrwertsteueranforderungen für digitale Produkte, Australien hat GST-Regeln, und andere Länder haben eigene Rahmenwerke. Wenn Ihr internationaler Umsatz mehr als geringfügig ist, ist eine Beratung mit einem Steuerberater, der Erfahrung mit grenzüberschreitendem Verkauf digitaler Produkte hat, eine lohnende absetzbare Investition.',
    },
    {
      question: 'Wann sollte ich vom Einzelunternehmen zur GmbH wechseln?',
      answer: 'Der richtige Zeitpunkt für die Gründung einer GmbH oder UG hängt von Ihrem Umsatzniveau, Ihrer Risikobereitschaft, den Gründungskosten in Ihrer Rechtsordnung und Ihrer persönlichen finanziellen Situation ab. Häufige Auslöser sind das Erreichen eines konstanten Umsatzes, der die Verwaltungskosten rechtfertigt, der Wunsch nach Haftungsschutz für das Privatvermögen, oder die Empfehlung eines Steuerberaters zur Strukturänderung aus Steuerplanungsgründen. Besprechen Sie den Zeitpunkt sowohl mit einem Steuerberater als auch mit einem Anwalt, die Ihre spezifischen Umstände bewerten können.',
    },
    {
      question: 'Wie lange muss ich meine geschäftlichen Finanzunterlagen aufbewahren?',
      answer: 'Die Aufbewahrungsfristen variieren je nach Rechtsordnung, betragen in Deutschland aber in der Regel zehn Jahre für Buchführungsunterlagen und sechs Jahre für sonstige steuerlich relevante Unterlagen, jeweils ab Ende des Kalenderjahres der letzten Eintragung. Digitale Unterlagen, die sicher in Cloud-Speicher mit Backups aufbewahrt werden, erfüllen die Aufbewahrungspflichten in den meisten Rechtsordnungen und sind tatsächlich zuverlässiger als Papierunterlagen, die verloren gehen oder beschädigt werden können. Im Zweifelsfall bewahren Sie Unterlagen länger auf als kürzer.',
    },
    {
