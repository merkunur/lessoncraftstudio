...
const content: EnrichedThemeContent = {
  ...
  gradeContent: {
    ...
    'second-grade': {
      ...
      snippetAnswer: 'Kevätaiheiset työlehdet toiselle luokalle (7–8-vuotiaat) syventävät pitkittäishavaintojen kirjaamista ja analysointia kevään merkkien seurannassa, kehittävät tilastollista ajattelua mittausdatan esittämisellä pylväsdiagrammein sekä vahvistavat tietotekstin kirjoittamista kevään luonnonilmiöiden raportoinnissa. POPS 2014:n ympäristöopin ja matematiikan vuosiluokkien 1–2 päättötavoitteet toteutuvat.',
      uniqueGradeAngle: 'Toisella luokalla kevätteema kehittyy ensimmäisen luokan havainnoinnista järjestelmälliseksi luonnontieteelliseksi tutkimusprojektiksi, koska seitsemän- ja kahdeksanvuotiaat osaavat kirjata pitkittäishavaintoja taulukoihin ja esittää dataa visuaalisesti. POPS 2014:n päättötavoitteet edellyttävät, että oppilas tutkii luontoa havainnoimalla ja dokumentoi tulokset. Toisen luokan oppilas seuraa kevään merkkejä järjestelmällisesti: päivän pituuden muutos minuuteissa, lämpötilan nousu viikottain, ensimmäisten kukkien ilmestyminen, muuttolintujen saapuminen. Data kirjataan taulukkoon ja esitetään pylväsdiagrammina: lämpötila viikoittain. Syy-seuraussuhteiden analyysi syventyy: miksi lumi sulaa ensin etelärinteiltä, miksi muuttolinnut saapuvat tiettyyn aikaan, miten päivän pituus vaikuttaa kasvien kasvuun. Tietotekstin kirjoittaminen kehittyy: oppilas kirjoittaa raportin kevään luonnonilmiöistä usealla kappaleella. Suomen ainutlaatuinen kevät — lumen sulaminen, jäiden lähtö, yIöttömän yön lähestyminen — tarjoaa vertaansa vailla olevan tutkimuskontekstin.',
      developmentalMilestones: [
        { milestone: 'Pitkittäishavaintojen järjestelmällinen kirjaaminen (7–8-vuotiaat seuraavat kevään muutoksia viikoittain)', howWeAddress: 'Kevään seurantatehtävät, joissa oppilas kirjaa lämpötilan, päivän pituuden ja luontohavainnot taulukkoon viikoittain useamman viikon ajan, kehittävät pitkittäisen tutkimuksen taitoja' },
        { milestone: 'Datan esittäminen pylväsdiagrammina (toisen luokan oppilaat visualisoivat mittausdataa)', howWeAddress: 'Diagrammitehtävät, joissa oppilas piirtää pylväsdiagrammin lämpötiladatasta ja tulkitsee sen trendejä, kehittävät tilastollista ajattelua ja datan visualisointia' },
        { milestone: 'Syy-seuraussuhteiden analysointi luonnossa (seitsemän- ja kahdeksanvuotiaat perustelevat luonnonilmiöitä)', howWeAddress: 'Pohdintatehtävät, joissa oppilas selittää miksi lumi sulaa etelärinteiltä ensin ja miten päivän pituus vaikuttaa kasveihin, kehittävät tieteellistä päättelytaitoa' },
        { milestone: 'Tietotekstin kirjoittaminen luonnonilmiöistä (toisen luokan oppilaat tuottavat jäsennellyn raportin)', howWeAddress: 'Raporttikirjoitustehtävät, joissa oppilas kirjoittaa tietotekstin kevään ilmiöistä usealla kappaleella sisältäen johdannon, havainnot ja johtopäätöksen, kehittävät tietotekstin kirjoittamista' },
      ],
      differentiationNotes: 'Tukea tarvitseville toisen luokan oppilaille rajaa seuranta kahteen muuttujaan (lämpötila ja yksi havainto), anna diagrammin piirtämiseen valmiit akselit ja tarjoa raporttikirjoitukseen lausepohjat. Edistyneille toisen luokan oppilaille laajenna seuranta viidelle muuttujalle, lisää viivadiagrammi pylväsdiagrammin rinnalle ja haasta kirjoittamaan vertaileva raportti kahdesta kevään ilmiöstä.',
      parentTakeaway: 'Toisen luokan kevättyölehdet tekevät vuodenajan vaihtumisesta tieteellisen tutkimusprojektin. Mittatkaa yhdessä lämpötila joka aamu ja kirjatkaa taulukkoon. Piirtäkää pylväsdiagrammi viikon lämpötiloista ja pohtikaa: milloin oli lämpimintä, miksi? Seuratkaa kevään merkkejä: koska ensimmäinen pääskynen saapui, koska leskenlehti kukki? Tärkeintä on opettaa, että luontoa voi tutkia järjestelmällisesti ja data kertoo tarinoita.',
      classroomIntegration: 'Kevätteema on toisen luokan ympäristöopin pitkäkestoinen tutkimusprojekti: viikoittainen havainnointi, datan kerääminen taulukkoon, pylväsdiagrammin piirtäminen matematiikassa, tietotekstin kirjoittaminen äidinkielessä ja kevättaiteen tekeminen kuvataiteessa. POPS 2014:n vuosiluokkien 1–2 päättöarvioinnissa kevätteema osoittaa tutkivan oppimisen, datan käsittelyn ja tieteellisen raportoinnin taidot.',
      assessmentRubric: [
        { skill: 'Pitkittäishavaintojen kirjaaminen', emerging: 'kirjaa yhden havainnon kerrallaan mutta ei ylläpidä taulukkoa säännöllisesti', proficient: 'kirjaa usean muuttujan taulukkoon viikoittain ja havaitsee muutostrendejä', advanced: 'ylläpitää monipuolista havaintopäiväkirjaa, analysoi trendejä ja ennustaa tulevia muutoksia' },
        { skill: 'Datan visualisointi diagrammina', emerging: 'piirtää pylväitä mutta akselit eivät ole johdonmukaiset', proficient: 'piirtää selkeän pylväsdiagrammin oikeilla akseleilla ja tulkitsee trendejä', advanced: 'piirtää useamman tyyppisiä diagrammeja, vertailee niitä ja tekee dataperustteisia johtopäätöksiä' },
        { skill: 'Tietotekstin kirjoittaminen', emerging: 'luettelee faktoja ilman jäsenneltyä rakennetta', proficient: 'kirjoittaa jäsennellyn tietotekstin johdannolla, havainnoilla ja johtopäätöksellä', advanced: 'kirjoittaa monipuolisen raportin useasta lähteestä, sisältäen omia pohdintoja ja jatkotutkimusehdotuksia' },
      ],
    },
    'third-grade': {
      ...
      snippetAnswer: 'Kevätaiheiset työlehdet kolmannelle luokalle (8–9-vuotiaat) kehittävät kevään ekosysteemimuutosten tieteellistä tutkimista fenologisten havaintojen järjestelmällisellä seurannalla, vahvistavat data-analyysiä pitkäkestoisen lämpötila- ja valodatan tilastollisella käsittelyllä sekä opettavat tieteellisen tutkimusraportin kirjoittamista kevään muutoksista usean lähteen pohjalta. POPS 2014:n vuosiluokkien 3–6 ympäristöopin tavoitteet käynnistyvät.',
      uniqueGradeAngle: 'Kolmannella luokalla kevätteema siirtyy kevään merkkien havainnoimisesta ekosysteemimuutosten tieteelliseen tutkimiseen, kun kahdeksan- ja yhdeksänvuotiaat kykenevät järjestelmälliseen datan keruuseen ja kausaaliseen päättelyyn. Fenologinen seuranta kehittyy tieteelliseksi tutkimukseksi: oppilas dokumentoi kasvien heRäämisen, lintujen paluun ja hyönteisten ilmestymisen päivämäärineen ja olosuhteineen. Data-analyysi syventyy: lämpötilakeskiarvot viikottain kertolaskulla ja jakolaskulla, valojakson piteneminen ja vertailu edellisvuoteen. Kevään ekosysteemimuutosten kausaalinen selittäminen: miksi muuttolinnut palaavat tiettyyn aikaan, miten lämpötila vaikuttaa itämiseen ja miten ravintoketjut aktivoituvat. Tutkimusraportti yhdistää kenttähavainnot ja kirjalliset lähteet. Ilmastonmuutoksen vaikutus kevään ajoitukseen tarjoaa ajankohtaisen tutkimusteeman. Suomen kevään erityispiirteet (jäiden lähtö, tulvat, valkoinen yö) tarjoavat ainutlaatuisen kontekstin.',
      developmentalMilestones: [
        { milestone: 'Fenologisten havaintojen järjestelmällinen seuranta (8–9-vuotiaat dokumentoivat kevään muutoksia tieteellisesti)', howWeAddress: 'Fenologiaprojektit, joissa oppilas seuraa kasvien heräämistä, lintujen paluuta ja hyönteisten ilmestymistä päivämäärineen, piirtää aikajanakuvauksen ja kirjoittaa havaintoraportit' },
        { milestone: 'Pitkäkestoisen lämpötila- ja valodatan tilastollinen analysointi (kolmannen luokan oppilaat laskevat keskiarvoja)', howWeAddress: 'Data-analyysiprojektit, joissa oppilas kokoaa viikottaiset lämpötila- ja valotiedot, laskee keskiarvoja kertolaskulla ja jakolaskulla ja piirtää vertailudiagrammeja' },
        { milestone: 'Ekosysteemimuutosten kausaalinen selittäminen (kahdeksan- ja yhdeksänvuotiaat ymmärtävät syy-seuraussuhteita)', howWeAddress: 'Kausaaliteettiprojektit, joissa oppilas selittää miksi muuttolinnut palaavat, miten lämpötila vaikuttaa itämiseen ja miten ravintoketjut aktivoituvat, perustaen selityksen dataan' },
        { milestone: 'Tieteellisen tutkimusraportin kirjoittaminen kevään muutoksista (kolmannen luokan oppilaat yhdistävät havainnot ja lähteet)', howWeAddress: 'Raporttiprojektit, joissa oppilas yhdistää omat kenttähavaintonsa kirjallisten lähteiden tietoon ja kirjoittaa monikappaleraportin johtopäätöksineen ja lähdeviitteineen' },
      ],
      differentiationNotes: 'Tukea tarvitseville kolmannen luokan oppilaille rajaa fenologinen seuranta kolmeen lajiin valmiilla seurantalomakkeella, anna data-analyysisssä valmiit taulukkopohjat ja tarjoa raporttiin rakennepohja. Edistyneille kolmannen luokan oppilaille laajenna seuranta kymmeneen lajiin vertaillen edellisvuoteen, lisää ilmastonmuutoksen pitkIäaikaisanalyysi ja haasta suunnittelemaan kokonainen kevään ekosysteemitutkimus julkaisukelpoisine raportteineen.',
      parentTakeaway: 'Kolmannen luokan kevättyölehdet kehittävät tieteellistä ajattelua ja datan käsittelyä. Seuratkaa yhdessä kevään merkkejä: kirjatkaa päivämäärä, milloin ensimmäinen leskenlehti kukkii, milloin pääskynen palaa. Mittatkaa viikottain lämpötila ja laskekaa keskiarvo. Tutkikaa: ovatko kevään merkit aikaisemmin kuin viime vuonna ja miksi? Tärkeintä on oppia keRäämään dataa järjestelmällisesti ja tekemIään johtopäätöksiä.',
      classroomIntegration: 'Kevättyölehdet integroituvat kolmannen luokan ympäristöoppiin, matematiikkaan ja äidinkieleen: fenologinen seuranta biologian jaksossa, data-analyysi matematiikan tilastojaksossa, ekosysteemimuutosten selittäminen luonnontieteessä ja tutkimusraportit tietokirjoittamisen jaksossa. POPS 2014:n vuosiluokkien 3–6 tutkivan oppimisen, datan käsittelyn ja tieteellisen kirjoittamisen tavoitteet toteutuvat.',
      assessmentRubric: [
        { skill: 'Fenologisten havaintojen järjestelmällinen seuranta', emerging: 'havaitsee kevään merkkejä mutta ei dokumentoi järjestelmällisesti', proficient: 'seuraa useita lajeja päivämäärineen, piirtää aikajanan ja kirjoittaa havaintoraportit', advanced: 'suunnittelee laajan seurantatutkimuksen, vertailee edellisvuoteen ja tekee perusteltuja ennusteita' },
        { skill: 'Pitkäkestoisen datan tilastollinen analysointi', emerging: 'kerää dataa mutta ei laske keskiarvoja eikä piirrIä diagrammeja', proficient: 'laskee viikottaiset keskiarvot, piirtää vertailudiagrammeja ja tulkitsee trendejä', advanced: 'analysoi dataa monipuolisesti, tunnistaa poikkeamia ja selittää syitä perustellusti tieteellisesti' },
        { skill: 'Tieteellinen tutkimusraportti kevään muutoksista', emerging: 'kertoo havainnoistaan ilman jäsenneltyä raporttia', proficient: 'kirjoittaa monikappaleraportin yhdistäen havainnot ja lähteet johtopäätöksineen', advanced: 'kirjoittaa analyyttisen tutkimusraportin, arvioi lähteitä kriittisesti ja esittää omia tutkimuskysymyksiä' },
      ],
    },
  },
