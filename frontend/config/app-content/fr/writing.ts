...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Fiches d\'Écriture | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Fiches d\'Écriture professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche d\'écriture avec lignes guidées et modèles de lettres',

    },
    sampleGallery: [
      { src: '/samples/english/writing/Writing 1.jpeg', alt: 'Fiche d\'écriture guidée', caption: 'Écriture guidée' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Fiches d\'Écriture thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Fiches d\'Écriture est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'writing', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Fiches d\'Écriture Gratuit' },
