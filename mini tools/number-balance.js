...
var NumberBalance = {
  ...
  strings: {
    title:        { en: 'Number Balance' },
    instruction:  { en: 'Put numbers in the pans. The beam is level only when both sides are worth the same.' },
    trayLabel:    { en: 'Numbers' },
    panLeft:      { en: 'Left pan' },
    panRight:     { en: 'Right pan' },
    hold:         { en: 'Hold the beam' },
    letGo:        { en: 'Let go' },
    heldNote:     { en: 'The beam is held. Which way will it go?' },
    coverLeft:    { en: 'Cover the left pan' },
    coverRight:   { en: 'Cover the right pan' },
    uncover:      { en: 'Take the cloth off' },
    coveredNote:  { en: 'What must be under the cloth to make it level?' },
    showTotals:   { en: 'Show what each pan is worth' },
    showNotation: { en: 'Write what the beam is doing' },
    clearPans:    { en: 'Empty the pans' },
    sayIt:        { en: 'Say it out loud' },
    andWord:      { en: 'and' },
    equalsFrame:  { en: '{left} is equal to {right}' },
    heavierFrame: { en: '{heavy} is more than {light}' },
    emptyPan:     { en: 'nothing' },
    gateBig:      { en: 'Numbers past ten are part of the Teacher plan.' },
    gatePrint:    { en: 'Printing is part of the Teacher plan.' },
    printBtn:     { en: 'Print the balance' },
    unlock:       { en: 'See the Teacher plan' },
    privacyLine:  { en: 'Nothing here is saved, counted or sent anywhere.' },
    setSpeak:     { en: 'Say the number when a tile is placed' }
  },
