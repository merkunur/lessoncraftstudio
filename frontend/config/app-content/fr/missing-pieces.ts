...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur de Pièces Manquantes | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Pièces Manquantes professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Puzzle pièces manquantes avec images à compléter',

    },
    sampleGallery: [
      { src: '/samples/english/missing pieces/Missing Pieces 1.jpeg', alt: 'Trouver la pièce manquante', caption: 'Pièce manquante' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Pièces Manquantes thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur de Pièces Manquantes est-il vraiment gratuit ?',
  ...
  internalLinks: [
    { slug: 'odd-one-out', pageType: 'app' as const, anchorText: 'Générateur de l\'Intrus' },
    { slug: 'sudoku', pageType: 'app' as const, anchorText: 'Générateur de Sudoku pour Enfants' },
    { slug: 'picture-path', pageType: 'app' as const, anchorText: 'Générateur de Chemin d\'Images' },
    { slug: 'missing-pieces', pageType: 'tool' as const, anchorText: 'Essayer Générateur de Pièces Manquantes Gratuit' },
    { slug: 'puzzle-bundle', pageType: 'bundle' as const, anchorText: 'Pack Puzzles et Logique Complet' }
  ],
};
