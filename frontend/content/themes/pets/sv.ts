...
const content: EnrichedThemeContent = {
  ...
  description: 'Utskrivbara husdjur-övningar för barn. Matematik, målarbilder, ordspel och pussel med husdjurtema. Förskola till årskurs 3. Gratis PDF. Skriv ut direkt.',
  ...
  gradeContent: {
    'preschool': {
      ...
      seoKeywords: 'husdjurövningar förskola, finmotorikövning, färgläggning och spårning, storlekssortering, enkel räkning, djurskötsel, ansvar, husdjursarter, husdjuruppgifter förskola, husdjurs lärande 3–4 år',
    ...
    'kindergarten': {
      ...
      seoDescription: 'Utskrivbara husdjursövningar för förskoleklassbarn (5–6 år). Räkning, ansvar och ordpussel med husdjurstema. 33 generatorer. Gratis PDF. Skriv ut direkt.',
      seoKeywords: 'husdjurövningar förskoleklass, begynnelsebokstäver, bokstavsövningar, räkning till 20, mönsterigenkänning, djurskötsel, ansvar, husdjursarter, husdjuruppgifter förskoleklass, husdjurs lärande 5–6 år',
    ...
    'first-grade': {
      ...
      seoKeywords: 'husdjurövningar årskurs 1, addition subtraktion, syntetisk läsning, självständig skrivning, meningsbyggnad, djurskötsel, ansvar, husdjursarter, husdjuruppgifter årskurs 1, husdjurs lärande 6–7 år',
    ...
    'second-grade': {
      ...
      seoKeywords: 'husdjurövningar årskurs 2, multiplikationsövningar, dataanalys barn, faktatexter läsning, positionssystem förståelse, djurskötsel, ansvar, husdjursarter, husdjuruppgifter årskurs 2, husdjurs lärande 7–8 år',
    ...
    'third-grade': {
      ...
      seoDescription: 'Utskrivbara husdjur-övningar för årskurs 3 (8–9 år). Flerstegsuppgifter, korsord, kryptogram och avancerade övningar. 33 generatorer. Gratis PDF. Gratis.',
      seoKeywords: 'husdjurövningar årskurs 3, multiplikation division, bråk introduktion, forskningsrapport, kritiskt tänkande, djurskötsel, ansvar, husdjursarter, husdjuruppgifter årskurs 3, husdjurs lärande 8–9 år',
