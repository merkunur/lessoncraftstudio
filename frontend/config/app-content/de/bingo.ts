...
const content: AppContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Ja. Mit einer kommerziellen Lizenz haben Sie volle Rechte, Ihre Bingo-Karten als digitale Downloads auf Etsy.de, als gedruckte Aktivitätsbücher auf Amazon KDP, als Unterrichtsmaterialien auf dem Lehrermarktplatz oder über jeden anderen Vertriebskanal zu verkaufen. Die konfigurierbaren Rastergrößen, Stapel-Generierung, ZIP-Export, dualen Füllmodi, Ansageblätter und 104 thematische Bildsammlungen geben Ihnen die kreativen Werkzeuge, um originale, verkaufsfertige Bingo-Produkte im großen Maßstab zu produzieren.',
    },
    {
