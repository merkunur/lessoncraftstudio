...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare frukt-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med frukttema. Førskole til 3. klasse. Gratis PDF. Ingen registrering.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Frukt-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare frukt-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'fruktoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, fruktgjenkjenning, vitaminer, sunt mellommåltid, fruktøvelser førskole, frukters læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Frukt-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare frukt-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'fruktoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, fruktgjenkjenning, vitaminer, sunt mellommåltid, fruktøvelser barnehage, frukters læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Frukt-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare frukt-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Velg tema og last ned gratis PDF.',
      seoKeywords: 'fruktoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, fruktgjenkjenning, vitaminer, sunt mellommåltid, fruktøvelser 1. klasse, frukters læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Frukt-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare frukt-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. 3 000+ tematiske bilder.',
      seoKeywords: 'fruktoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, fruktgjenkjenning, vitaminer, sunt mellommåltid, fruktøvelser 2. klasse, frukters læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Frukt-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare frukt-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'fruktoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, fruktgjenkjenning, vitaminer, sunt mellommåltid, fruktøvelser 3. klasse, frukters læring 8-9 år',
