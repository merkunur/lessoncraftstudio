...
const translations = {
  ...
  "it": {
    "app.title": "Creatore di Schede per Addizioni Illustrate",
  ...
  "pt": {
    ...
    "pleaseGenerateContentFirst": "Por favor, crie o conteúdo antes de descarregar.",
    "jpegError": "Erro JPEG: {}",
    "pdfError": "Erro PDF: {}",
  ...
  "sv": {
    ...
    "lang_no": "Norska",
    "lang_fi": "Finska",
    "pageSetup": "Sidinställningar", // Changed from "Sidkonfiguration"
    "pageSize": "Sidstorlek:",
  ...
  "da": {
    ...
    "borderOpacity": "Rammedekning:", // Changed from "Rammegennemsigtighed:"
  ...
  "no": {
    ...
    "pleaseGenerateContentFirst": "Opprett innholdet før nedlasting.",
    "jpegError": "JPEG-feil: {}",
    "pdfError": "PDF-feil: {}",
    "searching": "Søker...",
