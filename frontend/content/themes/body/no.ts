...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare kropp-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med kropptema. Førskole til 3. klasse. Gratis PDF. Ingen registrering.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Kroppen-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare kroppen-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'kroppsoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, kroppsdeler gjenkjenning, helseundervisning, anatomi, kroppsøvelser førskole, kroppens læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Kroppen-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare kroppen-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Ingen registrering.',
      seoKeywords: 'kroppsoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, kroppsdeler gjenkjenning, helseundervisning, anatomi, kroppsøvelser barnehage, kroppens læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Kroppen-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare kroppen-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. Ingen registrering nødvendig.',
      seoKeywords: 'kroppsoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, kroppsdeler gjenkjenning, helseundervisning, anatomi, kroppsøvelser 1. klasse, kroppens læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Kroppen-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare kroppen-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'kroppsoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, kroppsdeler gjenkjenning, helseundervisning, anatomi, kroppsøvelser 2. klasse, kroppens læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Kroppen-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare kroppen-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF. Hent nå.',
      seoKeywords: 'kroppsoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, kroppsdeler gjenkjenning, helseundervisning, anatomi, kroppsøvelser 3. klasse, kroppens læring 8-9 år',
