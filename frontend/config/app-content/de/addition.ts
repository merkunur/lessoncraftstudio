...
const content: AppContent = {
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Wechseln Sie zum L\u00f6sungsschl\u00fcssel-Tab und klicken Sie auf L\u00f6sungsschl\u00fcssel generieren, um automatisch eine ausgef\u00fcllte Version Ihres Arbeitsblatts zu erstellen. \u00d6ffnen Sie dann das Download-Men\u00fc und exportieren Sie sowohl das Arbeitsblatt als auch den L\u00f6sungsschl\u00fcssel als hochaufl\u00f6sendes JPEG oder druckfertiges PDF. Jeder Export wird mit \u00fcber 400 DPI gerendert, sodass Ihre Arbeitsbl\u00e4tter gestochen scharf aussehen \u2014 ob zu Hause gedruckt, an eine Druckerei gesendet oder als digitales Produkt auf Etsy oder Amazon KDP hochgeladen.',
      },
    ],
  },

  keyFeatures: {
    title: 'Hauptfunktionen des Additions-Arbeitsblatt-Generators',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Laden Sie Arbeitsbl\u00e4tter und L\u00f6sungsschl\u00fcssel als hochaufl\u00f6sende JPEG-Bilder oder mehrseitige PDF-Dokumente herunter. Die Export-Engine rendert mit einem 6-fach-Multiplikator und erzeugt \u00fcber 400 DPI bei Standardseitengr\u00f6\u00dfen. Das garantiert gestochen scharfe Linien und Texte \u2014 ob auf einem Heimdrucker, bei einer Druckerei oder als digitales Produkt auf Online-Marktpl\u00e4tzen. Letter, A4, Quadrat und benutzerdefinierte Gr\u00f6\u00dfen werden unterst\u00fctzt.',
      },
      {
        title: 'Eigene Bilder hochladen',
        description:
          'Gehen Sie \u00fcber die integrierte Bibliothek hinaus und laden Sie eigene PNG- oder JPEG-Bilder direkt in die App hoch. Ideal f\u00fcr Marken-Arbeitsbl\u00e4tter, eigene Cliparts, Klassenmaskottchen oder saisonale Inhalte, die Ihre Druckvorlagen von der Konkurrenz abheben. Hochgeladene Bilder integrieren sich nahtlos in jeden \u00dcbungsmodus, sodass Sie die volle kreative Kontrolle behalten.',
      },
      {
  ...
  businessUseCases: {
    title: 'Additions-Arbeitsbl\u00e4tter online verkaufen',
    cases: [
      {
      ...
      },
      {
        ...
        description:
          'Stellen Sie 50\u2013100 Additions-Arbeitsbl\u00e4tter zu einem gedruckten Aktivit\u00e4tsbuch im Amazon-KDP-Format zusammen. Nutzen Sie progressive Schwierigkeit \u2014 beginnen Sie mit dem Bild + Bild-Modus bei niedrigen Zahlenbereichen und steigern Sie sich zum Gemischten Modus nahe 10 \u2014 f\u00fcr einen strukturierten Lernpfad. F\u00fcgen Sie ein Titelblatt, Anleitungen und einen L\u00f6sungsteil am Ende hinzu. KDP-Mathe-Aktivit\u00e4tsb\u00fccher f\u00fcr Kinder von 3\u20137 Jahren verkaufen sich das ganze Jahr \u00fcber konstant mit minimalem Werbebudget.',
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Additions-Arbeitsblatt-Ersteller',
    },
    {
      pageType: 'guide',
  ...
  visuals: {
    ...
    videoTitle: 'Bildbasierte Additions-Arbeitsbl\u00e4tter erstellen \u2014 Schritt-f\u00fcr-Schritt-Anleitung',
  },
};
