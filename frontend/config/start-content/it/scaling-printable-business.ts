...
const content: StartContent = {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Scalata indipendente dalla piattaforma — prodotti sudoku identici funzionano su Etsy, Amazon KDP, Gumroad e ogni marketplace internazionale senza adattamento di formato. I puzzle puramente numerici superano ogni barriera linguistica.',
    },
    {
  ...
  visuals: {
    heroImage: { src: '/samples/italian/draw%20and%20color/disegna-e-colora-1.webp', alt: 'Scheda disegno e colore che dimostra la gamma creativa per scalare un\'­attività di stampabili' },
    samples: [
      { src: '/samples/italian/draw%20and%20color/disegna-e-colora-1.webp', alt: 'Scheda disegno e colore che mostra la varietà dei temi per l\'­espansione del catalogo', caption: 'Disegno e Colore — Gamma Creativa per la Profondità del Catalogo' },
