...
const content: BlogContent = {
  ...
  hero: {
    title: '11 langues pour vendre vos imprimables mondialement',
    tagline: 'Chaque langue ouvre un nouveau marché',
    description: 'Vendez vos imprimables en 11 langues pour toucher le monde entier. Stratégie multilingue complète. Suivez ce guide pas à pas pour créer des imprimables professionnels qui se vendent. Des techniques concrètes et des exemples adaptés au marché français.',
  },
  category: 'how-to',
  introduction: 'Ce tutoriel vous guide étape par étape pour 11 langues vendre mondialement imprimables. Chaque étape est accompagnée de conseils pratiques et d\'exemples concrets adaptés au marché français des imprimables éducatifs.',
  sections: [
    {
