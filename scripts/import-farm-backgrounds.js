 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-farm-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'farm_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/farm',
  displayNames: {
    en: 'Farm',
    de: 'Bauernhof',
    fr: 'Ferme',
...
const IMAGE_TRANSLATIONS = {
  ...
  'background landscape 026': {
    en: 'Landscape Background 6',
    de: 'Querformat Hintergrund 6',
    fr: 'Arrière-plan paysage 6',
    es: 'Fondo horizontal 6',
    it: 'Sfondo orizzontale 6',
    pt: 'Fundo paisagem 6',
    nl: 'Liggend achtergrond 6',
    sv: 'Liggande bakgrund 6',
    da: 'Landskabsbaggrund 6',
    no: 'Liggende bakgrunn 6',
    fi: 'Vaakasuuntainen tausta 6'
  },
  'background portrait 022': {
  ...
  'background portrait 027': {
    en: 'Portrait Background 6',
    de: 'Hochformat Hintergrund 6',
    fr: 'Arrière-plan portrait 6',
    es: 'Fondo vertical 6',
    it: 'Sfondo verticale 6',
    pt: 'Fundo retrato 6',
    nl: 'Staand achtergrond 6',
    sv: 'Stående bakgrund 6',
    da: 'Portrætbaggrund 6',
    no: 'Stående bakgrunn 6',
    fi: 'Pystysuuntainen tausta 6'
  }
};
