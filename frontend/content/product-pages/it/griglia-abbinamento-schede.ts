...
/**
 * Grid Match Worksheets - Italian Content (Griglia Abbinamento)
 *
 * File: frontend/content/product-pages/it/griglia-abbinamento-schede.ts
 * URL: /it/apps/griglia-abbinamento-schede
 *
...
export default gridMatchItContent;
