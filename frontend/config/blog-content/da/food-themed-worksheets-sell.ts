...
Start med LessonCraftStudios gratis prøveversion med vandmærke og test alle funktioner, før du investerer i en kommerciel licens.' }
  ...
  internalLinks: [
    { pageType: 'app', slug: 'farvelaegning-arbejdsark', anchorText: 'Mad Farvelægning' },
    { pageType: 'app', slug: 'matchning-arbejdsark', anchorText: 'Mad Matchning' },
    { pageType: 'app', slug: 'ordsoegning-arbejdsark', anchorText: 'Mad Ordsøgning' },
  ],
  relatedPosts: [
