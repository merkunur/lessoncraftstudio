...
const content: StartContent = {
  ...
  toolsRecommended: [
    ...
    },
    {
      ...
      description: 'Évolutivité pérenne grâce aux niveaux de difficulté configurables. Un seul générateur produit des centaines de produits de maths uniques couvrant les opérations, niveaux et formats — la définition même de l\'expansion du catalogue en profondeur.',
    },
    {
    ...
    },
    {
      ...
      description: 'Croissance agnostique des plateformes — des produits de sudoku identiques fonctionnent sur Etsy, Amazon KDP, Gumroad et chaque marketplace internationale sans adaptation de format. Les puzzles purement numériques franchissent toutes les barrières linguistiques.',
    },
    {
  ...
  visuals: {
    heroImage: { src: '/samples/french/draw%20and%20color/dessine-et-colorie-1.webp', alt: 'Fiche de dessin et coloriage démontrant l\'étendue créative pour la croissance d\'une activité d\'imprimables' },
    samples: [
      { src: '/samples/french/draw%20and%20color/dessine-et-colorie-1.webp', alt: 'Fiche de dessin et coloriage montrant la variété des thèmes pour l\'expansion du catalogue', caption: 'Dessin et coloriage — Étendue créative pour la profondeur du catalogue' },
