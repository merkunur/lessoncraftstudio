  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Define el uso de mayúsculas para cada fila: mayúsculas, minúsculas o tipo título. Para las filas en Texto Personalizado, activa los ejercicios de trazos de pre-escritura — líneas verticales, líneas horizontales, círculos o líneas en zigzag — para añadir calentamientos de motricidad fina antes de la práctica de letras. Ajusta la altura de fila para controlar el espaciado entre líneas. Usa el panel de Herramientas de Texto para añadir un título a la ficha, campos de nombre y fecha o instrucciones con siete fuentes, incluyendo Lexend Deca, Baloo 2, Fredoka y Quicksand. Arrastra, redimensiona y reposiciona cada elemento en el lienzo completo Fabric.js.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Los tres modos de práctica crean una progresión de aprendizaje natural en una sola ficha. El modo Trazado proporciona contornos de letras sólidos que los usuarios siguen directamente — soporte visual completo para letras nuevas o desconocidas. El Trazado Progresivo comienza con letras sólidas en el lado izquierdo de la fila y reduce progresivamente su visibilidad hacia la derecha, reforzando la confianza a medida que los usuarios dependen menos de la guía con cada repetición. La Copia Guiada muestra solo un contorno tenue, exigiendo una formación de letras casi autónoma con soporte visual mínimo. Esta progresión de trazado a copia reproduce las metodologías probadas de enseñanza de la escritura y ofrece a los vendedores un eje de diferenciación integrado para paquetes de productos por niveles.",
      },
      {
  ...
  faq: [
    {
      ...
      answer:
        "El modo Trazado proporciona contornos de letras sólidos que los usuarios trazan directamente — soporte visual completo para aprender letras nuevas. El Trazado Progresivo comienza con letras sólidas en el lado izquierdo de la fila y las desvanece progresivamente hacia la derecha, permitiendo a los usuarios pasar del trazado a la escritura autónoma dentro de una sola fila. La Copia Guiada muestra un contorno tenue de cada letra que los usuarios reproducen al lado con asistencia visual mínima. Estos tres modos crean una progresión natural del soporte completo a la escritura autónoma, y puedes combinar los tres en una sola ficha gracias a la independencia por fila.",
    },
    {
