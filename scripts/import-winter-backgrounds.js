/**
 * Background Import Script: Winter
 *
 ...
 *   cd /opt/lessoncraftstudio/frontend && NODE_PATH=./node_modules node ../scripts/import-winter-backgrounds.js
 */
...
const THEME_CONFIG = {
  name: 'winter_bg',
  type: 'backgrounds',
  sourceFolderName: 'BACKGROUNDS/winter',
  displayNames: {
    en: 'Winter',
    de: 'Winter',
    fr: 'Hiver',
