...
const content: StartContent = {
  seo: {
    primaryKeyword: 'guía licencia comercial imprimibles para emprendedores',
    secondaryKeywords: [
    ...
    metaDescription: 'Guía de licencia comercial para vendedores de. Qué cubre, qué permite y cómo usarla para vender fichas en Etsy, Amazon KDP y Hotmart legalmente.',
  },
  ...
  actionSteps: [
    ...
    },
    {
      ...
      description: 'Determina si venderás principalmente en Etsy, Amazon KDP, Hotmart u otro marketplace. Esta decisión no afecta tu licencia — todas las plataformas están cubiertas — pero moldea en qué formatos y cantidades de producto centrarte.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'No. La licencia comercial es independiente de la plataforma. Una licencia cubre ventas en Etsy, Amazon KDP, Hotmart, Hotmart, Creative Fabrica, Shopify, tu propia web y cualquier otro marketplace o canal de ventas. Puedes vender en múltiples plataformas simultáneamente.',
    },
    {
