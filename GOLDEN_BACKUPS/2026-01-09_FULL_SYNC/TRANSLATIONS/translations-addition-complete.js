...
const translations = {
  ...
  "es": {
    ...
    "pleaseGenerateContentFirst": "Por favor, cree el contenido antes de descargar.",
  ...
  "it": {
    ...
    "pleaseGenerateContentFirst": "Per favore crea il contenuto prima di scaricare.",
  ...
  "pt": {
    "app.title": "Gerador de Folhas de Adições Ilustradas",
    ...
    "letterPortrait": "Carta Retrato (612×792)",
    "letterLandscape": "Carta Paisagem (792×612)",
    "a4Portrait": "A4 Retrato (595×842)",
    "a4Landscape": "A4 Paisagem (842×595)",
    ...
    "download": "Baixar",
    "worksheetJpeg": "Folha (JPEG)",
    "answerKeyJpeg": "Gabarito (JPEG)",
    "worksheetPdf": "Folha (PDF)",
    ...
    "worksheetGeneratedSuccessfully": "Folha criada com sucesso!",
    ...
    "pleaseGenerateWorksheetFirst": "Por favor, crie primeiro uma folha.",
    "pleaseGenerateContentFirst": "Por favor, crie o conteúdo antes de baixar.",
    "jpegError": "Erro JPEG: {}",
    "pdfError": "Erro PDF: {}",
    "searching": "Pesquisando...",
    "loadingImagesForTheme": "Carregando imagens para o tema: {}... Por favor aguarde.",
    ...
    "fontVerdana": "Verdana",
    "fontPalatino": "Palatino",
    "worksheetContentSettings": "Configurações do conteúdo da folha",
  ...
  "nl": {
    ...
    "exerciseConfiguration": "Oefenconfiguratie",
    ...
    "pleaseGenerateContentFirst": "Maak eerst de inhoud voor het downloaden.",
    "jpegError": "JPEG Fout: {}",
    "pdfError": "PDF Fout: {}",
    "searching": "Zoeken...",
    ...
    "fontVerdana": "Verdana",
    "fontPalatino": "Palatino",
    "worksheetContentSettings": "Werkbladinhoudsinstellingen",
  ...
  "sv": {
    ...
    "plusSign": "+",
    "equalsSign": "=",
    "textAddedToWorksheet": "Text tillagd till övningsbladet.",
    ...
    "pleaseGenerateContentFirst": "Skapa innehållet innan nedladdning.",
    "jpegError": "JPEG-fel: {}",
    "pdfError": "PDF-fel: {}",
    "searching": "Söker...",
    ...
    "fontVerdana": "Verdana",
    "fontPalatino": "Palatino",
    "worksheetContentSettings": "Övningsbladets innehållsinställningar",
  ...
  "da": {
    ...
    "pleaseGenerateContentFirst": "Opret indholdet før download.",
    "jpegError": "JPEG-fejl: {}",
    "pdfError": "PDF-fejl: {}",
    "searching": "Søger...",
  ...
  "no": {
    ...
    "pleaseGenerateContentFirst": "Lag innholdet før nedlasting.",
    "jpegError": "JPEG-feil: {}",
    "pdfError": "PDF-feil: {}",
    "searching": "Søker...",
    ...
    "fontVerdana": "Verdana",
    "fontPalatino": "Palatino",
    "worksheetContentSettings": "Innholdsinnstillinger for oppgaveark",
    "worksheetContentLanguage": "Innholdsspråk for oppgaveark:",
