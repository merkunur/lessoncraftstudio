#!/usr/bin/env node
/**
 * Metered-paywall deck-play wall (2026-07-12): inject lcs-meter.js into every
 * published deck.html. Clone of inject-analytics-beacon.js (same symlink walk /
 * atomic write / idempotency marker). Dark until METERING_ENABLED flips.
 *
...
var MARKER = 'id="lcs-meter-js"';
var SCRIPT = '<script id="lcs-meter-js" defer src="https://www.lessoncraftstudio.com/worksheet-generators/js/lcs-meter.js?v=1"></script>\n';
