...
const content: EnrichedThemeContent = {
  ...
  description: 'Printbare rommet-oppgaver til barn. Matematikk, fargelegging, ordspill og puslespill med rommettema. Førskole til 3. klasse. Gratis PDF. 3 000+ bilder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Verdensrommet-oppgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare verdensrommet-oppgaver til førskolebarn (3–4 år). Fargelegging, telling 1–10 og finmotorikk. 33 generatorer. Gratis PDF. Last ned gratis PDF nå.',
      seoKeywords: 'romoppgaver førskole, finmotorikk øvelse, fargelegging og sporing, størrelsessortering, enkel telling, planeter, solsystemet, astronomi, romøvelser førskole, rommets læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Verdensrommet-oppgaver til Barnehage | LessonCraftStudio',
      seoDescription: 'Printbare verdensrommet-oppgaver til barnehagebarn (5–6 år). Telling, bokstaver, mønstre og visuell oppfatning. 33 generatorer. Gratis PDF. Skriv ut nå.',
      seoKeywords: 'romoppgaver barnehage, begynnelsesbokstaver øvelse, bokstavgjenkjenning, telling til 20, mønstergjenkjenning, planeter, solsystemet, astronomi, romøvelser barnehage, rommets læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Verdensrommet-oppgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare verdensrommet-oppgaver til 1. klasse (6–7 år). Addisjon, subtraksjon, lesing og skriving. 33 generatorer. Gratis PDF. 3 000+ tematiske bilder.',
      seoKeywords: 'romoppgaver 1. klasse, addisjon subtraksjon, syntetisk lesing, selvstendig skriving, setningsoppbygging, planeter, solsystemet, astronomi, romøvelser 1. klasse, rommets læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Verdensrommet-oppgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare verdensrommet-oppgaver til 2. klasse (7–8 år). Multiplikasjon, ordspill, logikk og problemløsning. 33 generatorer. Gratis PDF. 3 000+ bilder.',
      seoKeywords: 'romoppgaver 2. klasse, multiplikasjonsøvelser, dataanalyse barn, faktatekster lesing, posisjonstall forståelse, planeter, solsystemet, astronomi, romøvelser 2. klasse, rommets læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Verdensrommet-oppgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare verdensrommet-oppgaver til 3. klasse (8–9 år). Flertrinnsproblemer, kryssord, kryptogrammer og avanserte oppgaver. 33 generatorer. Gratis PDF.',
      seoKeywords: 'romoppgaver 3. klasse, multiplikasjon divisjon, brøker introduksjon, forskningsrapport, kritisk tenkning, planeter, solsystemet, astronomi, romøvelser 3. klasse, rommets læring 8-9 år',
