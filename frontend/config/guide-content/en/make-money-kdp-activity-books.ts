...
const content: GuideContent = {
  seo: {
    ...
    lsiKeywords: [
      ...
      `multi-platform Etsy Gumroad digital printable expansion`,
  ...
  monetization: [
    ...
    },
    {
      ...
      content: `Your KDP print books and Etsy digital downloads serve fundamentally different buyer needs, so they complement rather than compete. A parent searching Amazon wants a physical workbook their child can write in. A buyer searching Etsy wants a printable PDF they can reproduce for an entire class. The same worksheet content satisfies both needs in different formats. Once your KDP catalog identifies which content types sell best, create corresponding Etsy digital bundles for those same categories. This dual-platform approach can increase total revenue from each content set by 30 to 50 percent because you are reaching two non-overlapping buyer populations with minimal additional effort.`,
    },
  ],
