...
const appHeroImagesByLocale: Record<string, Record<string, string>> = {
  en: {
    ...
    'big-small': '/samples/english/big small/big-small-worksheet-worksheet.webp',
    ...
    'draw-and-color': '/samples/english/draw and color/grid-drawing-worksheet.webp',
    'drawing-lines': '/samples/english/drawing lines/drawing-lines-horizontal.webp',
    'find-and-count': '/samples/english/find and count/find-and-count-portrait.webp',
    'find-objects': '/samples/english/find objects/spotworks-worksheet.webp',
    ...
    'pattern-train': '/samples/english/pattern train/pattern-train-worksheet.webp',
    'pattern-worksheet': '/samples/english/pattern worksheet/pattern-worksheet.webp',
    ...
    'word-guess': '/samples/english/word guess/clue-grid-worksheet.webp',
  ...
  de: {
    ...
    'big-small': '/samples/german/big small/big-small-worksheet-worksheet.webp',
    ...
    'find-objects': '/samples/german/find objects/finde-das-unpassende-1-v7.webp',
    ...
    'pattern-worksheet': '/samples/german/pattern worksheet/pattern-worksheet.webp',
    ...
    'word-guess': '/samples/german/word guess/clue-grid-worksheet.webp',
  ...
  it: {
    ...
    'odd-one-out': '/samples/italian/odd one out/trova-il-diverso-1-v10.webp',
  ...
  nl: {
    ...
    'alphabet-train': '/samples/dutch/alphabet train/alfabettrein-1.webp',
    'big-small': '/samples/dutch/big small/groot-of-klein-1.webp',
    'bingo': '/samples/dutch/bingo/plaatjesbingo-1.webp',
    'chart-count': '/samples/dutch/chart count/plaatjesgrafiek-1.webp',
    'code-addition': '/samples/dutch/code addition/geheime-code-optellen-1.webp',
    ...
    'draw-and-color': '/samples/dutch/draw and color/teken-en-kleur-1.webp',
    'drawing-lines': '/samples/dutch/drawing lines/lijnen-tekenen-oefenen-1.webp',
    'find-and-count': '/samples/dutch/find and count/ik-zie,-ik-zie-1.webp',
    'find-objects': '/samples/dutch/find objects/vind-de-verborgen-voorwerpen-1.webp',
    'grid-match': '/samples/dutch/grid match/rasterpuzzel-1.webp',
    'matching': '/samples/dutch/matching/zoek-de-paren-1.webp',
    'math-puzzle': '/samples/dutch/math puzzle/wiskundepuzzels-1.webp',
    'math-worksheet': '/samples/dutch/math worksheet/wiskundeblad-1.webp',
    'missing-pieces': '/samples/dutch/missing pieces/ontbrekende-stukjes-1.webp',
    'more-less': '/samples/dutch/more less/meer-minder-1.webp',
    'odd-one-out': '/samples/dutch/odd one out/vind-de-vreemde-eend-1.webp',
    'pattern-train': '/samples/dutch/pattern train/patroontje-1.webp',
    'pattern-worksheet': '/samples/dutch/pattern worksheet/patroonpuzzels-1.webp',
    'picture-path': '/samples/dutch/picture path/afbeeldingspad-1.webp',
    'picture-sort': '/samples/dutch/picture sort/afbeeldingen-sorteren-1.webp',
    'prepositions': '/samples/dutch/prepositions/voorzetsels-1.webp',
    'shadow-match': '/samples/dutch/shadow match/schaduw-koppelen-1.webp',
    'sudoku': '/samples/dutch/sudoku/plaatjes-sudoku-1.webp',
    'treasure-hunt': '/samples/dutch/treasure hunt/schattenjacht-1.webp',
    'word-guess': '/samples/dutch/word guess/raad-het-woord-1.webp',
    'word-scramble': '/samples/dutch/word scramble/letterzaak-1.webp',
