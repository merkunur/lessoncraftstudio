...
const STORY_SEQUENCING = {
  en: {
    ...
    stories: {
      apple: {
        sentences: ['The apple is whole.', 'The apple has one bite.', 'The apple has three bites.', 'Only the core is left.'],
      ...
      banana: {
        sentences: ['The banana is not peeled.', 'One strip of peel hangs down.', 'Three strips hang down.', 'Only the empty peel is left.'],
        stateWords: ['not peeled', 'one strip', 'three strips', 'empty peel'],
        helpWords: ['banana', 'peel', 'strip', 'plate'],
        helpIds: ['banana', 'peel', 'strip', 'plate'],
      },
      sandwich: {
        sentences: ['There are two slices of bread.', 'One slice has jam on it.', 'The sandwich is cut in half.', 'Only a crust and crumbs are left.'],
      ...
      cake: {
        sentences: ['The cake is whole.', 'One slice is cut out.', 'Half of the cake is gone.', 'Only crumbs are left.'],
        stateWords: ['whole', 'one slice', 'half', 'crumbs'],
        helpWords: ['cake', 'slice', 'candles', 'crumbs', 'stand'],
        helpIds: ['cake', 'slice', 'candle', 'crumb', 'stand'],
      },
      fence: {
        sentences: ['The fence is all white.', 'Two planks are painted.', 'Four planks are painted.', 'The whole fence is painted.'],
      ...
      letter: {
        sentences: ['The card is blank.', 'A flower is drawn on the card.', 'Three lines of writing are added beside the drawing.', 'The card is in an envelope with a stamp.'],
      ...
      'paper-chain': {
        sentences: ['There is one sheet of paper.', 'The sheet is cut into five strips.', 'Two strips are glued into rings.', 'All five rings make a chain.'],
      ...
      'beach-walk': {
        sentences: ['There are no footprints in the sand.', 'A child walks and leaves three footprints.', 'The child finds a shell.', 'The child is back with the shell on the towel.'],
