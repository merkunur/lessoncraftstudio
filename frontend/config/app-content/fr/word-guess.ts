...
export const content: AppDetailContent = {
  ...
  seo: {
    titleTag: 'Générateur Deviner le Mot | Créer des Fiches Gratuitement',
    metaDescription: 'Créez des fiches Deviner le Mot professionnelles en quelques secondes. 104 thèmes, éditeur canvas, export PDF. Générateur gratuit en ligne pour enseignants et vendeurs.',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Fiche deviner le mot avec indices visuels',

    },
    sampleGallery: [
      { src: '/samples/english/word guess/Word Guess 1.jpeg', alt: 'Jeu deviner le mot illustré', caption: 'Deviner à partir d\'images' }
    ],
...
Chaque export inclut automatiquement un corrigé, éliminant le temps passé à créer les solutions manuellement. Les 104 thèmes couvrent toutes les catégories populaires : animaux (ferme, safari, océan, dinosaures), véhicules, aliments, nature, espace, sports, musique, saisons et fêtes. Créez des packs thématiques qui séduisent les acheteurs.`,
  ...
  businessUseCases: [
    {
      ...
      description: 'Créez des packs de 10-20 fiches Deviner le Mot thématiques et vendez-les en téléchargement instantané sur Etsy.',
      platform: 'Etsy',
    },
    {
  ...
  faq: [
    {
      question: 'Le Générateur Deviner le Mot est-il vraiment gratuit ?',
  ...
  internalLinks: [
    ...
    { slug: 'word-guess', pageType: 'tool' as const, anchorText: 'Essayer Générateur Deviner le Mot Gratuit' },
