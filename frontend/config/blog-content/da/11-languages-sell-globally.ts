...
const content: BlogContent = {
  ...
  internalLinks: [
    ...
    { pageType: 'app', slug: 'word-search-worksheets', anchorText: 'Ordsøgning Generator (11 sprog)' },
    { pageType: 'app', slug: 'crossword-worksheets', anchorText: 'Krydsord Generator (11 sprog)' },
  ],
  relatedPosts: [
