...
const content: ToolContent = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'In the Page Setup section, select your page size: Letter Portrait, Letter Landscape, A4 Portrait, A4 Landscape, Square (1200×1200), or enter a custom size. Choose a background color, select a decorative background theme from the image library with adjustable opacity, and add a border frame with independent opacity control. These layout settings give your pattern train worksheets a polished, branded look before you configure any pattern settings.',
      },
      {
        title: 'Choose Your Pattern Type',
        description: 'Select one of five repeating pattern types from the Content panel. AB alternates two items (A-B-A-B) for the simplest sequences. AAB groups two of one item then one of another (A-A-B-A-A-B). ABB reverses that grouping (A-B-B-A-B-B). ABC rotates three different items (A-B-C-A-B-C) for more complex identification. AABB pairs two of each before repeating (A-A-B-B-A-A-B-B). Each type targets a different level of pattern recognition skill, creating a natural difficulty progression from simple two-element alternation to multi-element sequences.',
      },
      {
      ...
      },
      {
        ...
        description: 'Browse 104 themed image collections with 3,100+ illustrations — animals, food, vehicles, nature, holidays, professions, and dozens more. Each theme provides visually coordinated images that look cohesive across the train wagons. The pattern type determines how many distinct images are needed: AB uses 2, AAB and ABB use 2, ABC uses 3, and AABB uses 2. Or upload your own custom images for subject-specific pattern train worksheets that go beyond the built-in library.',
      },
      {
  ...
  whatYouCanCreate: [
    {
      title: 'Themed Pattern Train Packs',
      description: 'Create sets of 15–25 pattern train worksheets grouped by theme — farm animals, dinosaurs, ocean creatures, vehicles, food, and more. Vary both the pattern type and clue count across the set for progressive difficulty: start with AB patterns showing 10 clues, advance to AAB and ABB with 7 clues, and finish with ABC and AABB patterns at 4–5 clues. Include the auto-generated answer key for every worksheet. The fully visual zero-text format means every pack sells worldwide without translation — one listing serves every market on Etsy.',
    },
    {
      title: 'KDP Pattern Recognition Workbooks',
      description: 'Compile 60–100 pattern train exercises into a printed workbook for Amazon KDP. Structure chapters as a skill progression: Chapter 1 covers AB patterns with high clue counts, Chapter 2 introduces AAB and ABB asymmetric groupings, Chapter 3 advances to ABC three-element patterns, Chapter 4 presents AABB extended sequences, and Chapter 5 reduces clue counts across all pattern types for challenge pages. Answer keys at the back. The zero-text visual format needs no translation for international KDP marketplaces — publish the same interior everywhere.',
    },
    {
  ...
  businessIdeas: [
    {
      title: 'Pattern-Type-Graded Etsy Shop',
      description: 'Open an Etsy shop specializing in pattern train worksheets organized by pattern complexity. Beginner packs feature AB patterns with 8–10 clues — the simplest repeating sequence with maximum visual support. Intermediate packs use AAB and ABB patterns with 6–7 clues. Advanced packs feature ABC and AABB patterns at 4–5 clues. The unique train car format immediately differentiates your listings from grid-based competitors. Price theme packs at $3–$5 and progressive multi-theme bundles at $12–$18.',
      platform: 'Etsy',
    },
    {
    ...
    },
    {
      ...
      description: 'Because pattern train worksheets contain only images on train cars with zero text on the output, the exact same product works in every language without modification. Create one set of pattern train exercises and sell it to buyers worldwide — no translation, no separate language versions, no duplicate listings to maintain. This is a concrete competitive advantage over text-based worksheet generators. One creation session produces a universally sellable product for every marketplace.',
  ...
  faq: [
    {
      ...
      answer: 'Yes. The tool offers a free trial with full features — all five pattern types, adjustable clue count from 4 to 10, the image library, answer key generation, and all export formats. No signup, no credit card required. Free trial downloads include a watermark. Purchase a commercial license to remove the watermark and unlock selling rights.',
    },
    {
    ...
    },
    {
      ...
      answer: 'The train displays 11 wagons across three rows: 5 wagons on the top row, 3 on the middle-left, and 3 on the middle-right. Each wagon holds one image from the repeating pattern sequence. The themed train artwork connects the wagons visually, creating a distinctive layout that stands out from standard grid-based pattern worksheets in marketplace listings.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Pattern train worksheets are fully visual by design. Only images appear on the train cars — no written words on the output. This makes worksheets universally usable regardless of language or reading level. For sellers, zero-text output means the same product sells worldwide without translation — one listing serves every market. Changing the content language only affects the UI labels in the generator, not the printed worksheet.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes. Custom image upload lets you add any picture to the pattern train exercises. Upload photos, illustrations, or graphics relevant to your subject or audience. Custom images work with all five pattern types and appear on the train wagons. This is useful for niche topics like plant growth stages, musical notes, or geometric shapes beyond the built-in 104-theme library.',
    },
    {
  ...
  visuals: {
    heroImages: {
      primary: '/samples/english/pattern train/pattern-train-worksheet.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/english/pattern train/pattern-train-worksheet-1.webp',
      ...
      {
        src: '/samples/english/pattern train/pattern-train-worksheet-5.webp',
      ...
      {
        src: '/samples/english/pattern train/pattern-train-answer-key.webp',
    ...
    videoTitle: 'How to Create Pattern Train Worksheets with Five Pattern Types — Step-by-Step Tutorial',
  },
};
