...
const ideasKeywords: Record<string, string[]> = {
  ...
  es: ['nichos rentables imprimibles Etsy', 'ideas de nichos imprimibles KDP', 'qué imprimibles se venden mejor', 'nichos fichas educativas', 'ideas negocio imprimibles', 'nichos imprimibles baja competencia'],
  pt: ['ideias de nichos atividades educativas', 'nichos imprimíveis rentáveis', 'quais atividades vendem mais', 'nichos atividades Etsy', 'ideias negócio imprimíveis', 'nichos atividades baixa concorrência'],
  it: ['idee schede didattiche', 'nicchie stampabili educativi', 'temi schede da stampare', 'idee prodotti didattici', 'nicchie Etsy educazione', 'schede tematiche idee'],
  nl: ['winstgevende niches printables Etsy', 'printable niche ideeën', 'seizoensgebonden printables', 'educatieve printables niches', 'Bol.com printables niches'],
  ...
  da: ['niche-ideer opgaver til print', 'profitable printable-nicher', 'Etsy nicheforskning opgaver', 'KDP niche-ideer aktivitetsbøger', 'hvilke opgaver sælger bedst', 'forretningsideer opgaver til print'],
...
const ideasContent: Record<string, {
  ...
  es: {
    heroTitle: '45 nichos rentables de imprimibles para Etsy y KDP',
    heroDescription: 'Descubra 45 nichos probados para su negocio de imprimibles con análisis de competencia. Encuentre oportunidades de baja competencia para Etsy o KDP.',
    metaTitle: '45 nichos rentables de imprimibles para Etsy y KDP',
    metaDescription: 'Descubra 45 nichos probados para su negocio de imprimibles con análisis de competencia. Encuentre oportunidades de baja competencia para Etsy o KDP.',
  ...
  it: {
    ...
    metaTitle: '45 idee di nicchia per schede didattiche | LessonCraftStudio',
    metaDescription: 'Scopri 45 nicchie per creare e vendere schede didattiche stampabili. Temi, stagioni, fasce d\'eta e formati con idee e strategie.',
  ...
  nl: {
    ...
    metaTitle: '45 winstgevende printables-niches | LessonCraftStudio',
    metaDescription: 'Ontdek 45 winstgevende niches om printables te verkopen op Etsy, KDP en Bol.com. Thema\'s, seizoenen, leeftijdsgroepen en productformaten.',
  ...
  da: {
    heroTitle: '45 profitable niche-ideer til opgaver til print',
    heroDescription: 'Find din perfekte niche. 45 profitable ideer med produktforslag, platformstips og prisstrategier for Etsy- og KDP-sælgere.',
    metaTitle: '45 profitable niche-ideer til opgaver til print | Etsy & KDP',
    metaDescription: 'Opdag 45 profitable nicher til opgaver til print. Ideer organiseret efter emne, sæson og format. Find din niche til Etsy og KDP.',
    ...
    subcatDescriptions: {
      animals: 'Dyre- og naturtema nicher for opgaver til print',
      season: 'Sæson- og højtidstema nicher for opgaver til print',
      interests: 'Interesse- og aktivitetsbaserede nicher for opgaver til print',
      education: 'Uddannelsesfokuserede nicher for opgaver til print',
