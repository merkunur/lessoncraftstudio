...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Echte cijfers van echte verkopers — geen hype',
    description: 'Echte cijfers van echte verkopers — geen hype. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
