...
const SKEL_OA = [
  `Uma pequena escada de tamanhos a construir com imagens de {N_PL}: é o coração desta folha da educação infantil. Em cada quadrinho a mesma coisa aparece em vários tamanhos, do menor ao maior, e todas misturadas. A criança as recoloca em ordem, do menor para o maior, formando uma bela fila crescente. Enquanto faz isso, olha e compara os tamanhos, sem contar nada e sem usar números. Aqui só importa o tamanho: o que vem antes, o que vem depois. Esse ordenar por tamanho é uma valiosa habilidade de base que prepara para a escola. Sem pressa, brinca-se no próprio ritmo. Sugira que ela procure primeiro a figura menor e a coloque no começo, depois aos poucos as outras até a maior. Se errar um lugar, troca com leveza e segue. Quando a fila está completa, do menor ao maior, a satisfação vem sozinha. Vivida ao lado de um adulto paciente, com palavras carinhosas e nenhuma corrida, vira um caloroso momento de brincadeira compartilhada.`,
