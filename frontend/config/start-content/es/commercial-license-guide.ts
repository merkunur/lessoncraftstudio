...
const content: StartContent = {
  ...
  mainContent: [
    ...
    },
    {
      ...
      content: 'La licencia comercial es independiente de la plataforma. Aunque Etsy y Amazon KDP son los canales más populares para los vendedores de imprimibles, la licencia cubre cada plataforma de venta por igual.\n\nTeachers Pay Teachers es una opción natural para fichas educativas. Tus fichas de matemáticas, puzzles de sopa de letras, actividades de crucigrama y otro contenido educativo generado pueden venderse en TpT bajo la misma licencia comercial. Los vendedores de TpT a menudo crean paquetes diferenciados — packs específicos por grado, colecciones por materia, sets estacionales — todos cubiertos.\n\nGumroad funciona bien para ventas directas sin comisiones de marketplace en su plan gratuito. Publica tus paquetes de fichas, packs de actividades o sets completos de currículo. La licencia comercial cubre las ventas en Gumroad igual que en cualquier otra plataforma.\n\nCreative Fabrica y Creative Market atienden al mercado de diseño y educación. Si tus fichas encajan en sus categorías, la licencia comercial cubre las ventas en ambas plataformas. Lo mismo aplica para Payhip, SendOwl, Sellfy y otras plataformas de entrega digital.\n\nShopify y WooCommerce te permiten vender directamente desde tu propia web. Construye una tienda de fichas con tu marca y derechos comerciales completos sobre cada producto generado. Sin comisión de marketplace, sin restricciones de plataforma, control total sobre la experiencia de tu cliente.\n\nLas ventas a escuelas e instituciones están cubiertas. Si un distrito escolar quiere comprar un conjunto de tus fichas directamente, la licencia comercial cubre esa transacción. Las licencias por volumen a instituciones, los acuerdos mayoristas con distribuidores educativos y las ventas directas B2B están todas dentro de tus derechos comerciales.\n\nEl principio es simple: si lo generaste con un generador licenciado, puedes venderlo en cualquier lugar a cualquier persona. La licencia no restringe tus canales de venta, tus precios ni tu base de clientes. Tus derechos comerciales son los mismos independientemente de dónde ocurra la transacción.',
    },
    {
      heading: 'Cómo se relaciona la prueba gratis con marca de agua con la licencia comercial',
      content: 'Cada generador de fichas ofrece una prueba gratis con marca de agua, y entender cómo se relaciona la prueba con la licencia comercial elimina la mayor duda que tienen la mayoría de los vendedores sobre la compra.\n\nLa prueba gratis con marca de agua te da acceso completo a cada función del generador. Puedes seleccionar cualquier tema, ajustar cualquier configuración, cambiar cualquier parámetro y generar fichas con la funcionalidad completa de la versión licenciada. Nada está bloqueado, oculto ni restringido durante la prueba. Ves exactamente lo que ofrece el producto comercial.\n\nLa única diferencia entre el resultado de la prueba y el resultado licenciado es una marca de agua en las fichas generadas. Esta marca de agua hace que el resultado de la prueba sea inadecuado para la venta comercial — ningún comprador quiere fichas con una marca de agua de terceros. Comprar una licencia elimina la marca de agua. Ese es el único cambio.\n\nEsta estructura de prueba está diseñada deliberadamente para protegerte como comprador. Nunca tienes que comprar una licencia basándote en promesas o capturas de pantalla. Puedes generar cientos de fichas de muestra, probar cada tema, intentar cada nivel de dificultad y verificar que el resultado cumple tus estándares de calidad — todo antes de gastar un solo dólar.\n\nPara los vendedores que evalúan las licencias comerciales, el flujo de trabajo de prueba recomendado es sencillo. Primero, genera muestras de los tipos de fichas que planeas vender. Segundo, prueba los temas y configuraciones específicos que usarías en tus productos. Tercero, si planeas vender internacionalmente, cambia de idioma y verifica la calidad del resultado multilingüe. Cuarto, confirma que el formato de salida, la resolución y la calidad de impresión cumplen los estándares de tu marketplace. Quinto, solo después de pruebas exhaustivas, compra el nivel de licencia que se ajuste a las necesidades de tu negocio.\n\nLa prueba gratis con marca de agua significa que no hay ningún riesgo en tu decisión de licencia. No estás comprando un producto a ciegas. Estás adquiriendo una licencia para una herramienta que ya has probado extensamente y has confirmado que cumple tus requisitos.',
    },
    {
      heading: 'Aplicaciones individuales vs paquetes de categoría: elegir la licencia correcta',
      content: 'El modelo de licencia ofrece dos estructuras de compra: licencias de aplicación individual y licencias de paquete de categoría. Elegir la opción correcta depende de la amplitud de tu catálogo de productos.\n\nLas licencias de aplicación individual tienen un precio de $27 (Paquete Comercial) o $47 (Paquete de Acceso Completo) por generador. Esta es la elección correcta cuando necesitas un generador específico para una línea de productos enfocada. Si te especializas exclusivamente en libros de puzzles de sopa de letras, una sola licencia del generador de Sopa de Letras cubre todas tus necesidades de producción. No hay razón para comprar generadores que no vas a usar.\n\nLas licencias de paquete de categoría tienen un precio de $79 (Paquete Comercial) o $119 (Paquete de Acceso Completo) para los seis generadores de una categoría. Las seis categorías son: Fichas de Actividades, Matemáticas y Números, Letras y Palabras, Dibujo y Arte, Puzzles y Juegos, y Patrones y Lógica. Cada paquete incluye todos los generadores de esa categoría.\n\nLa comparación matemática ilustra claramente el valor del paquete. La categoría Matemáticas y Números incluye seis generadores: Suma, Resta, Multiplicación, Puzzle Matemático, Código Matemático (Suma) y Código Matemático (Resta). Comprar los seis individualmente a $27 cada uno costaría $162 para el Paquete Comercial o $282 para el Acceso Completo. Los paquetes los fijan a $79 y $119 respectivamente — un ahorro de $83 y $163.\n\nLos paquetes también tienen sentido comercial para la diversidad de productos. Los vendedores que solo ofrecen puzzles de sopa de letras compiten en una categoría de producto. Los vendedores que ofrecen sopa de letras, crucigrama, anagrama, asociación, buscar y contar y vocabulario con imágenes compiten en seis categorías relacionadas con una sola compra de paquete. Más variedad de productos significa más publicaciones, más visibilidad en búsquedas y más potencial de ingresos.\n\nEl cálculo del retorno de inversión para cualquiera de las opciones es favorable. Una sola publicación de Etsy a $4,99 necesita seis ventas para recuperar el coste de una licencia individual de $27. Un paquete a $79 necesita 16 ventas entre todos los generadores. Para la mayoría de vendedores activos, estos umbrales se alcanzan rápidamente.\n\nComienza con una licencia individual para tu generador principal. Si te encuentras queriendo generadores adicionales de la misma categoría, actualiza al paquete para las aplicaciones restantes a una fracción del coste individual.',
    },
  ],
  ...
  actionSteps: [
    ...
    },
    {
      ...
      description: 'Determina si venderás principalmente en Etsy, Amazon KDP, TpT u otro marketplace. Esta decisión no afecta tu licencia — todas las plataformas están cubiertas — pero moldea en qué formatos y cantidades de producto centrarte.',
    },
    {
      step: 'Elige tu generador de inicio',
      description: 'Selecciona el generador que mejor se ajuste a tu nicho. La Sopa de Letras es el más popular para libros de puzzles. Suma y Resta son básicos para cuadernos de matemáticas. Colorear es el de mayor volumen para KDP. Comienza con uno antes de expandirte.',
    },
    {
  ...
  faq: [
    {
      ...
      answer: 'Sí. Cada generador ofrece una prueba gratis con marca de agua que te da acceso completo a todas las funciones. Genera tantas fichas de muestra como necesites para evaluar la calidad del resultado, probar diferentes temas y configuraciones, y confirmar que los generadores cumplen tus requisitos de producción. La única diferencia entre el resultado de la prueba y el licenciado es una marca de agua en las páginas generadas.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Sí. No hay límite en el número de fichas que generas, el número de productos que creas ni el número de publicaciones que publicas. Una licencia por generador cubre producción comercial ilimitada. No hay tarifas por ficha, ni cargos por publicación, ni límites de ingresos.',
    },
    {
      question: '¿Necesito licencias separadas para Etsy, Amazon KDP y otras plataformas?',
      answer: 'No. La licencia comercial es independiente de la plataforma. Una licencia cubre ventas en Etsy, Amazon KDP, Teachers Pay Teachers, Gumroad, Creative Fabrica, Shopify, tu propia web y cualquier otro marketplace o canal de ventas. Puedes vender en múltiples plataformas simultáneamente.',
    },
    {
      question: '¿La licencia comercial es una compra única o una suscripción?',
      answer: 'Compra única. No hay tarifas recurrentes, ni suscripciones mensuales, ni cargos de renovación. Pagas una vez y conservas los derechos comerciales para generar y vender fichas indefinidamente. La licencia es perpetua y no caduca.',
    },
    {
      question: '¿Puedo incluir fichas generadas en libros de actividades de Amazon KDP?',
      answer: 'Sí. La licencia comercial cubre tanto descargas digitales como productos impresos. Puedes publicar libros de actividades ilimitados en Amazon KDP usando contenido generado sin regalía por libro, sin tarifa por página y sin participación en ingresos. Tus regalías de KDP son totalmente tuyas.',
    },
    {
      question: '¿Necesito dar crédito a LessonCraftStudio en mis productos?',
      answer: 'No. Tus fichas generadas son tus productos para vender bajo tu propia marca. No se requiere atribución, línea de crédito ni reconocimiento en tus fichas, en tus publicaciones de marketplace ni en tus materiales de marketing.',
    },
    {
