...
const content: ToolContent = {
  seo: {
    primaryKeyword: 'jeu d\'ombres gratuit en ligne',
    secondaryKeywords: [
      'associer les ombres fiche gratuit sans inscription',
      'jeu de silhouettes à imprimer gratuit en ligne',
      'ombres et images association gratuit',
      'ombres maternelle exercice gratuit à imprimer',
    ],
    lsiKeywords: [
      'PS',
      'MS',
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Activez ou désactivez la case \" Afficher les Étiquettes \" (activée par défaut) pour afficher les identifiants A, B, C, D sur les images ou premières moitiés et 1, 2, 3, 4 sur les silhouettes ou secondes moitiés. Quand les étiquettes sont activées, les utilisateurs écrivent des paires lettre-numéro comme réponses — un guidage structuré pour les jeunes apprenants. Quand les étiquettes sont désactivées, la fiche devient un défi de correspondance purement visuel sans aide alphanumérique — idéal pour les cahiers de puzzles ou les activités avancées où les réponses écrites ne sont pas nécessaires. Cochez \" Inclure les Champs Nom/Date \" pour ajouter des lignes nom et date en bas de la fiche pour la responsabilité en ligne.',
      },
      {
  ...
  businessIdeas: [
    ...
    {
      title: 'Packs d\'Activités de Discrimination Visuelle pour Gumroad',
      description: 'Téléversez des packs d\'activités de discrimination visuelle sur Gumroad avec champs nom/date, étiquettes activables et corrigés auto-générés comme arguments de vente principaux. Les vendeurs recherchant des activités de discrimination visuelle apprécient les fiches qui incluent des versions guidées et des versions défi. Créez des ensembles liés au programme : correspondance d\'ombres d\'animaux pour les sciences, silhouettes de métiers pour les études sociales, puzzles d\'ombres alimentaires pour la nutrition. Chaque pack inclut des versions avec étiquettes pour l\'instruction encadrée et des versions sans étiquettes pour le travail autonome, pour que les vendeurs adaptent selon le niveau de l\'utilisateur. Le corrigé auto-généré élimine le temps de préparation.',
      platform: 'Gumroad',
    },
    {
      title: 'Tunnel de Vente Pinterest pour Puzzles de Silhouettes',
      description: 'Les fiches de discrimination visuelle font des épingles Pinterest visuellement saisissantes — le contraste entre les images en couleur et leurs silhouettes noires crée un format immédiatement accrocheur. Épinglez des exemples de fiches montrant le mode Trouve l\'Ombre avec des silhouettes d\'animaux distinctives et le mode Reconstitue l\'Image avec des moitiés d\'images séparées. Créez des séries d\'épingles distinctes pour \" puzzles d\'ombres d\'animaux \", \" correspondance de silhouettes de fêtes \" et \" activités de perception visuelle \". Les activités de silhouettes Halloween fonctionnent particulièrement bien sur Pinterest pendant la saison d\'automne. Le format purement visuel plaît aux parents et vendeurs de tous les pays. Reliez chaque épingle à vos listings Etsy ou Gumroad.',
      platform: 'Pinterest',
    },
    {
  ...
  proTips: [
    ...
    },
    {
      ...
      description: 'Quand la case \" Afficher les Étiquettes \" est désactivée, la fiche devient un défi de correspondance purement visuel sans identifiants A/B/C/D et 1/2/3/4. Cela crée une page de puzzle plus épurée et plus professionnelle, idéale pour les cahiers de puzzles imprimés et les téléchargements numériques premium. Sans étiquettes, les utilisateurs doivent s\'appuyer entièrement sur la correspondance visuelle — identifier les silhouettes par leur forme seule ou reconnecter les moitiés divisées par continuité visuelle. Les fiches sans étiquettes commandent une valeur perçue plus élevée dans les produits de cahiers de puzzles car elles sont plus soignées et présentent un véritable défi.',
    },
    {
    ...
    },
    {
      ...
      description: 'Les fiches de discrimination visuelle ne contiennent que des images, des silhouettes et des moitiés divisées — aucun texte spécifique à une langue sur la fiche. Chaque puzzle que vous créez est instantanément vendable partout dans le monde sans traduction ni localisation. Un ensemble de fiches de discrimination visuelle sert toutes les boutiques Etsy internationales, toutes les places de marché KDP et tous les acheteurs Gumroad quelle que soit la langue. Pendant que vos concurrents créent des versions linguistiques séparées de fiches avec du texte, vos puzzles de silhouettes fonctionnent partout à partir d\'un seul ensemble de fichiers.',
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: 'Le générateur propose deux modes distincts dans un seul outil. Le mode Trouve l\'Ombre place 4 images en couleur étiquetées A–D dans la rangée du haut et 4 silhouettes noires auto-générées étiquetées 1–4 dans la rangée du bas — les utilisateurs associent chaque image à son ombre en appariant les lettres aux numéros. Les silhouettes sont créées par un traitement au niveau des pixels (alpha > 10 → noir pur), pas par des filtres CSS. Le mode Reconstitue l\'Image divise 4 images en moitiés — premières moitiés étiquetées A–D, secondes moitiés étiquetées 1–4 — et les utilisateurs reconnectent les pièces pour compléter chaque illustration. Choisissez la coupe horizontale (haut/bas) ou verticale (gauche/droite) en mode Reconstitue l\'Image.',
    },
    {
  ...
  visuals: {
    heroImages: {
      primary: '/samples/french/shadow%20match/trouve-l\'ombre-1.webp',
    ...
    sampleGallery: [
      {
        src: '/samples/french/shadow%20match/trouve-l\'ombre-1.webp',
      ...
      {
        src: '/samples/french/shadow%20match/trouve-l\'ombre-2.webp',
      ...
      {
        src: '/samples/french/shadow%20match/trouve-l\'ombre-1-answer-key.webp',
