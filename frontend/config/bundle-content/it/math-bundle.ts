...
const content: BundleContent = {
  seo: {
    ...
    metaDescription: 'Ottieni 6 generatori di schede matematiche in un unico pacchetto. Crea schede di addizione, sottrazione, puzzle, confronto e algebra per Etsy, KDP e TPT.',
  },
