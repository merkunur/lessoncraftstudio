...
export const ideaPageSlugs: IdeaSlugConfig[] = [
  // === Animals & Nature (8) ===
  { ideaId: 'farm-animals-printable-ideas', slugs: { en: 'farm-animals-printable-ideas', de: 'bauernhoftiere-druckvorlagen-ideen', fr: 'animaux-ferme-idees-imprimables', es: 'animales-granja-ideas-imprimibles', pt: 'animais-fazenda-ideias-imprimiveis', it: 'animali-fattoria-idee-stampabili', nl: 'boerderijdieren-printable-ideen', sv: 'bondgardsdjur-utskriftsbara-ideer' } },
  ...
  { ideaId: 'birds-printable-ideas', slugs: { en: 'birds-printable-ideas', de: 'voegel-druckvorlagen-ideen', fr: 'oiseaux-idees-imprimables', es: 'aves-ideas-imprimibles', pt: 'aves-ideias-imprimiveis', it: 'uccelli-idee-stampabili', nl: 'vogels-printable-ideen', sv: 'faglar-utskriftsbara-ideer' } },
  ...
  { ideaId: 'easter-printable-ideas', slugs: { en: 'easter-printable-ideas', de: 'ostern-druckvorlagen-ideen', fr: 'paques-idees-imprimables', es: 'pascua-ideas-imprimibles', pt: 'pascoa-ideias-imprimiveis', it: 'pasqua-idee-stampabili', nl: 'pasen-printable-ideen', sv: 'pask-utskriftsbara-ideer' } },
  { ideaId: 'valentines-day-printable-ideas', slugs: { en: 'valentines-day-printable-ideas', de: 'valentinstag-druckvorlagen-ideen', fr: 'saint-valentin-idees-imprimables', es: 'san-valentin-ideas-imprimibles', pt: 'dia-namorados-ideias-imprimiveis', it: 'san-valentino-idee-stampabili', nl: 'valentijnsdag-printable-ideen', sv: 'alla-hjartans-dag-utskriftsbara-ideer' } },
  { ideaId: 'back-to-school-printable-ideas', slugs: { en: 'back-to-school-printable-ideas', de: 'schulanfang-druckvorlagen-ideen', fr: 'rentree-scolaire-idees-imprimables', es: 'vuelta-al-cole-ideas-imprimibles', pt: 'regresso-aulas-ideias-imprimiveis', it: 'ritorno-scuola-idee-stampabili', nl: 'terug-naar-school-printable-ideen', sv: 'skolstart-utskriftsbara-ideer' } },
  ...
  { ideaId: 'spring-printable-ideas', slugs: { en: 'spring-printable-ideas', de: 'fruehling-druckvorlagen-ideen', fr: 'printemps-idees-imprimables', es: 'primavera-ideas-imprimibles', pt: 'primavera-ideias-imprimiveis', it: 'primavera-idee-stampabili', nl: 'lente-printable-ideen', sv: 'var-utskriftsbara-ideer' } },
  { ideaId: 'thanksgiving-printable-ideas', slugs: { en: 'thanksgiving-printable-ideas', de: 'erntedankfest-druckvorlagen-ideen', fr: 'action-de-grace-idees-imprimables', es: 'accion-de-gracias-ideas-imprimibles', pt: 'acao-gracas-ideias-imprimiveis', it: 'ringraziamento-idee-stampabili', nl: 'thanksgiving-printable-ideen', sv: 'tacksagelse-utskriftsbara-ideer' } },
  { ideaId: 'parents-day-printable-ideas', slugs: { en: 'parents-day-printable-ideas', de: 'elterntag-druckvorlagen-ideen', fr: 'fete-des-parents-idees-imprimables', es: 'dia-de-los-padres-ideas-imprimibles', pt: 'dia-dos-pais-ideias-imprimiveis', it: 'festa-genitori-idee-stampabili', nl: 'ouderdag-printable-ideen', sv: 'foraldradagen-utskriftsbara-ideer' } },
  ...
  { ideaId: 'preschool-printable-ideas', slugs: { en: 'preschool-printable-ideas', de: 'vorschule-druckvorlagen-ideen', fr: 'maternelle-idees-imprimables', es: 'preescolar-ideas-imprimibles', pt: 'pre-escolar-ideias-imprimiveis', it: 'prescuola-idee-stampabili', nl: 'peuterspeelzaal-printable-ideen', sv: 'forskola-utskriftsbara-ideer' } },
  ...
  { ideaId: 'first-grade-printable-ideas', slugs: { en: 'first-grade-printable-ideas', de: 'erste-klasse-druckvorlagen-ideen', fr: 'cp-idees-imprimables', es: 'primer-grado-ideas-imprimibles', pt: 'primeiro-ano-ideias-imprimiveis', it: 'prima-elementare-idee-stampabili', nl: 'groep-3-printable-ideen', sv: 'arskurs-1-utskriftsbara-ideer' } },
  { ideaId: 'second-grade-printable-ideas', slugs: { en: 'second-grade-printable-ideas', de: 'zweite-klasse-druckvorlagen-ideen', fr: 'ce1-idees-imprimables', es: 'segundo-grado-ideas-imprimibles', pt: 'segundo-ano-ideias-imprimiveis', it: 'seconda-elementare-idee-stampabili', nl: 'groep-4-printable-ideen', sv: 'arskurs-2-utskriftsbara-ideer' } },
  { ideaId: 'third-grade-printable-ideas', slugs: { en: 'third-grade-printable-ideas', de: 'dritte-klasse-druckvorlagen-ideen', fr: 'ce2-idees-imprimables', es: 'tercer-grado-ideas-imprimibles', pt: 'terceiro-ano-ideias-imprimiveis', it: 'terza-elementare-idee-stampabili', nl: 'groep-5-printable-ideen', sv: 'arskurs-3-utskriftsbara-ideer' } },
  ...
  { ideaId: 'esl-printable-ideas', slugs: { en: 'esl-printable-ideas', de: 'daf-druckvorlagen-ideen', fr: 'fle-idees-imprimables', es: 'ele-ideas-imprimibles', pt: 'ple-ideias-imprimiveis', it: 'italiano-l2-idee-stampabili', nl: 'nt2-printable-ideen', sv: 'svenska-som-andrasprak-utskriftsbara-ideer' } },
  { ideaId: 'summer-learning-printable-ideas', slugs: { en: 'summer-learning-printable-ideas', de: 'sommerlernen-druckvorlagen-ideen', fr: 'apprentissage-ete-idees-imprimables', es: 'aprendizaje-verano-ideas-imprimibles', pt: 'aprendizagem-verao-ideias-imprimiveis', it: 'apprendimento-estivo-idee-stampabili', nl: 'zomerleren-printable-ideen', sv: 'sommarlarande-utskriftsbara-ideer' } },
  ...
  { ideaId: 'custom-worksheet-service-ideas', slugs: { en: 'custom-worksheet-service-ideas', de: 'arbeitsblatt-service-ideen', fr: 'service-fiches-personnalisees-idees', es: 'servicio-fichas-personalizadas-ideas', pt: 'servico-fichas-personalizadas-ideias', it: 'servizio-schede-personalizzate-idee', nl: 'werkblad-service-op-maat-ideen', sv: 'skraddarsydd-arbetsblad-tjanst-ideer' } },
