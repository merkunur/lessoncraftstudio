...
const content: BlogContent = {
  seo: {
    ...
    metaDescription: 'Ofrecer muestras de sus fichas como lead magnet es la estrategia mas efectiva para construir una lista de email de compradores potenciales. Una muestra de ',
  },
  hero: {
    title: 'Muestras de Imprimibles como Lead Magnet Efectivo',
    tagline: 'Regale un poco para vender mucho',
    description: 'Ofrecer muestras de sus fichas como lead magnet es la estrategia mas efectiva para construir una lista de email de compradores potenciales. Una muestra de 3-5 paginas de alta calidad demuestra el valor de sus productos y motiva la compra del paquete completo. Esta guia le muestra como crear muestras que convierten sin canibalizar sus productos de pago.',
  },
  category: 'how-to',
