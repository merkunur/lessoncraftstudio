/* =====================================================================
   register-number-sieve.js — wire TOOL #36 into the site
   ---------------------------------------------------------------------
   Run:  node scripts/register-number-sieve.js [--dry-run]
...
const KEY = 'number-sieve';
const PREV = 'folding-sheet';          /* the key this one is inserted after */
const E = require('./_number-sieve-content.js');
