...
(function (global) {
  ...
  function nilaSVG(mood) {
    ...
    return '<svg class="np-nila-svg" viewBox="0 0 108 100" role="img" aria-label="' + (LANG === 'fr' ? 'Nila la loutre' : LANG === 'de' ? 'Nila die Otterdame' : LANG === 'es' ? 'Nila la nutria' : 'Nila the otter') + '">'
  ...
  global.NilaPondActivity = {
    ...
    strings: {
      title: { en: "Nila's Idea Pond", de: 'Nilas Ideen-Teich', fr: 'L’étang aux idées de Nila', es: 'El estanque de ideas de Nila' },
      instruction: { en: '', de: '', fr: '', es: '' },
      prompt: { en: "What's the big idea?", de: 'Worum geht es?', fr: 'De quoi parle ce texte ?', es: '¿De qué trata?' },
      readAgain: { en: '🔊 Read again', de: '🔊 Nochmal vorlesen', fr: '🔊 Écouter encore', es: '🔊 Leer otra vez' },
      commit: { en: "That's the big idea!", de: 'Das ist die Hauptsache!', fr: 'C’est l’idée principale !', es: '¡Esa es la idea principal!' },
      ...
      supplyHint: { en: 'Which one was in the story?', de: 'Welcher von diesen zwei kam in der Geschichte vor?', fr: 'Lequel était dans l’histoire ?', es: '¿Cuál de estos dos estaba en la historia?' },
      pondLabel: { en: 'Back to the pond', de: 'Zurück in den Teich', fr: 'Retour à l’étang', es: 'De vuelta al estanque' },
      slotLabel: { en: 'Detail', de: 'Detail', fr: 'Détail', es: 'Detalle' },
      nilaListen: { en: 'Listen to the little story…', de: 'Hör dir die kleine Geschichte an …', fr: 'Écoute la petite histoire…', es: 'Escucha la pequeña historia…' },
      nilaPickFirst: { en: 'Tap a fish, then tell me the big idea!', de: 'Tipp einen Fisch an und sag mir, worum es geht.', fr: 'Touche un poisson, puis dis-moi l’idée principale !', es: 'Toca un pez y dime de qué trata.' },
      nilaWrong: { en: "Hmm — let's listen again.", de: 'Hmm – hören wir noch einmal zu.', fr: 'Hmm… on écoute encore une fois.', es: 'Mmm… escuchemos otra vez.' },
      nilaSchool: { en: 'Now bring the true details home!', de: 'Jetzt bring die echten Details nach Hause.', fr: 'Maintenant, ramène les détails vrais à la maison !', es: '¡Ahora lleva a casa los detalles verdaderos!' },
      nilaWin: { en: 'You found the big idea!', de: 'Du hast die Hauptsache gefunden!', fr: 'Tu as trouvé l’idée principale !', es: '¡Encontraste la idea principal!' },
      hintCheck: { en: 'Find the big idea first, then tap Check!', de: 'Finde zuerst die Hauptsache, dann tippe auf „Prüfen".', fr: 'Trouve d’abord l’idée principale, puis touche Vérifier !', es: 'Encuentra primero la idea principal y luego toca Comprobar.' },
      retellPrefix: { en: 'So it was all about this. ', de: 'Es ging also die ganze Zeit um das hier: ', fr: 'C’est donc ça, l’idée principale : ', es: 'Así que de eso trataba todo: ' }
    },
    defaults: {},
