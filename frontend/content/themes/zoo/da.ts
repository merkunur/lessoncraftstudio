...
const content: EnrichedThemeContent = {
  // -- SEO fields --
  name: 'Zoologisk have',
  title: 'Gratis Printbare Zoo-opgaver til Børn | LessonCraftStudio',
  description: 'Printbare zoo-opgaver til børn. Matematik, farvelægning, ordspil og puslespil med zootema. Førskole til 3. klasse. Gratis PDF. 3.000+ tematiske billeder.',
  ...
  gradeContent: {
    'preschool': {
      seoTitle: 'Gratis Zoo-opgaver til Førskole | LessonCraftStudio',
      seoDescription: 'Printbare zoo-opgaver til førskolebørn (3–4 år). Farvelægning, tælling 1–10 og finmotorik. 33 generatorer. Gratis PDF. 3.000+ billeder. Ingen tilmelding.',
      seoKeywords: 'zoo-opgaver førskole, finmotorik øvelse, farvelægning og sporing, størrelsessortering, simpel tælling, eksotiske dyr, zoo-besøg, vilde dyr, zoo-øvelser førskole, zoos læring 3-4 år',
    ...
    'kindergarten': {
      seoTitle: 'Gratis Zoo-opgaver til Børnehaveklasse | LessonCraftStudio',
      seoDescription: 'Printbare zoo-opgaver til børnehaveklassen (5–6 år). Tælling, bogstaver, mønstre og visuel opfattelse. 33 generatorer. Gratis PDF. Ingen tilmelding krævet.',
      seoKeywords: 'zoo-opgaver børnehaveklasse, begyndelsesbogstaver øvelse, bogstavgenkendelse, tælling til 20, mønstergenkendelse, eksotiske dyr, zoo-besøg, vilde dyr, zoo-øvelser børnehaveklasse, zoos læring 5-6 år',
    ...
    'first-grade': {
      seoTitle: 'Gratis Zoo-opgaver til 1. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare zoo-opgaver til 1. klasse (6–7 år). Addition, subtraktion, læsning og skrivning. 33 generatorer. Gratis PDF. 3.000+ billeder. Ingen tilmelding.',
      seoKeywords: 'zoo-opgaver 1. klasse, addition subtraktion, syntetisk læsning, selvstændig skrivning, sætningsopbygning, eksotiske dyr, zoo-besøg, vilde dyr, zoo-øvelser 1. klasse, zoos læring 6-7 år',
    ...
    'second-grade': {
      seoTitle: 'Gratis Zoo-opgaver til 2. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare zoo-opgaver til 2. klasse (7–8 år). Multiplikation, ordspil, logik og problemløsning. 33 generatorer. Gratis PDF. Vælg mellem 3.000+ billeder.',
      seoKeywords: 'zoo-opgaver 2. klasse, multiplikation øvelser, dataanalyse børn, faktatekster læsning, positionstal forståelse, eksotiske dyr, zoo-besøg, vilde dyr, zoo-øvelser 2. klasse, zoos læring 7-8 år',
    ...
    'third-grade': {
      seoTitle: 'Gratis Zoo-opgaver til 3. Klasse | LessonCraftStudio',
      seoDescription: 'Printbare zoo-opgaver til 3. klasse (8–9 år). Flertrinsproblemer, krydsord, kryptogrammer og avancerede opgaver. 33 generatorer. Gratis PDF. Print nu.',
      seoKeywords: 'zoo-opgaver 3. klasse, multiplikation division, brøker introduktion, forskningsrapport, kritisk tænkning, eksotiske dyr, zoo-besøg, vilde dyr, zoo-øvelser 3. klasse, zoos læring 8-9 år',
