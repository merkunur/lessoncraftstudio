...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Leer van de fouten van anderen in plaats van uw eigen te maken',
    description: 'Leer van de fouten van anderen in plaats van uw eigen te maken. In deze gids ontdekt u hoe u deze kennis toepast op uw printable business voor maximale resultaten.',
  },
