...
window.NumberBondCore = {
  ...
  strings: {
    ...
    /* ── subtraction-as-unknown-addend mode (1.OA.B.4) strings — reuses the
       make-ten MODE (whole = minuend, given = subtrahend, fill = difference);
       only the framing differs. EN authored; 10 non-EN folded in by the native
