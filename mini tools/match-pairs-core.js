...
window.MatchPairsCore = {
  ...
  strings: {
    ...
    speakAllPairsMake: { en: 'All pairs make {n}!',                                                de: 'Alle Paare ergeben {n}!',                                                              es: '¡Todas las parejas forman {n}!',                                                                      it: 'Tutte le coppie fanno {n}!',                                                                                           fr: 'Toutes les paires font {n} !',                                                                                                                                      pt: 'Todos os pares formam {n}!',                                                                                                                                                                                                           nl: 'Alle paren maken {n}!',                                                                                  sv: 'Alla par blir {n}!' },
    /* Speech on Check wrong. */
    speakTryAgain:     { en: 'Some pairs don\'t add up yet. Try again.',                           de: 'Manche Paare passen noch nicht. Versuch\'s nochmal.',                                  es: 'Algunas parejas no encajan todavía. Inténtalo de nuevo.',                                             it: 'Alcune coppie non vanno ancora. Riprova.',                                                                             fr: 'Certaines paires ne vont pas encore. Réessaie.',                                                                                                                    pt: 'Alguns pares ainda não fazem o objetivo. Tente novamente.',                                                                                                                                                                            nl: 'Sommige paren kloppen nog niet. Probeer het nog eens.',                                                  sv: 'Vissa par stämmer inte än. Försök igen.' }
  },
