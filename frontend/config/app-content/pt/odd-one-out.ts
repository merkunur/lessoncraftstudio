...
const content: AppContent = {
  seo: {
    primaryKeyword: 'gerador de fichas encontre o diferente',
    secondaryKeywords: [
    ...
    lsiKeywords: [
      ...
      'gerador de fichas de discriminação visual uso comercial',
      'fichas encontre o diferente imprimíveis para negócio online',
    ],
  ...
  howItWorks: {
    title: 'Como Criar Fichas do Intruso em 5 Passos',
    steps: [
      {
        title: 'Configure o Layout de Página',
        description:
          'Abra o painel de Configuração de Página e escolha um tamanho: Carta Vertical, Carta Horizontal, A4 Vertical, A4 Horizontal, Quadrado (1200×1200) ou qualquer dimensão personalizada. Escolha uma cor de página com o seletor de cor como fundo de reserva. Selecione um tema de fundo e ajuste a opacidade (de 0 a 1 em passos de 0,05), e depois escolha um tema de moldura com o seu próprio controlo de opacidade independente. Estas opções de layout enquadram a sua ficha do intruso antes de configurar os exercícios.',
      },
      {
  ...
  keyFeatures: {
    title: 'Características Principais do Gerador de Fichas do Intruso',
    features: [
      {
      ...
      },
      {
        ...
        description:
          'Cada ficha do intruso gera automaticamente um gabarito complementar num separador de canvas separado. O gabarito reproduz o layout exato da ficha e desenha um contorno de círculo vermelho à volta do elemento intruso em cada fila de exercício. A espessura do traço do círculo escala dinamicamente com o tamanho da imagem — calculada como o maior entre tamanhoImagem × 0,04 ou 3 píxeis — assegurando uma visibilidade consistente em todos os tamanhos de página e quantidades de exercícios. Sem marcação manual, sem criação de ficheiros separados — o gabarito mantém-se sincronizado com a ficha automaticamente.',
      },
      {
  ...
  businessUseCases: {
    title: 'Como Vender Fichas do Intruso Online',
    cases: [
      {
        title: 'Packs Temáticos de Puzzles do Intruso na Etsy',
        description:
          'Crie packs de discriminação visual temáticos usando o sistema de dois temas — animais contra comida, veículos contra natureza, festividades contra desportos e dezenas mais de combinações entre categorias. Cada emparelhamento de temas produz exercícios únicos suficientes para múltiplas fichas com ambos os modos Idêntico e Similar. Empacote 10 a 20 fichas do intruso por pack com gabaritos incluídos, e venda a $3–$7 por conjunto. O formato puramente visual significa que cada pack funciona para qualquer mercado linguístico sem modificação, expandindo a sua base de clientes globalmente.',
      ...
      },
      {
        ...
        description:
          'As 104 coleções de imagens temáticas cobrem cada ocasião sazonal e festiva — Natal, Halloween, Páscoa, Dia dos Namorados, regresso às aulas, férias de verão e mais. Crie coleções do intruso de tempo limitado que se alinhem com os períodos de maior compra. Lance packs de puzzles de Halloween em setembro, coleções de Natal em outubro e packs de Dia dos Namorados em janeiro. Misture os modos Idêntico e Similar dentro de cada conjunto sazonal para variedade e valor percebido. Os produtos sazonais obtêm preços mais altos durante os seus períodos de pico e criam razões naturais para compras repetidas.',
        platform: 'Etsy / Amazon KDP / TPT (sazonal)',
      },
      {
        title: 'Alcance Global com Puzzles Puramente Visuais',
        description:
          'Como as fichas do intruso são totalmente visuais — não aparece nenhum texto no puzzle — cada ficha funciona em qualquer idioma sem modificação. O cabeçalho autogerado traduz-se para os 11 idiomas suportados, mas o conteúdo do puzzle não requer nenhuma localização. Isto torna as fichas do intruso excepcionalmente eficientes para vendedores que visam mercados internacionais. Crie um único conjunto de fichas e publique-o em múltiplas lojas da Etsy específicas por idioma ou marketplaces de Amazon KDP. O mesmo produto serve os mercados em inglês, alemão, francês, espanhol e todos os demais simultaneamente.',
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchorText: 'Gerador de Fichas de Sudoku',
    },
    {
      pageType: 'app',
  ...
  visuals: {
    heroImages: {
      ...
      primaryAlt: 'Ficha do intruso com quatro imagens por fila de exercício, ilustrações temáticas coloridas e cabeçalho localizado Encontra o Diferente',
    },
    sampleGallery: [
      {
        src: '/samples/portuguese/odd one out/Encontra o Diferente 2.webp',
        alt: 'Ficha do intruso em modo Similar com três animais e um alimento por fila',
      ...
      },
      {
        ...
        alt: 'Ficha do intruso em modo Idêntico com três imagens idênticas e uma diferente por fila',
    ...
    videoTitle: 'Como Criar Fichas do Intruso com Dois Modos e Gabaritos Automáticos — Tutorial Passo a Passo',
  },
};
