...
const content: StartContent = {
  ...
  toolsRecommended: [
    {
      ...
      description: 'Den beste flerspråklige demonstrasjonen — skjulte ord endres helt basert på språkvalg. Generer tematiske ordsøk-puslespill på alle 11 språk med vokabular fra den innebygde oversettelsesdatabasen.',
    },
    {
      appId: 'crossword-worksheets',
      title: 'Bildekryssord Generator',
      description: 'Kryssordsvar og ledetråder tilpasses fullstendig til hvert språk. Rutenettlayouter regenereres for å tilpasse seg forskjellige ordlengder på tvers av språk, noe som produserer genuint lokaliserte puslespill.',
    },
    {
      appId: 'word-scramble-worksheets',
      title: 'Bokstavblanding Generator',
      description: 'Blandede ord tilpasses hvert språks vokabular. Tyske sammensatte ord, franske aksentord og spansk vokabular blandes alle korrekt innenfor språkspesifikke regler.',
    },
    {
      appId: 'alphabet-train-worksheets',
      title: 'Alfabettog Generator',
      description: 'Bokstavsett og alfabetisk rekkefølge justeres for hvert språk. Språk med tilleggstegn (tyske ß, svenske åäö, norske æøå) produserer forskjellige togkomposisjoner.',
    },
    {
      appId: 'matching-worksheets',
      title: 'Koblingsoppgaver Generator',
      description: 'I ordkoblingsmodus endres vokabularetiketter per språk. Koble bilder til tyske, franske eller spanske navn ved hjelp av den innebygde oversettelsesdatabasen for autentisk lokalisert innhold.',
    },
    {
      appId: 'find-and-count-worksheets',
      title: 'Finn og Tell Generator',
      description: 'Bildeetiketter lokaliseres på alle 11 språk. Tellearbeidsark med tyske objektnavn, franske etiketter eller spansk vokabular skaper genuint differensierte internasjonale produkter.',
    },
  ],

  faq: [
    {
      question: 'Kan jeg teste flerspråklig arbeidsarkproduksjon før jeg kjøper en lisens?',
      answer: 'Ja. Hver generator tilbyr en gratis prøveversjon med vannmerke. Bytt språkvelgeren til et av de 11 støttede språkene og generer prøvearbeidsark for å evaluere oversettelseskvaliteten og utdataformatet. Den gratis prøveversjonen med vannmerke lar deg fullstendig teste flerspråklige funksjoner før du forplikter deg.',
    },
    {
      question: 'Trenger jeg å snakke tysk eller fransk for å selge arbeidsark på disse språkene?',
      answer: 'Nei. Språkavhengige generatorer håndterer all vokabularoversettelse internt ved hjelp av en verifisert database. Du trenger ikke å snakke målspråket for å lage nøyaktig flerspråklig arbeidsarkinnhold. Du vil trenge grunnleggende oversettelseshjelp for oppføringstitler og beskrivelser på Etsy eller Amazon, men selve arbeidsarkinnholdet krever ingen språkferdigheter fra deg.',
    },
    {
      question: 'Er oversettelsene nøyaktige nok for pedagogisk innhold?',
      answer: 'Oversettelsesdatabasen inneholder over 3 000 profesjonelt verifiserte vokabularoppføringer på tvers av alle 11 språk. Hver oversettelse ble gjennomgått for nøyaktighet, inkludert korrekte diakritiske tegn (tyske omlyder, franske aksenter, portugisiske tilder, norske tegn). Denne databasedrevne tilnærmingen produserer mer pålitelige resultater enn maskinoversettelse for pedagogisk vokabular.',
    },
    {
      question: 'Hva er forskjellen mellom språkavhengige og rent visuelle generatorer?',
      answer: 'Språkavhengige generatorer (13 apper inkludert ordsøk, kryssord og bokstavblanding) produserer arbeidsarkinnhold som endres basert på det valgte språket — forskjellige ord, ledetråder og vokabular vises på siden. Rent visuelle generatorer (20 apper inkludert fargelegging, matematikk og Sudoku) produserer innhold som er språkuavhengig — resultatet ser identisk ut uansett språkvalg.',
    },
    {
      question: 'Kan jeg selge de samme rent visuelle arbeidsarkene i flere språkmarkeder?',
      answer: 'Ja. Fargeleggingssider, matematikkarbeidsark, Sudoku-puslespill og annet rent visuelt innhold bruker tall, bilder og former som er universelle. Du kan oppføre den samme PDF-filen på Etsy.de, Etsy.fr, Amazon.de og Amazon.fr med lokalisert oppføringstekst. Ingen ny innholdsgenerering er nødvendig — kun oversatte titler og beskrivelser.',
    },
    {
      question: 'Hvilket ikke-engelskspråk bør jeg starte med?',
      answer: 'Tysk er det anbefalte første utvidelsesspråket for de fleste selgere. Amazon.de er den nest største Amazon-markedsplassen globalt, Etsy.de har en aktiv kjøperbase for pedagogiske utskriftsbare produkter, og konkurransen i tyske pedagogiske arbeidsark er dramatisk lavere enn på engelsk. Fransk er det anbefalte andre språket.',
    },
    {
      question: 'Trenger jeg separate kommersielle lisenser for hvert språk?',
      answer: 'Nei. En kommersiell lisens dekker alle språk som støttes av den generatoren. Du kjøper én lisens per generator og kan lage kommersielt innhold på alle 11 støttede språk. Det er ingen per-språk lisenskrav.',
    },
    {
  ...
  nextSteps: [
    ...
    },
    {
      ...
      description: 'KDP-spesifikk strategi for publisering av aktivitetsbøker på Amazon. Dekker innholdsformatering, forsidedesign, nøkkelordforskning, priser og skalering av KDP-katalogen din internasjonalt.',
    },
    {
      slug: 'etsy-utskriftsbar-forretning',
      title: 'Etsy Utskriftsbar Forretning Masterclass',
      description: 'Etsy-spesifikk guide for digitale utskriftsbare nedlastinger. Dekker butikkoppsett, Etsy-SEO, oppføringsoptimalisering og hvordan du når internasjonale kjøpere gjennom Etsys regionale domener.',
    },
    {
      slug: 'lag-arbeidsark-som-selger',
      title: 'Slik Lager du Arbeidsark som Selger',
      description: 'Dypdykk i produktskapingskvalitet: designstandarder, differensieringsteknikker og metodene som gjør at dine flerspråklige arbeidsark skiller seg ut fra konkurrentene.',
    },
  ],

  internalLinks: [
    { pageType: 'guide', slug: 'flerspraklig-utskriftsbar-forretning', anchorText: 'Bygg en flerspråklig utskriftsbar forretning' },
    { pageType: 'guide', slug: 'arbeidsark-flere-spraak', anchorText: 'Lag arbeidsark på flere språk' },
    { pageType: 'guide', slug: 'selg-pedagogiske-utskriftsbare-etsy', anchorText: 'Selg pedagogiske utskriftsbare på Etsy' },
    { pageType: 'start', slug: 'skalering-utskriftsbar-forretning', anchorText: 'Skaler din utskriftsbare forretning' },
  ],

  visuals: {
    heroImage: { src: '/samples/norwegian/wordsearch/ordleting-1.webp', alt: 'Ordsøk-puslespillarbeidsark som demonstrerer flerspråklig arbeidsarkgenerering på 11 språk' },
    samples: [
      { src: '/samples/norwegian/wordsearch/ordleting-1.webp', alt: 'Ordsøk-puslespillarbeidsark med språkavhengig vokabular', caption: 'Ordsøk — Beste Flerspråklige Demo' },
      { src: '/samples/norwegian/crossword/bildekryssord-1.webp', alt: 'Kryssordpuslespill med lokaliserte ledetråder og svar', caption: 'Bildekryssord — Fullstendig Lokaliserte Puslespill' },
      { src: '/samples/norwegian/word%20scramble/bokstavblanding-1.webp', alt: 'Bokstavblandingsarbeidsark med språktilpasset vokabular', caption: 'Bokstavblanding — Språkavhengig Produksjon' },
      { src: '/samples/norwegian/alphabet%20train/alfabettog-1.webp', alt: 'Alfabettog-arbeidsark som viser språkspesifikke bokstavsett', caption: 'Alfabettog — Tilpassede Bokstavsett' },
    ],
