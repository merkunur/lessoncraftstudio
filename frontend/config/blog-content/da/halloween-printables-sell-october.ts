...
Start med LessonCraftStudios gratis prøveversion med vandmærke og test alle funktioner, før du investerer i en kommerciel licens.' }
  ...
  internalLinks: [
    { pageType: 'app', slug: 'farvelaegning-arbejdsark', anchorText: 'Halloween Farvelægning' },
    { pageType: 'app', slug: 'ordsoegning-arbejdsark', anchorText: 'Halloween Ordsøgning' },
    { pageType: 'app', slug: 'banko-arbejdsark', anchorText: 'Halloween Banko' },
  ],
  relatedPosts: [
