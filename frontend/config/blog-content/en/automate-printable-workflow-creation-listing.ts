...
const content: BlogContent = {
  seo: {
    ...
    secondaryKeywords: [
      ...
      'automate worksheet creation process',
      'streamline printable product listing',
    ],
    lsiKeywords: [
      'printable business efficiency tools',
  ...
  cta: {
    heading: 'Automate Your Content Creation Today',
    description: 'LessonCraftStudio generators produce complete worksheet sets with answer keys in minutes. Start automating the most time-consuming phase of your business. Try any generator free trial with watermark.',
