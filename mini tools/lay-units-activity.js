...
(function (global) {
  ...
  var NUMW = {
    ...
    /* it — native ensemble. Unit "aiutante" is masculine → win uses apocope "Un"/"Due" (Un aiutante,
       never "Uno aiutante"). count = tap-count register; win = capitalized sentence-start before the noun. */
    it: {
      count: ['zero', 'uno', 'due', 'tre', 'quattro', 'cinque', 'sei', 'sette', 'otto', 'nove', 'dieci'],
      win:   ['Zero', 'Un', 'Due', 'Tre', 'Quattro', 'Cinque', 'Sei', 'Sette', 'Otto', 'Nove', 'Dieci']
    }
  };
  ...
  global.LayUnitsActivity = {
    ...
    strings: {
      ...
      title: { en: "Inchie's Garden Path", de: 'Inchies Gartenweg', fr: "Le chemin du jardin d'Inchie", es: 'El sendero de Inchie', pt: 'O caminho do jardim de Inchie', it: 'Il sentiero del giardino di Inchie' },
      instruction: { en: '', de: '' },
      prompt: { en: 'Lay the helpers, then count.', de: 'Leg die Helfer aus und zähl sie dann.', fr: 'Pose les bâtonnets, puis compte-les.', es: 'Pon los ayudantes y cuéntalos.', pt: 'Coloque os ajudantes e conte.', it: 'Metti gli aiutanti, poi contali.' },
      add: { en: '+ Add a helper', de: '+ Helfer dazu', fr: '+ Un bâtonnet', es: '+ Otro ayudante', pt: '+ Outro ajudante', it: '+ Un aiutante' },
      addBig: { en: '+ Big helper', de: '+ Großer Helfer', fr: '+ Un grand bâtonnet', es: '+ Ayudante grande', pt: '+ Ajudante grande', it: '+ Aiutante grande' },
      nudgeL: { en: '◀' }, nudgeR: { en: '▶' }, take: { en: 'Take back', de: 'Zurücknehmen', fr: 'Retirer', es: 'Quitar', pt: 'Tirar', it: 'Togli' },
      count: { en: 'Count them! Tap each helper.', de: 'Zähl sie! Tipp jeden Helfer an.', fr: 'Compte-les ! Touche chaque bâtonnet.', es: '¡Cuéntalos! Toca cada ayudante.', pt: 'Conte! Toque em cada ajudante.', it: 'Contali! Tocca ogni aiutante.' },
      ...
      sayWin: { en: 'helpers long! 🌸', de: 'Helfer lang! 🌸', fr: 'bâtonnets de long ! 🌸', es: 'ayudantes de largo! 🌸', pt: 'ajudantes de comprimento! 🌸', it: 'aiutanti di lunghezza! 🌸' },
      sayWinSpoken: { en: 'helpers long', de: 'Helfer lang', fr: 'bâtonnets de long', es: 'ayudantes de largo', pt: 'ajudantes de comprimento', it: 'aiutanti di lunghezza' },
      sayGap: { en: 'A little gap snuck in — scootch them together!', de: 'Da hat sich eine Lücke eingeschlichen – schieb sie zusammen!', fr: "Un petit trou s'est glissé — rapproche-les !", es: '¡Se coló un huequito! ¡Júntalos bien!', pt: 'Entrou um buraquinho — junte eles bem!', it: 'Si è infilato un buchino — attaccali bene!' },
      sayOverlap: { en: 'Two helpers are on top — give them room!', de: 'Zwei Helfer liegen übereinander – gib ihnen Platz!', fr: 'Deux bâtonnets se chevauchent — laisse-leur de la place !', es: '¡Dos ayudantes están encimados! ¡Dales lugar!', pt: 'Dois ajudantes estão em cima um do outro — dê espaço!', it: 'Due aiutanti sono accavallati — dai loro un po\' di spazio!' },
      sayShort: { en: 'Not all the way yet — add more helpers!', de: 'Noch nicht ganz bis zum Ende – leg noch ein paar Helfer dazu!', fr: 'Pas encore jusqu\'au bout — ajoute des bâtonnets !', es: '¡Todavía no llegas! ¡Pon más ayudantes!', pt: 'Ainda não chegou! Coloque mais ajudantes!', it: 'Non sei ancora arrivato — aggiungi altri aiutanti!' },
      sayOverhang: { en: "That's past the end — take one back.", de: 'Das ragt über das Ende hinaus – nimm einen weg.', fr: 'Ça dépasse le bout — retire-en un.', es: '¡Eso se pasó del final! Quita uno.', pt: 'Isso passou do fim — tire um.', it: 'Sei andato oltre la fine — togline uno.' },
      sayStart: { en: 'Start the first helper right at the tip!', de: 'Fang mit dem ersten Helfer genau an der Spitze an!', fr: 'Commence le premier bâtonnet pile au bord !', es: '¡Empieza el primer ayudante justo en la puntita!', pt: 'Comece o primeiro ajudante bem na pontinha!', it: 'Fai partire il primo aiutante proprio dalla punta!' },
      ...
      saySnug: { en: 'All snug, no holes! Now count them.', de: 'Schön lückenlos, keine Lücke! Jetzt zähl sie.', fr: 'Bien serrés, sans trou ! Maintenant, compte-les.', es: '¡Bien juntitos, sin huecos! Ahora cuéntalos.', pt: 'Bem juntinhos, sem buracos! Agora conte.', it: 'Tutti attaccati, senza buchi! Ora contali.' },
      sayInverse: { en: 'Smaller helpers, more of them!', de: 'Kleinere Helfer – mehr davon!', fr: 'Plus les bâtonnets sont petits, plus il en faut !', es: 'Ayudantes más pequeños, ¡más necesitas!', pt: 'Ajudantes menores, mais ajudantes você precisa!', it: 'Aiutanti più piccoli? Te ne servono di più!' },
      ...
      countBig: { en: 'Count the BIG helpers.', de: 'Zähl die GROSSEN Helfer.', fr: 'Compte les GRANDS bâtonnets.', es: 'Cuenta los ayudantes GRANDES.', pt: 'Conte os ajudantes GRANDES.', it: 'Conta gli aiutanti GRANDI.' },
      countLittle: { en: 'Now count the LITTLE helpers!', de: 'Jetzt zähl die KLEINEN Helfer!', fr: 'Maintenant, compte les PETITS bâtonnets !', es: '¡Ahora cuenta los ayudantes PEQUEÑOS!', pt: 'Agora conte os ajudantes PEQUENOS!', it: 'Ora conta gli aiutanti PICCOLI!' },
      judgeMiss: { en: 'Look closely — same size, no gaps, no overhang?', de: 'Schau genau hin – gleich groß, keine Lücke, nichts steht über?', fr: 'Regarde bien — même taille, sans trou, rien qui dépasse ?', es: 'Fíjate bien — ¿mismo tamaño, sin huecos, sin que se pase?', pt: 'Olhe bem — mesmo tamanho, sem buracos, sem passar do fim?', it: 'Guarda bene — stessa misura, niente buchi, senza andare oltre la fine?' },
      invMidA: { en: '{n} big helpers! Now the little ones.', de: '{n} große Helfer! Jetzt die kleinen.', fr: '{n} grands bâtonnets ! Maintenant, les petits.', es: '¡{n} ayudantes grandes! Ahora los pequeños.', pt: '{n} ajudantes grandes! Agora os pequenos.', it: '{n} aiutanti grandi! Ora i piccoli.' },
      invDone: { en: '{a} big, {b} little — smaller helpers, more of them! 🌸', de: '{a} große, {b} kleine – kleinere Helfer, mehr davon! 🌸', fr: '{a} grands, {b} petits — plus les bâtonnets sont petits, plus il en faut ! 🌸', es: '{a} grandes y {b} pequeños: los más pequeños, ¡más necesitas! 🌸', pt: '{a} grandes e {b} pequenos: ajudantes menores, mais ajudantes você precisa! 🌸', it: '{a} grandi e {b} piccoli — aiutanti più piccoli, te ne servono di più! 🌸' }
    },
    defaults: {},
