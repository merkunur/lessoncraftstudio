...
const content: BlogContent = {
  ...
  hero: {
    ...
    tagline: 'Realistische verwachtingen op basis van echte verkopersdata',
    description: 'Uw eerste maand als printable verkoper op Etsy zal waarschijnlijk tegenvallen — en dat is volkomen normaal. De meeste nieuwe winkels maken 0-5 verkopen in maand één. Het algoritme vertrouwt uw winkel nog niet, u hebt geen beoordelingen en uw listings hebben niet genoeg tijd gehad om geïndexeerd te worden. Maar deze maand gaat niet over omzet — het gaat over het bouwen van het fundament.',
  },
